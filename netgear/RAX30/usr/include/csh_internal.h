...
int start_circle_agent(bool run_synchronously);
int stop_circle_agent(void);
int restart_circle_agent(void);
int reset_circle_agent(void);
...
void setCshError(int error_number);
char* getErrorMessage(int error_number);
char* shellRunner(const char* command, char** output);
#endif /* _INTERNAL_H_ */
