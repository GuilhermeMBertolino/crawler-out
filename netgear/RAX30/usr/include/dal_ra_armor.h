...
#define MAX_SWITCH_SIZE 12 //!< Buffer length to store the status of armor ra switch
#define ARMOR_RA_EVENT_STATUS_MAX_LEN 8 //!< Buffer length to store the armor ra events status
