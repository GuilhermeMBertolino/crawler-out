<?
    ...
    if($devMode == "router")
    {
        $data->router_info__rpeVer = (object) null;
        $data->router_info__rpeVer->value = getProtectionEngineVersion();
        $data->router_info__rpeVer->mlang = "RPE003";
        $data->router_info__rpeVer->type = 'advTableRow';
    }
    ...
    $data->internet_info__wanMask->type = 'advTableRow';
    ...
    if($smartEnable == "false" && $devMode != "bridge")
    {
