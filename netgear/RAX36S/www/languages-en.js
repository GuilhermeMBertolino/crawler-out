...
devname_warning_31="Please use alpha numericals up to 31 characters"
...
h_device_name_page3="<body bgcolor=#0099cc><p><font size=4><b>Device Name Help</b></font></p><p><b>Device Name:</b> device name identifies this router. It is provided to client devices connected to the router to recognize this device. </p><p>It should start with letter and should contain only letters, number, ‘-‘ and ‘_’ symbols, [a-zA-Z]+[a-zA-Z0-9\-\_].The maximum length is 31 characters</p></body>"
...
sec_8_127_or_128h="(8-127 characters or 128 hex digits)"
...
thank_login_info="Thank you for purchasing Netgear's RAX10v2 Wireless-N Router. Be sure to use the Firmware Upgrade periodically to take advantage of improvements and feature additions NETGEAR offers for this product.<BR><BR>To take advantage of the Wireless-N feature offered by the router, use a wireless adapter that displays this logo."
thank_login_info_RangeMax="Thank you for purchasing Netgear's RAX10v2 RangeMax (TM) Wireless-N 600 Router. Be sure to use the Firmware Upgrade periodically to take advantage of improvements and feature additions NETGEAR offers for this product.<BR><BR>To take advantage of the Wireless-N feature offered by the router, use a wireless adapter that displays this logo."
...
error_module="Error upgrade file module name! (Module name is \"RAX10v2\") "
error_language_form="Incorrect upgrade file language name. (The language name is\"RAX10v2-*-Language-table\".)"
h_wlan_2_54_289_600="<P>Mode<P>Select the desired wireless mode. The options are:<UL><LI>Up to 54 Mbps - Legacy Mode with maximum speed of up to 54 Mbps for b/g networks.<LI>Up to 286 Mbps - Neighbor Friendly Mode, with a speed up to 286 Mbps in presence of neighboring wireless networks.<LI>Up to 600 Mbps - Performance Mode - Maximum Wireless-N speed up to 600 Mbps. </LI></UL><P>The 2.4GHz (b/g/n) default is <b>Up to 600Mbps</b>, which allows all 11b and 11g and 11n wireless stations. The 5GHz (a/n) default is <b>Up to 1733Mbps</b>, which allows all 11a and 11n wireless stations. </P>"
...
wlan_network_ac_mark="Wireless Network (5GHz 802.11a/n/ac/ax)"
...
h_wladv_Frag="<P>CTS/RTS Threshold, Preamble Mode</P><P>These settings are reserved for wireless testing and advanced configuration only. Do not change these settings.</P>"
print_prompt4_1="1. Install ReadySHARE Vault on each PC by downloading the software from <a class='linktype' target='_blank' href='http://www.netgear.com/readyshare'>www.netgear.com/readyshare</a>."
print_prompt5_1="2. Launch ReadySHARE Vault. Use the Dashboard or the Backup tab to set up and run your backup."
...
h_new_attach_device="<body bgcolor=#0099cc><p><font size=4><b>Attached Device Help</b></font></p><p>This screen displays information about the devices that are attached to the router. </p><p><b>Edit selection:</b> Select a device and click the <b>Edit</b> button. The Edit Device page displays. </p><p><b>Status:</b>This column shows a device's access control status. If access control is disabled, this column is hidden.</p><p><b>Connection Type:</b> This column shows how a device connects to router. </p><p><b>Device Name:</b>This column shows a device's name, type icon. This information is automatically detected by the router. </p><p><b>IP Address:</b>This column shows the IP address of this device. </p><p><b>MAC Address:</b> This column shows MAC address of this device. </p><p>To block or allow one or more devices to access your network, click the <b>Access Control</b> link in the top right corner of this screen to go to the Access Control screen and make changes.</p></body>"
wlan_mode_573_5="Up to 573.5 Mbps"
wlan_mode_481="Up to 481 Mbps"
wlan_mode_1000="Up to 1000 Mbps"
wlan_mode_573="Up to 573 Mbps"
wlan_mode_240="Up to 240 Mbps"
wlan_mode_500="Up to 500 Mbps"
wlan_mode_2166="Up to 2166 Mbps"
wlan_mode_286="Up to 286 Mbps"
wlan_mode_2401="Up to 2401 Mbps"
wlan_mode_4333="Up to 4333 Mbps"
wlan_mode_1200="Up to 1200 Mbps"
wlan_mode_1083="Up to 1083 Mbps"
traffic_turn_led_w="Turn the Internet LED to flashing green/amber"
web_management_help="<body bgcolor=#0099cc ><P><font size=4><B>Web Services Management Help</B></font></P><hr><p name=usehttps id=usehttps></p><p><b>Always Use HTTPS to Access Router</b></p><p><ul>Enabling of this feature enhances the security of the connection to the router web interface.<br>When enabled, your access to the router web interface uses HTTPS.<br>When disabled, your access to the router web interface can use either HTTP or HTTPS.</ul></p><hr> <p><b>To save or cancel changes:</b></p><p name=To id=To></p><p>Click <b>Apply</b> to have your changes take effect.<br> Click <b>Cancel</b> to return to the previous settings.</p></body>"
