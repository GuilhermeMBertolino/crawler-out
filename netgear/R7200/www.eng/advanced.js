function close_all_sub(click_name)/* fold all menus, except the menu which user click */
{
	...
	for ( i=0; i< sub_array.length; i++)
	{
		...
		if( sub_name != click_name )
		{
			...
			if( button_name == "usb_bt" && ( top.enabled_wds == 1))
...
var wds_items = ["internet", "guest", "wan", "block_site", "block_services", "schedule","email","ipmac", "log", "forwarding_triggering", "dns", "static", "remote", "upnp", "traffic", "access_control", "vlan", "led_ctrl"];
var ap_items = ["lan", "wan", "internet", "block_site", "block_services",  "wds", "forwarding_triggering",  "remote", "usb_mobile", "ipv6", "upnp", "traffic", "parental", "fbwifi", "openvpn", "vlan", "mode"];
var modem_items = ["lan", "wan", "internet", "block_site", "block_services", "schedule", "wds", "forwarding_triggering", "dns", "static", "remote", "traffic", "wireless", "wlap", "guest", "usb_basic", "media",  "qos", "parental", "openvpn", "vpn_ply", "vpn_sta", "readyshare", "upnp", "ipv6", "email", "vlan"];   /* , "block_services" */
...
function menu_class_default()
{
	...
	if(top.document.getElementById("DSL_setup_wizard") != null)
		menu_div = top.document.getElementById("DSL_setup_wizard");
	else if(top.document.getElementById("setup_wizard") != null)
	...
	content_length = menu_div.getElementsByTagName("span")[0].innerHTML.length;
	if( top.enabled_wds == 1 || top.enable_ap_flag == 1 || top.is3g_mode == "1" || (top.enable_ap_flag == 0 && top.enabled_modem == 1))
		settingClass(menu_div, content_length, "advanced_grey_button");
	else
		settingClass(menu_div, content_length, "advanced_black_button");
	...
	{
		content_length = menu_div.getElementsByTagName("span")[0].innerHTML.length;
		if( top.enabled_wps == 1 && top.enabled_wds == 0 && top.wps_mode != "disabled" && (top.enable_ap_flag ==1 || top.enabled_modem != 1))
			settingClass(menu_div, content_length, "advanced_black_button");
		else
			settingClass(menu_div, content_length, "advanced_grey_button");
	}
	...
	for(i=0; i<extensible_items.length; i++)
	{
		...
		content_length = menu_div.getElementsByTagName("span")[0].innerHTML.length;
		if(i == 1 && ( top.enabled_wds == 1))//usb in modem mode or repeater mode
			settingClass(menu_div, content_length, "advanced_grey_button");
		else
...
function menu_color_change( change_id )
{
	...
	if( change_id == "home" ||  change_id == "setup_wizard" || change_id == "DSL_setup_wizard" || change_id == "wps" || change_id == "cloud")
	{
...
function click_adv_action(id)
{
        if( enable_action == 1 )
        {
		...
		else if( id == "DSL_setup_wizard" && top.enabled_wds == 0 && top.enable_ap_flag != 1 && top.enabled_modem != 1)
                {
                        menu_color_change('DSL_setup_wizard');
                        goto_formframe('BRS_WIZ_sel.htm&todo=cfg_init');
                }
                else if( id == "wps" && top.enabled_wps == 1 && top.enabled_wds == 0 && top.wps_mode != "disabled" && (top.enable_ap_flag ==1 || top.enabled_modem != 1))
                {
                ...
                else if( id == "wireless" && (top.enable_ap_flag == 1 || top.enabled_modem != 1))
                {
                        goto_formframe("WLG_dualband_idx.htm&todo=cfg_init");
                        menu_color_change('wireless');
                }
                else if( id == "guest" && top.enabled_wds == 0 && (top.enable_ap_flag == 1 || top.enabled_modem != 1))
                {
				...
				*/
                ...
                else if( id == "qos" && (top.enable_ap_flag == 1 || top.enabled_modem != 1))
                {
                ...
                else if( id == "usb_basic" && (top.enable_ap_flag == 1 || top.enabled_modem != 1))
                {
		...
		else if( id == "usb_printer" )
                {
                        goto_formframe("RMT_print.htm&todo=cfg_init");
                        menu_color_change('usb_printer');
                }
                else if( id == "usb_vault" )
                {
                        goto_formframe("RMT_vault.htm&todo=cfg_init");
                        menu_color_change('usb_vault');
                }
                else if( id == "usb_media" && (top.enable_ap_flag == 1 || top.enabled_modem != 1))
                {
                        goto_formframe("USB_media.htm&todo=cfg_init");
                        menu_color_change('usb_media');
                }
                else if( id == "usb_readycloud" && (top.enable_ap_flag == 1 ||top.enabled_modem != 1))
                {
                        goto_formframe("Readyshare_remote.htm&todo=cfg_init");
                        menu_color_change('usb_readycloud');
                }
                else if(id == "usb_mobile" && top.enabled_wds == 0 && top.enable_ap_flag != 1 && top.enabled_modem != 1)
                {	
				goto_formframe("choose_wan.htm&todo=cfg_init");
                        menu_color_change('usb_mobile');
		}
                else if( id == "parental" && top.enable_ap_flag != 1 && top.enabled_modem != 1)
                {
		...
		else if(id == "ipmac" && top.enabled_wds ==0 && (top.enable_ap_flag == 1 || top.enabled_modem != 1))
		{
			goto_formframe("IP_Mac.htm&todo=cfg_init");
			menu_color_change('ipmac');
		}
		else if(id == "cloud" && top.enabled_wds == 0 && top.enable_ap_flag != 1 && top.is3g_mode == "0" && top.enabled_modem != 1)
		{
			...
			menu_color_change('cloud');
                ...
                {
                        goto_formframe("FW_ntp.htm&todo=cfg_init");
				...
				*/
                ...
                else if( id == "wlap" && (top.enable_ap_flag == 1 || top.enabled_modem != 1))
                {
                ...
                {
                        goto_formframe("WLG_opmode_main.htm&todo=cfg_init");
                        menu_color_change('opmode');
                }
		 ...
		 else if( id == "openvpn"  && top.enable_ap_flag != 1 && top.enabled_modem != 1)
                {
		...
		else if( id == "ipv6" && top.enable_ap_flag != 1 && top.enabled_modem != 1)
		{
		...
		*/
		else if( id == "traffic" && top.enabled_wds == 0 && top.enable_ap_flag != 1 && top.enabled_modem != 1)
		{
		...
		else if( id == "fbwifi" && top.enabled_wds == 0 && top.enable_ap_flag != 1 && top.enabled_modem != 1)
		{
                        goto_formframe("fbwifi.htm&todo=cfg_init");
                        menu_color_change('fbwifi');
		}
		else if( id == "vlan" && top.enabled_wds == 0 && top.enable_ap_flag != 1 && top.enabled_modem != 1)
		{
