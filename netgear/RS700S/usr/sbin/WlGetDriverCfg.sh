...
echo -n maxscb=; echo $(wl -i $ifname maxscb)
echo -n maxassoc=; echo $(wl -i $ifname maxassoc)
echo -n mbss=; echo $(wl -i $ifname mbss)
echo -n mbss_ign_mac_valid=; echo $(wl -i $ifname mbss_ign_mac_valid)
...
echo -n chan_info=; echo $(wl -i $ifname chan_info)
...
echo -n txpwr_percent=; echo $(wl -i $ifname txpwr_percent)
