...
#
# $Id: mapgetcfg.sh 787960 2020-06-17 06:55:52Z tp888369 $
#
...
do
	...
	do
        ...
        exec_cmd wl -i $radio dfs_status
		...
		exec_cmd acs_cli2 -i $radio dump acs_record
	...
	do
		...
		exec_cmd wl -i $bss mlo info
		exec_cmd wl -i $bss nrate
		exec_cmd wl -i $bss rate
		exec_cmd wl -i $bss bs_data
		exec_cmd wl -i $bss rx_report
