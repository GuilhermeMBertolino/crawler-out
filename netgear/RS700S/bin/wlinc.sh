...
NOT_EAP=`test -e /etc/rc3.d/S91eap; echo $?`
...
if [ ! -z $CROSSBOW ] && [ -z $CROSSBOWFOL ]; then
    ...
    # CrossBow platforms
    PLTDRV_PROC_LIST=" xbow_fwq xbow_stq archer_dhd "
    WLDRV_INTR_LIST=" ${WLDRV_INTR_LIST} m2m0 m2m1 mlc phy "
