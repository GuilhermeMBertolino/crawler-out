...
var jsArr = ['jquery-1.8.js','script/jquery.jscrollpane.min.js'];
var cssArr = [];
var jsWithOut = ['UPG_upgrade','upgrade_check','DEV_name','UPG_fw_check','top','QOS_down_streaming','adv-wifi','CongratulationsFULL','QOS_down_streaming_iqos','QOS_down_streaming_iqos_basic','start_CV','ADVANCED_home'];
