  ...
  function postConfig(callback)
  {
      ...
      formData.append("config_file",$("#file_upgrade").prop("files")[0]);
      $.ajax({
        url : "/cgi-bin/rex_cgi?function=wizardRestoreConfig&csrftoken=" + CSRF_TOKEN,
        type : "POST",
        cache : false,
        dataType : "json",
        processData: false,
  ...
  function wizPost(postData, callbackFun)
  {
      $.ajax({
  ...
  function postManualPortSetting()
  {
      var postData = {};
      postData.function = "WanPortManual";
      var o = {};
      o["mode"] = $("[name='wan_port_select']:checked").val();
      //Ian
      wanPort = $("[name='wan_port_select']:checked").val();
  ...
  function postWifiSetup()
  {
      ...
      o["6GSsid"] = $("input[name='wla_6g_ssid']").val();
      o["6GPassword"] = $("input[name='wla_6g_password']").val();
      o["wifiRegion"] = $('select[name=country]').val();
      postData.data = o;
      //console.log(postData);
      wizPost(JSON.stringify(postData));
  }

  function afterWanPortDetect(resp)
  {
      ...
      {
            if(resp.message.indexOf("Manual Configure") != -1)
            {
                nextPage = "wanPreference-page";
            }
            else if(resp.message.indexOf(",") != -1)
            {
                wanPort = resp.message.split(",")[0];
                var wanType = resp.message.split(",")[1];
                switch(wanType){
                    case 'dhcp':
  ...
  function postWanPortDetect(callbackFun)
  { 
      var postData = {};
      postData.function = "WanPortDetect";
      var o = {};
      postData.data = o;
      //console.log(postData);
      wizPost(JSON.stringify(postData), callbackFun);
  }

  function postDhcpSetting(client_Mac)
  {
      var postData = {};
      postData.function = "wanIP";
      var o = {};
      o["wanmode"] = wanPort;
      o["domain"] = "";
      o["ipType"] = "dynamic";
  ...
  function postPptpSetting()
  {
      ...
      var o = {};
      //TODO: PEGA Ian>> wan port not fixed on 1G port
      o["wanmode"] = wanPort;
  ...
  function addWizardPage(pageId)
  {
      ...
      switch(pageId)
      {
          case 'internetPing-page':
              newDiv = '<div class="form-group" align="center" style="overflow:auto;scrolling:auto"> \r\n\
                    <div class="rowCenter" style="height: 25px;">\r\n\
                      <p class="wizardTitleBlack" mlang="genie_23">Checking the Internet connection; please wait ...</p>\r\n\
                    </div>\r\n\
          ...
          case 'internetDetect-page':
              newDiv = '<div class="form-group" style="overflow:auto;scrolling:auto"> \r\n\
                    <div class="rowCenter" style="height: 25px;">\r\n\
          ...
          case 'internetDetectSuccess-page':
              newDiv = '<div class="form-group" align="center" style="overflow:auto;scrolling:auto"> \r\n\
                    ...
                    <div class="rowCenter">\r\n\
                        <img src="images/RAXE300_PRODUCT-FRONT.png">\r\n\
                    </div>\r\n\
                    <div class="rowCenter" style="height: 10px;"></div>\r\n\
                    <div class="rowCenter">\r\n\
              ...
              break;
          case 'noCable-page':
              newDiv = '<div class="form-group" style="margin:auto;overflow:auto;scrolling:auto;display: table;"> \r\n\
                  <div class="rowCenter" style="height: 25px;">\r\n\
          ...
          case 'cableConnectionRetry-page':
              ...
              break;
          case 'autoWanPortDetect-page':
              newDiv = '<div class="form-group" align="center" style="height:365px;overflow:auto;scrolling:auto"> \r\n\
                    <div class="rowCenter" style="height: 25px;">\r\n\
                      <p class="wizardTitleBlack" mlang="genie_247">Checking your network setup, please wait ...</p>\r\n\
                    </div>\r\n\
                    <div class="form-row" style="height:30px;"></div>\r\n\
                    <div class="rowCenter">\r\n\
                      <img id="card-searching-internet" frameborder="0" border="0" src="/images/wait.gif">\r\n\
              ...
              break;
          case 'wanPreference-page':
              newDiv = '<div class="form-group" style="margin: auto;height:365px;overflow:auto;scrolling:auto;display: table;"> \r\n\
                  <div class="rowCenter" style="height: 25px;">\r\n\
                    <p class="wizardTitleBlack" mlang="MWAN_008">WAN Preference</p>\r\n\
                  </div>\r\n\
                  <div class="rowCenter" style="height: 15px;">\r\n\
                    <p class="wizardTextBlack" style="font-size: 14px;padding-bottom: 5px;" mlang="MWAN_001"></p>\r\n\
                  </div>\r\n\
                  <div class="rowCenter" style="height:20px;">\r\n\
                    <label align="left" class="checkbox-container">\r\n\
                      <input type="radio" checked name="wan_port_select" id="wan_port_1G" value="1G">\r\n\
                      <span mlang="MWAN_002"></span>\r\n\
                      <span class="radio-checkmark"></span>\r\n\
                    </label>\r\n\
                  </div>\r\n\
                  <div class="rowCenter" style="height:20px;">\r\n\
                    <label align="left"class="checkbox-container">\r\n\
                      <input type="radio" name="wan_port_select" id="wan_port_multiG" value="MultiG">\r\n\
                      <span mlang="MWAN_003"></span>\r\n\
                      <span class="radio-checkmark"></span>\r\n\
                    </label>\r\n\
                  </div>\r\n\
                  <div class="rowCenter" style="height: 10px;"></div>\r\n\
                      ...
                      <td>\r\n\
                        <table style="table-layout: fixed; border-spacing: 0px;">\r\n\
                          ...
                          <tr id="oldPasswordTr">\r\n\
                            ...
                            <td width="30%" align="left" class="wizardTd"><input class="input1" type="password" name="sysOldPasswd" id="sys_old_passwd" size="22" maxlength="32" autocomplete="new-password"></td>\r\n\
                            <td width="40%" align="left" class="wizardTd"></td>\r\n\
                          </tr>\r\n\
                          <tr>\r\n\
                            ...
                            <td width="70%" class="wizardTd" align="left" colspan="2" ><div style="border-radius:30px; background-color:#D3D3D3; font-size:11px">\r\n\
                              <table style="width:100%">\r\n\
                                ...
                                <tr>\r\n\
                                  ...
                                  <td width="95%" colspan="2" align="left" style="height:22px" mlang="PWD001"></td>\r\n\
                                </tr>\r\n\
                                <tr>\r\n\
                                  ...
                                  <td width="95%" align="left" mlang="PCVP_036"></td>\r\n\
                                </tr>\r\n\
                                <tr>\r\n\
                                  <td width="5%" class="wizardTd" align="left"><img id="weak_password_rule1_2" src="images/DDNS_Yes.png" style="display: none;padding-left:20px;height:75%"><img id="weak_password_rule1_2_gray" src="images/DDNS_Yes_gray.png" style="display: table-cell;padding-left:20px;height:75%"></td>\r\n\
                                  <td width="95%" align="left" mlang="PCVP_037"></td>\r\n\
                                </tr>\r\n\
                              </table>\r\n\
                            </td>\r\n\
                          </tr>\r\n\
                          <tr>\r\n\
                            ...
                            <td width="30%" align="left" class="wizardTd"><input class="input1" type="password" name="sysConfirmPasswd" id="sys_confirm_passwd" size="22" maxlength="32" autocomplete="new-password"></td>\r\n\
                            <td width="40%" align="left" class="wizardTd"></td>\r\n\
                          </tr>\r\n\
                          <tr>\r\n\
                            <td colspan=2>&nbsp;</td>\r\n\
          ...
          case 'applySetting-page':
              ...
              case 'wifiSetup-page':
                  newDiv = '<div class="form-group" align="center" style="height:700px;text-align: center;width:70%;margin: 10px auto;overflow:auto;scrolling:auto"> \r\n\
                  ...
                  <div id="wiz_region_list">\r\n\
                    <div class="form-row" align="left">\r\n\
                      <span mlang="SWS019" >Region:</span>\r\n\
                    </div>\r\n\
                    <div class="from-row" style="display:none">\r\n\
                      <select id="wirelessRegion" nowrap="nowrap" name="country" size="1">\r\n\
                        <option value="0" mlang="SWS014">Select Region</option>\r\n\
                        <option value="AF" mlang="SWS003" >Africa</option>\r\n\
                        <option value="TH" mlang="SWS004" >Asia</option>\r\n\
                        <option value="AU" mlang="SWS005" >Australia</option>\r\n\
                        <option value="CA" mlang="SWS006" >Canada</option>\r\n\
                        <option value="CN" mlang="PCVP_046" >China</option>\r\n\
                        <option value="EU" mlang="SWS007" >Europe</option>\r\n\
                        <option value="IN" mlang="3G32" >India</option>\r\n\
                        <option value="IL" mlang="SWS008" >Israel</option>\r\n\
                        <option value="JP" mlang="SWS009" >Japan</option>\r\n\
                        <option value="KO" mlang="SWS010" >Korea</option>\r\n\
                        <option value="MY" mlang="3G35" >Malaysia</option>\r\n\
                        <option value="MX" mlang="SWS012" >Mexico</option>\r\n\
                        <option value="DZ" mlang="SWS082" >Middle East(Algeria/Syria/Yemen)</option>\r\n\
                        <option value="QA" mlang="SWS083" >Middle East(Iran/Lebanon/Qatar)</option>\r\n\
                        <option value="KW" mlang="PCVP_047" >Middle East(Egypt/Tunisia/Kuwait)</option>\r\n\
                        <option value="TR" mlang="PCVP_048" >Middle East(Turkey)</option>\r\n\
                        <option value="AE" mlang="PCVP_049" >United Arab Emirates</option>\r\n\
                        <option value="RU" mlang="3G43" >Russia</option>\r\n\
                        <option value="SG" mlang="3G44" >Singapore</option>\r\n\
                        <option value="BR" mlang="SWS013" >South America</option>\r\n\
                        <option value="TW" mlang="3G49" >Taiwan</option>\r\n\
                        <option value="US" mlang="SWS015" >United States</option>\r\n\
                        <option value="HK" mlang="3G30" >Hong Kong</option>\r\n\
                        <option value="VN" >Vietnam</option>\r\n\
                      </select>\r\n\
                    </div>\r\n\
                    <div class="from-row">\r\n\
                    <select id="wireless_region" nowrap="nowrap" size="1">\r\n\
                      <option value="0" mlang="SWS014">Select Region</option>\r\n\
                      <option value="Africa" mlang="SWS003" >Africa</option>\r\n\
                      <option value="Asia" mlang="SWS004" >Asia</option>\r\n\
                      <option value="Australia" mlang="SWS005" >Australia</option>\r\n\
                      <option value="Canada" mlang="SWS006" >Canada</option>\r\n\
                      <option value="China" mlang="PCVP_046" >China</option>\r\n\
                      <option value="Europe" mlang="SWS007" >Europe</option>\r\n\
                      <option value="India" mlang="3G32" >India</option>\r\n\
                      <option value="Israel" mlang="SWS008" >Israel</option>\r\n\
                      <option value="Japan" mlang="SWS009" >Japan</option>\r\n\
                      <option value="Korea" mlang="SWS010" >Korea</option>\r\n\
                      <option value="Malaysia" mlang="3G35" >Malaysia</option>\r\n\
                      <option value="Mexico" mlang="SWS012" >Mexico</option>\r\n\
                      <option value="Algeria" mlang="SWS082" >Middle East(Algeria/Syria/Yemen)</option>\r\n\
                      <option value="Iran" mlang="SWS083" >Middle East(Iran/Lebanon/Qatar)</option>\r\n\
                      <option value="Egypt" mlang="PCVP_047" >Middle East(Egypt/Tunisia/Kuwait)</option>\r\n\
                      <option value="Turkey" mlang="PCVP_048" >Middle East(Turkey)</option>\r\n\
                      <option value="Saudi" mlang="PCVP_049" >United Arab Emirates</option>\r\n\
                      <option value="Russia" mlang="3G43" >Russia</option>\r\n\
                      <option value="Singapore" mlang="3G44" >Singapore</option>\r\n\
                      <option value="South America" mlang="SWS013" >South America</option>\r\n\
                      <option value="Taiwan" mlang="3G49" >Taiwan</option>\r\n\
                      <option value="United States" mlang="SWS015" >United States</option>\r\n\
                      <option value="Hong Kong" mlang="3G30" >Hong Kong</option>\r\n\
                      <option value="Vietnam">Vietnam</option>\r\n\
                    </select>\r\n\
                    </div>\r\n\
                  </div>\r\n\
                  <table style="table-layout: fixed;width:80%; border-spacing: 0px;">\r\n\
                    <tbody>\r\n\
                        <tr>\r\n\
                          <td width="70%" align="left" class="input_field" mlang="genie_1115">2.4GHz Wireless Network Name (SSID):</td>\r\n\
                          <td width="100%" align="left" class="wizardTd"><input class="input1" type="text" name="wl_ssid" id="wl_ssid" size="32" maxlength="32"></td>\r\n\
                        </tr>\r\n\
                        <tr>\r\n\
                          <td width="30%" align="left" class="wizardTd appendColon" mlang="genie_1116">2.4GHz Wireless Network Password (Network Key): </td>\r\n\
                          <td width="50%" align="left" class="wizardTd"><input class="input1" type="password" name="wl_password" id="wl_password" size="22" maxlength="32"></td>\r\n\
                          <td width="0" align="left" id="Netgear_img" style="display: table-cell; white-space: nowrap; font-size: 20px;"><img style="vertical-align:middle; width:20px;height:20px" src="images/pwdEyeSlash.png" id="pwd_display" onclick="onClick_pwdEye(\'wl_password\',\'pwd_display\');"></td></tr>\r\n\
                        <tr id="5gssid">\r\n\
                          <td width="80%" align="left" class="input_field" mlang="genie_1117">5GHz Wireless Network Name (SSID):</td>\r\n\
                          <td width="80%" align="left" class="wizardTd"><input class="input1" type="text" name="wla_ssid" id="wla_ssid" size="32" maxlength="32"></td>\r\n\
                        </tr>\r\n\
                        <tr id="5gpass">\r\n\
                          <td width="30%" align="left" class="wizardTd appendColon" mlang="genie_1118">5GHz Wireless Network Password (Network Key): </td>\r\n\
                          <td width="30%" align="left" class="wizardTd"><input class="input1" type="password" name="wla_password" id="wla_password" size="22" maxlength="32"></td>\r\n\
                          <td width="40%" align="left" id="Netgear_img" style="display: table-cell; white-space: nowrap; font-size: 12px; color: green;"><img style="vertical-align:middle; width:20px;height:20px" src="images/pwdEyeSlash.png" id="pwd_an_display" onclick="onClick_pwdEye(\'wla_password\',\'pwd_an_display\');"></td>\r\n\
                        </tr>\r\n\
                        <tr>\r\n\
                          <td width="80%" align="left" class="input_field" mlang="WL6G_004">6GHz Wireless Network Name (SSID):</td>\r\n\
                          <td width="80%" align="left" class="wizardTd"><input class="input1" type="text" name="wla_6g_ssid" id="wla_6g_ssid" size="32" maxlength="32"></td>\r\n\
                        </tr>\r\n\
                        <tr>\r\n\
                          <td width="30%" align="left" class="wizardTd appendColon" mlang="WL6G_005">6GHz Wireless Network Password (Network Key): </td>\r\n\
                          <td width="30%" align="left" class="wizardTd"><input class="input1" type="password" name="wla_6g_password" id="wla_6g_password" size="22" maxlength="32"></td>\r\n\
                          <td width="40%" align="left" id="Netgear_img" style="display: table-cell; white-space: nowrap; font-size: 12px; color: green;"><img style="vertical-align:middle; width:20px;height:20px" src="images/pwdEyeSlash.png" id="pwd_6g_display" onclick="onClick_pwdEye(\'wla_6g_password\',\'pwd_6g_display\');"></td>\r\n\
                        </tr>\r\n\
                      </tbody>\r\n\
                    </table>\r\n\
                  <div style="margin-left: 0%; margin-right: auto; max-width: 80%; text-align: left;" id="samediv">\r\n\
          ...
          case 'congratulations-page':
              newDiv = '<div class="form-group" id="card-orbi-config-complete" style="margin:auto;overflow:auto;scrolling:auto;display: table;"> \r\n\
                <div class="rowCenter" style="height: 20px;">\r\n\
                ...
                <div class="rowCenter" style="height:20px;" align="left">\r\n\
                   <div style="display: inline-block;font-size: 14px;font-family: Arial, Helvetica, sans-serif;min-width: 300px;text-align: left;padding-bottom: 5px;">\r\n\
                    <span mlang="WL6G_004"></span>\r\n\
                  </div>\r\n\
                  <div style="display: inline-block;">\r\n\
                    <span name="ssid_6g" id="wifi_6g_ssid_info"></span>\r\n\
                  </div>\r\n\
                </div>\r\n\
                <div class="rowCenter" style="height:20px;" align="left">\r\n\
                   <div style="display: inline-block;font-size: 14px;font-family: Arial, Helvetica, sans-serif;min-width: 300px;text-align: left;padding-bottom: 5px;">\r\n\
                  ...
                  <div style="display: inline-block;">\r\n\
                    <span name="key_6g" id="wifi_6g_pwd_info"></span>\r\n\
                  </div>\r\n\
                </div>\r\n\
                <div class="rowCenter" style="height:25px;"></div>\r\n\
                <div id="pls_wait_div" class="rowCenter wifiLoading" style="height:25px; display: block;">\r\n\
                    <div class="rowCenter"><p style="display: inline-block;font-size: 14px;font-family: Arial, Helvetica, sans-serif;min-width: 300px;text-align: right;padding-bottom: 5px;" align="center" mlang="D-genie_93">please wait a few seconds ...</p></div>\r\n\
                </div>\r\n\
                <div class="rowCenter">\r\n\
                    <div class="waitWifiSetting" style="display: none; float: left; min-width: 300px;">\r\n\
                   <button class = "button-sty1" id="print_cred" onclick="onclick_window_print();" mlang="genie_102">Print this</button>\r\n\
                  </div>\r\n\
              ...
              break;
          case 'ip_conflict-page':
              newDiv = '<div id="card-important-udpate" class="form-group install-card"> \r\n\
                        <div class="form-row" style="padding-bottom:24px;">\r\n\
                          <img class="netgear-logo" src="images/netgear.svg">\r\n\
                          <span style="font-size:30px;color:black; margin-right:8px;"> Nighthawk® <?= getModelNameStr()?></span>\r\n\
                        </div>\r\n\
                        <div class="form-row"  style="font-size:22px; padding-bottom: 20px;">\r\n\
                          <span mlang="OTH004">Important Update</span>\r\n\
                        </div>\r\n\
                        <div class="form-row" style="font-size:14px; padding-bottom: 20px;">\r\n\
                          <span mlang="OTH009">To avoid a conflict with your Internet Service Provider, your router\'s IP address has been updated to </span>\r\n\
                          <span><b class="js_ip"></b>.</span>\r\n\
                        </div>\r\n\
                        <div  class="form-row">\r\n\
                          <button type="Button" value="Next" name="next" id="next" class="button-cancel cancel_bt" mlang="OTH011">Next</button>\r\n\
                        </div>\r\n\
                      </div>\r\n';
              break;
      }
  ...
  function addWizardPages()
  {
      ...
      addWizardPage("autoWanPortDetect-page");
      addWizardPage("wanPreference-page");
      ...
      addWizardPage("ip_conflict-page");
  ...
  function afterIpConflict(ip)
  {
    $(".js_ip").text(ip);
    fetchData('target', 'clearIpConflict', '', '');
  }

  function onclick_window_print()
  {
      if(findCurrentPage() == 'congratulations-page')
          window.print();
