...
{
    global $ssid_2g, $ssid_5g, $ssid_5g1, $ssid_6g;
    global $guest_ssid_2g, $guest_ssid_5g, $guest_ssid_5g1, $guest_6g;
    ...
    if(strpos($if_path,"WiFi") !== FALSE)
    {
        ...
        else if(strpos($if_path,"SSID.{$ssid_6g}") !== FALSE)
        {
            return "WL6G_002";// 6G
        }
        ...
        else if(strpos($if_path,"SSID.{$guest_ssid_6g}") !== FALSE)
        {
            return "WL6G_003";//Guest 6G
        }
    }
...
function getDevNameFromD2Cli($mac)
{
    $dev_name  = "";
    $cmd_str= "pudil -F {$mac}";
    $res = exec($cmd_str);
    if($res != "")
    {
        $d2_deviceidlist = explode(chr(0x1E),$res);
        $displayNameCustom  = $d2_deviceidlist[0];
        $displayNameDPI     = $d2_deviceidlist[1];
        $displayNameNetgear = $d2_deviceidlist[2];
