<?
  ...
  $data->oneG = (object) null;
  $data->oneG->value = getCheckboxVal_InternetPort();
  $data->oneG->type = 'checkbox';

  $data->multiG = (object) null;
  $data->multiG->value = getCheckboxVal_MultigigPort();
  $data->multiG->type = 'checkbox';
  ...
  $data->wifi6g = (object) null;
  $data->wifi6g->value = getCheckboxVal_wifi6g();
  $data->wifi6g->type = 'checkbox';

  $data->wanPort = (object) null;
  $data->wanPort->value = getWanPort();
  $data->wanPort->type = 'checkbox';

  $data->isLacpEnabled = (object) null;
  $data->isLacpEnabled->value = getLacpEnable();
  $data->isLacpEnabled->type = 'checkbox';

  $data->internetPortStatus = (object) null;
  $data->internetPortStatus->value = getInternetPortStatus();
