...
*/
  ...
  $data->{'6GEnableGuest'} = (object) null;
  $data->{'6GEnableGuest'}->value = getCheckboxVal_6gEnableGuest();
  $data->{'6GEnableGuest'}->type = 'checkbox';

  $data->{'6GSsidBroadcast'} = (object) null;
  $data->{'6GSsidBroadcast'}->value = getCheckboxVal_6gGuestSsidBroadcast();
  $data->{'6GSsidBroadcast'}->type = 'checkbox';

  $data->{'6GAllowAccessLocal'} = (object) null;
  $data->{'6GAllowAccessLocal'}->value = getCheckboxVal_6gGuestAllowAccessLocal();
  $data->{'6GAllowAccessLocal'}->type = 'checkbox';

  $data->{'6GSsid'} = (object) null;
  $data->{'6GSsid'}->value = getTextVal_6gGuestSsid();
  $data->{'6GSsid'}->type = 'input';

  $data->{'6GSecurity'} = (object) null;
  $data->{'6GSecurity'}->value = getRadioVal_6gGuestSecurity();
  $data->{'6GSecurity'}->type = 'radio';

  $data->{'6GPassword'} = (object) null;
  $data->{'6GPassword'}->value = getTextVal_6gGuestPasswd();
  ...
  $data->{'6GMainSsid'} = (object) null;
  $data->{'6GMainSsid'}->value = getTextVal_6gSsid();
