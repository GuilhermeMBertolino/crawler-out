<?
  ...
  $data->{'6GOfdma'} = (object) null;
  $data->{'6GOfdma'}->value = getCheckboxVal_6GOfdma();
  $data->{'6GOfdma'}->type = 'checkbox';
...
*/
  ...
  $data->{'6GSsidBroadcast'} = (object) null;
  $data->{'6GSsidBroadcast'}->value = getCheckboxVal_6gSsidBroadcast();
  $data->{'6GSsidBroadcast'}->type = 'checkbox';

  $data->{'6GSsid'} = (object) null;
  $data->{'6GSsid'}->value = getTextVal_6gSsid();
  $data->{'6GSsid'}->type = 'input';

  $data->{'6GChannel'} = (object) null;
  $data->{'6GChannel'}->value = getSelectVal_6gChannel();
  $data->{'6GChannel'}->type = 'select';

  $data->{'6GMode'} = (object) null;
  $data->{'6GMode'}->value = getSelectVal_6gMode();
  $data->{'6GMode'}->type = 'select';

  $data->{'6GSecurity'} = (object) null;
  $data->{'6GSecurity'}->value = getRadioVal_6gSecurity();
  $data->{'6GSecurity'}->type = 'radio';

  $data->{'6GPassword'} = (object) null;
  $data->{'6GPassword'}->value = getTextVal_6gPasswd();
  $data->{'6GPassword'}->type = 'input';

  $data->{'6GEncryptMode'} = (object) null;
  $data->{'6GEncryptMode'}->value = getSelectVal_6gEncryptMode();
  $data->{'6GEncryptMode'}->type = 'select';

  $data->{'6GGroupKeyInt'} = (object) null;
  $data->{'6GGroupKeyInt'}->value = getTextVal_6gGroupKey();
  //$data->{'6GGroupKeyInt'}->type = 'radio';

  $data->{'6GRadiusIP'} = (object) null;
  $data->{'6GRadiusIP'}->value = getIpVal_6gRadiusIP();
  $data->{'6GRadiusIP'}->type = 'ip';
  $data->{'6GRadiusIP'}->idStr_prefix = 'radius_ipaddress';
  $data->{'6GRadiusIP'}->idStr_postfix = '_6g';

  $data->{'6GRadiusPort'} = (object) null;
  $data->{'6GRadiusPort'}->value = getTextVal_6gRadiusPort();
  $data->{'6GRadiusPort'}->type = 'input';

  $data->{'6GRadiusSecret'} = (object) null;
  $data->{'6GRadiusSecret'}->value = getTextVal_6gRadiusSecret();
  $data->{'6GRadiusSecret'}->type = 'input';
...
*/
  ...
  $data->{'6GBandwidth'} = (object) null;
  $data->{'6GBandwidth'}->value = db_get("Device.WiFi.Radio.{$radio_6g}.OperatingChannelBandwidth");
  $data->{'6GBandwidth'}->type = 'nopost';
  ...
  $data->{'6GGuestSsid'} = (object) null;
  $data->{'6GGuestSsid'}->value = getTextVal_6gGuestSsid();
  ...
  $data->{'enable6GAX256QAM'} = (object) null;
  $data->{'enable6GAX256QAM'}->value = getEnable6GAX256QAM();
