...
function getWMM_Status($wifiType)
{
	...
	{
		$Wmm2G = db_get("Device.WiFi.AccessPoint.{$ap_2g}.WMMEnable");
		return num_to_TrueFalse($Wmm2G);
	}
	else if ($wifiType == 1) 
	{
		$Wmm5G = db_get("Device.WiFi.AccessPoint.{$ap_5g}.WMMEnable");
		return num_to_TrueFalse($Wmm5G);
	}
	else if ($wifiType == 2) 
	{
		$Wmm6G = db_get("Device.WiFi.AccessPoint.{$ap_6g}.WMMEnable");
		return num_to_TrueFalse($Wmm6G);
	}
}
