      ...
      switch(pageId)
      {
          ...
          case 'internetDetectSuccess-page':
              newDiv = '<div class="form-group" align="center" style="overflow:auto;scrolling:auto"> \r\n\
                    ...
                    <div class="rowCenter">\r\n\
                        <img src="images/RAX30_PRODUCT-FRONT.png">\r\n\
                    </div>\r\n\
                    <div class="rowCenter" style="height: 10px;"></div>\r\n\
                    <div class="rowCenter">\r\n\
              ...
              newDiv = '<div class="form-group" style="margin:auto;overflow:auto;scrolling:auto;display: table;"> \r\n\
                ...
                <div class="rowCenter" style="height:20px;" align="left">\r\n\
                  ...
                  <div style="display: inline-block;width:340px;background:url(images/roundedcornr_input.gif) no-repeat left; line-height: 40px;">\r\n\
                    <input type="text" name="pppoe_username" id="pppoe_name" style="width:150px;position:relative; margin-left:20px; height:18px; box-sizing: border-box; padding: 1px 2px; border-radius: 1px;" size="15" maxlength="63" value="">\r\n\
                  </div>\r\n\
                </div>\r\n\
                <div class="rowCenter" style="height:20px;" align="left">\r\n\
                   <div style="display: inline-block;font-size: 16px;font-family: Arial, Helvetica, sans-serif;min-width: 200px;text-align: left; line-height: 40px;">\r\n\
                  ...
                  <div style="display: inline-block;width:340px;background:url(images/roundedcornr_input.gif) no-repeat left; line-height: 45px;">\r\n\
                    <input type="password" name="pppoe_passwd" id="pppoe_password" style="width:150px;position:relative; margin-left:20px; height:18px; box-sizing: border-box; padding: 1px 2px; border-radius: 1px;" size="15" maxlength="63" value="" autocomplete="new-password">\r\n\
                  </div>\r\n\
                </div>\r\n\
                <div class="rowCenter" style="height:25px;"></div>\r\n\
          ...
          case 'applySetting-page':
              ...
              break;
          case 'wifiSetup-page':
              newDiv = '<div class="form-group" style="text-align: center;height:auto;width:60%;min-height: 360px;margin: 10px auto;overflow: auto;">\r\n\
                    ...
                    <div class="wifi_content" style="width: 80%; margin-left: auto; margin-right: auto;">\r\n\
                      ...
                      <label for="wl_ssid" class="input_label" mlang="genie_1115"></label>\r\n\
                      </div>\r\n\
                      <div class="input_row">\r\n\
                      <input class="input_field" style="padding-top: 10px;" type="password" name="wl_password" placeholder="Password" id="wl_password" maxlength="64" value="">\r\n\
                      <label for="wl_password" class="input_label" mlang="genie_1116"></label>\r\n\
                      ...
                      <label for="wla_ssid" class="input_label" mlang="genie_1117"></label>\r\n\
                      </div>\r\n\
                      ...
                      <label for="wla_password" class="input_label" mlang="genie_1118"></label>\r\n\
