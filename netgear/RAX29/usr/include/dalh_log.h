 ...
 */
#define DALH_LOG_DEBUG 1
#define DALH_LOG_INFO 2
#define DALH_LOG_WARNING 3
#define DALH_LOG_ERROR 4
#define DALH_LOG_SILENT 5 /** only for declaring __log_level - no debug output */
 ...
 */
#define log_debug(...) log(DALH_LOG_DEBUG, __VA_ARGS__)
#define log_info(...) log(DALH_LOG_INFO, __VA_ARGS__)
#define log_warning(...) log(DALH_LOG_WARNING, __VA_ARGS__)
#define log_error(...) log(DALH_LOG_ERROR, __VA_ARGS__)
...
/** default log level have to be declared somewhere: DALH_LOG_DEBUG, DALH_LOG_INFO,
 * DALH_LOG_WARNING, DALH_LOG_ERROR, DALH_LOG_SILENT */
