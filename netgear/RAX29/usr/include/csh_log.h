 ...
 *
 * Filename:	csh_log.h
 * Purpose:		logging functionality for the csh process
 ...
 */
#define CSH_LOG_DEBUG    1
#define CSH_LOG_INFO    2
#define CSH_LOG_WARNING    3
#define CSH_LOG_ERROR    4
#define CSH_LOG_SILENT    5 /** only for declaring __log_level - no debug output */
 ...
 */
#define log_debug(...) log(CSH_LOG_DEBUG, __VA_ARGS__)
#define log_info(...) log(CSH_LOG_INFO, __VA_ARGS__)
#define log_warning(...) log(CSH_LOG_WARNING, __VA_ARGS__)
#define log_error(...) log(CSH_LOG_ERROR, __VA_ARGS__)
...
/** default log level have to be declared somewhere: CSH_LOG_DEBUG, CSH_LOG_INFO,
 * CSH_LOG_WARNING, CSH_LOG_ERROR, CSH_LOG_SILENT */
