 ...
 */
#define DIL_LOG_DEBUG   1
#define DIL_LOG_INFO    2
#define DIL_LOG_WARNING 3
#define DIL_LOG_ERROR   4
#define DIL_LOG_SILENT  5 /** only for declaring __log_level - no debug output */
 ...
 */
#define log_debug(...) log(DIL_LOG_DEBUG, __VA_ARGS__)
#define log_info(...) log(DIL_LOG_INFO, __VA_ARGS__)
#define log_warning(...) log(DIL_LOG_WARNING, __VA_ARGS__)
#define log_error(...) log(DIL_LOG_ERROR, __VA_ARGS__)
