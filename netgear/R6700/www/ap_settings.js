...
var StartChannel = new Array(<%4582%>);
var FinishChannel = new Array(<%4583%>);
...
var curr_region = "<%20%>"
var curr_channel_5g_value = "<%1989%>"
var curr_channel_2g_value = "<%1969%>"
...
{
    var cf = document.forms[0];
    cf.w_channel.options[0].text = "<%43%>";
...
{
    var cf = document.forms[0];
    cf.w_channel_5g.options[0].text = "<%43%>";
...
function setOpMode_24g_psr()
{
    ...
    if ((sec_type_2G == "None") || (sec_type_2G == "WPA2-PSK")|| (sec_type_2G == "WPA-AUTO-PSK"))
    {
        ...
        cf.opmode.options[0].text = "<%4588%>";
        cf.opmode.options[1].text = "<%4589%>";
