...
if [ "$dev" = "3" -o "$dev" = "4" -o "$dev" = 5 -o\
 ...
 "$dev" = "16" -o "$dev" = "17"  -o "$dev" = "18"  -o "$dev" = "19" ];then
SDK_TYPE=OPENWRT
...
#2) check Platform
if [ "$dev" = "6" -o "$dev" = "7" -o "$dev" = "8" -o "$dev" = "12" -o "$dev" = "16" -o "$dev" = "17"];then
PLATFORM=MT7622
LAN_INTF=eth0
WAN_INTF=eth1
if [ "$dev" = "12" -o "$dev" = "16" -o "$dev" = "17" -o "$dev" = "18" -o "$dev" = "19" ]; then
...
if [ "$dev" = "1" -o "$dev" = "3" -o "$dev" = "7" -o "$dev" = "9" -o "$dev" = "11" -o "$dev" = "15" -o "$dev" = "19" ];then
DBDC_MODE=1
fi
