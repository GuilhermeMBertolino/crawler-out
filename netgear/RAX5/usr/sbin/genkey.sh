...
export EASYRSA_PKI="/etc/reserve-data/pki"
...
export EASYRSA_CERT_EXPIRE=7300 # Jinjuan Pei, 20220316, Per spec, Certificate expiration time is 20 years.
export EASYRSA_KEY_SIZE=1024

export ROOT_PATH="/etc/reserve-data"
...
/usr/sbin/easyrsa-v3.0.6/easyrsa init-pki && openssl rand -out /etc/reserve-data/pki/.rnd -hex 256
