...
function _M.send_content(out, res_iter, write_method)
   ...
   while ok and res do
      write(out, res)
      --[[++PEGA++]]
      --[[take off flush for process freezing]]
   ...
   --[[++PEGA++]]
   --[[add return for checking response sent]]
   return ok
   --[[--PEGA--]]
end
...
function _M.send_output(out, status, headers, res_iter, write_method, res_line)
   ...
   --[[++PEGA++]]
   --[[add return for checking response sent]]
   return _M.send_content(out, res_iter, write_method)
   --[[--PEGA--]]
end
...
function _M.run(app, t)
   ...
   if ok then
     ...
     --[[++PEGA++]]
     --[[add return for checking response sent]]
     return _M.send_output(t.output, status, headers, res_iter, t.write_method, t.http_response)
     --[[--PEGA--]]
   else
