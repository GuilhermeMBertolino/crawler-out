...
mtkwifi.ChannelList_6G_All = {
    ...
    {channel= 1  , text="Channel  1   (5.180 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 5  , text="Channel  5   (5.200 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 9  , text="Channel  9   (5.220 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 13 , text="Channel  13  (5.240 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 17 , text="Channel  17  (5.260 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 21 , text="Channel  21  (5.280 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 25 , text="Channel  25  (5.300 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 29 , text="Channel  29  (5.180 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 33 , text="Channel  33  (5.200 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 37 , text="Channel  37  (5.220 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 41 , text="Channel  41  (5.240 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 45 , text="Channel  45  (5.260 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 49 , text="Channel  49  (5.280 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 53 , text="Channel  53  (5.300 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 57 , text="Channel  57  (5.240 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 61 , text="Channel  61  (5.260 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 65 , text="Channel  65  (5.280 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 69 , text="Channel  69  (5.300 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 73 , text="Channel  73  (5.180 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 77 , text="Channel  77  (5.200 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 81 , text="Channel  81  (5.220 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 85 , text="Channel  85  (5.240 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 89 , text="Channel  89  (5.260 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 93 , text="Channel  93  (5.280 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 97 , text="Channel  97  (5.300 GHz)", region={[0]=1, [1]=1, [5]=1, [6]=1, [7]=1}},
    {channel= 101, text="Channel  101 (5.240 GHz)", region={[0]=1, [2]=1, [7]=1}},
    {channel= 105, text="Channel  105 (5.260 GHz)", region={[0]=1, [2]=1, [7]=1}},
    {channel= 109, text="Channel  109 (5.280 GHz)", region={[0]=1, [2]=1, [7]=1}},
    {channel= 113, text="Channel  113 (5.280 GHz)", region={[0]=1, [2]=1}},
    {channel= 117, text="Channel  117 (5.280 GHz)", region={[0]=1, [2]=1}},
    {channel= 121, text="Channel  121 (5.240 GHz)", region={[0]=1, [3]=1}},
    {channel= 125, text="Channel  125 (5.260 GHz)", region={[0]=1, [3]=1}},
    {channel= 129, text="Channel  129 (5.280 GHz)", region={[0]=1, [3]=1}},
    {channel= 133, text="Channel  133 (5.280 GHz)", region={[0]=1, [3]=1}},
    {channel= 137, text="Channel  137 (5.280 GHz)", region={[0]=1, [3]=1}},
    {channel= 141, text="Channel  141 (5.240 GHz)", region={[0]=1, [3]=1}},
    {channel= 145, text="Channel  145 (5.260 GHz)", region={[0]=1, [3]=1}},
    {channel= 149, text="Channel  149 (5.280 GHz)", region={[0]=1, [3]=1}},
    {channel= 153, text="Channel  153 (5.280 GHz)", region={[0]=1, [3]=1}},
    {channel= 157, text="Channel  157 (5.280 GHz)", region={[0]=1, [3]=1}},
    {channel= 161, text="Channel  161 (5.240 GHz)", region={[0]=1, [3]=1}},
    {channel= 165, text="Channel  165 (5.260 GHz)", region={[0]=1, [3]=1}},
    {channel= 169, text="Channel  169 (5.280 GHz)", region={[0]=1, [3]=1}},
    {channel= 173, text="Channel  173 (5.280 GHz)", region={[0]=1, [3]=1}},

    {channel= 177, text="Channel  177 (5.280 GHz)", region={[0]=1, [3]=1}},
    {channel= 181, text="Channel  181 (5.240 GHz)", region={[0]=1, [3]=1}},
    {channel= 185, text="Channel  185 (5.260 GHz)", region={[0]=1, [3]=1}},
    {channel= 189, text="Channel  189 (5.280 GHz)", region={[0]=1, [4]=1}},
    {channel= 193, text="Channel  193 (5.280 GHz)", region={[0]=1, [4]=1}},
    {channel= 197, text="Channel  197 (5.280 GHz)", region={[0]=1, [4]=1}},
    {channel= 201, text="Channel  201 (5.240 GHz)", region={[0]=1, [4]=1}},
    {channel= 205, text="Channel  205 (5.260 GHz)", region={[0]=1, [4]=1}},
    {channel= 209, text="Channel  209 (5.280 GHz)", region={[0]=1, [4]=1}},
    {channel= 213, text="Channel  213 (5.280 GHz)", region={[0]=1, [4]=1}},
    {channel= 217, text="Channel  217 (5.280 GHz)", region={[0]=1, [4]=1}},
    {channel= 221, text="Channel  221 (5.240 GHz)", region={[0]=1, [4]=1}},
    {channel= 225, text="Channel  225 (5.260 GHz)", region={[0]=1, [4]=1}},
    {channel= 229, text="Channel  229 (5.280 GHz)", region={[0]=1, [4]=1}},
    {channel= 233, text="Channel  233 (5.280 GHz)", region={[0]=1, [4]=1}},
}
    ...
    for _,line in ipairs(mtkwifi.__lines(content)) do
        ...
        if string.byte(line) ~= string.byte("#") then
            ...
            if band then
                ...
                local security = string.match(bssLineStr, "0x%d+ 0x%d+")
                tmp[alMac][band][bssInfoIdx]['authMode'] = security:sub(1,6)
                tmp[alMac][band][bssInfoIdx]['encType'] = security:sub(8,13)
                local newBssLineStr = string.match(bssLineStr, "0x%d+ %S.*")
                local updateBssLineStr = string.gsub(newBssLineStr, "0x%d+ 0x%d+%s", "")
