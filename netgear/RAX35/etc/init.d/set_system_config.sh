...
tune_network_parameters()
{
	...
	if [ -n "$CONFIG_TARGET_LANTIQ_XRX500" ]; then
		...
		#20190219, According to Spec, we need to support maximum session to 65536.
		#sysctl -w net.netfilter.nf_conntrack_max="65536"
		sysctl -w net.ipv4.netfilter.ip_conntrack_udp_timeout="300"
		sysctl -w net.ipv4.netfilter.ip_conntrack_udp_timeout_stream="300"
		sysctl -w net.netfilter.nf_conntrack_expect_max="100"
	fi
