...
#<<PEGA KKHuang: Add for 2.4GHz AX mode 256QAM only
UBOOT_ENV_MODEL=/proc/environment/model
if  [ -e $UBOOT_ENV_MODEL ]; then
    MODEL="$(cat $UBOOT_ENV_MODEL)"
    if [ "$MODEL" == "RAX28" ];  then
        WIFI_BOARDFLAGS4=`nvram kget sb/0/boardflags4`
        ...
        if [ $IS256QAM -eq 0 ];  then
            ...
            nvram kset sb/0/boardflags4=0x$NEW_WIFI_BOARDFLAGS4_IN_HEX
            nvram kcommit
            sync
        fi
    fi
...
#<<PEGA JYang, update TSSI / 2.4G gain parameters
nvram kset sb/0/agbg0=0
nvram kset sb/0/agbg1=0
nvram kset sb/0/aga0=0
nvram kset sb/0/aga1=0

# We will keep 1st parameter of 2G PA nvram
# because it be changed by PA traning at MFG
pa2ga0_params="0xb024,0x102a,0x21dc"
pa2g40a0_params="0xcf4b,0x58ab,0x28f4"
pa2ga1_params="0xaf53,0x0ef5,0x21b6"
pa2g40a1_params="0xbfd6,0x36dd,0x2662"

envrams

param_1=`envram get sb/0/pa2ga0 | cut -d "," -f1`
new_value=`echo $param_1,$pa2ga0_params`
nvram kset sb/0/pa2ga0=$new_value

param_1=`envram get sb/0/pa2g40a0 | cut -d "," -f1`
new_value=`echo $param_1,$pa2g40a0_params`
nvram kset sb/0/pa2g40a0=$new_value

param_1=`envram get sb/0/pa2ga1 | cut -d "," -f1`
new_value=`echo $param_1,$pa2ga1_params`
nvram kset sb/0/pa2ga1=$new_value

param_1=`envram get sb/0/pa2g40a1 | cut -d "," -f1`
new_value=`echo $param_1,$pa2g40a1_params`
nvram kset sb/0/pa2g40a1=$new_value
