...
$TimeSynEnable = map("/device/time/timesyn/enable", "1", "true", "true", "true", "*", "false");
$DaylightSavingIsWorking = map("/runtime/time/datetimesyn", "GDT", "true", "*", "false");
...
if($TimeZone=="") $TimeZone = get("x", "/device/time/timezone");
...
$tzfile = fread("s", "/tmp/tzfile");
$tzfile = substr($tzfile, 0, strchr($tzfile, "\n")); //Remove "\n" character.
?>
<? if($Remove_XML_Head_Tail != 1)	{HTML_hnap_xml_header();}?>
      ...
      <TimeSynEnable><?=$TimeSynEnable?></TimeSynEnable>
      <DaylightSavingIsWorking><?=$DaylightSavingIsWorking?></DaylightSavingIsWorking>
      <tzfile><?=$tzfile?></tzfile>
