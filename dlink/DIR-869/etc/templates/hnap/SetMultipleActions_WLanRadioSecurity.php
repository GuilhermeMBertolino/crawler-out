...
function bsd_wifisecurity_from_24g($wlan, $src)
{
	...
	TRACE_debug("bsd_wifisecurity_from_24g: wlan=".$wlan);
	TRACE_debug("bsd_wifisecurity_from_24g: path_src_wifi=".$path_src_wifi);
	TRACE_debug("bsd_wifisecurity_from_24g: 24g_encrtype=".$24g_encrtype);
	TRACE_debug("bsd_wifisecurity_from_24g: 24g_authtype=".$24g_authtype);	
...
else
{
	...
	else
	{
		...
		if( $keyRenewal == "0" ) $keyRenewal = "3600";
...
{
	bsd_wifisecurity_from_24g($WLAN2, $WLAN1);
	if ($_GLOBALS['FEATURE_TRI_BAND'] == 1) bsd_wifisecurity_from_24g($WLAN3, $WLAN1);
}

if($smartconnect_gz_enable == 1)
{
	bsd_wifisecurity_from_24g($WLAN2_GZ, $WLAN1_GZ);
	if ($_GLOBALS['FEATURE_TRI_BAND'] == 1) bsd_wifisecurity_from_24g($WLAN3_GZ, $WLAN1_GZ);
}
