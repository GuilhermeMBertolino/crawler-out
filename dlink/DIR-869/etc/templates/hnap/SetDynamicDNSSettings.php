...
if(isdomain($DDNS4_Hostname)==0 || isdomain($DDNS4_ServerAddress)==0)	{$rlt = "ERROR";} // Prevent the security issue of Command Injection
...
if($rlt=="OK")
{
	...
	*/
	...
	else if($DDNS4_ServerAddress=="oray.cn")
	{
		$DDNS4_ServerAddress="ORAY";
		set("/ddns4/entry:1/oray-type",	"oray.cn");
	}
	else if($DDNS4_ServerAddress=="www.oray.com")
	{
		$DDNS4_ServerAddress="ORAY";
		set("/ddns4/entry:1/oray-type",	"www.oray.com");
	}
	//NOIP have 4 server address, we should save it's server address in order to distinguish them
	else if($DDNS4_ServerAddress=="noip.com")
	{
		$DDNS4_ServerAddress="NOIP";
		set("/ddns4/entry:1/noip-type",	"noip.com");
	}
	else if($DDNS4_ServerAddress=="noip.org")
	{
		$DDNS4_ServerAddress="NOIP";
		set("/ddns4/entry:1/noip-type",	"noip.org");
	}
	else if($DDNS4_ServerAddress=="no-ip.com")
	{
		$DDNS4_ServerAddress="NOIP";
		set("/ddns4/entry:1/noip-type",	"no-ip.com");
	}
	else if($DDNS4_ServerAddress=="no-ip.org")
	{
		$DDNS4_ServerAddress="NOIP";
		set("/ddns4/entry:1/noip-type",	"no-ip.org");
	}
	else if($DDNS4_ServerAddress=="www.noip.com")
	{
		$DDNS4_ServerAddress="NOIP";
		set("/ddns4/entry:1/noip-type",	"www.noip.com");
	}
	else												{$rlt="ERROR_SERVERADDRESS";}
