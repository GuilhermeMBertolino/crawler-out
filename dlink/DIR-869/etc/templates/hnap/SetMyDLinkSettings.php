...
function do_post($post_str, $post_url, $withcookie)
{
	...
	$head="https://";   //force using https to register
	$f_url = $head.$url;
...
{
	if(substr($language, 0, 2)=="de")	{$lang="de";}
	else if(substr($language, 0, 2)=="en")		{$lang="en";}
	else if(substr($language, 0, 2)=="es")	{$lang="es";}
	else if(substr($language, 0, 2)=="fr")	{$lang="fr";}
	else if(substr($language, 0, 2)=="it")	{$lang="it";}
	else if(substr($language, 0, 2)=="ko")	{$lang="ko";}
	else if(substr($language, 0, 2)=="pt")	{$lang="pt";}
	else if(substr($language, 0, 2)=="ru")	{$lang="ru";}
	else if($language=="zh-cn")				{$lang="zh_CN";}
	else if($language=="zh-tw")				{$lang="zh_TW";}
...
$language = query($nodebase."Language");
