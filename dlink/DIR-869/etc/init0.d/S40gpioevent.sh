...
#	event "STATUS.READY"		add "usockc /var/gpio_ctrl STATUS_GREEN"
	event "STATUS.READY"            add "null"
	event "STATUS.CRITICAL"		add "usockc /var/gpio_ctrl INET_AMBER"
...
#	event "STATUS.AMBER.BLINK.FAST"		add "usockc /var/gpio_ctrl STATUS_AMBER_BLINK_FAST"
	...
	event "BAND5G-2.LED.ON"         add "usockc /var/gpio_ctrl WIFI5_LED_ON"
	event "BAND5G-2.LED.OFF"        add "usockc /var/gpio_ctrl WIFI5_LED_OFF"
	...
	event "BRIDGE-1.CONNECTED"		insert "WANLED:phpsh /etc/scripts/update_wanled.php EVENT=BRIDGE_CONNECTED"
	event "BRIDGE-1.DISCONNECTED"		insert "WANLED:phpsh /etc/scripts/update_wanled.php EVENT=BRIDGE_DISCONNECTED"
