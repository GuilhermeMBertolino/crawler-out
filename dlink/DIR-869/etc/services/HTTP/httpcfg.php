...
function http_server($sname, $uid, $ifname, $af, $ipaddr, $port, $hnap, $mtfwu)
{
	$web_file_access = query("/webaccess/enable"); //jef add +   for support use shareport.local to access shareportmobile

	$tr069webcontrol = query("/tr069/external/enable_multilogin/enable"); //for support multi-login
	$mydlink_dbg = "1";//query("/mydlink/debug");
...
//jef -
	...
	if ($mtfwu==1 && $port==80)
	{
		if($uid=="LAN-1" || $uid=="BRIDGE-1")
		{
			echo
			"		Control".							"\n".
			"		{".									"\n".
			"			Alias /MTFWU".					"\n".
			"			Location /htdocs/MTFWU".		"\n".
			"			External".						"\n".
			"			{".								"\n".
			"				/usr/sbin/mtfwu { mtfwu }".	"\n".
			"			}".								"\n".
			"			IndexNames { index.mtfwu }".	"\n".
			"		}".									"\n";
		}
	}
	if($mydlink_dbg == "1")
	...
	if ($tr069webcontrol == "1")
  	{
          	echo
          	"       Control".                           "\n".
          	"       {".                                 "\n".
          	"           Alias /tr069login".             "\n".
     		"           Location /htdocs/web/tr069login".   "\n".
	        "                       IndexNames { index.php }".              "\n".
	        "       }".                                 "\n".
	        "       Control".                           "\n".
        	"       {".                                 "\n".
        	...
        	"               Control".                                                       "\n".
        	"               {".                                                                     "\n".
        	"                       Alias /dws/api/tr069Check".             "\n".
        	"                       Location /htdocs/web/tr069_authentication_check.cgi".   "\n".
        	"                       PathInfo On".                   "\n".
     	     	"                       External".                                              "\n".
        	"                       {".                                                             "\n".
	        "                               /htdocs/fileaccess.cgi { * }"."\n".
	        ...
	        "               Control".                                                       "\n".
	        "               {".                                                                     "\n".
	        "                       Alias /dws/api/tr069Login".                     "\n".
          	"                       Location /htdocs/web/tr069_authentication.cgi". "\n".
          	"                       External".                                              "\n".
          	"                       {".                                                             "\n".
          	"                               /htdocs/web/tr069_authentication.cgi { * }"."\n".
          	"                       }".                                                             "\n".
          	"               }".                                     "\n".
          	"               Control".                                                       "\n".
          	"               {".                                                                     "\n".
          	"                       Alias /dws/api/tr069Logout".                    "\n".
          	"                       Location /htdocs/web/tr069_authentication_logout.cgi".  "\n".
          	"                       External".                                              "\n".
          	"                       {".                                                             "\n".
          	"                               /htdocs/web/tr069_authentication_logout.cgi { * }"."\n".
          	"                       }".                                                             "\n".
          	"               }".                                     "\n";
  	}
	echo
...
$mtfwu = query("/runtime/device/mtfwu/enable"); /* Multi-firmware update */
...
foreach("/runtime/services/http/server")
{
	...
	if($ifname!="" || $ipaddr!="")
	{
		if ($af!="")
		{
			...
			{
				$have_http = 1;
				http_server($sname, $inf,$ifname,$af,$ipaddr,$port,$hnap,$mtfwu);
...
if($have_http==0)
{
	...
	$ver	= query("/runtime/device/firmwareversion");
	$sname	= "Linux, HTTP/1.1, ".$model." Ver ".$ver;	/* HTTP server name */
	http_server($sname, "BRIDGE-1","br0","inet","","80",1,$mtfwu);
}
?>
