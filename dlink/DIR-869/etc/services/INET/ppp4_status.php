...
if($STATUS == "connecting")	{
	...
	{
		echo "xmldbc -k autodetect\n";
		echo "xmldbc -t \"autodetect:70:event AUTODETECT\"\n";		/*After 70s, Check connection okay or not?*/
	}
}
...
if ($STATUS == "on demand")
{
	...
	/* prevent private ip on wan */
	echo "iptables -t nat -A POSTROUTING -o ppp0 -j MASQUERADE\n";
