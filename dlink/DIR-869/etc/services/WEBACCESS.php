...
function setup_wfa_account()
{
	...
	if($admin_disklist==""){$admin_disklist=",:::";}
		...
		startcmd("tpyrcrsu 2"); //Add for hide plain passwd,johnson
...
{                                     
    ...
    if(check_port_conflict("8081", "TCP")=="0")
    {
        set("/runtime/webaccess/public_ds_port", 8081);
        return;
    }
    if(check_port_conflict("8008", "TCP")=="0")
    {
        set("/runtime/webaccess/public_ds_port", 8008);
        return;
    }
    if(check_port_conflict("3128", "TCP")=="0")
    {
        set("/runtime/webaccess/public_ds_port", 3128);
        return;
    }
}
