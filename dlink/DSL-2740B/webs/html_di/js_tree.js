...
function ctCollapseTree (id, expandLevel)
{
...
function ctItemMouseUp (item)
{
	...
	else item.id = 'JSCookTreeFolderOpen';
...
var ctThemeXP1 =
{
	...
	// for each level of depth of the tree.
  	...
  	// HTML code to the left of a folder item
  	// first one is for folder closed, second one is for folder opened
	folderLeft: [['<img alt="" src="'+root+'disk.gif" />', '<img alt="" src="'+root+'disk.gif" />'],
				 ['<img alt="" src="'+root+'folder1.gif" />', '<img alt="" src="'+root+'folderopen1.gif" />']],
  	// HTML code to the right of a folder item
  	// first one is for folder closed, second one is for folder opened
  	folderRight: [['', '']],
	// HTML code for the connector
	...
	folderConnect: [[['',''],['','']],[['<img alt="" src="'+root+'plus.gif" />','<img alt="" src="'+root+'minus.gif" />'],
					 ['<img alt="" src="'+root+'plusbottom.gif" />','<img alt="" src="'+root+'minusbottom.gif" />']]],

	// HTML code to the left of a regular item
	itemLeft: ['<img alt="" src="'+root+'folder1.gif" />'],
	// HTML code to the right of a regular item
	itemRight: [''],
	// HTML code for the connector
	// first one is for w/ having next sibling, second one is for no next sibling
	itemConnect: [['',''],['<img alt="" src="'+root+'join.gif" />', '<img alt="" src="'+root+'joinbottom.gif" />']],

	// HTML code for spacers
	// first one connects next, second one doesn"t
	spacer: [['',''],['<img alt="" src="'+root+'line.gif" />', '<img width=19 height=16 alt="" src="'+root+'spacer.gif" />']],
