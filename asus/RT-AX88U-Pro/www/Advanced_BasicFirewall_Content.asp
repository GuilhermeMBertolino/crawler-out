...
add_option(document.form.KnownApps, "<#750#>", 0, 1);
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2475#></td></tr>';
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#425#></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,6);"><#2092#></a></th>
<td>
<input type="radio" value="1" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '1')" <% nvram_match("fw_enable_x", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '0')" <% nvram_match("fw_enable_x", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,7);"><#2090#></a></th>
<td>
<input type="radio" value="1" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '1')" <% nvram_match("fw_dos_x", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '0')" <% nvram_match("fw_dos_x", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th align="right"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,1);"><#2135#></a></th>
<td>
<select name="fw_log_x" class="input_option">
<option value="none" <% nvram_match("fw_log_x", "none","selected"); %>><#875#></option>
<option value="drop" <% nvram_match("fw_log_x", "drop","selected"); %>><#2937#></option>
<option value="accept" <% nvram_match("fw_log_x", "accept","selected"); %>><#2934#></option>
<option value="both" <% nvram_match("fw_log_x", "both","selected"); %>><#2935#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,5);"><#2139#></a></th>
<td>
<input type="radio" value="1" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '1')" <% nvram_match("misc_ping_x", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '0')" <% nvram_match("misc_ping_x", "0", "checked"); %>><#199#>
</td>
</tr>
...
<th><#2093#></th>
<td>
<input type="radio" value="1" name="fw_wl_enable_x" <% nvram_match("fw_wl_enable_x", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="fw_wl_enable_x" <% nvram_match("fw_wl_enable_x", "0", "checked"); %>><#199#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="7"><#2148#>&nbsp;(<#2693#>&nbsp;128)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2113#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#2114#></a></th>
<th><#2468#></th>
<th><#2692#></th>
</tr>
<tr>
...
<div>
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#430#></div>
<div class="formfontdesc">
<div><#2146#></div>
<div><#2147#></div>
</div>
...
<th><#2145#></th>
<td>
<input type="radio" value="1" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><#2474#></th>
...
<th><#1541#></th>
<th><#2149#></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2466#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#2114#></a></th>
<th><#2468#></th>
<th><#2692#></th>
</tr>
