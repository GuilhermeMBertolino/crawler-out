...
<title><#869#> - WireGuard Server</title>
...
<td>
<input class="button_gen" type="button" value="<#1553#>" onClick="exportConfig();"/>
...
<div class="apply_gen">
<input type="button" onClick="location.reload();" value="<#1707#>" class="button_gen">
</div>
</td>
</tr>
</table>
