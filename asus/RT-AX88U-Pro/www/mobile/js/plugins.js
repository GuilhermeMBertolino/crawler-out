...
document.querySelector('label[for="wireless_checkbox"]').innerHTML = '<#697#>';
wlArrayRet.push({"title":"5 GHz", "ifname":get_wl_unit_by_band('5G'), "suffix": "_5G"});
wlArrayRet.push({"title":"6 GHz", "ifname":get_wl_unit_by_band('6G'), "suffix": "_6G"});
}
...
switch(state) {
case "down":
$("#LED_state").html("<#950#> : Link down (DSL LED Off)<br>");
$("#LED_state").show();
break;
case "wait":
case "wait for init":
$("#LED_state").html("<#950#> : Wait for init (DSL LED Flashing)<br>");
$("#LED_state").show();
break;
case "init":
case "initializing":
$("#LED_state").html("<#950#> : Initializing (DSL LED Flashing)<br>");
$("#LED_state").show();
break;
case "up":
$("#LED_state").html("<#950#> : Link up (DSL LED On)<br>");
$("#LED_state").show();
break;
default:
$("#LED_state").hide();
...
$("<div>")
.addClass("inputTitleContainer")
.append($("<div>").addClass("inputTitle").html(wl.title + " <#587#>"))
...
$("#gdContainer").append($("<div>").attr({"class": "GD-wait"}).append($("<div>").attr({"id": "GD-status"}).html("<#1940#>")))
