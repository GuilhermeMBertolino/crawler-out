...
{
$("#settingProfileBar").showSelectorHint("<#3233#>");
return false;
}
...
httpUserInput.showTextHint("<#807#>");
return false;
}
/* check password */
if(!use_defpass){
...
httpPassInput.showTextHint("<#516#>");
return false;
}
...
if(!confirm("<#335#>")){
httpPassInput.showTextHint("<#1289#>");
return false;
}
}
}
...
$("#verify_pincode_status").html("<#2841#>");
...
break;
case '4':
$("#verify_pincode_status").html("<#2779#>");
break;
case '6':
$("#verify_pincode_status").html("<#2839#>");
break;
case '-1':
$("#verify_pincode_status").html("<#2814#>");
break;
case '-2':
case '-10':
$("#verify_pincode_status").html("<#2812#>");
break;
default:
break;
}
...
$("#verify_pincode_status").html("<#2550#>");
$("#verify_pincode_status").css("display", "");
return false;
}
else{
...
$("#new_pincode_status").html("<#2785#>");
else
$("#new_pincode_status").html("<#2550#>");
...
if(!confirm("<#335#>")){
$("#wireless_key_" + band).showTextHint("<#1289#>");
return false;
}
}
return true;
...
$("#wan_pppoe_passwd").showTextHint("<#720#>");
...
result_text += "<li><#1063#></li>";
result_text += "<li><#1131#></li>";
result_text += "<li><#1064#></li>";
result_text += "<li><#1052#></li>";
result_text += "</ol>";
}
result_text += '<#1058#>';
...
$("#login_name #http_username_title").html("<#2370#>");
...
if(isSupport("concurrep"))
$("#siteSurvey_page").find(".titleSub").html("<#4307#>");
else
$("#siteSurvey_page").find(".titleSub").html("<#3975#>");
...
if(isSupport("RPMesh"))
$("#papList_page").find(".titleSub").html("<#4307#>");
else
$("#papList_page").find(".titleSub").html("<#3975#>");
genPAPList(systemVariable.papList, systemVariable.multiPAP.wlcOrder);
...
var applyBtn = (systemVariable.isNewFw == 2) ? "<#227#>" : "<#1713#>";
...
httpApi.checkCap("http://<#871#>", function(){
setTimeout(function(){
if(isPage("amasconncap_page")) window.location.href = "http://<#871#>/cfg_onboarding.cgi?flag=AMesh&id=" + systemVariable.macAddr.split(":").join("");
}, 3000);
...
var auth_change_str = "* <#948#> <#1039#>".replace("WPA3-personal", current_auth).replace("WPA2/WPA3-personal", changeTo_auth);
...
var $ssid = $("<div>").html(htmlEnDeCode.htmlEncode("<#586#>: " + function(){
...
var $key = $("<div>").html(htmlEnDeCode.htmlEncode("<#587#>: " + wl_item.key_new));
...
$("#SDN_Scenarios_page .titleMain").html(((isSupport("mtlancfg") && isSupport("BUSINESS")) ? "<#2328#>": "<#2329#>"));
