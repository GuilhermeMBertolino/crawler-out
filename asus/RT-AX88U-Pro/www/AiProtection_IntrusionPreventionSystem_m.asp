...
code += '<div class="table-cell"><#1272#></div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1272#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1234#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1233#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1235#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
$('#deleteData').hide();
code += '<div class="no-data"><#2475#></div>';
}
...
<div>
<div class="card-bg">
<div class="page-title"><#1332#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1754#></div>
<div class="description"><#1333#></div>
</div>
<div class="tm-logo">
