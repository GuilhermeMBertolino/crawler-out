...
var jscolor_attr = "{closable:true, closeText:\"<#1687#>\", onFineChange:\"edit_component_color_callback(this)\"}";
...
var captive_portal_list_row = captive_portal_adv_profile_list.split("<");
var auth_array = ["<#1550#>", "Account/Password", "Account/Password", "Account/Password"];/*untranslated*/
var code = "";
...
code += '<td id="td_wl_name" width="30%"><#875#></td>';
...
window.open('Captive_Portal_Advanced_Preview.asp', '<#4255#>', 'toolbar=no,scrollbars=no,resizable=yes,location=no,menubar=no,width=476,height=714');
...
code += "<div id='toolbar_template' title='<#4191#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_template' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4191#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc step1'>";
code += "<div class='help_desc_title'>1. <#4250#></div>";
code += "<div class='help_desc_text'><#4251#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_2' class='help_step' style='display:none;'>";
code += "<div class='help_frame step2'>";
code += "<div class='help_desc_title'>2. <#4252#></div>";
code += "<div class='help_desc_text'><#4253#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_3' class='help_step' style='display:none;'>";
code += "<div class='help_frame step3'>";
code += "<div id='toolbar_unit_image' title='<#1682#> <#4193#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_image' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_text' title='<#1682#> Text' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_text' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_account' title='<#1682#> <#3031#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_account' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_eula' title='<#1682#> Eula' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_eula' style='cursor:default;'></div>";
code += "</div>";
code += "<div class='help_desc step3'>";
code += "<div class='help_desc_title'>3. <#4239#></div>";
...
code += "<div id='toolbar_background' title='<#4174#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_background' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4174#></div>";
code += "</div>";
code += "<div id='toolbar_editor' title='<#4192#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_editor' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4192#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc step4'>";
code += "<div class='help_desc_title'>4. <#4242#></div>";
code += "<div class='help_desc_text'><#4243#></div>";
code += "<div class='help_desc_text'><#4244#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_5' class='help_step' style='display:none;'>";
code += "<div class='help_frame step5'>";
code += "<div title='<#4175#>' class='splash_page_toolbar_unit_preview' style='cursor:default;'></div>";
code += "</div>";
code += "<div class='help_desc step5'>";
code += "<div class='help_desc_title'>5. <#4245#></div>";
code += "<div class='help_desc_text'><#4246#></div>";
...
code += "<input class='button_gen' type='button' style='cursor:default;' value='<#1708#>' disabled/>";
code += "</div>";
code += "<div class='help_desc step6'>";
code += "<div class='help_desc_title'>6. <#4248#></div>";
code += "<div class='help_desc_text'><#4249#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc_action_bg'>";
code += "<div class='help_desc_action_idx'>1 / 6</div>";
code += "<div id='help_desc_action_close' class='help_desc_action' style='display:none;' onclick='help_close();'><#1687#></div>";
...
code += "<div id='captive_portal_adv_step_1' onclick='switch_tab(1)'>1. <#4222#></div>";
code += "<div id='captive_portal_adv_step_2' onclick='switch_tab(2)'>2. <#4255#></div>";
...
code += "<input id='captive_portal_adv_finsih' class='button_gen' style='display:none;' type='button' value='<#1695#>'/>";
code += "</div>";
return code;
}
...
var code = "";
code += "<tr>";
code += "<th>" + wl_nband_title[_unit] + " <#586#></th>";
code += "<td>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='2'><#4225#></td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(31, 2);'><#4232#></a></th>";
code += "<td>";
...
code += "<option value='hour'><#2346#></option>";
code += "<option value='minute'><#2743#></option>";
code += "</select>";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_away_timeout' id='cpa_away_timeout_unlimited' checked><label for='cpa_away_timeout_unlimited'><#2686#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(31, 3);'><#4254#></a></th>";
code += "<td>";
...
code += "<option value='day'><#1729#></option>";
code += "<option value='hour'><#2346#></option>";
code += "<option value='minute'><#2743#></option>";
code += "</select>";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_session_timeout' id='cpa_session_timeout_unlimited' checked><label for='cpa_session_timeout_unlimited'><#2686#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4189#></th>";
...
code += "&nbsp;&nbsp;Mb/s";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_bw_dl' id='cpa_bw_dl_unlimited' checked><label for='cpa_bw_dl_unlimited'><#2686#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4190#></th>";
...
code += "&nbsp;&nbsp;Mb/s";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_bw_ul' id='cpa_bw_ul_unlimited' checked><label for='cpa_bw_ul_unlimited'><#2686#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4234#> (<#4238#>)</th>";
code += "<td>";
...
code += "<span style='margin-left:5px;'>ex. http <#4196#> https ://www.asus.com</span>";
code += "</td>";
code += "</tr>";
code += "</table>";
return code;
...
var code = "<div class='edit_component_item_hint'><#4216#></div>";
...
var code = "";
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'><#4202#></div>";
...
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<div class='edit_component_item_title'><#4207#> <span>(* <#4208#>)</span></div>";
code += "<div class='edit_component_item_content'>";
code += "<div class='edit_component_item_title' style='margin-top:5px;'><#4207#> title</div>";/*untranslated*/
...
code += "<div class='edit_component_item_title' style='margin-top:5px;'><#4257#></div>";
...
code += "</div>";
code += "<div style='width:49%;float:left;'>";
code += "<div class='edit_component_item_title'><#4210#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"eula\");' type='button' value='<#1686#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_eula"]) {
...
code += "<div class='edit_component_item_title'><#4203#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"account\");' type='button' value='<#1686#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_account"]) {
...
var code = "";
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'><#4211#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4212#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4213#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4215#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"button\");' type='button' value='<#1686#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_account"]) {
...
add_hint_msg($('input[name="edit_image_walled_garden"]'), "" + image_walled_garden + "<#2549#>");
$("input[name=edit_image_walled_garden]").focus();
return;
}
}
...
code += "<input type='radio' name='edit_background_type' id='edit_background_image' value='image' onclick='showHideBackgroundType();' checked><label for='edit_background_image'><#4217#></label>";
code += "<input type='radio' name='edit_background_type' id='edit_background_color' value='color' onclick='showHideBackgroundType();'><label for='edit_background_color'><#4218#></label>";
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
...
code += "<div class='edit_drag_drop_text'><#4195#><br><#4196#><br><#4197#></div>";
code += "</div>";
code += "<div class='edit_drag_drop_hint'><#4233#>: < 10MB</div>";
code += "<div class='edit_drag_drop_hint'><#4237#>: jpg, png</div>";
code += "<div class='edit_drag_drop_hint'><#4236#>: 1152 x 864 px <#4196#> <#4219#></div>";
}
else {
...
code += "<div class='edit_component_item_title'><#4220#></div>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"background\");' type='button' value='<#1686#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
...
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'>";
code += "<input type='radio' name='edit_image_type' id='edit_image_image' value='image' onclick='showHideImageType();' checked><label for='edit_image_image'><#4193#></label>";
code += "<input type='radio' name='edit_image_type' id='edit_image_color' value='color' onclick='showHideImageType();'><label for='edit_image_color'><#4194#></label>";
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
...
code += "<div class='edit_drag_drop_text edit_drag_drop_text_for_image'><#4195#><br><#4196#><br><#4197#></div>";
code += "</div>";
}
else {
...
code += "</div>";
code += "<div class='edit_component_item_title'><a style='cursor:help;color:#D0D6D8' href='javascript:void(0);' onClick='openHint(31, 5);'><#4198#></a></div>";
code += "<div class='edit_component_item_content'>";
...
add_hint_msg($('input[name="edit_text_walled_garden"]'), "" + text_walled_garden + "<#2549#>");
$("input[name=edit_text_walled_garden]").focus();
return;
}
}
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"text_" + _idx + "\");' type='button' value='<#1686#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_text"]) {
...
code += "<div class='component_title'><span><#4193#></span></div>";
...
code += "<div class='edit_component_item_title'><#4192#></div>";
...
code += "<div id='toolbar_unit_image' title='<#1682#> Image' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_image' onclick='edit_component_add(\"image\", event);'></div>";
code += "<div id='toolbar_unit_text' title='<#1682#> Text' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_text' onclick='edit_component_add(\"text\" , event);'></div>";
code += "<div id='toolbar_unit_account' title='<#1682#> <#3031#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_account' onclick='edit_component_add(\"account\" , event);'></div>";
code += "<div id='toolbar_unit_eula' title='<#1682#> Eula' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_eula' onclick='edit_component_add(\"eula\" , event);'></div>";
code += "<div title='<#4175#>' class='splash_page_toolbar_unit_preview' onclick='preview(event);'></div>";
code += "</div>";
...
code += "<input id='captive_portal_adv_reset' class='button_gen' onclick='reset_splash_page_layout()' type='button' value='<#1708#>'/>";
code += "<div id='splash_page_toolbar_unit_help' title='<#1699#>' class='splash_page_toolbar_unit_help' onclick='toolbar_unit_help(event);'></div>";
code +="</div>";
code += "</div>";
code += "<div class='splash_page_toolbar_bg_right' onclick='stop_propagation(event);'>";
code += "<div id='toolbar_template' title='<#4191#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_template' onclick='edit_component_template();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4191#></div>";
code += "</div>";
code += "<div id='toolbar_background' title='<#4174#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_background' onclick='edit_component_background();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4174#></div>";
code += "</div>";
code += "<div id='toolbar_editor' title='<#4192#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_editor' onclick='edit_component_editor();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4192#></div>";
code += "</div>";
code += "</div>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='2'><#4228#></td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><#4229#></th>";
code += "<td>";
code += "<input type='radio' name='cpa_verification' id='cpa_verification_local' value='0' onclick='showHideVerification();' checked><label for='cpa_verification_local'><#4221#></label>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='3'><#3617#>&nbsp;(<#2693#>&nbsp;32)</td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><#3616#></th>";
...
code += "</thead>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 1);'><#3922#></a></th>";
code += "<td>";
...
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 2);'><#3926#></a></th>";
code += "<td>";
...
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 3);'><#3924#></a></th>";
code += "<td>";
...
captive_portal_adv_edit_idx = 1;
set_tab_and_action_btn();
alert("Please select at least one <#586#>.");/*untranslated*/
return false;
}
var wl_if = "";
...
splash_page_adv_html += "<title><#4255#></title>\n";
...
if(_array.length == 0)
code += '<tr><td style="color:#FFCC00;" colspan=' + _colspan_num[_connect_type] + '><#2475#></td></tr>';
else{
...
var data = [];
if(event_log_mode) {
data = [["<#388#>", "<#309#>", "<#3616#>", "<#3031#>", "<#4254#>", "<#4232#>", "<#4184#>", "<#4185#>", "<#4186#>"]];
}
else {
data = [["<#388#>", "<#309#>", "<#3616#>", "<#3031#>", "Failure Time"]];
}
...
code += "<thead><tr style='height:30px;'><td colspan='10'><#4187#>";
code += "</td></tr></thead>";
code += "<tr id='tr_auth_pass' style='cursor:pointer;height:40px;'>";
code += "<th id='th_macAddress_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");' style='cursor:pointer;'><#3045#></th>";
...
code += "<th id='th_userName_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#3616#></th>";
code += "<th id='th_auth_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#3031#></th>";
code += "<th id='th_session_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4254#></th>";
code += "<th id='th_awayTimeout_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4232#></th>";
code += "<th id='th_startTime_pass' width='20%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4184#></th>";
code += "<th id='th_receviedBytes_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4185#></th>";
code += "<th id='th_transmittedBytes_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4186#></th>";
code += "</tr>";
code += "</table>";
...
code += "<thead><tr style='height:30px;'><td colspan='5'><#4187#>";
code += "</td></tr></thead>";
code += "<tr id='tr_auth_failed' style='cursor:pointer;height:40px;'>";
code += "<th id='th_macAddress_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3045#></th>";
...
code += "<th id='th_userName_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3616#></th>";
code += "<th id='th_auth_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3031#></th>";
...
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='exportConnectEventLog();' type='button' value='<#1553#>'/>";
code += "<input class='button_gen' onclick='update_connect_status();' type='button' value='<#1707#>'/>";
code += "</div>";
...
var code = "";
code += "<div class='edit_component_item_title' style='margin-bottom:8px;'><#4200#>: <span id='edit_component_level' class='edit_component_level'>" + $("#"+ _component_id + "").css("z-index") + "</span></div>";/*untranslated*/
...
<div>&nbsp;</div>
<div class="formfonttitle"><#299#> - <#4176#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="captive_portal_adv_intro_icon"></div>
<div style='float:left;width:80%;'>
<div class="captive_portal_adv_intro_txt" style="color:#FC0;"><#4177#></div>
<div class="captive_portal_adv_intro_txt"><#4178#></div>
<div class="captive_portal_adv_intro_txt brt_series">
<#1967#> : <a id="faq" href="" target="_blank" style="font-weight:bolder;text-decoration:underline;" href="" target="_blank">GO</a>
</div>
</div>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(31, 1);"><#4181#></a></th>
<td>
...
<span style="color:#FFCC00;">(<#4182#>: 60 - 800, <#3227#>: 300 <#3196#>)</span>
</td>
</tr>
<tr id="tr_event_log">
<th><#4180#></th>
<td>
<input class='button_gen' onclick='show_event_log();' type='button' value='<#2694#>'/>
</td>
</tr>
</table>
...
<span class='captive_portal_adv_add_title' onclick="editProfile('new')"><#3810#></span>
</div>
<table width="100%" align="center" cellpadding="4" cellspacing="0" class="FormTable_table">
<thead>
<tr>
<td id="td_profile_table_title" colspan="5"><#4183#> &nbsp;(<#2693#>&nbsp;1)</td>
</tr>
</thead>
<tr>
<th width="30%"><#4230#></th>
