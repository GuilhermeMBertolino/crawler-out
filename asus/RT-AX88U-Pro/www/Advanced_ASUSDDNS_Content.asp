...
var ddns_accournt_remove_note = stringSafeGet("<#165#>");
function init(){
show_menu();
...
if(isSupport("rog")){
document.querySelector('#icon_help').classList.add('rog');
document.querySelector('#ddns_copy').classList.add('rog');
}
else if(isSupport("tuf")){
document.querySelector('#icon_help').classList.add('tuf');
...
$("#deregister_btn").click(function(){
if(orig_le_enable != "0"){
var confirm_msg = stringSafeGet("<#2623#>");
...
document.getElementById("DDNSName").value = "<#164#>";
}
else{
...
document.getElementById("ddns_hostname_x").value = "<#164#>";
}
...
document.getElementById("ddns_status").innerHTML = "<#753#>";
if(inadyn)
show_deregister_btn();
}
}
...
if(ddns_server_x == "WWW.ASUS.COM"){
document.getElementById("ddns_status").innerHTML = "<#754#>";
if(ddnsStatus != "")
...
show_alert_block("<#2606#> '" + s.charAt(i) +"' !");
return false;
}
}
return true;
...
function cleandef(){
if(document.form.DDNSName.value == "<#164#>")
...
document.getElementById("le_desc").innerHTML = "<#2650#>";
...
case "2":
document.getElementById("cert_desc").style.display = "none";
html_code += '<div style="display:table-cell"><input class="btn_subusage button_gen" onclick="open_upload_window();" type="button" value="<#1714#>"/><img id="loadingicon" style="margin-left:5px;display:none;" src="/images/InternetScan.gif"></div>';
document.getElementById("cert_act").innerHTML = html_code;
document.getElementById("cert_act").style.display = "";
if(orig_le_enable != "0")
document.getElementById("cert_details").style.display = "";
...
document.getElementById("cert_status").innerHTML = "<#3691#>";
else
document.getElementById("cert_status").innerHTML = "<#3568#>";
setTimeout("get_cert_info();", 1000);
}
else{
document.getElementById("cert_status").innerHTML = "<#753#>";
...
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=168"><#2631#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=169"><#2632#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=170"><#2633#></a></div>'
...
$(e).parent().find('.tooltiptextdown').html('You can use '+ddnsname+' to connect to the home network and manage it when youre out.');
}
</script>
</head>
...
<div class="formfonttitle"><#414#> - <#419#> </div>
<div class="formfonttitle_help"><i onclick="show_feature_desc()" class="icon_help"></i></div>
</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc formfontdesc_help_left">
<div><#2627#></div>
</div>
<div class="formfontdesc hint-color" id="wan_ip_hide2" style="color:#FC0; display:none;"><#2630#><#2628#></div>
<div class="formfontdesc hint-color" id="lb_note" style="color:#FC0; display:none;"><#2679#></div>
...
<div style="color:#FFCC00">*<#2634#></div>
</td>
</tr>
<tr>
<th id="ddns_wan_unit_th"><#3822#></th>
<td id="ddns_wan_unit_td">
<select name="ddns_wan_unit" class="input_option">
<option class="content_input_fd" value="-1" <% nvram_match("ddns_wan_unit", "-1","selected"); %>><#166#></option>
<option class="content_input_fd" value="0" <% nvram_match("ddns_wan_unit", "0","selected"); %>><#1903#></option>
<option class="content_input_fd" value="1"<% nvram_match("ddns_wan_unit", "1","selected"); %>><#1910#></option>
</select>
</td>
</tr>
<tr id="ddns_ipv6update_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,18);"><#1741#></a></th>
<td>
<input type="radio" name="ddns_ipv6_update" class="input" value="1" <% nvram_match("ddns_ipv6_update", "1", "checked"); %>><#200#>
<input type="radio" name="ddns_ipv6_update" class="input" value="0" <% nvram_match("ddns_ipv6_update", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><#2641#></th>
...
<option value="WWW.ORAY.COM" <% nvram_match("ddns_server_x", "WWW.ORAY.COM","selected"); %>>WWW.ORAY.COM()</option>
...
<input id="deregister_btn" class="button_gen" style="display: none; margin-left: 5px;" type="button" value="<#213#>"/>
<a id="link" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#2642#></a>
<a id="linkToHome" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1730#></a>
</td>
</tr>
<tr id="ddns_hostname_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#2638#></a></th>
<td>
...
<th><#2649#></th>
<td>
<input type="radio" value="1" name="ddns_wildcard_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '1')" <% nvram_match("ddns_wildcard_x", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="ddns_wildcard_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '0')" <% nvram_match("ddns_wildcard_x", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="check_ddns_field" style="display:none;">
<th><#1746#></th>
<td>
<input type="radio" value="1" name="ddns_regular_check" onClick="change_ddns_setting(document.form.ddns_server_x.value);" <% nvram_match("ddns_regular_check", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="ddns_regular_check" onClick="change_ddns_setting(document.form.ddns_server_x.value);" <% nvram_match("ddns_regular_check", "0", "checked"); %>><#199#>
</td>
</tr>
<tr style="display:none;">
<th><#1747#></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="ddns_regular_period" value="<% nvram_get("ddns_regular_period"); %>" autocorrect="off" autocapitalize="off"> <#2743#>
</td>
</tr>
<tr style="display:none;">
<th><#2645#></th>
...
<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#2643#>" /></td>
</tr>
...
<input type="radio" value="1" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "1", "checked"); %>><#1733#>
</span>
<input type="radio" value="2" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "2", "checked"); %>><#1735#>
<span id="self_signed" style="color:#FFF;">
<input type="radio" value="0" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "0", "checked"); %>><#875#>
</span>
...
<div class="cert_status_title"><#756#> :</div>
<div id="cert_status" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3700#> :</div>
<div id="issueTo" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3699#> :</div>
<div id="issueBy" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3698#> :</div>
<div id="expireOn" class="cert_status_val"></div>
</div>
<div>
<input class="button_gen" onclick="save_cert_key();" type="button" value="<#1553#>" />
</div>
</td>
</tr>
</table>
<div class="apply_gen">
<input class="button_gen" onclick="apply_eula_check();" type="button" value="<#209#>" />
</div>
</div>
...
<div class="formfonttitle" style="margin-top: 15px; margin-left: 15px;"><#1735#></div>
<div class="formfontdesc" style="margin: 15px;"><#1736#></div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1737#> :</div>
<div style="display:table-cell;"><input type="file" name="file_key" class="input Upload_file"></div>
</div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1743#> :</div>
<div style="display:table-cell;"><input type="file" name="file_cert" class="input Upload_file"></div>
</div>
<div style="color: #FC0; margin-left: 15px; margin-top: 20px">* <#1738#></div>
<div align="center" style="margin-top:30px; padding-bottom:15px; display: flex; justify-content: center;">
<div style=""><input class="button_gen" type="button" onclick="hide_upload_window();" id="cancelBtn" value="<#212#>"></div>
<div style=""><input class="button_gen" type="button" onclick="upload_cert_key();" id="applyBtn" value="<#1704#>"></div>
</div>
</div>
</form>
</body>
