...
document.getElementById("asus_eula_title").innerHTML = services_show;
document.getElementById("alexa_ifttt").innerHTML = "<#149#>";
}
else{
services_show = services_show.replace('%1$@', services_array.within_alexa_ifttt);
document.getElementById("asus_eula_title").innerHTML = services_show;
document.getElementById("alexa_ifttt").innerHTML = "<#150#>";
}
}
else
...
<div>&nbsp;</div>
<div id="formfonttitle" class="formfonttitle"><#431#> - <#4304#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="privacy_desc" style="font-size:14px; margin: 20px 10px auto 10px; display:none;" class="formfontdesc"><#123#></div>
...
<input class="btn_subusage button_gen" id="asus_withdraw_btn" onclick="withdraw_eula('asus');" type="button" value="<#163#>"/>
...
<div style="text-align: center;">
<div style="margin: 0px auto 10px;display: flex;justify-content: center;">
<input class="btn_subusage button_gen" id="asus_pp_withdraw_btn" onclick="show_eula_confirm('asus_pp');" type="button" value="<#163#>"/>
...
<div class="eula_withdraw_title"><#159#></div>
<div class="eula_withdraw_content">
<div><#160#></div>
<div style="margin-top:5px;"><#161#>
<div><#157#></div>
<div><#158#></div>
</div>
</div>
<div style="text-align:center;">
<div style="margin: 0px auto 10px;display: flex;justify-content: center;">
<input class="btn_subusage button_gen" id="tm_withdraw_btn" onclick="withdraw_eula('tm');" type="button" value="<#163#>"/>
