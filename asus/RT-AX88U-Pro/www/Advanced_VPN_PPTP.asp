...
document.getElementById("dualwan_ctrl").innerHTML = "<#3065#> <span class=\"formfontdesc\">Primary WAN IP : " + wan0_ipaddr + " </span><span class=\"formfontdesc\">Secondary WAN IP : " + wan1_ipaddr + "</span>";
...
document.getElementById("wan_ctrl").innerHTML = "<#3065#>" + wan_ipaddr;
...
$rowObj.children(":first").html("<#2475#>");
else
...
alert("<#3638#> " + document.form._pptpd_clients_start.value);
document.form._pptpd_clients_end.focus();
document.form._pptpd_clients_end.select();
setEnd();
return false;
...
document.getElementById("pptpd_conflict").innerHTML = "<#3651#> <b>"+origin_lan_ip+"</b>";
return;
}
...
document.getElementById("pptpd_conflict").innerHTML = "<#3649#> <b>"+pool_start+" ~ "+pool_end+"</b>";
return;
}
if(dhcp_staticlists != ""){
...
document.getElementById("pptpd_conflict").innerHTML = "<#3650#> <b>"+static_ip+"</b>";
return;
}
}
}
...
<div id="privateIP_notes" class="formfontdesc" style="display:none;color:#FC0;"><#3717#></div>
...
<div class="formfontdesc"><#3064#></div>
<div id="wan_ctrl" class="formfontdesc"></div>
<div id="dualwan_ctrl" style="display:none;" class="formfontdesc"></div>
<div class="formfontdesc" style="margin-top:-10px;"><#3066#></div>
<div class="formfontdesc" style="margin-top:-10px;">(7) <#2928#></div>
...
<span id="pptpd_broadcast_hint" style="font-family: Lucida Console;color: #FFCC00;display: none;"><#3063#></span>
</td>
</tr>
<tr>
<th><#3031#></th>
...
<input type="checkbox" class="input" name="pptpd_mppe_no" onClick="return changeMppe();"><#2913#>
</td>
</tr>
<tr>
<th><#327#></th>
...
<span id="pptpd_subnet" style="font-family: Lucida Console;color: #FFF;"></span><input type="text" maxlength="3" class="input_3_table" name="_pptpd_clients_end" value="" autocorrect="off" autocapitalize="off"/><span style="color:#FFCC00;"> <#3661#></span>
...
<thead>
<tr>
<td colspan="2"><#3148#> (<#2032#>)</td>
</tr>
</thead>
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6,1);"><#3153#></a></th>
<td>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6,2);"><#3154#></a></th>
<td>
...
<input class="button_gen" type="button" onclick="srConfirm();" value="<#1704#>">
</div>
</div>
</form>
<div id="footer"></div>
