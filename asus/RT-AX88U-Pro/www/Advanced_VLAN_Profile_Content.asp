...
var $table_thead_title = $("<td>").html("<#2324#>")
.attr('colSpan', '6')
.appendTo($table_thead_tr);
var $table_th_tr = $("<tr>").appendTo($table_bg);
var $table_th_name = $("<th>").html("<#586#>").css({'text-align':'center','width':'50%'}).appendTo($table_th_tr);
var $table_th_vid = $("<th>").html("<#3877#>").css({'text-align':'center','width':'20%'}).appendTo($table_th_tr);
var $table_th_iso = $("<th>").html("<#3635#>").css({'text-align':'center','width':'15%'}).appendTo($table_th_tr);
var $table_th_edit = $("<th>").html("<#2692#>").css({'text-align':'center','width':'15%'}).appendTo($table_th_tr); // / <#217#>
...
code += "<th class='IE8HACK' width='40%'><#586#></th>";
...
code += "<th><#3635#></th>";
code += "<td style='padding:10px;text-align:left;'>";
code += "<input type='radio' name='update_iso' class='input' value='1'><#200#>";
code += "<input type='radio' name='update_iso' class='input' value='0'><#199#>";
code += "</td>";
code += "</tr>";
code += "</table>";
code += "</td></tr></tbody></table>";
code += "<div style='margin-top:10px;margin-bottom:20px;width:100%;text-align:center;'>";
code += "<input class='button_gen' type='button' onclick='close_vlan_profile_View()' value='<#212#>'>";
code += "<input class='button_gen' type='button' onclick='Update_vlan_rl(\""+apgx_id_string+"\","+choosed_rl_index+","+choosed_rl_vid+","+choosed_rl_iso+")' style='margin-left:15px;' value='<#1704#>'>";
code += "</div>";
...
<div class="formfontdesc"><#3636#></div>
