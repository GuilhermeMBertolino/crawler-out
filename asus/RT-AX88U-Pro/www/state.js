...
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top" style="margin:7px 0 0 5px;"><#870#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:20px 0 0 10px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#783#></div></div></a>\n';
}
else{
banner_code +='<div style="margin-left:10px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#870#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:15px 0 0 15px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#783#></div></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin:15px 0 0 15px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#192#></div></div></a>\n';
}
}
else if(tuf_support){
if(CoBrand == "8")
...
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#870#></span></div>';
banner_code +='<div style="position: absolute;margin-left: 720px;"><a href="javascript:logout();"><div style="margin:20px 0 0 0;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 0;"><#783#></div></div></a></div>\n';
}
...
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:125px; *width:136px;" class="titlebtn" align="center"><span><#783#></span></div></a>\n';
...
banner_code +='<div style="margin-top:13px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#870#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:25px; *width:136px;" class="titlebtn" align="center"><span><#783#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#192#></span></div></a>\n';
}
if(rog_support){
...
banner_code += '<div style="font-size: 14px;margin-left:12px;"><#4393#></div>';
...
banner_code += '<div style="padding: 2px 8px;margin: 0 0 2px 230px;width:735px;display:flex;justify-content:space-between;" class="radio_hint top_banner_hint">';
banner_code += '<div style="background-image: url(\'images/New_ui/exclamationmark.svg\');width:16px;height:16px;background-size: 100%;background-repeat:no-repeat;cursor: pointer"></div>';
banner_code += '<div style="font-size: 14px;margin-left:12px;"><#2967#></div>';
...
banner_code +='<div style="padding:5px 0 5px 15px;font-size:14px;color:#BDBDBD"><#1437#></div>';
banner_code +='</div>';
banner_code +='</div>';
...
banner_code += "<#2770#>";
banner_code +='</div>';
banner_code +="<span><input style=\"margin-left:30px;\" type=\"checkbox\" name=\"stop_show_chk\" id=\"stop_show_chk\"><#2824#></input></span>";
...
footer_code += '<td width="20" align="right"><div id="bottom_help_icon" style="margin-right:3px;"></div></td><td width="110" id="bottom_help_title" align="left"><#2337#> & <#3349#></td>';
var genlink = "https://nw-dlcdnet.asus.com/support/forward.html?model="+support_site_modelid+"&type=Manual&lang="+href_lang+"&kw=&num=";
footer_code += "<td width=\"335\" id=\"bottom_help_link\" align=\"left\"><a target=\"_blank\" rel=\"noreferrer\" href=\""+ genlink +"\" style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\"><#2709#></a>";
footer_code += "&nbsp|&nbsp<a id=\"registration_link\" target=\"_blank\" rel=\"noreferrer\" href=\""+ href_reg_url +"\" target=\"_self\" style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\"><#3083#></a>";
if(dsl_support && frs_feedback_support){
footer_code += '&nbsp|&nbsp<a id="fb_link" href="/Advanced_Feedback.asp" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2731#></a>';
}
...
footer_code += '&nbsp|&nbsp<a id="fb_link" href="'+location_href+'" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2731#></a>';
}
footer_code += '</td>';
...
document.getElementById("elliptic_ssid_" + bandName[i].toLocaleLowerCase()).title = "<#3277#>"
...
document.getElementById("sw_mode_span").innerHTML = "<#874#>";
else if(sw_mode == "2"){
if(wlc_express == 1)
...
document.getElementById('selected_lang').innerHTML = "<#896#>";
}
...
code += '<div style="margin: 24px 0;"><#4394#></div>';
var _str = '<#4395#>';
var _str1 = '<#4396#>';
var _temp = _str.replace('%1$@', 'WiFi radio').replace('%2$@', _str1);
code += '<div style="margin: 24px 0;">'+ _temp +'</div>';
code += '<div style="margin: 32px 0;"><input id="radio_hint_checkbox" type="checkbox"><#4397#></div>';
...
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;" onclick="radio_agree();"><div class="button-icon button-icon-check"></div><div class="button-text"><#4396#></div></div>';
code += '</div></div>';
obj.html(code);
}
...
code += '<div style="font-size: 16px;font-weight: bold;margin: 12px 0;"><#2967#></div>';
code += '<div style="margin: 18px 0;"><#2968#></div>';
code += '<div style="margin: 18px 0;"><#2969#></div>';
if(_flag == "1")
code += '<div style="margin: 18px 0;"><input id="radio_hint_checkbox" type="checkbox"><#4397#></div>';
...
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;"><div class="button-icon button-icon-check"></div><div class="button-text"><#1550#></div></div>';
code += '</div></div>';
obj.html(code);
...
wlHintHtml += '<div class="prod_madelName"><div class="title_name"><div class="div_td img_gap"><div class="login_img"></div></div><div class="div_td"><#870#></div></div></div>';
