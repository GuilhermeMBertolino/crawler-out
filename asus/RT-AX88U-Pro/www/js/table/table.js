...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2693#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2553#> " + _createRuleCount + " <#2554#>");
return;
}
...
$titleHtml.html("<#2543#>");/*untranslated*/
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#2932#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2546#>");
return false;
}
}
