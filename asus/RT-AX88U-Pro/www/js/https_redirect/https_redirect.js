...
var $scan_title = $("<div>").addClass("scan_title").appendTo($scan_qr_code_block).html("<#4403#>");
...
$("<label>").attr("for","https_redirect_hint").html("<#4408#>").appendTo($cb_text_bg);
