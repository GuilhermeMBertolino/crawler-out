...
var category_name = ["<#1239#>", "<#1254#>", "<#1257#>", "<#1261#>"];
var sub_category_name = [["<#1241#>", "<#1242#>", "<#1243#>"],
["<#1244#>", "<#1245#>", "<#1246#>", "<#1247#>", "<#1248#>"],
["<#1259#>", "<#1260#>"],
["<#1262#>", "<#1263#>", "<#1264#>"]];
var category_desc = ["<#1240#>",
"<#1255#>",
"<#1258#>",
"<#1265#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1660#>&nbsp;(<#2693#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#3200#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1567#> (<#3045#>)</th>';
code += '<th width="40%"><#1249#></th>';
code += '<th width="10%"><#2692#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#3994#>/<#1550#>">';
...
code += '</tr>';
if(apps_filter == ""){
code += '<tr><td class="tableNoRule" style="color:#FFCC00;" colspan="10"><#2475#></td></tr>';
}
else{
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#489#> - <#1238#></div>
</td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1238#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3403#></td></tr></table>
</div>
</a>
</div>
</td>
