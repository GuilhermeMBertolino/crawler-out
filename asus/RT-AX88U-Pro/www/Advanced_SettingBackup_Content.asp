...
showtext(document.getElementById("loading_block2"), "<#3178#>");
...
showtext(document.getElementById("loading_block2"), "<#3219#>");
document.getElementById('loading_block3').style.display = "none";
if(!isSupport("demoui"))
...
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#3226#></a>
</th>
<td colspan = "4">
<div style="float:left;">
<input class="btn_subusage button_gen" onclick="restoreRule('restore');" type="button" value="<#1709#>" name="action1" />
</div>
...
<span><label for="restoreInit"><#3229#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#3231#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="btn_subusage button_gen" onclick="saveSetting('Router');" type="button" value="<#3231#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#3236#></span></label>
</div>
</div>
...
<div style="float:left;width:80%;">
<span><label for="transfer_ddns"><#1745#></span></label>
</div>
</div>
</div>
</td>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#3235#></a>
</th>
<td colspan = "4">
...
<tr>
<td style="border:0px">
<input type="button" class="btn_subusage button_gen" onclick="selectSetting();" value="<#1714#>"/>
</td>
