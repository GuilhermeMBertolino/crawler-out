...
document.getElementById("loginMethod").innerHTML = "<#1000#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#999#>";
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 6)?"<#938#>":"<#904#>";
}
...
<span class="formfonttitle"><#420#> - <#421#><span id="clouddiskstr"> / <#1640#></span></span>
...
<div class="formfontdesc" style="margin-top: 10px;"><#3175#></div>
<div id="smbv1_hint" class="formfontdesc"><#948#>&nbsp;<#3176#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,2);"><#3242#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,3);"><#3255#></a>
</th>
<td>
...
<option class="content_input_fd" value="0" <% nvram_match("usb_fs_ntfs_sparse", "0","selected"); %>><#3995#></option>
<option class="content_input_fd" value="1" <% nvram_match("usb_fs_ntfs_sparse", "1","selected"); %>><#3994#></option>
</select>
</td>
</tr>
</table>
