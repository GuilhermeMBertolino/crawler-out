...
x.options[0].text = "<#3967#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#3967#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#3968#>", "upper");
...
x.options[0].text = "<#3968#>";
x.options[0].value = "upper";
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#3967#>", "lower");
...
|| opts[opts.selectedIndex].text == "<#4388#>"
...
var auth_array = [["<#4388#>", "owe"], ["WPA3-Personal", "sae"]];
}
else{
