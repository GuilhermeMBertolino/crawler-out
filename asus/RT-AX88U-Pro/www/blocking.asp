...
var category_info = [ ["Parental Controls", "1", "<#1239#>", "<#1241#>", "<#1476#>"],
["Parental Controls", "3", "<#1239#>", "<#1241#>", "<#1478#>"],
["Parental Controls", "4", "<#1239#>", "<#1241#>", "<#1479#>"],
["Parental Controls", "5", "<#1239#>", "<#1241#>", "<#1480#>"],
["Parental Controls", "6", "<#1239#>", "<#1241#>", "<#1481#>"],
["Parental Controls", "8", "<#1239#>", "<#1241#>", "<#1482#>"],
["Parental Controls", "9", "<#1239#>", "<#1242#>", "<#1483#>"],
["Parental Controls", "10", "<#1239#>", "<#1242#>", "<#1484#>"],
["Parental Controls", "14", "<#1239#>", "<#1242#>", "<#1485#>"],
["Parental Controls", "15", "<#1239#>", "<#1242#>", "<#1486#>"],
["Parental Controls", "16", "<#1239#>", "<#1242#>", "<#1487#>"],
["Parental Controls", "25", "<#1239#>", "<#1242#>", "<#1488#>"],
["Parental Controls", "26", "<#1239#>", "<#1242#>", "<#1489#>"],
["Parental Controls", "11", "<#1239#>", "<#1243#>", "<#1490#>"],
["Parental Controls", "24", "<#1254#>", "<#1244#>", "<#1491#>"],
["Parental Controls", "51", "<#1254#>", "<#1245#>", "<#1492#>"],
["Parental Controls", "53", "<#1254#>", "<#1246#>", "<#1493#>"],
["Parental Controls", "89", "<#1254#>", "<#1246#>", "<#1494#>"],
["Parental Controls", "42", "<#1254#>", "<#1247#>", "<#1495#>"],
["Parental Controls", "56", "<#1257#>", "<#1259#>", "<#1496#>"],
["Parental Controls", "70", "<#1257#>", "<#1259#>", "<#1497#>"],
["Parental Controls", "71", "<#1257#>", "<#1259#>", "<#1498#>"],
["Parental Controls", "57", "<#1257#>", "<#1260#>", "<#1499#>"],
["Parental Controls", "69", "<#1261#>", "<#1263#>", "<#1500#>"],
["Parental Controls", "23", "<#1261#>", "<#1264#>", "<#1501#>"],
["Home Protection", "91", "Anti-Trojan detecting and blocked", "", "<#1502#>"],
["Home Protection", "2", "Malicious site blocked", "", "<#1477#>"],
["Home Protection", "39", "Malicious site blocked", "", "<#1503#>"],
["Home Protection", "73", "Malicious site blocked", "", "<#1504#>"],
["Home Protection", "74", "Malicious site blocked", "", "<#1505#>"],
["Home Protection", "75", "Malicious site blocked", "", "<#1506#>"],
["Home Protection", "76", "Malicious site blocked", "", "<#1507#>"],
["Home Protection", "77", "Malicious site blocked", "", "<#1508#>"],
["Home Protection", "78", "Malicious site blocked", "", "<#1509#>"],
["Home Protection", "79", "Malicious site blocked", "", "<#1510#>"],
["Home Protection", "80", "Malicious site blocked", "", "<#1511#>"],
["Home Protection", "81", "Malicious site blocked", "", "<#1512#>"],
["Home Protection", "82", "Malicious site blocked", "", "<#1513#>"],
["Home Protection", "83", "Malicious site blocked", "", "<#1514#>"],
["Home Protection", "84", "Malicious site blocked", "", "<#1515#>"],
["Home Protection", "85", "Malicious site blocked", "", "<#1516#>"],
["Home Protection", "86", "Malicious site blocked", "", "<#1517#>"],
["Home Protection", "88", "Malicious site blocked", "", "<#1518#>"],
["Home Protection", "92", "Malicious site blocked", "", "<#1519#>"],
["Home Protection", "94", "Malicious site blocked", "", "<#1520#>"],
["Home Protection", "95", "Malicious site blocked", "", "<#1521#>"]
];
var target_info = {
url: "",
category_id: "",
...
var parental_string = "";
code = "<ul>";
code += "<li><div><span class='desc_info'><#1754#>:</span><br>" + target_info.desc + "</div></li>";
if(casenum != "")
code += "<li><div><span class='desc_info'>URL: </span>" + target_info.url +"</div></li>";
if(target_info.category_type == "Parental Controls")
code += "<li><div><span class='desc_info'><#1249#> :</span>" + target_info.content_category + "</div></li>";
code += "</ul>";
document.getElementById('detail_info').innerHTML = code;
if(target_info.category_type == "Parental Controls"){ //Webs Apps filter
code_title = "<div class='er_title' style='height:auto;'><#1531#></div>";
code_suggestion = "<ul>";
code_suggestion += stringSafeGet("<li><span><#1530#></span></li>");
code_suggestion += "<li><span><#1535#></span></li>";
code_suggestion += '<li><#1309#><a href="https://global.sitesafety.trendmicro.com/index.php" target="_blank"><#1310#></a></li>';
code_suggestion += "</ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#1527#></div>";
code_suggestion = "<ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#834#></div>";
document.getElementById('main_reason').innerHTML = "<#833#>";
code = "";
code += "<div><#844#></div>";
document.getElementById('detail_info').innerHTML = code;
code_suggestion = "<ul>";
code_suggestion += "<li><span><#845#></span></li>";
code_suggestion += "<li><span><#846#></span></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
code_title = "<div class='er_title' style='height:auto;'><#1536#></div>"
code_suggestion = "<ul>";
if(bwdpi_support)
parental_string = "<#3403#>";
else
parental_string = stringSafeGet("<#489#>");
code_suggestion += "<li><#1533#> "+ parental_string +" <#1534#></li>";
code_suggestion += "<li><#1535#></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
<div class="prod_madelName"><#870#></div>
<div id="main_reason" class="p1 title_gap"><#1523#></div>
<div ></div>
<div>
...
<div class="p1 title_gap"><#854#></div>
<div>
<div class="p1 title_gap"></div>
<div class="nologin">
...
<div id="go_btn" class='button' style="display:none;"><#1554#></div>
</div>
</body>
</html>
