...
var port_mismatch_notice = "<#2516#>";
var port_mismatch_list = "<#2517#>";
if(wan_proto=="v6plus"){
port_confirm = port_confirm.replace("%0$@", "<#2514#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2514#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2514#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2514#>");
}
if(wan_proto=="ocnvc"){
port_confirm = port_confirm.replace("%0$@", "<#2513#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2513#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2513#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2513#>");
}
...
break;
case "https" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#2144#></a></li>";
break;
case "ssh" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#3012#></a></li>";
break;
case "openvpn" :
items += "<li><a href='/Advanced_VPNServer_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OpenVPN</a></li>";
break;
case "ftp" :
items += "<li><a href='/Advanced_NATPassThrough_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#447#> - <#2174#></a></li>";
break;
case "ipsec" :
...
items += "<li><a href='/Advanced_Instant_Guard.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#4380#></a></li>";
}
break;
default :
break;
...
notification.desc[12] = "<#2770#>";
notification.action_desc[12] = "<#1447#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1440#>';
notification.action_desc[0] = '<#1447#>';
...
notification.desc[1] = '<#1441#>';
notification.action_desc[1] = '<#1448#>';
...
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1448#></a>';
...
notification.desc[2] = '<#1442#>';
notification.action_desc[2] = '<#1447#> (2.4GHz)';
...
notification.desc[3] = '<#1442#>';
if(band5g2_support)
notification.action_desc[3] = '<#1447#> (5GHz-1)';
else
notification.action_desc[3] = '<#1447#> (5GHz)';
...
notification.desc[19] = '<#1442#>';
notification.action_desc[19] = '<#1447#> (5GHz-2)';
...
notification.ftp = 1;
notification.desc[4] = '<#1444#>';
notification.action_desc[4] = '<#849#>';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1443#>';
notification.action_desc[4] = '<#1447#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.desc[5] = '<#1446#>';
notification.action_desc[5] = '<#849#>';
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1445#>';
notification.action_desc[5] = '<#1447#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[8] = "<#1704#>";
...
notification.desc[15] = '<#4150#>';
notification.action_desc[15] = '<#4151#>';
