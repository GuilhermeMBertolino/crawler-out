...
if(info_bar == ''){
$('#recountIcon').hide();
code += '<div class="no-data"><#1237#></div>';
}
else{
$('#recountIcon').show();
...
code += '<div class="table-cell"><#1802#></div>';
code += '<div class="table-cell"><#1235#></div>';
code += '<div class="table-cell"><#1234#></div>';
code += '<div class="table-cell"><#1233#></div>';
code += '</div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1235#>">'+ cat_id_array[cat_id_index].description +'</div>';
var _name = dataObj[eventID].source[0];
if(clientList[_name]){
_name = clientList[_name].name;
}
code += '<div class="table-cell" data-title="<#1234#>">'+ _name +'</div>';
code += '<div class="table-cell" data-title="<#1233#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '</div>';
}
}
else{
...
<div>
<div class="card-bg">
<div class="page-title"><#1312#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1754#></div>
<div class="description"><#1311#></div>
</div>
<div class="tm-logo">
...
<div class="event-hit"><#1304#></div>
</div>
<div class="card-lv1 card-lv1-bg">
<div class="flexbox flex-a-center flex-j-spaceB">
<div class="description"><#1330#></div>
...
<div class="page-title canvas-title"><#1219#></div>
</div>
<div class="canvas-bg">
<div class="chart-title"><#1304#></div>
