...
<title><#869#> - Subnet Management</title>
...
alertMsg("<#4176#>", ipConflict_cp.ipAddr, ipConflict_cp.netLegalRangeStart, ipConflict_cp.netLegalRangeEnd);
return false;
}
}
if(cp_freewifi_support){
...
<tr>
<td align="left">
<span class="formfonttitle"><#791#></span>
...
<th><#2578#></th>
<td>
<input type="radio" value="1" name="radioDHCPEnable" class="content_input_fd" checked><#200#>
<input type="radio" value="0" name="radioDHCPEnable" class="content_input_fd"><#199#>
</td>
</tr>
<tr>
...
<tr>
<th width="200"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,7);"><#2655#></a></th>
<td>
...
<input type="radio" value="1" name="dhcp_static" /><#200#>
<input type="radio" value="0" name="dhcp_static" /><#199#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#2595#>&nbsp;(<#2693#>&nbsp;<span id="max_staticIp_num" style="color:#FFF;">8</span>)</td>
</tr>
</thead>
<tr>
...
<input class="button_gen" type="button" onclick="show_subnet_edit(0);" value="<#212#>">
<input id="saveButton" class="button_gen" type="button" onclick="" value="<#1704#>">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#410#> - <#3348#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#444#></div>
<div style="margin-left:8px; margin-bottom:7px;"> <div style="font-size:12px; font-weight:800;display:table-cell;vertical-align:bottom;"><#445#>&nbsp;(<#2693#>&nbsp;8)</div><div style="display:table-cell;padding-left:6px;"><input id="add_subnet_btn" type="button" class="add_btn" onClick="add_subnet();" value=""></div></div>
...
<tr>
<th style="width:19%"><#3152#></th>
<th style="width:19%"><#331#></th>
<th style="width:19%"><#2601#></th>
<th style="width:19%"><#2599#></th>
<th style="width:10%"><#2591#></th>
<th style="width:7%"><#3094#></th>
<th><#1688#></th>
</tr>
</table>
