...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='" + usb_port_conflict_faq + "' target='_blank' style='text-decoration:underline;color:#FC0;'><#1967#></a>";
...
add_option(document.form.KnownGames, "<#750#>", 0, 1);
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2475#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2477#>&nbsp;(<#2693#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1541#></th>';
html += '<th width="15%"><#2479#></th>';
html += '<th width="15%"><#2481#></th>';
html += '<th width="17%"><#2482#></th>';
html += '<th width="8%"><#2468#></th>';
html += '<th width="17%"><#2476#></th>';
html += '<th width="6%"><#3094#></th>';
html += '<th width="6%"><#1688#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1903#></option>")
.append("<option value='1'><#1910#></option>")
...
$("#vts_port_x").parent().parent().find('th').html('<#2479#><div class="setup_info_icon" style="display:none;"></div>');
if((wan_proto == "v6plus" || wan_proto == "ocnvc") && s46_ports_check_flag && array_ipv6_s46_ports.length > 1){
$(".setup_info_icon").show();
$(".setup_info_icon").click(
function() {
...
<div>&nbsp;</div>
<div class="formfonttitle"><#414#> - <#417#></div>
...
<div><#2465#></div>
<div><#2123#></div>
<div id="FTP_desc"><#2095#></div>
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#417#>&nbspFAQ</a>
</div>
</div>
<div class="formfontdesc hint-color" id="lb_note" style="color:#FFCC00; display:none;"><#2681#></div>
...
<tr>
<th><#2464#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3810#>">
</div>
</td>
</tr>
</tbody>
...
<tr>
<th><#2479#><div class="setup_info_icon" style="display:none;"></div></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2481#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2482#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/unfold_more.svg" align="right" onclick="pullLANIPList(this);" title="<#3205#>">
...
<input class="button_gen" type="button" onclick="cancelProfile();" value="<#212#>">
<input id="saveProfile" class="button_gen" type="button" value="<#1704#>">
</div>
</div>
<div id="footer"></div>
</form>
