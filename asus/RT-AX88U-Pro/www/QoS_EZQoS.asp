...
var category_title = ["", "<#918#>", "<#930#>", "<#922#>", "<#932#>","<#917#>", "<#924#>", "<#934#>"];
...
$("#dualwan_primary_title").html("<#1903#> - "+dualwan_primary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_primary_title").html("<#1903#> - "+dualwan_primary_display);
}
...
$("#dualwan_secondary_title").html("<#1910#> - "+dualwan_secondary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_secondary_title").html("<#1910#> - "+dualwan_secondary_display);
}
...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2736#> - <#926#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#3104#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#3103#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#399#> - <#2736#>";
...
alert("<#3639#> "+ (qos_xobw_orig/1024).toFixed(2));
...
alert("<#3639#> "+(qos_xobw1_orig/1024).toFixed(2));
...
document.form.rb_enable.value = 0;
document.form.re_rb_enable.value = 0;
}
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#353#>");
return false;
}
}
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2716#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#2998#>&nbsp;(<#2693#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1660#>&nbsp;(<#2693#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#3200#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1426#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1426#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2903#></th>';
else
code += '<th style="width:330px"><#2903#></th>';
code += '<th style="width:130px"><#1832#></th>';
code += '<th style="width:130px"><#3569#></th>';
code += '<th style="width:90px"><#2692#></th>';
code += '</tr>';
...
code += '<input type="text" style="margin-left:10px;float:left;width:255px;" class="input_20_table" name="PC_devicename" onkeyup="device_filter(this);check_field();" placeholder="<#1222#>" autocorrect="off" autocapitalize="off" autocomplete="off">';
code += '<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullLANIPList(this);" title="<#3203#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#2475#></td></tr>';
}
else{
...
<!--[if lte IE 6.5.]><script>alert("<#1390#>");</script><![endif]-->
</div>
...
<tr>
<div class="description_down"><#925#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#927#></div>
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2344#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2706#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" id="btn_cancel_priority" type="button" onclick="cancel_priority_panel();" value="<#212#>">
<input class="button_gen" type="button" onclick="save_priority();" value="<#1705#>">
</div>
</td>
</tr>
</form>
...
<#1946#>
<ul>
<li id="function_int_desc"><#1947#></li>
<li id="qos_desc"><#1950#></li>
<li><#1948#></li>
</ul>
<#1949#>
</div>
...
<th><#2272#></th>
<td colspan="2">
<input type="radio" name="nvgfn_enable" class="input" value="1" <% nvram_match("nvgfn_enable", "1", "checked"); %>><#200#>
<input type="radio" name="nvgfn_enable" class="input" value="0" <% nvram_match("nvgfn_enable", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><#1926#></th>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#1954#></div>
</td>
</tr>
<tr id="router_boost_tr" style="display:none">
<th>RouterBoost</th>
<td colspan="2">
<input id="rb_on" name="rb_toggle" onClick="routerboost_enable_setting();" type="radio" <% nvram_match("rb_enable", "1","checked"); %>><label for="rb_on"><#1681#></label>
<input id="rb_off" name="rb_toggle" onClick="routerboost_enable_setting();" type="radio" <% nvram_match("rb_enable", "0","checked"); %>><label for="rb_off"><#1689#></label>
</td>
</tr>
<tr id="qos_type_tr" style="display:none">
<th><#3102#></th>
<td colspan="3">
<input id="int_type" name="qos_type_radio" value="1" onClick="change_qos_type(this.value);" style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link" class="hintstyle" style="display:none;" href="javascript:void(0);" onClick="openHint(20, 5);"><label for="int_type"><#925#></label></a>
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#1957#></label></a>
<input id="bw_limit_type" name="qos_type_radio" value="2" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "2","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 7)"><label for="bw_limit_type"><#168#></label></a>
...
<th><#1464#></th>
<td colspan="2">
<input id="auto" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="auto"><#167#></label>
<input id="manu" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="manu"><#396#></label>
</td>
</tr>
...
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#3569#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1832#></a></th>
<td>
...
<tr>
<td height="30" align="left" valign="top" bgcolor="#4D595D">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#928#></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" >
<div style=" *width:136px;margin-left:300px;" class="titlebtn" align="center" onClick="submitQoS();"><span><#209#></span></div>
</td>
</tr>
</table>
</td>
