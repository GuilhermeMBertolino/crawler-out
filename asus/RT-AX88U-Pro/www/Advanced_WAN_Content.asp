...
(applyData["wan_proto"] == "v6plus" || applyData["wan_proto"] == "ocnvc")){
...
else if(wan_proto == "v6plus" || wan_proto == "ocnvc"){
...
/*
var profile_name_parm = {"title":"<#3722#>", "type":"text", "id":"profile_name", "need_check":true};
$content_container.append(Get_Component_Input(profile_name_parm));
*/
if(type == "user_defined")
var connection_type_options = [{"text":"<#180#>","value":"dhcp", "title":"DHCP"}, {"text":"<#181#>","value":"static"},
{"text":"PPPoE","value":"pppoe"}, {"text":"Bridge","value":"bridge"}];
else{
var connection_type_options = [{"text":"<#180#>","value":"dhcp"}, {"text":"<#181#>","value":"static"},
{"text":"PPPoE","value":"pppoe"}, {"text":"PPTP","value":"pptp"}, {"text":"L2TP","value":"l2tp"}];
if(Softwire46_support){
connection_type_options.push({"text":"<#2514#>","value":"v6plus"});
if(ocnvc_support)
connection_type_options.push({"text":"<#2513#>","value":"ocnvc"});
}
}
var connection_type_parm = {"title": "<#378#>", "id": "wan_proto", "options": connection_type_options, "set_value": "dhcp"}
...
var wan_enabled_parm = {"title":"<#1925#>", "type":"switch", "id":"wan_enable"};
...
var nat_enabled_parm = {"title":"<#1918#>", "type":"switch", "id":"wan_nat_x", "openHint":"7_22", "container_id":"nat_enable_container"};
...
var upnp_enabled_parm = {"title":"<#1469#>", "type":"switch", "id":"wan_upnp_enable", "openHint":"7_23"};
...
var dhcpfilter_enabled_parm = {"title":"<#1469#>", "type":"switch", "id":"wan_dhcpfilter_enable", "container_id":"dhcpfilter_enable_container"};
...
var dot1q_enabled_parm = {"title":"<#3994#>", "type":"switch", "id":"wan_dot1q"};
...
var vid_parm = {"title":"<#3877#> (2-4094)", "type":"text", "id":"wan_vid", "need_check":true, "maxlength":4};
...
$wan_ip_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#2455#>")));
var dhcp_enabled_parm = {"title":"<#2676#>", "type":"switch", "id":"wan_dhcpenable_x", "container_id":"dhcp_enabled_container"};
...
var ip_parm = {"title":"<#309#>", "type":"text", "id":"wan_ipaddr_x", "need_check":true, "maxlength": 15, "openHint":"7_1"};
Get_Component_Input(ip_parm).appendTo($static_wanip_container)
.find("#" + ip_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var subnetmask_parm = {"title":"<#331#>", "type":"text", "id":"wan_netmask_x", "need_check":true, "maxlength": 15, "openHint":"7_2"};
Get_Component_Input(subnetmask_parm).appendTo($static_wanip_container)
.find("#" + subnetmask_parm.id)
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var gateway_parm = {"title":"<#329#>", "type":"text", "id":"wan_gateway_x", "need_check":true, "maxlength": 15, "openHint":"7_3"};
...
$dns_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#2489#>")));
var wandns_enabled_parm = {"title":"<#327#>", "type":"switch", "id":"wan_dnsenable_x", "openHint":"7_12", "container_id": "dnsenable_container"};
...
var dnsserver1_parm = {"title":"<#313#>", "type":"text", "id":"wan_dns1_x", "need_check":true, "maxlength": 15, "openHint":"7_13"};
Get_Component_Input(dnsserver1_parm).appendTo($dns_server_container)
.find("#" + dnsserver1_parm.id)
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var dnsserver2_parm = {"title":"<#315#>", "type":"text", "id":"wan_dns2_x", "need_check":true, "maxlength": 15, "openHint":"7_14"};
...
var dnspriv_options = [{"text":"<#875#>","value":"0"}, {"text":"DNS-over-TLS (DoT)","value":"1"}];
var dnspriv_parm = {"title":"<#3850#>", "id":"dnspriv_enable", "options": dnspriv_options, "set_value": "0", "openHint":"7_35"};
...
var dnspriv_profile_options = [{"text":"<#3840#>","value":"1"}, {"text":"<#3841#>","value":"0"}];
var dnspriv_profile_parm = {"title":"<#3838#>", "id":"dnspriv_profile", "options": dnspriv_profile_options, "set_value": "1", "openHint":"7_36", "container_id":"dnspriv_profile_container"};
...
$dhcp_option_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#2494#>")));
var wan_vendorid_parm = {"title":"<#1775#> (<#2900#> 60)", "type":"text", "id":"wan_vendorid", "need_check":true, "maxlength":126};
...
$("<div>").addClass("title").html(htmlEnDeCode.htmlEncode("<#1776#> (<#2900#> 61)")).appendTo($client_id_container);
...
$account_settings_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#506#>")));
var username_parm = {"title":"<#3616#>", "type":"text", "id":"wan_pppoe_username", "need_check":true, "maxlength":64, "openHint":"7_4"};
Get_Component_Input(username_parm).appendTo($account_settings_container)
.find("#" + username_parm.id)
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
});
var pwd_parm = {"title":"<#504#>", "type":"password", "id":"wan_pppoe_passwd", "need_check":true, "maxlength":64, "openHint":"7_5"};
Get_Component_Input(pwd_parm).appendTo($account_settings_container)
var ppp_auth_options = [{"text":"<#166#>","value":""}, {"text":"PAP","value":"pap"}, {"text":"CHAP","value":"chap"}];
var ppp_auth_parm = {"title": "<#814#>", "id": "wan_pppoe_auth", "options": ppp_auth_options, "set_value": ""}
$account_settings_container.append(Get_Component_Custom_Select(ppp_auth_parm));
var pppoe_idletime_parm = {"title":"<#3035#>", "type":"text", "id":"wan_pppoe_idletime", "need_check":true, "maxlength":10, "openHint":"7_6", "container_id": "idletime_container"};
...
var pppoe_mtu_parm = {"title":"<#3055#> (128 - 1492)", "type":"text", "id":"wan_pppoe_mtu", "need_check":true, "maxlength":5, "openHint":"7_7"};
...
var pppoe_mru_parm = {"title":"<#3053#> (128 - 1492)", "type":"text", "id":"wan_pppoe_mru", "need_check":true, "maxlength":5, "openHint":"7_8"};
...
var pppoe_service_parm = {"title":"<#3061#>", "type":"text", "id":"wan_pppoe_service", "need_check":true, "maxlength":32, "openHint":"7_9"};
...
var pppoe_ac_parm = {"title":"<#3039#>", "type":"text", "id":"wan_pppoe_ac", "need_check":true, "maxlength":32, "openHint":"7_10"};
...
var pppoe_hostuniq_parm = {"title":"Host-Uniq (<#2342#>)", "type":"text", "id":"wan_pppoe_hostuniq", "need_check":true, "maxlength":256, "openHint":"7_18"};
...
var pptp_options = [{"text":"<#166#>","value":"0"}, {"text":"<#2913#>","value":"-mppc"}, {"text":"MPPE 40","value":"+mppe-40"}, {"text":"MPPE 128","value":"+mppe-128"}];
var pptp_option_parm = {"title": "<#3059#>", "id": "wan_pptp_options_x", "options": pptp_options, "set_value": "", "openHint":"7_17", "container_id":"pptp_option_container"}
$account_settings_container.append(Get_Component_Custom_Select(pptp_option_parm));
var ppp_echo_options = [{"text":"<#1550#>","value":"0"}, {"text":"PPP Echo","value":"1"}, {"text":"DNS Probe","value":"2"}];
var ppp_echo_parm = {"title": "<#3043#>", "id": "wan_ppp_echo", "options": ppp_echo_options, "set_value": "0", "openHint":"7_31"}
$account_settings_container.append(Get_Component_Custom_Select(ppp_echo_parm));
var echo_interval_parm = {"title":"<#3046#>", "type":"text", "id":"wan_ppp_echo_interval", "need_check":true, "maxlength":6, "openHint":"7_32"};
Get_Component_Input(echo_interval_parm).appendTo($account_settings_container)
.find("#" + echo_interval_parm.id)
.unbind("keypress").keypress(function(){
return validator.isNumber(this, event);
});
var echo_fail_parm = {"title":"<#3048#>", "type":"text", "id":"dns_delay_round", "need_check":true, "maxlength":6, "openHint":"7_34"};
Get_Component_Input(echo_fail_parm).appendTo($account_settings_container)
.find("#" + echo_fail_parm.id)
.unbind("keypress").keypress(function(){
return validator.isNumber(this, event);
});
var pppoe_options_parm = {"title":"<#3041#>", "type":"text", "id":"wan_pppoe_options_x", "need_check":true, "maxlength":255, "openHint":"7_18"};
...
$special_isp_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#508#>")));
var vpndhcp_parm = {"title":"<#3062#>", "type":"switch", "id":"wan_vpndhcp", "container_id":"vpndhcp_container"};
...
var vpn_parm = {"title":"<#183#>", "type":"text", "id":"wan_heartbeat_x", "need_check":true, "maxlength":256, "openHint":"7_19", "container_id":"vpn_container"};
Get_Component_Input(vpn_parm).appendTo($special_isp_container)
.find("#" + vpn_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
});
var host_name_parm = {"title":"<#3042#>", "type":"text", "id":"wan_hostname", "need_check":true, "maxlength":32, "openHint":"7_15"};
...
$("<a>").addClass("hintstyle").attr({"href":"javascript:void(0);"}).html(htmlEnDeCode.htmlEncode("<#3045#>")).unbind("click").click(function(){
openHint(7,16);
...
.html(htmlEnDeCode.htmlEncode("<#186#>"))
.click(function(){
$("#wan_hwaddr_x").val(login_mac_str());
applyData.wan_hwaddr_x = $("#wan_hwaddr_x").val();
})
.appendTo($mac_settings_container);
var wan_dhcp_qry_options = [{"text":"<#1773#>","value":"0"}, {"text":"<#1771#>","value":"1"}, {"text":"<#4223#>","value":"2"}];
var wan_dhcp_qry_parm = {"title": "<#1770#>", "id": "wan_dhcp_qry", "options": wan_dhcp_qry_options, "set_value": "1", "openHint":"7_30"}
Get_Component_Custom_Select(wan_dhcp_qry_parm).attr({"data-sec-option-id":"dhcp-only"}).appendTo($special_isp_container)
if(type == "internet"){
var ttl_inc_parm = {"title":"<#1942#>", "type":"switch", "id":"ttl_inc_enable", "set_value": "off"};
...
var ttl_spoof_parm = {"title":"<#3315#>", "type":"switch", "id":"ttl_spoof_enable", "set_value": "off"};
...
var wan_mtu_parm = {"title":"<#3055#> (1280-1500)", "type":"text", "id":"wan_mtu", "need_check":true, "maxlength":4};
...
var $btn_container_delete_mobile = $("<div>").addClass("btn_container delete mobile").appendTo($action_container).html("<#1688#>");
var $btn_container_apply = $("<div>").addClass("btn_container apply").attr({"id":"apply_btn"}).appendTo($action_container).html("<#210#>");
...
var var_item0 = new Option("<#180#>", "dhcp");
var var_item1 = new Option("<#181#>", "static");
...
if(Softwire46_support){
var var_item5 = new Option("<#2514#>", "v6plus");
document.form.wan_proto.options.add(var_item5);
if(ocnvc_support){
var var_item6 = new Option("<#2513#>", "ocnvc");
...
if (MSWANList[i][2]=="1") cell[1].innerHTML = "<center><#200#></center>";
else cell[1].innerHTML = "<center><#199#></center>";
...
else if (MSWANList[i][1]=="dhcp") cell[3].innerHTML = "<center><#180#></center>";
else if (MSWANList[i][1]=="bridge") cell[3].innerHTML = "<center>Bridge</center>";
else if (MSWANList[i][1]=="static") cell[3].innerHTML = "<center><#181#></center>";
...
else if (MSWANList[i][1]=="v6plus") cell[3].innerHTML = "<center><#2514#></center>";
else if (MSWANList[i][1]=="ocnvc") cell[3].innerHTML = "<center><#2513#></center>";
...
var msg_iptv = "<#3884#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(cur_wanports_bond));
}
else{
...
else if(Softwire46_support && (proto_type == "lw4o6" || proto_type == "map-e" || proto_type == "v6plus" || proto_type == "ocnvc")){
showhide("wan_DHCP_opt",0);
inputCtrl(document.form.wan_auth_x, 0);
...
document.getElementById("check_mac").innerHTML="<#371#>";
return false;
}else if(flag ==2){
var childsel=document.createElement("div");
childsel.setAttribute("id","check_mac");
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac").innerHTML="<#332#>";
return false;
}else{
...
code +='<tr><td style="color:#FFCC00;" colspan="5"><#2475#></td></tr>';
else{
...
function update_map(){
var msg = stringSafeGet("<#2723#>")+" <#1024#>";
if(confirm(msg)){
$.ajax({
url: "/s46reset.cgi",
success: function( response ) {
...
var DNSListTableCategory=["<#322#>", "<#323#>", "<#324#>", "Safe", "<#325#>"];
var code="";
code += "<div style='margin-top:15px;margin-left:15px;float:left;font-size:15px;color:#93A9B1;'><#321#></div>";
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='4'><#1690#>";
code += "</td></tr></thead>";
code += "<tr id='tr_default_title' height='40px'>";
code += "<th width='5%'></th>";
code += "<th width='15%'><#639#></th>";
code += "<th width='80%'><#2354#></th></tr>";
code += "<tr id='tr_auto_option' height='40px'>";
code += "<td><input name='DNS_service_opt' id='dns_auto' type='radio' class='input'></td>";
code += "<td>ISP</td>";
code += "<td style='padding:10px;text-align:left;'><#311#></td></tr>";
code += "</table>";
code += "</td></tr>";
...
code += "<th width='5%'></th>";
code += "<th width='15%'><#639#></th>";
code += "<th width='15%'><#2354#></th>";
code += "<th width='65%'><#1754#></th></tr>";
...
var description_temp = "<a href='"+DNSService[idx].url+"' target='_blank' style='text-decoration:underline;'> <b><#2683#></b></a>";
...
code += "<tr><td>";
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='4'><#396#>";
code += "</td></tr></thead>";
...
code += "<input id='button_dns_cancel' class='button_gen' type='button' onclick='closeDNSListView()' value='<#212#>'>";
code += "<input id='button_dns_ok' class='button_gen' type='button' onclick='Update_DNS_service()' style='margin-left:15px;' value='<#1705#>'>";
code += "</div>";
...
DSN_status_info="<b>Default status :</b> <#311#>";
}
else{
DNS_list_index=DNSList_match(document.form.wan_dns1_x.value, document.form.wan_dns2_x.value);
if(DNS_list_index >= 0){
DSN_status_info = "<b><#260#>:</b> "+DNSService[DNS_list_index].FilterMode; /* Untranslated */
DSN_status_info += "<br><b><#1541#>:</b> "+DNSService[DNS_list_index].DNSService; /* Untranslated */
DSN_status_info += "<br><b><#510#>:</b> "+document.form.wan_dns1_x.value+", "+document.form.wan_dns2_x.value; /* Untranslated */
}
else{
DSN_status_info = "<b><#510#>:</b> "+document.form.wan_dns1_x.value; /* Untranslated */
...
<div>&nbsp;</div>
<div class="formfonttitle"><#414#> - <#415#></div>
<div style="margin: 10px 0 10px 5px;" class="splitLine"></div>
<div id="desc_default" class="formfontdesc"><#1856#></div>
<div id="desc_edit" class="formfontdesc"><#2675#></div>
...
<th style="width:20%;"><center><#2468#></center></th>
<th style="width:10%;"><center><#2393#></center></th>
<th style="width:10%;"><center><#3094#></center></th>
<th style="width:10%;" id="MS_WAN_add_del"><center><#1688#></center></th>
</tr>
</table>
...
<option value="dhcp" <% nvram_match("wan_proto", "dhcp", "selected"); %>><#180#></option>
<option value="static" <% nvram_match("wan_proto", "static", "selected"); %>><#181#></option>
...
<div id="s46reset_btn" style="margin-left: 5px;"><input type="button" class="button_gen" onclick="update_map();" value="<#2722#>"></div>
...
<th><#1925#></th>
<td>
<input type="radio" name="wan_enable" class="input" value="1" <% nvram_match("wan_enable", "1", "checked"); %>><#200#>
<input type="radio" name="wan_enable" class="input" value="0" <% nvram_match("wan_enable", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,22);"><#1918#></a></th>
<td>
<input type="radio" name="wan_nat_x" class="input" value="1" <% nvram_match("wan_nat_x", "1", "checked"); %>><#200#>
<input type="radio" name="wan_nat_x" class="input" value="0" <% nvram_match("wan_nat_x", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,23);"><#1469#></a></th>
<td>
<input type="radio" name="wan_upnp_enable" class="input" value="1" onclick="return change_common_radio(this, 'LANHostConfig', 'wan_upnp_enable', '1')" <% nvram_match("wan_upnp_enable", "1", "checked"); %>><#200#>
<input type="radio" name="wan_upnp_enable" class="input" value="0" onclick="return change_common_radio(this, 'LANHostConfig', 'wan_upnp_enable', '0')" <% nvram_match("wan_upnp_enable", "0", "checked"); %>><#199#>
</td>
</tr>
<tr style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#1469#></a></th>
<td>
<input type="radio" name="wan_dhcpfilter_enable" class="input" value="1" <% nvram_match("wan_dhcpfilter_enable", "1", "checked"); %>><#200#>
<input type="radio" name="wan_dhcpfilter_enable" class="input" value="0" <% nvram_match("wan_dhcpfilter_enable", "0", "checked"); %>><#199#>
</td>
</tr>
<tr style="display:none;">
<th><#3880#></th>
<td>
<input type="radio" name="bond_wan_radio" class="input" value="1" onclick="return change_common_radio(this, 'LANHostConfig', 'bond_wan', '1')" <% nvram_match("bond_wan", "1", "checked"); %>><#200#>
<input type="radio" name="bond_wan_radio" class="input" value="0" onclick="return change_common_radio(this, 'LANHostConfig', 'bond_wan', '0')" <% nvram_match("bond_wan", "0", "checked"); %>><#199#>
<div id="wanAgg_desc" style="color:#FFCC00;"><#3879#></div>
...
<th><#3994#></th>
<td>
<input type="radio" name="wan_dot1q" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'wan_dot1q', 1);" <% nvram_match("wan_dot1q", "1", "checked"); %>><#200#>
<input type="radio" name="wan_dot1q" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'wan_dot1q', 0);" <% nvram_match("wan_dot1q", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th>VLAN ID</th>
...
<th><#2676#></th>
<td>
<input type="radio" name="wan_dhcpenable_x" class="input" value="1" onclick="change_wan_dhcp_enable(0);" <% nvram_match("wan_dhcpenable_x", "1", "checked"); %>><#200#>
<input type="radio" name="wan_dhcpenable_x" class="input" value="0" onclick="change_wan_dhcp_enable(0);" <% nvram_match("wan_dhcpenable_x", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,1);"><#309#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,2);"><#331#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,3);"><#329#></a></th>
<td>
...
<th><#2676#></th>
<td>
<input type="radio" name="wan_s46_dhcpenable_x" class="input" value="1" onclick="change_wan_dhcp_enable(0);" <% nvram_match("wan_dhcpenable_x", "1", "checked"); %>><#200#>
<input type="radio" name="wan_s46_dhcpenable_x" class="input" value="0" onclick="change_wan_dhcp_enable(0);" <% nvram_match("wan_dhcpenable_x", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
...
<a id="s46_ipaddr_hint" class="hintstyle" href="javascript:void(0);" onClick="openHint(7,1);" style="display:none"><#309#></a>
</th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2496#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2518#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,12);"><#510#></a></th>
<td>
<div id="DNS_status"></div>
<div id="DNS_Assign_splitLine" style="margin:10px 0 5px 0;"></div>
<div id="DNS_Assign_desc"><#1827#></div>
<div id="DNS_Assign_button" style="text-align:right;"><input id="assign_button" type="button" class="button_gen" onclick="Assign_DNS_service()" value="<#211#>"></div>
</td>
</tr>
<tr style="display:none">
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,35);"><#3850#></a>
</th>
<td align="left">
<select id="dnspriv_enable" class="input_option" name="dnspriv_enable" onChange="change_dnspriv_enable(this.value);">
<option value="0" <% nvram_match("dnspriv_enable", "0", "selected"); %>><#875#></option>
...
<tr style="display:none">
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,36);"><#3838#></a>
</th>
<td>
<input type="radio" name="dnspriv_profile" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'dnspriv_profile', 1)" <% nvram_match("dnspriv_profile", "1", "checked"); %> /><#3840#>
<input type="radio" name="dnspriv_profile" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'dnspriv_profile', 0)" <% nvram_match("dnspriv_profile", "0", "checked"); %> /><#3841#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="5"><#3842#>&nbsp;(<#2693#>&nbsp;8)</td>
</tr>
</thead>
<tr>
<th><a href="javascript:void(0);" onClick="openHint(7,37);"><div class="table_text"><div class="table_text"><#309#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,38);"><div class="table_text"><div class="table_text"><#3844#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,39);"><div class="table_text"><div class="table_text"><#3846#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,40);"><div class="table_text"><div class="table_text"><#3848#></div></a></th>
<th><#2692#></th>
</tr>
<tr>
...
<thead>
<tr><td colspan="2"><#2494#></td></tr>
</thead>
<tr>
<th width="40%"><#1775#> (<#2900#> 60):</th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,29);"><#3031#></a>
</th>
<td align="left">
<select class="input_option" name="wan_auth_x" onChange="change_wan_type(document.form.wan_proto.value);">
<option value="" <% nvram_match("wan_auth_x", "", "selected"); %>><#875#></option>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,4);"><#3616#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,5);"><#504#></a>
</th>
<td>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd);"><#640#></div>
</td>
</tr>
<tr style="display:none">
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#814#></a>
</th>
<td>
<select class="input_option" name="wan_pppoe_auth">
<option value="" <% nvram_match("wan_pppoe_auth", "", "selected"); %>><#166#></option>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#3035#></a>
</th>
<td>
<input type="text" maxlength="10" class="input_12_table" name="wan_pppoe_idletime" value="<% nvram_get("wan_pppoe_idletime"); %>" onkeypress="return validator.isNumber(this,event)" autocorrect="off" autocapitalize="off"/>&nbsp<#3196#>
<input type="checkbox" style="margin-left:30;display:none;" name="wan_pppoe_idletime_check" value="" />
</td>
</tr>
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,7);"><#3055#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,8);"><#3053#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,9);"><#3061#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,10);"><#3039#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);">Host-Uniq (<#2342#>)</a>
</th>
<td align="left">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,17);"><#3059#></a>
</th>
<td>
<select name="wan_pptp_options_x" class="input_option">
<option value="" <% nvram_match("wan_pptp_options_x", "","selected"); %>><#166#></option>
<option value="-mppc" <% nvram_match("wan_pptp_options_x", "-mppc","selected"); %>><#2913#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,31);"><#3043#></a></th>
<td>
<select name="wan_ppp_echo" class="input_option" onChange="ppp_echo_control();">
<option value="0" <% nvram_match("wan_ppp_echo", "0","selected"); %>><#1550#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,32);"><#3046#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,33);"><#3048#></a></th>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);"><#3041#></a>
</th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,19);"><#183#></a></th>
<td>
...
<tr id="vpn_dhcp">
<th><#3062#></th>
<td><input type="radio" name="wan_vpndhcp" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'wan_vpndhcp', 1)" <% nvram_match("wan_vpndhcp", "1", "checked"); %> /><#200#>
<input type="radio" name="wan_vpndhcp" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'wan_vpndhcp', 0)" <% nvram_match("wan_vpndhcp", "0", "checked"); %> /><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,15);"><#3042#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,16);"><#3045#></a></th>
<td>
...
<input type="button" class="btn_subusage my-1 button_gen" onclick="showMAC();" value="<#186#>">
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,30);"><#1770#></a></th>
<td>
<select name="wan_dhcp_qry" class="input_option">
<option value="0" <% nvram_match("wan_dhcp_qry", "0","selected"); %>><#1773#></option>
<option value="1" <% nvram_match("wan_dhcp_qry", "1","selected"); %>><#1771#></option>
<option value="2" <% nvram_match("wan_dhcp_qry", "2","selected"); %>><#4223#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#1942#></a></th>
<td>
<input type="radio" name="ttl_inc_enable" class="input" value="1" <% nvram_match("ttl_inc_enable", "1", "checked"); %>><#200#>
<input type="radio" name="ttl_inc_enable" class="input" value="0" <% nvram_match("ttl_inc_enable", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#3315#></a></th>
<td>
<input type="radio" name="ttl_spoof_enable" class="input" value="1" <% nvram_match("ttl_spoof_enable", "1", "checked"); %>><#200#>
<input type="radio" name="ttl_spoof_enable" class="input" value="0" <% nvram_match("ttl_spoof_enable", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th>
...
<input class="actionButtonCancel button_gen" onclick="exit_to_main();" type="button" value="<#212#>">
<input class="button_gen" onclick="applyRule();" type="button" value="<#1704#>"/>
</div>
</td>
</tr>
</tbody>
