...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2736#> - <#1957#>";
}
else{
...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#750#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2716#>");
return false;
}
}
replace_symbol();
...
alert("<#3638#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#2344#></option>';
else
code += '<option value="0"><#2344#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#2343#></option>';
else
code += '<option value="1"><#2343#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2729#></option>';
else
code += '<option value="2"><#2729#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2705#></option>';
else
code += '<option value="3"><#2705#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2706#></option>';
else
code += '<option value="4"><#2706#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#3104#></option>
<option value="3"><#3103#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1540#>&nbsp;(<#2693#>&nbsp;32)</td>
...
<tr>
<th><#1541#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1542#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1543#></div></a></th>
<th><div class="table_text"><#2468#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#3620#></div></a></th>
<th><#1544#></th>
<th><#2692#></th>
</tr>
<tr>
<td width="20%">
<input type="text" maxlength="32" class="input_12_table" style="float:left;width:105px;" placeholder="<#750#>" name="qos_service_name_x_0" onKeyPress="return validator.isString(this, event)" autocorrect="off" autocapitalize="off">
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullQoSList(this);" title="<#3208#>">
...
<img id="pull_arrow_mac" class="pull_arrow"height="14px;" src="/images/unfold_more.svg" onclick="pullLANIPList(this);" title="<#3203#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#2344#></option>
<option value='1' selected><#2343#></option>
<option value='2'><#2729#></option>
<option value='3'><#2705#></option>
<option value='4'><#2706#></option>
</select>
</td>
<td width="6%">
