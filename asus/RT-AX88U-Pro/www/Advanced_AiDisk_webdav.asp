...
<div class="formfontdesc"><#3579#></div>
...
<option value="0" <% nvram_match("enable_webdav", "0","selected"); %> ><#3995#></option>
<option value="1" <% nvram_match("enable_webdav", "1","selected"); %> ><#3994#></option>
</select>
</td>
</tr>
