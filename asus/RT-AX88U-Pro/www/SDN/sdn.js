...
var $pwd_strength_container = $("<div>").addClass("pwd_strength_container").attr("id", "scorebarBorder"+postfix).attr("title", "<#376#>");
...
var str_SDN_choose = stringSafeGet("<#2326#>");
var str_WiFi_sche = stringSafeGet("<#2332#>");
var str_Scheduled = stringSafeGet("<#3401#>");
var str_Scheduled_one_time = stringSafeGet("<#3402#>");
var str_noProfile_hint = stringSafeGet("<#2322#>");
var str_GuestNetwork_WiFi_Sche_desc = stringSafeGet("<#2333#>");
var str_Scenario_Classroom = stringSafeGet("<#3182#>");
var str_Scenario_coffee = stringSafeGet("<#3183#>");
var str_Scenario_Study = stringSafeGet("<#3189#>");
var str_Scenario_EV_charging = stringSafeGet("<#3184#>");
var str_Scenario_smartHome = stringSafeGet("<#3190#>");
var str_Scenario_branchOffice = stringSafeGet("<#3181#>");
var str_Scenario_Hotel = stringSafeGet("<#3186#>");
var str_Scenario_Mall = stringSafeGet("<#3187#>");
var str_Scenario_Friends = stringSafeGet("<#3185#>");
var str_GuestNetwork_Portal_desc2 = stringSafeGet("<#2312#>");
var str_GuestNetwork_Wizard_type_desc0 = stringSafeGet("<#2335#>");
var str_GuestNetwork_Employee_recommend = stringSafeGet("<#2303#>");
...
let result = options;
let support_6G = false;
if(get_wl_unit_by_band("6G") != ""){//Check CAP supoort 6G
support_6G = true;
}
else{
$.each(cfg_clientlist, function(index, node_info){//Check RE supoort 6G
if(support_6G) return false;
let wifi_band_info = httpApi.aimesh_get_node_wifi_band(node_info);
let band_6G = wifi_band_info.filter((item)=>{
...
return (el.value != "4" && el.value != "5" && el.value != "6");
});
}
result = options.filter((el) => {
...
cp_text_map.push({"id":"1", "text":"<#4176#> WiFi"});
...
cp_text_map.push({"id":"4", "text":`<#2740#>`});
}
...
{"type":"Employee", "text":"<#2301#>", "desc":"<#2302#>"},
{"type":"Portal", "text":"<#2310#>", "desc":"<#2312#>"},
{"type":"Guest", "text":"<#299#>", "desc":"<#2294#>"},
{"type":"Kids", "text":"<#2308#>", "desc":"<#2309#>"},
{"type":"IoT", "text":"<#2305#>", "desc":"<#2306#>"},
{"type":"VPN", "text":"<#2315#>", "desc":"<#2316#>"},
{"type":"Customized", "text":"<#2300#>", "desc":""},
];
if(isSupport("BUSINESS")){
...
specific_wizard_type.text = "<#2325#>";
...
show_customize_alert("<#4356#>".replace("#MAXNUM", sdn_maximum));
return false;
}
selected_sdn_idx = "";
...
$("<div>").addClass("main_info").html("<#2323#>").appendTo($item_text_container);
...
var $profile_item_container = $("<div>").addClass("profile_item_container " + sdn_type + "").attr("sdn_idx", _profile_data.sdn_idx);
var $item_tag_cntr = $("<div>").addClass("item_tag_container").appendTo($profile_item_container);
if(specific_data.sdn_rl.vpnc_idx != "0"){
$("<div>").addClass("item_tag VPN").html("<#3813#>").appendTo($item_tag_cntr);
}
if(specific_data.sdn_rl.vpns_idx != "0"){
$("<div>").addClass("item_tag VPN").html("<#183#>").appendTo($item_tag_cntr);
}
...
$("<div>").addClass("item_tag no_icon").html(`<#2740#>`).appendTo($item_tag_cntr);
}
...
.attr({"title":"<#586#>: " + _profile_data.name})
...
$("<div>").addClass("clients_num").attr({"title":"<#2927#>"}).html(htmlEnDeCode.htmlEncode(_profile_data.client_num)).appendTo($sub_info);/* untranslated */
...
show_customize_alert("<#3789#>".replace(/VPN/g, "<#2314#>").replace(/2/g, "1"));
return;
}
...
if(wifi_band & 2 || wifi_band & 4){
wifi_band_arr.push("5G");
}
if(wifi_band & 16 || wifi_band & 64){
wifi_band_arr.push("6G");
}
return false;
}
});
if(wifi_band_arr.length == 0){
conn_type = [{"type": "LAN", "text": "<#3428#>"}];
return conn_type;
}
if(_sdn_data.sdn_rl.wifi_sched_on == "0"){
conn_type = [{"type": "WiFi_offline", "text": "<#3429#> (<#1578#>)"}];
return conn_type;
}
...
band_info.text = `${((band == "2G") ? "2.4" : band.substring(0,1))} GHz <#3429#>`;
conn_type.push(band_info);
});
return conn_type;
}
}
...
var $item_text_container = $("<div>").addClass("item_text_container");
$item_text_container.appendTo($profile_item_container);
$("<div>").addClass("main_info").html("<#2300#>").appendTo($item_text_container);
var $item_action_container = $("<div>").addClass("item_action_container");
$item_action_container.appendTo($profile_item_container);
$("<div>").addClass("icon_add").appendTo($item_action_container);
return $profile_item_container;
...
var $item_text_container = $("<div>").addClass("item_text_container");
$item_text_container.appendTo($profile_item_container);
$("<div>").addClass("main_info").html("<#2330#>").appendTo($item_text_container);
var $item_action_container = $("<div>").addClass("item_action_container");
$item_action_container.appendTo($profile_item_container);
$("<div>").addClass("icon_add").appendTo($item_action_container);
return $profile_item_container;
...
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2330#>").addClass("Scenarios").appendTo($container)
...
$("<div>").html(htmlEnDeCode.htmlEncode("<#1549#>")).appendTo($title);
var $item_scenarios_cntr = $("<div>").addClass("item_scenarios_container").appendTo($content_container);
$("<div>").addClass("title").html("<#2327#>").appendTo($item_scenarios_cntr);
...
{"type":"Employee", "title":"<#2301#>", "desc":str_GuestNetwork_Wizard_type_desc0+" "+str_GuestNetwork_Employee_recommend},
{"type":"Portal", "title":"<#2310#>", "desc":str_GuestNetwork_Portal_desc2},
{"type":"Guest", "title":"<#299#>", "desc":"<#2294#>"},
{"type":"Sched", "title":"<#2325#>", "desc":str_GuestNetwork_WiFi_Sche_desc},
{"type":"IoT", "title":"<#2305#>", "desc":"<#2306#>"}
];
...
var $container = $("<div>").addClass("setting_content_container");
Get_Component_Popup_Profile_Title("<#321#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
$("<div>").addClass("btn_container apply").html("<#1704#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
$("<div>").addClass("service").html("<#639#>").appendTo($item_title_cntr);
$("<div>").addClass("server").html("<#2354#>").appendTo($item_title_cntr);
$("<div>").addClass("desc").html("<#1754#>").appendTo($item_title_cntr);
...
desc += "&nbsp;";
desc += $("<a/>").attr({"href":dns_item.url, "target":"_blank"}).css({"text-decoration":"underline"}).html("<b><#2683#></b>")[0].outerHTML;
}
...
var $cate_title = $("<div>").addClass("category_title").html("<#396#>").appendTo($dns_list_cntr);
var $item_title_cntr = $("<div>").addClass("item_container").appendTo($dns_list_cntr);
$("<div>").addClass("radio").appendTo($item_title_cntr);
$("<div>").addClass("service").html("<#639#>").appendTo($item_title_cntr);
$("<div>").addClass("server").html("<#2354#>").appendTo($item_title_cntr);
...
$("<div>").html("<#313#>").appendTo($service);
$("<div>").html("<#315#>").appendTo($service);
...
$("<div>").addClass("service").html("<#3227#>").appendTo($default_item_title_cntr);
...
$("<div>").html(htmlEnDeCode.htmlEncode("<#1549#>")).appendTo($btn_back_cntr);
...
var $FWF_change_bg = $("<div>").addClass("FWF_change_bg").attr({"title":"<#4197#>"}).appendTo($FWF_bg);
...
$("<div>").attr({"data-component":"FWF_brand_name"}).addClass("brand_name").html("<#4230#>").appendTo($FWF_text_info_cntr);
...
$("<div>").addClass("cb_text").html("<#4269#>").appendTo($cb_text_container);
...
$("<div>").addClass("btn_container").html("<#4270#>").appendTo($("<div>").addClass("action_container").appendTo($action_info_cntr))
return $container;
}
...
var $MB_change_bg = $("<div>").addClass("MB_change_bg").attr({"title":"<#4197#>"}).appendTo($MB_bg);
...
$("<div>").attr({"data-component":"MB_desc"}).addClass("MB_desc").html("<#1754#>").appendTo($MB_text_info_cntr);
var $action_info_cntr = $("<div>").addClass("action_info_cntr").appendTo($MB_portal_cntr);
$("<div>").addClass("btn_container").html("<#4270#>").appendTo($("<div>").addClass("action_container").appendTo($action_info_cntr))
return $container;
}
function Get_Upload_Image_Container(_callback){
var $bg_upload_image = $("<div>").addClass("bg_upload_image").attr({"title":"<#4263#>"});
...
{"type":"Employee", "title":"<#2301#>", "desc":str_GuestNetwork_Wizard_type_desc0+" "+str_GuestNetwork_Employee_recommend},
{"type":"Portal", "title":"<#2310#>", "desc":str_GuestNetwork_Portal_desc2+" "+stringSafeGet("<#2313#>")},
{"type":"Guest", "title":"<#299#>", "desc":"<#2294#> "+stringSafeGet("<#2295#>")},
{"type":"Kids", "title":"<#2308#>", "desc":str_GuestNetwork_WiFi_Sche_desc+" "+stringSafeGet("<#2334#>")},
{
"type":"IoT","title":`<#2305#>`,
"desc":`
...
enable the "<#2331#>" option. This is perfect for everyday control devices that require frequent monitoring and management.
<br>
To enhance security, disable the "<#2331#>" option and establish a dedicated,
isolated network that shields your IoT devices from external threats.
`/* untranslated */
},
{"type":"VPN", "title":"<#2315#>", "desc":stringSafeGet("<#2317#>")}
];
if(isSwMode("ap")){
...
if(specific_wizard_type != undefined){
specific_wizard_type.type = "Sched";
specific_wizard_type.title = "<#2325#>";
}
}
else{
wizard_type_list = wizard_type_list.filter(function(item, index, array){
...
$("<div>").addClass("title").html("<#2907#>").appendTo($popup_title_container);
...
$("<div>").addClass("title").html("<#2909#>").appendTo($feature_desc_cntr);
$("<div>").addClass("desc").html(
stringSafeGet("<#3392#>")+" "+stringSafeGet("<#3393#>")+" "+stringSafeGet("<#3394#>")
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup")
$container.append(Get_Component_Popup_Profile_Title("<#702#>"));
...
if(isSupport("SMART_HOME_MASTER_UI")){
$("<div>").addClass("title").html(htmlEnDeCode.htmlEncode(`<#299#>`)).appendTo($content_container);
...
.html(htmlEnDeCode.htmlEncode(item.cp_text + " (<#765#>)"))
}
});
...
.after($("<div>").html("<#3789#>".replace(/VPN/g, "<#2314#>").replace(/2/g, "1")).addClass("item_hint"));
}
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2301#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2301#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#586#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
});
var security_options = [{"text":"<#2363#>","option_id":"pwd"}, {"text":"<#408#>","option_id":"radius"}];
var security_parm = {"title":"<#747#>", "options": security_options, "container_id":"security_employee"};
...
.filter((()=>{
return get_elem_attr_wifi_auth(wifi_band);
})()).show();
resize_iframe_height();
...
let wifi_auth_options = [{"text":"WPA2-Personal","value":"psk2"},{"text":"WPA/WPA2-Personal","value":"pskpsk2"},{"text":"WPA2/WPA3-Personal","value":"psk2sae"}];
var wifi_auth_options_parm = {"title": "<#3930#>", "id": "wifi_auth", "options": wifi_auth_options, "set_value": "psk2"};
...
let wifi_auth_options_6G_parm = {"title": `<#3930#>`, "id": "wifi_auth_6G", "options": wifi_auth_options_6G, "set_value": "sae"};
...
var wifi_auth_radius_options_parm = {"title": "<#3930#>", "id": "wifi_auth_radius", "options": wifi_auth_radius_options, "set_value": "wpa2"};
...
let wifi_auth_radius_options_6G_parm = {"title": "<#3930#>", "id": "wifi_auth_radius_6G", "options": wifi_auth_radius_options_6G, "set_value": "wpa3"};
...
var sdn_pwd_parm = {"title":"<#587#>", "type":"password", "id":"sdn_pwd", "need_check":true, "maxlength":32, "openHint":"0_7"};
...
var radius_ipaddr_parm = {"title":"<#3922#>", "type":"text", "id":"radius_ipaddr", "need_check":true, "maxlength":15, "openHint":"2_1"};
...
var radius_port_parm = {"title":"<#3926#>", "type":"text", "id":"radius_port", "need_check":true, "maxlength":5, "openHint":"2_2"};
...
var radius_key_parm = {"title":"<#3924#>", "type":"password", "id":"radius_key", "need_check":true, "maxlength":64, "openHint":"2_3"};
...
var more_config_parm = {"title":"<#2851#>", "id":"more_config", "slide_target":"more_config_cntr"};
...
var wifi_band_options_parm = {"title": "WiFi <#2391#>", "id": "wifi_band", "options": wifi_band_options, "set_value": "3"};
...
var aimesh_parm = {"title":"<#4375#>", "id":"wizard_aimesh", "slide_target":"wizard_aimesh_cntr"};
...
if(isSwMode("rt")){
var bw_enabled_parm = {"title":"<#168#>", "type":"switch", "id":"bw_enabled", "set_value":"off"};
...
var bw_parm = {"title":"<#1464#> (Mb/s)", "container_id":"container_bw",
...
var access_intranet_parm = {"title":"<#898#>", "type":"switch", "id":"access_intranet", "openHint":"0_26"};
Get_Component_Switch(access_intranet_parm).appendTo($more_config_cntr);
}
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
$("<div>").addClass("btn_container apply").html("<#209#>").appendTo($action_container);
...
var $container = $("<div>").addClass("setting_content_container");
var profile_title = ((isSupport("BUSINESS")) ? "<#2325#>" : "<#2308#>");
if(view_mode == "popup"){
...
if(isSwMode("rt")){
if(get_cp_type_support("4")){
var portal_options = [{"text":"<#875#>", "value":"0"}];
cp_type_rl_json.forEach(function(item){
if(item.cp_idx == "2")
return;
portal_options.push({"text":item.cp_text, "value":item.cp_idx});
});
var portal_options_parm = {"title": "<#2314#>", "id": "portal_type", "options": portal_options};
...
var MB_desc_parm = {"title":"<#1754#>", "type":"text", "id":"MB_desc", "need_check":true, "maxlength":80, "set_value":"<#1754#>"};
...
"type_2":"text", "id_2":"bw_ul", "maxlength_2":12, "need_check_2":true};
Get_Component_Bandwidth_Setting(bw_parm).attr({"data-group":"wifi_settings"}).hide().appendTo($more_config_cntr);
var access_intranet_parm = {"title":"<#898#>", "type":"switch", "id":"access_intranet", "openHint":"0_26", "set_value":"off"};
Get_Component_Switch(access_intranet_parm).appendTo($more_config_cntr);
}
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
$("<div>").addClass("btn_container apply").html("<#209#>").appendTo($action_container);
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("VPN <#2882#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("VPN <#2882#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#586#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2305#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2305#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#586#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
$("<div>").attr({"id":"sdn_pwd_strength", "data-group":"wifi_settings"}).append(Get_Component_PWD_Strength_Meter()).appendTo($content_container).hide();
if(isSwMode("rt")){
let use_main_subnet_parm = {"title":`<#2331#>`, "type":"switch", "id":"use_main_subnet", "set_value":"on"};
Get_Component_Switch(use_main_subnet_parm).appendTo($content_container);
}
var more_config_parm = {"title":"<#2851#>", "id":"more_config", "slide_target":"more_config_cntr"};
Get_Component_Slide_Title(more_config_parm).appendTo($content_container);
var $more_config_cntr = $("<div>").attr({"data-slide_target": "more_config_cntr"}).hide().appendTo($content_container);
var wifi_band_options_parm = {"title": "WiFi <#2391#>", "id": "wifi_band", "options": wifi_band_options, "set_value": "1"};
var $sel_wifi_band = Get_Component_Custom_Select(wifi_band_options_parm).appendTo($more_config_cntr).find("#select_" + wifi_band_options_parm.id + "");
$sel_wifi_band.children("div").click(function(e){
var options = $(this).attr("value");
var $profile_setting = $(this).closest(".profile_setting");
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#299#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#299#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#586#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
var security_options = [{"text":"Open System","option_id":"open"}, {"text":"<#2363#>","option_id":"pwd"}];
var security_parm = {"title":"<#747#>", "options": security_options, "container_id":"security_guest"};
Get_Component_Switch_Text(security_parm).attr({"data-group":"wifi_settings"}).appendTo($content_container)
.find(".switch_text_container > .switch_text_item")
.click(function(e){
e = e || event;
...
.html(()=>{return ((options == "4" || options == "5" || options == "6") ? `<#4388#>` : `Open System`);});
}
}
if($wifi_settings_objs.find("#bw_enabled").length > 0){
if($wifi_settings_objs.find("#bw_enabled").hasClass("on")){
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2300#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2300#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#586#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
if(isSwMode("rt")){
let use_main_subnet_parm = {"title":`<#2331#>`, "type":"switch", "id":"use_main_subnet", "set_value":"off"};
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2310#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2310#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#586#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
var FWF_brand_name_parm = {"title":"<#4230#>", "type":"text", "id":"FWF_brand_name", "need_check":true, "maxlength":40};
...
$("<div>").addClass("title").attr({"data-container":"profile_title"}).html("<#1849#>").appendTo($title_cntr);
...
var general_parm = {"title":"<#404#>", "id":"category_general", "slide_target":"category_general_cntr"};
...
var adv_parm = {"title":"<#402#>", "id":"category_adv", "slide_target":"category_adv_cntr"};
...
var aimesh_parm = {"title":"<#4375#>", "id":"category_aimesh", "slide_target":"category_aimesh_cntr"};/* untranslated */
...
$("<div>").attr({"data-component":"del_btn"}).addClass("btn_container delete mobile").appendTo($action_container).html("<#1688#>");
$("<div>").attr({"data-component":"apply_btn"}).addClass("btn_container apply").appendTo($action_container).html("<#209#>");
if(isSwMode("rt")){
...
var client_tab_options = [{"text":"<#1581#>","option_id":"all"}, {"text":"<#3428#>","option_id":"wired"}, {"text":"<#3429#>","option_id":"wireless"}];
var client_tab_parm = {"title":"<#1660#> : 0 <#1580#>", "options": client_tab_options, "container_id":"client_tab"};
...
$client_num.html("<#1660#> : " + sdn_clientlist_data.length + " <#1580#>");
...
Get_FWF_Change_BG_Container().hide().appendTo($FWF_ui_cntr);
var FWF_conntimeout_parm = {"title":"<#4254#> (<#2743#>)", "type":"text", "id":"FWF_conntimeout", "need_check":true, "maxlength":3, "set_value":"60", "openHint":"31_3"};
Get_Component_Input(FWF_conntimeout_parm).appendTo($freewifi_cntr)
.find("#" + FWF_conntimeout_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isNumber(this,event);
});
var FWF_redirecturl_parm = {"title":"<#4234#> (<#4238#>)", "type":"text", "id":"FWF_redirecturl", "maxlength":256};
Get_Component_Input(FWF_redirecturl_parm).appendTo($freewifi_cntr);
var FWF_passcode_enabled_parm = {"title":"<#4265#>", "type":"switch", "id":"FWF_passcode_enabled", "set_value":"off"};
...
var FWF_passcode_parm = {"title":"<#4264#>", "type":"text", "id":"FWF_passcode", "need_check":true, "maxlength":64, "container_id":"container_FWF_passcode"};
Get_Component_Input(FWF_passcode_parm).hide().appendTo($freewifi_cntr);
var FWF_terms_service_enabled_parm = {"title":"<#4235#>", "type":"switch", "id":"FWF_terms_service_enabled", "set_value":"on"};
...
"title":"<#4257#>", "id":"FWF_terms_service", "rows":"8", "cols":"55", "need_check":true, "maxlength":"5120", "set_value":parm_terms_service,
...
var MB_desc_parm = {"title":"<#1754#>", "type":"text", "id":"MB_desc", "need_check":true, "maxlength":80};
Get_Component_Input(MB_desc_parm).appendTo($message_board_cntr)
.find("#" + MB_desc_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
...
var $btn_container_delete_mobile = $("<div>").attr({"id":"del_btn"}).addClass("btn_container delete mobile").appendTo($action_container).html("<#1688#>");
var $btn_container_apply = $("<div>").attr({"id":"apply_btn"}).addClass("btn_container apply").appendTo($action_container).html("<#209#>");
$content_container.find("[need_check=true]").keyup(function(){
...
$("<div>").addClass("subtab_item").attr({"subtab":"net"}).html("<#2882#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
$("<div>").addClass("subtab_item").attr({"subtab":"client"}).html("<#2176#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
$(this).closest(".Setting_SubTab_Container").find(".subtab_item").removeClass("selected");
$(this).addClass("selected");
...
.filter((()=>{
return get_elem_attr_wifi_auth(options);
})()).show();
}
}
if($wifi_settings_objs.find("#bw_enabled").length > 0){
...
var security_radius_options = [{"text":"<#2363#>","option_id":"pwd"}, {"text":"<#408#>","option_id":"radius"}];
var security_radius_parm = {"title":"<#747#>", "options": security_radius_options, "container_id":"security_employee"};
...
if(!isMobile()){
var qrcode_btn_parm = {"title":`<#514#>`, "id":"qrcode_print_btn"};
Get_Component_Print_Btn(qrcode_btn_parm).appendTo($net_mode_container);
}
var bw_enabled_parm = {"title":"<#168#>", "type":"switch", "id":"bw_enabled"};
...
if(isSwMode("rt")){
var dhcp_enable_parm = {"title":"<#2578#>", "type":"switch", "id":"dhcp_enable", "openHint":"5_1"};
Get_Component_Switch(dhcp_enable_parm).appendTo($net_mode_container);
var ipaddr_parm = {"title":"<#2574#>", "type":"text", "id":"ipaddr", "need_check":true, "maxlength":15};
...
var netmask_options = [
{"text":"255.255.255.0 (253 <#2176#>)","value":"255.255.255.0"},
{"text":"255.255.255.128 (125 <#2176#>)","value":"255.255.255.128"},
{"text":"255.255.255.192 (61 <#2176#>)","value":"255.255.255.192"},
{"text":"255.255.255.224 (29 <#2176#>)","value":"255.255.255.224"},
{"text":"255.255.255.240 (13 <#2176#>)","value":"255.255.255.240"},
];
var netmask_parm = {"title": "<#331#>", "id": "netmask", "options": netmask_options, "set_value": "255.255.255.0", "openHint":"4_2"};
Get_Component_Custom_Select(netmask_parm).appendTo($net_mode_container);
}
var vid_parm = {"title":"<#3877#>", "type":"text", "id":"vlan_id", "need_check":true, "maxlength":4};//1-4094
if(is_Web_iframe){
if(isSupport("SMART_HOME_MASTER_UI")){
...
if(isSwMode("rt")){
var hide_ssid_parm = {"title":"<#4017#>", "type":"switch", "id":"hide_ssid"};
...
var ap_iso_parm = {"title":"<#4047#>", "type":"switch", "id":"ap_isolate", "openHint":"3_5"};
...
$(_obj).find("[data-container=profile_title]").html("<#1849#>");
var specific_wizard_type = wizard_type_text.filter(function(item, index, array){
return (item.type == _profile_data.sdn_rl.sdn_name);
})[0];
if(specific_wizard_type != undefined){
let profile_title_text = specific_wizard_type.text;
...
if(wifi_band & 2 || wifi_band & 4){//5G
wifi_band_select.band_5g = true;
}
if(wifi_band & 16 || wifi_band & 64){//6G
...
$("<div>").addClass("title").html("<#3905#>").appendTo($popup_title_container);
...
$("<div>").addClass("qr_text").html("<#4401#>").appendTo($qrcode_cntr);
...
testResult.errReason = '<#362#>" '+ invalid_char +'" !';
return testResult;
}
if(str){
...
testResult.isError = true;
testResult.errReason = keywordArray + " <#2548#>";
return testResult;
}
}
}
...
if(psk_length < 8){
testResult.isError = true;
testResult.errReason = "<#345#>";
testResult.set_value = "00000000";
return testResult;
}
if(psk_length > 31){
testResult.isError = true;
testResult.errReason = "<#346#>";
return testResult;
}
if(psk_length != psk_length_trim){
testResult.isError = true;
testResult.errReason = stringSafeGet("<#348#>");
return testResult;
}
...
testResult.isError = true;
testResult.errReason = '<#359#> ' + ssid.charAt(i) + ' <#360#>';
return testResult;
}
}
}
...
if(!$.isNumeric(str)){
testResult.isError = true;
testResult.errReason = "<#3100#>";
return testResult;
}
if(str.split(".").length > 2 || parseFloat(str) < 0.1){
testResult.isError = true;
testResult.errReason = "<#2741#> : 0.1 Mb/s";
return testResult;
}
return testResult;
};
...
testResult.isError = true;
testResult.errReason = "<#2015#> ex. http or https ://www.asus.com";
return testResult;
}
};
...
if($sdn_name.val() == ""){
$sdn_name.show_validate_hint("<#339#>");
$sdn_name.focus();
return false;
}
...
$sdn_name.show_validate_hint("<#2546#>");
$sdn_name.focus();
return false;
}
var $sdn_pwd = $(_obj).find("#sdn_pwd");
...
if($sdn_pwd.val() == ""){
$sdn_pwd.show_validate_hint("<#339#>");
$sdn_pwd.focus();
return false;
}
...
$radius_ipaddr.show_validate_hint(($radius_ipaddr.val() + " <#353#>"));
$radius_ipaddr.focus();
return false;
}
}
...
if($radius_port.val() == ""){
$radius_port.show_validate_hint("<#339#>");
$radius_port.focus();
return false;
}
...
$ipaddr.show_validate_hint("<#2542#>");
$ipaddr.focus();
return false;
}
var ipaddr_substr = $ipaddr.val().substr(0, $ipaddr.val().lastIndexOf("."));
...
$ipaddr.show_validate_hint("<#2542#>".replace("LAN", "WAN"));
$ipaddr.focus();
return false;
}
var specific_data = sdn_all_rl_json.filter(function(item, index, array){
...
$ipaddr.show_validate_hint("<#3674#>");
$ipaddr.focus();
return false;
}
}
...
if($vlan_id.val() == ""){
$vlan_id.show_validate_hint("<#339#>");
$vlan_id.focus();
return false;
}
...
$vlan_id.show_validate_hint("<#2546#>");
$vlan_id.focus();
return false;
}
}
...
$FWF_conntimeout.show_validate_hint("<#339#>");
...
if($FWF_passcode.val() == ""){
$FWF_passcode.show_validate_hint("<#339#>");
$FWF_passcode.focus();
return false;
}
...
{tag:"#RESTAURANT",text:stringSafeGet("<#3191#>")},
{tag:"#GYM",text:stringSafeGet("<#1129#>")},
{tag:"#CHILDREN",text:stringSafeGet("<#3192#>")},
{tag:"#VOICE_ASSISTANT",text:stringSafeGet("<#3193#>")},
{tag:"#SURVEILLANCE_DEVICES",text:stringSafeGet("<#3194#>")},
{tag:"#WFH",text:stringSafeGet("<#3195#>")},
{tag:"#BRANCH_OFFICE",text:stringSafeGet("<#3181#>")}
];
setTimeout(function(){
...
function get_elem_attr_wifi_auth(_wifiband){
if(_wifiband == "4" || _wifiband == "5" || _wifiband == "6")//6G, 5G6G, 2G5G6G
...
var aimesh_wifi_band_full = {"all":{"band_2G": true, "band_5G": true, "band_6G": true}, "node":[]};
...
aimesh_wifi_band_full.node[dut_mac] = {"band_2G": true, "band_5G": true, "band_6G": true, "support_WPA3E": false, "support_6G": false};
$.each(aimesh_wifi_band_info[dut_mac], function(index, wifi_band){
if(wifi_band.band == 1 || wifi_band.band == 2 || wifi_band.band == 4 || wifi_band.band == 16 || wifi_band.band == 64){
if(wifi_band.used < wifi_band.no_used && wifi_band.used < wifi_band_maximum){
switch(wifi_band.band){
case 1:
aimesh_wifi_band_full.node[dut_mac].band_2G = false;
aimesh_wifi_band_full.all.band_2G = false;
break;
case 2:
case 4:
aimesh_wifi_band_full.node[dut_mac].band_5G = false;
aimesh_wifi_band_full.all.band_5G = false;
break;
case 16:
case 64:
aimesh_wifi_band_full.node[dut_mac].band_6G = false;
...
$("<div>").html("<#339#>").addClass("validate_hint").insertAfter($AiMesh_List_cntr);
resize_iframe_height();
}
}).appendTo($node_cntr);
...
let sub_info_text = (node_info.online == "1") ? `<span>${node_info.ip}</span>` : `<span><#1578#> | ${node_info.mac}</span>`;
...
var hint = "* <#1155#> <#1157#>".replace("#MODELLIST", get_model_name(node_info));
...
if(wifi_band != ""){
$("<div>").addClass("icon_wifi_band wifi_" + wifi_band + "").appendTo($node_content_cntr);
}
});
}
});
...
{value:"Home",text:"<#1102#>"}, {value:"Living Room",text:"<#1103#>"}, {value:"Dining Room",text:"<#1104#>"},
{value:"Bedroom",text:"<#1105#>"}, {value:"Office",text:"<#1106#>"}, {value:"Stairwell",text:"<#1107#>"},
{value:"Hall",text:"<#1108#>"}, {value:"Kitchen",text:"<#1109#>"}, {value:"Attic",text:"<#1110#>"},
{value:"Basement",text:"<#1111#>"}, {value:"Yard",text:"<#1112#>"}, {value:"Master Bedroom",text:"<#1113#>"},
{value:"Guest Room",text:"<#1114#>"}, {value:"Kids Room",text:"<#1115#>"}, {value:"Study Room",text:"<#1116#>"},
{value:"Hallway",text:"<#1117#>"}, {value:"Walk-in Closet",text:"<#1118#>"}, {value:"Bathroom",text:"<#1119#>"},
{value:"First Floor",text:"<#1127#>"}, {value:"Second Floor",text:"<#1120#>"}, {value:"Third Floor",text:"<#1121#>"},
{value:"Storage",text:"<#1122#>"}, {value:"Balcony",text:"<#1123#>"}, {value:"Meeting Room",text:"<#1124#>"},
{value:"Garage",text:"<#1126#>"}, {value:"Gaming Room",text:"<#1128#>"}, {value:"Gym",text:"<#1129#>"},
{value:"Custom",text:"<#1125#>"}
];
}
var result = {"loc_text":"<#1102#>", "loc_css":"Home"};
var loc_text = "Home";
if(_isReNode){
...
let select_band_is_support = true;
if(_sel_wifi_bnad == "3"){
...
$("<div>").addClass("node_hint")
.html(htmlEnDeCode.htmlEncode("* <#1214#>"))
.appendTo($node_cntr);
}
function set_node_cb_closed_noSupport(){
$node_cntr.find(".icon_checkbox").addClass("closed");
$("<div>").addClass("node_hint")
.html(htmlEnDeCode.htmlEncode(`* The Router do not support 6GHz.`))/* untranslated */
.appendTo($node_cntr);
}
});
}
...
$("<div>").addClass("title").html("<#3813#>").appendTo($vpnc_group);
var vpnc_options = [];
...
$("<div>").html("<#1555#>").appendTo($btn_cntr);
...
$("<div>").addClass("title").html("<#183#>").appendTo($vpns_group);
...
"continue_btn": encode_decode_text('<#4270#>', 'encode'),
...
splash_page_setting.splash_page_setting["terms_service_cb_text"] = encode_decode_text("<#4269#>", "encode");
splash_page_setting.splash_page_setting["terms_service_title"] = encode_decode_text("<#4207#>", 'encode');
splash_page_setting.splash_page_setting["agree_btn"] = encode_decode_text("<#1683#>", 'encode');
if(_setting.auth_type == "1"){
splash_page_setting.splash_page_setting["passcode_blank"] = encode_decode_text('<#4264#> : <#339#>', 'encode');
