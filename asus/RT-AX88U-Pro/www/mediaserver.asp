...
<link rel="icon" href="images/favicon.png"><title><#869#> - <#806#></title>
...
<span class="formfonttitle" style="margin-left: 8px;"><#806#></span>
<span id="returnBtn">
...
<div id="upnp_desc_id" class="formfontdesc" style="margin-top: 10px; margin-left: 8px;"><#3574#></div>
</td>
</tr>
<tr>
<td>
...
<div id="noUSB" style="color:#FC0;display:none;margin-left:17px;padding-top:2px;padding-bottom:2px;"><#2915#></div>
</td>
</tr>
<tr>
<th><#1813#></th>
...
<th><#1815#></th>
<td>
<input type="radio" value="0" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "0", "checked"); %>><#1816#>
<input type="radio" value="1" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "1", "checked"); %>><#1814#>
</td>
</tr>
</table>
</div>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1814#>&nbsp;(<#2693#>&nbsp;10)</td>
</tr>
</thead>
<tr>
<th><#1811#></th>
...
<tr>
<td width="45%">
<input id="PATH" type="text" class="input_30_table" value="" onclick="get_disk_tree();" autocorrect="off" autocapitalize="off" readonly="readonly"/" placeholder="<#750#>" >
</td>
<td width="40%">
