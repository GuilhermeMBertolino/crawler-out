...
set_re_status();
document.getElementById("remoteIP_span").innerHTML = (remoteIP == "")?"<#1431#>":remoteIP;
}
...
showtext(document.getElementById("Connstatus"), "<#1693#>");
document.getElementById("remoteIP_tr").style.display = "none";
}
}
</script>
...
<tr>
<th><#1433#></th>
<td><input type="button" class="button_gen" value="<#1554#>" onclick="javascript:parent.location.href='../survey.htm';"></td>
</tr>
</table>
</body>
</html>
