...
code += '<div class="info-title"><#113#></div>';
code += '<div class="button-right"><input type="button" class="button_gen" value="<#626#>" onclick="gotoSiteSurvey();"></div>';
code += '</div>';
...
code += '<div class="info-title"><#3277#></div>';
code += '<select class="input_option" id="smartConnectSwitch" onchange="enableSmartConnect(this.value)">'
code += '<option value="0" '+ (variable.smart_connect_x === '0' ? 'selected': '') +'><#1687#>';
code += '<option value="1" '+ (variable.smart_connect_x !== '0' ? 'selected': '') +'><#1694#>';
code += '</select>'
...
if(show_dwb_hint){
var $dwb_hint = $("<div>").addClass("dwb_hint").html('<#54#>');
$dwb_hint.find(".faq-link").attr("onclick", "top.change_wl_unit_status(" + dwb_info.band + ");");
code += `<div class="dwb_hint">${wl_nband_title[dwb_info.band]} <#53#></div>`;
...
code += '<div class="info-block">';
code += '<div class="info-title"><#586#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3930#></div>';
...
code += '<span><#1038#> <a id="wl'+ unit +'_wpa3FaqLink" class="faq-link" target="_blank" href="">FAQ</a></span>';
code += '</div>';
}
...
if(!system.lyraHideSupport){
code += '<div class="info-block">';
code += '<div class="info-title"><#881#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4116#></div>';
...
_optionArray = [['<#875#>', '0'], ['<#3280#>', '1'], ['2.4 GHz and 5 GHz Smart Connect', '3']];
if(variable['smart_connect_selif_x'] == '3'){
_smart_connect_x = '3';
}
}
else if(system.modelName == 'GT-BE96'){
_optionArray = [['<#875#>', '0'], ['<#3280#>', '1'], ['5 GHz Smart Connect', '2']];
if(variable['smart_connect_selif_x'] == '3'){
_smart_connect_x = '3';
}
}
else{
_optionArray = [['<#875#>', '0'], ['<#3280#>', '1'], ['5GHz Smart Connect', '2']];
}
}
}
else{
...
<div id="wireless_tab" class="tab-block tab-click" onclick="switchTab(this.id)"><#403#></div>
<div id="status_tab" class="tab-block" onclick="switchTab(this.id)"><#756#></div>
...
<input type="button" class="button_gen" value="<#209#>" onclick="apply();">
</div>
</div>
</body>
</html>
