...
html += "<div class='aimesh_node_setting_info_title'><#4306#></div>";
...
case "ctrl_led" :
html += "<div style='margin-top:10px;'>";
html += "<div class='aimesh_node_setting_info_title'><#4333#></div>";
html += "<div class='aimesh_node_setting_info_content'>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2475#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
parent.$("#amesh_connect_msg").find(".amesh_hint_text.amesh_hint_title").html("<#1066#>");
}
});
});
}
...
code += "</div>";
code += "<div class='amesh_router_info_text'><#2176#>: ";
var re_client_num = 0;
...
code += "<div class='amesh_title offline' onclick='show_offline_msg(event);'><#1578#></div>";
}
code += "</div>";
code += "</div>";
code += "</div>";
...
$amesh_cancel.attr({"type" : "button", "value" : "<#1704#>"});
...
$amesh_wait_search_text.html("<#1059#>");
...
$amesh_cancel.attr({"type" : "button", "value" : "<#212#>"});
$amesh_action_bg.append($amesh_cancel);
$amesh_cancel.click(
function() {
initial_amesh_obj();
...
$amesh_apply.attr({"type" : "button", "value" : "<#209#>"});
...
$amesh_wpa3_text.append($("<div>").html("<#1040#>"));
...
$aimesh_illustration_bg.append(gen_text("<#1137#>", "backhaul_router"));
$aimesh_illustration_bg.append(gen_text("<#1065#>", "backhaul_node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1065#>", "backhaul_node for_dsl"));
}
...
result_text += "<#1049#>";
result_text += "<div style='margin-left: 20px;'>1. <#1050#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1051#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1052#></div>";
result_text += "<div style='margin-left: 20px;'>4. <#1053#></div>";
}
if(ameshRouter_support && ameshNode_support)
result_text += "b. ";
if(ameshNode_support){
result_text += "<#1054#>";
result_text += "<div style='margin-left: 20px;'>1. <#1055#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1056#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1057#></div>";
}
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
$aimesh_illustration_bg.append(gen_text("Modem", "modem"));
$aimesh_illustration_bg.append(gen_text("<#1137#>", "router"));
$aimesh_illustration_bg.append(gen_text("<#1065#>", "node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1065#>", "node for_dsl"));
}
var $amesh_clear_bg = $('<div>');
$amesh_clear_bg.css("clear", "both");
$aimesh_illustration_bg.append($amesh_clear_bg);
...
$amesh_apply.attr({"type" : "button", "value" : "<#1704#>"});
$amesh_action_bg.append($amesh_apply);
$amesh_apply.click(
function() {
initial_amesh_obj();
...
hint += "<#1210#>";
hint += "<br>";
hint += "<#1211#> <#1212#>".replace("#RE_MAXNUM", cfg_re_maxnum);
hint += "<br>";
hint += "<#1213#>";
...
code += "<div class='aimesh_node_static_info_title'><#1101#></div>";
...
code += "<div class='aimesh_node_static_info_title'><#309#></div>";
...
code += "<div>";
code += "<div class='aimesh_node_setting_info_title'><#388#></div>";
code += "<div id='aimesh_node_macaddr' class='aimesh_node_setting_info_content'></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#1087#></div>";
code += "<select id='aimesh_node_connection_priority' class='aimesh_node_input_select'>";
code += "<option value='3' class='aimesh_node_input_select_option'><#166#></option>";
code += "<option value='2' class='aimesh_node_input_select_option'><#1077#></option>";
code += "</select>";
code += "<div id='aimesh_node_connection_priority_hint' class='aimesh_node_setting_info_content'><#1703#></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#205#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_connection_type' class='text_hyperlink'></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#2185#></div>";
...
code += "<div class='aimesh_node_setting_info_title'><#402#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_usb_app' class='text_hyperlink'><#400#></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
...
code += "<th class='IE8HACK' width=" + aimesh_node_client_info_width[0] + "><#1568#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#2959#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3647#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3822#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2851#>");
...
block_chars_hint = block_chars_array[i] + " <#2548#>";
}
if(block_chars_hint != "") {
...
function() {
if(node_info.online == "1" && re_path > 0) {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1687#>" : "<#2851#>";
...
var led_table = ["<#1687#>", "<#2705#>", "<#2729#>", "<#2343#>"];
...
$amesh_close.attr({"type" : "button", "value" : "<#1687#>"});
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2475#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#4305#>" : nodeClientObj.ip;
...
option_array.push(gen_option_attr("3", ((_eap_flag) ? "<#166#> (<#1082#>)" : "<#166#>"), "auto"));
...
var option_text = (_eap_flag) ? "<#1092#>" : "<#1091#>";
...
option_array.push(gen_option_attr("2", ((_eap_flag) ? "<#1081#>" : "<#1077#>"), "eth"));
return option_array;
}
...
<tr>
<td colspan="2">
<div class="amesh_title"><#1044#></div>
<div class="amesh_title amesh_content"><#1047#></div>
</td>
</tr>
...
<tr>
<td width="50%">
<div class="amesh_title amesh_help" onclick="scenario();"><#1045#></div>
</td>
<td width="50%" height="32px;" style="text-align:center;">
<input id="searchReadyOnBoarding" type="button" class="button_gen" value="<#1711#>" onClick="searchReadyOnBoarding();">
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2475#></div></div>
</td>
</tr>
<tr>
</table>
