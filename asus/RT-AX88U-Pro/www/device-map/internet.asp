...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1729#> ";
if (Hours != 0)
value += Hours.toString() + " <#2346#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2743#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#3196#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
if(gobi_support){
pri_if = (pri_if == "USB")? "<#2827#>" : pri_if;
sec_if = (sec_if == "USB")? "<#2827#>": sec_if;
if((unit == "0" && pri_if == "<#2827#>") || (unit == "1" && sec_if == "<#2827#>"))
$("#wan_enable_title").text("<#2747#>");
}
...
showtext(document.getElementById("dualwan_mode"), "<#1887#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1886#>");
...
<td height="50" style="padding:10px 15px 0px 15px;">
<div style="display:flex; align-items:center; justify-content:space-between;">
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;"><#1869#></div>
...
<p class="formfonttitle_nwm"><#3864#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3862#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1885#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1888#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3824#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#4132#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3152#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2591#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2684#></p>
...
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1554#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1558#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1554#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
</table>
...
<p class="formfonttitle_nwm"><#768#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2574#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2354#></p>
...
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#626#>" style="float:right;margin: 5px 0;">
</td>
</tr>
</table>
</form>
