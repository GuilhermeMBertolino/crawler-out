...
disk_list_array = { "info" : ["<#1790#>", "disk.asp"], "health" : ["<#1783#>", "disk_utility.asp"], "format" : ["<#1697#>", "disk_format.asp"]};
...
<p class="formfonttitle_nwm"><#2846#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#1456#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#3431#>:</p>
...
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#806#>:</p>
<input type="button" class="button_gen" onclick="goUPnP();" value="<#1554#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="aidisk_hyperlink">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1022#>:</p>
<input type="button" class="button_gen" onclick="gotoAidisk();" value="<#1554#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="dmLink" style="display:none;">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1826#>:</p>
<input type="button" class="button_gen" onclick="gotoDM();" value="<#1554#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; "><#3174#>:</p>
<input id="show_remove_button" class="button_gen" type="button" class="button" onclick="remove_disk_call();" value="<#1556#>">
<div id="show_removed_string" style="display:none;"><#3172#></div>
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; " onmouseover="parent.overHint(24);" onmouseout="parent.nd();"><#3210#></p>
...
<li><#1806#><a href="/" target="_parent"><#1807#></a><#1808#></li>
</ul>
</div>
