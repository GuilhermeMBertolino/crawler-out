...
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#1755#><img src="/images/InternetScan.gif"></div>';
else
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#2475#></div>';
if(parent.webWrapper)
clientHtmlTd = '<div style="color:#000;height:30px;text-align:center;margin-top:50px;font-size: 22px;"><#2475#></div>';
}
...
var Modified_wired_term = wired_span.replace("<#3428#>", "<#3820#>");
...
var Modified_wireless_term = wireless_span.replace("<#3429#>", "WiFi");
...
var overlibStr = "<p><#388#>:</p>" + client.mac.toUpperCase();
if(client.ssid)
overlibStr += "<p>SSID:</p>" + client.ssid.replace(/"/g, '&quot;');
if(client.isLogin)
overlibStr += "<p>Logged In User:</p>YES";
if(client.isPrinter)
overlibStr += "<p><#1757#></p>YES";
if(client.isITunes)
overlibStr += "<p><#1756#></p>YES";
if(client.isWL > 0){
overlibStr += "<p><#3919#>:</p>" + isWL_map[client.isWL]["text"].replace("G", " GHz") + " (" + client.rssi + " dBm)";
if(stainfo_support) {
overlibStr += "<p>Tx Rate:</p>" + ((client.curTx != "") ? client.curTx : "-");
overlibStr += "<p>Rx Rate:</p>" + ((client.curRx != "") ? client.curRx : "-");
overlibStr += "<p><#901#>:</p>" + client.wlConnectTime;
}
}
return overlibStr;
}
...
overlibStrTmp += "<p><span>.....................................</span></p><p style='margin-top:5px'><#2721#> :</p>";
...
<#3428#>&nbsp;(<b style="font-size:10px;" id="tabWiredNum">0</b>)
</span>
</div>
<script>
...
<#3429#>&nbsp;(<b style="font-size:10px;" id="tabWirelessNum">0</b>)
</span>
...
<input type="button" id="refresh_list" class="button_gen" value="<#1707#>" style="margin-left:70px;">
<script>
