...
$(".ipsec_inactive.renew_hint").show().html("<br><#3769#>");
}
}
});
...
html += "<div class='ipsec_connect_status_title'><#3334#></div>";
html += "<div class='ipsec_connect_status_title'><#901#></div>";
html += "<div class='ipsec_connect_status_title'><#3734#> <#2979#></div>";
...
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1686#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1705#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1707#>"/>
</div>
</div>
...
<span class="hint-color"><#3743#></span>
</div>
...
<th><#773#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1685#>"/>
</td>
</tr>
<tr class="ipsec_setting_content">
<th><#808#></th>
...
<th><#3727#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3719#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<span class="hint-color"><#2032#></span>
</td>
</tr>
<tr>
<th><#315#></th>
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#3994#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#3995#></label>
</td>
</tr>
...
<span class="hint-color">(10~900) <#3196#></span>
</td>
</tr>
</table>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable " style="margin-top:15px;">
...
<th><#3658#></th>
<td>
<div><#756#> : <span id="cert_status"></span></div>
<div><#3767#> : <span id="cert_issueTo"></span></div>
<div><#3766#> : <span id="cert_issueBy"></span></div>
<div><#3698#> : <span id="cert_expire"></span></div>
<div>
<input class="button_gen_dis ipsec_active export" type="button" value="<#1553#>">
<span class="ipsec_inactive"><#754#></span>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_windows" class="input" value="0" checked>
<label for="ipsec_export_cert_windows"><#3771#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3772#></label>
</div>
</td>
</tr>
<tr>
...
<span class="ipsec_inactive renew_hint"><#754#></span>
