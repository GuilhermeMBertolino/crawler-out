...
document.getElementById("iptv_configure_status").innerHTML = "<#872#>";
else
...
document.getElementById("voip_configure_status").innerHTML = "<#872#>";
else
...
alert_msg = hint_str1.replace("%1$@", "<#2865#>").replace("%2$@", "IPTV") + " " + hint_str2;
}
alert(alert_msg);
return true;
}
...
var msg = "<#3883#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
if(confirm(msg)){
...
msg = hint_str.replace("%1$@", port_list).replace("%2$@", "IPTV").replace("%3$@", "<#2865#>");
if(confirm(msg)){
document.form.lacp_enabled.disabled = false;
document.form.lacp_enabled.value = "0";
}
...
if(val == "12")
document.getElementById("gaming_note").innerHTML = "<#3138#>";
else if(val == "56")
document.getElementById("gaming_note").innerHTML = "<#3139#>";
...
if(improxy_support){
add_option(select, "<#3994#> IGMP", "1", 0);
add_option(select, "<#3994#> IGMP & MLD", "3", 0);
}
else
add_option(select, "<#3994#>", "1", 0);
select.value = val;
if(select.selectedIndex < 0)
select.selectedIndex = 0;
...
<option value="dhcp"><#180#></option>
<option value="static"><#181#></option>
...
<tr id="dnsenable_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,12);"><#327#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,13);"><#313#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,14);"><#315#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,29);"><#3031#></a></th>
<td align="left">
<select class="input_option" name="wan_auth_x_now" onChange="change_wan_type(document.form.wan_proto_now.value);">
<option value="" <% nvram_match("wan_auth_x_now", "", "selected"); %>><#875#></option>
<option value="8021x-md5" <% nvram_match("wan_auth_x_now", "8021x-md5", "selected"); %>>802.1x MD5</option>
</select></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,4);"><#3616#></a></th>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd_now);"><#640#></div>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#3035#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,7);"><#3055#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,8);"><#3053#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,9);"><#3061#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,10);"><#3039#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,17);"><#3059#></a></th>
<td>
<select name="wan_pptp_options_x_now" class="input_option">
<option value=""><#166#></option>
<option value="-mppc"><#2913#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);"><#3041#></a></th>
...
<input class="button_gen" type="button" onclick="hide_connection_settings();" value="<#212#>">
<input class="button_gen" type="button" onclick="save_connection_settings();" value="<#1704#>">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#410#> - IPTV</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#2584#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#2585#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#3137#></a></th>
<td>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#749#></a></th>
<td>
...
<th width="30%"><#1903#></th>
<td align="left">
<span style="color:#FFFFFF;"><#1906#></span>
<select id="wans_lanport1" name="wans_lanport1" class="input_option" style="margin-left:7px;"></select>
<div style="margin-top:2px;"><span style="color:#FFFFFF;">( <#1904#> : </span><span id="cur_primary" style="color:#FFFFFF;"></span><span style="color:#FFFFFF;"> )</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#3995#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#3145#></a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option" onChange="change_mr_enable(this.value);">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#3995#></option>
<!-- <option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#3994#></option> -->
</select>
<span id="mr_hint" style="display:none;">( <#3146#> )</span>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#3995#></span>
<span style="margin-left: 5px;"><#3147#></span>
</div>
</td>
</tr>
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,14);"><#3156#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,15);"><#3157#></a></th>
<td>
...
<option value="0" <% nvram_match("mr_qleave_x", "0","selected"); %> ><#3995#></option>
<option value="1" <% nvram_match("mr_qleave_x", "1","selected"); %> ><#3994#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#3995#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#3994#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#3159#></a></th>
<td>
