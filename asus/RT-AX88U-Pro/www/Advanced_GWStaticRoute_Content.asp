...
<div class="formfontdesc"><#3151#></div>
...
<th><#3150#></th>
<td>
<input type="radio" value="1" name="sr_enable_x" class="input" onclick="return change_common_radio(this, 'RouterConfig', 'sr_enable_x', '1')" <% nvram_match("sr_enable_x", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="sr_enable_x" class="input" onclick="return change_common_radio(this, 'RouterConfig', 'sr_enable_x', '0')" <% nvram_match("sr_enable_x", "0", "checked"); %>><#199#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="6" id="GWStatic"><#3149#>&nbsp;(<#2693#>&nbsp;32)</td>
</tr>
</thead>
<tr>
<th><a href="javascript:void(0);" onClick="openHint(6,1);"><div class="table_text"><#3153#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,2);"><div class="table_text"><#3154#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,3);"><div class="table_text"><#3152#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,4);"><div class="table_text"><#3155#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,5);"><div class="table_text"><#3822#></div></a></th>
<th><#2692#></th>
</tr>
<tr>
<td width="20%">
...
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" style="position:absolute;" onclick="pullLANIPList(this);" title="<#3205#>">
