...
var code = "";
code += "<tr>";
code += "<th style='width:20%;text-align:left'><#901#></th>";
code += "<th style='width:30%;text-align:left'><#3045#> / <#1567#></th>";
code += "<th style='width:50%;text-align:left'><#1830#></th>";
code += "</tr>";
...
var data = [["<#901#>", "<#388#>", "<#1567#>".replace(/&#39;/g, "'"), "<#1830#>"]];
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2736#> - <#920#></div>
...
<option value="all" selected><#1427#></option>
</select>
...
<input class="input_3_table short_input" value="1" id="current_page"></input>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1686#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1707#>">
<input class="button_gen" onClick="exportWebHistoryLog()" type="button" value="<#1553#>" >
</div>
</div>
</td>
</tr>
