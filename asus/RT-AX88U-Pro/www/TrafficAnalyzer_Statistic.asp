...
if(show_refresh){
document.getElementById('statistic_hint').innerHTML = "* <#3452#>";
}
else{
document.getElementById('statistic_hint').innerHTML = "* <#3451#>";
}
...
var description = "";
if(type == "router"){
document.getElementById('top_client_title').innerHTML = "<#388#>:";
if(period == "monthly"){
description = "<#3445#>";
}
...
if(top5_info == ""){
if(type == "router")
document.getElementById('top_client_name').innerHTML = "<#3438#>";
else
document.getElementById('top_client_name').innerHTML = "<#3437#>";
document.getElementById('top_client_traffic').innerHTML = "<#3439#>";
}
else{
...
if(type == "router")
code = "<option value='all' selected><#3435#></option>";
else
code = "<option value='all' selected><#3434#></option>";
top5_client_array = [];
top5_app_array = [];
...
code += '<th colspan="4"><#1567#>: '+ mac +'</th>';
else
code += '<th colspan="4"><#1567#>: '+ getClientCurrentName(mac); +'</th>';
}
else{
...
if(type == "router"){
code += "<th style='width:55%;text-align:left;'><#3436#></th>";
}
else{
code += '<th style="width:55%;text-align:left;"><#1567#></th>';
}
code += '<th style="width:15%;text-align:right;"><#2940#></th>';
code += '<th style="width:15%;text-align:right;"><#2936#></th>';
code += '<th style="width:15%;text-align:right;"><#3430#></th>';
code += '</tr>';
...
code = '<div style="width:110px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#3438#></div>';
}
else{
...
if(document.getElementById('duration_option').value == "monthly"){
document.getElementById('total_traffic_title').innerHTML = "<#3450#>";
}
else if(document.getElementById('duration_option').value == "weekly"){
document.getElementById('total_traffic_title').innerHTML = "<#3457#>";
}
else{ //daily
document.getElementById('total_traffic_title').innerHTML = "<#3449#>";
}
document.getElementById('current_traffic_title').innerHTML = "<#3447#>";
document.getElementById('current_traffic_percent_title').innerHTML = "<#3455#>";
}
...
<div class="formfontdesc"><#3448#></div>
<div style="margin-left:10px;">
<label style="font-size:16px;"><#3327#>:</label>
<input class="input_12_table" id="datepicker" value="">
<div id="statistic_hint" class="hint-color" style="text-align:right;margin-top:-21px;padding-right:15px;font-size:14px;">* <#3451#></div>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#3326#>:</div>
</td>
<td>
<div id="router" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter_pressed" onclick="switch_content(this);"><#2975#></div>
</td>
<td>
<div id="apps" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter" onclick="switch_content(this);"><#1434#></div>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#3328#>:</div>
</td>
<td>
<select class="input_option" id="traffic_option" onChange="change_traffic_direction(this);">
<option value="both" selected><#2935#></option>
<option value="down"><#2936#></option>
<option value="up"><#2940#></option>
</select>
</td>
<td>
<select class="input_option" id="duration_option" onChange="switch_date_type(this);">
<option value="monthly"><#1793#></option>
<option value="weekly"><#1805#></option>
<option value="daily" selected><#1785#></option>
</select>
</td>
<td>
...
<div onclick="change_top5_clients(0);" style="width:100px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#3438#></div>
</td>
<td>
...
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD" id="top_client_title"><#388#>:</th>
<td style="font-size:14px;" id="top_client_name"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#3456#>:</th>
<td style="font-size:14px;" id="top_client_traffic"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#3453#> :</th>
<td></td>
</tr>
</table>
...
<tr>
<td colspan="3">
<div class="hint-color" style="font-size:16px;text-align:center;" id="info_block_title"><#3443#></div>
</td>
</td>
</table>
</div>
