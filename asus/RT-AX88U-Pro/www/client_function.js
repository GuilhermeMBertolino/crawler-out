...
code += '<span title="Change to default client icon" onclick="card_setDefaultIcon();"><#1690#></span>';
code += '<span id="card_changeIconTitle" title="Change client icon" style="margin-left:10px;" onclick="card_show_custom_image();"><#1684#></span>';
code += '</div>';
}
code += '</td>';
...
code += "<span onmouseover='return overlib(\"" + htmlEnDeCode.htmlEncode(block_internet_hint) +"\");' onmouseout='return nd();'><#1570#></span>";
code += '</div>';
...
code += '<div id="card_internetTimeScheduling" class="internetTimeEdit" style="float:right;margin-right:10px;" title="<#3403#>"></div>';
code += '</div>';
code += '<div class="clientList_line"></div>';
code += '<div id="div_card_ipmac_binding" style="height:33px;width:100%;margin:5px 0;">';
code += '<div style="width:65%;float:left;line-height:33px;">';
code += "<span onmouseover='return overlib(\"" + htmlEnDeCode.htmlEncode(ip_binding_hint) +"\");' onmouseout='return nd();'><#1573#></span>";
code += '</div>';
...
code += '<input class="button_gen" type="button" style="margin-right:5px;" onclick="card_closeClientListView();" value="<#212#>">';
code += '<input id="card_client_confirm" class="button_gen" type="button" value="<#209#>">';
...
switch(rssi_t) {
case 1:
connectModeTip = "<#738#>: <#493#>\n";
break;
case 2:
connectModeTip = "<#738#>: <#494#>\n";
break;
case 3:
connectModeTip = "<#738#>: <#495#>\n";
break;
case 4:
connectModeTip = "<#738#>: <#496#>\n";
break;
}
if(isSupport("stainfo")) {
if(clientInfo.curTx != "")
...
connectModeTip += "<#901#>: " + clientInfo.wlConnectTime + "";
}
}
if(sw_mode != 4){
...
document.getElementById("card_client_ipMethod").style.display = "";
document.getElementById("card_client_ipMethod").innerHTML = "<#1578#>";
...
document.getElementById("card_client_login").innerHTML = "<#1576#>";
}
if(clientInfo.isPrinter) {
document.getElementById("card_client_printer").style.display = "";
document.getElementById("card_client_printer").innerHTML = "<#1577#>";
}
...
var opModeDes = ["none", "<#874#>", "<#480#>", "<#459#>", "<#467#>"];
...
document.getElementById("card_changeIconTitle").innerHTML = "<#1687#>";
}
else {
slideFlag = true;
slideUp("card_custom_image", 500);
document.getElementById("card_changeIconTitle").innerHTML = "<#1684#>";
}
}
}
...
confirmFlag = confirm(stringSafeGet("<#1569#>"));
if(confirmFlag) {
hide_edit_client_block();
if(document.getElementById("edit_client_block") != null) {
...
code += '<thead><tr>';
code += '<td colspan="4">Client upload icon&nbsp;(<#2693#>&nbsp;100)</td>'; /*untranslated*/
code += '</tr></thead>';
code += '<tr>';
code += '<th width="45%"><#2959#></th>';
code += '<th width="30%"><#2957#></th>';
code += '<th width="15%"><#1568#></th>';
code += '<th width="10%"><#1688#></th>';
code += '</tr>';
code += '</table>';
code += '<div id="card_usericons_block"></div>';
code += '<div style="margin-top:15px;padding-bottom:10px;width:100%;text-align:center;">';
code += '<input class="button_gen" type="button" onclick="uploadIcon_cancel();" value="<#212#>">';
code += '<input class="button_gen" type="button" onclick="uploadIcon_confirm();" value="<#1704#>">';
...
code +='<tr><td class="hintColor" colspan="4"><#2475#></td></tr>';
...
if(isSupport("smart_connect") || isSupport("bandstr")){
var sc_list = [];
}
if(isSupport("amas")){
...
var obj_width = isSupport("stainfo") ? obj_width_map[2] : obj_width_map[1];
var wl_colspan = isSupport("stainfo") ? 9 : 6;
var code = "";
var drawSwitchMode = function(mode) {
var drawSwitchModeHtml = "";
drawSwitchModeHtml += "<div style='margin-top:15px;margin-left:15px;float:left; display: flex;'>";
if(mode == "All") {
drawSwitchModeHtml += "<div class='block_filter_pressed clientlist_All me-2'>";
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#1426#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter clientlist_ByInterface m-0' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'>" + (isSupport("mtlancfg") ? "<#2882#>" : "<#3822#>") + "</div>";
drawSwitchModeHtml += "</div>";
}
else {
drawSwitchModeHtml += "<div class='block_filter clientlist_All me-2' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#1426#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter_pressed clientlist_ByInterface'>";
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'>" + (isSupport("mtlancfg") ? "<#2882#>" : "<#3822#>") + "</div>";
drawSwitchModeHtml += "</div>";
}
drawSwitchModeHtml += "</div>";
...
code += "<div class='closeBtn' style='float:right;'><img src='/images/button-close.gif' style='width:30px;cursor:pointer' onclick='closeClientListView();'></div>";
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='" + wl_colspan + "'><#1581#>";
code += "<a id='all_expander'class='clientlist_expander' onclick='showHideContent(\"clientlist_all_list_Block\", this);'>[ <#1582#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_all_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2393#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1568#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"all_list\");' style='cursor:pointer;'><#2959#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"all_list\");' style='cursor:pointer;'><#3647#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"all_list\");' style='cursor:pointer;'><#2957#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"all_list\");' style='cursor:pointer;'><#3822#></th>";
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"num\", \"all_list\");' style='cursor:pointer;'><#901#></th>";
}
code += "</tr>";
code += "</table>";
...
case "ByInterface" :
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='" + wl_colspan + "'><#3428#>";
code += "<a id='wired_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wired_list_Block\", this);'>[ <#1582#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_wired_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2393#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1568#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wired_list\");' style='cursor:pointer;'><#2959#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wired_list\");' style='cursor:pointer;'><#3647#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wired_list\");' style='cursor:pointer;'><#2957#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " ><#3822#></th>";
if(isSupport("stainfo") && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='23px'><td colspan='" + wl_colspan + "'>" + tr_title;
code += "<a id='sc_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_sc_list_Block\", this);'>[ <#1582#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_sc_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2393#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1568#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"sc_list\");' style='cursor:pointer;'><#2959#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"sc_list\");' style='cursor:pointer;'><#3647#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"sc_list\");' style='cursor:pointer;'><#2957#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"sc_list\");' style='cursor:pointer;'><#3822#></th>";
if(isSupport("stainfo") && !(isSwMode('mb') || isSwMode('ew'))) {
code += "<th width=" + obj_width[6] + " onclick='sorter.addBorder(this);sorter.doSorter(6, \"num\", \"sc_list\");' style='cursor:pointer;' title='The transmission rates of your wireless device'>Tx Rate (Mbps)</th>";/*untranslated*/
code += "<th width=" + obj_width[7] + " onclick='sorter.addBorder(this);sorter.doSorter(7, \"num\", \"sc_list\");' style='cursor:pointer;' title='The receive rates of your wireless device'>Rx Rate (Mbps)</th>";/*untranslated*/
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"num\", \"sc_list\");' style='cursor:pointer;'><#901#></th>";
}
code += "</tr>";
code += "</table>";
code += "<div id='clientlist_sc_list_Block'></div>";
}
else{
...
if(wl_if != ""){
var wl_ssid_parm = "wl" + get_wl_unit_by_band(wl_if) + "_ssid";
tr_title = htmlEnDeCode.htmlEncode(decodeURIComponent(httpApi.nvramCharToAscii([wl_ssid_parm])[wl_ssid_parm])) + " (" + tr_title + ")";
}
}
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='23px'><td colspan='" + wl_colspan + "'>" + tr_title;
code += "<a id='wl" + wl_map[wl_nband_title[i]] + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wl" + wl_map[wl_nband_title[i]] + "_list_Block\", this);'>[ <#1582#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_wl" + wl_map[wl_nband_title[i]] + "_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2393#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1568#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2959#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3647#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2957#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3822#></th>";
if(isSupport("stainfo") && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#901#></th>";
}
code += "</tr>";
code += "</table>";
...
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='23px'><td colspan='" + wl_colspan + "'>" + sdn_all_rl.apg_rl.ssid;
code += "<a id='sdn" + sdn_idx + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_sdn" + sdn_idx + "_list_Block\", this);'>[ <#1582#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_sdn" + sdn_idx + "_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2393#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1568#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"sdn"+sdn_idx+"_list\");' style='cursor:pointer;'><#2959#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"sdn"+sdn_idx+"_list\");' style='cursor:pointer;'><#3647#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"sdn"+sdn_idx+"_list\");' style='cursor:pointer;'><#2957#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"sdn"+sdn_idx+"_list\");' style='cursor:pointer;'><#3822#></th>";
if(isSupport("stainfo") && !(isSwMode('mb') || isSwMode('ew'))) {
code += "<th width=" + obj_width[6] + " onclick='sorter.addBorder(this);sorter.doSorter(6, \"num\", \"sdn"+sdn_idx+"_list\");' style='cursor:pointer;' title='The transmission rates of your wireless device'>Tx Rate (Mbps)</th>";/*untranslated*/
code += "<th width=" + obj_width[7] + " onclick='sorter.addBorder(this);sorter.doSorter(7, \"num\", \"sdn"+sdn_idx+"_list\");' style='cursor:pointer;' title='The receive rates of your wireless device'>Rx Rate (Mbps)</th>";/*untranslated*/
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"num\", \"sdn"+sdn_idx+"_list\");' style='cursor:pointer;'><#901#></th>";
}
code += "</tr>";
code += "</table>";
code += "<div id='clientlist_sdn" + sdn_idx + "_list_Block'></div>";
});
}
else{
for(var i=1; i<isSupport("mssid_count")+1; i++){
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='23px'><td colspan='" + wl_colspan + "'><#299#> - " + i;
code += "<a id='gn" + i + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_gn" + i + "_list_Block\", this);'>[ <#1582#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_gn" + i + "_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2393#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1568#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#2959#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3647#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#2957#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3822#></th>";
if(isSupport("stainfo") && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#901#></th>";
}
code += "</tr>";
code += "</table>";
...
if(!top.isIE8)
code += "<div style='text-align:center;margin-top:15px;'><input type='button' class='button_gen' onclick='exportClientListLog();' value='<#1553#>'></div>";
code += "</td></tr></tbody>";
code += "</table>";
divObj.innerHTML = code;
...
document.getElementById("all_expander").innerHTML = "[ <#1583#> ]";
}
}
else {
$.each(isWL_map, function(index, value){
...
document.getElementById("wired_expander").innerHTML = "[ <#1583#> ]";
}
}
else{
if(!sorter["wl"+index+"_display"]){
document.getElementById("clientlist_wl"+index+"_list_Block").style.display = "none";
document.getElementById("wl"+index+"_expander").innerHTML = "[ <#1583#> ]";
}
}
});
if(isSupport("smart_connect") || isSupport("bandstr")){
...
document.getElementById("sc_expander").innerHTML = "[ <#1583#> ]";
}
}
if(isSupport("amas")){
if(isSupport("mtlancfg")){
...
document.getElementById("sdn"+sdn_all_rl.sdn_rl.idx+"_expander").innerHTML = "[ <#1583#> ]";
}
});
}
else{
...
document.getElementById("gn"+i+"_expander").innerHTML = "[ <#1583#> ]";
}
}
}
}
...
if(sortArray == "" && (isSupport("smart_connect") || isSupport("bandstr"))){
...
clientListCode += "<tr id='tr_" + objID + "'><td class='hintColor' colspan='" + wl_colspan + "'><#2475#></td></tr>";
}
else {
...
clientListCode += '<div class="imgUserIcon_viewlist"><i class="type" style="--svg:url(' + listView_userIconBase64 + ')"></div>';
}
clientListCode += "</div>";
}
else if( clientlist_sort[j].type != "0" || clientlist_sort[j].vendor == "") {
var icon_type = "type" + clientlist_sort[j].type;
clientListCode += "<div style='height:40px;width:40px;cursor:default;' class='clientIcon_no_hover' title='"+ clientlist_sort[j].deviceTypeName +"'><i class='" + icon_type + "'></i>";
...
clientListCode += "<div style='height:42px;width:42px;background-size:100%;cursor:default;' class='vendorIcon_no_hover' title='"+ clientlist_sort[j].deviceTypeName +"'>";
clientListCode += "<i class='vendor-icon "+ vendorIconClassName +"'></i>";
clientListCode += "</div>";
}
else {
var icon_type = "type" + clientlist_sort[j].type;
clientListCode += "<div style='height:40px;width:40px;cursor:default;' class='clientIcon_no_hover' title='"+ clientlist_sort[j].deviceTypeName +"'><i class='" + icon_type + "'></i></div>";
}
}
clientListCode += "</td>";
...
clientListCode += "<td width='" + obj_width[5] + "' align='center'><div class='interface_container'><div class='" + radioIcon_css + " radio_" + rssi_t + "'></div>";
...
document.getElementById(_obj).innerText = "<#2931#>";
}
else {
slideFlag = true;
slideUp(_controlObj, 100);
document.getElementById(_obj).innerText = "<#2932#>";
}
}
}
...
htmlCode += "<div id='" + _containerID + "_clientlist_dropdown_expand' class='clientlist_dropdown_expand' onclick='expand_hide_Client(\"" + _containerID + "_clientlist_dropdown_expand\", \"" + _containerID + "_clientlist_offline\");' onmouseover='over_var=1;' onmouseout='over_var=0;'><#2932#></div>";
...
if(document.getElementById("" + _containerID + "_clientlist_dropdown_expand").innerText == "<#2932#>") {
...
{tag:"#CLIENTLIST_ELECTRONIC_DEVICES",text:"<#1584#>"},
{tag:"#CLIENTLIST_DESKTOP",text:"<#1585#>"},
{tag:"#CLIENTLIST_WINDOWS_DESKTOP",text:"<#1586#>"},
{tag:"#CLIENTLIST_LINUX_DESKTOP",text:"<#1587#>"},
{tag:"#CLIENTLIST_LINUX_DEVICE",text:"<#1588#>"},
{tag:"#CLIENTLIST_SMARTPHONE",text:"<#1589#>"},
{tag:"#CLIENTLIST_IPHONE",text:"<#1590#>"},
{tag:"#CLIENTLIST_ASUS_SMARTPHONE",text:"<#1591#>"},
{tag:"#CLIENTLIST_WINDOWS_PHONE",text:"<#1592#>"},
{tag:"#CLIENTLIST_ANDROID_PHONE",text:"<#1593#>"},
{tag:"#CLIENTLIST_PAD",text:"<#1594#>"},
{tag:"#CLIENTLIST_IPAD",text:"<#1595#>"},
{tag:"#CLIENTLIST_ASUS_PAD",text:"<#1596#>"},
{tag:"#CLIENTLIST_ANDROID_TABLET",text:"<#1597#>"},
{tag:"#CLIENTLIST_REPEATER",text:"<#1598#>"},
{tag:"#CLIENTLIST_NAS_SERVER",text:"<#1599#>"},
{tag:"#CLIENTLIST_NB",text:"<#1600#>"},
{tag:"#CLIENTLIST_WINDOWS_NB",text:"<#1601#>"},
{tag:"#CLIENTLIST_MACBOOK",text:"<#1602#>"},
{tag:"#Clientlist_ASUS_NB",text:"<#1603#>"},
{tag:"#CLIENTLIST_SD_CARD",text:"<#1604#>"},
{tag:"#CLIENTLIST_ROG_DEVICE",text:"<#1605#>"},
{tag:"#CLIENTLIST_SCANNER",text:"<#1606#>"},
{tag:"#CLIENTLIST_APPLE_DEVICE",text:"<#1607#>"},
{tag:"#CLIENTLIST_ANDROID_DEVICE",text:"<#1608#>"},
{tag:"#CLIENTLIST_WINDOWS_DEVICE",text:"<#1609#>"},
{tag:"#CLIENTLIST_ASUS_DEVICE",text:"<#1610#>"},
{tag:"#CLIENTLIST_MEDIA_ENTERTAINMENT",text:"<#1611#>"},
{tag:"#CLIENTLIST_ELECTRONIC_EQUIPMENT",text:"<#1612#>"},
{tag:"#CLIENTLIST_AIR_CONDITIONER",text:"<#1613#>"},
{tag:"#CLIENTLIST_REFRIGERATOR",text:"<#1614#>"},
{tag:"#CLIENTLIST_WEIGHT_SCALE",text:"<#1615#>"},
{tag:"#CLIENTLIST_ELECTRIC_POT",text:"<#1616#>"},
{tag:"#CLIENTLIST_MICROWAVE_OVEN",text:"<#1617#>"},
{tag:"#CLIENTLIST_AIR_PURIFIER",text:"<#1618#>"},
{tag:"#CLIENTLIST_FAN",text:"<#1619#>"},
{tag:"#CLIENTLIST_DEHUMIDIFIER",text:"<#1620#>"},
{tag:"#CLIENTLIST_WASHING_MACHINE",text:"<#1621#>"},
{tag:"#CLIENTLIST_WATER_HEATER",text:"<#1622#>"},
{tag:"#CLIENTLIST_ELECTRIC_KETTLE",text:"<#1623#>"},
{tag:"#CLIENTLIST_SMART_BULB",text:"<#1624#>"},
{tag:"#CLIENTLIST_SMART_TV",text:"<#1625#>"},
{tag:"#CLIENTLIST_CLEANING_ROBOT",text:"<#1626#>"},
{tag:"#CLIENTLIST_SECURITY",text:"<#1627#>"},
{tag:"#CLIENTLIST_SEISMOGRAPH",text:"<#1628#>"},
{tag:"#CLIENTLIST_SMART_LOCK",text:"<#1629#>"},
{tag:"#CLIENTLIST_WEARABLES",text:"<#1630#>"},
{tag:"#CLIENTLIST_SMART_BRACELET",text:"<#1631#>"},
{tag:"#CLIENTLIST_WATCH",text:"<#1632#>"},
{tag:"#CLIENTLIST_WALL_SWITCH",text:"<#1633#>"},
{tag:"#CLIENTLIST_WINDOW_SENSOR",text:"<#1634#>"},
{tag:"#CLIENTLIST_TEMPERATURE_HUMIDITY_SENSOR",text:"<#1635#>"},
{tag:"#CLIENTLIST_BODY_SENSOR",text:"<#1636#>"},
{tag:"#CLIENTLIST_SMART_PLUG",text:"<#1637#>"},
{tag:"#CLIENTLIST_ROBOT",text:"<#1638#>"},
{tag:"#PRINTER",text:"<#1577#>"},
{tag:"#ROUTER",text:"<#1760#>"},
{tag:"#NAS",text:"<#1762#>"},
{tag:"#IPCAM",text:"<#1763#>"}
];
...
$upload_category.append($("<div>").addClass("category_title").html("<#2940#>"));
