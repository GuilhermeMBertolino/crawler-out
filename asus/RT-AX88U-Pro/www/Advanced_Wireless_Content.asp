...
if(based_modelid == 'XT8PRO' || based_modelid == 'BT12' || based_modelid == 'BQ16' || based_modelid == 'BQ16_PRO' || based_modelid == 'BM68'){
...
if((based_modelid == 'GT-AX11000' || based_modelid == 'RT-AX92U' || based_modelid == 'RT-AX95Q' || based_modelid == 'XT8PRO' || based_modelid == 'BT12' || based_modelid == 'BQ16' || based_modelid == 'BQ16_PRO' || based_modelid == 'BM68' || based_modelid == 'XT8_V2' || based_modelid == 'GT-AXE11000' || based_modelid == 'GT-AX11000_PRO' || based_modelid == 'ET12' || based_modelid == 'XT12' || based_modelid == 'GT-AXE16000' || based_modelid == 'GT-BE98' || based_modelid == 'GT-BE98_PRO' || based_modelid == 'GT-BE96') && wl2.channel_160m == "" && wl_unit == '2'){
...
if((smart_connect_support || smart_connect_v2_support) && (isSwMode("rt") || isSwMode("ap"))){ //get select before and control setting
...
document.getElementById("auto_channel").innerHTML = "<#3914#>: " + temp;
}
...
$('#band0_autoChannel').html('<#3914#>: ' + cur_control_channel[0]);
}
if (band1_channel == '0') {
$('#band1_autoChannel').show();
$('#band1_autoChannel').html('<#3914#>: ' + cur_control_channel[1]);
}
...
$('#band2_autoChannel').html('<#3914#>: ' + cur_control_channel[2]);
}
}
}
...
if(document.form.wl_wpa_psk.value == "<#3918#>"){
...
if((smart_connect_support || smart_connect_v2_support) && (isSwMode("rt") || isSwMode("ap")) && document.form.smart_connect_x.value != 0){ //apply smart connect setting
...
if(document.form.smart_connect_x.value == '1'){
document.form.smart_connect_selif_x.value = '7';
}
else if(document.form.smart_connect_x.value == '2'){
document.form.smart_connect_selif_x.value = '6';
}
}
if(meshBackhaulAutoSupport && document.form.fh_ap_enabled){
...
confirm_asus({
title: "<#4017#>",
contentA: confirm_content+"<br><br><#1041#> <#1024#>",
contentC: "",
left_button: "<#1704#>",
left_button_callback: function(){
...
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4105#>';
else{
if(band5g_11ac_support)
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4108#>';
else
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4109#>';
}
...
var tmo2nmode = [["0", "<#166#>"],["6", "B Only"],["5", "G Only"],["1", "N Only"],["2", "B/G Mixed"],["4", "G/N Mixed"]];
var tmo5nmode = [["0", "<#166#>"],["7", "A Only"],["1", "N Only"],["3", "AC Only"],["4", "A/N Mixed"]];
...
if(wl_info.band2g_support && wl_info.band5g_support && (wl_info.band5g_2_support || wl_info.band6g_support)){
if(band6g_support){
desc = ["<#3280#> (2.4 GHz, 5 GHz and 6 GHz)"];
value = ["1"];
}
else{
desc = ["<#3280#> (2.4 GHz, 5 GHz-1 and 5 GHz-2)", "5 GHz Smart Connect (5 GHz-1 and 5 GHz-2)"];
value = ["1", "2"];
}
}
else if(wl_info.band2g_support && wl_info.band5g_support){
desc = ["<#3279#> (2.4 GHz and 5 GHz)"];
value = ["1"];
}
}
...
if((based_modelid == 'GT-AX11000' || based_modelid == 'RT-AX92U' || based_modelid == 'RT-AX95Q' || based_modelid == 'XT8PRO' || based_modelid == 'BT12' || based_modelid == 'BQ16' || based_modelid == 'BQ16_PRO' || based_modelid == 'BM68' || based_modelid == 'XT8_V2' || based_modelid == 'RT-AXE95Q' || based_modelid == 'ET8PRO' || based_modelid == 'ET8_V2' || based_modelid == 'GT-AXE11000' || based_modelid == 'GT-AX11000_PRO' || based_modelid == 'ET12' || based_modelid == 'XT12' || based_modelid == 'GT-AXE16000' || based_modelid == 'GT-BE98' || based_modelid == 'GT-BE98_PRO' || based_modelid == 'GT-BE96') && wl2.channel_160m == '' && wl_unit == '2'){
...
$("#enable_160_field").hide();
if ((wl_unit == '0' && val == '2') || based_modelid == "RT-AC3200" || ((based_modelid == "RT-AX92U" || based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "BT12" || based_modelid == "BQ16" || based_modelid == "BQ16_PRO" || based_modelid == "BM68" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "ET8_V2") && country != "EU" && wl_unit == "1")) {
$("#dfs_checkbox").hide();
}
else {
$("#dfs_checkbox").show();
...
$("#auto_channel").html("<#3914#>: " + cur_control_channel[wl_unit]);
...
$selectObj.append($('<option>', {value: "2", text: "<#1094#>"}));
/*
if(select_node_capability.fronthaul_ap_option_auto)
$selectObj.append($('<option>', {value: "1", text: "<#166#>"}));
*/
if(select_node_capability.fronthaul_ap_option_off)
$selectObj.append($('<option>', {value: "0", text: "<#1095#>"}));
if(meshBackhaulAutoSupport ){
$selectObj.append($('<option>', {value: "1", text: "", hidden: true}));
}
if($selectObj.find("option").length > 0){
var $trObj = $("<tr>").addClass("fronthaul_ap");
var $thObj = $("<th>").html("<#1093#>");
var $tdObj = $("<td>");
$trObj.append($thObj).append($tdObj.append($selectObj));
if(meshBackhaulAutoSupport ){
var fh_connect_obj ='<div id="fh_connection_hint" style="color:#FC0;"><input id="fh_connection_hint_checkbox" type="checkbox" onchange="handleFhConnectionHint(this.checked)"><#1096#></div>';
...
if(dwb_info.band == wl_unit){
var value = ["1"];
var desc = ["<#3279#> (2.4 GHz and 5 GHz)"];
if($(this).val() == "2")
desc = ["<#3280#>"];
...
<div style="margin:-55px 0 0 75px;"><#717#></div>
</div>
...
<input type="hidden" name="smart_connect_selif_x" value='<% nvram_get("smart_connect_selif_x"); %>'>
...
<div class="formfontdesc"><#951#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0,27);"><#3282#></a></th>
<td>
...
<div id="radio_smartcon_enable" class="left" style="width: 94px;display:table-cell;"></div><div id="smartcon_rule_link" style="display:table-cell; vertical-align: middle;"><a href="Advanced_Smart_Connect.asp" class="sc_rule_link btn_subusage"><#3285#></a></div>
<div class="clear"></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_bss_enabled", "0","selected"); %>><#3995#></option>
<option class="content_input_fd" value="1" <% nvram_match("wl_bss_enabled", "1","selected"); %>><#3994#></option>
</select>
</td>
</tr-->
<tr id="wl_ssid_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 1);"><#586#></a></th>
<td id="ssid_setting">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#4017#></a></th>
<td>
<input type="radio" value="1" name="wl_closed" class="input" <% nvram_match("wl_closed", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="wl_closed" class="input" <% nvram_match("wl_closed", "0", "checked"); %>><#199#>
<br>
<span id="dwb_band_hide_hint"><#59#></span>
</td>
</tr>
<tr>
<th><a id="wl_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4058#></a></th>
<td>
...
<span id="wl_optimizexbox_span" style="display:none"><input type="checkbox" name="wl_optimizexbox_ckb" id="wl_optimizexbox_ckb" value="<% nvram_get("wl_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4060#></span>
<span id="wl_gmode_checkbox" style="display:none;"><input type="checkbox" name="wl_gmode_check" id="wl_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4059#></span>
...
<span id="wl_nmode_x_hint" style="display:none;"><br><#4106#><br></span>
<span id="wl_NOnly_note" style="display:none;"></span>
<br>
<span id="wl_AXOnly_note" style="display:none;"><#4110#></span>
...
<th>
<a id="he_mode_text" class="hintstyle"><#3969#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl_11ax", "1","selected"); %>><#3994#></option>
<option value="0" <% nvram_match("wl_11ax", "0","selected"); %>><#3995#></option>
</select>
<span id="he_mode_faq" style="padding: 0 10px"><#3970#></span>
</div>
</td>
</tr>
<tr id="mbo_field" style="display:none">
<th>
<a class="hintstyle"><#3927#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_mbo_enable" class="input_option" onChange="handleMFP();">
<option value="1" <% nvram_match("wl_mbo_enable", "1","selected"); %>><#3994#></option>
<option value="0" <% nvram_match("wl_mbo_enable", "0","selected"); %>><#3995#></option>
</select>
</div>
</td>
</tr>
...
<th>
<a class="hintstyle"><#3985#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_twt" class="input_option">
<option value="1" <% nvram_match("wl_twt", "1","selected"); %>><#3994#></option>
<option value="0" <% nvram_match("wl_twt", "0","selected"); %>><#3995#></option>
</select>
</div>
</td>
</tr>
...
<span id="enable_160_field" style="display:none"><input type="checkbox" onClick="enable_160MHz(this);" id="enable_160mhz" ><#3940#></span>
</td>
</tr>
<tr>
<th>
<a id="wl_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#876#></a>
</th>
<td>
...
<div><span id="dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#3962#></span></div>
<div><span id="acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#3960#></span></div>
<div><span id="acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#3961#></span></div>
<div><span id="acs_ch13_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#3959#></span></div>
<div><span id="psc6g_field" style="display:none;"><input id="psc6g_checkbox" type="checkbox" onClick="wl_chanspec_list_change();" <% nvram_match("psc6g", "1", "checked"); %>><#4386#> <#4387#></span></div>
<div><span id="acs_unii4_field" style="display:none;"><input id="acs_unii4_checkbox" type="checkbox" onClick="handleUNII4Hint(this.checked)" <% nvram_match("acs_unii4", "1", "checked"); %>><#3963#></span></div>
</td>
</tr>
<tr id="wl_nctrlsb_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 15);"><#3966#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 5);"><#3930#></a></th>
<td>
<div>
...
<option value="owe" <% nvram_match("wl_auth_mode_x", "owe", "selected"); %>><#4388#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 6);"><#881#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 7);"><#4069#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 9);"><#3992#></a></th>
<td>
<select name="wl_wep_x" class="input_option" onChange="wep_encryption_change(this);">
<option value="0" <% nvram_match("wl_wep_x", "0", "selected"); %>><#875#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 10);"><#877#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#3987#></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#3988#></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#3989#></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#3990#></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 8);"><#4065#></a></th>
<td>
...
<option value="0" <% nvram_match("wl_mfp", "0", "selected"); %>><#3995#></option>
<option value="1" <% nvram_match("wl_mfp", "1", "selected"); %>><#4051#></option>
<option value="2" <% nvram_match("wl_mfp", "2", "selected"); %>><#4052#></option>
</select>
...
<span id="mbo_notice" style="display:none"><#3928#></span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 11);"><#4080#></a></th>
...
<span id="band0_autoChannel" style="display:none;margin-left:10px;"><#3914#></span><br>
<span id="band0_acs_ch13"><input id="band0_acs_ch13_checkbox" type="checkbox" <%
nvram_match("acs_ch13", "1" , "checked" ); %>><#3959#></span>
</td>
</tr>
...
<span id="band1_autoChannel" style="display:none;margin-left:10px;"><#3914#></span><br>
<span id="band1_acsDFS"><input id="band1_acsDFS_checkbox" type="checkbox" <%
nvram_match("acs_dfs", "1" , "checked" ); %>><#3962#></span>
</td>
</tr>
...
<span id="band2_autoChannel" style="display:none;margin-left:10px;"><#3914#></span><br>
<span id="band2_acsDFS"><input id="band2_acsDFS_checkbox" type="checkbox" <% nvram_match("acs_band3", "1" , "checked" ); %>><#3962#></span>
<span id="band2_psc6g" style="display:none"><input id="band2_psc6g_checkbox" type="checkbox" onclick="separateGenChannel('2', document.form.band2_channel.value, document.form.band2_bw.value);" <% nvram_match("psc6g", "1" , "checked" ); %>><#4386#> <#4387#></span>
<span id="band2_acs_unii4_field" style="display:none;"><br><input id="band2_acs_unii4_checkbox" type="checkbox" onClick="handleUNII4Hint(this.checked)" <% nvram_match("acs_unii4", "1", "checked"); %>><#3963#></span>
</td>
</tr>
