...
grid += "<tr><th style=\"height:30px;\"><#1721#></th>";
grid += "<th><#3420#></th>";
grid += "<th><#3427#></th>";
grid += "<th><#3430#></th></tr>";
...
if(rows == 0)
grid +='<tr><td style="color:#FFCC00;" colspan="4"><#2475#></td></tr>';
...
<option value="2"><#2734#></option>
<option value="3" selected><#2735#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="2" id="TriggerList" style="text-align:left;"><#2674#> <span style="color:#FFF;background-color:transparent;" id='last-dates'></span></td>
</tr>
</thead>
<tbody>
<tr class='even'><th width="40%"><#3420#></th><td id='last-dn'>-</td></tr>
<tr class='odd'><th width="40%"><#3427#></th><td id='last-up'>-</td></tr>
<tr class='footer'><th width="40%"><#3430#></th><td id='last-total'>-</td></tr>
</tbody>
</table>
</td>
</tr>
