...
<script>
option_netstat = new Array("<#3266#>","<#3270#>","<#3271#>","<#3269#>","<#3272#>","<#3267#>","<#1809#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2874#>", "<#2875#>", "<#2876#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2896#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2888#> - Netstat</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2896#></div>
...
<option value="-a"><#3266#></option>
<option value="-ta"><#3270#></option>
<option value="-ua"><#3271#></option>
<option value="-w"><#3269#></option>
<option value="-xa"><#3272#></option>
<option value="-l"><#3267#></option>
<option value="-r"><#1809#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2903#> IP</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3204#>">
...
<option value="-r state" selected><#2881#></option>
<option value="-r src"><#2879#></option>
<option value="-r dst"><#2877#></option>
<option value="-r src-port"><#2880#></option>
<option value="-r dst-port"><#2878#></option>
</select>
</td>
</tr>
