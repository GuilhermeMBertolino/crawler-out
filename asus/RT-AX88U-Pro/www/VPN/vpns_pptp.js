...
if(based_modelid == "RT-AC5300" || based_modelid == "GT-AC5300" || based_modelid == "GT-AC9600" || based_modelid == "RT-AC3200" || based_modelid == "RT-AC3100" || based_modelid == "GT-AX11000" || based_modelid == "RT-AX92U" || based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "BT12" || based_modelid == "BQ16" || based_modelid == "BQ16_PRO" || based_modelid == "BM68" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "ET8_V2" || based_modelid == "RT-AX56_XD4" || based_modelid == "XD4PRO" || based_modelid == "CT-AX56_XD4" || based_modelid == "RT-AX58U" || based_modelid == "RT-AX58U_V2" || based_modelid == "TUF-AX3000" || based_modelid == "TUF-AX5400" || based_modelid == "DSL-AX82U" || based_modelid == "RT-AX82U" || based_modelid == "RT-AX56U" || based_modelid == "RT-AC88U" || based_modelid == "RT-AX88U" || based_modelid == "RT-AC86U" || based_modelid == "GT-AC2900" || based_modelid == "RT-AC87U" || based_modelid == "RT-AC68U" || based_modelid == "RT-AX86U" || based_modelid == "RT-AX68U" || based_modelid == "RT-AC68U_V4" || based_modelid == "GT-AXE11000" || based_modelid == "GS-AX3000" || based_modelid == "GS-AX5400" || based_modelid == "GT-AX6000" || based_modelid == "GT-AX11000_PRO" || based_modelid == "ET12" || based_modelid == "XT12" || based_modelid == "GT-AXE16000" || based_modelid == "GT-BE98" || based_modelid == "GT-BE98_PRO" || based_modelid == "RT-BE96U" || based_modelid == "GT-BE96" || based_modelid == "RT-BE88U" || based_modelid == "RT-BE86U" || based_modelid == "RT-BE58U" || based_modelid == "TUF-BE3600" || based_modelid == "RT-AC66U" || based_modelid == "RT-AC56U" || based_modelid == "RT-N66U" || based_modelid == "RT-N18U" || based_modelid == "XC5" || based_modelid == "EBA63"){
...
var $faq = $("<a/>").attr({"id":"faq", "target":"_blank", "href":faq_href}).html("<#183#> FAQ")
...
$("<div>").addClass("item_hint").html("* <#3661#>").appendTo($container);
return $container;
}
...
var pptpd_clientlist_username = {"title":"<#3616#>", "type":"text", "id":"pptpd_clientlist_username", "need_check":true, "maxlength":64};
...
.val(htmlEnDeCode.htmlEncode());
var pptpd_clientlist_password = {"title":"<#2363#>", "type":"text", "id":"pptpd_clientlist_password", "need_check":true, "maxlength":64};
...
$("<div>").addClass("profile_title_item").append($("<span>").html("<#3148#> (<#2032#>)")).appendTo($content_container);
var pptpd_sr_ipaddr = {"title":"<#3153#>", "type":"text", "id":"pptpd_sr_ipaddr", "maxlength":15, "openHint":"6_1"};
...
var pptpd_sr_netmask = {"title":"<#3154#>", "type":"text", "id":"pptpd_sr_netmask", "maxlength":15, "openHint":"6_2"};
...
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
var $btn_container_apply = $("<div>").addClass("btn_container apply").html("<#1704#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
testResult.isError = true;
testResult.errReason = "<#3638#> " + clients_start;
}
return testResult;
};
...
if($pptpd_dnsenable_x.hasClass("off")){
if($pptpd_dns1.val() == ""){
$pptpd_dns1.show_validate_hint("<#339#>");
$pptpd_dns1.focus();
return false;
}
...
if($pptpd_dns2.val() == ""){
$pptpd_dns2.show_validate_hint("<#339#>");
$pptpd_dns2.focus();
return false;
}
...
if($pptpd_winsenable_x.hasClass("off")){
if($pptpd_wins1.val() == ""){
$pptpd_wins1.show_validate_hint("<#339#>");
$pptpd_wins1.focus();
return false;
}
...
if($pptpd_wins2.val() == ""){
$pptpd_wins2.show_validate_hint("<#339#>");
$pptpd_wins2.focus();
return false;
}
...
if($pptpd_mru.val() == ""){
$pptpd_mru.show_validate_hint("<#339#>");
$pptpd_mru.focus();
return false;
}
...
if($pptpd_mtu.val() == ""){
$pptpd_mtu.show_validate_hint("<#339#>");
$pptpd_mtu.focus();
return false;
}
...
$pptpd_clients_start.show_validate_hint($pptpd_clients_start.val() + " <#353#>");
$pptpd_clients_start.focus();
return false;
}
$pptpd_clients_end.val($pptpd_clients_end.val().trim());
if($pptpd_clients_end.val() == ""){
$pptpd_clients_end.show_validate_hint("<#339#>");
...
if($pptpd_clientlist_username.val() == ""){
$pptpd_clientlist_username.show_validate_hint("<#339#>");
...
if($pptpd_clientlist_password.val() == ""){
$pptpd_clientlist_password.show_validate_hint("<#339#>");
...
$pptpd_sr_ipaddr.show_validate_hint("<#3651#> " + lan_ipaddr);
$pptpd_sr_ipaddr.focus();
return false;
}
}
...
result = "<#3649#> <b>"+pool_start+" ~ "+pool_end+"</b>";
}
...
var pptpd_ms_network_parm = {"title":"<#3663#>", "type":"switch", "id":"pptpd_ms_network"};
...
var pptpd_broadcast_parm = {"title":"<#3643#>", "type":"switch", "id":"pptpd_broadcast"};
Get_Component_Switch(pptpd_broadcast_parm).appendTo($detail_adv);
$("<div>").attr({"id": "PPTP_broadcast_hint"}).addClass("item_hint").html("* <#3063#>").appendTo($detail_adv).hide();
var pptpd_chap_options = [{"text":"<#166#>","value":"0"},{"text":"MS-CHAPv1","value":"1"},{"text":"MS-CHAPv2","value":"2"}];
var pptpd_chap_parm = {"title": "<#3031#>", "id": "pptpd_chap", "options": pptpd_chap_options, "set_value": "0"};
Get_Component_Custom_Select(pptpd_chap_parm).appendTo($detail_adv);
var pptpd_mppe_options = [{"text":"MPPE-128","value":"1"},{"text":"MPPE-40","value":"4"},{"text":"<#2913#>","value":"8"}];
var pptpd_mppe_parm = {"title": "<#2852#>", "id": "pptpd_mppe", "options": pptpd_mppe_options};
...
var pptpd_dnsenable_x_parm = {"title":"<#327#>", "type":"switch", "id":"pptpd_dnsenable_x", "slide_target":"pptpd_dns"};
...
var pptpd_dns1_parm = {"title":"<#313#>", "type":"text", "id":"pptpd_dns1", "need_check":true, "maxlength":15};
Get_Component_Input(pptpd_dns1_parm).appendTo($pptpd_dns_content_container)
.find("#" + pptpd_dns1_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var pptpd_dns2_parm = {"title":"<#315#>", "type":"text", "id":"pptpd_dns2", "need_check":true, "maxlength":15};
Get_Component_Input(pptpd_dns2_parm).appendTo($pptpd_dns_content_container)
.find("#" + pptpd_dns2_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var pptpd_winsenable_x_parm = {"title":"<#2493#>", "type":"switch", "id":"pptpd_winsenable_x", "slide_target":"pptpd_wins"};
...
var pptpd_wins1_parm = {"title":"<#2491#>", "type":"text", "id":"pptpd_wins1", "need_check":true, "maxlength":15};
Get_Component_Input(pptpd_wins1_parm).appendTo($pptpd_wins_content_container)
.find("#" + pptpd_wins1_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var pptpd_wins2_parm = {"title":"<#2492#>", "type":"text", "id":"pptpd_wins2", "need_check":true, "maxlength":15};
...
var pptpd_clients_parm = {"title":"<#3647#>", "type":"text", "start_id":"pptpd_clients_start", "start_maxlength":15, "end_id":"pptpd_clients_end", "end_maxlength":3,
...
$("<div>").addClass("profile_title_item").append($("<span>").html("<#3785#>")).appendTo($detail_general);
pptpd_clientlist_data = [];
var $Add_Client_Title_obj = Get_Component_Add_Client_Title().appendTo($detail_general);
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("<#3813#> (<#2693#>" + htmlEnDeCode.htmlEncode(pptpd_clientlist_limit) + ")");
...
show_customize_alert("<#4356#>".replace("#MAXNUM", pptpd_clientlist_limit));
return false;
}
