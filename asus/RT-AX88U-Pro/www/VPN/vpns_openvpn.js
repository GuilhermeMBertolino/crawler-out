...
$("<div>").addClass("title").html("<#2909#>").appendTo($feature_desc);
...
$("<div>").addClass("title").html("<#2347#>").appendTo($feature_desc);
...
$("<div>").addClass("text import_file").html(htmlEnDeCode.htmlEncode("<#1553#>")).appendTo($btn_container);
$("<div>").attr({"id":"openvpn_initial"}).addClass("pure_text loadingicon").html("<#3689#>").appendTo($input_container).hide();
...
var $text = $("<div>").addClass("text import_file").html(htmlEnDeCode.htmlEncode("<#1714#>")).appendTo($btn_container);
...
{
$(this).closest(".btn_item").find(".status_text").html("<#3233#>").show();
return false;
}
...
$input_btn.closest(".btn_item").find(".status_text").html("<#3218#>").show();
}
});
});
...
$("<div>").addClass("title").html("<#3617#>").appendTo($popup_title_container);
var $close_btn = $("<div>").addClass("vpn_icon_all_collect close_btn");
$close_btn.appendTo($popup_title_container);
$close_btn.unbind("click").click(function(e){
e = e || event;
...
var clientlist_username = {"title":"<#3616#>", "type":"text", "id":"clientlist_username", "need_check":true, "maxlength":64};
...
var clientlist_password = {"title":"<#2363#>", "type":"text", "id":"clientlist_password", "need_check":true, "maxlength":64};
...
var $btn_container_apply = $("<div>").addClass("btn_container apply").appendTo($action_container).html("<#1704#>");
...
common_name.title = ($(_obj).find("#vpn_server_igncrt").hasClass("on")) ? "<#3616#>" : "Common Name(CN)";/* untranslated */
Get_Component_Input(common_name).appendTo($content_container);
var subnet = {"title":"<#3348#>", "type":"text", "id":"vpn_clientlist_subnet_0", "need_check":true, "maxlength":15, "openHint":"32_23"};
...
var subnet = {"title":"<#3154#>", "type":"text", "id":"vpn_clientlist_netmask_0", "need_check":true, "maxlength":15, "openHint":"32_24"};
Get_Component_Input(subnet).appendTo($content_container)
.find("#" + subnet.id + "").unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var push = {"title":"<#3088#>", "type":"switch", "id":"vpn_clientlist_push_0", "openHint":"32_25"};
...
var $container = $("<div>");
var $popup_title_container = $("<div>").addClass("popup_title_container").appendTo($container);
$("<div>").addClass("title").html("<#3703#>").appendTo($popup_title_container);
var $close_btn = $("<div>").addClass("vpn_icon_all_collect close_btn");
$close_btn.appendTo($popup_title_container);
$close_btn.unbind("click").click(function(e){
e = e || event;
...
if(auth == "tls"){
var vpn_crt_server1_ca_parm = {"title":"<#3692#>", "id":"edit_vpn_crt_server1_ca", "rows":"8", "cols":"65", "maxlength":"3999"};
Get_Component_Textarea(vpn_crt_server1_ca_parm).appendTo($content_container);
var vpn_crt_server1_crt_parm = {"title":"<#3697#>", "id":"edit_vpn_crt_server1_crt", "rows":"8", "cols":"65", "maxlength":"3999"};
Get_Component_Textarea(vpn_crt_server1_crt_parm).appendTo($content_container);
var vpn_crt_server1_key_parm = {"title":"<#3701#>", "id":"edit_vpn_crt_server1_key", "rows":"8", "cols":"65", "maxlength":"3999"};
Get_Component_Textarea(vpn_crt_server1_key_parm).appendTo($content_container);
var vpn_crt_server1_dh_parm = {"title":"<#3693#>", "id":"edit_vpn_crt_server1_dh", "rows":"8", "cols":"65", "maxlength":"3999"};
Get_Component_Textarea(vpn_crt_server1_dh_parm).appendTo($content_container);
var vpn_crt_server1_crl_parm = {"title":"<#3788#> (<#2032#>)", "id":"edit_vpn_crt_server1_crl", "rows":"8", "cols":"65", "maxlength":"3999"};
Get_Component_Textarea(vpn_crt_server1_crl_parm).appendTo($content_container);
}
else if(auth == "secret"){
var vpn_crt_server1_static_parm = {"title":"<#3702#>", "id":"edit_vpn_crt_server1_static", "rows":"8", "cols":"65", "maxlength":"3999"};
Get_Component_Textarea(vpn_crt_server1_static_parm).appendTo($content_container);
}
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
$("<div>").addClass("btn_container apply").appendTo($action_container).html("<#1704#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
if(auth == 'tls'){
httpApi.nvramSet({
...
$(_obj).find("#openvpn_error_message").show().html("<#3682#>");
}
else if(vpnd_state != '2' && vpn_server1_errno == '4'){
$(_obj).find("#openvpn_initial").hide();
$(_obj).find("#openvpn_error_message").show().html("<#3683#>");
}
else if(vpnd_state != '2' && vpn_server1_errno == '5'){
$(_obj).find("#openvpn_initial").hide();
$(_obj).find("#openvpn_error_message").show().html("<#3684#>");
}
else if((vpnd_state == '-1' && vpn_server1_errno == '0') || (vpnd_state != '2' && vpn_server1_errno == '7')){
$(_obj).find("#openvpn_initial").hide();
$(_obj).find("#openvpn_error_message").show().html("<#3685#>");
}
...
$("<div>").addClass("profile_title_item connect_client_title").append($("<span>").html("<#3334#> - " + idx)).appendTo($content_container);
...
$vpn_server_sn.show_validate_hint("<#3651#> " + origin_lan_ip);
$vpn_server_sn.focus();
return false;
}
if(lan_ip_subnet == openvpn_server_subnet){
$vpn_server_sn.show_validate_hint("<#3649#>"+pool_start+" ~ "+pool_end);
$vpn_server_sn.focus();
return false;
}
...
$vpn_server_r1.show_validate_hint("<#3651#> "+origin_lan_ip);
$vpn_server_r1.focus();
return false;
}
...
var detail_options_parm = {"title": "<#808#>", "id": "detail_options", "options": detail_options, "set_value": "1"};
...
var vpn_server_port_parm = {"title":"<#3926#>", "type":"text", "id":"vpn_server_port", "need_check":true, "maxlength":5};
...
var $vpn_server_port_hint_obj = $("<div>").addClass("item_hint").html("* <#3318#>").appendTo($detail_general);
...
var vpn_server_tls_keysize_parm = {"title": "<#3170#>", "id": "vpn_server_tls_keysize", "options": vpn_server_tls_keysize_options, "openHint":"32_8", "display_type": "horizontal"};
...
var vpn_server_client_access_options = [{"text":"<#3641#>","value":"0"},{"text":"<#3642#>","value":"1"},{"text":"<#1719#>","value":"2"}];
var vpn_server_client_access_parm = {"title": "<#3640#>", "id": "vpn_server_client_access", "options": vpn_server_client_access_options, "display_type": "vertical"};
...
var export_ovpn_parm = {"title":"<#3657#>", "type":"export_ovpn"};
...
var renew_cert_parm = {"title":"<#3768#>", "type":"renew_cert", "openHint":"33_2"};
...
var export_cert_parm = {"title":"<#3658#>", "type":"import_cert", "openHint":"32_27"};
Get_Component_Export_Cert(export_cert_parm).appendTo($cert_btn_bg);
var import_cert_parm = {"title":"<#3659#>", "type":"import_cert", "openHint":"32_28"};
...
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("<#3813#> (<#2693#>" + htmlEnDeCode.htmlEncode(openvpn_clientlist_limit) + ")");
...
show_customize_alert("<#4356#>".replace("#MAXNUM", openvpn_clientlist_limit));
return false;
}
...
var detail_adv_switch_parm = {"options": [{"text":"<#409#>","value":"1"},{"text":"<#3675#>","value":"2"}]};
...
var vpn_server_if_parm = {"title": "<#3690#>", "id": "vpn_server_if", "options": vpn_server_if_options, "openHint":"32_4"};
...
var vpn_server_proto_parm = {"title": "<#2468#>", "id": "vpn_server_proto", "options": vpn_server_proto_options, "openHint":"32_5"};
Get_Component_Custom_Select(vpn_server_proto_parm).appendTo($detail_adv_standard);
var vpn_server_x_dns_parm = {"title":"<#3710#>", "type":"switch", "id":"vpn_server_x_dns", "openHint":"32_15"};
...
var vpn_server_pdns_parm = {"title":"<#3664#>", "type":"switch", "id":"vpn_server_pdns", "openHint":"32_16", "container_id":"server_pdns"};
...
var vpn_server_cipher_parm = {"title": "<#3681#>", "id": "vpn_server_cipher", "options": vpn_server_cipher_options, "openHint":"32_17"};
...
var vpn_server_digest_parm = {"title": "<#3668#>", "id": "vpn_server_digest", "options": vpn_server_digest_options, "openHint":"32_26"};
Get_Component_Custom_Select(vpn_server_digest_parm).appendTo($detail_adv_standard);
var vpn_server_comp_options = [
{"text":"<#3995#>","value":"-1"},
{"text":"<#875#>","value":"no"},
{"text":"<#3994#>","value":"yes"},
{"text":"<#907#>","value":"adaptive"},
{"text":"LZ4","value":"lz4"}
];
var vpn_server_comp_parm = {"title": "<#3673#>", "id": "vpn_server_comp", "options": vpn_server_comp_options, "openHint":"32_18"};
Get_Component_Custom_Select(vpn_server_comp_parm).appendTo($detail_adv_standard);
var vpn_server_igncrt_parm = {"title":"<#3666#>", "type":"switch", "id":"vpn_server_igncrt", "openHint":"32_9"};
...
var vpn_server_crypt_parm = {"title": "<#3665#>", "id": "vpn_server_crypt", "options": vpn_server_crypt_options, "openHint":"32_7"};
...
$("<div>").attr("id", "Hint_fixed_tls_crypto").addClass("item_hint").html("* <#3667#>").appendTo($detail_adv_standard);
var openvpn_keys_parm = {"title":"<#3706#>"};
...
"title": "<#3669#> (TLS-Auth)", "id": "vpn_server_hmac", "options": vpn_server_hmac_options,
...
var server_snnm_parm = {"title":"<#3712#>", "openHint":"32_11",
...
if(ipv6_item_flag){
var vpn_server_sn6_parm = {"title":"IPv6 <#3712#>", "type":"text", "id":"vpn_server_sn6", "need_check":true, "maxlength":43,
"container_id":"server_sn6"};
Get_Component_Input(vpn_server_sn6_parm).appendTo($detail_adv_standard);
}
var vpn_server_dhcp_parm = {"title":"<#3680#>", "type":"switch", "id":"vpn_server_dhcp", "openHint":"32_13", "container_id":"server_dhcp"};
...
var server_range_parm = {"title":"<#3671#>", "openHint":"32_14",
...
var server_local_parm = {"title":"<#3704#>", "openHint":"32_12",
...
if(ipv6_item_flag){
var server_local_parm = {"title":"IPv6 <#3704#>",
...
var vpn_server_plan_parm = {"title":"<#3708#>", "type":"switch", "id":"vpn_server_plan", "openHint":"32_2", "container_id":"server_plan"};
Get_Component_Switch(vpn_server_plan_parm).appendTo($detail_adv_standard);
var vpn_server_rgw_parm = {"title":"<#3709#>", "type":"switch", "id":"vpn_server_rgw", "openHint":"32_3", "container_id":"server_rgw"};
Get_Component_Switch(vpn_server_rgw_parm).appendTo($detail_adv_standard);
var vpn_server_reneg_parm = {"title":"<#3713#> (<#3196#>)", "type":"text", "id":"vpn_server_reneg", "need_check":true, "maxlength":5, "openHint":"32_19", "container_id":"server_reneg"};
Get_Component_Input(vpn_server_reneg_parm).appendTo($detail_adv_standard)
.find("#" + vpn_server_reneg_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isNumber(this,event);
});
var vpn_server_ccd_parm = {"title":"<#3711#>", "type":"switch", "id":"vpn_server_ccd", "container_id":"server_ccd"};
...
var vpn_server_c2c_parm = {"title":"<#3670#>", "type":"switch", "id":"vpn_server_c2c", "openHint":"32_20", "container_id":"server_c2c"};
Get_Component_Switch(vpn_server_c2c_parm).appendTo($detail_adv_standard);
var vpn_server_ccd_excl_parm = {"title":"<#3672#>", "type":"switch", "id":"vpn_server_ccd_excl", "openHint":"32_21", "container_id":"server_ccd_excl"};
...
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("Allowed Clients (<#2693#>" + htmlEnDeCode.htmlEncode(openvpn_allowed_clientlist_limit) + ")");
...
show_customize_alert("<#4356#>".replace("#MAXNUM", openvpn_allowed_clientlist_limit));
return false;
}
...
show_openvpn_allowed_clientlist($openvpn_allowed_clientlist_bg);
var vpn_server_custom_parm = {"title":"<#3675#>", "id":"vpn_server_custom", "rows":"8", "cols":"55", "maxlength":"15000"};
