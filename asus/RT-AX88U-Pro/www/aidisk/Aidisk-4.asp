...
case "0":
showtext(document.getElementById("dummyShareStr"), "\"<#3344#>\"");
break;
case "1":
showtext(document.getElementById("dummyShareStr"), "\"<#3345#>\"");
break;
case "2":
showtext(document.getElementById("dummyShareStr"), "\"<#3346#>\"");
break;
}
}
...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#3347#></td>
</tr>
<tr>
...
<input type="button" id="finish" value="<#1695#>" class="button_gen">
</div>
</td>
</tr>
</table>
