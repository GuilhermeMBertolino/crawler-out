...
if(modemlist[i] == "AUTO")
document.getElementById("shown_modems").options[i] = new Option("<#166#>", modemlist[i]);
else
...
<tr>
<td align="left">
<span class="formfonttitle"><#424#> / <#3606#></span>
</td>
<td align="right">
<img id='back_app_installation' onclick="go_setting('/APP_Installation.asp')" align="right" style="cursor:pointer;position:absolute;margin-left:-20px;margin-top:-30px;" title="<#400#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</td>
</tr>
</table>
</div>
<div style="margin:5px;" class="splitLine"></div>
<div class="formfontdesc"><#2355#></div>
...
<option value="0" <% nvram_match("modem_android", "0", "selected"); %>><#166#></option>
...
<option value="1" <% nvram_match("modem_autoapn", "1","selected"); %>><#166#></option>
<option value="0" <% nvram_match("modem_autoapn", "0","selected"); %>><#396#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,9);"><#2350#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,8);"><#2361#></a></th>
<td>
...
<tr>
<th width="40%">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(21,1);"><#3399#></a>
</th>
<td>
...
<br/><span id="hsdpa_hint" style="display:none;"><#2356#></span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,3);"><#2366#></a></th>
<td>
<input id="modem_apn" name="modem_apn" class="input_20_table" maxlength="32" type="text" value="" autocorrect="off" autocapitalize="off"/>
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3202#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,10);"><#2353#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,11);"><#3616#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,12);"><#504#></a></th>
<td>
...
<option value="0" <% nvram_match("modem_authmode", "0", "selected"); %>><#875#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,2);"><#2982#></a></th>
<td>
...
<br><span id="pincode_status" style="display:none;"><#499#></span>
</td>
</tr>
<tr>
<th>E-mail</th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,13);"><#2367#></a></th>
<td>
