...
statusmenu ="<span><#3886#></span>".replace("#WAN", "1G WAN");
else
statusmenu ="<span><#3886#></span>".replace("#WAN", "WAN");
}
else if(itemNum == 102){
statusmenu ="<span><#3887#></span>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
}
if(itemNum == 50){
statusmenu ="<span><#623#></span>";
}
if(itemNum == 85){
statusmenu ="<span><#916#></span>";
}
else if(itemNum == 86){
statusmenu ="<span><#919#><br><#908#></span>";
}
else if(itemNum == 87){
statusmenu ="<span><#931#><br><#909#></span>";
}
else if(itemNum == 88){
statusmenu ="<span><#933#><br><#911#></span>";
}
else if(itemNum == 89){
...
statusmenu ="<span><#908#></span>";
}
else if(itemNum == 92){
statusmenu ="<span><#909#></span>";
}
else if(itemNum == 93){
statusmenu ="<span><#910#></span>";
}
else if(itemNum == 94){
statusmenu ="<span><#911#></span>";
}
else if(itemNum == 95){
statusmenu ="<span><#912#></span>";
}
else if(itemNum == 96){
statusmenu ="<span><#913#></span>";
}
else if(itemNum == 97){
statusmenu ="<span><#914#></span>";
}
else if(itemNum == 103){
statusmenu ="<span><#936#></span>";
}
else if(itemNum == 104){
statusmenu ="<span><#935#></span>";
}
if(itemNum == 98){
var signal = parseInt(sim_signal);
if(isNaN(signal) || signal <= 0){
statusmenu += "<div class='StatusHint'><#2787#></div>";
}
else if(usb_state == 2 && usb_sbstate == 0 && usb_auxstate != 1){
statusmenu += "<div class='StatusHint'><#202#> <#2361#>: </div><span>" + decodeURIComponent(modem_act_provider) + "</span>";
}
else{
statusmenu += "<div class='StatusHint'><#233#></div>";
}
}
if(itemNum == 99){
if(sim_state == "1")
statusmenu += "<div class='StatusHint'><#2817#></div>";
else if(sim_state == "2"){
...
statusmenu += "<div class='StatusHint'><#2780#></div>";
else if(sim_state == "4")
statusmenu += "<div class='StatusHint'><#2779#></div>";
else if(sim_state == "5")
statusmenu += "<div class='StatusHint'><#2781#></div>";
else if(sim_state == "6")
statusmenu += "<div class='StatusHint'><#2839#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2814#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2812#></div>";
else
statusmenu += "<div><#2756#></div>";
}
if(itemNum == 24)
...
if(itemNum == 25)
statusmenu += "<span><#1302#></span>";
else if(itemNum == 23)
statusmenu += "<span><#1301#></span>";
else if(itemNum == 22)
statusmenu += "<span><#1300#></span>";
else if(itemNum == 21)
statusmenu += "<span><#1299#></span>";
else if(itemNum == 20)
statusmenu += "<span><#1298#></span>";
else if(itemNum == 19)
statusmenu += "<span><#1297#></span>";
else if(itemNum == 18)
statusmenu += "<span><#1296#></span>";
else if(itemNum == 17)
statusmenu += "<span><#1295#></span>";
else if(itemNum == 16)
statusmenu += "<span><#1294#></span>";
else if(itemNum == 15)
statusmenu += "<span><#1293#></span>";
else if(itemNum == 14)
statusmenu += "<span><#1292#></span>";
else if(itemNum == 13)
...
if(itemNum == 26)
statusmenu += "<span><#3108#></span>";
if(itemNum == "A"){
statusmenu = "<div class='StatusHint'><#925#> :</div>";
if(bwdpi_app_rulelist.indexOf('game') != -1){
modeDesc = "<#1262#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('media') != -1){
modeDesc = "<#1263#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('web') != -1){
modeDesc = "<#932#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('eLearning') != -1){
modeDesc = "<#934#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('videoConference') != -1){
modeDesc = "<#922#>"; /* untranslated */
}
else{
modeDesc = "<#1720#>"; /* untranslated */
}
...
statusmenu += "<span>" + lineDesc + "</span>";
statusmenu += "<div class='StatusHint'><#2853#> :</div>";
lineDesc = ""; /* Untranslated */
...
wifiDesc = "<b>2.4GHz -</b> <#1551#>";
else
wifiDesc = "<b>2.4GHz -</b> <#1552#>";
if(wlan1_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1551#>";
else
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1552#>";
if(wlan2_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1551#>";
else
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1552#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else if(wl_info.band5g_support){
if(wlan0_radio_flag == "0" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1551#><br><br><b>5 GHz -</b><br><#1551#>";
else if(wlan0_radio_flag == "1" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1552#><br><br><b>5 GHz -</b><br><#1551#>";
else if(wlan0_radio_flag == "0" && wlan1_radio_flag == "1")
wifiDesc = "<b>2.4GHz -</b><br><#1551#><br><br><b>5 GHz -</b><br><#1552#>";
else
wifiDesc = "<b>2.4GHz -</b><br><#1552#><br><br><b>5 GHz -</b><br><#1552#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else{
if(wlan0_radio_flag == "0")
...
statusmenu += "<div><#1694#></div>";
if(monoClient != "monoClient=")
statusmenu += "<div><#3076#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
statusmenu += "<div><#1691#></div>";
}
if(statusmenu != "")
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2914#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2853#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1729#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2346#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2743#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2346#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2743#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2743#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2743#>';
}
statusmenu += ")</span><br>";
}
}
...
statusmenu += "<div class='StatusHint'><#299#>:</div><span><#1691#></span>";
}
if(itemNum == 3){
var eLAN_str = "<#1938#>".replace(/WAN/, "LAN");
(function(){
var wans_mode = '<%nvram_get("wans_mode");%>';
...
this.hint = "<#1563#> : <#3011#> "+wans_lanport;
}
else
this.hint = "<#3098#>";
}
...
statusmenu = "<div class='StatusHint'><#1903#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1938#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3011#> "+wans_lanport+") - </div>";
else if( wans_dualwan_array[0] == "usb"){
if(gobi_support)
statusmenu += "<div class='StatusHint'><#2827#> - </div>";
else
statusmenu += "<b><#424#> - </b><br>";
}
statusmenu += "<span>" + connect_status.primary.hint + "</span>";
statusmenu += "<div class='StatusHint'><br><#1910#>:</div>";
...
statusmenu = "<div class='StatusHint'><#3335#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1938#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3011#> "+wans_lanport+") - </div>";
...
return "<#2853#> : <span>0</span> <#2346#> <span>0</span> <#2743#>";
else
return "<#2853#> : <span>"+EHours+"</span> <#2346#> <span>"+EMinutes+"</span> <#2743#>";
}
...
statusmenu = "<span class='StatusClickHint' onclick='cancel_dblog();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1991#></span>";
_caption = "System Diagnostic capture";
}
else if(hint_show_id == 9){ //2015.07 Viz add for bwdpi : Adaptive QoS mode
statusmenu = "<span class='StatusClickHint' onclick='priority_change();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#915#></span><br>";
statusmenu += "<span class='StatusClickHint' onclick='qos_disable();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1952#></span>";
_caption = "<#925#>";
}
else if(hint_show_id == 8){ //2014.10 Viz add for dsl dslx_diag_state
statusmenu = "<span class='StatusClickHint' onclick='cancel_diag();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1991#></span>";
...
if(gobi_support){
statusmenu += "<#2810#></span>"
_caption = "<#2827#>";
}
else{
statusmenu += "<#2278#></span>"
_caption = "<#424#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotocooler();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1963#></span>";
_caption = "Perfomance Tuning";
}
else if(hint_show_id == 4){
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2277#></span>";
...
statusmenu = "<span class='StatusClickHint' onclick='suspendconn(0, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1780#></span>";
else{
...
statusmenu += "<#3833#></span>";
}
}
else{
if(gobi_support){
if( wans_dualwan_array[0] == "wan")
statusmenu += "<div class='StatusHint'><#1938#>:</div>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3011#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<div class='StatusHint'><#2827#>:</div>";
...
statusmenu += "<b><#3011#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#424#> -</b><br>";
}
...
if(gobi_support){
if( wans_dualwan_array[1] == "wan")
statusmenu += "<div class='StatusHint'><br><#1938#>:</div>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#3011#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2827#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1910#>:</div>";
if( wans_dualwan_array[1] == "wan")
...
statusmenu += "<span class='StatusClickHint' onclick='suspendconn(1, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1780#></span>";
else{
...
statusmenu += "<#1914#> <span style='font-weight:normal'>"+ usbDevicesList[i].deviceName +"</span></div>";
}
}
if(statusmenu == "")
statusmenu = "<span class='StatusHint'><#1781#></span>";
...
statusmenu += "<ol>";
if(based_modelid == "RT-AXE7800")
statusmenu += "<li><#3890#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "1G WAN");
else
statusmenu += "<li><#3890#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "WAN");
statusmenu += "<li><#3891#></li>";
statusmenu += "<li><#3892#></li>";
statusmenu += "<li><#3893#></li>";
statusmenu += "</ol>";
statusmenu += "<#3894#>";
statusmenu += "</div>";
...
return overlib('<#230#>', HAUTO, VAUTO);
...
if (typeof ol_text=='undefined') var ol_text='<#971#>';
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#1303#>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<#493#>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<#494#>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<#495#>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<#496#>"; }
}
else{
if (nScore >= 0 && nScore < 20) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#492#></a>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#493#></a>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#494#></a>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#495#></a>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#496#></a>"; }
}
