...
<title id="web_title"><#869#> - <#489#></title>
...
document.getElementById('content_title').innerHTML = "<#489#> - <#3403#>";
document.getElementById('desc_title').innerHTML = "<#2951#>";
document.getElementById('web_title').innerHTML = "<#869#> - <#3403#>";
document.getElementById('PC_enable').innerHTML = "<#2949#>";
}
if(isSupport("PC_SCHED_V3")){
$("#desc_title").html("<#2961#>");
var $desc_item = $("#desc_item").empty();
$("<li>").html("<#2962#>").appendTo($desc_item);
$("<li>").html("<#2953#>").appendTo($desc_item);
$("<li>").html("<#2963#>").appendTo($desc_item);
$("<li>").html("<#2964#>").appendTo($desc_item);
...
code +='<thead><tr><td colspan="4"><#1660#>&nbsp;(<#2693#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#3200#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#3200#></option>';
code += '<option value="0"><#1550#></option>';
code += '<option value="1"><#1802#></option>';
code += '<option value="2"><#1471#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1567#> (<#3045#>)</th>';
code +='<th width="20%"><#2958#></th>';
code +='<th width="20%"><#2692#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1550#></option>';
code += '<option value="1" selected><#1802#></option>';
code += '<option value="2"><#1471#></option>';
code += '</select>';
code += '</td>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" style="position:absolute;" onclick="pullLANIPList(this);" title="<#3203#>">';
...
code += '<option value="0" ' + ((client_time_obj.enable == "0") ? "selected" : "") + '><#1550#></option>';
code += '<option value="1" ' + ((client_time_obj.enable == "1") ? "selected" : "") + '><#1802#></option>';
code += '<option value="2" ' + ((client_time_obj.enable == "2")? "selected" : "") + '><#1471#></option>';
code += '</select>';
code += '</td>';
...
$("#mainTable").fadeIn();
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="applyRule(1);" value="<#209#>">';
showDropdownClientList('setClientIP', 'mac', 'all', 'ClientList_Block_PC', 'pull_arrow', 'all');
showclock();
}
function selectAll(){
...
var hint = "<#4356#>".replace("#MAXNUM", weekScheduleApi.data_max);
hint += "\n";
hint += "<#4357#>";
alert(hint);
return false;
...
code += "<span class=\"clicked\"><#3403#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#1238#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#3403#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1238#></span>";
}
...
<tr>
<td align="left">
<div id="content_title" class="formfonttitle" style="width:400px"><#489#></div>
</td>
<td>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1238#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#3403#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<div style="font-size:14px;margin-left:6px;margin-bottom:6px;"><#2966#></div>
...
<div id="svc_hint_div" style="display:none;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" class="hint-color" style="text-decoration:underline;cursor:pointer;"><#297#></span></div>
