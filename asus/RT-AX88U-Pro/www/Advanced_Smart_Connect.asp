...
code +='<thead><tr><td colspan="4"><#3290#></td></tr></thead>';
code +='<tr id="band_text"><th width="20%"><#2391#></th>';
if(start_band_idx == '1'){
if(band6g_support){
...
code +='<td>';
code +='<input onclick="change_lb(1,'+i+');" type="radio" name="wl'+i+'_bsd_steering_balance" value="1"><#200#>';
code +='<input onclick="change_lb(0,'+i+');" type="radio" name="wl'+i+'_bsd_steering_balance" value="0"><#199#>';
code +='</td>';
}
code +='</tr>';
code +='<tr><th><#3291#></th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#2939#></option>';
code +='<option value="1" class="content_input_fd"><#2938#></option>';
code +='</select></td>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_ld_t" style="display:none;"><#1550#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th><#2980#></th>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_gd_t" style="display:none;"><#1550#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#1426#></option>';
...
code +='<thead><tr><td colspan="4"><#3286#></td></tr></thead>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_ld_t" style="display:none;"><#1550#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th><#2980#></th>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_gd_t" style="display:none;"><#1550#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
var code="";
code +='<table cellspacing="0" cellpadding="4" bordercolor="#6b8fa3" border="1" align="center" width="100%" class="FormTable" id="MainTable2" style="margin-top:10px">';
code +="<thead><tr><td colspan=\"4\"><#3284#></td></tr></thead>";
code +='<tr id="target_band_text"><th width="20%"><#2392#></th>';
if('<% nvram_get("smart_connect_x"); %>' != 2 && (wl_info.band5g_2_support || wl_info.band6g_support)){
for(i = start_band_idx; i < wl_info.wl_if_total; i++){
...
vht_desc = ["<#1426#>","AC only","not-allowed"];
vht_value = [0,1,2];
...
based_modelid == "XT8PRO" || based_modelid == "BT12" || based_modelid == "BQ16" || based_modelid == "BQ16_PRO" ||
based_modelid == "BM68" ||
...
based_modelid == "RT-BE58U" || based_modelid == "TUF-BE3600"
)?1000:600,
value:1,
slide:function(event, ui){
...
based_modelid == "GT-AX11000" ||
based_modelid == "RT-AX92U" ||
based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "BT12" || based_modelid == "BQ16" || based_modelid == "BQ16_PRO" || based_modelid == "BM68" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "ET8_V2"
|| based_modelid == "RT-AX86U" || based_modelid == "RT-AX68U" || based_modelid == "RT-AC68U_V4" ||
based_modelid == "RT-AXE7800" || based_modelid == "GT10" || based_modelid == "RT-AX9000" ||
based_modelid == "GT-AXE11000" ||
based_modelid == "GT-AX6000" ||
...
<div>&nbsp;</div>
<div class="formfonttitle"><#403#> - <#3285#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3283#></div>
<div style="text-align:right;margin-top:-36px;padding-bottom:3px;"><input type="button" class="button_gen" value="<#3627#>" onClick="pop_clientlist_listview(true)"></div>
...
<th width="20%"><#3289#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="windows_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#3196#>
</td>
</tr>
<tr>
<th><#3287#></th>
...
<th><#3288#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="dwell_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#3196#>
</td>
</tr>
</table>
<div class="apply_gen">
<input type="button" id="restoreButton" class="button_gen" value="<#3227#>" onclick="restoreRule();">
