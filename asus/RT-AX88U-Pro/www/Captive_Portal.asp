...
$("#apply_button").val('<#209#>');
}
else {
captivePortalShowAndHide(0);
$("#apply_button").val('<#4224#>');
}
...
each_band_code += "<div class='gn_item_title'><#586#></div>";
...
each_band_code += "<div class='gn_item_unenabled'><#754#></div>";
}
...
code += "<div class='gn_group_title'><#299#> - " + (wl_idx + 1) + " - Used by " + third_party_wl_used[(wl_idx + 1)] + "</div>";
else
code += "<div class='gn_group_title'><#299#> - " + (wl_idx + 1) + "</div>";
...
code += "<input class='button_gen' onclick='cancel_gn_group();' type='button' value='<#212#>'/>";
code += "<input class='button_gen' onclick='save_gn_group();' type='button' value='<#209#>'/>";
code += "</div>";
...
code += "<div class='splash_item_title'>" + wl_nband_title[_wl_idx] + " <#586#></div>";
...
code = "";
code += "<div class='cp_item_title'><#4255#></div>";
...
code += "<option value='center'><#4231#></option>";
code += "<option value='extend'><#4262#></option>";
code += "</select>";
code += "</div>";
code += "<div id='splash_image_conent' class='splash_image_conent'>";
if(isSupportFileReader() && isSupportCanvas()) {
code += "<div id='splash_image_default' class='splash_image_default' onclick='splash_upload_image();' title='<#4263#>'>";
code += "<div class='splash_image_text'><#4263#></div>";
}
else {
...
code += "</div>";
code += "<div id='splash_image_canvas_content' class='splash_image_canvas_content' style='display:none;' onclick='preview_splash_page();' title='<#4263#>'>";
...
code += "</div>";
code += "<div class='splash_template_title'><#4268#>";
code += "</div>";
...
code += "</div>";
code += "<div class='splash_template_continue'><#4270#></div>";
code += "</div>";
code += "</div>";
code += "</div>";
code += "<div class='splash_image_hint'><#4233#>: < 10MB</div>";
code += "<div class='splash_image_hint'><#4237#>: jpg, png</div>";/*untranslated*/
code += "<div class='splash_image_hint'><#4236#>: 1152 x 864 px or above</div>";/*untranslated*/
if(isSupportFileReader() && isSupportCanvas()) {
code += "<div class='splash_preview'>";
code += "<input class='button_gen' onclick='splash_upload_image();' type='button' value='<#4174#>' style='margin: 0 5px'/>";
code += "<input class='button_gen' onclick='preview_splash_page();' type='button' value='<#4175#>' style='margin: 0 5px'/>";
code += "</div>";
...
code += "<div class='splash_content'>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4230#></div>";
...
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4264#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4257#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4254#></div>";
...
code += "<span class='splash_item_text'><#2743#></span>";
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#168#></div>";
code += "<span class='splash_item_hint' style='margin:0px;'>(<#1945#>)</span>";
code += "<div class='splash_item_title'><#2936#></div>";
...
code += "<div class='splash_item_title'><#2940#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4234#> (<#4238#>)</div>";
...
code += "<input class='button_gen' onclick='apply();' type='button' value='<#209#>'/>";
code += "</div>";
$('#captive_portal_content').append(code);
}
function apply() {
...
html_landing += "</g>\n";
html_landing += "</svg>\n";
html_landing += "<div id='splash_template_title' class='splash_template_title'><#4268#></div>\n";
...
html_landing += "<div id='splash_template_continue' class='splash_template_continue' onclick='continue_action();'><#4270#></div>\n";
html_landing += "</div>\n";
html_landing += "</div>\n";
...
<div class='landing_folder_title'><#870#></div>
<div id='e0' class='folder_tree'></div>
<div class='landing_folder_bottom'>
<input class='button_gen' type='button' onclick='cancel_folderTree();' value='<#212#>'>
<input class='button_gen' type='button' style='margin-left:15px;' onclick='confirm_folderTree();' value='<#1704#>'>
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#299#> - Free WiFi</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="cp_page_intro_icon"></div>
<div style='float:left;width:80%;'>
<div class="cp_page_intro_txt" style="color:#FC0;"><#4258#></div>
<div class="cp_page_intro_txt"><#4259#></div>
