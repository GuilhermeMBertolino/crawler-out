...
showtext(document.getElementById("proceeding_main_txt"), "<#389#>...");
...
showtext(document.getElementById("proceeding_main_txt"), "<#392#>");
showtext(document.getElementById("proceeding_txt"), Math.round(y)+"% <#389#>");
--seconds;
setTimeout("LoadingTime("+seconds+", '"+flag+"');", 1000);
}
else{
showtext(document.getElementById("proceeding_main_txt"), translate("<#391#>"));
