...
document.getElementById("loginMethod").innerHTML = "<#993#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#992#>";
...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='' target='_blank' style='text-decoration:underline;color:#FC0;'><#1967#></a>";
...
confirm_str_off= "<#1651#>"; //"<#1653#>"+ By Viz 2011.09
confirm_str_on = "<#1655#>";
}
else if(protocol == "ftp"){
status = this.FTP_status;
confirm_str_off = "<#1652#>";
confirm_str_on = "<#1656#>";
...
account_group_menu_code += '<div class="noAccount" id="noAccount"><#2916#></div>\n'
else{
...
alert("<#2553#> " + maximum_account + " <#2554#>");
return false;
}
else
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 11)?"<#938#>":"<#904#>";
}
...
if(ftp_ssl_support){
document.getElementById("TLS_disabled").innerHTML = (flag==1)? "":"<#3611#>";
...
<div class="formfontdesc" style="margin-top: 10px;"><#2175#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,1);"><#3250#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,9);"><#3244#></a>
</th>
<td>
<select name="ftp_lang" class="input_option">
<option value="CN" <% nvram_match("ftp_lang", "CN", "selected"); %>>GBK</option><!-- <#3247#> -->
<option value="TW" <% nvram_match("ftp_lang", "TW", "selected"); %>>Big5</option><!-- <#3246#> -->
<option value="EN" <% nvram_match("ftp_lang", "EN", "selected"); %>>UTF-8</option><!--<#3245#>-->
<option value="RU" <% nvram_match("ftp_lang", "RU", "selected"); %>><#3248#></option>
<option value="CZ" <% nvram_match("ftp_lang", "CZ", "selected"); %>><#3249#></option>
</select>
</td>
</tr>
</table>
...
<td><div id="createAccountBtn" title="<#938#>"></div></td>
<td><div id="deleteAccountBtn" title="<#1750#>"></div></td>
<td><div id="modifyAccountBtn" title="<#2845#>"></div></td>
</tr>
<tr id="trPMGroup" style="display:none;">
<td>
<select name="" id="user_type" class="input_option" onchange="switchUserType(this.value);">
<option value="group"><#2977#></option>
<option value="account"><#2979#></option>
</select>
</td>
</tr>
</table>
...
<table align="right">
<tr>
<td><div id="createFolderBtn" title="<#940#>"></div></td>
<td><div id="deleteFolderBtn" title="<#1753#>"></div></td>
<td><div id="modifyFolderBtn" title="<#2849#>"></div></td>
</tr>
</table>
</td>
</tr>
...
<div id="machine_name" class="machineName"><#870#></div>
</td>
<td>
...
<input name="changePermissionBtn" id="changePermissionBtn" type="button" value="<#1705#>" class="button_gen_dis" disabled="disabled">
</div>
</td>
</tr>
</table>
