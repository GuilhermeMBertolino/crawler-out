...
loadXML();
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#2193#> <#4122#>";
...
document.getElementById("wps_band_hint").innerHTML = "* <#4098#>";
return false;
}
...
if(wps_enable_old == "1"){
document.getElementById("wps_enable_word").innerHTML = "<#1552#>";
document.getElementById("enableWPSbtn").value = "<#1550#>";
...
document.getElementById("wps_enable_word").innerHTML = "<#1551#>"
document.getElementById("enableWPSbtn").value = "<#3994#>";
...
document.getElementById("wps_enable_hint").innerHTML = "* <#2920#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#1554#></a>"
controlDisplayItem();
return;
}
...
document.getElementById("wps_enable_hint").innerHTML = "<#4125#><br><#4126#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#404#></a> <#4127#>"
controlDisplayItem();
return;
}
if(wps_enable_old == "0"){
document.getElementById("wps_state_tr").style.display = "";
document.getElementById("wps_state_td").innerHTML = "<#4124#>";
...
document.getElementById("wps_config_td").innerHTML = "<#1551#>";
else
document.getElementById("wps_config_td").innerHTML = "<#1552#>";
}
...
if(radio_2 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(0);\"><#1554#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a>"
}
if(radio_5 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(1);\"><#1554#> " + get_band_str(wps_infos1[12].firstChild.nodeValue) + "</a>"
}
document.getElementById("wps_enable_hint").innerHTML = "* <#2920#>" + band_link + "";
...
document.getElementById("wps_enable_hint").innerHTML = "<#4125#><br><#4126#> " + band_link + " <#4127#>";
if (rej0 && rej1){
document.getElementById("wps_state_tr").style.display = "none";
document.getElementById("devicePIN_tr").style.display = "none";
document.getElementById("wpsmethod_tr").style.display = "none";
...
document.getElementById("wps_state_td").innerHTML = "<#4124#> / <#4124#>";
document.getElementById("WPSConnTble").style.display = "none";
document.getElementById("wpsDesc").style.display = "none";
}
else{
...
<div class="formfontdesc"><#3958#></div>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(13,1);"><#4096#></a></th>
<td>
...
if( !SG_mode || (SG_mode && confirm(stringSafeGet("<#2921#>")))){
...
<tr id="wps_band_tr">
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,5);"><#1717#></th>
<td id="wps_switch">
<span class="devicepin" style="color:#FFF;" id="wps_band_word"></span>&nbsp;&nbsp;
<input type="button" class="button_gen" name="switchWPSbtn" id="switchWPSbtn" value="<#3350#>" class="button" onClick="SwitchBand();">
...
<td style="border:0px">
<input class="btn_subusage button_gen" type="button" onClick="resetWPS();" id="Reset_OOB" name="Reset_OOB" value="<#1708#>" style="padding:0 0.3em 0 0.3em;" >
<div id="Reset_OOB_desc"><#4081#></div>
</td>
</tr></table>
</div>
</td>
...
<tr id="devicePIN_tr">
<th>
<span id="devicePIN_name"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,4);"><#4026#></a></span>
</th>
<td>
...
<tr id="wpsmethod_tr">
<th>
<span id="wps_method"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,2);"><#4102#></a></span>
</th>
<td>
<input type="radio" name="wps_method" onclick="changemethod(0);" value="0"><#4097#>
<input type="radio" name="wps_method" onclick="changemethod(1);" value="1"><#4104#>
...
<div id="starBtn" style="margin-top:10px;"><input class="button_gen" type="button" style="margin-left:5px;" onClick="configCommand();" id="addEnrolleebtn_client" name="addEnrolleebtn" value="<#4123#>"></div>
</td>
</tr>
</table>
</td>
