...
$("#settingProfileBar").showSelectorHint("<#339#>");
return false;
}
if(
...
{
$("#settingProfileBar").showSelectorHint("<#3229#>");
return false;
}
...
httpUserInput.showTextHint("<#805#>");
return false;
}
/* check password */
if(!use_defpass){
...
if(!confirm("<#335#>")){
httpPassInput.showTextHint("<#1287#>");
return false;
}
}
}
...
transformWLCObj();
if((isSupport("SDN_Scenario") && systemVariable.isDefault) && (isSwMode("RT") || isSwMode("AP"))){
initialize_SDN();
...
$("#static_ipaddr").showTextHint("<#310#>");
return false;
}
...
if(sim_act == 2)
$(".sim_puk_apply").html("<#209#>");
else
$(".sim_pin_apply").html("<#209#>");
switch(sim_state){
case '1':
$("#sim_desc").html("<#2813#>");
$(".sim_pin_apply").html("<#218#>");
...
$("#verify_pincode_status").html("<#2837#>");
...
break;
case '4':
$("#verify_pincode_status").html("<#2775#>");
break;
case '6':
$("#verify_pincode_status").html("<#2835#>");
break;
case '-1':
$("#verify_pincode_status").html("<#2810#>");
break;
case '-2':
case '-10':
$("#verify_pincode_status").html("<#2808#>");
break;
default:
break;
}
...
$("#verify_pincode_status").html("<#2547#>");
$("#verify_pincode_status").css("display", "");
return false;
}
else{
...
$("#new_pincode_status").html("<#2781#>");
else
$("#new_pincode_status").html("<#2547#>");
...
$(".wlcKeyApply").html(`<#218#>`);
}
else{
$('#wlc_wifiKey').after(`<span id="wlc_pre_auth_hint" class="hint_yellow"><#109#></span>`);
$(".wlcKeyApply").html(`<#218#>`);
var obj = {
"action_mode": "apply",
...
if(!confirm("<#335#>")){
$("#wireless_key_" + band).showTextHint("<#1287#>");
return false;
}
}
return true;
...
var scProfile = {};
scProfile.baseBand = (systemVariable.productid == 'GT-BE98_PRO') ? get_wl_unit_by_band("5G") : get_wl_unit_by_band("2G");
...
if((isSupport('wifi6e') || isSupport('wifi7')) && qisPostData.smart_connect_x == '1'){
if(systemVariable.productid == 'GT-AXE16000' || systemVariable.productid == 'GT-BE98' || systemVariable.productid == 'GT-BE98_PRO'){
...
else if((isSupport('wifi6e') || isSupport('wifi7')) && qisPostData.smart_connect_x == '3'){
qisPostData.wl0_auth_mode_x = "psk2";
qisPostData.wl0_mfp = "0";
}
else{
...
else if((isSupport("SDN_Scenario") && systemVariable.isDefault && systemVariable.productid.indexOf('EBG') == -1) && (isSwMode("RT") || isSwMode("AP"))){
initialize_SDN();
setTimeout(goTo.SDN_Scenarios, 50);
}
...
if(pppoeAuthFail){
$(".btn_wireless_apply").html("<#209#>");
$(".btn_login_apply").html("<#209#>");
$("#wan_pppoe_passwd").showTextHint("<#718#>");
...
if (!yearChecked) {
alert("<#137#>");
$("label[for=ASUS_EULA_enable]").css({"color": top.businessWrapper ? "red" : "#FC0"});
return false;
}
...
if(systemVariable.isDefault && isSwMode("WISP")){
systemVariable.lanIpaddr = "192.168.72.1";
postData.lan_ipaddr = "192.168.72.1";
postData.lan_ipaddr_rt = "192.168.72.1";
postData.dhcp_start = "192.168.72.2";
postData.dhcp_end = "192.168.72.254";
}
httpApi.nvramSet(postData, goTo.Finish);
}
else{
goTo.Update();
}
...
result_text += "<#1059#>";
result_text += "<ol>";
result_text += "<li><#1060#></li>";
result_text += "<li><#1061#></li>";
result_text += "<li><#1129#></li>";
result_text += "<li><#1062#></li>";
result_text += "<li><#1050#></li>";
result_text += "</ol>";
}
result_text += '<#1056#>';
...
$("#login_name .titleMain").html("<#380#>");
$("#login_name #login_desc").html(str_local_login_desc);
$("#login_name #http_username_title").html("<#2367#>");
var find_local_login_pw = str_find_st.replace("%@", "<#497#>");
...
var str_HowFindPassword_Local = str_HowFindPassword.replace("%@", "<#497#>");
...
if(isSupport("concurrep"))
$("#siteSurvey_page").find(".titleSub").html("<#4301#>");
else
$("#siteSurvey_page").find(".titleSub").html("<#3971#>");
...
if(isSupport("RPMesh"))
$("#papList_page").find(".titleSub").html("<#4301#>");
else
$("#papList_page").find(".titleSub").html("<#3971#>");
genPAPList(systemVariable.papList, systemVariable.multiPAP.wlcOrder);
...
if(isSupport("smart_connect_v2")){
let smart_connect_selif_x = (systemVariable.productid === "RT-BE96U") ? "11": (systemVariable.productid === "GT-BE98_PRO") ? "27" : "7";
qisPostData.smart_connect_selif_x = ((qisPostData.smart_connect_x == "1") ? smart_connect_selif_x : httpApi.nvramGet(["smart_connect_selif_x"]).smart_connect_selif_x);
}
if((isSupport('wifi6e') || isSupport('wifi7')) && qisPostData.smart_connect_x != '0'){
...
*/
if(isSupport("defpsk")){
var find_WiFi_pw = str_find_st.replace("%@", "<#498#>");
...
var str_HowFindPassword_WiFi = str_HowFindPassword.replace("%@", "<#498#>");
...
var applyBtn = (systemVariable.isNewFw == 2) ? "<#227#>" : "<#1711#>";
var abortBtn = (systemVariable.isNewFw == 2) ? "<#226#>" : "<#212#>";
...
$("#upgradeBtn").show();
$(".detectIcon").hide();
$("#liveUpdateStatus").html("<#333#>"); //<#201#><br/>
}
else{
errCount++;
setTimeout(arguments.callee, 1000);
...
$("#liveUpdateStatus").html("<#2181#>...");
setTimeout(arguments.callee, 1000);
}
else if(fwUpgradeInfo.webs_state_error != "0" && fwUpgradeInfo.webs_state_error != ""){
$("#upgradeBtn").show();
$(".detectIcon").hide();
$("#liveUpdateStatus").html("<#286#>");
}
else{
$("#liveUpdateStatus").html("<#287#>");
setTimeout(arguments.callee, 1000);
}
}, 500);
...
if(isSwMode("RP"))
$("#summary_page").find("#stepText2").html("<#476#>");
}
else{
$("#summary_page").find("#stepText1").html("<#474#> <#473#>");
$("#summary_page").find("#stepText2").html("<#476#>");
}
if(isSupport("lantiq")){
...
httpApi.checkCap("http://<#869#>", function(){
setTimeout(function(){
if(isPage("amasconncap_page")) window.location.href = "http://<#869#>/cfg_onboarding.cgi?flag=AMesh&id=" + systemVariable.macAddr.split(":").join("");
}, 3000);
...
if(isSupport("dsl")){
$('#noWan_desc').html("<#535#>");
$('#desktop_manual_applyBtn').html("<#224#>");
$('#desktop_manual_applyBtn').on("click", function() { goTo.Wireless(); });
$('#mobile_manual_applyBtn').html("<#224#>");
...
if(isSupport("SDN_Scenario") && systemVariable.isDefault){
...
var auth_change_str = "* <#946#> <#1037#>".replace("WPA3-personal", current_auth).replace("WPA2/WPA3-personal", changeTo_auth);
...
var $ssid = $("<div>").html(htmlEnDeCode.htmlEncode("<#585#>: " + function(){
...
var $key = $("<div>").html(htmlEnDeCode.htmlEncode("<#586#>: " + wl_item.key_new));
...
$("#SDN_Scenarios_page .titleMain").html(((isSupport("mtlancfg") && isSupport("BUSINESS")) ? "<#2327#>": "Guest Network Pro"));/* untranslated */
