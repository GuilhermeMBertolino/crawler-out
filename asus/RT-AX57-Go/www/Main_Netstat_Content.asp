...
<script>
option_netstat = new Array("<#3262#>","<#3266#>","<#3267#>","<#3265#>","<#3268#>","<#3263#>","<#1807#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2870#>", "<#2871#>", "<#2872#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2892#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2884#> - Netstat</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2892#></div>
...
<option value="-a"><#3262#></option>
<option value="-ta"><#3266#></option>
<option value="-ua"><#3267#></option>
<option value="-w"><#3265#></option>
<option value="-xa"><#3268#></option>
<option value="-l"><#3263#></option>
<option value="-r"><#1807#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2899#> IP</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullLANIPList(this);" title="<#3200#>">
...
<option value="-r state" selected><#2877#></option>
<option value="-r src"><#2875#></option>
<option value="-r dst"><#2873#></option>
<option value="-r src-port"><#2876#></option>
<option value="-r dst-port"><#2874#></option>
</select>
</td>
</tr>
