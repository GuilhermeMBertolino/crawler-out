...
var wan_hwaddr_x_orig = '<% nvram_get("wan_hwaddr_x"); %>';
...
$("#dhcpdns_hint_dnspriv").html("<span><#1770#></span>");
...
$("#dotPresets").children().remove().end().append("<option value='-1'><#748#></option>");
...
document.getElementById("yadns_hint").innerHTML = "<span><#4141#></span>";
if(dnspriv_support){
document.getElementById("yadns_hint_dnspriv").style.display = "";
document.getElementById("yadns_hint_dnspriv").innerHTML = "<span><#4141#></span>";
}
}
}
if(gobi_support){
document.getElementById("page_title").innerHTML = "<#3824#>";
document.getElementById("wan_inf_th").innerHTML = "<#3819#>";
}
...
{tag:"#ADGUARD_1",text:"<#316#>"},
{tag:"#ADGUARD_2",text:"<#317#>"},
{tag:"#CLOUDFLARE_1",text:"<#318#>"},
{tag:"#CLOUDFLARE_2",text:"<#319#>"},
{tag:"#CLOUDFLARE_3",text:"<#320#>"}
];
...
else if(obj.options[obj.selectedIndex].text == "<#2823#>"){
...
if((productid == "GT-AX6000" || productid == "GT-BE98" || productid == "GT-BE98_PRO" || productid == "RT-AX88U_PRO") && wans_lanport == "5"){
...
if((productid == "GT-AX6000" || productid == "GT-BE98" || productid == "GT-BE98_PRO" || productid == "RT-AX88U_PRO") && wans_extwan == "1")
wans_dualwan_NAME = "2.5G WAN";
else{
...
wlc_band != "" &&
isSwMode("rt") &&
document.form.wan_hwaddr_x.value != wan_hwaddr_x_orig
){
...
if(!is_ipv4 && !is_ipv6) {
alert(document.form.dnspriv_server_0.value + "<#353#>");
document.form.dnspriv_server_0.focus();
return false;
}
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='4'><#1688#>";
code += "</td></tr></thead>";
code += "<tr id='tr_default_title' height='40px'>";
code += "<th class='IE8HACK' width='5%'></th>";
code += "<th class='IE8HACK' width='15%'><#638#></th>";
code += "<th class='IE8HACK' width='80%'><#2351#></th></tr>";
...
code += "<th class='IE8HACK' width='5%'></th>";
code += "<th class='IE8HACK' width='15%'><#638#></th>";
code += "<th class='IE8HACK' width='15%'><#2351#></th>";
code += "<th class='IE8HACK' width='65%'><#1752#></th></tr>";
...
var description_temp = DNSService[idx].Description+" <a href='"+DNSService[idx].url+"' target='_blank' style='text-decoration:underline;'> <b><#2680#></b></a>";
...
code += "<input class='button_gen' type='button' onclick='closeDNSListView()' value='<#212#>'>";
code += "<input class='button_gen' type='button' onclick='Update_DNS_service()' style='margin-left:15px;' value='<#1702#>'>";
code += "</div>";
...
DSN_status_info += "<br><b><#1539#>:</b> "+DNSService[DNS_list_index].DNSService; /* Untranslated */
...
function update_map(){
var msg = stringSafeGet("<#2720#>")+" <#1022#>";
if(confirm(msg)){
$.ajax({
url: "/s46reset.cgi",
success: function( response ) {
...
<div id="page_title" class="formfontdesc" style="margin-bottom:0px;"><#2672#></div>
...
<tr>
<th id="wan_inf_th"><#3858#></th>
<td align="left">
<select class="input_option" name="wan_unit" onchange="change_wan_unit(this);"></select>
</td>
</tr>
</table>
<div id="basic_setting_desc" class="formfontdesc" style="margin-bottom:0px; margin-top: 15px;"><#3813#></div>
...
<option value="v6plus" <% nvram_match("wan_proto", "v6plus", "selected"); %>><#2511#></option>
<option value="ocnvc" <% nvram_match("wan_proto", "ocnvc", "selected"); %>><#2510#></option>
</select>
<div id="s46reset_div" style="display: flex; align-items: center;">
<div id="s46btn_div" style="display: flex; align-items: center;">
<div id="s46reset_btn" style="margin-left: 5px;"><input type="button" class="button_gen" onclick="update_map();" value="<#2719#>"></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,22);"><#1916#></a></th>
<td>
<input type="radio" name="wan_nat_x" class="input" value="1" onclick="change_nat(1);" <% nvram_match("wan_nat_x", "1", "checked"); %>><#200#>
<input type="radio" name="wan_nat_x" class="input" value="0" onclick="change_nat(0);" <% nvram_match("wan_nat_x", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="nat_type_tr" style="display:none;">
<th><#2249#>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="faq_nat" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">FAQ</a></th>
<td>
<select name="nat_type" class="input_option">
<option value="0" <% nvram_match("nat_type", "0", "selected"); %>><#2250#></option>
<option value="1" <% nvram_match("nat_type", "1", "selected"); %>><#2251#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,23);"><#1467#></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">UPnP&nbspFAQ</a></th>
<td>
...
<div id="wanAgg_desc" style="color:#FFCC00;"><#3875#></div>
...
<th><#3990#></th>
<td>
<input type="radio" name="ewan_dot1q" class="input" value="1" onclick="change_dsl_dhcp_enable();" <% nvram_match("ewan_dot1q", "1", "checked"); %>><#200#>
<input type="radio" name="ewan_dot1q" class="input" value="0" onclick="change_dsl_dhcp_enable();" <% nvram_match("ewan_dot1q", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th>VLAN ID</th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2493#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2515#></a></th>
...
<div class="assign_dns"><#1825#></div>
<div style="margin:-38px 0 5px 0;text-align:right;"><input type="button" class="button_gen" onclick="Assign_DNS_service()" value="<#211#>"></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,42);"><#3830#></a></th>
<td>
<input type="radio" value="1" name="dns_fwd_local" <% nvram_match("dns_fwd_local", "1", "checked"); %> /><#200#>
<input type="radio" value="0" name="dns_fwd_local" <% nvram_match("dns_fwd_local", "0", "checked"); %> /><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,43);"><#3849#></a></th>
<td>
<input type="radio" value="1" name="dns_norebind" <% nvram_match("dns_norebind", "1", "checked"); %> /><#200#>
<input type="radio" value="0" name="dns_norebind" <% nvram_match("dns_norebind", "0", "checked"); %> /><#199#>
</td>
</tr>
<tr id="dnssec_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,44);"><#3851#></a></th>
<td>
<input type="radio" value="1" name="dnssec_enable" onclick="showhide('dnssec_strict_tr',1);" <% nvram_match("dnssec_enable", "1", "checked"); %> /><#200#>
<input type="radio" value="0" name="dnssec_enable" onclick="showhide('dnssec_strict_tr',0);" <% nvram_match("dnssec_enable", "0", "checked"); %> /><#199#>
</td>
</tr>
<tr id="dnssec_strict_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,45);"><#3853#></a></th>
<td>
<input type="radio" value="1" name="dnssec_check_unsigned_x" <% nvram_match("dnssec_check_unsigned_x", "1", "checked"); %> /><#200#>
<input type="radio" value="0" name="dnssec_check_unsigned_x" <% nvram_match("dnssec_check_unsigned_x", "0", "checked"); %> /><#199#>
</td>
</tr>
<tr id="dns_priv_override_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,46);"><#3855#></a></th>
<td>
<select id="dns_priv_override" class="input_option" name="dns_priv_override">
<option value="0" <% nvram_match("dns_priv_override", "0", "selected"); %>><#166#></option>
<option value="1" <% nvram_match("dns_priv_override", "1", "selected"); %>><#200#></option>
<option value="2" <% nvram_match("dns_priv_override", "2", "selected"); %>><#199#></option>
</select>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,35);"><#3846#></a></th>
<td align="left">
<select id="dnspriv_enable" class="input_option" name="dnspriv_enable" onChange="change_dnspriv_enable(this.value);">
<option value="0" <% nvram_match("dnspriv_enable", "0", "selected"); %>><#873#></option>
...
<div id="dnsfilter_hint_dnspriv" style="display:none;"><span><#269#></span></div>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,36);"><#3834#></a></th>
<td>
<input type="radio" name="dnspriv_profile" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'dnspriv_profile', 1)" <% nvram_match("dnspriv_profile", "1", "checked"); %> /><#3836#>
<input type="radio" name="dnspriv_profile" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'dnspriv_profile', 0)" <% nvram_match("dnspriv_profile", "0", "checked"); %> /><#3837#>
</td>
</tr>
<tr style="display:none" id="dot_presets_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,41);"><div class="table_text"><#3832#></a></th>
<td>
...
<thead>
<tr>
<td colspan="5"><#3838#>&nbsp;(<#2690#>&nbsp;8)</td>
</tr>
</thead>
<tr>
<th><a href="javascript:void(0);" onClick="openHint(7,37);"><div class="table_text"><#309#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,38);"><div class="table_text"><#3840#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,39);"><div class="table_text"><#3842#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,40);"><div class="table_text"><#3844#></div></a></th>
<th><#2689#></th>
</tr>
<tr>
...
<thead>
<tr><td colspan="2"><#2491#></td></tr>
</thead>
<tr>
<th width="40%"><#1773#> (<#2896#> 60):</th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,29);"><#3027#></a></th>
<td align="left">
<select class="input_option" name="wan_auth_x" onChange="change_wan_type(document.form.wan_proto.value);">
<option value="" <% nvram_match("wan_auth_x", "", "selected"); %>><#873#></option>
<option value="8021x-md5" <% nvram_match("wan_auth_x", "8021x-md5", "selected"); %>>802.1x MD5</option>
</select></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,4);"><#3612#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,5);"><#504#></a></th>
<td>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd);"><#639#></div>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#812#></a></th>
<td align="left">
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#3031#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,7);"><#3051#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,8);"><#3049#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,9);"><#3057#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,10);"><#3035#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);">Host-Uniq (<#2339#>)</a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,17);"><#3055#></a></th>
<td>
<select name="wan_pptp_options_x" class="input_option">
<option value="" <% nvram_match("wan_pptp_options_x", "","selected"); %>><#166#></option>
<option value="-mppc" <% nvram_match("wan_pptp_options_x", "-mppc","selected"); %>><#2909#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,31);"><#3039#></a></th>
<td>
<select name="wan_ppp_echo" class="input_option" onChange="ppp_echo_control();">
<option value="0" <% nvram_match("wan_ppp_echo", "0","selected"); %>><#1548#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,32);"><#3042#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,33);"><#3044#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,34);"><#3046#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);"><#3037#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,15);"><#3038#></a></th>
<td>
...
<tr>
<th ><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,16);"><#3041#></a></th>
<td>
...
<input type="button" class="button_gen" onclick="showMAC();" value="<#186#>">
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,30);"><#1768#></a></th>
<td>
<select name="wan_dhcp_qry" class="input_option">
<option value="0" <% nvram_match(" wan_dhcp_qry", "0","selected"); %>><#1771#></option>
<option value="1" <% nvram_match(" wan_dhcp_qry", "1","selected"); %>><#1769#></option>
<option value="2" <% nvram_match(" wan_dhcp_qry", "2","selected"); %>><#4217#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#1940#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#3311#></a></th>
<td>
...
<input class="button_gen" id="apply_btn" onclick="applyRule();" type="button" value="<#209#>"/>
</div>
</td>
</tr>
</td>
