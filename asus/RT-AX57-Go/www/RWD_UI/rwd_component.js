...
var $ok = $("<div>").addClass("ok btn").html("<#1702#>");
...
var $desc = $("<div>").addClass("desc").html("<#4285#>");
$desc.appendTo($del_profile);
var $action_btn_container = $("<div>").addClass("action_btn_container");
$action_btn_container.appendTo($del_profile);
var $del = $("<div>").attr({"data-btn":"del"}).addClass("del btn").html("<#1686#>");
$del.appendTo($action_btn_container);
var $cancel = $("<div>").addClass("cancel btn").html("<#212#>");
