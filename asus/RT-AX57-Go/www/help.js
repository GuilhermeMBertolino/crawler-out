...
statusmenu ="<span><#3882#></span>".replace("#WAN", "1G WAN");
else
statusmenu ="<span><#3882#></span>".replace("#WAN", "WAN");
}
else if(itemNum == 102){
statusmenu ="<span><#3883#></span>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
}
if(itemNum == 50){
statusmenu ="<span><#622#></span>";
}
if(itemNum == 85){
statusmenu ="<span><#914#></span>";
}
else if(itemNum == 86){
statusmenu ="<span><#917#><br><#906#></span>";
}
else if(itemNum == 87){
statusmenu ="<span><#929#><br><#907#></span>";
}
else if(itemNum == 88){
...
statusmenu ="<span><#934#></span>";
}
else if(itemNum == 104){
statusmenu ="<span><#933#></span>";
}
if(itemNum == 98){
var signal = parseInt(sim_signal);
if(isNaN(signal) || signal <= 0){
statusmenu += "<div class='StatusHint'><#2783#></div>";
}
else if(usb_state == 2 && usb_sbstate == 0 && usb_auxstate != 1){
statusmenu += "<div class='StatusHint'><#202#> <#2358#>: </div><span>" + decodeURIComponent(modem_act_provider) + "</span>";
}
else{
...
if(itemNum == 99){
if(sim_state == "1")
statusmenu += "<div class='StatusHint'><#2813#></div>";
else if(sim_state == "2"){
if( g3err_pin == "1" && pin_remaining_count < 3)
statusmenu += "<div class='StatusHint'>Wrong PIN code. Please input the correct PIN code.</div>";
else
statusmenu += "<div class='StatusHint'><#2774#></div>";
}
else if(sim_state == "3")
statusmenu += "<div class='StatusHint'><#2776#></div>";
else if(sim_state == "4")
statusmenu += "<div class='StatusHint'><#2775#></div>";
else if(sim_state == "5")
statusmenu += "<div class='StatusHint'><#2777#></div>";
else if(sim_state == "6")
statusmenu += "<div class='StatusHint'><#2835#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2810#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2808#></div>";
else
statusmenu += "<div><#2752#></div>";
}
if(itemNum == 24)
...
if(itemNum == 26)
statusmenu += "<span><#3104#></span>";
if(itemNum == "A"){
statusmenu = "<div class='StatusHint'><#923#> :</div>";
if(bwdpi_app_rulelist.indexOf('game') != -1){
modeDesc = "<#1260#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('media') != -1){
modeDesc = "<#1261#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('web') != -1){
modeDesc = "<#930#>"; /* untranslated */
}
...
modeDesc = "<#920#>"; /* untranslated */
}
else{
modeDesc = "<#1718#>"; /* untranslated */
}
...
statusmenu += "<span>" + lineDesc + "</span>";
statusmenu += "<div class='StatusHint'><#2849#> :</div>";
lineDesc = ""; /* Untranslated */
...
wifiDesc = "<b>2.4GHz -</b> <#1549#>";
else
wifiDesc = "<b>2.4GHz -</b> <#1550#>";
if(wlan1_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1549#>";
else
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1550#>";
if(wlan2_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1549#>";
else
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1550#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else if(wl_info.band5g_support){
if(wlan0_radio_flag == "0" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1549#><br><br><b>5 GHz -</b><br><#1549#>";
else if(wlan0_radio_flag == "1" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1550#><br><br><b>5 GHz -</b><br><#1549#>";
else if(wlan0_radio_flag == "0" && wlan1_radio_flag == "1")
wifiDesc = "<b>2.4GHz -</b><br><#1549#><br><br><b>5 GHz -</b><br><#1550#>";
else
wifiDesc = "<b>2.4GHz -</b><br><#1550#><br><br><b>5 GHz -</b><br><#1550#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else{
if(wlan0_radio_flag == "0")
...
statusmenu += "<div><#1692#></div>";
if(monoClient != "monoClient=")
statusmenu += "<div><#3072#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
statusmenu += "<div><#1689#></div>";
}
if(statusmenu != "")
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2910#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2849#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1727#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2343#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2739#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2343#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2739#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2739#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2739#>';
}
statusmenu += ")</span><br>";
}
}
...
statusmenu += "<div class='StatusHint'><#299#>:</div><span><#1689#></span>";
}
if(itemNum == 3){
var eLAN_str = "<#1936#>".replace(/WAN/, "LAN");
(function(){
var wans_mode = '<%nvram_get("wans_mode");%>';
...
this.hint = "<#1561#> : <#3007#> "+wans_lanport;
}
else
this.hint = "<#3094#>";
}
...
statusmenu = "<div class='StatusHint'><#1901#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1936#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3007#> "+wans_lanport+") - </div>";
else if( wans_dualwan_array[0] == "usb"){
if(gobi_support)
statusmenu += "<div class='StatusHint'><#2823#> - </div>";
else
statusmenu += "<b><#424#> - </b><br>";
}
statusmenu += "<span>" + connect_status.primary.hint + "</span>";
statusmenu += "<div class='StatusHint'><br><#1908#>:</div>";
...
statusmenu = "<div class='StatusHint'><#3331#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1936#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3007#> "+wans_lanport+") - </div>";
...
statusmenu += "<div><#1779#></div>";
else if(usbDevicesList[i].hasErrPart)
statusmenu += "<div><#1782#></div>";
else{
...
if( statusmenu == "" )
statusmenu = "<div class='StatusHint'><#2911#></div>";
return overlib(statusmenu, OFFSETX, -160, LEFT, DELAY, 400);
});
}
if( statusmenu != "" )
...
return "<#2849#> : <span>0</span> <#2343#> <span>0</span> <#2739#>";
else
return "<#2849#> : <span>"+EHours+"</span> <#2343#> <span>"+EMinutes+"</span> <#2739#>";
}
...
statusmenu = "<span class='StatusClickHint' onclick='cancel_dblog();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1989#></span>";
_caption = "System Diagnostic capture";
}
else if(hint_show_id == 9){ //2015.07 Viz add for bwdpi : Adaptive QoS mode
statusmenu = "<span class='StatusClickHint' onclick='priority_change();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#913#></span><br>";
statusmenu += "<span class='StatusClickHint' onclick='qos_disable();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1950#></span>";
_caption = "<#923#>";
}
else if(hint_show_id == 8){ //2014.10 Viz add for dsl dslx_diag_state
statusmenu = "<span class='StatusClickHint' onclick='cancel_diag();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1989#></span>";
...
if(gobi_support){
statusmenu += "<#2806#></span>"
_caption = "<#2823#>";
}
else{
statusmenu += "<#2277#></span>"
_caption = "<#424#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotocooler();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1961#></span>";
_caption = "Perfomance Tuning";
}
else if(hint_show_id == 4){
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2276#></span>";
...
statusmenu = "<span class='StatusClickHint' onclick='suspendconn(0, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1778#></span>";
else{
...
statusmenu += "<#3829#></span>";
}
}
else{
if(gobi_support){
if( wans_dualwan_array[0] == "wan")
statusmenu += "<div class='StatusHint'><#1936#>:</div>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3007#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<div class='StatusHint'><#2823#>:</div>";
...
statusmenu += "<b><#3007#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#424#> -</b><br>";
}
...
if(gobi_support){
if( wans_dualwan_array[1] == "wan")
statusmenu += "<div class='StatusHint'><br><#1936#>:</div>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#3007#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2823#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1908#>:</div>";
if( wans_dualwan_array[1] == "wan")
...
statusmenu += "<span class='StatusClickHint' onclick='suspendconn(1, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1778#></span>";
else{
...
statusmenu += "<#1912#> <span style='font-weight:normal'>"+ usbDevicesList[i].deviceName +"</span></div>";
}
}
if(statusmenu == "")
statusmenu = "<span class='StatusHint'><#1779#></span>";
...
statusmenu += "<ol>";
if(based_modelid == "RT-AXE7800")
statusmenu += "<li><#3886#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "1G WAN");
else
statusmenu += "<li><#3886#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "WAN");
statusmenu += "<li><#3887#></li>";
statusmenu += "<li><#3888#></li>";
statusmenu += "<li><#3889#></li>";
statusmenu += "</ol>";
statusmenu += "<#3890#>";
statusmenu += "</div>";
...
if (typeof ol_text=='undefined') var ol_text='<#969#>';
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#1301#>"; }
