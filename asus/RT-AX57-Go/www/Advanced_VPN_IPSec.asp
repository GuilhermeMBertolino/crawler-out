...
$(".ipsec_inactive.renew_hint").show().html("<br><#3765#>");
}
}
});
...
alert(document.form.ipsec_clients_start.value+" <#353#>");
...
html += "<div class='ipsec_connect_status_title'><#3330#></div>";
html += "<div class='ipsec_connect_status_title'><#899#></div>";
html += "<div class='ipsec_connect_status_title'><#3730#> <#2975#></div>";
...
<input class="button_gen" onclick="cancel_viewLog();" type="button" value="<#212#>"/>
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1684#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1703#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1705#>"/>
</div>
</div>
...
<th><#771#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1683#>"/>
</td>
</tr>
<tr class="ipsec_setting_content">
<th><#806#></th>
...
<th><#3723#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3715#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<span class="hint-color"><#2030#></span>
</td>
</tr>
<tr>
<th><#315#></th>
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#3990#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#3991#></label>
</td>
</tr>
...
<span class="hint-color">(10~900) <#3192#></span>
</td>
</tr>
</table>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable " style="margin-top:15px;">
...
<th><#3654#></th>
<td>
<div><#754#> : <span id="cert_status"></span></div>
<div><#3763#> : <span id="cert_issueTo"></span></div>
<div><#3762#> : <span id="cert_issueBy"></span></div>
<div><#3694#> : <span id="cert_expire"></span></div>
<div>
<input class="button_gen_dis ipsec_active export" type="button" value="<#1551#>">
<span class="ipsec_inactive"><#752#></span>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_windows" class="input" value="0" checked>
<label for="ipsec_export_cert_windows"><#3767#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3768#></label>
</div>
</td>
</tr>
<tr>
...
<input class="button_gen_dis ipsec_active renew" type="button" value="<#220#>">
<span class="ipsec_inactive renew_hint"><#752#></span>
