...
<link rel="icon" href="images/favicon.png"><title><#867#> - <#804#></title>
...
<input class="button_gen button_media_biz" type="button" style="margin-left:27%;margin-top:18px;" onclick="cancel_folderTree();" value="<#212#>">
...
<span class="formfonttitle" style="margin-left: 8px;"><#804#></span>
<span id="returnBtn">
<img id="returnBtn" onclick="go_setting('/APP_Installation.asp')" align="right" title="<#400#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</span>
</div>
<div id="splitLine" class="splitLine"></div>
<div id="upnp_desc_id" class="formfontdesc" style="margin-top: 10px; margin-left: 8px;"><#3570#></div>
</td>
</tr>
<tr>
<td>
...
<div id="noUSB" style="color:#FC0;display:none;margin-left:17px;padding-top:2px;padding-bottom:2px;"><#2911#></div>
</td>
</tr>
<tr>
<th><#1811#></th>
...
<th><#1813#></th>
<td>
<input type="radio" value="0" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "0", "checked"); %>><#1814#>
<input type="radio" value="1" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "1", "checked"); %>><#1812#>
</td>
</tr>
</table>
</div>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1812#>&nbsp;(<#2690#>&nbsp;10)</td>
</tr>
</thead>
<tr>
<th><#1809#></th>
...
<tr>
<td width="45%">
<input id="PATH" type="text" class="input_30_table" value="" onclick="get_disk_tree();" autocorrect="off" autocapitalize="off" readonly="readonly"/" placeholder="<#748#>" >
</td>
<td width="40%">
...
<div id="apply_btn">
<input type="button" class="button_gen" onclick="applyRule()" value="<#209#>"/>
</div>
</td>
</tr>
<tr>
