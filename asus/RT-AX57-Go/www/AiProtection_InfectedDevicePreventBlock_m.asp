...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1233#>">'+ dataObj[eventID].threat +'</div>';
...
if(!confirm(AiProtection_InfectedDevicePreventBlock_m.asp)){
return false;
}
else{
...
<div>
<div class="card-bg">
<div class="page-title"><#1223#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1752#></div>
<div class="description"><#1222#></div>
</div>
<div class="tm-logo">
