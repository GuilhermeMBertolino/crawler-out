...
each_band_code += "<div class='gn_item_title'><#585#></div>";
...
each_band_code += "<div class='gn_item_unenabled'><#752#></div>";
}
...
code += "<div class='splash_item_title'>" + wl_nband_title[_wl_idx] + " <#585#></div>";
...
code = "";
code += "<div class='cp_item_title'><#4249#></div>";
...
code += "<option value='center'><#4225#></option>";
code += "<option value='extend'><#4256#></option>";
code += "</select>";
code += "</div>";
code += "<div id='splash_image_conent' class='splash_image_conent'>";
if(isSupportFileReader() && isSupportCanvas()) {
code += "<div id='splash_image_default' class='splash_image_default' onclick='splash_upload_image();' title='<#4257#>'>";
code += "<div class='splash_image_text'><#4257#></div>";
}
else {
...
code += "</div>";
code += "<div id='splash_image_canvas_content' class='splash_image_canvas_content' style='display:none;' onclick='preview_splash_page();' title='<#4257#>'>";
...
code += "</div>";
code += "<div class='splash_template_title'><#4262#>";
code += "</div>";
...
code += "</div>";
code += "<div class='splash_template_continue'><#4264#></div>";
code += "</div>";
code += "</div>";
code += "</div>";
code += "<div class='splash_image_hint'><#4227#>: < 10MB</div>";
code += "<div class='splash_image_hint'><#4231#>: jpg, png</div>";/*untranslated*/
code += "<div class='splash_image_hint'><#4230#>: 1152 x 864 px or above</div>";/*untranslated*/
if(isSupportFileReader() && isSupportCanvas()) {
code += "<div class='splash_preview'>";
code += "<input class='button_gen' onclick='splash_upload_image();' type='button' value='<#4168#>' style='margin: 0 5px'/>";
code += "<input class='button_gen' onclick='preview_splash_page();' type='button' value='<#4169#>' style='margin: 0 5px'/>";
code += "</div>";
...
code += "<div class='splash_content'>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4224#></div>";
...
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4258#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4251#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4248#></div>";
...
code += "<span class='splash_item_text'><#2739#></span>";
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#168#></div>";
code += "<span class='splash_item_hint' style='margin:0px;'>(<#1943#>)</span>";
code += "<div class='splash_item_title'><#2932#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4228#> (<#4232#>)</div>";
...
html_landing += "</g>\n";
html_landing += "</svg>\n";
html_landing += "<div id='splash_template_title' class='splash_template_title'><#4262#></div>\n";
...
html_landing += "<div id='splash_template_continue' class='splash_template_continue' onclick='continue_action();'><#4264#></div>\n";
html_landing += "</div>\n";
html_landing += "</div>\n";
...
<div class='landing_folder_title'><#868#></div>
...
<input class='button_gen' type='button' style='margin-left:15px;' onclick='confirm_folderTree();' value='<#1702#>'>
</div>
</div>
...
<div class="cp_page_intro_txt" style="color:#FC0;"><#4252#></div>
<div class="cp_page_intro_txt"><#4253#></div>
