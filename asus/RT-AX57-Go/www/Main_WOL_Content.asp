...
<div>&nbsp;</div>
<div class="formfonttitle"><#2884#> - <#2901#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3271#></div>
<div class="formfontdesc"><#3272#></div>
...
<input class="btn_subusage mt-1 mb-1 button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2902#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2895#>&nbsp;(<#2690#>&nbsp;32)</td>
</tr>
</thead>
<tr>
