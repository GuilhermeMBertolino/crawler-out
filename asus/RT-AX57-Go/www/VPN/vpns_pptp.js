...
if(based_modelid == "RT-AC5300" || based_modelid == "GT-AC5300" || based_modelid == "GT-AC9600" || based_modelid == "RT-AC3200" || based_modelid == "RT-AC3100" || based_modelid == "GT-AX11000" || based_modelid == "RT-AX92U" || based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "BT12" || based_modelid == "BQ16" || based_modelid == "BM68" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "ET8_V2" || based_modelid == "RT-AX56_XD4" || based_modelid == "XD4PRO" || based_modelid == "CT-AX56_XD4" || based_modelid == "RT-AX58U" || based_modelid == "RT-AX58U_V2" || based_modelid == "TUF-AX3000" || based_modelid == "TUF-AX5400" || based_modelid == "DSL-AX82U" || based_modelid == "RT-AX82U" || based_modelid == "RT-AX56U" ||
...
$("<div>").addClass("item_hint").html("* <#3657#>").appendTo($container);
return $container;
}
...
var pptpd_clientlist_username = {"title":"<#3612#>", "type":"text", "id":"pptpd_clientlist_username", "need_check":true, "maxlength":64};
...
.val(htmlEnDeCode.htmlEncode());
var pptpd_clientlist_password = {"title":"<#2360#>", "type":"text", "id":"pptpd_clientlist_password", "need_check":true, "maxlength":64};
...
$("<div>").addClass("profile_title_item").append($("<span>").html("<#3144#> (<#2030#>)")).appendTo($content_container);
var pptpd_sr_ipaddr = {"title":"<#3149#>", "type":"text", "id":"pptpd_sr_ipaddr", "maxlength":15, "openHint":"6_1"};
...
var pptpd_sr_netmask = {"title":"<#3150#>", "type":"text", "id":"pptpd_sr_netmask", "maxlength":15, "openHint":"6_2"};
...
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
var $btn_container_apply = $("<div>").addClass("btn_container apply").html("<#1702#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
testResult.isError = true;
testResult.errReason = "<#3634#> " + clients_start;
}
return testResult;
};
...
$pptpd_sr_ipaddr.show_validate_hint("<#3647#> " + lan_ipaddr);
$pptpd_sr_ipaddr.focus();
return false;
}
}
...
result = "<#3645#> <b>"+pool_start+" ~ "+pool_end+"</b>";
}
...
var pptpd_ms_network_parm = {"title":"<#3659#>", "type":"switch", "id":"pptpd_ms_network"};
...
var pptpd_broadcast_parm = {"title":"<#3639#>", "type":"switch", "id":"pptpd_broadcast"};
Get_Component_Switch(pptpd_broadcast_parm).appendTo($detail_adv);
$("<div>").attr({"id": "PPTP_broadcast_hint"}).addClass("item_hint").html("* <#3059#>").appendTo($detail_adv).hide();
var pptpd_chap_options = [{"text":"<#166#>","value":"0"},{"text":"MS-CHAPv1","value":"1"},{"text":"MS-CHAPv2","value":"2"}];
var pptpd_chap_parm = {"title": "<#3027#>", "id": "pptpd_chap", "options": pptpd_chap_options, "set_value": "0"};
Get_Component_Custom_Select(pptpd_chap_parm).appendTo($detail_adv);
var pptpd_mppe_options = [{"text":"MPPE-128","value":"1"},{"text":"MPPE-40","value":"4"},{"text":"<#2909#>","value":"8"}];
var pptpd_mppe_parm = {"title": "<#2848#>", "id": "pptpd_mppe", "options": pptpd_mppe_options};
...
var pptpd_winsenable_x_parm = {"title":"<#2490#>", "type":"switch", "id":"pptpd_winsenable_x", "slide_target":"pptpd_wins"};
...
var pptpd_wins1_parm = {"title":"<#2488#>", "type":"text", "id":"pptpd_wins1", "need_check":true, "maxlength":15};
Get_Component_Input(pptpd_wins1_parm).appendTo($pptpd_wins_content_container)
.find("#" + pptpd_wins1_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var pptpd_wins2_parm = {"title":"<#2489#>", "type":"text", "id":"pptpd_wins2", "need_check":true, "maxlength":15};
...
var pptpd_clients_parm = {"title":"<#3643#>", "type":"text", "start_id":"pptpd_clients_start", "start_maxlength":15, "end_id":"pptpd_clients_end", "end_maxlength":3,
...
$("<div>").addClass("profile_title_item").append($("<span>").html("<#3781#>")).appendTo($detail_general);
pptpd_clientlist_data = [];
var $Add_Client_Title_obj = Get_Component_Add_Client_Title().appendTo($detail_general);
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("<#3809#> (<#2690#>" + htmlEnDeCode.htmlEncode(pptpd_clientlist_limit) + ")");
...
show_customize_alert("<#4349#>".replace("#MAXNUM", pptpd_clientlist_limit));
return false;
}
