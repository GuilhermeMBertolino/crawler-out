...
if(info_bar == ''){
$('#recountIcon').hide();
code += '<div class="no-data"><#1235#></div>';
}
else{
$('#recountIcon').show();
...
code += '<div class="table-cell"><#1800#></div>';
code += '<div class="table-cell"><#1233#></div>';
code += '<div class="table-cell"><#1232#></div>';
code += '<div class="table-cell"><#1231#></div>';
code += '</div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1233#>">'+ cat_id_array[cat_id_index].description +'</div>';
var _name = dataObj[eventID].source[0];
if(clientList[_name]){
_name = clientList[_name].name;
}
code += '<div class="table-cell" data-title="<#1232#>">'+ _name +'</div>';
code += '<div class="table-cell" data-title="<#1231#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '</div>';
}
}
else{
...
<div class="description-title"><#1752#></div>
<div class="description"><#1309#></div>
</div>
<div class="tm-logo">
...
<div class="event-hit"><#1302#></div>
</div>
<div class="card-lv1 card-lv1-bg">
<div class="flexbox flex-a-center flex-j-spaceB">
<div class="description"><#1328#></div>
...
<div class="page-title canvas-title"><#1217#></div>
</div>
<div class="canvas-bg">
<div class="chart-title"><#1302#></div>
