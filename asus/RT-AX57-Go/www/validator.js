...
document.getElementById("check_ip_input").innerHTML="<#353#>";
...
isValidHost: function(value) { //<#353#>
var err_count=0;
var alert_content = "<#353#>\n<#2557#>";
...
alert(document.form.wan_ipaddr_x.value + " <#353#>");
document.form.wan_ipaddr_x1.focus();
return false;
}
...
alert(document.form.wan_ipaddr_x1.value + "<#337#>");
document.form.wan_ipaddr_x1.focus();
document.form.wan_ipaddr_x1.select();
return false;
}
...
if(!groupChar(c)){
alert('<#359#> '+o.value.charAt(i)+' <#360#>');
o.focus();
o.select();
return false;
}
