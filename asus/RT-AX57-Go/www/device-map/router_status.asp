...
var led_table = ["<#1548#>", "<#3077#>", "<#2726#>", "<#2340#>"];
...
var code = '';
if(system.INTELplatform){
code += '<div class="info-title"><#4300#></div>';
...
code += '<div class="info-block"><div class="info-title"><#2571#></div><div class="info-content">'+ _lanIP +'</div></div>';
code += '<div class="info-block"><div class="info-title"><#2978#></div><div class="info-content">'+ variable.secret_code +'</div></div>';
if(variable.serial_no != ''){
code += '<div class="info-block"><div class="info-title"><#3209#></div><div class="info-content">'+ variable.serial_no +'</div></div>';
}
code += '<div class="info-block"><div class="info-title">LAN <#388#></div><div class="info-content">'+ variable.lan_hwaddr +'</div></div>';
if(system.band2gSupport){
if(system.modelName === 'GT-AXE16000' || system.modelName === 'GT-BE98' || system.modelName === 'GT-BE98_PRO'){
code += '<div class="info-block"><div class="info-title">2.4 GHz <#388#></div><div class="info-content">'+ variable.wl3_hwaddr +'</div></div>';
}
else if(odmpid === 'GT6'){
code += '<div class="info-block"><div class="info-title">2.4 GHz <#388#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
else{
code += '<div class="info-block"><div class="info-title">2.4 GHz <#388#></div><div class="info-content">'+ variable.wl0_hwaddr +'</div></div>';
}
}
if(system.triBandSupport){
if(system.band6gSupport){
code += '<div class="info-block"><div class="info-title">5 GHz <#388#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">6 GHz <#388#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
else{
if(system.modelName == 'MAP-AC2200')
{
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#388#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#388#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
}
else if(odmpid === 'GT6'){
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#388#></div><div class="info-content">'+ variable.wl0_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#388#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
}
else
{
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#388#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#388#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
}
}
...
code += '<div class="info-block"><div class="info-title">LAN <#388#></div><div class="info-content">'+ variable.wl3_hwaddr +'</div></div>';
}
...
var modeDesc = ['<#4133#>', '<#4135#>', '<#4137#>', '', '<#1549#>'];
code += '<div class="division-block"><#4126#></div>';
...
code += '<div class="info-content"><#2174#> '+ yadns_clients[i] +'</div>';
code += '</div>';
}
}
...
var code = '<div class="division-block"><#760#></div>';
code += '<div>';
for(i=0;i<core_num;i++){
...
var code = '<div class="division-block"><#762#></div>';
code += '<div>';
code += '<div>';
code += '<div class="display-flex flex-a-center ram-content">';
code += '<div class="ram-text-width"><#763#></div>';
code += '<div class="ram-text-width"><#764#></div>';
code += '<div class="ram-text-width"><#765#></div>';
code += '</div>';
code += '<div class="display-flex flex-a-center ram-content">';
...
$("<div>").css({"margin-bottom":"6px"}).html("<#3010#> <#3011#>").appendTo($hint_text_bg);
...
$("<div>").css({"margin-bottom":"6px"}).html("<#3012#> :").appendTo($hint_text_bg);
var $help_item = $("<ol>").css({"margin":"0", "padding":"0", "margin-left":"24px"}).appendTo($hint_text_bg);
$("<li>").css({"color":"#64737c"}).html("<#3017#>".replace("#ETHCABLE", "Cat 5e")).appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3013#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3014#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3015#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3016#>").appendTo($help_item);
var $action_bg = $("<div>").css({"margin-top":"18px", "text-align":"right"}).appendTo($popup_hint_bg);
var $action_ok = $("<input/>").attr({"id":"action_ok", "type":"button", "value":"<#1702#>"}).addClass("button_gen");
...
$("#phy_ports").append('<div class="division-block" style="position:relative;"><span><#756#></span><div class="port_status_notice_icon"></div></div>');
...
$("<div>").addClass("conn").html("<#202#>").appendTo($port_status_icon_desc);
$("<div>").addClass("warn").html("<#2921#>").appendTo($port_status_icon_desc);/* untranslated */
$("<div>").addClass("unplug").html("<#759#>").appendTo($port_status_icon_desc);
if(show_notice){
...
var code = '<div class="division-block"><#756#></div>';
code += '<div>';
code += '<div class="display-flex flex-a-center table-header">';
code += '<div class="port-block-width table-content"><#757#></div>';
code += '<div class="port-block-width table-content"><#754#></div>';
code += '</div>';
...
var code = '<div class="division-block"><#4376#></div>';
code += '<div>';
code += '<div class="display-flex flex-a-center table-header">';
code += '<div class="port-block-width table-content"><#754#></div>';
code += '<div class="port-block-width table-content">Tx (<#2409#>)</div>';
code += '<div class="port-block-width table-content">Rx (<#2409#>)</div>';
code += '</div>';
...
<div id="wireless_tab" class="tab-block" onclick="switchTab(this.id)"><#403#></div>
<div id="status_tab" class="tab-block tab-click" onclick="switchTab(this.id)"><#754#></div>
