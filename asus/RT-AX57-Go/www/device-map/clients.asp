...
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#1753#><img src="/images/InternetScan.gif"></div>';
else
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#2472#></div>';
if(parent.businessWrapper)
clientHtmlTd = '<div style="color:#000;height:30px;text-align:center;margin-top:50px;font-size: 22px;"><#2472#></div>';
}
...
var Modified_wired_term = wired_span.replace("<#3424#>", "<#3816#>");
...
var Modified_wireless_term = wireless_span.replace("<#3425#>", "WiFi");
...
if(client.isPrinter)
overlibStr += "<p><#1755#></p>YES";
if(client.isITunes)
overlibStr += "<p><#1754#></p>YES";
if(client.isWL > 0){
overlibStr += "<p><#3915#>:</p>" + isWL_map[client.isWL]["text"].replace("G", " GHz") + " (" + client.rssi + " dBm)";
if(stainfo_support) {
overlibStr += "<p>Tx Rate:</p>" + ((client.curTx != "") ? client.curTx : "-");
overlibStr += "<p>Rx Rate:</p>" + ((client.curRx != "") ? client.curRx : "-");
overlibStr += "<p><#899#>:</p>" + client.wlConnectTime;
}
}
return overlibStr;
}
...
overlibStrTmp += "<p><span>.....................................</span></p><p style='margin-top:5px'><#2718#> :</p>";
...
<#3424#>&nbsp;(<b style="font-size:10px;" id="tabWiredNum">0</b>)
</span>
</div>
<script>
...
<#3425#>&nbsp;(<b style="font-size:10px;" id="tabWirelessNum">0</b>)
</span>
...
<input type="button" id="refresh_list" class="button_gen" value="<#1705#>" style="margin-left:70px;">
<script>
