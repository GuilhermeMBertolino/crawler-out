...
disk_list_array = { "info" : ["<#1788#>", "disk.asp"], "health" : ["<#1781#>", "disk_utility.asp"], "format" : ["<#1695#>", "disk_format.asp"]};
...
<p class="formfonttitle_nwm"><#2842#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#1454#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#3427#>:</p>
...
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#804#>:</p>
<input type="button" class="button_gen" onclick="goUPnP();" value="<#1552#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="aidisk_hyperlink">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1020#>:</p>
<input type="button" class="button_gen" onclick="gotoAidisk();" value="<#1552#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="dmLink" style="display:none;">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1824#>:</p>
<input type="button" class="button_gen" onclick="gotoDM();" value="<#1552#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; "><#3170#>:</p>
<input id="show_remove_button" class="button_gen" type="button" class="button" onclick="remove_disk_call();" value="<#1554#>">
<div id="show_removed_string" style="display:none;"><#3168#></div>
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; " onmouseover="parent.overHint(24);" onmouseout="parent.nd();"><#3206#></p>
...
<li><#1804#><a href="/" target="_parent"><#1805#></a><#1806#></li>
</ul>
</div>
