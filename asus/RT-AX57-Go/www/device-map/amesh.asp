...
html += "<div class='aimesh_node_setting_info_title'><#4300#></div>";
...
case "ctrl_led" :
html += "<div style='margin-top:10px;'>";
html += "<div class='aimesh_node_setting_info_title'><#4326#></div>";
html += "<div class='aimesh_node_setting_info_content'>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2472#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
parent.$("#amesh_connect_msg").find(".amesh_hint_text.amesh_hint_title").html("<#1064#>");
}
});
});
}
...
code += "</div>";
code += "<div class='amesh_router_info_text'><#2174#>: ";
var re_client_num = 0;
...
code += "<div class='amesh_title offline' onclick='show_offline_msg(event);'><#1576#></div>";
}
code += "</div>";
code += "</div>";
code += "</div>";
...
$amesh_cancel.attr({"type" : "button", "value" : "<#1702#>"});
...
$amesh_wait_search_text.html("<#1057#>");
...
$amesh_wpa3_text.append($("<div>").html("<#1038#>"));
...
$aimesh_illustration_bg.append(gen_text("<#1135#>", "backhaul_router"));
$aimesh_illustration_bg.append(gen_text("<#1063#>", "backhaul_node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1063#>", "backhaul_node for_dsl"));
}
...
result_text += "<#1047#>";
result_text += "<div style='margin-left: 20px;'>1. <#1048#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1049#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1050#></div>";
result_text += "<div style='margin-left: 20px;'>4. <#1051#></div>";
}
if(ameshRouter_support && ameshNode_support)
result_text += "b. ";
if(ameshNode_support){
result_text += "<#1052#>";
result_text += "<div style='margin-left: 20px;'>1. <#1053#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1054#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1055#></div>";
}
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
$aimesh_illustration_bg.append(gen_text("Modem", "modem"));
$aimesh_illustration_bg.append(gen_text("<#1135#>", "router"));
$aimesh_illustration_bg.append(gen_text("<#1063#>", "node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1063#>", "node for_dsl"));
}
var $amesh_clear_bg = $('<div>');
$amesh_clear_bg.css("clear", "both");
$aimesh_illustration_bg.append($amesh_clear_bg);
...
$amesh_apply.attr({"type" : "button", "value" : "<#1702#>"});
$amesh_action_bg.append($amesh_apply);
$amesh_apply.click(
function() {
initial_amesh_obj();
...
hint += "<#1208#>";
hint += "<br>";
hint += "<#1209#> <#1210#>".replace("#RE_MAXNUM", cfg_re_maxnum);
hint += "<br>";
hint += "<#1211#>";
...
code += "<div class='aimesh_node_static_info_title'><#1099#></div>";
...
code += "<div class='aimesh_node_setting_info_title'><#1085#></div>";
...
code += "<option value='2' class='aimesh_node_input_select_option'><#1075#></option>";
code += "</select>";
code += "<div id='aimesh_node_connection_priority_hint' class='aimesh_node_setting_info_content'><#1701#></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
...
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#2183#></div>";
...
code += "<th class='IE8HACK' width=" + aimesh_node_client_info_width[0] + "><#1566#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#2955#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3643#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3818#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2847#>");
...
block_chars_hint = block_chars_array[i] + " <#2545#>";
}
if(block_chars_hint != "") {
...
function() {
if(node_info.online == "1" && re_path > 0) {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1685#>" : "<#2847#>";
...
var led_table = ["<#1685#>", "<#2702#>", "<#2726#>", "<#2340#>"];
...
$amesh_close.attr({"type" : "button", "value" : "<#1685#>"});
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2472#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#4299#>" : nodeClientObj.ip;
...
option_array.push(gen_option_attr("3", ((_eap_flag) ? "<#166#> (<#1080#>)" : "<#166#>"), "auto"));
...
var option_text = (_eap_flag) ? "<#1090#>" : "<#1089#>";
...
option_array.push(gen_option_attr("2", ((_eap_flag) ? "<#1079#>" : "<#1075#>"), "eth"));
return option_array;
}
...
<tr>
<td colspan="2">
<div class="amesh_title"><#1042#></div>
<div class="amesh_title amesh_content"><#1045#></div>
</td>
</tr>
...
<tr>
<td width="50%">
<div class="amesh_title amesh_help" onclick="scenario();"><#1043#></div>
</td>
<td width="50%" height="32px;" style="text-align:center;">
<input id="searchReadyOnBoarding" type="button" class="button_gen" value="<#1709#>" onClick="searchReadyOnBoarding();">
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2472#></div></div>
</td>
</tr>
<tr>
</table>
