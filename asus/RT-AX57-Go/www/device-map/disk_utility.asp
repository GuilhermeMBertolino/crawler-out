...
if(progressBar >= 5)
progressBar =5;
document.getElementById('scan_message').innerHTML = "<#1790#>";
}
...
progressBar = 15;
document.getElementById('scan_message').innerHTML = "<#1801#>";
}
...
progressBar = 40;
document.getElementById('scan_message').innerHTML = "<#1794#>";
}
...
progressBar = 90;
document.getElementById('scan_message').innerHTML = "<#1793#>";
}
else if(scan_status == 5 && stopScan == 0){
if(progressBar <= 90)
progressBar = 91;
document.getElementById('scan_message').innerHTML = "<#1786#>";
}
else{
...
clearTimeout(timer);
document.getElementById('scan_message').innerHTML = "<#1799#>";
...
<div class="font_style" style="margin-left:10px;margin-bottom:5px;margin-top:10px;"><#1784#></div>
<div >
...
<input id="btn_scan" type="button" class="button_gen" onclick="go_scan();" value="<#625#>">
<input id="btn_abort" type="button" class="button_gen" onclick="abort_scan();" value="<#212#>" style="display:none">
...
<tr>
<td class="list_bg">
<div class="font_style" style="margin-left:12px;margin-top:10px;"><#1798#></div>
<div style="margin-top:5px;*margin-top:-5px;width:283px;" class="line_horizontal"></div>
<div style="margin-left:10px;">
<table>
<tr class="font_style">
<td style="width:100px;">
<div style="margin-bottom:5px;" ><#1787#></div>
<select name="diskmon_freq" onchange="freq_change();" class="input_option">
<option value="0" <% nvram_match("diskmon_freq", "0", "selected"); %>><#1548#></option>
<option value="1" <% nvram_match("diskmon_freq", "1", "selected"); %>><#1791#></option>
<option value="2" <% nvram_match("diskmon_freq", "2", "selected"); %>><#1803#></option>
<option value="3" <% nvram_match("diskmon_freq", "3", "selected"); %>><#1783#></option>
</select>
</td>
<td >
<div id="date_field">
<div style="margin-bottom:5px;"><#1719#></div>
...
<td>
<div id="week_field">
<div style="margin-bottom:5px"><#1802#></div>
...
<td>
<div id="time_field">
<div style="margin-bottom:5px;"><#1800#></div>
...
<div style="margin-top:20px;margin-bottom:10px;" align="center">
<input type="button" class="button_gen" onclick="apply_schedule();" value="<#209#>">
