...
'triBandSmartConnect': [['0', '<#3276#>', '0']],
'dualBand6GHzSmartConnect': [['0', '2.4 / 5 GHz', '0'], ['2', '6 GHz', '2']],
'dualBandSmartConnect': [['0', '<#3275#>', '0']],
'triBand5GHzSmartConnect': [['0', '2.4 GHz', '0'], ['1', '5GHz Smart Connect', '1']],
'GT6-5GHzSmartConnect': [['2', '2.4 GHz', '2'], ['1', '5GHz Smart Connect', '1']],
'triBandMeshSmartConnect': [['0', '<#3275#>', '0'], ['2', '5 GHz-2', '2']],
'GT6triBandMeshSmartConnect': [['0', '<#3275#>', '0'], ['1', '5 GHz-2', '1']],
'triBand6GHzMeshSmartConnect': [['0', '<#3275#>', '0'], ['2', '6 GHz', '2']],
...
code += '<div class="button-right"><input type="button" class="button_gen" value="<#625#>" onclick="gotoSiteSurvey();"></div>';
code += '</div>';
...
code += '<div class="info-title"><#3273#></div>';
code += '<select class="input_option" onchange="enableSmartConnect(this.value)">'
code += '<option value="0" '+ (variable.smart_connect_x === '0' ? 'selected': '') +'><#1685#>';
code += '<option value="1" '+ (variable.smart_connect_x !== '0' ? 'selected': '') +'><#1692#>';
code += '</select>'
...
if(show_dwb_hint){
if(band6g_support){
code += '<div class="dwb_hint">6 GHz <#53#></div>';
}
else{
code += '<div class="dwb_hint">5 GHz-2 <#53#></div>';
}
...
code += '<div class="info-block">';
code += '<div class="info-title"><#585#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#3926#></div>';
...
code += '<span><#1036#> <a id="wl'+ unit +'_wpa3FaqLink" class="faq-link" target="_blank" href="">FAQ</a></span>';
code += '</div>';
}
...
if(!system.lyraHideSupport){
code += '<div class="info-block">';
code += '<div class="info-title"><#879#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4110#></div>';
...
if(dwb_info.mode == '1'){
if(isSupport("wifi6e")){
_optionArray = [['<#873#>', '0'], ['<#3276#>', '1'], ['<#3275#>', '3']];
}
else{
_optionArray = [['<#873#>', '0'], ['<#3275#>', '1']];
if(isSupport("amas_fronthaul_network")){
var fh_ap_enabled = httpApi.nvramGet(["fh_ap_enabled"]).fh_ap_enabled;
if(fh_ap_enabled == "2")
_optionArray[1][0] = '<#3276#>';
}
}
}
else{
...
_optionArray = [['<#873#>', '0'], ['<#3276#>', '1'], ['2.4 GHz and 5 GHz Smart Connect', '3']];
if(variable['smart_connect_selif_x'] == '3'){
_smart_connect_x = '3';
}
}
else{
_optionArray = [['<#873#>', '0'], ['<#3276#>', '1'], ['5GHz Smart Connect', '2']];
}
}
}
else{
...
<div id="status_tab" class="tab-block" onclick="switchTab(this.id)"><#754#></div>
