...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1727#> ";
if (Hours != 0)
value += Hours.toString() + " <#2343#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2739#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#3192#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
if(gobi_support){
pri_if = (pri_if == "USB")? "<#2823#>" : pri_if;
sec_if = (sec_if == "USB")? "<#2823#>": sec_if;
if((unit == "0" && pri_if == "<#2823#>") || (unit == "1" && sec_if == "<#2823#>"))
$("#wan_enable_title").text("<#2743#>");
}
...
showtext(document.getElementById("dualwan_mode"), "<#1885#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1884#>");
...
var currWanType = wans_dualwan.split(" ")[parent.document.form.dual_wan_flag.value];
if(currWanType == "usb"){
document.getElementById('RemoteAP_Item_WISP').style.display = "none";
document.getElementById('sitesurvey_tr_WISP').style.display = "none";
}
}
}
else{
...
if(lanproto == "static")
showtext(document.getElementById("LanProto"), "<#181#>");
else
showtext(document.getElementById("LanProto"), "<#180#>");
...
wanlink_type_conv = "<#180#>";
else if(wanlink_type_conv == "static")
wanlink_type_conv = "<#181#>";
...
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;" id="wan_enable_title"><#415#></div>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<div style="display:flex; align-items:center; justify-content:space-between;">
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;"><#1867#></div>
...
<p class="formfonttitle_nwm"><#766#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3860#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3858#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1883#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1886#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" ><#205#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3820#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#331#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#4126#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3148#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2588#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2681#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#238#></p>
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1552#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1556#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1552#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
<tr id="sitesurvey_tr_WISP" style="display:none">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;"><#113#></p>
<div class="line_horizontal"></div>
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#625#>" style="float:right;margin: 5px 0;">
</td>
</tr>
</table>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2571#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#329#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2351#></p>
