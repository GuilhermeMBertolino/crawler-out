...
code += '<div class="table-cell"><#1270#></div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1270#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1232#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1231#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1233#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
$('#deleteData').hide();
code += '<div class="no-data"><#2472#></div>';
}
...
<div>
<div class="card-bg">
<div class="page-title"><#1330#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1752#></div>
<div class="description"><#1331#></div>
</div>
<div class="tm-logo">
