...
case "0":
showtext(document.getElementById("dummyShareStr"), "\"<#3340#>\"");
break;
case "1":
showtext(document.getElementById("dummyShareStr"), "\"<#3341#>\"");
break;
case "2":
showtext(document.getElementById("dummyShareStr"), "\"<#3342#>\"");
break;
}
}
...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#3343#></td>
</tr>
<tr>
...
<input type="button" id="finish" value="<#1693#>" class="button_gen">
</div>
</td>
</tr>
</table>
