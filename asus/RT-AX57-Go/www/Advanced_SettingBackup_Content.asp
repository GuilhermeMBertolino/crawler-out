...
showtext(document.getElementById("loading_block2"), "<#3174#>");
...
showtext(document.getElementById("loading_block2"), "<#3215#>");
document.getElementById('loading_block3').style.display = "none";
if(!isSupport("demoui"))
...
/*if(findasus_support){
document.getElementById('loading_block3').innerHTML = "<div><#458#></div>";
}else{*/
document.getElementById('loading_block3').innerHTML = "<div><#391#>.<#368#></div>";
}
},
success: function(){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#431#> - <#436#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3228#></div>
<table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th width="25%" align="right">
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#3222#></a>
</th>
<td colspan = "4">
<div style="float:left;">
<input class="btn_subusage button_gen" onclick="restoreRule('restore');" type="button" value="<#1707#>" name="action1" />
</div>
...
<span><label for="restoreInit"><#3225#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#3227#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="btn_subusage button_gen" onclick="saveSetting('Router');" type="button" value="<#3227#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#3232#></span></label>
</div>
</div>
...
<div style="float:left;width:80%;">
<span><label for="transfer_ddns"><#1743#></span></label>
</div>
</div>
</div>
</td>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#3231#></a>
</th>
<td colspan = "4">
...
<tr>
<td style="border:0px">
<input type="button" class="btn_subusage button_gen" onclick="selectSetting();" value="<#1712#>"/>
</td>
