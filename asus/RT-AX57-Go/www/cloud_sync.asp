...
cal_panel_block("invitation", 0.25);
if(!isInvite){
document.getElementById("invitationInfo").innerHTML = "<br/> <#970#>";
...
htmlCode += "<tr height='40px'><td width='30%'><#2440#></td><td style='font-weight:bolder;'>" + decode_array[0] + "</td></tr>";
htmlCode += "<tr height='40px'><td width='30%'><#1643#></td><td style='font-weight:bolder;'>" + parseRule(decode_array[2]) + "</td></tr>";
htmlCode += "<tr height='40px'><td width='30%'>Destination</td><td style='font-weight:bolder;'>" + decode_array[1] + "</td></tr>";
htmlCode += "<tr height='40px'><td width='30%'><#3382#></td><td>";
htmlCode += "<input type='text' id='PATH_rs' class='input_20_table' style='margin-left:0px;height:23px;' name='cloud_dir' value='' onclick=''/>";
htmlCode += "<input name='button' type='button' class='button_gen' style='margin-left:5px;' onclick='get_disk_tree(1);document.getElementById(\"folderTree_panel\").style.marginLeft+=30;' value='<#1640#>'/>";
htmlCode += "</td></tr>";
if(decode_array[3] != ""){
...
htmlCode += "<span style='color:#FC0;display:none;margin-left:5px;' id='codeHint'><#2548#></span></td></tr>";
}
htmlCode += "</table>";
...
code +='<tr height="55px"><td style="color:#FFCC00;" colspan="6"><#2914#></td>';
else if(document.getElementById("usb_status").className == "usbstatusoff")
code +='<tr height="55px"><td style="color:#FFCC00;" colspan="6"><#2911#></td>';
else if(cloud_synclist_array == "")
code +='<tr height="55px"><td style="color:#FFCC00;" colspan="6"><#2472#></td>';
else{
...
<tr>
<td>
<div class="machineName" style="font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:20px;margin-left:30px;"><#1641#></div>
</td>
</tr>
</table>
...
<input class="button_gen" type="button" onclick="confirm_invitation();" value="<#1702#>">
</div>
</div>
</div>
...
<table><tr><td>
<div class="machineName" style="width:200px;font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:15px;margin-left:30px;"><#868#></div>
</td>
<td>
<div style="width:240px;margin-top:14px;margin-left:135px;">
<table >
<tr>
<td><div id="createFolderBtn" class="createFolderBtn" title="<#938#>"></div></td>
<td><div id="deleteFolderBtn" class="deleteFolderBtn" title="<#1751#>"></div></td>
<td><div id="modifyFolderBtn" class="modifyFolderBtn" title="<#2845#>"></div></td>
</tr>
</table>
</div>
</td></tr></table>
...
<input class="button_gen" type="button" id="btn_confirm_folder0" onclick="confirm_folderTree0();" value="<#1702#>" style="display:none;">
<input class="button_gen" type="button" id="btn_confirm_folder" onclick="confirm_folderTree();" value="<#1702#>" style="display:none;">
</div>
</div>
...
<thead>
<tr>
<td colspan="6" id="cloud_synclist"><#958#></td>
</tr>
</thead>
<tr>
<th width="30%" style="height:40px;font-family: Calibri;font-weight: bolder;"><#3080#></th>
<td>
...
<dl>
<dt>
<div id="select_service" style="height:35px;margin:-4px 0px 0px 0px;padding:4px;" value=""><#936#></div>
</dt>
...
<input name="button" type="button" class="button_gen" onclick="get_disk_tree(0);" value="<#1640#>"/>
<div id="noUSB0" style="color:#FC0;display:none;margin-left: 3px;"><#2911#></div>
</td>
</tr>
<tr style="display:none;">
<th width="30%" style="font-family: Calibri;font-weight: bolder;">
...
<input name="button" type="button" class="button_gen" onclick="get_disk_tree(1);" value="<#1640#>"/>
<div id="noUSB" style="color:#FC0;display:none;margin-left: 3px;"><#2911#></div>
</td>
</tr>
<tr>
<th width="30%" style="font-family: Calibri;font-weight: bolder;">
...
<option value="0"><#1645#></option>
<option value="1"><#1644#></option>
...
<span id="authHint" style="color:#FC0;display:none"><#1450#></span>
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle">AiCloud 2.0 - <#3288#></div>
...
<#3290#> <a id="faq_link" href="" style="text-decoration:underline;font-weight:bolder;">FAQ</a>
</div>
</td>
</tr>
</table>
...
<tr>
<th width="10%"><#3080#></th>
<th width="25%"><#3612#></a></th>
<th width="10%"><#1643#></a></th>
<th width="30%"><#2164#></th>
<th width="15%"><#511#></th>
<th width="10%"><#1686#></th>
</tr>
...
<tbody>
<tr height="55px">
<td style="color:#FFCC00;" colspan="6"><#705#>...</td> </tr>
</tbody>
</table>
</div>
...
<input name="applybutton" id="applybutton" type="button" class="button_gen" onclick="showAddTable(9);" value="<#936#>" style="word-wrap:break-word;word-break:normal;">
