...
if(isSupport("wisp") && isSwMode("rt") && wlc_band_value != ""){
if($('select[name="band' + wlc_band_value + '_channel"]').is(':visible')){
$('select[name="band' + wlc_band_value + '_bw"]').prop('disabled', true);
$('select[name="band' + wlc_band_value + '_channel"]').prop('disabled', true);
$('select[name="band' + wlc_band_value + '_nctrlsb"]').prop('disabled', true);
}
if($(document.form.wl_bw).is(':visible') && wlc_band_value == wl_unit_value){
$('select[name="wl_bw"]').prop('disabled', true);
$('select[name="wl_channel"]').prop('disabled', true);
$('select[name="wl_nctrlsb"]').prop('disabled', true);
}
}
...
document.form.wl_wpa_psk.value = "<#3914#>";
...
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#4116#>";
...
x.options[0].text = "<#3963#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#3963#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#3964#>", "upper");
...
x.options[0].text = "<#3964#>";
x.options[0].value = "upper";
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#3963#>", "lower");
...
if(document.form.wl_wpa_psk.value == "<#3914#>")
...
if(radio_value) {
confirm_flag=7;
confirm_content="<#1033#>";
}
}
else {
if(radio_value) {
confirm_flag=6;
confirm_content="<#1032#>";
}
}
}
else {
...
confirm_asus({
title: "<#4013#>",
contentA: confirm_content+"<br><br><#1039#> <#1022#>",
contentC: "",
left_button: "<#1702#>",
left_button_callback: function(){
if(confirm_flag==1 || confirm_flag==7){
...
var restart_needed_time = this.restart_needed_time;
...
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4099#>';
else{
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4103#>';
}
...
document.form.wl_nmode_x.options[0] = new Option("<#166#>", 0);
...
$('#band0_auto_channel').html('<#3910#>: ' + cur_control_channel[0]);
}
if (band1_channel == '0') {
$('#band1_auto_channel').show();
$('#band1_auto_channel').html('<#3910#>: ' + cur_control_channel[1]);
}
}else{
document.getElementById("wl_unit_field").style.display = "none";
...
free_options(obj);
obj.options[0] = new Option("<#166#>", val);
obj.selectedIndex = 0;
}
...
obj.options[0] = new Option("<#166#>", 0);
...
var option = '<option value="0"><#166#></option>';
if(unit == '0'){
...
var bw = bwValTransform[bwValue];
var option = '<option value="lower"><#166#></option>';
if(unit == '0'){
...
option += '<option value="0"><#3991#></option>';
option += '<option value="1"><#4045#></option>';
option += '<option value="2"><#4046#></option>';
}
...
<tr>
<td>
<div class="drword" id="drword"><#392#> <#389#>...
<br/>
<div id="disconnect_hint" style="display:none;"><#390#></div>
<br/>
</div>
<div id="wireless_client_detect" style="margin-left:10px;position:absolute;display:none;width:400px;">
<img src="images/loading.gif">
<div style="margin:-55px 0 0 75px;"><#715#></div>
</div>
...
<div class="formfontdesc"><#949#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0,27);"><#3278#></a></th>
<td>
...
<div id="radio_smartcon_enable" class="left" style="width: 94px;display:table-cell;"></div><div id="smartcon_rule_link" style="display:table-cell; vertical-align: middle;"><a href="Advanced_Smart_Connect.asp" style="font-family:Lucida Console;color:#FC0;text-decoration:underline;cursor:pointer;"><#3281#></a></div>
<div class="clear"></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_bss_enabled", "0","selected"); %>><#3991#></option>
<option class="content_input_fd" value="1" <% nvram_match("wl_bss_enabled", "1","selected"); %>><#3990#></option>
</select>
</td>
</tr-->
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 1);"><#585#></a></th>
<td id="ssid_setting">
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#4013#></a></th>
<td>
<input type="radio" value="1" name="wl_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_closed', '1')" <% nvram_match("wl_closed", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="wl_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_closed', '0')" <% nvram_match("wl_closed", "0", "checked"); %>><#199#>
...
<tr style="display:none">
<th><a id="band0_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4052#></a></th>
<td>
<select name="wl_nmode_x" class="input_option" onChange="wireless_mode_change(this);">
<option value="0" <% nvram_match("wl_nmode_x", "0","selected"); %>><#166#></option>
...
<span id="wl_optimizexbox_span" style="display:none"><input type="checkbox" name="wl_optimizexbox_ckb" id="wl_optimizexbox_ckb" value="<% nvram_get("wl_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4054#></input></span>
<span id="wl_gmode_checkbox" style="display:none;"><input type="checkbox" name="wl_gmode_check" id="wl_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4053#></input></span>
...
<span id="wl_nmode_x_hint" style="display:none;"><br><#4100#><br></span>
...
<th>
<a id="he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#3965#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
<select name="wl_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl_11ax", "1" ,"selected"); %> ><#3990#></option>
<option value="0" <% nvram_match("wl_11ax", "0" ,"selected"); %> ><#3991#></option>
</select>
<span id="he_mode_faq" style="padding: 0 10px"><#3966#></span>
</div>
</td>
</tr>
<tr id="mbo_field" style="display:none">
<th>
<a class="hintstyle"><#3923#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_mbo_enable" class="input_option" onChange="handleMFP();">
<option value="1" <% nvram_match("wl_mbo_enable", "1","selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wl_mbo_enable", "0","selected"); %>><#3991#></option>
</select>
</div>
</td>
</tr>
...
<th>
<a class="hintstyle"><#3981#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_twt" class="input_option">
<option value="1" <% nvram_match("wl_twt", "1","selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wl_twt", "0","selected"); %>><#3991#></option>
</select>
</div>
</td>
</tr>
<tr id="wl_bw_field" style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 14);"><#3938#></a></th>
<td>
...
<th><a id="wl_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#874#></a></th>
<td>
...
<div><span id="dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#3958#></input></span></div>
<div><span id="acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#3956#></input></span></div>
<div><span id="acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#3957#></input></span></div>
<div><span id="acs_ch13_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#3955#></input></span></div>
</div>
</td>
</tr>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_edmg_channel", "0","selected"); %>><#166#></option>
</select>
<span id="auto_edmg_channel" style="display:none;margin-left:10px;"></span><br>
</td>
</tr>
<tr id="wl_nctrlsb_field" style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 15);"><#3962#></a></th>
<td>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 5);"><#3926#></a></th>
<td>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 6);"><#879#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 7);"><#4063#></a></th>
<td>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 9);"><#3988#></a></th>
<td>
<select name="wl_wep_x" class="input_option" onChange="wepCryptoChange(this);">
<option value="0" <% nvram_match("wl_wep_x", "0", "selected"); %>><#873#></option>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 10);"><#875#></a></th>
<td>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#3983#></th>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#3984#></th>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#3985#></th>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#3986#></th>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 8);"><#4059#></a></th>
<td>
...
<option value="0" <% nvram_match("wl_mfp", "0", "selected"); %>><#3991#></option>
<option value="1" <% nvram_match("wl_mfp", "1", "selected"); %>><#4045#></option>
<option value="2" <% nvram_match("wl_mfp", "2", "selected"); %>><#4046#></option>
</select>
...
<span id="mbo_notice" style="display:none"><#3924#></span>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 11);"><#4074#></a></th>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#4013#></a></th>
<td>
<input type="radio" value="1" name="band01_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl0_closed', '1')" <% nvram_match("wl0_closed", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="band01_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl0_closed', '0')" <% nvram_match("wl0_closed", "0", "checked"); %>><#199#>
<!-- <span id="dwb_band_hide_hint"><#59#></span> -->
</td>
</tr>
<tr>
<th><a id="band01_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4052#></a></th>
<td>
<select name="band01_nmode_x" class="input_option" onChange="genAuthMethod('01', this.value);">
<option value="0" <% nvram_match("wl0_nmode_x", "0","selected"); %>><#166#></option>
...
<th>
<a id="band01_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#3965#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
<select name="band01_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl0_11ax", "1" ,"selected"); %> ><#3990#></option>
<option value="0" <% nvram_match("wl0_11ax", "0" ,"selected"); %> ><#3991#></option>
</select>
<span id="band0_he_mode_faq" style="padding: 0 10px"><#3966#></span>
</div>
</td>
</tr>
...
<option value="1" <% nvram_match("wl0_mbo_enable", "1","selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wl0_mbo_enable", "0","selected"); %>><#3991#></option>
</select>
</div>
</td>
</tr>
...
<option value="1" <% nvram_match("wl0_twt", "1","selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wl0_twt", "0","selected"); %>><#3991#></option>
</select>
</div>
</td>
</tr>
...
<option value="0" <% nvram_match("wl0_mfp", "0", "selected"); %>><#3991#></option>
<option value="1" <% nvram_match("wl0_mfp", "1", "selected"); %>><#4045#></option>
<option value="2" <% nvram_match("wl0_mfp", "2", "selected"); %>><#4046#></option>
</select>
...
<span id="band01_mbo_notice" style="display:none"><#3924#></span>
</td>
</tr>
...
<option value="0" <% nvram_match("wl0_wep_x", "0", "selected"); %>><#873#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#4013#></a></th>
<td>
<input type="radio" value="1" name="band0_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl0_closed', '1')" <% nvram_match("wl0_closed", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="band0_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl0_closed', '0')" <% nvram_match("wl0_closed", "0", "checked"); %>><#199#>
<!-- <span id="dwb_band_hide_hint"><#59#></span> -->
</td>
</tr>
...
<span id="band0_optimizexbox_span" style="display:none"><input type="checkbox" name="band0_optimizexbox_ckb" id="band0_optimizexbox_ckb" value="<% nvram_get("wl0_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4054#></input></span>
<span id="band0_gmode_checkbox"><input type="checkbox" name="band0_gmode_check" id="band0_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4053#></input></span>
...
<span id="band0_nmode_x_hint" style="display:none;"><br><#4100#><br></span>
...
<th>
<a id="band0_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#3965#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
...
<th><a id="band0_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#874#></a></th>
<td>
...
<div style="margin-top:5px">
<div><span id="band0_acs_ch13_checkbox" style="display:none;"><input id="band0_acs_ch13" type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#3955#></input></span></div>
</div>
</td>
</tr>
...
<span id="band0_mbo_notice" style="display:none"><#3924#></span>
</td>
</tr>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#4013#></a></th>
<td>
<input type="radio" value="1" name="band1_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl1_closed', '1')" <% nvram_match("wl1_closed", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="band1_closed" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl1_closed', '0')" <% nvram_match("wl1_closed", "0", "checked"); %>><#199#>
<!-- <span id="dwb_band_hide_hint"><#59#></span> -->
</td>
</tr>
<tr id="band1_nmode_x_field">
<th><a id="band1_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4052#></a></th>
<td>
<select name="band1_nmode_x" class="input_option" onChange="genAuthMethod('1', this.value);">
<option value="0" <% nvram_match("wl1_nmode_x", "0","selected"); %>><#166#></option>
...
<span id="band1_optimizexbox_span" style="display:none"><input type="checkbox" name="band1_optimizexbox_ckb" id="band1_optimizexbox_ckb" value="<% nvram_get("wl1_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4054#></input></span>
<span id="band1_gmode_checkbox" style="display:none;"><input type="checkbox" name="band1_gmode_check" id="band1_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4053#></input></span>
...
<span id="band1_nmode_x_hint" style="display:none;"><br><#4100#><br></span>
...
<th>
<a id="band1_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#3965#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
<select name="band1_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl1_11ax", "1" ,"selected"); %> ><#3990#></option>
<option value="0" <% nvram_match("wl1_11ax", "0" ,"selected"); %> ><#3991#></option>
</select>
<span id="band1_he_mode_faq" style="padding: 0 10px"><#3966#></span>
</div>
</td>
</tr>
...
<option value="1" <% nvram_match("wl1_mbo_enable", "1","selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wl1_mbo_enable", "0","selected"); %>><#3991#></option>
</select>
</div>
</td>
</tr>
...
<option value="1" <% nvram_match("wl1_twt", "1","selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wl1_twt", "0","selected"); %>><#3991#></option>
</select>
</div>
</td>
</tr>
...
<th><a id="band1_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#874#></a></th>
<td>
...
<div style="margin-top:5px">
<div><span id="band1_dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="band1_acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#3958#></input></span></div>
<div><span id="band1_acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#3956#></input></span></div>
<div><span id="band1_acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#3957#></input></span></div>
</div>
</td>
</tr>
...
<option value="0" <% nvram_match("wl1_mfp", "0", "selected"); %>><#3991#></option>
<option value="1" <% nvram_match("wl1_mfp", "1", "selected"); %>><#4045#></option>
<option value="2" <% nvram_match("wl1_mfp", "2", "selected"); %>><#4046#></option>
</select>
...
<span id="band1_mbo_notice" style="display:none"><#3924#></span>
</td>
</tr>
...
<option value="0" <% nvram_match("wl1_wep_x", "0", "selected"); %>><#873#></option>
...
<div class="apply_gen">
<input type="button" id="applyButton" class="button_gen" value="<#209#>" onclick="applyRule();">
</div>
</td>
</tr>
</tbody>
