...
document.getElementById("privateIP_notes").innerHTML = "<#3713#>";
...
document.getElementById(username_status).innerHTML = '<#233#>';
}
...
document.getElementById(username_status).innerHTML = '<a class="hintstyle2" href="javascript:void(0);" onClick="showOpenVPNClients(\''+openvpnd_connected_clients[y].username+'\');"><#202#></a>';
break;
}
}
...
alert($("input[name='vpn_server_sn6']").val() + " <#353#>");
...
alert("<#3647#> " + origin_lan_ip);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
if(lan_ip_subnet == openvpn_server_subnet) {
alert("<#3645#>"+pool_start+" ~ "+pool_end);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
...
alert(document.form.vpn_server_r1.value + " <#353#>");
document.form.vpn_server_r1.focus();
document.form.vpn_server_r1.select();
return false;
}
...
alert(document.form.vpn_server_r2.value + " <#353#>");
document.form.vpn_server_r2.focus();
document.form.vpn_server_r2.select();
return false;
}
...
document.getElementById('openvpn_error_message').innerHTML = "<span><#3678#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && vpn_server1_errno == '4'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3679#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && vpn_server1_errno == '5'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3680#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if((vpnd_state == '-1' && vpn_server1_errno == '0') || (vpnd_state != '2' && vpn_server1_errno == '7')){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3681#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2472#></td>';
else{
...
document.getElementById("allowed_client_name").innerHTML = (flag==1)?"<#3612#>":"Common Name(CN)";
}
...
<tr>
<div class="description_down"><#3699#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<p><#3690#> <span style="color:#FFCC00;">----- BEGIN xxx ----- </span>/<span style="color:#FFCC00;"> ----- END xxx -----</span> <#3691#>
<p><#3692#>
</div>
...
<input class="button_gen" type="button" onclick="cancel_Key_panel('tls');" value="<#212#>">
<input class="button_gen" type="button" onclick="save_keys('tls');" value="<#1703#>">
</div>
</td>
</tr>
</form>
...
<div style="margin-top:5px;width:100%;text-align:center;">
<input class="button_gen" type="button" onclick="cancel_Key_panel('secret');" value="<#212#>">
<input class="button_gen" type="button" onclick="save_keys('secret');" value="<#1703#>">
</div>
</td>
</tr>
</tbody>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#183#> - OpenVPN</div>
...
<option value="1" selected><#404#></option>
<option value="2"><#402#></option>
</select>
</td>
</tr>
<tr id="trServerPortBasic">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,6);"><#3922#></a>
...
<div id="portSuggestionBasic" style="color: #FFCC00;"><#3314#></div>
</td>
</tr>
...
<label for="vpn_server_client_access_local"><#3637#></label>
...
<label for="vpn_server_client_access_both"><#3638#></label>
...
<label for="vpn_server_client_access_custom" class="client_access_custom"><#1717#></label>
</td>
</tr>
...
<td>
<div id="export_div">
<input id="exportToLocal" class="button_gen" type="button" value="<#1551#>" />
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(33,2);"><#3764#></a></th>
<td>
<input id="renewCertToLocal" class="button_gen" type="button" value="<#220#>" onClick="renewCert();"/>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,27);"><#3654#></a></th>
<td>
<input id="exportCertToLocal" class="button_gen" type="button" value="<#1551#>" onClick="exportCert();"/>
</td>
</tr>
<tr id="openvpn_import_cert" style="display:none;" data-group="cert_btn">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,28);"><#3655#></a></th>
<td>
<input class="button_gen" type="button" value="<#1712#>" onClick="selectImportFile();"/>
</td>
</tr>
</table>
</div>
...
<td>
<input type="radio" name="vpn_server_x_eas" class="input" value="1"><#200#>
<input type="radio" name="vpn_server_x_eas" class="input" value="0"><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,4);"><#3686#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,5);"><#2465#></a></th>
<td>
...
<div id="portSuggestionAdvanced" style="color: #FFCC00;"><#3314#></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,15);"><#3706#></a></th>
<td>
<input type="radio" name="vpn_server_x_dns" class="input" value="1" onclick="update_visibility();"><#200#>
<input type="radio" name="vpn_server_x_dns" class="input" value="0" onclick="update_visibility();"><#199#>
</td>
</tr>
<tr id="server_pdns">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,16);"><#3660#></a></th>
<td>
<input type="radio" name="vpn_server_pdns" class="input" value="1" <% nvram_match_x("", "vpn_server_pdns", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_pdns" class="input" value="0" <% nvram_match_x("", "vpn_server_pdns", "0", "checked"); %>><#199#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,17);"><#3677#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,26);"><#3664#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,18);"><#3669#></a></th>
<td>
<select name="vpn_server_comp" class="input_option">
<option value="-1" <% nvram_match("vpn_server_comp","-1","selected"); %> ><#3991#></option>
<option value="no" <% nvram_match("vpn_server_comp","no","selected"); %> ><#873#></option>
<option value="yes" <% nvram_match("vpn_server_comp","yes","selected"); %> ><#3990#></option>
<option value="adaptive" <% nvram_match("vpn_server_comp","adaptive","selected"); %> ><#905#></option>
...
<option value="auto" <% nvram_match("vpn_server_firewall","auto","selected"); %> ><#166#></option>
<option value="external" <% nvram_match("vpn_server_firewall","external","selected"); %> ><#1939#></option>
<option value="custom" <% nvram_match("vpn_server_firewall","custom","selected"); %> ><#1717#></option>
</select>
</td>
</tr-->
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,9);"><#3662#></a></th>
<td>
<input type="radio" name="vpn_server_igncrt" class="input" value="1" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_igncrt" class="input" value="0" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "0", "checked"); %>><#199#>
<span id="Hint_fixed_tls_crypto" style="display:none;"><#3663#></span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,7);"><#3661#></a></th>
<td>
...
<span id="server_tls_crypto_text" onclick="set_Keys('tls');" style="text-decoration:underline;cursor:pointer;"><#3702#></span>
<span id="server_static_crypto_text" onclick="set_Keys('secret');" style="text-decoration:underline;cursor:pointer;"><#3702#></span>
<!-- rm 2017/06/28 span id="server_custom_crypto_text"><#3701#></span-->
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,8);"><#3166#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,10);"><#3665#></a></th>
<td>
<select name="vpn_server_hmac" class="input_option">
<option value="-1" <% nvram_match("vpn_server_hmac","-1","selected"); %> ><#3991#></option>
...
<tr id="server_snnm">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,11);"><#3708#></a></th>
<td>
...
<input type="radio" name="vpn_server_ip6" class="input" value="1" onclick="update_visibility_ipv6();" <% nvram_match_x("", "vpn_server_ip6", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_ip6" class="input" value="0" onclick="update_visibility_ipv6();" <% nvram_match_x("", "vpn_server_ip6", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="server_ipv6_nat" data-group="ipv6_settings">
<th>Enable NAT IPv6</th><td>
<input type="radio" name="vpn_server_nat6" class="input" value="1" <% nvram_match_x("", "vpn_server_nat6", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_nat6" class="input" value="0" <% nvram_match_x("", "vpn_server_nat6", "0", "checked"); %>><#199#>
<br>
...
<tr id="server_dhcp">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,13);"><#3676#></a></th>
<td>
<input type="radio" name="vpn_server_dhcp" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_dhcp" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="server_range">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,14);"><#3667#></a></th>
<td>
...
<tr id="server_local">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,12);"><#3700#></a></th>
<td>
...
<th><#3703#></th>
<td>
<input type="text" maxlength="4" class="input_6_table" name="vpn_server_poll" onKeyPress="return validator.isNumber(this,event);" value="<% nvram_get("vpn_server_poll"); %>" autocorrect="off" autocapitalize="off"> <#2739#>
<span style="color:#FC0">(<#4143#>)</span>
</td>
</tr-->
<tr id="server_plan">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,2);"><#3704#></a></th>
<td>
<input type="radio" name="vpn_server_plan" class="input" value="1" <% nvram_match_x("", "vpn_server_plan", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_plan" class="input" value="0" <% nvram_match_x("", "vpn_server_plan", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="server_rgw">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,3);"><#3705#></a></th>
<td>
<input type="radio" name="vpn_server_rgw" class="input" value="1" <% nvram_match_x("", "vpn_server_rgw", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_rgw" class="input" value="0" <% nvram_match_x("", "vpn_server_rgw", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="server_reneg">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,19);"><#3709#></a></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="vpn_server_reneg" value="<% nvram_get("vpn_server_reneg"); %>" autocorrect="off" autocapitalize="off"> <#3192#>
<span class="hint-color">(<#3223#> : -1)</span>
</td>
</tr>
<tr id="server_ccd">
<th><#3707#></th>
<td>
<input type="radio" name="vpn_server_ccd" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_ccd" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="server_c2c">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,20);"><#3666#></a></th>
<td>
<input type="radio" name="vpn_server_c2c" class="input" value="1" <% nvram_match_x("", "vpn_server_c2c", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_c2c" class="input" value="0" <% nvram_match_x("", "vpn_server_c2c", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="server_ccd_excl">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,21);"><#3668#></a></th>
<td>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "1", "checked"); %>><#200#>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "0", "checked"); %>><#199#>
</td>
</tr>
</table>
...
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,23);"><#3344#></a></th>
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,24);">Mask</a></th>
<th width="12%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,25);"><#3084#></a></th>
<th width="12%"><#2689#></th>
</tr>
<tr>
...
<option value="0" selected><#199#></option>
...
<input id="mailSendPannelCancel" class="button_gen" type="button" value="<#212#>">
...
<div class="panelSubmiter">
<input id="mailConfigPannelCancel" class="button_gen" type="button" value="<#212#>">
<input id="mailConfigPannelSubmiter" class="button_gen" type="button" value="<#1703#>">
