...
if(based_modelid == "RT-AC95U" || based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "BT12" || based_modelid == "BQ16" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "ET8_V2" || based_modelid == "RT-AX82_XD6" || based_modelid == "RT-AX82_XD6S" || based_modelid == "XD4S" || based_modelid == "RT-AX53U" || based_modelid == "XD6_V2" || based_modelid == "RT-AX59U" || based_modelid == "RT-AX52"){
if($("#wans_lanport1 option[value='4']").length > 0)
$("#wans_lanport1 option[value='4']").remove();
if($("#wans_lanport2 option[value='4']").length > 0)
$("#wans_lanport2 option[value='4']").remove();
...
var confirm_flag = confirm(stringSafeGet("<#1875#>"));
if(confirm_flag) {
...
return confirm(stringSafeGet("<#1876#>"));
};
if(wans_flag == 1) {
...
var hint_str = "<#3019#>";
var confirm_str = hint_str.replace("%1$@", conflict_lanport_text).replace("%2$@", "<#414#>").replace("%3$@", "<#2861#>");
...
$("#fo_detection_count_hd").html("<#1874#>");
new_html_str = "<#1872#>".replace("$WANDOG_MAXFAIL", replace_html);
$("#wandog_maxfail_setting").html(new_html_str);
}
else{
var new_str = stringSafeGet("<#1873#>");
new_html_str = new_str.replace("$WANDOG_MAXFAIL", replace_html);
$("#fo_detection_count_hd").html("<#2889#>");
$("#wandog_maxfail_setting").html(new_html_str);
}
...
<tr><td colspan="2"><#3319#></td></tr><tr><td colspan="2"><#3320#>&nbsp;:&nbsp;<span id="str_detect_time"></span>&nbsp;<#3192#>.</td></tr>
<tr>
<th style="width:30%;"><#3327#></th>
<td>
<input type="text" name="detect_interval" class="input_3_table" maxlength="1" value=""; placeholder="5" autocorrect="off" autocapitalize="off" onKeyPress="return validator.isNumber(this, event);" onblur="update_str_time();" style="width: 38px; margin: 0px;">&nbsp;&nbsp;<#3192#>
</td>
</tr>
<tr>
<th><#3329#></th>
...
<span id="detect_tail_msg">&nbsp;( Detection Time: <span id="detection_time_value"></span>&nbsp;&nbsp;<#3192#>)</span>
</td>
</tr>
</table>
...
<div class="formfontdesc"><#1866#><a id="dualwan_faq" href="" target="_blank" style="margin-left:5px; text-decoration: underline;"><#237#> FAQ</a></div>
<div id="wan_aggre_desc" class="formfontdesc" style="color:#FFCC00; display:none;"><#3884#></div>
...
<span id="usb_tethering_hint" style="display: none;"><#1911#></span>
</td>
</tr>
<tr id="wans_mode_tr">
<th><#1883#></th>
...
<option value="fo"><#1884#></option>
<option value="lb" <% nvram_match("wans_mode", "lb", "selected"); %>><#1885#></option>
</select>
<span id="wans_mode_fo" style="margin-left:5px; color:#FFF; display:none;"><#1884#></span>
<span id="fb_span" style="display:none"><input type="checkbox" id="fb_checkbox"><#1868#></span>
<script>
...
<div id="lb_note" style="color:#FFCC00; display:none;"><#1881#></div>
<div id="lb_note2" style="color:#FFCC00; display:none;"><#1882#></div>
</td>
</tr>
...
<option value="1" <% nvram_match("wans_standby", "1", "selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wans_standby", "0", "selected"); %>><#3991#></option>
</select>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1901#>
<input type="radio" value="2" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1908#>
</td>
</tr>
<tr class="ISPProfile">
<th><#1877#></th>
...
<thead>
<tr>
<td colspan="2"><#1900#><div style="font-weight: normal; font-style: italic; margin-top: 5px;"><#1964#></div></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,3);"><#3328#></a></th>
<td id="retry_intervale_setting"><#272#>
<div><span id="consume_bytes_warning" style=""></span></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,5);"><div id="fo_detection_count_hd"><#1874#></div></a></th>
<td id="wandog_maxfail_setting"></td>
</tr>
<tr id="wandog_fb_count_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,6);"><div id="fb_detection_count_hd"><#1871#></div></a></th>
<td id="wandog_fbcount_setting"><#1870#></td>
</tr>
<tr>
<th><#2880#></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullPingTargetList(this);" title="<#3203#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
