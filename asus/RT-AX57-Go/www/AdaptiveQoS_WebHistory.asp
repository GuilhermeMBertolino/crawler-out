...
var code = "";
code += "<tr>";
code += "<th style='width:20%;text-align:left'><#899#></th>";
code += "<th style='width:30%;text-align:left'><#3041#> / <#1565#></th>";
code += "<th style='width:50%;text-align:left'><#1828#></th>";
code += "</tr>";
...
var data = [["<#899#>", "<#388#>", "<#1565#>".replace(/&#39;/g, "'"), "<#1828#>"]];
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2733#> - <#918#></div>
...
<option value="all" selected><#1425#></option>
</select>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1684#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1705#>">
<input class="button_gen" onClick="exportWebHistoryLog()" type="button" value="<#1551#>" >
</div>
</div>
</td>
</tr>
