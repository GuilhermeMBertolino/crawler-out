...
background-image: url(/images/New_ui/SDN/dark_theme/Navigation/close_fill.svg);
}
...
$("#deregister_btn").click(function(){
if(orig_le_enable != "0"){
var confirm_msg = stringSafeGet("<#2620#>");
...
document.getElementById("ddns_status").innerHTML = "<#751#>";
if(inadyn)
show_deregister_btn();
}
}
...
if(ddns_server_x == "WWW.ASUS.COM"){
document.getElementById("ddns_status").innerHTML = "<#752#>";
if(ddnsStatus != "")
...
show_alert_block("<#2603#> '" + s.charAt(i) +"' !");
return false;
}
}
return true;
...
document.getElementById("le_desc").innerHTML = "<#2647#>";
...
case "2":
document.getElementById("cert_desc").style.display = "none";
html_code += '<div style="display:table-cell"><input class="btn_subusage button_gen" onclick="open_upload_window();" type="button" value="<#1712#>"/><img id="loadingicon" style="margin-left:5px;display:none;" src="/images/InternetScan.gif"></div>';
document.getElementById("cert_act").innerHTML = html_code;
document.getElementById("cert_act").style.display = "";
if(orig_le_enable != "0")
document.getElementById("cert_details").style.display = "";
...
document.getElementById("cert_status").innerHTML = "<#3687#>";
else
document.getElementById("cert_status").innerHTML = "<#3564#>";
setTimeout("get_cert_info();", 1000);
}
else{
document.getElementById("cert_status").innerHTML = "<#751#>";
...
var $close_btn = $("<div>").addClass("close_btn");
...
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=168"><#2628#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=169"><#2629#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=170"><#2630#></a></div>'
...
<div class="formfonttitle_help"><a onclick="show_feature_desc()"><i class="icon_help"></i></a></div>
</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc formfontdesc_help_left">
<div><#2624#></div>
</div>
<div class="formfontdesc hint-color" id="wan_ip_hide2" style="color:#FC0; display:none;"><#2627#><#2625#></div>
<div class="formfontdesc hint-color" id="lb_note" style="color:#FC0; display:none;"><#2676#></div>
...
<div style="color:#FFCC00">*<#2631#></div>
</td>
</tr>
<tr>
<th id="ddns_wan_unit_th"><#3818#></th>
...
<option class="content_input_fd" value="0" <% nvram_match("ddns_wan_unit", "0","selected"); %>><#1901#></option>
<option class="content_input_fd" value="1"<% nvram_match("ddns_wan_unit", "1","selected"); %>><#1908#></option>
</select>
</td>
</tr>
<tr id="ddns_ipv6update_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,18);"><#1739#></a></th>
<td>
...
<a id="link" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#2639#></a>
<a id="linkToHome" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1728#></a>
</td>
</tr>
<tr id="ddns_hostname_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#2635#></a></th>
<td>
...
<div class="tooltip"><a onClick="copyDdnsInputValue(this)" onmouseover="showDescTooltip(this)" data-toggle="tooltip" data-title="Copied!"><i class="icon-copy"></i></a></div>
</div>
</td>
</tr>
...
<th><#1745#></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="ddns_regular_period" value="<% nvram_get("ddns_regular_period"); %>" autocorrect="off" autocapitalize="off"> <#2739#>
</td>
</tr>
<tr style="display:none;">
<th><#2642#></th>
...
<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#2640#>" /></td>
</tr>
...
<input type="radio" value="1" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "1", "checked"); %>><#1731#>
</span>
<input type="radio" value="2" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "2", "checked"); %>><#1733#>
<span id="self_signed" style="color:#FFF;">
<input type="radio" value="0" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "0", "checked"); %>><#873#>
</span>
...
<div class="cert_status_title"><#754#> :</div>
<div id="cert_status" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3696#> :</div>
<div id="issueTo" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3695#> :</div>
<div id="issueBy" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3694#> :</div>
<div id="expireOn" class="cert_status_val"></div>
</div>
<div>
<input class="button_gen" onclick="save_cert_key();" type="button" value="<#1551#>" />
</div>
</td>
</tr>
</table>
...
<div class="formfonttitle" style="margin-top: 15px; margin-left: 15px;"><#1733#></div>
<div class="formfontdesc" style="margin: 15px;"><#1734#></div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1735#> :</div>
<div style="display:table-cell;"><input type="file" name="file_key" class="input Upload_file"></div>
</div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1741#> :</div>
<div style="display:table-cell;"><input type="file" name="file_cert" class="input Upload_file"></div>
</div>
<div style="color: #FC0; margin-left: 15px; margin-top: 20px">* <#1736#></div>
...
<div style=""><input class="button_gen" type="button" onclick="upload_cert_key();" id="applyBtn" value="<#1702#>"></div>
</div>
</div>
</form>
</body>
