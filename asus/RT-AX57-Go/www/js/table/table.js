...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2690#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2550#> " + _createRuleCount + " <#2551#>");
return;
}
...
$titleHtml.html("<#2540#>");/*untranslated*/
...
$actionButtonCancelHtml.html("<#212#>");
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#2928#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2543#>");
return false;
}
}
