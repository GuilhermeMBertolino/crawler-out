...
{"value":1800, "title":"30 <#2739#>", "text":"30 mins"},
{"value":3600, "title":"1 <#2343#>", "text":"1 hr(s)"},
{"value":7200, "title":"2 <#2343#>", "text":"2 hr(s)"},
{"value":14400, "title":"4 <#2343#>", "text":"4 hr(s)"},
{"value":21600, "title":"6 <#2343#>", "text":"6 hr(s)"}
];
var _time_unit_parm = {
...
$("<div>").addClass("add_new_text").html("<#3806#>").appendTo($component);
return $component;
}
...
$("<div>").addClass("cb_text").html("<#4344#>").appendTo($all_day_com);
}
var $weekdayset_cntr = $("<div>").addClass("weekdayset_container").appendTo($container);
$("<div>").addClass("title").html("<#4358#>").appendTo($weekdayset_cntr);
...
if(total_weekday == 0)
$(this).closest(".weekdayset_container").find(".valid_hint_component").html("* <#339#>").show();
else
...
$("<div>").addClass("sche_btn_cancel").html("<#212#>").unbind("click").click(function(e){
...
$("<div>").addClass("sche_btn_save").html("<#1703#>").unbind("click").click(function(e){
var $top_schedule_ui = $(this).closest(".schedule_ui");
...
if(!legal_flag){
$top_schedule_ui.find(".timeset_container .valid_hint_component").html("* <#4362#> <#4363#>").show();
return;
}
else
...
if(total_weekday == 0){
legal_flag = false;
$top_schedule_ui.find(".weekdayset_container .valid_hint_component").html("* <#339#>").show();
return;
}
else
...
$("<div>").attr({"title":"<#1717#>", "data-component":"custom", "value":custom_default}).html("<span><#1717#></span>").addClass("custom").appendTo($quickset_comp);
...
if((hour == 0 && min < 5)){
show_valid_hint("* <#2126#>", $top_timeset_obj.find(".combi_input.minute"));
return false;
}
$(this).val(num_add_left_pad($(this).val(), 2));
$top_timeset_obj.find(".valid_hint_component").hide().empty();
