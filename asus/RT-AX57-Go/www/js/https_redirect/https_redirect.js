...
var $scan_title = $("<div>").addClass("scan_title").appendTo($scan_qr_code_block).html("<#4396#>");
...
$("<label>").attr("for","https_redirect_hint").html("<#4401#>").appendTo($cb_text_bg);
var $btn_bg = $("<div>").addClass("btn_bg").appendTo($action_bg);
var $btn_no = $("<div>").html("<#199#>").appendTo($btn_bg);
...
var $btn_yes = $("<div>").html("<#200#>").appendTo($btn_bg);
