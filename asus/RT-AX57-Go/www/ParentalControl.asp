...
<title id="web_title"><#867#> - <#489#></title>
...
document.getElementById('content_title').innerHTML = "<#489#> - <#3399#>";
document.getElementById('desc_title').innerHTML = "<#2947#>";
document.getElementById('web_title').innerHTML = "<#867#> - <#3399#>";
document.getElementById('PC_enable').innerHTML = "<#2945#>";
}
if(isSupport("PC_SCHED_V3")){
$("#desc_title").html("<#2957#>");
var $desc_item = $("#desc_item").empty();
$("<li>").html("<#2958#>").appendTo($desc_item);
$("<li>").html("<#2949#>").appendTo($desc_item);
$("<li>").html("<#2959#>").appendTo($desc_item);
$("<li>").html("<#2960#>").appendTo($desc_item);
...
code +='<thead><tr><td colspan="4"><#1658#>&nbsp;(<#2690#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#3196#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#3196#></option>';
code += '<option value="0"><#1548#></option>';
code += '<option value="1"><#1800#></option>';
code += '<option value="2"><#1469#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1565#> (<#3041#>)</th>';
code +='<th width="20%"><#2954#></th>';
code +='<th width="20%"><#2689#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1548#></option>';
code += '<option value="1" selected><#1800#></option>';
code += '<option value="2"><#1469#></option>';
code += '</select>';
code += '</td>';
...
code += '<option value="0" ' + ((client_time_obj.enable == "0") ? "selected" : "") + '><#1548#></option>';
code += '<option value="1" ' + ((client_time_obj.enable == "1") ? "selected" : "") + '><#1800#></option>';
code += '<option value="2" ' + ((client_time_obj.enable == "2")? "selected" : "") + '><#1469#></option>';
code += '</select>';
code += '</td>';
...
var hint = "<#4349#>".replace("#MAXNUM", weekScheduleApi.data_max);
hint += "\n";
hint += "<#4350#>";
alert(hint);
return false;
...
code += "<span class=\"clicked\"><#3399#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#1236#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#3399#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1236#></span>";
}
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1236#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#3399#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<div style="font-size:14px;margin-left:6px;margin-bottom:6px;"><#2962#></div>
