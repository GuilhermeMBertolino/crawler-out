...
document.getElementById("mfb_iframe").setAttribute("src", "/multifuncbtn/mfb.html" + curTheme);
...
<input type="hidden" name="current_page" value="Advanced_MultiFuncBtn.asp">
<input type="hidden" name="next_page" value="Advanced_MultiFuncBtn.asp">
...
<iframe id="mfb_iframe" class="rwd_iframe" frameborder="0"></iframe>
</td>
</tr>
</tbody>
</table>
