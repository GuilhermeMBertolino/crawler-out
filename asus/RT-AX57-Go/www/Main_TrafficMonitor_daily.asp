...
grid += "<tr><th style=\"height:30px;\"><#1719#></th>";
grid += "<th><#3416#></th>";
grid += "<th><#3423#></th>";
grid += "<th><#3426#></th></tr>";
...
if(rows == 0)
grid +='<tr><td style="color:#FFCC00;" colspan="4"><#2472#></td></tr>';
...
<option value="3" selected><#2732#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="2" id="TriggerList" style="text-align:left;"><#2671#> <span style="color:#FFF;background-color:transparent;" id='last-dates'></span></td>
</tr>
</thead>
<tbody>
<tr class='even'><th width="40%"><#3416#></th><td id='last-dn'>-</td></tr>
<tr class='odd'><th width="40%"><#3423#></th><td id='last-up'>-</td></tr>
<tr class='footer'><th width="40%"><#3426#></th><td id='last-total'>-</td></tr>
</tbody>
</table>
</td>
</tr>
