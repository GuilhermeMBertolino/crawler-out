...
var category_info = [ ["Parental Controls", "1", "<#1237#>", "<#1239#>", "<#1474#>"],
["Parental Controls", "3", "<#1237#>", "<#1239#>", "<#1476#>"],
["Parental Controls", "4", "<#1237#>", "<#1239#>", "<#1477#>"],
["Parental Controls", "5", "<#1237#>", "<#1239#>", "<#1478#>"],
["Parental Controls", "6", "<#1237#>", "<#1239#>", "<#1479#>"],
["Parental Controls", "8", "<#1237#>", "<#1239#>", "<#1480#>"],
["Parental Controls", "9", "<#1237#>", "<#1240#>", "<#1481#>"],
["Parental Controls", "10", "<#1237#>", "<#1240#>", "<#1482#>"],
["Parental Controls", "14", "<#1237#>", "<#1240#>", "<#1483#>"],
["Parental Controls", "15", "<#1237#>", "<#1240#>", "<#1484#>"],
["Parental Controls", "16", "<#1237#>", "<#1240#>", "<#1485#>"],
["Parental Controls", "25", "<#1237#>", "<#1240#>", "<#1486#>"],
["Parental Controls", "26", "<#1237#>", "<#1240#>", "<#1487#>"],
["Parental Controls", "11", "<#1237#>", "<#1241#>", "<#1488#>"],
["Parental Controls", "24", "<#1252#>", "<#1242#>", "<#1489#>"],
["Parental Controls", "51", "<#1252#>", "<#1243#>", "<#1490#>"],
["Parental Controls", "53", "<#1252#>", "<#1244#>", "<#1491#>"],
["Parental Controls", "89", "<#1252#>", "<#1244#>", "<#1492#>"],
["Parental Controls", "42", "<#1252#>", "<#1245#>", "<#1493#>"],
["Parental Controls", "56", "<#1255#>", "<#1257#>", "<#1494#>"],
["Parental Controls", "70", "<#1255#>", "<#1257#>", "<#1495#>"],
["Parental Controls", "71", "<#1255#>", "<#1257#>", "<#1496#>"],
["Parental Controls", "57", "<#1255#>", "<#1258#>", "<#1497#>"],
["Parental Controls", "69", "<#1259#>", "<#1261#>", "<#1498#>"],
["Parental Controls", "23", "<#1259#>", "<#1262#>", "<#1499#>"],
["Home Protection", "91", "Anti-Trojan detecting and blocked", "", "<#1500#>"],
["Home Protection", "2", "Malicious site blocked", "", "<#1475#>"],
["Home Protection", "39", "Malicious site blocked", "", "<#1501#>"],
["Home Protection", "73", "Malicious site blocked", "", "<#1502#>"],
["Home Protection", "74", "Malicious site blocked", "", "<#1503#>"],
["Home Protection", "75", "Malicious site blocked", "", "<#1504#>"],
["Home Protection", "76", "Malicious site blocked", "", "<#1505#>"],
["Home Protection", "77", "Malicious site blocked", "", "<#1506#>"],
["Home Protection", "78", "Malicious site blocked", "", "<#1507#>"],
["Home Protection", "79", "Malicious site blocked", "", "<#1508#>"],
["Home Protection", "80", "Malicious site blocked", "", "<#1509#>"],
["Home Protection", "81", "Malicious site blocked", "", "<#1510#>"],
["Home Protection", "82", "Malicious site blocked", "", "<#1511#>"],
["Home Protection", "83", "Malicious site blocked", "", "<#1512#>"],
["Home Protection", "84", "Malicious site blocked", "", "<#1513#>"],
["Home Protection", "85", "Malicious site blocked", "", "<#1514#>"],
["Home Protection", "86", "Malicious site blocked", "", "<#1515#>"],
["Home Protection", "88", "Malicious site blocked", "", "<#1516#>"],
["Home Protection", "92", "Malicious site blocked", "", "<#1517#>"],
["Home Protection", "94", "Malicious site blocked", "", "<#1518#>"],
["Home Protection", "95", "Malicious site blocked", "", "<#1519#>"]
];
var target_info = {
url: "",
category_id: "",
...
var parental_string = "";
code = "<ul>";
code += "<li><div><span class='desc_info'><#1752#>:</span><br>" + target_info.desc + "</div></li>";
if(casenum != "")
code += "<li><div><span class='desc_info'>URL: </span>" + target_info.url +"</div></li>";
if(target_info.category_type == "Parental Controls")
code += "<li><div><span class='desc_info'><#1247#> :</span>" + target_info.content_category + "</div></li>";
code += "</ul>";
document.getElementById('detail_info').innerHTML = code;
if(target_info.category_type == "Parental Controls"){ //Webs Apps filter
code_title = "<div class='er_title' style='height:auto;'><#1529#></div>";
code_suggestion = "<ul>";
code_suggestion += stringSafeGet("<li><span><#1528#></span></li>");
code_suggestion += "<li><span><#1533#></span></li>";
code_suggestion += '<li><#1307#><a href="https://global.sitesafety.trendmicro.com/index.php" target="_blank"><#1308#></a></li>';
code_suggestion += "</ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#1525#></div>";
code_suggestion = "<ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#832#></div>";
document.getElementById('main_reason').innerHTML = "<#831#>";
code = "";
code += "<div><#842#></div>";
document.getElementById('detail_info').innerHTML = code;
code_suggestion = "<ul>";
code_suggestion += "<li><span><#843#></span></li>";
code_suggestion += "<li><span><#844#></span></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
code_title = "<div class='er_title' style='height:auto;'><#1534#></div>"
code_suggestion = "<ul>";
if(bwdpi_support)
parental_string = "<#3399#>";
else
parental_string = stringSafeGet("<#489#>");
code_suggestion += "<li><#1531#> "+ parental_string +" <#1532#></li>";
code_suggestion += "<li><#1533#></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
<div class="prod_madelName"><#868#></div>
<div id="main_reason" class="p1 title_gap"><#1521#></div>
<div ></div>
<div>
...
<div class="p1 title_gap"><#852#></div>
<div>
<div class="p1 title_gap"></div>
<div class="nologin">
...
<div id="go_btn" class='button' style="display:none;"><#1552#></div>
</div>
</body>
</html>
