...
<div id="kwf_desc2" class="formfontdesc"><#2096#></div>
...
<th><#2094#></th>
<td>
<input type="radio" value="1" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "1", "checked"); %>><#1692#>
<input type="radio" value="0" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "0", "checked"); %>><#1689#>
</td>
</tr>
</table>
