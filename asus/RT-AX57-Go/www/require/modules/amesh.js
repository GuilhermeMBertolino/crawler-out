...
document.getElementById("ameshNumber").innerHTML = "<#1063#>: <span>" + num + "</span>";
}
...
&& (_smart_connect_enable !== undefined && _smart_connect_enable === '1')
&& smart_connect_mode[0] === '1'
&& auth_text === 'WPA2/WPA3-Personal'){
return support_flag;
}
var confirm_msg = "<#1035#>".replace("#AUTHMODE", auth_text);
