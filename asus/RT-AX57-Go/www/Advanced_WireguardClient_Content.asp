...
<title><#867#> - WireGuard Client</title>
...
<td>
<input type="radio" value="1" name="wgc_enable" class="input" <% nvram_match("wgc_enable", "1", "checked"); %>><#200#></input>
<input type="radio" value="0" name="wgc_enable" class="input" <% nvram_match("wgc_enable", "0", "checked"); %>><#199#></input>
</td>
</tr>
<tr id="wgc_nat">
<th><#1916#></th>
<td>
<input type="radio" value="1" name="wgc_nat" class="input" <% nvram_match("wgc_nat", "1", "checked"); %>><#200#></input>
<input type="radio" value="0" name="wgc_nat" class="input" <% nvram_match("wgc_nat", "0", "checked"); %>><#199#></input>
</td>
</tr>
</table>
