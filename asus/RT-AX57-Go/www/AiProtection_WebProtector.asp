...
var category_name = ["<#1237#>", "<#1252#>", "<#1255#>", "<#1259#>"];
var sub_category_name = [["<#1239#>", "<#1240#>", "<#1241#>"],
["<#1242#>", "<#1243#>", "<#1244#>", "<#1245#>", "<#1246#>"],
["<#1257#>", "<#1258#>"],
["<#1260#>", "<#1261#>", "<#1262#>"]];
var category_desc = ["<#1238#>",
"<#1253#>",
"<#1256#>",
"<#1263#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1658#>&nbsp;(<#2690#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#3196#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1565#> (<#3041#>)</th>';
code += '<th width="40%"><#1247#></th>';
code += '<th width="10%"><#2689#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#3990#>/<#1548#>">';
...
code += '</tr>';
if(apps_filter == ""){
code += '<tr><td class="tableNoRule" style="color:#FFCC00;" colspan="10"><#2472#></td></tr>';
}
else{
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#489#> - <#1236#></div>
</td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1236#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3399#></td></tr></table>
</div>
</a>
</div>
</td>
...
<span><#1254#></span>
<div>
<a id="faq" class="notInBusiness" href="" style="text-decoration:underline;" target="_blank"><#489#> FAQ</a>
</div>
</td>
</tr>
</table>
...
<input class="button_gen" type="button" onclick="applyRule();" value="<#209#>">
