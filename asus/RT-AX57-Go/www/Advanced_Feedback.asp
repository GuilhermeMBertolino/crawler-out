...
infolist = new Array();
infolist.push(["<#748#> ...","No_selected"]);
infolist.push(["<#2031#>","phone"]);
infolist.push(["QQ","qq"]);
infolist.push(["<#3893#>","wechat"]);
...
ptypelist = new Array();
ptypelist.push(["<#748#> ...", "No_selected"]);
ptypelist.push(["<#2036#>", "Setting_Problem"]);
ptypelist.push(["<#1980#>", "Connection_or_Speed_Problem"]);
ptypelist.push(["<#1972#>", "Compatibility_Problem"]);
ptypelist.push(["<#2040#>", "Suggestion"]);
ptypelist.push(["<#2051#>", "Technical_Support"]);
ptypelist.push(["<#922#>", "Other_Problem"]);
...
url_group = new Array();
timelist = new Array();
desclist.push(["<#748#> ...","No_selected"]);
url_group.push(["select"]);//false value
if(ptype == "Setting_Problem"){
desclist.push(["<#514#>","QIS"]);
url_group.push(["QIS"]);
desclist.push(["<#401#>","Network Map"]);
url_group.push(["index"]);
desclist.push(["<#299#>","Guest Network"]);
url_group.push(["Guest_network"]);
desclist.push(["<#1313#>","AiProtection"]);
url_group.push(["AiProtection"]);
desclist.push(["<#923#>","Adaptive QoS"]); //5
url_group.push(["AdaptiveQoS"]);
desclist.push(["<#1955#>","Traditional QoS"]);
url_group.push(["AiProtection"]);
desclist.push(["<#916#>","Gaming"]);
url_group.push(["GameBoost"]);
desclist.push(["<#3442#>/<#399#>","Traffic Analyzer/Manager"]);
url_group.push(["TrafficMonitor"]);
desclist.push([stringSafeGet("<#489#>"),"Parental Ctrl"]);
url_group.push(["ParentalControl"]);
desclist.push(["<#400#>","USB Application"]); //10
...
desclist.push(["<#403#>","Wireless"]);
url_group.push(["ACL", "WAdvanced", "Wireless", "WMode", "WSecurity", "WWPS"]);
desclist.push(["<#414#>","WAN"]);
url_group.push(["WAN_", "PortTrigger", "VirtualServer", "Exposed", "NATPassThrough"]);
desclist.push(["<#237#>","Dual WAN"]); //15
url_group.push(["WANPort"]);
desclist.push(["<#410#>","LAN"]);
url_group.push(["LAN", "DHCP", "GWStaticRoute", "IPTV", "SwitchCtrl"]);
desclist.push(["<#424#>/<#3602#>","USB dongle"]);
url_group.push(["Modem"]);
desclist.push(["<#1824#>","DM"]);
url_group.push(["DownloadMaster"]);//false value
desclist.push(["<#419#>","DDNS"]);
url_group.push(["DDNS"]);
desclist.push(["IPv6","IPv6"]); //20
url_group.push(["IPv6"]);
desclist.push(["VPN","VPN"]);
url_group.push(["VPN"]);
desclist.push(["<#425#>","Firewall"]);
url_group.push(["Firewall", "KeywordFilter", "URLFilter"]);
desclist.push(["<#431#>","Administration"]);
url_group.push(["OperationMode", "System", "SettingBackup"]);
desclist.push(["<#771#>","System Log"]);
url_group.push(["System"]);
desclist.push(["<#2884#>","Network Tools"]); //25
url_group.push(["Status_"]);
desclist.push(["<#3108#>","Rescue"]);
url_group.push(["Rescue"]);//false value
desclist.push(["<#1976#>","Other Devices"]);
url_group.push(["Other_Device"]);//false value
desclist.push(["<#3892#>","Fail to access"]);
url_group.push(["GUI"]);//false value
desclist.push(["<#435#>","FW update"]);
url_group.push(["FirmwareUpgrade"]);
if(isSupport("Instant_Guard")){
desclist.push(["<#4373#>","Instant Guard"]); //30
url_group.push(["Instant_Guard"]);
}
}
else if(ptype == "Connection_or_Speed_Problem"){
desclist.push(["<#1981#>","Wireless speed"]);
desclist.push(["<#1982#>","Wired speed"]);
desclist.push(["<#1984#>","Unstable connection"]);
desclist.push(["<#1983#>","Router reboot"]);
desclist.push(["<#1985#>","Wireless disconnected"]);
}
else if(ptype == "Compatibility_Problem"){
desclist.push(["<#1975#>","modem"]);
desclist.push(["<#1977#>","other router"]);
desclist.push(["<#1973#>","OS or Application"]);
desclist.push(["<#1978#>","printer"]);
desclist.push(["<#1979#>","USB modem"]);
desclist.push(["<#1974#>","external hardware disk"]);
desclist.push(["<#1976#>","network devices"]);
}
else if(ptype == "Suggestion"){
desclist.splice(0,1);
desclist.push(["<#2043#>","Translation"]);
desclist.push(["<#2044#>","UI/UX"]);
desclist.push(["<#2041#>","Current Feature"]);
desclist.push(["<#2042#>","New Feature Request"]);
}
else if(ptype == "Technical_Support"){
desclist.splice(0,1);
desclist.push(["<#2049#>","tech_ASUS"]);
desclist.push(["<#2047#>","tech_Amazon"]);
desclist.push(["<#2050#>","tech_iOS"]);
desclist.push(["<#2048#>","tech_Android"]);
}
else{ //Other_Problem
desclist.splice(0,1);
desclist.push(["<#922#>","others"]);
}
...
timelist.push(["<#748#> ...","No_selected"]);
timelist.push(["<#2059#>","Just Now"]);
...
timelist.push(["<#2063#>","Today"]);
timelist.push(["<#2064#>","Recently"]);
timelist.push(["<#2065#>","I don’t recall"]);
...
bandlist.push(["<#1424#>","All"]);
bandlist.push(["<#2020#>","I am not sure"]);
bandlist.push(["<#2021#>","Issue with the main router"]);
bandlist.push(["<#2022#>","Issue with node(s)"]);
...
unstablelist.push(["<#748#> ...","No_selected"]);
unstablelist.push(["<#2018#>","All WiFi"]);
...
unstablelist.push(["<#2019#>","Both WiFi and WAN"]);
unstablelist.push(["<#2020#>","I am not sure"]);
unstablelist.push(["<#2021#>","Issue with the main router"]);
unstablelist.push(["<#2022#>","Issue with node(s)"]);
...
if(value) {
if(allUsbStatus.search("storage") == "-1"){
alert("USB disk required in order to store the debug log, please plug-in a USB disk to <#868#> and Enable DSL Line Diagnostic again.");/*untranslated*/
...
var remaining_time_str = "<#2849#> : ";
if(dblog_remaining == 0) {
remaining_time_str += "0" + " " + "(Prepare data...)"; //Untranslated
return remaining_time_str;
}
if(days)
remaining_time_str += days + " <#1727#> ";
if(hours)
remaining_time_str += hours + " <#2343#> ";
if(minutes)
remaining_time_str += minutes + " <#2739#> ";
if(seconds)
remaining_time_str += seconds + " <#3192#> ";
return remaining_time_str;
};
...
var dblog_service_mapping = ["", "WiFi", "<#1824#>", "<#804#>", "AiMesh"];
...
selectOption = {"1 <#2343#>" : hour_to_sec(1)};
}
if(usb_support && $("input[name=dblog_tousb_cb]").prop("checked")) {
baseOption = { "12 <#2343#>" : hour_to_sec(12), "1 <#1727#>" : hour_to_sec(24), "2 <#1727#>" : hour_to_sec(48), "3 <#1727#>" : hour_to_sec(72) };
}
else {
baseOption = { "6 <#2343#>" : hour_to_sec(6), "12 <#2343#>" : hour_to_sec(12), "24 <#2343#>" : hour_to_sec(24) };
}
...
$(".dblog_service_item.wifi").after(gen_appendix_option(16, "<#2056#>", "dhd"));
}
$("input[name=dblog_service_list]").prop("checked", true);
...
if($("input[name=dblog_tousb_cb]").prop("checked")) {
if(media_support)
$(".dblog_service_item.all").after(gen_service_option(4, "<#804#>", "noUSB"));
if(!nodm_support)
$(".dblog_service_item.all").after(gen_service_option(2, "<#1824#>", "noUSB"));
}
}
...
var auth_status_hint = "<#1451#>";
document.form.fb_email.value = "";
switch(_status) {
case "0" :
auth_status_hint = "<#567#>";
break;
case "1" :
auth_status_hint = "<#1450#>";
...
<tr>
<td>
<div class="drword" id="drword" style="height:110px;"><#392#> <#707#>...
<br/>
<br/>
</div>
</td>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#431#> - <#2728#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="fb_desc0" class="formfontdesc" style="display:none;"><#2001#></div>
<div id="fb_desc1" class="formfontdesc" style="display:none;"><#2002#></div>
<div id="fb_desc_disconnect" class="formfontdesc hint-color" style="display:none;"><#2003#> <a class="hint-color" href="mailto:router_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top">router_feedback@asus.com</a></div>
...
<th><#2007#> *</th>
<td>
<input type="checkbox" class="input" name="attach_syslog" id="attach_syslog_id"><label for="attach_syslog_id"><#771#></label>&nbsp;&nbsp;&nbsp;
<input type="checkbox" class="input" name="attach_cfgfile" id="attach_cfgfile_id"><label for="attach_cfgfile_id"><#2035#></label>&nbsp;&nbsp;&nbsp;
<span id="attach_iptables_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_iptables" id="attach_iptables_id"><label for="attach_iptables_id"><#2015#></label></span>
<span id="attach_modem_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_modemlog" id="attach_modemlog_id"><label for="attach_modemlog_id"><#1966#></label></span>
<input type="checkbox" class="input" name="attach_wlanlog" id="attach_wlanlog_id"><label for="attach_wlanlog_id"><#2055#></label>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(25,11);"><#1997#> *</a></th>
<td>
<input type="radio" name="dslx_diag_enable" class="input" value="1" onclick="change_dsl_diag_enable(1);"><#200#>
<input type="radio" name="dslx_diag_enable" class="input" value="0" onclick="change_dsl_diag_enable(0);" checked><#199#>
<br>
<span id="storage_ready" class="hint-color" style="display:none;">* <#3600#></span>
<span id="be_lack_storage" class="hint-color" style="display:none;">* <#2911#></span>
</td>
</tr>
...
<option value="0" selected><#166#></option>
<option value="3600">1 <#2343#></option>
<option value="18000">5 <#2343#></option>
<option value="43200">12 <#2343#></option>
<option value="86400">24 <#2343#></option>
<option value="172800">48 <#2343#></option>
</select>
</td>
</tr>
<tr class="dblog_support_class">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34, 1);"><#1998#></a></th>
<td>
<div class="dblog_disabled_status">
<input type='radio' name='dblog_enable' id='dblog_status_en' value="1" onclick="diag_change_dblog_status();"><label for='dblog_status_en'><#200#></label>
<input type='radio' name='dblog_enable' id='dblog_status_dis' value="0" onclick="diag_change_dblog_status();" checked><label for='dblog_status_dis'><#199#></label>
<label class="storeUSBHint"><input type="checkbox" name="dblog_tousb_cb" value="1" onclick="diag_change_storeUSB();" checked><#1999#></label>
<span class="noUSBHint">* <#2911#></span>
</div>
<div class="dblog_enabled_status">
<span>* <#1990#></span>
<br>
<span class="dblog_stop_text" onclick="dblog_stop();"><#1989#></span>
</div>
</td>
</tr>
...
<div class="dblog_disabled_status">
<label class="dblog_service_item all"><input type="checkbox" name="dblog_service_list_all" onclick="diag_change_service_list_all();"><#1424#></label>
</div>
<div class="dblog_enabled_status">
...
<option value="No_selected"><#748#> ...</option>
<option value="Stable_connection"><#2037#></option>
<option value="Occasional_interruptions"><#2029#></option>
<option value="Frequent_interruptions"><#2014#></option>
<option value="Unavailable"><#2052#></option>
</select>
</td>
</tr>
<tr>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2066#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2058#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34,2);"><#1449#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34,3);"><#2046#></a></th>
<td>
...
<div id="eula_content" style="margin-left: 20px;"><#2053#></div>
</div>
<input class="btn_subusage button_gen" name="btn_send" onclick="applyRule()" type="button" value="<#1555#>"/>
</div>
</td>
</tr>
<tr>
...
<strong class="warning_title"><#2191#></strong>
<ul>
<li><#2028#><br><a id="call_link" style="font-weight: bolder;text-decoration:underline;cursor:pointer;" href="" target="_blank">https://www.asus.com/support/CallUs/</a></li>
</ul>
</div>
</td>
</tr>
