...
<tr>
<td>
<div class="weakness_router_status"><#1271#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<input class="button_gen" type="button" onclick="close_weakness_status();" value="<#1685#>">
</td>
<td>
<input id="all_security_btn" class="button_gen" type="button" onclick="enable_whole_security();" value="<#1710#>">
</td>
</tr>
</table>
</td>
...
<tr>
<th>
<div style="font-size:16px;"><#1219#></div>
</th>
</tr>
<td>
<div class="formfontdesc" style="font-size: 14px;"><#1267#></div>
</td>
<tr>
<td>
...
<span style="color: #FFF;"><#1310#></span>
</div>
<div>
...
<input class="button_gen" type="button" onclick="close_alert_preference();" value="<#1685#>">
...
<tr>
<td align="left">
<span class="formfonttitle"><#1313#></span>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="width:430px"><#1268#></div>
<div style="width:430px">
<a id="faq" style="text-decoration:underline;" href="" target="_blank"><#1313#> FAQ</a>
</div>
</td>
<td>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1271#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1272#></div>
</td>
<td width="6px">
...
<td style="width:20%;">
<div>
<input class="button_gen" type="button" onclick="showWeaknessTable();" value="<#1708#>">
</div>
</td>
<td>
<div class="line_vertical"></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1310#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1309#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size: 16px;"><#1302#></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1330#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1331#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1223#></div>
<div style="font-size: 14px;color:#FC0;height:auto;;padding-top:5px;"><#1222#></div>
</td>
<td>
<div class="line_vertical"></div>
</td>
...
<input class="button_gen" type="button" onclick="show_alert_preference();" value="<#1219#>">
</div>
</div>
