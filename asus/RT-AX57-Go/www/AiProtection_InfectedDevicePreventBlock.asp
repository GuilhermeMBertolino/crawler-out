...
code += '<div style="display:table-cell;width:150px;padding-right:5px;"><#1232#></div>';
code += '<div style="display:table-cell;width:100px;padding-right:5px;"><#1231#></div>';
code += '</div>';
if(dataObj == ""){
...
code += '<div style="display:table-cell;width:100px;height:30px;vertical-align:middle;padding-right:5px;cursor: pointer;text-decoration: underline;" title="<#1343#>" onclick="TMEvent();">'+ dataObj[eventID].destination[0] +'</div>';
code += '</div>';
}
}
...
<tr>
<td align="left">
<span class="formfonttitle"><#1313#> - <#1223#></span>
</td>
</tr>
</table>
</div>
...
<div style="margin: 0 8px;"><div id="save_icon" class="icon-container icon-save" title="<#1703#>" onclick="download(csvContent, 'InfectedDevicePreventBlock.csv', 'data:text/csv;charset=utf-8');"></div></div>
...
<div style="display:table-cell;width:150px;padding-right:5px;"><#1232#></div>
<div style="display:table-cell;width:100px;padding-right:5px;"><#1231#></div>
</div>
</div>
</div>
</div>
