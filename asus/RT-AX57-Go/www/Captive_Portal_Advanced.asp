...
var jscolor_attr = "{closable:true, closeText:\"<#1685#>\", onFineChange:\"edit_component_color_callback(this)\"}";
...
var captive_portal_list_row = captive_portal_adv_profile_list.split("<");
var auth_array = ["<#1548#>", "Account/Password", "Account/Password", "Account/Password"];/*untranslated*/
var code = "";
...
if(arrayLength == 0)
code += '<tr><td style="color:#FFCC00;" colspan="5"><#2472#></td></tr>';
else{
...
code += '<td id="td_wl_name" width="30%"><#873#></td>';
...
window.open('Captive_Portal_Advanced_Preview.asp', '<#4249#>', 'toolbar=no,scrollbars=no,resizable=yes,location=no,menubar=no,width=476,height=714');
...
code += "<div id='toolbar_template' title='<#4185#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_template' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4185#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc step1'>";
code += "<div class='help_desc_title'>1. <#4244#></div>";
code += "<div class='help_desc_text'><#4245#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_2' class='help_step' style='display:none;'>";
code += "<div class='help_frame step2'>";
code += "<div class='help_desc_title'>2. <#4246#></div>";
code += "<div class='help_desc_text'><#4247#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_3' class='help_step' style='display:none;'>";
code += "<div class='help_frame step3'>";
code += "<div id='toolbar_unit_image' title='<#1680#> <#4187#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_image' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_text' title='<#1680#> Text' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_text' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_account' title='<#1680#> <#3027#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_account' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_eula' title='<#1680#> Eula' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_eula' style='cursor:default;'></div>";
code += "</div>";
code += "<div class='help_desc step3'>";
code += "<div class='help_desc_title'>3. <#4233#></div>";
code += "<div class='help_desc_text'><#4234#></div>";
code += "<div class='help_desc_text'><#4235#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_4' class='help_step' style='display:none;'>";
code += "<div class='help_frame step4'>";
code += "<div id='toolbar_background' title='<#4168#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_background' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4168#></div>";
code += "</div>";
code += "<div id='toolbar_editor' title='<#4186#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_editor' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4186#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc step4'>";
code += "<div class='help_desc_title'>4. <#4236#></div>";
code += "<div class='help_desc_text'><#4237#></div>";
code += "<div class='help_desc_text'><#4238#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_5' class='help_step' style='display:none;'>";
code += "<div class='help_frame step5'>";
code += "<div title='<#4169#>' class='splash_page_toolbar_unit_preview' style='cursor:default;'></div>";
code += "</div>";
code += "<div class='help_desc step5'>";
code += "<div class='help_desc_title'>5. <#4239#></div>";
code += "<div class='help_desc_text'><#4240#></div>";
code += "<div class='help_desc_text'><#4241#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_6' class='help_step' style='display:none;'>";
code += "<div class='help_frame step6'>";
code += "<input class='button_gen' type='button' style='cursor:default;' value='<#1706#>' disabled/>";
code += "</div>";
code += "<div class='help_desc step6'>";
code += "<div class='help_desc_title'>6. <#4242#></div>";
code += "<div class='help_desc_text'><#4243#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc_action_bg'>";
code += "<div class='help_desc_action_idx'>1 / 6</div>";
code += "<div id='help_desc_action_close' class='help_desc_action' style='display:none;' onclick='help_close();'><#1685#></div>";
code += "<div id='help_desc_action_next' class='help_desc_action' onclick='switch_help(\"next\", event);'><#218#></div>";
code += "<div id='help_desc_action_pre' class='help_desc_action' style='display:none;' onclick='switch_help(\"pre\", event);'><#219#></div>";
code += "</div>";
...
code += "<div id='captive_portal_adv_step_1' onclick='switch_tab(1)'>1. <#4216#></div>";
code += "<div id='captive_portal_adv_step_2' onclick='switch_tab(2)'>2. <#4249#></div>";
code += "<div id='captive_portal_adv_step_3' onclick='switch_tab(3)'>3. <#506#></div>";
code += "</div>";
return code;
}
...
code += "<input id='captive_portal_adv_pre' class='button_gen' style='display:none;' onclick='preRule()' type='button' value='<#219#>'/>";
code += "<input id='captive_portal_adv_next' class='button_gen' style='display:none;' onclick='nextRule()' type='button' value='<#218#>'/>";
code += "<input id='captive_portal_adv_finsih' class='button_gen' style='display:none;' type='button' value='<#1693#>'/>";
code += "</div>";
return code;
}
...
var code = "";
code += "<tr>";
code += "<th>" + wl_nband_title[_unit] + " <#585#></th>";
code += "<td>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='2'><#4219#></td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(31, 2);'><#4226#></a></th>";
code += "<td>";
...
code += "<option value='hour'><#2343#></option>";
code += "<option value='minute'><#2739#></option>";
code += "</select>";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_away_timeout' id='cpa_away_timeout_unlimited' checked><label for='cpa_away_timeout_unlimited'><#2683#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(31, 3);'><#4248#></a></th>";
code += "<td>";
...
code += "<option value='day'><#1727#></option>";
code += "<option value='hour'><#2343#></option>";
code += "<option value='minute'><#2739#></option>";
code += "</select>";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_session_timeout' id='cpa_session_timeout_unlimited' checked><label for='cpa_session_timeout_unlimited'><#2683#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4183#></th>";
...
code += "&nbsp;&nbsp;Mb/s";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_bw_dl' id='cpa_bw_dl_unlimited' checked><label for='cpa_bw_dl_unlimited'><#2683#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4184#></th>";
...
code += "&nbsp;&nbsp;Mb/s";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_bw_ul' id='cpa_bw_ul_unlimited' checked><label for='cpa_bw_ul_unlimited'><#2683#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4228#> (<#4232#>)</th>";
code += "<td>";
...
code += "<span style='margin-left:5px;'>ex. http <#4190#> https ://www.asus.com</span>";
code += "</td>";
code += "</tr>";
code += "</table>";
return code;
...
var code = "<div class='edit_component_item_hint'><#4210#></div>";
...
add_hint_msg($('input[name="edit_eula_terms_service_title"]'), "<#339#>");
$('input[name="edit_eula_terms_service_title"]').focus();
return;
}
if(eula_terms_service == "") {
add_hint_msg($('textarea#edit_eula_terms_service'), "<#339#>");
$('textarea#edit_eula_terms_service').focus();
return;
}
if(eula_hyperlink == "") {
add_hint_msg($('input[name="edit_eula_hyperlink_label"]'), "<#339#>");
...
var code = "";
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'><#4196#></div>";
...
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<div class='edit_component_item_title'><#4201#> <span>(* <#4202#>)</span></div>";
code += "<div class='edit_component_item_content'>";
code += "<div class='edit_component_item_title' style='margin-top:5px;'><#4201#> title</div>";/*untranslated*/
...
code += "<div class='edit_component_item_title' style='margin-top:5px;'><#4251#></div>";
...
code += "</div>";
code += "<div style='width:49%;float:left;'>";
code += "<div class='edit_component_item_title'><#4204#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"eula\");' type='button' value='<#1684#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_eula"]) {
...
var code = "";
if(account_username == "") {
add_hint_msg($('input[name="edit_account_username_label"]'), "<#339#>");
$('input[name="edit_account_username_label"]').focus();
return;
}
else if(account_password == "") {
add_hint_msg($('input[name="edit_account_password_label"]'), "<#339#>");
...
code += "<div class='edit_component_item_title'><#4197#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4198#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<div class='edit_component_item_title'><#4199#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4200#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"account\");' type='button' value='<#1684#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_account"]) {
...
if(botton_label == "") {
add_hint_msg($('input[name="edit_button_label"]'), "<#339#>");
...
var code = "";
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'><#4205#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4206#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4207#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='captive_portal_adv_line'></div>";
code += "<div class='edit_component_item_title'><#4208#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4209#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"button\");' type='button' value='<#1684#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_account"]) {
...
add_hint_msg($('input[name="edit_image_walled_garden"]'), "" + image_walled_garden + " <#353#>");
...
add_hint_msg($('input[name="edit_image_walled_garden"]'), "" + image_walled_garden + "<#2546#>");
$("input[name=edit_image_walled_garden]").focus();
return;
}
}
...
code += "<input type='radio' name='edit_background_type' id='edit_background_image' value='image' onclick='showHideBackgroundType();' checked><label for='edit_background_image'><#4211#></label>";
code += "<input type='radio' name='edit_background_type' id='edit_background_color' value='color' onclick='showHideBackgroundType();'><label for='edit_background_color'><#4212#></label>";
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
...
code += "<div class='edit_drag_drop_text'><#4189#><br><#4190#><br><#4191#></div>";
code += "</div>";
code += "<div class='edit_drag_drop_hint'><#4227#>: < 10MB</div>";
code += "<div class='edit_drag_drop_hint'><#4231#>: jpg, png</div>";
code += "<div class='edit_drag_drop_hint'><#4230#>: 1152 x 864 px <#4190#> <#4213#></div>";
}
else {
...
code += "<div class='edit_component_item_title'><#4214#></div>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"background\");' type='button' value='<#1684#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
...
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'>";
code += "<input type='radio' name='edit_image_type' id='edit_image_image' value='image' onclick='showHideImageType();' checked><label for='edit_image_image'><#4187#></label>";
code += "<input type='radio' name='edit_image_type' id='edit_image_color' value='color' onclick='showHideImageType();'><label for='edit_image_color'><#4188#></label>";
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
...
code += "<div class='edit_drag_drop_text edit_drag_drop_text_for_image'><#4189#><br><#4190#><br><#4191#></div>";
code += "</div>";
}
else {
...
code += "</div>";
code += "<div class='edit_component_item_title'><a style='cursor:help;color:#D0D6D8' href='javascript:void(0);' onClick='openHint(31, 5);'><#4192#></a></div>";
code += "<div class='edit_component_item_content'>";
...
add_hint_msg($('input[name="edit_text_walled_garden"]'), "" + text_walled_garden + " <#353#>");
...
add_hint_msg($('input[name="edit_text_walled_garden"]'), "" + text_walled_garden + "<#2546#>");
$("input[name=edit_text_walled_garden]").focus();
return;
}
}
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"text_" + _idx + "\");' type='button' value='<#1684#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_text"]) {
...
code += "<div class='component_title'><span><#4187#></span></div>";
...
code += "<div class='edit_component_item_title'><#4186#></div>";
...
code += "<div id='toolbar_unit_image' title='<#1680#> Image' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_image' onclick='edit_component_add(\"image\", event);'></div>";
code += "<div id='toolbar_unit_text' title='<#1680#> Text' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_text' onclick='edit_component_add(\"text\" , event);'></div>";
code += "<div id='toolbar_unit_account' title='<#1680#> <#3027#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_account' onclick='edit_component_add(\"account\" , event);'></div>";
code += "<div id='toolbar_unit_eula' title='<#1680#> Eula' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_eula' onclick='edit_component_add(\"eula\" , event);'></div>";
code += "<div title='<#4169#>' class='splash_page_toolbar_unit_preview' onclick='preview(event);'></div>";
code += "</div>";
...
code += "<input id='captive_portal_adv_reset' class='button_gen' onclick='reset_splash_page_layout()' type='button' value='<#1706#>'/>";
code += "<div id='splash_page_toolbar_unit_help' title='<#1697#>' class='splash_page_toolbar_unit_help' onclick='toolbar_unit_help(event);'></div>";
code +="</div>";
code += "</div>";
code += "<div class='splash_page_toolbar_bg_right' onclick='stop_propagation(event);'>";
code += "<div id='toolbar_template' title='<#4185#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_template' onclick='edit_component_template();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4185#></div>";
code += "</div>";
code += "<div id='toolbar_background' title='<#4168#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_background' onclick='edit_component_background();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4168#></div>";
code += "</div>";
code += "<div id='toolbar_editor' title='<#4186#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_editor' onclick='edit_component_editor();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4186#></div>";
code += "</div>";
code += "</div>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='2'><#4222#></td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><#4223#></th>";
code += "<td>";
code += "<input type='radio' name='cpa_verification' id='cpa_verification_local' value='0' onclick='showHideVerification();' checked><label for='cpa_verification_local'><#4215#></label>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='3'><#3613#>&nbsp;(<#2690#>&nbsp;32)</td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><#3612#></th>";
...
code += "</thead>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 1);'><#3918#></a></th>";
code += "<td>";
...
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 2);'><#3922#></a></th>";
code += "<td>";
...
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 3);'><#3920#></a></th>";
code += "<td>";
...
captive_portal_adv_edit_idx = 1;
set_tab_and_action_btn();
alert("Please select at least one <#585#>.");/*untranslated*/
return false;
}
var wl_if = "";
...
gn_overwrite_hint += "<#299#> " + empty_wl_idx + " - " + wl_nband_title[0] + " will be overwrite.\n\n";
}
if(wl_info.band5g_support) {
if($("#cb_wl_1").prop("checked")) {
...
gn_overwrite_hint += "<#299#> " + empty_wl_idx + " - " + wl_nband_title[1] + " will be overwrite.\n\n";
}
}
if(wl_info.band5g_2_support) {
if($("#cb_wl_2").prop("checked")) {
...
gn_overwrite_hint += "<#299#> " + empty_wl_idx + " - " + wl_nband_title[2] + " will be overwrite.";
}
}
}
...
splash_page_adv_html += "<title><#4249#></title>\n";
...
splash_page_adv_html += "alert('<#339#>');\n";
...
gn_overwrite_hint += "<#299#> " + _wl_subunit + " - " + wl_nband_title[0] + " will be overwrite.\n\n";
break;
case "1" :
if(!check_gn_if_status(_wl_subunit, gn_array_5g))
gn_overwrite_hint += "<#299#> " + _wl_subunit + " - " + wl_nband_title[1] + " will be overwrite.\n\n";
break;
case "2" :
if(!check_gn_if_status(_wl_subunit, gn_array_5g_2))
gn_overwrite_hint += "<#299#> " + _wl_subunit + " - " + wl_nband_title[2] + " will be overwrite.";
break;
}
}
}
...
if(_array.length == 0)
code += '<tr><td style="color:#FFCC00;" colspan=' + _colspan_num[_connect_type] + '><#2472#></td></tr>';
else{
...
var data = [];
if(event_log_mode) {
data = [["<#388#>", "<#309#>", "<#3612#>", "<#3027#>", "<#4248#>", "<#4226#>", "<#4178#>", "<#4179#>", "<#4180#>"]];
}
else {
data = [["<#388#>", "<#309#>", "<#3612#>", "<#3027#>", "Failure Time"]];
}
...
code += "<thead><tr style='height:30px;'><td colspan='10'><#4181#>";
code += "</td></tr></thead>";
code += "<tr id='tr_auth_pass' style='cursor:pointer;height:40px;'>";
code += "<th id='th_macAddress_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");' style='cursor:pointer;'><#3041#></th>";
code += "<th id='th_ipAddress_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#309#></th>";
code += "<th id='th_userName_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#3612#></th>";
code += "<th id='th_auth_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#3027#></th>";
code += "<th id='th_session_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4248#></th>";
code += "<th id='th_awayTimeout_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4226#></th>";
code += "<th id='th_startTime_pass' width='20%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4178#></th>";
code += "<th id='th_receviedBytes_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4179#></th>";
code += "<th id='th_transmittedBytes_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4180#></th>";
code += "</tr>";
code += "</table>";
...
code += "<thead><tr style='height:30px;'><td colspan='5'><#4181#>";
code += "</td></tr></thead>";
code += "<tr id='tr_auth_failed' style='cursor:pointer;height:40px;'>";
code += "<th id='th_macAddress_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3041#></th>";
code += "<th id='th_ipAddress_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#309#></th>";
code += "<th id='th_userName_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3612#></th>";
code += "<th id='th_auth_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3027#></th>";
...
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='exportConnectEventLog();' type='button' value='<#1551#>'/>";
code += "<input class='button_gen' onclick='update_connect_status();' type='button' value='<#1705#>'/>";
code += "</div>";
...
var code = "";
code += "<div class='edit_component_item_title'><#4193#></div>";
...
var code = "";
code += "<div class='edit_component_item_title' style='margin-bottom:8px;'><#4194#>: <span id='edit_component_level' class='edit_component_level'>" + $("#"+ _component_id + "").css("z-index") + "</span></div>";/*untranslated*/
...
<div>&nbsp;</div>
<div class="formfonttitle"><#299#> - <#4170#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="captive_portal_adv_intro_icon"></div>
<div style='float:left;width:80%;'>
<div class="captive_portal_adv_intro_txt" style="color:#FC0;"><#4171#></div>
<div class="captive_portal_adv_intro_txt"><#4172#></div>
<div class="captive_portal_adv_intro_txt brt_series">
<#1965#> : <a id="faq" href="" target="_blank" style="font-weight:bolder;text-decoration:underline;" href="" target="_blank">GO</a>
</div>
</div>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(31, 1);"><#4175#></a></th>
<td>
...
<span style="color:#FFCC00;">(<#4176#>: 60 - 800, <#3223#>: 300 <#3192#>)</span>
</td>
</tr>
<tr id="tr_event_log">
<th><#4174#></th>
<td>
<input class='button_gen' onclick='show_event_log();' type='button' value='<#2691#>'/>
</td>
</tr>
</table>
...
<span class='captive_portal_adv_add_title' onclick="editProfile('new')"><#3806#></span>
</div>
<table width="100%" align="center" cellpadding="4" cellspacing="0" class="FormTable_table">
<thead>
<tr>
<td id="td_profile_table_title" colspan="5"><#4177#> &nbsp;(<#2690#>&nbsp;1)</td>
</tr>
</thead>
<tr>
<th width="30%"><#4224#></th>
...
<input class='button_gen' onclick='cpa_apply();' type='button' value='<#209#>'/>
</div>
</td>
</tr>
</tbody>
