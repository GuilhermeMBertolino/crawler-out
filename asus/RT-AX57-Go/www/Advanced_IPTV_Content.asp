...
document.getElementById("iptv_configure_status").innerHTML = "<#870#>";
else
...
document.getElementById("voip_configure_status").innerHTML = "<#870#>";
else
...
alert_msg = hint_str1.replace("%1$@", "<#2861#>").replace("%2$@", "IPTV") + " " + hint_str2;
}
alert(alert_msg);
return true;
}
...
var msg = "<#3879#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
if(confirm(msg)){
...
msg = hint_str.replace("%1$@", port_list).replace("%2$@", "IPTV").replace("%3$@", "<#2861#>");
if(confirm(msg)){
document.form.lacp_enabled.disabled = false;
document.form.lacp_enabled.value = "0";
}
...
if(val == "12")
document.getElementById("gaming_note").innerHTML = "<#3134#>";
else if(val == "56")
document.getElementById("gaming_note").innerHTML = "<#3135#>";
...
if(improxy_support){
add_option(select, "<#3990#> IGMP", "1", 0);
add_option(select, "<#3990#> IGMP & MLD", "3", 0);
}
else
add_option(select, "<#3990#>", "1", 0);
select.value = val;
if(select.selectedIndex < 0)
select.selectedIndex = 0;
...
<option value="" <% nvram_match("wan_auth_x_now", "", "selected"); %>><#873#></option>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd_now);"><#639#></div>
</td>
</tr>
...
<input class="button_gen" type="button" onclick="save_connection_settings();" value="<#1702#>">
</div>
</div>
...
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#2581#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#2582#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#3133#></a></th>
<td>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#747#></a></th>
<td>
...
<th width="30%"><#1901#></th>
<td align="left">
<span style="color:#FFFFFF;"><#1904#></span>
<select id="wans_lanport1" name="wans_lanport1" class="input_option" style="margin-left:7px;"></select>
<div style="margin-top:2px;"><span style="color:#FFFFFF;">( <#1902#> : </span><span id="cur_primary" style="color:#FFFFFF;"></span><span style="color:#FFFFFF;"> )</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#3991#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#3141#></a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option" onChange="change_mr_enable(this.value);">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#3991#></option>
<!-- <option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#3990#></option> -->
</select>
<span id="mr_hint" style="display:none;">( <#3142#> )</span>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#3991#></span>
<span style="margin-left: 5px;"><#3143#></span>
</div>
</td>
</tr>
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,14);"><#3152#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,15);"><#3153#></a></th>
<td>
...
<option value="0" <% nvram_match("mr_qleave_x", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("mr_qleave_x", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#3155#></a></th>
<td>
