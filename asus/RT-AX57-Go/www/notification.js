...
var port_mismatch_notice = "<#2513#>";
var port_mismatch_list = "<#2514#>";
if(wan_proto=="v6plus"){
port_confirm = port_confirm.replace("%0$@", "<#2511#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2511#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2511#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2511#>");
}
if(wan_proto=="ocnvc"){
port_confirm = port_confirm.replace("%0$@", "<#2510#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2510#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2510#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2510#>");
}
...
switch(key) {
case "pf" :
items += "<li><a href='/Advanced_VirtualServer_Content.asp' style='text-decoration:underline;cursor:pointer;'><#417#></a></li>";
break;
case "open_nat" :
items += "<li><a href='/GameProfile.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OPEN NAT</a></li>";
break;
case "pt" :
items += "<li><a href='/Advanced_PortTrigger_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#416#></a></li>";
break;
case "https" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#2142#></a></li>";
break;
case "ssh" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#3008#></a></li>";
break;
case "openvpn" :
items += "<li><a href='/Advanced_VPNServer_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OpenVPN</a></li>";
break;
case "ftp" :
items += "<li><a href='/Advanced_NATPassThrough_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#447#> - <#2172#></a></li>";
break;
case "ipsec" :
...
items += "<li><a href='/Advanced_Instant_Guard.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#4373#></a></li>";
}
break;
default :
break;
...
notification.desc[12] = "<#2766#>";
notification.action_desc[12] = "<#1445#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1438#>';
notification.action_desc[0] = '<#1445#>';
...
notification.desc[1] = '<#1439#>';
notification.action_desc[1] = '<#1446#>';
...
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1446#></a>';
...
notification.desc[2] = '<#1440#>';
notification.action_desc[2] = '<#1445#> (2.4GHz)';
...
notification.desc[3] = '<#1440#>';
if(band5g2_support)
notification.action_desc[3] = '<#1445#> (5GHz-1)';
else
notification.action_desc[3] = '<#1445#> (5GHz)';
...
notification.desc[19] = '<#1440#>';
notification.action_desc[19] = '<#1445#> (5GHz-2)';
...
notification.ftp = 1;
notification.desc[4] = '<#1442#>';
notification.action_desc[4] = '<#847#>';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1441#>';
notification.action_desc[4] = '<#1445#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.desc[5] = '<#1444#>';
notification.action_desc[5] = '<#847#>';
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1443#>';
notification.action_desc[5] = '<#1445#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[18] = '<#212#>';
...
notification.action_desc[8] = "<#1702#>";
...
notification.desc[16] = '<#303#><#304#><#305#><#306#>';
...
notification.desc[17] = 'IP?<br>ISP';
notification.action_desc[17] = 'IP(PPPoE)';
...
notification.desc[15] = '<#4144#>';
notification.action_desc[15] = '<#4145#>';
