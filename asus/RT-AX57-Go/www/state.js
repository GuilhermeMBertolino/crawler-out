if(parent.businessWrapper) document.write('<link rel="stylesheet" type="text/css" href="/css/business-white.css"></link>');
...
if(isSupport("BUSINESS") && !parent.businessWrapper){
...
location.href = "/index.html?url=settings&current_theme=business";
}
}
...
var band6g_support =(isSupport('wifi7') || isSupport('wifi6e')) ? true : false;
...
var dualWAN_support = (wlc_band != "") ? false : isSupport("dualwan");
...
var stopFlag = parent.businessWrapper ? 0 : 0;
...
var dualwan_enabled = (isSupport("dualwan") && wans_dualwan_orig.search("none") == -1) ? 1 : 0;
...
var Guest_Network_naming = ((isSupport("mtlancfg")) ? ((isSupport("BUSINESS")) ? "<#2327#>" : "Guest Network Pro") : "<#299#>"); // Untranslated
...
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top" style="margin:7px 0 0 5px;"><#868#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:20px 0 0 10px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#781#></div></div></a>\n';
}
else{
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#868#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:20px 0 0 15px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#781#></div></div></a>\n';
}
}
else if(tuf_support){
if(CoBrand == "8")
...
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#868#></span></div>';
banner_code +='<div style="position: absolute;margin-left: 720px;"><a href="javascript:logout();"><div style="margin:20px 0 0 0;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 0;"><#781#></div></div></a></div>\n';
}
...
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:125px; *width:136px;" class="titlebtn" align="center"><span><#781#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#192#></span></div></a>\n';
}
else{
banner_code +='<div class="banner1" align="center"><img src="images/New_ui/asustitle.png" width="218" height="54" align="left">\n';
banner_code +='<div style="margin-top:13px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#868#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:25px; *width:136px;" class="titlebtn" align="center"><span><#781#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#192#></span></div></a>\n';
}
...
banner_code += '<div style="font-size: 14px;margin-left:12px;"><#4386#></div>';
...
banner_code += '<div style="padding: 2px 8px;margin: 0 0 2px 230px;width:735px;display:flex;justify-content:space-between;" class="radio_hint top_banner_hint">';
banner_code += '<div style="background-image: url(\'images/New_ui/exclamationmark.svg\');width:16px;height:16px;background-size: 100%;background-repeat:no-repeat;cursor: pointer"></div>';
banner_code += '<div style="font-size: 14px;margin-left:12px;"><#2963#></div>';
...
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#433#>:</span><span class="title_link" style="text-decoration: none;" id="op_link"><a href="/Advanced_OperationMode_Content.asp" style="color:white"><span id="sw_mode_span" style="text-decoration: underline;"></span></a></span>\n';
}
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#294#></span><a href="/Advanced_FirmwareUpgrade_Content.asp" style="color:white;"><span id="firmver" class="title_link"></span></a>\n';
...
banner_code +='<div style="padding:5px 0 5px 15px;font-size:14px;color:#BDBDBD"><#1435#></div>';
banner_code +='</div>';
banner_code +='</div>';
...
banner_code += "<#2766#>";
banner_code +='</div>';
banner_code +="<span><input style=\"margin-left:30px;\" type=\"checkbox\" name=\"stop_show_chk\" id=\"stop_show_chk\"><#2820#></input></span>";
...
if(parent.businessWrapper) setTimeout(parent.setupBusinessUI, 100)
});
}
require(['/require/modules/menuTree.js'], function(menuTree){
menuList = menuTree.list;
...
Session.set("menuList", menuList);
Session.set("menuExclude", menuExclude);
if(!parent.businessWrapper) showMenuTree(menuList, menuExclude);
});
if(nt_center_support){
...
if(parent.businessWrapper) parent.setupBusinessUI();
}
...
var menu_code = parent.businessWrapper ? '<div>' : '<div style="margin-top:-172px">';
...
if(!(menuList[clickedItem.menu].index == "menu_APP" && curTab.url.indexOf("Advanced_Modem_Content") == 0) && menuExclude.tabs.indexOf(curTab.url) !== -1) continue;
...
var tableHeight = parent.businessWrapper ? 0 : getTableHeight();
...
footer_code +='<div align="center" class="copyright"><#292#></div><br>';
...
footer_code += '<td width="20" align="right"><div id="bottom_help_icon" style="margin-right:3px;"></div></td><td width="110" id="bottom_help_title" align="left"><#2334#> & <#3345#></td>';
var genlink = "https://nw-dlcdnet.asus.com/support/forward.html?model="+support_site_modelid+"&type=Manual&lang="+href_lang+"&kw=&num=";
footer_code += "<td width=\"335\" id=\"bottom_help_link\" align=\"left\"><a target=\"_blank\" rel=\"noreferrer\" href=\""+ genlink +"\" style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\"><#2706#></a>";
footer_code += "&nbsp|&nbsp<a id=\"registration_link\" target=\"_blank\" rel=\"noreferrer\" href=\""+ href_reg_url +"\" target=\"_self\" style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\"><#3079#></a>";
if(dsl_support && frs_feedback_support){
footer_code += '&nbsp|&nbsp<a id="fb_link" href="/Advanced_Feedback.asp" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2728#></a>';
}
...
footer_code += '&nbsp|&nbsp<a id="fb_link" href="'+location_href+'" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2728#></a>';
}
footer_code += '</td>';
...
if(parent.businessWrapper) return false;
if(isiOS){
var obj_inputBtn;
/* language options */
...
document.getElementById("sw_mode_span").innerHTML = "Public WiFi Mode (WISP)";
else
document.getElementById("sw_mode_span").innerHTML = "<#872#>";
}
else if(sw_mode == "2"){
if(wlc_express == 1)
document.getElementById("sw_mode_span").innerHTML = "<#482#>";
else if(wlc_express == 2)
document.getElementById("sw_mode_span").innerHTML = "<#484#>";
else
document.getElementById("sw_mode_span").innerHTML = "<#480#>";
}
else if(sw_mode == "3")
document.getElementById("sw_mode_span").innerHTML = "<#459#>";
else if(sw_mode == "4")
document.getElementById("sw_mode_span").innerHTML = "<#467#>";
else
...
code +='<td><span id="proceeding_main_txt"><#392#></span><span id="proceeding_txt" style="color:#FFFFCC;"></span></td>\n';
code +='</tr>\n';
code +='</table>\n';
...
document.getElementById('selected_lang').innerHTML = "<#894#>";
}
...
this.link = "/" + QISWIZARD + "?flag=wispMode";
}
else{
if(dualwan_enabled)
this.link = "gotoWAN";
...
this.hint = "<#828#>";
this.link = "/QIS_wizard.htm?flag=wispMode";
}
this.className = "_disconnected";
}
...
if(!(isSupport("wisp") && isSwMode("rt") && wlc_band != ""))
...
if(typeof wlc_band != undefined && wlc_band != "" && document.querySelector("#speed_status") != null){
var targetBand = wl_nband_array[wlc_band]
if(targetBand == 2) {
...
if(document.getElementById("NM_connect_status")){
document.getElementById("NM_connect_status").innerHTML = "<#202#>";
...
if(document.getElementById("NM_connect_status")){
document.getElementById("NM_connect_status").innerHTML = "<#233#>";
...
code += '<div style="margin: 24px 0;"><#4387#></div>';
var _str = '<#4388#>';
var _str1 = '<#4389#>';
var _temp = _str.replace('%1$@', 'WiFi radio').replace('%2$@', _str1);
code += '<div style="margin: 24px 0;">'+ _temp +'</div>';
code += '<div style="margin: 32px 0;"><input id="radio_hint_checkbox" type="checkbox"><#4390#></div>';
code += '<div style="display:flex;justify-content:flex-end;margin:28px 0;">';
code += '<div id="cancelBtn" class="button-container button-container-sm" style="margin: 0 12px;" onclick="radio_disagree();"><div class="button-icon icon-cancel"></div><div class="button-text"><#212#></div></div>';
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;" onclick="radio_agree();"><div class="button-icon button-icon-check"></div><div class="button-text"><#4389#></div></div>';
code += '</div></div>';
obj.html(code);
}
...
code += '<div style="font-size: 16px;font-weight: bold;margin: 12px 0;"><#2963#></div>';
code += '<div style="margin: 18px 0;"><#2964#></div>';
code += '<div style="margin: 18px 0;"><#2965#></div>';
if(_flag == "1")
code += '<div style="margin: 18px 0;"><input id="radio_hint_checkbox" type="checkbox"><#4390#></div>';
code += '<div style="display:flex;justify-content:flex-end;margin-top:28px;">';
code += '<div id="cancelBtn" class="button-container button-container-sm" style="margin: 0 12px;"><div class="button-icon icon-cancel"></div><div class="button-text"><#212#></div></div>';
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;"><div class="button-icon button-icon-check"></div><div class="button-text"><#1548#></div></div>';
code += '</div></div>';
obj.html(code);
...
if(odmpid === 'GT6'){
[wlObj[0], wlObj[1], wlObj[2]] = [wlObj[2], wlObj[0], wlObj[1]];
}
}
...
if(odmpid === 'GT6'){
[wlObj[0], wlObj[1]] = [wlObj[1], wlObj[0]];
}
}
}
...
else if(applyParam.smartConnect && odmpid === 'GT6'){
[wlObj[0], wlObj[1], wlObj[2]] = [wlObj[2], wlObj[0], wlObj[1]];
}
return wlObj;
})();
...
wlHintCss += ((top.businessWrapper) ? "background:url(/images/New_ui/login_bg.png) #f5f5f5 no-repeat;" : "background:url(/images/New_ui/login_bg.png) #283437 no-repeat;");
wlHintCss += ((top.businessWrapper) ? "background-size: cover;" : "background-size: 1280px 1076px;");
...
wlHintCss += ((top.businessWrapper) ? "color:#000;" : "color:#fff;");
wlHintCss += "margin-top: 10px;";
wlHintCss += "}.nologin{";
wlHintCss += "word-break: break-all;";
wlHintCss += "margin:10px 0px 0px 78px;";
wlHintCss += ((top.businessWrapper) ? "background-color:rgba(255,255,255,0.4);" : "background-color:rgba(255,255,255,0.2);");
...
wlHintCss += ((top.businessWrapper) ? "color:#181818;" : "color:#93d2d9;");
wlHintCss += "}.img_gap{";
...
wlHintHtml += '<div class="prod_madelName"><div class="title_name"><div class="div_td img_gap"><div class="login_img"></div></div><div class="div_td"><#868#></div></div></div>';
wlHintHtml += '<div id="login_filed">';
wlHintHtml += "<div class='p1 title_gap'><#234#></div>";
