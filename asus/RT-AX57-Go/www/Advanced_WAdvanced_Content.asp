...
country_array = [];
var country_selection_list = [["AA", "<#1664#>"], ["CN", "<#1666#>"], ["SG", "<#1670#>"], ["EU", "<#1667#>"], ["KR", "<#1668#>"], ["RU", "<#1669#>"], ["US", "<#1671#>"], ["AU", "<#1665#>"], ["XX", "<#1665#>"]];
...
country_selection_list.push(["GD", "<#1666#>"]);
}
if(EG_mode){
...
document.getElementById('wl_txbf_desc').innerHTML = "<#3994#>";
}
else{
document.getElementById('wl_txbf_desc').innerHTML = "<#3995#>";
}
}
else
{
...
if (based_modelid == "TUF-AX4200" || based_modelid == "TUF-AX6000" || based_modelid == "RT-AX59U" || based_modelid == "RT-AX52" || based_modelid == "PRT-AX57_GO") {
inputCtrl(document.form.wl_itxbf, 1);
}
if (MUMIMO5G_support) {
document.getElementById("wl_MU_MIMO_field").style.display = "";
...
document.getElementById('wl_txbf_desc').innerHTML = "<#4029#>";
inputCtrl(document.form.wl_txbf, 1);
inputCtrl(document.form.wl_itxbf, 1);
}
}
...
else if ((based_modelid == 'RT-AX92U' || based_modelid == 'RT-AX95Q' || based_modelid == 'XT8PRO' || based_modelid == 'BT12' || based_modelid == 'BQ16' || based_modelid == 'BM68' || based_modelid == 'XT8_V2' || based_modelid == 'RT-AXE95Q' || based_modelid == 'ET8PRO' || based_modelid == 'ET8_V2' || based_modelid == 'RT-AX56_XD4' || based_modelid == 'XD4PRO' || based_modelid == 'CT-AX56_XD4' || based_modelid == 'RT-AX56U' || based_modelid == "RP-AX56" || based_modelid == "RP-AX58" || based_modelid == 'XC5' || based_modelid == "EBA63") && (wl_unit_value == '0' || wl_unit_value == '1')){
document.getElementById("wl_MU_MIMO_field").style.display = "none";
document.form.wl_mumimo.disabled = true;
}
...
var value = ['0', '1', '3'];
var desc = ['<#3991#>', 'DL OFDMA only', 'DL OFDMA + MU-MIMO'];
add_options_x2(document.form.wl_ofdma, desc, value, document.form.wl_ofdma.value);
}
else if(Rawifi_support){
var value = ['0', '1', '4', '2','3'];
var desc = ['<#3991#>', 'DL OFDMA only', 'DL OFDMA + MU-MIMO', 'DL/UL OFDMA', 'DL/UL OFDMA + MU-MIMO'];
...
var name = country ? country.name : '<#4072#> ' + index;
if(tcode == index){
matched = true;
name += ' (<#3223#>)';
}
...
if(!matched){
code += '<option value='+ tcode +' ><#3223#></option>';
}
code += '</select>';
...
document.getElementById('wl_txPower_field_title').innerHTML = "<#3975#>&nbsp;&nbsp;&nbsp;&nbsp;<20dBm";
document.getElementById('tx_power_desc_EG').innerHTML = "<20dBm";
}
else{
document.getElementById('wl_txPower_field_title').innerHTML = "<#3975#>&nbsp;&nbsp;&nbsp;<23dBm";
...
power_table_desc = ["<#3976#>", "<#3977#>", "<#3978#>", "<#3979#>", "<#3980#>"];
...
var confirm_txt = "<#3970#>";
if(wl_unit_value == '1' || wl_unit_value == '2'){ // 5GHz up
if(band5g_11ax_support){
if(based_modelid == 'RT-AX92U'){
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3994#>");
}
else{
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3995#>");
}
}
else{
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3994#>");
...
confirm_txt = confirm_txt.replace("$Beamforming$", "<#4029#>");
}
...
var confirm_text = "<#1153#> <#1154#> <#1155#>\n<#3218#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#403#> - <#409#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="title_bg">
<div id="titl_desc" class="formfontdesc"><#3953#></div>
<div id="lantiq_ready" style="display:none;color:#FC0;margin-left:5px;font-size:13px;">Wireless is setting...</div>
<div id="svc_hint_div" style="display:none;margin-left:5px;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" style="color:#FFCC00;text-decoration:underline;cursor:pointer;"><#297#></span></div>
...
<tr id="wl_rf_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 1);"><#4065#></a></th>
<td>
<input type="radio" value="1" name="wl_radio" class="input" onClick="control_TimeField();" <% nvram_match("wl_radio", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="wl_radio" class="input" onClick="control_TimeField();" <% nvram_match("wl_radio", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="wl_sched_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 23);"><#4080#></a></th>
<td>
<input type="radio" value="1" name="wl_timesched" class="input" onClick="control_TimeField();return change_common_radio(this, 'WLANConfig11b', 'wl_timesched', '1');" <% nvram_match("wl_timesched", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="wl_timesched" class="input" onClick="control_TimeField();return change_common_radio(this, 'WLANConfig11b', 'wl_timesched', '0')" <% nvram_match("wl_timesched", "0", "checked"); %>><#199#>
<span id="time_setting" style="padding-left:20px;cursor:pointer;text-decoration:underline" onclick="show_wifi_schedule();"><#3399#></span>
</td>
</tr>
<tr id="wl_ap_isolate_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 5);"><#4041#></a></th>
<td>
<input type="radio" value="1" name="wl_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_ap_isolate', '1')" <% nvram_match("wl_ap_isolate", "1", "checked"); %>><#200#>
<input type="radio" value="0" name="wl_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_ap_isolate', '0')" <% nvram_match("wl_ap_isolate", "0", "checked"); %>><#199#>
</td>
</tr>
<tr id="rssiTr" class="rept ew">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 31);"><#3118#></a></th>
<td>
<select id="wl_user_rssi_option" class="input_option" onchange="changeRSSI(this.value);">
<option value="1"><#3990#></option>
<option value="0" <% nvram_match("wl_user_rssi", "0","selected"); %>><#3991#></option>
</select>
<span id="rssiDbm" style="color:#FFF">
<#3119#>
<input type="text" maxlength="3" name="wl_user_rssi" class="short_input input_3_table" value="<% nvram_get("wl_user_rssi"); %>" autocorrect="off" autocapitalize="off">
dBm
</span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,34);"><#4014#></a></th>
<td>
<select name="wl_btc_mode" class="input_option">
<option value="0" <% nvram_match("wl_btc_mode", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_btc_mode", "1","selected"); %> ><#3990#></option>
<option value="2" <% nvram_match("wl_btc_mode", "2","selected"); %> ><#4016#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 22);"><#4037#></a></th>
<td>
<select name="wl_igs" class="input_option">
<option value="1" <% nvram_match("wl_igs", "1","selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wl_igs", "0","selected"); %>><#3991#></option>
</select>
</td>
</tr>
<tr id="wl_mrate_select">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 7);"><#3968#></a></th>
<td>
<select name="wl_mrate_x" class="input_option">
<option value="0" <% nvram_match("wl_mrate_x", "0", "selected"); %>><#166#></option>
</select>
</td>
</tr>
<tr id="wl_plcphdr_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,20);"><#4106#></a></th>
<td>
<select name="wl_plcphdr" class="input_option">
<option value="long" <% nvram_match("wl_plcphdr", "long", "selected"); %>><#4107#></option>
<option value="short" <% nvram_match("wl_plcphdr", "short", "selected"); %>><#4108#></option>
<!-- auto mode applicable for STA only
<option value="auto" <% nvram_match("wl_plcphdr", "auto", "selected"); %>><#166#></option>
-->
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 9);"><#4032#></a></th>
<td>
...
<option value="1" <% nvram_match("wl_ampdu_rts", "1", "selected"); %>><#3990#></option>
<option value="0" <% nvram_match("wl_ampdu_rts", "0", "selected"); %>><#3991#></option>
</select>
</td>
</tr>
<tr id="rts_threshold">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 10);"><#4078#></a></th>
<td>
...
<tr id="wl_dtim_field">
<th><a class="hintstyle" id="wl_dtim_th"><#4025#></a></th>
<td>
...
<tr id="wl_bcn_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 12);"><#4011#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 13);"><#4085#></a></th>
<td>
<select name="wl_frameburst" class="input_option">
<option value="off" <% nvram_match("wl_frameburst", "off","selected"); %>><#3991#></option>
<option value="on" <% nvram_match("wl_frameburst", "on","selected"); %>><#3990#></option>
</select>
</td>
</tr>
<tr id="PktAggregate"><th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 16);"><#4061#></a></th>
<td>
<select name="wl_PktAggregate" class="input_option">
<option value="0" <% nvram_match("wl_PktAggregate", "0","selected"); %>><#3991#></option>
<option value="1" <% nvram_match("wl_PktAggregate", "1","selected"); %>><#3990#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 14);"><#4088#></a></th>
<td>
<select name="wl_wme" id="wl_wme" class="input_option" onChange="enable_wme_check(this);">
<option value="auto" <% nvram_match("wl_wme", "auto", "selected"); %>><#166#></option>
<option value="on" <% nvram_match("wl_wme", "on", "selected"); %>><#3990#></option>
<option value="off" <% nvram_match("wl_wme", "off", "selected"); %>><#3991#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,15);"><#4057#></a></th>
<td>
<select name="wl_wme_no_ack" id="wl_wme_no_ack" class="input_option">
<option value="off" <% nvram_match("wl_wme_no_ack", "off","selected"); %>><#3991#></option>
<option value="on" <% nvram_match("wl_wme_no_ack", "on","selected"); %>><#3990#></option>
</select>
</td>
</tr>
<tr id="wl_wme_apsd_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,17);"><#4006#></a></th>
<td>
<select name="wl_wme_apsd" class="input_option">
<option value="off" <% nvram_match("wl_wme_apsd", "off","selected"); %> ><#3991#></option>
<option value="on" <% nvram_match("wl_wme_apsd", "on","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr id="DLSCapable" class="rept"> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,18);"><#4022#></a></th>
<td>
<select name="wl_DLSCapable" class="input_option">
<option value="0" <% nvram_match("wl_DLSCapable", "0","selected"); %>><#3991#></option>
<option value="1" <% nvram_match("wl_DLSCapable", "1","selected"); %>><#3990#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,21);"><#4028#></a></th>
<td>
<select name="wl_noisemitigation" class="input_option" onChange="">
<option value="0" <% nvram_match("wl_noisemitigation", "0","selected"); %>><#3991#></option>
<option value="1" <% nvram_match("wl_noisemitigation", "1","selected"); %>><#3990#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);"><#4081#></a></th>
<td>
<select name="traffic_5g" class="input_option">
<option value="1" <% nvram_match("traffic_5g", "1","selected"); %>><#3990#></option>
<option value="0" <% nvram_match("traffic_5g", "0","selected"); %>><#3991#></option>
</select>
</td>
</tr>
<tr id="wl_ampdu_mpdu_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,26);"><#3998#></a></th>
<td>
<select name="wl_ampdu_mpdu" class="input_option">
<option value="0" <% nvram_match("wl_ampdu_mpdu", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_ampdu_mpdu", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr id="wl_ack_ratio_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,27);"><#3996#></a></th>
<td>
<select name="wl_ack_ratio" class="input_option">
<option value="0" <% nvram_match("wl_ack_ratio", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_ack_ratio", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("mlr_enable", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("mlr_enable", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr>
<th id="turbo_qam_title"><a id="turbo_qam_hint" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,28);"><#4082#></a></th>
<td>
<select name="wl_turbo_qam" class="input_option">
<option value="0" <% nvram_match("wl_turbo_qam", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_turbo_qam", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr>
...
<option value="0" <% nvram_match("wl_turbo_qam_brcm_intop", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_turbo_qam_brcm_intop", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr id="wl_80211h_tr" style="display:none;">
<th><a class="hintstyle"><#3993#></a></th>
<td>
<select name="wl1_80211h" class="input_option">
<option value="0" <% nvram_match("wl1_80211h", "0","selected"); %>><#3991#></option>
<option value="1" <% nvram_match("wl1_80211h", "1","selected"); %>><#3990#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,32);"><#4007#></a></th>
<td>
<select name="wl_atf" class="input_option">
<option value="0" <% nvram_match("wl_atf", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_atf", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr id="wl_MU_MIMO_field" style="display:none">
<th><a class="hintstyle"><#3969#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_mumimo" class="input_option" onchange="handle_mimo(this.value)" disabled>
<option value="0" <% nvram_match("wl_mumimo", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_mumimo", "1","selected"); %> ><#3990#></option>
</select>
</div>
</td>
</tr>
<tr id="ofdma_field" style="display:none">
<th><a class="hintstyle"><#2926#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_ofdma" class="input_option">
<option value="0" <% nvram_match("wl_ofdma", "0","selected"); %>><#3991#></option>
...
<tr id="wl_txbf_field">
<th><a id="wl_txbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,24);"><#4029#></a></th>
<td>
<select name="wl_txbf" class="input_option" onchange="handle_beamforming(this.value)">
<option value="0" <% nvram_match("wl_txbf", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_txbf", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr id="wl_itxbf_field">
<th><a id="wl_itxbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,25);"><#4086#></a></th>
<td>
<select name="wl_itxbf" class="input_option" disabled>
<option value="0" <% nvram_match("wl_itxbf", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_itxbf", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("wl_ext_nss", "0","selected"); %>><#3991#></option>
<option value="2" <% nvram_match("wl_ext_nss", "2","selected"); %>>4x4@80MHz</option>
<option value="1" <% nvram_match("wl_ext_nss", "1","selected"); %>><#3990#></option>
</select>
</td>
</tr>
<tr id="wl_txPower_field">
<th><a id="wl_txPower_field_title" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 16);"><#3975#></a></th>
<td>
<div>
<table>
<tr>
...
<option value="0" <% nvram_match("wl_precacen", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_precacen", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr>
...
<option value="0" <% nvram_match("wl_hwol", "0","selected"); %> ><#3991#></option>
<option value="1" <% nvram_match("wl_hwol", "1","selected"); %> ><#3990#></option>
</select>
</td>
</tr>
<tr id="region_tr" style="display:none" class="rept ew">
<th><a class="hintstyle"><#4072#></a></th>
