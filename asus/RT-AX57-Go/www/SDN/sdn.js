...
var str_SDN_choose = stringSafeGet("<#2325#>");
var str_WiFi_sche = stringSafeGet("<#2329#>");
var str_Scheduled = stringSafeGet("<#3397#>");
var str_Scheduled_one_time = stringSafeGet("<#3398#>");
var str_noProfile_hint = stringSafeGet("<#2321#>");
var str_GuestNetwork_WiFi_Sche_desc = stringSafeGet("<#2330#>");
var str_Scenario_Classroom = stringSafeGet("<#3178#>");
var str_Scenario_coffee = stringSafeGet("<#3179#>");
var str_Scenario_Study = stringSafeGet("<#3185#>");
var str_Scenario_EV_charging = stringSafeGet("<#3180#>");
var str_Scenario_smartHome = stringSafeGet("<#3186#>");
var str_Scenario_branchOffice = stringSafeGet("<#3177#>");
var str_Scenario_Hotel = stringSafeGet("<#3182#>");
var str_Scenario_Mall = stringSafeGet("<#3183#>");
var str_Scenario_Friends = stringSafeGet("<#3181#>");
var str_GuestNetwork_Portal_desc2 = stringSafeGet("<#2311#>");
var str_GuestNetwork_Wizard_type_desc0 = stringSafeGet("<#2332#>");
var str_GuestNetwork_Employee_recommend = stringSafeGet("<#2302#>");
...
cp_text_map.push({"id":"1", "text":"<#4170#> WiFi"});
...
{"type":"Employee", "text":"<#2300#>", "desc":"<#2301#>"},
{"type":"Portal", "text":"<#2309#>", "desc":"<#2311#>"},
{"type":"Guest", "text":"<#299#>", "desc":"<#2293#>."},
{"type":"Kids", "text":"<#2307#>", "desc":"<#2308#>"},
{"type":"IoT", "text":"<#2304#>", "desc":"<#2305#>"},
{"type":"VPN", "text":"<#2314#>", "desc":"<#2315#>"},
{"type":"Customized", "text":"<#2299#>", "desc":""},
];
if(isSupport("BUSINESS")){
...
specific_wizard_type.text = "<#2324#>";
...
show_customize_alert("<#4349#>".replace("#MAXNUM", sdn_maximum));
return false;
}
selected_sdn_idx = "";
...
$("<div>").addClass("main_info").html("<#2322#>").appendTo($item_text_container);
...
$("<div>").addClass("item_tag VPN").html("<#3809#>").appendTo($item_tag_cntr);
}
...
.attr({"title":"<#585#>: " + _profile_data.name})
...
$("<div>").addClass("clients_num").attr({"title":"<#2923#>"}).html(htmlEnDeCode.htmlEncode(_profile_data.client_num)).appendTo($sub_info);/* untranslated */
...
show_customize_alert("<#3785#>".replace(/VPN/g, "<#2313#>").replace(/2/g, "1"));
return;
}
...
conn_type = [{"type": "LAN", "text": "<#3424#>"}];
return conn_type;
}
if(_sdn_data.sdn_rl.wifi_sched_on == "0"){
conn_type = [{"type": "WiFi_offline", "text": "<#3425#> (<#1576#>)"}];
return conn_type;
}
...
case "1":
conn_type = [{"type": ((cap_wifi_auth == "lock") ? "WiFi_2G_lock": "WiFi_2G") , "text": "2.4 GHz <#3425#>"}];
break;
case "2":
conn_type = [{"type": ((cap_wifi_auth == "lock") ? "WiFi_5G_lock": "WiFi_5G") , "text": "5 GHz <#3425#>"}];
break;
case "3":
conn_type = [
{"type": ((cap_wifi_auth == "lock") ? "WiFi_5G_lock": "WiFi_5G") , "text": "5 GHz <#3425#>"},
{"type": ((cap_wifi_auth == "lock") ? "WiFi_2G_lock": "WiFi_2G") , "text": "2.4 GHz <#3425#>"}
];
break;
}
return conn_type;
...
var $item_text_container = $("<div>").addClass("item_text_container");
$item_text_container.appendTo($profile_item_container);
$("<div>").addClass("main_info").html("<#2299#>").appendTo($item_text_container);
var $item_action_container = $("<div>").addClass("item_action_container");
$item_action_container.appendTo($profile_item_container);
$("<div>").addClass("icon_add").appendTo($item_action_container);
return $profile_item_container;
...
var $item_text_container = $("<div>").addClass("item_text_container");
$item_text_container.appendTo($profile_item_container);
$("<div>").addClass("main_info").html("<#2328#>").appendTo($item_text_container);
var $item_action_container = $("<div>").addClass("item_action_container");
$item_action_container.appendTo($profile_item_container);
$("<div>").addClass("icon_add").appendTo($item_action_container);
return $profile_item_container;
...
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2328#>").addClass("Scenarios").appendTo($container)
...
$("<div>").html(htmlEnDeCode.htmlEncode("<#1547#>")).appendTo($title);
var $item_scenarios_cntr = $("<div>").addClass("item_scenarios_container").appendTo($content_container);
$("<div>").addClass("title").html("<#2326#>").appendTo($item_scenarios_cntr);
...
{"type":"Employee", "title":"<#2300#>", "desc":str_GuestNetwork_Wizard_type_desc0+" "+str_GuestNetwork_Employee_recommend},
{"type":"Portal", "title":"<#2309#>", "desc":str_GuestNetwork_Portal_desc2},
{"type":"Guest", "title":"<#299#>", "desc":"<#2293#>."},
{"type":"Sched", "title":"<#2324#>", "desc":str_GuestNetwork_WiFi_Sche_desc},
{"type":"IoT", "title":"<#2304#>", "desc":"<#2305#>."}
];
...
$("<div>").addClass("btn_container apply").html("<#1702#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
$("<div>").addClass("service").html("<#638#>").appendTo($item_title_cntr);
$("<div>").addClass("server").html("<#2351#>").appendTo($item_title_cntr);
$("<div>").addClass("desc").html("<#1752#>").appendTo($item_title_cntr);
...
desc += "&nbsp;";
desc += $("<a/>").attr({"href":dns_item.url, "target":"_blank"}).css({"text-decoration":"underline"}).html("<b><#2680#></b>")[0].outerHTML;
}
...
$("<div>").addClass("service").html("<#3223#>").appendTo($default_item_title_cntr);
...
$("<div>").html(htmlEnDeCode.htmlEncode("<#1547#>")).appendTo($btn_back_cntr);
...
var $FWF_change_bg = $("<div>").addClass("FWF_change_bg").attr({"title":"<#4191#>"}).appendTo($FWF_bg);
...
$("<div>").attr({"data-component":"FWF_brand_name"}).addClass("brand_name").html("<#4224#>").appendTo($FWF_text_info_cntr);
...
$("<div>").addClass("cb_text").html("<#4263#>").appendTo($cb_text_container);
...
$("<div>").addClass("btn_container").html("<#4264#>").appendTo($("<div>").addClass("action_container").appendTo($action_info_cntr))
return $container;
}
...
var $MB_change_bg = $("<div>").addClass("MB_change_bg").attr({"title":"<#4191#>"}).appendTo($MB_bg);
...
$("<div>").attr({"data-component":"MB_desc"}).addClass("MB_desc").html("<#1752#>").appendTo($MB_text_info_cntr);
var $action_info_cntr = $("<div>").addClass("action_info_cntr").appendTo($MB_portal_cntr);
$("<div>").addClass("btn_container").html("<#4264#>").appendTo($("<div>").addClass("action_container").appendTo($action_info_cntr))
return $container;
}
function Get_Upload_Image_Container(_callback){
var $bg_upload_image = $("<div>").addClass("bg_upload_image").attr({"title":"<#4257#>"});
...
{"type":"Employee", "title":"<#2300#>", "desc":str_GuestNetwork_Wizard_type_desc0+" "+str_GuestNetwork_Employee_recommend},
{"type":"Portal", "title":"<#2309#>", "desc":str_GuestNetwork_Portal_desc2+" "+stringSafeGet("<#2312#>")},
{"type":"Guest", "title":"<#299#>", "desc":"<#2293#> "+stringSafeGet("<#2294#>")},
{"type":"Kids", "title":"<#2307#>", "desc":str_GuestNetwork_WiFi_Sche_desc+" "+stringSafeGet("<#2331#>")},
{
"type":"IoT","title":`<#2304#>`,
"desc":`
...
enable the "Use same subnet as main network" option. This is perfect for everyday control devices that require frequent monitoring and management.
<br>
To enhance security, disable the "Use same subnet as main network" option and establish a dedicated,
isolated network that shields your IoT devices from external threats.
`/* untranslated */
},
{"type":"VPN", "title":"<#2314#>", "desc":stringSafeGet("<#2316#>")}
];
if(isSwMode("ap")){
...
if(specific_wizard_type != undefined){
specific_wizard_type.type = "Sched";
specific_wizard_type.title = "<#2324#>";
}
}
else{
wizard_type_list = wizard_type_list.filter(function(item, index, array){
...
$("<div>").addClass("title").html("<#2903#>").appendTo($popup_title_container);
...
$("<div>").addClass("title").html("<#2905#>").appendTo($feature_desc_cntr);
$("<div>").addClass("desc").html(
stringSafeGet("<#3388#>")+" "+stringSafeGet("<#3389#>")+" "+stringSafeGet("<#3390#>")
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup")
$container.append(Get_Component_Popup_Profile_Title("<#701#>"));
...
.html(htmlEnDeCode.htmlEncode(item.cp_text + " (<#763#>)"))
}
});
...
.after($("<div>").html("<#3785#>".replace(/VPN/g, "<#2313#>").replace(/2/g, "1")).addClass("item_hint"));
}
...
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#585#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
});
var security_options = [{"text":"<#2360#>","option_id":"pwd"}, {"text":"<#408#>","option_id":"radius"}];
var security_parm = {"title":"<#745#>", "options": security_options, "container_id":"security_employee"};
...
var wifi_auth_options_parm = {"title": "<#3926#>", "id": "wifi_auth", "options": wifi_auth_options, "set_value": "psk2"};
...
var wifi_auth_radius_options_parm = {"title": "<#3926#>", "id": "wifi_auth_radius", "options": wifi_auth_radius_options, "set_value": "wpa2"};
...
var sdn_pwd_parm = {"title":"<#586#>", "type":"password", "id":"sdn_pwd", "need_check":true, "maxlength":32, "openHint":"0_7"};
...
var radius_ipaddr_parm = {"title":"<#3918#>", "type":"text", "id":"radius_ipaddr", "need_check":true, "maxlength":15, "openHint":"2_1"};
...
var radius_port_parm = {"title":"<#3922#>", "type":"text", "id":"radius_port", "need_check":true, "maxlength":5, "openHint":"2_2"};
...
var radius_key_parm = {"title":"<#3920#>", "type":"password", "id":"radius_key", "need_check":true, "maxlength":64, "openHint":"2_3"};
...
var more_config_parm = {"title":"<#2847#>", "id":"more_config", "slide_target":"more_config_cntr"};
...
var wifi_band_options = [{"text":"2.4GHz / 5GHz","value":"3"}, {"text":"2.4GHz","value":"1"}, {"text":"5GHz","value":"2"}, {"text":"<#873#>","value":"0"}];
var wifi_band_options_parm = {"title": "WiFi <#2388#>", "id": "wifi_band", "options": wifi_band_options, "set_value": "3"};
...
var aimesh_parm = {"title":"<#4368#>", "id":"wizard_aimesh", "slide_target":"wizard_aimesh_cntr"};
...
var bw_parm = {"title":"<#1462#> (Mb/s)", "container_id":"container_bw",
...
var access_intranet_parm = {"title":"<#896#>", "type":"switch", "id":"access_intranet", "openHint":"0_26"};
...
var $container = $("<div>").addClass("setting_content_container");
var profile_title = ((isSupport("BUSINESS")) ? "<#2324#>" : "<#2307#>");
if(view_mode == "popup"){
...
if(isSwMode("rt")){
if(get_cp_type_support("4")){
var portal_options = [{"text":"<#873#>", "value":"0"}];
cp_type_rl_json.forEach(function(item){
if(item.cp_idx == "2")
return;
portal_options.push({"text":item.cp_text, "value":item.cp_idx});
});
var portal_options_parm = {"title": "<#2313#>", "id": "portal_type", "options": portal_options};
...
var MB_desc_parm = {"title":"<#1752#>", "type":"text", "id":"MB_desc", "need_check":true, "maxlength":80, "set_value":"<#1752#>"};
...
"type_2":"text", "id_2":"bw_ul", "maxlength_2":12, "need_check_2":true};
Get_Component_Bandwidth_Setting(bw_parm).attr({"data-group":"wifi_settings"}).hide().appendTo($more_config_cntr);
var access_intranet_parm = {"title":"<#896#>", "type":"switch", "id":"access_intranet", "openHint":"0_26", "set_value":"off"};
Get_Component_Switch(access_intranet_parm).appendTo($more_config_cntr);
}
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
$("<div>").addClass("btn_container apply").html("<#209#>").appendTo($action_container);
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("VPN <#2878#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("VPN <#2878#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#585#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2304#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2304#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#585#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
$("<div>").attr({"id":"sdn_pwd_strength", "data-group":"wifi_settings"}).append(Get_Component_PWD_Strength_Meter()).appendTo($content_container).hide();
let use_main_subnet_parm = {"title":`Use same subnet as main network`, "type":"switch", "id":"use_main_subnet", "set_value":"on"};/* untranslated */
Get_Component_Switch(use_main_subnet_parm).appendTo($content_container);
var more_config_parm = {"title":"<#2847#>", "id":"more_config", "slide_target":"more_config_cntr"};
Get_Component_Slide_Title(more_config_parm).appendTo($content_container);
var $more_config_cntr = $("<div>").attr({"data-slide_target": "more_config_cntr"}).hide().appendTo($content_container);
var wifi_band_options = [{"text":"2.4GHz / 5GHz","value":"3"}, {"text":"2.4GHz","value":"1"}, {"text":"5GHz","value":"2"}, {"text":"<#873#>","value":"0"}];
var wifi_band_options_parm = {"title": "WiFi <#2388#>", "id": "wifi_band", "options": wifi_band_options, "set_value": "1"};
var $sel_wifi_band = Get_Component_Custom_Select(wifi_band_options_parm).appendTo($more_config_cntr).find("#select_" + wifi_band_options_parm.id + "");
$sel_wifi_band.children("div").click(function(e){
var options = $(this).attr("value");
var $profile_setting = $(this).closest(".profile_setting");
...
var security_options = [{"text":"Open System","option_id":"open"}, {"text":"<#2360#>","option_id":"pwd"}];
var security_parm = {"title":"<#745#>", "options": security_options, "container_id":"security_guest"};
Get_Component_Switch_Text(security_parm).attr({"data-group":"wifi_settings"}).appendTo($content_container)
.find(".switch_text_container > .switch_text_item")
.click(function(e){
e = e || event;
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2299#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2299#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#585#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
let use_main_subnet_parm = {"title":`Use same subnet as main network`, "type":"switch", "id":"use_main_subnet", "set_value":"off"};/* untranslated */
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2309#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2309#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#585#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
var FWF_brand_name_parm = {"title":"<#4224#>", "type":"text", "id":"FWF_brand_name", "need_check":true, "maxlength":40};
...
$("<div>").addClass("title").attr({"data-container":"profile_title"}).html("<#1847#>").appendTo($title_cntr);
...
var aimesh_parm = {"title":"<#4368#>", "id":"category_aimesh", "slide_target":"category_aimesh_cntr"};/* untranslated */
...
$("<div>").attr({"data-component":"del_btn"}).addClass("btn_container delete mobile").appendTo($action_container).html("<#1686#>");
...
var client_tab_options = [{"text":"<#1579#>","option_id":"all"}, {"text":"<#3424#>","option_id":"wired"}, {"text":"<#3425#>","option_id":"wireless"}];
var client_tab_parm = {"title":"<#1658#> : 0 <#1578#>", "options": client_tab_options, "container_id":"client_tab"};
...
$client_num.html("<#1658#> : " + sdn_clientlist_data.length + " <#1578#>");
...
Get_FWF_Change_BG_Container().hide().appendTo($FWF_ui_cntr);
var FWF_conntimeout_parm = {"title":"<#4248#> (<#2739#>)", "type":"text", "id":"FWF_conntimeout", "need_check":true, "maxlength":3, "set_value":"60", "openHint":"31_3"};
Get_Component_Input(FWF_conntimeout_parm).appendTo($freewifi_cntr)
.find("#" + FWF_conntimeout_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isNumber(this,event);
});
var FWF_redirecturl_parm = {"title":"<#4228#> (<#4232#>)", "type":"text", "id":"FWF_redirecturl", "maxlength":256};
Get_Component_Input(FWF_redirecturl_parm).appendTo($freewifi_cntr);
var FWF_passcode_enabled_parm = {"title":"<#4260#>", "type":"switch", "id":"FWF_passcode_enabled", "set_value":"off"};
...
var FWF_passcode_parm = {"title":"<#4258#>", "type":"text", "id":"FWF_passcode", "need_check":true, "maxlength":64, "container_id":"container_FWF_passcode"};
Get_Component_Input(FWF_passcode_parm).hide().appendTo($freewifi_cntr);
var parm_terms_service = terms_service_template;
var FWF_termsservice_parm = {"title":"<#4251#>", "id":"FWF_termsservice", "rows":"8", "cols":"55", "need_check":true, "maxlength":"5120", "set_value":parm_terms_service};
...
var MB_desc_parm = {"title":"<#1752#>", "type":"text", "id":"MB_desc", "need_check":true, "maxlength":80};
Get_Component_Input(MB_desc_parm).appendTo($message_board_cntr)
.find("#" + MB_desc_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
...
var $btn_container_delete_mobile = $("<div>").attr({"id":"del_btn"}).addClass("btn_container delete mobile").appendTo($action_container).html("<#1686#>");
...
$("<div>").addClass("subtab_item").attr({"subtab":"net"}).html("<#2878#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
$("<div>").addClass("subtab_item").attr({"subtab":"client"}).html("<#2174#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
$(this).closest(".Setting_SubTab_Container").find(".subtab_item").removeClass("selected");
$(this).addClass("selected");
...
var security_radius_options = [{"text":"<#2360#>","option_id":"pwd"}, {"text":"<#408#>","option_id":"radius"}];
var security_radius_parm = {"title":"<#745#>", "options": security_radius_options, "container_id":"security_employee"};
...
if(isSwMode("rt")){
var dhcp_enable_parm = {"title":"<#2575#>", "type":"switch", "id":"dhcp_enable", "openHint":"5_1"};
Get_Component_Switch(dhcp_enable_parm).appendTo($net_mode_container);
var ipaddr_parm = {"title":"<#2571#>", "type":"text", "id":"ipaddr", "need_check":true, "maxlength":15};
...
var netmask_options = [
{"text":"255.255.255.0 (253 <#2174#>)","value":"255.255.255.0"},
{"text":"255.255.255.128 (125 <#2174#>)","value":"255.255.255.128"},
{"text":"255.255.255.192 (61 <#2174#>)","value":"255.255.255.192"},
{"text":"255.255.255.224 (29 <#2174#>)","value":"255.255.255.224"},
{"text":"255.255.255.240 (13 <#2174#>)","value":"255.255.255.240"},
];
...
var vid_parm = {"title":"<#3873#>", "type":"text", "id":"vlan_id", "need_check":true, "maxlength":4};//1-4094
if(is_Web_iframe){
...
if(isSwMode("rt")){
var hide_ssid_parm = {"title":"<#4013#>", "type":"switch", "id":"hide_ssid"};
...
var ap_iso_parm = {"title":"<#4041#>", "type":"switch", "id":"ap_isolate", "openHint":"3_5"};
...
$(_obj).find("[data-container=profile_title]").html("<#1847#>");
var specific_wizard_type = wizard_type_text.filter(function(item, index, array){
...
$("<div>").addClass("title").html("<#3901#>").appendTo($popup_title_container);
...
$("<div>").addClass("qr_text").html("<#4394#>").appendTo($qrcode_cntr);
...
testResult.isError = true;
testResult.errReason = keywordArray + " <#2545#>";
return testResult;
}
}
}
...
if(!$.isNumeric(str)){
testResult.isError = true;
testResult.errReason = "<#3096#>";
return testResult;
}
if(str.split(".").length > 2 || parseFloat(str) < 0.1){
testResult.isError = true;
testResult.errReason = "<#2737#> : 0.1 Mb/s";
return testResult;
}
return testResult;
};
...
testResult.isError = true;
testResult.errReason = "<#2013#> ex. http or https ://www.asus.com";
return testResult;
}
};
...
$sdn_name.show_validate_hint("<#2543#>");
$sdn_name.focus();
return false;
}
var $sdn_pwd = $(_obj).find("#sdn_pwd");
...
$ipaddr.show_validate_hint("<#2539#>");
$ipaddr.focus();
return false;
}
var ipaddr_substr = $ipaddr.val().substr(0, $ipaddr.val().lastIndexOf("."));
...
$ipaddr.show_validate_hint("<#2539#>".replace("LAN", "WAN"));
$ipaddr.focus();
return false;
}
var specific_data = sdn_all_rl_json.filter(function(item, index, array){
...
$ipaddr.show_validate_hint("<#3670#>");
$ipaddr.focus();
return false;
}
}
...
$vlan_id.show_validate_hint("<#2543#>");
$vlan_id.focus();
return false;
}
}
...
{tag:"#RESTAURANT",text:stringSafeGet("<#3187#>")},
{tag:"#GYM",text:stringSafeGet("<#1127#>")},
{tag:"#CHILDREN",text:stringSafeGet("<#3188#>")},
{tag:"#VOICE_ASSISTANT",text:stringSafeGet("<#3189#>")},
{tag:"#SURVEILLANCE_DEVICES",text:stringSafeGet("<#3190#>")},
{tag:"#WFH",text:stringSafeGet("<#3191#>")},
{tag:"#BRANCH_OFFICE",text:stringSafeGet("<#3177#>")}
];
setTimeout(function(){
...
var node_ip_mac = node_info.mac + " | " + ( (node_info.online == "1") ? node_info.ip : "<#1576#>");
...
var hint = "* <#1153#> <#1155#>".replace("#MODELLIST", get_model_name(node_info));
...
{value:"Home",text:"<#1100#>"}, {value:"Living Room",text:"<#1101#>"}, {value:"Dining Room",text:"<#1102#>"},
{value:"Bedroom",text:"<#1103#>"}, {value:"Office",text:"<#1104#>"}, {value:"Stairwell",text:"<#1105#>"},
{value:"Hall",text:"<#1106#>"}, {value:"Kitchen",text:"<#1107#>"}, {value:"Attic",text:"<#1108#>"},
{value:"Basement",text:"<#1109#>"}, {value:"Yard",text:"<#1110#>"}, {value:"Master Bedroom",text:"<#1111#>"},
{value:"Guest Room",text:"<#1112#>"}, {value:"Kids Room",text:"<#1113#>"}, {value:"Study Room",text:"<#1114#>"},
{value:"Hallway",text:"<#1115#>"}, {value:"Walk-in Closet",text:"<#1116#>"}, {value:"Bathroom",text:"<#1117#>"},
{value:"First Floor",text:"<#1125#>"}, {value:"Second Floor",text:"<#1118#>"}, {value:"Third Floor",text:"<#1119#>"},
{value:"Storage",text:"<#1120#>"}, {value:"Balcony",text:"<#1121#>"}, {value:"Meeting Room",text:"<#1122#>"},
{value:"Garage",text:"<#1124#>"}, {value:"Gaming Room",text:"<#1126#>"}, {value:"Gym",text:"<#1127#>"},
{value:"Custom",text:"<#1123#>"}
];
}
var result = {"loc_text":"<#1100#>", "loc_css":"Home"};
var loc_text = "Home";
if(_isReNode){
...
$("<div>").addClass("node_hint")
.html(htmlEnDeCode.htmlEncode("* <#1212#>"))
.appendTo($node_cntr);
}
});
}
...
$("<div>").addClass("title").html("<#3809#>").appendTo($vpnc_group);
var vpnc_options = [];
...
$("<div>").html("<#1553#>").appendTo($btn_cntr);
...
"continue_btn": encode_decode_text('<#4264#>', 'encode'),
...
splash_page_setting.splash_page_setting["terms_service_cb_text"] = encode_decode_text("<#4263#>", "encode");
splash_page_setting.splash_page_setting["terms_service_title"] = encode_decode_text("<#4201#>", 'encode');
splash_page_setting.splash_page_setting["agree_btn"] = encode_decode_text("<#1681#>", 'encode');
if(_setting.auth_type == "1"){
splash_page_setting.splash_page_setting["passcode_blank"] = encode_decode_text('<#4258#> : <#339#>', 'encode');
