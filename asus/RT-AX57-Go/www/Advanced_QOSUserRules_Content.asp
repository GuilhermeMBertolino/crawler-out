...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2733#> - <#1955#>";
}
else{
document.getElementById('content_title').innerHTML = "<#399#> - QoS";
}
showqos_rulelist();
load_QoS_rule();
...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#748#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#353#>");
return false;
}
}
}
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2713#>");
return false;
}
}
replace_symbol();
...
alert("<#3634#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#2341#></option>';
else
code += '<option value="0"><#2341#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#2340#></option>';
else
code += '<option value="1"><#2340#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2726#></option>';
else
code += '<option value="2"><#2726#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2702#></option>';
else
code += '<option value="3"><#2702#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2703#></option>';
else
code += '<option value="4"><#2703#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#3100#></option>
<option value="3"><#3099#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1538#>&nbsp;(<#2690#>&nbsp;32)</td>
...
<tr>
<th><#1539#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1540#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1541#></div></a></th>
<th><div class="table_text"><#2465#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#3616#></div></a></th>
<th><#1542#></th>
<th><#2689#></th>
</tr>
<tr>
<td width="20%">
<input type="text" maxlength="32" class="input_12_table" style="float:left;width:105px;" placeholder="<#748#>" name="qos_service_name_x_0" onKeyPress="return validator.isString(this, event)" autocorrect="off" autocapitalize="off">
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullQoSList(this);" title="<#3204#>">
...
<img id="pull_arrow_mac" class="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullLANIPList(this);" title="<#3199#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#2341#></option>
<option value='1' selected><#2340#></option>
<option value='2'><#2726#></option>
<option value='3'><#2702#></option>
<option value='4'><#2703#></option>
</select>
</td>
<td width="6%">
