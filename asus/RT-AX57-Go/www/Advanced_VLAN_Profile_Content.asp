...
var $table_thead_title = $("<td>").html("<#2323#>")
.attr('colSpan', '6')
.appendTo($table_thead_tr);
var $table_th_tr = $("<tr>").appendTo($table_bg);
var $table_th_name = $("<th>").html("<#585#>").css({'text-align':'center','width':'50%'}).appendTo($table_th_tr);
var $table_th_vid = $("<th>").html("<#3873#>").css({'text-align':'center','width':'20%'}).appendTo($table_th_tr);
var $table_th_iso = $("<th>").html("<#3631#>").css({'text-align':'center','width':'15%'}).appendTo($table_th_tr);
var $table_th_edit = $("<th>").html("<#2689#>").css({'text-align':'center','width':'15%'}).appendTo($table_th_tr); // / <#217#>
...
code += "<th class='IE8HACK' width='40%'><#585#></th>";
...
code += "<input class='button_gen' type='button' onclick='Update_vlan_rl(\""+apgx_id_string+"\","+choosed_rl_index+","+choosed_rl_vid+","+choosed_rl_iso+")' style='margin-left:15px;' value='<#1702#>'>";
code += "</div>";
...
<div class="formfontdesc"><#3632#></div>
