...
<div>&nbsp;</div>
<div class="formfonttitle"><#771#> - <#437#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2274#></div>
...
<tr>
<th><#2273#></a></th>
<td><span id="boot_days"></span> <#1727#> <span id="boot_hours"></span> <#2343#> <span id="boot_minutes"></span> <#2739#> <span id="boot_seconds"></span> <#3192#></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11,1)"><#2659#></a></th>
<td>
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1684#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1703#>" class="button_gen">
</form>
</td>
</tr>
</table>
