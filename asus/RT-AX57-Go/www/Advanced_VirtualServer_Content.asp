...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='" + usb_port_conflict_faq + "' target='_blank' style='text-decoration:underline;color:#FC0;'><#1965#></a>";
...
add_option(document.form.KnownGames, "<#748#>", 0, 1);
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2472#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2474#>&nbsp;(<#2690#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1539#></th>';
html += '<th width="15%"><#2476#></th>';
html += '<th width="15%"><#2478#></th>';
html += '<th width="17%"><#2479#></th>';
html += '<th width="8%"><#2465#></th>';
html += '<th width="17%"><#2473#></th>';
html += '<th width="6%"><#3090#></th>';
html += '<th width="6%"><#1686#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1901#></option>")
.append("<option value='1'><#1908#></option>")
...
$("#vts_port_x").parent().parent().find('th').html('<#2476#><div class="setup_info_icon" style="display:none;"></div>');
if((wan_proto == "v6plus" || wan_proto == "ocnvc") && s46_ports_check_flag && array_ipv6_s46_ports.length > 1){
$(".setup_info_icon").show();
$(".setup_info_icon").click(
function() {
...
<div><#2462#></div>
<div><#2121#></div>
<div id="FTP_desc"><#2093#></div>
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#417#>&nbspFAQ</a>
</div>
</div>
<div class="formfontdesc hint-color" id="lb_note" style="color:#FFCC00; display:none;"><#2678#></div>
...
<tr>
<th><#2461#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3806#>">
</div>
</td>
</tr>
</tbody>
...
<tr>
<th><#2476#><div class="setup_info_icon" style="display:none;"></div></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2478#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2479#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/unfold_more.svg" align="right" onclick="pullLANIPList(this);" title="<#3201#>">
...
<input id="saveProfile" class="button_gen" type="button" value="<#1702#>">
</div>
</div>
<div id="footer"></div>
</form>
