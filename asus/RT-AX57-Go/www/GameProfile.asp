...
code += '<div class="table-content1-width"><div><#1260#></div></div>';
code += '<div class="table-content2-width"><div><#1570#></div></div>';
code += '<div class="table-content3-width"><div><#2465#></div></div>';
...
<div class="control-description"><#2461#></div>
...
<div class="new-g-p-s-title"><#2230#></div>
</div>
...
<div class="new-g-p-s-title"><#2233#></div>
</div>
...
<div class="new-g-p-s-title"><#3233#></div>
</div>
<div class="new-p-platform">
<div id="name_field" class="game-p-s-field">
<div class="settings-filed-title"><#1539#></div>
...
<div class="settings-filed-title"><#2465#></div>
<div class="select-container">
<select name="" id="new_profile_protocol">
<option value="TCP">TCP</option>
<option value="UDP">UDP</option>
<option value="BOTH"><#2931#></option>
</select>
...
<div class="settings-filed-title"><#2476#><div class="setup_info_icon_game" style="display:none;"></div></div>
...
<div class="settings-filed-title"><#2478#></div>
...
<div class="hint"><#2030#></div>
</div>
<div id="localIP_field" class="game-p-s-field" >
<div class="settings-filed-title"><#2479#></div>
...
<div class="settings-filed-title"><#2473#></div>
...
<div class="button-text"><#1702#></div>
</div>
</div>
...
<div class="new-g-p-title"><#2230#></div>
<div class="new-g-p-rule"><span id="rule_num">2</span> Rules (<#2690#> 32)</div>
</div>
<div id="list_content">
