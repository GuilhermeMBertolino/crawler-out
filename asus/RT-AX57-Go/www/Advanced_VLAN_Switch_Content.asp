...
var str_port_binding_note = stringSafeGet("<#3630#>");
var str_modify = stringSafeGet(" <#848#>");
var rate_map = [
{
value: 'X',
text: '<#759#>'
...
link_rate_tmp = (link_rate_tmp == undefined)? rate_map[0]:link_rate_tmp; //<#759#>
...
max_rate_tmp = (max_rate_tmp == undefined)? rate_map[0]:max_rate_tmp; //<#759#>
...
$port_table_thead2.html("<#1063#>");
} else {
$port_table_thead2.html("<#1135#>");
}
...
note_wan_aggregation += ": ";
str_port_binding_note_tmp = str_port_binding_note.replace("%@", "<#3874#>");
...
note_link_aggregation += ": ";
str_port_binding_note_tmp = str_port_binding_note.replace("%@", "<#2861#>");
...
note_iptv += ": ";
str_port_binding_note_tmp = str_port_binding_note.replace("%@", "<#2727#>");
...
.text("Allow all tagging(<#3223#>)") // Untranslated
);
$.each(VLAN_Profile_select, function(i, VLAN_Profile_select) {
if(VLAN_Profile_select.apgIdx != ""){ //except pure VLAN profile
text = VLAN_Profile_select.name;
...
<div class="formfontdesc"><#3633#></div>
