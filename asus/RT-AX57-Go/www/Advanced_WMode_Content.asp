...
document.getElementById("repeaterModeHint_desc").innerHTML = "<#1701#>";
document.getElementById("repeaterModeHint").style.display = "";
}
else{
show_wl_wdslist();
...
code +='<tr><td style="color:#FFCC00;"><#2472#></td>';
}
else{
...
code += '<div style="text-decoration:underline;font-weight:bolder;" onclick="rescan();"><#1431#></div>';
}
else{
...
<div class="formfontdesc"><#3943#></div>
<div class="formfontdesc hint-color"><#946#></div>
<div class="formfontdesc hint-color" style="margin-left:28px;">
<#3944#>&nbsp;<#3945#><br><#3234#>
</div>
<div class="formfontdesc"><#3946#>
<ol>
<li><#3947#></li>
<li><#3948#></li>
<li><#3949#></li>
...
<div id="wl_bw_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#3951#></div>
<div id="wl_ch_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#3952#></div>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#4002#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#4003#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#4004#></option>
</select>
</td>
</tr>
...
<td colspan="4"><#3971#>&nbsp;(<#2690#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#3971#></th>
<th class="edit_table" width="20%"><#2689#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullLANIPList(this);" title="<#3197#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
