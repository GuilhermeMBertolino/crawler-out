...
{url: "Captive_Portal_Advanced.asp", tabName: "<#4252#>"},
...
{url: "ParentalControl.asp", tabName: "<#3476#>"},
{url: "YandexDNS.asp", tabName: "<#4208#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "QoS_EZQoS.asp", tabName: "<#2810#>"},
...
{url: "Main_Spectrum_Content.asp", tabName: "<#3387#>"},
...
{url: "AdaptiveQoS_InternetSpeed.asp", tabName: "<#2472#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "cloud_sync.asp", tabName: "<#3365#>"},
{url: "cloud_router_sync.asp", tabName: "<#3290#>"},
{url: "cloud_settings.asp", tabName: "<#3310#>"},
{url: "cloud_syslog.asp", tabName: "<#2774#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
/* ============================================================================================================ */
...
{url: "Advanced_WProxy_Content.asp", tabName: "<#3974#>"},
{url: "Advanced_Roaming_Block_Content.asp", tabName: "<#3977#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Advanced_SwitchCtrl_Content.asp", tabName: "<#3424#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Advanced_VPNClient_Content.asp", tabName: (vpn_fusion_support) ? "<#4347#>" : "<#3886#>"},
...
{url: "Advanced_Feedback.asp", tabName: "<#2805#>"},
...
{url: "Advanced_Privacy.asp", tabName: "<#4379#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
tab: [
{url: "Main_Analysis_Content.asp", tabName: "<#2956#>"},
{url: "Main_Netstat_Content.asp", tabName: "Netstat"},
{url: "Main_WOL_Content.asp", tabName: "<#2978#>"},
{url: "Advanced_Smart_Connect.asp", tabName: "<#3358#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
}
],
