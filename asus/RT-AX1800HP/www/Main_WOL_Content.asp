...
<div>&nbsp;</div>
<div class="formfonttitle"><#2961#> - <#2978#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3348#></div>
<div class="formfontdesc"><#3349#></div>
...
<input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2979#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2972#>&nbsp;(<#2767#>&nbsp;32)</td>
</tr>
</thead>
<tr>
