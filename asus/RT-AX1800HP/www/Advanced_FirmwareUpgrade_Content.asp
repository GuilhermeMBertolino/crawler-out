...
html += "<td>";
html += '<div>';
html += '<input type="button" id="update" name="update" class="button_gen" onclick="show_offline_msg(true);" value="<#2768#>" />';
...
html += '<a id="linkpage" target="_blank"><div style="padding-top:5px;"><#2768#></div></a>';
html += '</div>';
...
document.getElementById('update_states').innerHTML="<#2464#>&nbsp;<#2266#>";
...
<input type="button" id="sig_check" name="sig_check" class="button_gen" onclick="sig_version_check();" value="<#2768#>">
</div>
<div>
...
<input type="button" id="update" name="update" class="button_gen" onclick="detect_update();" value="<#2768#>" />
</div>
...
<a id="linkpage" target="_blank"><div style="padding-top:5px;"><#2768#></div></a>
</div>
<div id="check_states">
...
<tr><th><#2920#></th><td><div id="usb_modem_act_swver"><% nvram_get("usb_modem_act_swver"); %></div></td></tr>
<tr>
<th><#2984#></th>
<td>
<input type="file" name="file" class="input" style="color:#FFCC00;*color:#000;width: 194px;">
<input type="button" name="upload" class="button_gen" onclick="upgrade_modem_fw()" value="<#1789#>" />
</td>
</tr>
</table>
</form>
