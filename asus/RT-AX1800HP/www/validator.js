...
document.getElementById("check_ip_input").innerHTML="<#428#>";
...
isValidHost: function(value) { //<#428#>
var err_count=0;
var alert_content = "<#428#>\n<#2634#>";
...
alert(document.form.wan_ipaddr_x.value + " <#428#>");
document.form.wan_ipaddr_x1.focus();
return false;
}
...
alert(document.form.wan_ipaddr_x1.value + "<#412#>");
document.form.wan_ipaddr_x1.focus();
document.form.wan_ipaddr_x1.select();
return false;
}
...
if(!groupChar(c)){
alert('<#434#> '+o.value.charAt(i)+' <#435#>');
o.focus();
o.select();
return false;
}
