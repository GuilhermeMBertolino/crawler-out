...
document.form.wl_wpa_psk.value = "<#3991#>";
...
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#4198#>";
...
x.options[0].text = "<#4043#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#4043#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#4044#>", "upper");
...
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#4043#>", "lower");
...
if(document.form.wl_wpa_psk.value == "<#3991#>")
...
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4181#>';
else{
...
$('#band0_auto_channel').html('<#3987#>: ' + cur_control_channel[0]);
}
if (band1_channel == '0') {
$('#band1_auto_channel').show();
$('#band1_auto_channel').html('<#3987#>: ' + cur_control_channel[1]);
}
}else{
document.getElementById("wl_unit_field").style.display = "none";
...
option += '<option value="0"><#4071#></option>';
option += '<option value="1"><#4127#></option>';
option += '<option value="2"><#4128#></option>';
}
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0,27);"><#3355#></a></th>
<td>
...
<div id="radio_smartcon_enable" class="left" style="width: 94px;display:table-cell;"></div><div id="smartcon_rule_link" style="display:table-cell; vertical-align: middle;"><a href="Advanced_Smart_Connect.asp" style="font-family:Lucida Console;color:#FC0;text-decoration:underline;cursor:pointer;"><#3358#></a></div>
<div class="clear"></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_bss_enabled", "0","selected"); %>><#4071#></option>
<option class="content_input_fd" value="1" <% nvram_match("wl_bss_enabled", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr-->
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#4093#></a></th>
<td>
...
<tr style="display:none">
<th><a id="band0_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4134#></a></th>
<td>
...
<span id="wl_optimizexbox_span" style="display:none"><input type="checkbox" name="wl_optimizexbox_ckb" id="wl_optimizexbox_ckb" value="<% nvram_get("wl_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4136#></input></span>
<span id="wl_gmode_checkbox" style="display:none;"><input type="checkbox" name="wl_gmode_check" id="wl_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4135#></input></span>
...
<span id="wl_nmode_x_hint" style="display:none;"><br><#4182#><br></span>
...
<th>
<a id="he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#4045#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
<select name="wl_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl_11ax", "1" ,"selected"); %> ><#4070#></option>
<option value="0" <% nvram_match("wl_11ax", "0" ,"selected"); %> ><#4071#></option>
</select>
<span id="he_mode_faq" style="padding: 0 10px"><#4046#></span>
</div>
</td>
</tr>
<tr id="mbo_field" style="display:none">
<th>
<a class="hintstyle"><#4000#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_mbo_enable" class="input_option" onChange="handleMFP();">
<option value="1" <% nvram_match("wl_mbo_enable", "1","selected"); %>><#4070#></option>
<option value="0" <% nvram_match("wl_mbo_enable", "0","selected"); %>><#4071#></option>
</select>
</div>
</td>
</tr>
...
<th>
<a class="hintstyle"><#4061#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_twt" class="input_option">
<option value="1" <% nvram_match("wl_twt", "1","selected"); %>><#4070#></option>
<option value="0" <% nvram_match("wl_twt", "0","selected"); %>><#4071#></option>
</select>
</div>
</td>
</tr>
<tr id="wl_bw_field" style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 14);"><#4018#></a></th>
<td>
...
<div><span id="dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#4038#></input></span></div>
<div><span id="acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#4036#></input></span></div>
<div><span id="acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#4037#></input></span></div>
<div><span id="acs_ch13_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#4035#></input></span></div>
</div>
</td>
</tr>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 15);"><#4042#></a></th>
<td>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 5);"><#4003#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 7);"><#4145#></a></th>
<td>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 9);"><#4068#></a></th>
<td>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#4063#></th>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 8);"><#4141#></a></th>
<td>
...
<option value="0" <% nvram_match("wl_mfp", "0", "selected"); %>><#4071#></option>
<option value="1" <% nvram_match("wl_mfp", "1", "selected"); %>><#4127#></option>
<option value="2" <% nvram_match("wl_mfp", "2", "selected"); %>><#4128#></option>
</select>
...
<span id="mbo_notice" style="display:none"><#4001#></span>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 11);"><#4156#></a></th>
...
<tr>
<th><a id="band01_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4134#></a></th>
<td>
...
<th>
<a id="band01_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#4045#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
<select name="band01_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl0_11ax", "1" ,"selected"); %> ><#4070#></option>
<option value="0" <% nvram_match("wl0_11ax", "0" ,"selected"); %> ><#4071#></option>
</select>
<span id="band0_he_mode_faq" style="padding: 0 10px"><#4046#></span>
</div>
</td>
</tr>
...
<option value="1" <% nvram_match("wl0_mbo_enable", "1","selected"); %>><#4070#></option>
<option value="0" <% nvram_match("wl0_mbo_enable", "0","selected"); %>><#4071#></option>
</select>
</div>
</td>
</tr>
...
<option value="1" <% nvram_match("wl0_twt", "1","selected"); %>><#4070#></option>
<option value="0" <% nvram_match("wl0_twt", "0","selected"); %>><#4071#></option>
</select>
</div>
</td>
</tr>
...
<option value="0" <% nvram_match("wl0_mfp", "0", "selected"); %>><#4071#></option>
<option value="1" <% nvram_match("wl0_mfp", "1", "selected"); %>><#4127#></option>
<option value="2" <% nvram_match("wl0_mfp", "2", "selected"); %>><#4128#></option>
</select>
...
<span id="band01_mbo_notice" style="display:none"><#4001#></span>
</td>
</tr>
...
<span id="band0_optimizexbox_span" style="display:none"><input type="checkbox" name="band0_optimizexbox_ckb" id="band0_optimizexbox_ckb" value="<% nvram_get("wl0_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4136#></input></span>
<span id="band0_gmode_checkbox"><input type="checkbox" name="band0_gmode_check" id="band0_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4135#></input></span>
...
<span id="band0_nmode_x_hint" style="display:none;"><br><#4182#><br></span>
...
<th>
<a id="band0_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#4045#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
...
<div style="margin-top:5px">
<div><span id="band0_acs_ch13_checkbox" style="display:none;"><input id="band0_acs_ch13" type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#4035#></input></span></div>
</div>
</td>
</tr>
...
<span id="band0_mbo_notice" style="display:none"><#4001#></span>
</td>
</tr>
...
<th><a id="band1_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4134#></a></th>
<td>
...
<span id="band1_optimizexbox_span" style="display:none"><input type="checkbox" name="band1_optimizexbox_ckb" id="band1_optimizexbox_ckb" value="<% nvram_get("wl1_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4136#></input></span>
<span id="band1_gmode_checkbox" style="display:none;"><input type="checkbox" name="band1_gmode_check" id="band1_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4135#></input></span>
...
<span id="band1_nmode_x_hint" style="display:none;"><br><#4182#><br></span>
...
<th>
<a id="band1_he_mode_text" class="hintstyle" href="javascript:void(0);" onClick=""><#4045#></a>
</th>
<td>
<div style="display:flex;align-items: center;">
<select name="band1_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl1_11ax", "1" ,"selected"); %> ><#4070#></option>
<option value="0" <% nvram_match("wl1_11ax", "0" ,"selected"); %> ><#4071#></option>
</select>
<span id="band1_he_mode_faq" style="padding: 0 10px"><#4046#></span>
</div>
</td>
</tr>
...
<option value="1" <% nvram_match("wl1_mbo_enable", "1","selected"); %>><#4070#></option>
<option value="0" <% nvram_match("wl1_mbo_enable", "0","selected"); %>><#4071#></option>
</select>
</div>
</td>
</tr>
...
<option value="1" <% nvram_match("wl1_twt", "1","selected"); %>><#4070#></option>
<option value="0" <% nvram_match("wl1_twt", "0","selected"); %>><#4071#></option>
</select>
</div>
</td>
</tr>
...
<div style="margin-top:5px">
<div><span id="band1_dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="band1_acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#4038#></input></span></div>
<div><span id="band1_acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#4036#></input></span></div>
<div><span id="band1_acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#4037#></input></span></div>
</div>
</td>
</tr>
...
<option value="0" <% nvram_match("wl1_mfp", "0", "selected"); %>><#4071#></option>
<option value="1" <% nvram_match("wl1_mfp", "1", "selected"); %>><#4127#></option>
<option value="2" <% nvram_match("wl1_mfp", "2", "selected"); %>><#4128#></option>
</select>
...
<span id="band1_mbo_notice" style="display:none"><#4001#></span>
</td>
</tr>
