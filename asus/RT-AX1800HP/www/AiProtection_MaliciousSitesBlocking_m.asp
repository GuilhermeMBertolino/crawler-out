...
if(info_bar == ''){
$('#recountIcon').hide();
code += '<div class="no-data"><#1312#></div>';
}
else{
$('#recountIcon').show();
...
code += '<div class="table-cell"><#1877#></div>';
code += '<div class="table-cell"><#1310#></div>';
code += '<div class="table-cell"><#1309#></div>';
code += '<div class="table-cell"><#1308#></div>';
code += '</div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1310#>">'+ cat_id_array[cat_id_index].description +'</div>';
var _name = dataObj[eventID].source[0];
if(clientList[_name]){
_name = clientList[_name].name;
}
code += '<div class="table-cell" data-title="<#1309#>">'+ _name +'</div>';
code += '<div class="table-cell" data-title="<#1308#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '</div>';
}
}
else{
...
<div>
<div class="card-bg">
<div class="page-title"><#1387#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1829#></div>
<div class="description"><#1386#></div>
</div>
<div class="tm-logo">
...
<div class="event-hit"><#1379#></div>
</div>
<div class="card-lv1 card-lv1-bg">
<div class="flexbox flex-a-center flex-j-spaceB">
<div class="description"><#1405#></div>
...
<div class="page-title canvas-title"><#1294#></div>
</div>
<div class="canvas-bg">
<div class="chart-title"><#1379#></div>
