...
alert_msg = hint_str1.replace("%1$@", "<#2938#>").replace("%2$@", "IPTV") + " " + hint_str2;
}
alert(alert_msg);
return true;
}
...
var msg = "<#3956#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
if(confirm(msg)){
...
msg = hint_str.replace("%1$@", port_list).replace("%2$@", "IPTV").replace("%3$@", "<#2938#>");
if(confirm(msg)){
document.form.lacp_enabled.disabled = false;
document.form.lacp_enabled.value = "0";
}
...
if(val == "12")
document.getElementById("gaming_note").innerHTML = "<#3211#>";
else if(val == "56")
...
if(improxy_support){
add_option(select, "<#4070#> IGMP", "1", 0);
add_option(select, "<#4070#> IGMP & MLD", "3", 0);
}
else
add_option(select, "<#4070#>", "1", 0);
select.value = val;
if(select.selectedIndex < 0)
select.selectedIndex = 0;
...
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#2658#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#2659#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#3210#></a></th>
<td>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#4071#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#3218#></a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option" onChange="change_mr_enable(this.value);">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#4071#></option>
<!-- <option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#4070#></option> -->
</select>
<span id="mr_hint" style="display:none;">( <#3219#> )</span>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#4071#></span>
<span style="margin-left: 5px;"><#3220#></span>
</div>
</td>
</tr>
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,14);"><#3229#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,15);"><#3230#></a></th>
<td>
...
<option value="0" <% nvram_match("mr_qleave_x", "0","selected"); %> ><#4071#></option>
<option value="1" <% nvram_match("mr_qleave_x", "1","selected"); %> ><#4070#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#4071#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#4070#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#3232#></a></th>
<td>
