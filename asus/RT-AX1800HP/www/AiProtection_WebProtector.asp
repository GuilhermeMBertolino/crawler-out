...
var category_name = ["<#1314#>", "<#1329#>", "<#1332#>", "<#1336#>"];
var sub_category_name = [["<#1316#>", "<#1317#>", "<#1318#>"],
["<#1319#>", "<#1320#>", "<#1321#>", "<#1322#>", "<#1323#>"],
["<#1334#>", "<#1335#>"],
["<#1337#>", "<#1338#>", "<#1339#>"]];
var category_desc = ["<#1315#>",
"<#1330#>",
"<#1333#>",
"<#1340#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1735#>&nbsp;(<#2767#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#3273#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1642#> (<#3118#>)</th>';
code += '<th width="40%"><#1324#></th>';
code += '<th width="10%"><#2766#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#4070#>/<#1625#>">';
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#564#> - <#1313#></div>
</td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1313#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3476#></td></tr></table>
</div>
</a>
</div>
</td>
...
<span><#1331#></span>
<div>
<a id="faq" href="" style="text-decoration:underline;" target="_blank"><#564#> FAQ</a>
</div>
</td>
</tr>
</table>
...
<input class="button_gen" type="button" onclick="applyRule();" value="<#284#>">
