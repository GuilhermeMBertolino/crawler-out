...
$(".ipsec_inactive.renew_hint").show().html("<br><#3842#>");
}
}
});
...
alert(document.form.ipsec_clients_start.value+" <#428#>");
...
html += "<div class='ipsec_connect_status_title'><#3407#></div>";
html += "<div class='ipsec_connect_status_title'><#976#></div>";
html += "<div class='ipsec_connect_status_title'><#3807#> <#3052#></div>";
...
<input class="button_gen" onclick="cancel_viewLog();" type="button" value="<#287#>"/>
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1761#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1780#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1782#>"/>
</div>
</div>
...
<th><#847#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1760#>"/>
</td>
</tr>
<tr class="ipsec_setting_content">
<th><#882#></th>
...
<th><#3800#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3792#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<span class="hint-color"><#2107#></span>
</td>
</tr>
<tr>
<th><#390#></th>
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#4070#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#4071#></label>
</td>
</tr>
...
<span class="hint-color">(10~900) <#3269#></span>
</td>
</tr>
</table>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable " style="margin-top:15px;">
...
<th><#3731#></th>
<td>
<div><#830#> : <span id="cert_status"></span></div>
<div><#3840#> : <span id="cert_issueTo"></span></div>
<div><#3839#> : <span id="cert_issueBy"></span></div>
<div><#3771#> : <span id="cert_expire"></span></div>
<div>
<input class="button_gen_dis ipsec_active export" type="button" value="<#1628#>">
<span class="ipsec_inactive"><#828#></span>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_windows" class="input" value="0" checked>
<label for="ipsec_export_cert_windows"><#3844#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3845#></label>
</div>
</td>
</tr>
<tr>
...
<input class="button_gen_dis ipsec_active renew" type="button" value="<#295#>">
<span class="ipsec_inactive renew_hint"><#828#></span>
