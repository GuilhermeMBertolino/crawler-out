...
loadXML();
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#2268#> <#4198#>";
...
document.getElementById("wps_band_hint").innerHTML = "* <#4174#>";
return false;
}
...
if(wps_enable_old == "1"){
document.getElementById("wps_enable_word").innerHTML = "<#1627#>";
document.getElementById("enableWPSbtn").value = "<#1625#>";
...
document.getElementById("wps_enable_word").innerHTML = "<#1626#>"
document.getElementById("enableWPSbtn").value = "<#4070#>";
...
document.getElementById("wps_enable_hint").innerHTML = "* <#2993#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#1629#></a>"
controlDisplayItem();
return;
}
...
document.getElementById("wps_enable_hint").innerHTML = "<#4201#><br><#4202#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#479#></a> <#4203#>"
controlDisplayItem();
return;
}
if(wps_enable_old == "0"){
document.getElementById("wps_state_tr").style.display = "";
document.getElementById("wps_state_td").innerHTML = "<#4200#>";
...
document.getElementById("wps_config_td").innerHTML = "<#1626#>";
else
document.getElementById("wps_config_td").innerHTML = "<#1627#>";
}
...
if(radio_2 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(0);\"><#1629#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a>"
}
if(radio_5 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(1);\"><#1629#> " + get_band_str(wps_infos1[12].firstChild.nodeValue) + "</a>"
}
document.getElementById("wps_enable_hint").innerHTML = "* <#2993#>" + band_link + "";
...
if(rej0)
band_link += "<a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(0);\"><#479#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a> ";
if(rej1)
band_link += "<a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(1);\"><#479#> " + get_band_str(wps_infos1[12].firstChild.nodeValue) + "</a> ";
document.getElementById("wps_enable_hint").innerHTML = "<#4201#><br><#4202#> " + band_link + " <#4203#>";
if (rej0 && rej1){
document.getElementById("wps_state_tr").style.display = "none";
document.getElementById("devicePIN_tr").style.display = "none";
document.getElementById("wpsmethod_tr").style.display = "none";
...
document.getElementById("wps_state_td").innerHTML = "<#4200#> / <#4200#>";
document.getElementById("WPSConnTble").style.display = "none";
document.getElementById("wpsDesc").style.display = "none";
}
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#478#> - <#480#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#4034#></div>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(13,1);"><#4172#></a></th>
<td>
...
<tr id="wps_band_tr">
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,5);"><#1792#></th>
<td id="wps_switch">
<span class="devicepin" style="color:#FFF;" id="wps_band_word"></span>&nbsp;&nbsp;
<input type="button" class="button_gen" name="switchWPSbtn" id="switchWPSbtn" value="<#3423#>" class="button" onClick="SwitchBand();">
...
<td style="border:0px">
<input class="button_gen" type="button" onClick="resetWPS();" id="Reset_OOB" name="Reset_OOB" value="<#1783#>" style="padding:0 0.3em 0 0.3em;" >
<br><span id="Reset_OOB_desc"><#4157#></span>
</td>
</tr></table>
</div>
</td>
...
<tr id="devicePIN_tr">
<th>
<span id="devicePIN_name"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,4);"><#4102#></a></span>
</th>
<td>
...
<tr id="wpsmethod_tr">
<th>
<span id="wps_method"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,2);"><#4178#></a></span>
</th>
<td>
<input type="radio" name="wps_method" onclick="changemethod(0);" value="0"><#4173#>
<input type="radio" name="wps_method" onclick="changemethod(1);" value="1"><#4180#>
...
<div id="starBtn" style="margin-top:10px;"><input class="button_gen" type="button" style="margin-left:5px;" onClick="configCommand();" id="addEnrolleebtn_client" name="addEnrolleebtn" value="<#4199#>"></div>
</td>
</tr>
</table>
</td>
