...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1804#> ";
if (Hours != 0)
value += Hours.toString() + " <#2420#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2816#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#3269#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
if(gobi_support){
pri_if = (pri_if == "USB")? "<#2900#>" : pri_if;
sec_if = (sec_if == "USB")? "<#2900#>": sec_if;
if((unit == "0" && pri_if == "<#2900#>") || (unit == "1" && sec_if == "<#2900#>"))
$("#wan_enable_title").text("<#2820#>");
}
...
showtext(document.getElementById("dualwan_mode"), "<#1962#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1961#>");
...
if(lanproto == "static")
showtext(document.getElementById("LanProto"), "<#256#>");
else
showtext(document.getElementById("LanProto"), "<#255#>");
...
wanlink_type_conv = "<#255#>";
else if(wanlink_type_conv == "static")
wanlink_type_conv = "<#256#>";
...
$("#ipv6_DNS_servers").prop('title', `<#2578#>`);
...
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;" id="wan_enable_title"><#490#></div>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<div style="display:flex; align-items:center; justify-content:space-between;">
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;"><#1944#></div>
...
<p class="formfonttitle_nwm"><#3937#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3935#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1960#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1963#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" ><#280#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3897#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#4208#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3225#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2665#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2758#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#313#></p>
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1629#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1633#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1629#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
</table>
...
<p class="formfonttitle_nwm"><#842#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2648#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#404#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2428#></p>
...
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#700#>" style="float:right;margin: 5px 0;">
</td>
</tr>
</table>
</form>
