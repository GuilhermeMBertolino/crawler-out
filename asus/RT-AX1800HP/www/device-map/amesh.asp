...
html += "<div class='aimesh_node_setting_info_title'><#4382#></div>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2549#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#3032#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3720#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3895#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2924#>");
...
block_chars_hint = block_chars_array[i] + " <#2622#>";
}
if(block_chars_hint != "") {
...
function() {
if(node_info.online == "1" && re_path > 0) {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1762#>" : "<#2924#>";
...
var led_table = ["<#1762#>", "<#2779#>", "<#2803#>", "<#2417#>"];
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2549#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#4381#>" : nodeClientObj.ip;
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2549#></div></div>
</td>
</tr>
<tr>
</table>
