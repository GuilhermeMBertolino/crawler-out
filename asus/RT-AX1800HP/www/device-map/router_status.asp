...
var led_table = ["<#1625#>", "<#3154#>", "<#2803#>", "<#2417#>"];
...
var code = '';
if(system.INTELplatform){
code += '<div class="info-title"><#4382#></div>';
...
code += '<div class="info-block"><div class="info-title"><#2648#></div><div class="info-content">'+ _lanIP +'</div></div>';
code += '<div class="info-block"><div class="info-title"><#3055#></div><div class="info-content">'+ variable.secret_code +'</div></div>';
if(variable.serial_no != ''){
code += '<div class="info-block"><div class="info-title"><#3286#></div><div class="info-content">'+ variable.serial_no +'</div></div>';
}
...
var modeDesc = ['<#4215#>', '<#4217#>', '<#4219#>', '', '<#1626#>'];
code += '<div class="division-block"><#4208#></div>';
...
$("<div>").css({"margin-bottom":"6px"}).html("<#3087#> <#3088#>").appendTo($hint_text_bg);
...
$("<div>").css({"margin-bottom":"6px"}).html("<#3089#> :").appendTo($hint_text_bg);
var $help_item = $("<ol>").css({"margin":"0", "padding":"0", "margin-left":"24px"}).appendTo($hint_text_bg);
$("<li>").css({"color":"#64737c"}).html("<#3094#>".replace("#ETHCABLE", "Cat 5e")).appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3090#>").appendTo($help_item);
...
$("<div>").addClass("warn").html("<#2998#>").appendTo($port_status_icon_desc);/* untranslated */
...
code += '<div class="display-flex flex-a-center table-header">';
code += '<div class="port-block-width table-content"><#830#></div>';
code += '<div class="port-block-width table-content">Tx (<#2486#>)</div>';
code += '<div class="port-block-width table-content">Rx (<#2486#>)</div>';
code += '</div>';
