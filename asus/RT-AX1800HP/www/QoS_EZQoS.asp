...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2810#> - <#1001#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#3177#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#3176#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#474#> - <#2810#>";
...
alert("<#3712#> "+ (qos_xobw_orig/1024).toFixed(2));
...
alert("<#3712#> "+(qos_xobw1_orig/1024).toFixed(2));
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2790#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#3071#>&nbsp;(<#2767#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1735#>&nbsp;(<#2767#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#3273#>">';
...
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2976#></th>';
else
code += '<th style="width:330px"><#2976#></th>';
code += '<th style="width:130px"><#1907#></th>';
code += '<th style="width:130px"><#3642#></th>';
code += '<th style="width:90px"><#2766#></th>';
code += '</tr>';
...
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3276#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#2549#></td></tr>';
}
else{
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2418#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2780#></div>
</td>
</tr>
</table>
</td>
...
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#3642#></a></th>
<td>
