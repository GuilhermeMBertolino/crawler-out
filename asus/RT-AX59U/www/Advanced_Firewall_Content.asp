...
add_option(document.form.LWKnownApps, "<#2536#>", "User Defined", 1);
...
<option value="DROP" <% nvram_match("filter_lw_default_x", "DROP","selected"); %>><#3972#></option>
...
<option value="User Defined"><#2536#></option>
</select>
</td>
</tr>
<tr>
...
<thead>
<tr>
<td colspan="6" id="filter_lwlist"><#2190#>&nbsp;(<#2768#>&nbsp;32)</td>
</tr>
</thead>
<tr>
