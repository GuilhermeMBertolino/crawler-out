...
var code = "";
code += "<tr>";
code += "<th style='width:20%;text-align:left'><#976#></th>";
code += "<th style='width:30%;text-align:left'><#3119#> / <#1642#></th>";
code += "<th style='width:50%;text-align:left'><#1905#></th>";
code += "</tr>";
...
var data = [["<#976#>", "<#463#>", "<#1642#>".replace(/&#39;/g, "'"), "<#1905#>"]];
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2811#> - <#995#></div>
...
<option value="all" selected><#1502#></option>
</select>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1761#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1782#>">
<input class="button_gen" onClick="exportWebHistoryLog()" type="button" value="<#1628#>" >
</div>
</div>
</td>
</tr>
