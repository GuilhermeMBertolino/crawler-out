...
document.getElementById("iptv_configure_status").innerHTML = "<#947#>";
else
...
document.getElementById("voip_configure_status").innerHTML = "<#947#>";
else
...
alert_msg = hint_str1.replace("%1$@", "<#2939#>").replace("%2$@", "IPTV") + " " + hint_str2;
}
alert(alert_msg);
return true;
}
...
var msg = "<#3957#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
if(confirm(msg)){
...
msg = hint_str.replace("%1$@", port_list).replace("%2$@", "IPTV").replace("%3$@", "<#2939#>");
if(confirm(msg)){
document.form.lacp_enabled.disabled = false;
document.form.lacp_enabled.value = "0";
}
...
if(val == "12")
document.getElementById("gaming_note").innerHTML = "<#3212#>";
else if(val == "56")
document.getElementById("gaming_note").innerHTML = "<#3213#>";
...
if(improxy_support){
add_option(select, "<#4071#> IGMP", "1", 0);
add_option(select, "<#4071#> IGMP & MLD", "3", 0);
}
else
add_option(select, "<#4071#>", "1", 0);
select.value = val;
if(select.selectedIndex < 0)
select.selectedIndex = 0;
...
<tr>
<td>
<div class="drword" id="drword" style="height:110px;"><#467#> <#464#>...
<br/>
<br/>
</div>
...
<option value="dhcp"><#255#></option>
<option value="static"><#256#></option>
...
<tr id="dnsenable_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,12);"><#402#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,13);"><#388#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,14);"><#390#></a></th>
...
<option value="" <% nvram_match("wan_auth_x_now", "", "selected"); %>><#950#></option>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd_now);"><#714#></div>
</td>
</tr>
...
<input class="button_gen" type="button" onclick="hide_connection_settings();" value="<#287#>">
<input class="button_gen" type="button" onclick="save_connection_settings();" value="<#1779#>">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#485#> - IPTV</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#2659#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#2660#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#3211#></a></th>
<td>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#823#></a></th>
<td>
...
<th width="30%"><#1978#></th>
<td align="left">
<span style="color:#FFFFFF;"><#1981#></span>
<select id="wans_lanport1" name="wans_lanport1" class="input_option" style="margin-left:7px;"></select>
<div style="margin-top:2px;"><span style="color:#FFFFFF;">( <#1979#> : </span><span id="cur_primary" style="color:#FFFFFF;"></span><span style="color:#FFFFFF;"> )</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#4072#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#3219#></a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option" onChange="change_mr_enable(this.value);">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#4072#></option>
<!-- <option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#4071#></option> -->
</select>
<span id="mr_hint" style="display:none;">( <#3220#> )</span>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#4072#></span>
<span style="margin-left: 5px;"><#3221#></span>
</div>
</td>
</tr>
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,14);"><#3230#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,15);"><#3231#></a></th>
<td>
...
<option value="0" <% nvram_match("mr_qleave_x", "0","selected"); %> ><#4072#></option>
<option value="1" <% nvram_match("mr_qleave_x", "1","selected"); %> ><#4071#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#4072#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#4071#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#3233#></a></th>
<td>
