...
code +='<thead><tr><td colspan="4"><#3364#></td></tr></thead>';
code +='<tr id="band_text"><th width="20%"><#2466#></th>';
if(start_band_idx == '1'){
if(band6g_support){
...
code +='<td>';
code +='<input onclick="change_lb(1,'+i+');" type="radio" name="wl'+i+'_bsd_steering_balance" value="1"><#275#>';
code +='<input onclick="change_lb(0,'+i+');" type="radio" name="wl'+i+'_bsd_steering_balance" value="0"><#274#>';
code +='</td>';
}
code +='</tr>';
code +='<tr><th><#3365#></th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#3013#></option>';
code +='<option value="1" class="content_input_fd"><#3012#></option>';
code +='</select></td>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_ld_t" style="display:none;"><#1625#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th><#3054#></th>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_gd_t" style="display:none;"><#1625#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#1501#></option>';
...
code +='<thead><tr><td colspan="4"><#3360#></td></tr></thead>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_ld_t" style="display:none;"><#1625#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th><#3054#></th>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_gd_t" style="display:none;"><#1625#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
var code="";
code +='<table cellspacing="0" cellpadding="4" bordercolor="#6b8fa3" border="1" align="center" width="100%" class="FormTable" id="MainTable2" style="margin-top:10px">';
code +="<thead><tr><td colspan=\"4\"><#3358#></td></tr></thead>";
code +='<tr id="target_band_text"><th width="20%"><#2467#></th>';
if('<% nvram_get("smart_connect_x"); %>' != 2 && (wl_info.band5g_2_support || wl_info.band6g_support)){
for(i = start_band_idx; i < wl_info.wl_if_total; i++){
...
vht_desc = ["<#1501#>","AC only","not-allowed"];
vht_value = [0,1,2];
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2962#> - <#3359#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3357#></div>
<div style="text-align:right;margin-top:-36px;padding-bottom:3px;"><input type="button" class="button_gen" value="<#3701#>" onClick="pop_clientlist_listview(true)"></div>
...
<th width="20%"><#3363#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="windows_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#3270#>
</td>
</tr>
<tr>
<th><#3361#></th>
...
<th><#3362#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="dwell_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#3270#>
</td>
</tr>
</table>
<div class="apply_gen">
<input type="button" id="restoreButton" class="button_gen" value="<#3301#>" onclick="restoreRule();">
