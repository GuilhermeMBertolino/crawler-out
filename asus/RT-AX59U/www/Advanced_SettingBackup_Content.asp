...
$("#restoreInit_text").html(`<#3298#>`);
}
}
function restoreRule(_flag){
var alert_string = "<#3295#>";
...
showtext(document.getElementById("loading_block2"), "<#3252#>");
...
showtext(document.getElementById("loading_block2"), "<#3293#>");
document.getElementById('loading_block3').style.display = "none";
...
<div class="formfontdesc"><#3306#></div>
<table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th width="25%" align="right">
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#3300#></a>
</th>
<td colspan = "4">
...
<span><label for="restoreInit" id="restoreInit_text"><#3303#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#3305#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="button_gen" onclick="saveSetting('Router');" type="button" value="<#3305#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#3310#></span></label>
</div>
</div>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#3309#></a>
</th>
<td colspan = "4">
