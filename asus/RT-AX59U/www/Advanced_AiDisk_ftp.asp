...
document.getElementById("loginMethod").innerHTML = "<#1068#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#1067#>";
...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='' target='_blank' style='text-decoration:underline;color:#FC0;'><#2042#></a>";
...
confirm_str_off= "<#1726#>"; //"<#1728#>"+ By Viz 2011.09
confirm_str_on = "<#1730#>";
}
else if(protocol == "ftp"){
status = this.FTP_status;
confirm_str_off = "<#1727#>";
confirm_str_on = "<#1731#>";
...
account_group_menu_code += '<div class="noAccount" id="noAccount"><#2990#></div>\n'
else{
...
alert("<#2628#> " + maximum_account + " <#2629#>");
return false;
}
else
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 11)?"<#1013#>":"<#979#>";
}
...
if(ftp_ssl_support){
document.getElementById("TLS_disabled").innerHTML = (flag==1)? "":"<#3685#>";
...
<span class="formfonttitle"><#495#> - <#497#></span>
<span id="returnBtn" class="returnBtn">
<img onclick="go_setting('/APP_Installation.asp')" align="right" title="<#475#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</span>
</div>
<div id="splitLine" class="splitLine"></div>
<div class="formfontdesc" style="margin-top: 10px;"><#2250#></div>
</td>
</tr>
<tr>
<td>
...
<th><#1085#></th>
<td>
<input type="radio" name="ftp_tls" class="input" value="1" <% nvram_match_x("", "ftp_tls", "1", "checked"); %> onChange="secure_check(1);"><#275#>
<input type="radio" name="ftp_tls" class="input" value="0" <% nvram_match_x("", "ftp_tls", "0", "checked"); %> onChange="secure_check(0);"><#274#>
<span id="TLS_disabled" style="color:#FC0;margin-left:10px;"></span>
</td>
</tr>
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,1);"><#3324#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,9);"><#3318#></a>
</th>
<td>
<select name="ftp_lang" class="input_option">
<option value="CN" <% nvram_match("ftp_lang", "CN", "selected"); %>>GBK</option><!-- <#3321#> -->
<option value="TW" <% nvram_match("ftp_lang", "TW", "selected"); %>>Big5</option><!-- <#3320#> -->
<option value="EN" <% nvram_match("ftp_lang", "EN", "selected"); %>>UTF-8</option><!--<#3319#>-->
<option value="RU" <% nvram_match("ftp_lang", "RU", "selected"); %>><#3322#></option>
<option value="CZ" <% nvram_match("ftp_lang", "CZ", "selected"); %>><#3323#></option>
</select>
</td>
</tr>
</table>
...
<td><div id="createAccountBtn" title="<#1013#>"></div></td>
<td><div id="deleteAccountBtn" title="<#1825#>"></div></td>
<td><div id="modifyAccountBtn" title="<#2919#>"></div></td>
</tr>
<tr id="trPMGroup" style="display:none;">
<td>
<select name="" id="user_type" class="input_option" onchange="switchUserType(this.value);">
<option value="group"><#3051#></option>
<option value="account"><#3053#></option>
</select>
</td>
</tr>
</table>
...
<table align="right">
<tr>
<td><div id="createFolderBtn" title="<#1015#>"></div></td>
<td><div id="deleteFolderBtn" title="<#1828#>"></div></td>
<td><div id="modifyFolderBtn" title="<#2923#>"></div></td>
</tr>
</table>
</td>
</tr>
...
<div id="machine_name" class="machineName"><#945#></div>
</td>
<td>
...
<input name="changePermissionBtn" id="changePermissionBtn" type="button" value="<#1780#>" class="button_gen_dis" disabled="disabled">
</div>
</td>
</tr>
</table>
