...
var invite_content = "";
var sync_rule_desc = "";
document.getElementById('invite_desc').innerHTML = "<#3455#>: " + htmlEnDeCode.htmlEncode(document.form.router_sync_desc.value);
...
document.getElementById('invite_rule').innerHTML = "<#3457#>: "+sync_rule_desc;
...
document.getElementById('invite_captcha').innerHTML = "<#3243#>: None";
else
document.getElementById('invite_captcha').innerHTML = "<#3243#>: "+captcha;
}
...
document.getElementById('invite_desc').innerHTML = "<#3455#>: "+router_synclist_desc[j];
...
document.getElementById('invite_captcha').innerHTML = "<#3243#>: "+ router_synclist_captcha[j];
...
mailtoCode += "<#3458#>%0D%0A".replace(/ /g, "%20");
mailtoCode += document.getElementById('invite_share').innerHTML.replace(/ /g, "%20") + "%0D%0A";
mailtoCode += '"><div onmouseover="" style="margin-right:15px;background-image:url(images/cloudsync/mail_send.png);background-repeat:no-repeat;width:64px;height:64px;"></div><div style="font-size:12px;margin-top:3px;margin-right:17px;"><#3286#></div></a>';
return mailtoCode;
}
...
var hint_string = "";
hint_string += "<#3237#><br><br>";
hint_string += "<#3239#><br><br>";
hint_string += "<#3238#>";
...
<input class="button_gen" type="button" onclick="confirm_folderTree();" value="<#1779#>">
</div>
</div>
<div id="invitation_block" class="panel_folder" >
<table><tr><td>
<div class="machineName" style="width:200px;font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:20px;margin-left:30px;"><#2471#></div>
</td></tr></table>
...
<tr>
<td>
<div style="margin-top:10px;width:440px;"><#3458#></div>
</td>
</tr>
<tr>
<td>
...
<input class="button_gen" type="button" onclick="close_invitation_block();" value="<#1762#>" style="margin-top:15px;margin-left:200px">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle">AiCloud 2.0 - <#3291#></div>
...
3. <#3449#><br>
4. <#3450#><br>
<span class="formfontdesc" id="wan_ip_hide2" style="color:#FFCC00;display:none;margin-left:0px;">5. <#3451#></span>
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<div style="margin-left:15px;margin-top:3px;"><#3453#></div>
</td>
</tr>
</table>
</div>
...
<tr style="height:40px;">
<th>
<div style="margin-top:5px;"><#3460#></div>
</th>
<td>
<input type="text" id="PATH" class="input_25_table" style="height: 25px;" name="cloud_dir" value="" autocorrect="off" autocapitalize="off">
<input name="button" type="button" class="button_gen" onclick="get_disk_tree();" value="<#1717#>"/>
<div id="noUSB" style="color:#FC0;display:none;margin-left:3px;font-size:12px;line-height:140%;"><#2989#></div>
</td>
</tr>
<tr style="height:40px;">
<th>
<div style="margin-top:5px;"><#1720#></div>
</th>
<td>
<select name="router_sync_rule" class="input_option" style="height:27px;">
<option value="0"><#3240#></option>
<option value="1"><#3242#></option>
<option value="2"><#3241#></option>
</select>
<span>
...
<option value="0"><#950#></option>
<option value="1"><#2785#></option>
<option value="2"><#3452#></option>
</select>
...
<input type="button" id="applyButton" class="button_gen" value="<#1773#>" onclick="domain_name_select();">
...
<a href="cloud_main.asp"><span style="font-family:Lucida Console;text-decoration:underline;color:#FC0"><#3234#></span></a><br><#3235#>
</div>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="6" id="cloud_synclist"><#3459#></td>
</tr>
</thead>
<tr>
<th width="10%"><#3158#></th>
<th width="25%"><#2518#></a></th>
...
<input name="applybutton" id="applybutton" type="button" class="button_gen" onclick="location.href='cloud_syslog.asp'" value="<#1760#>" style="word-wrap:break-word;word-break:normal;">
</div>
</div>
</td>
</tr>
