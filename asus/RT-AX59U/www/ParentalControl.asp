...
document.getElementById('content_title').innerHTML = "<#564#> - <#3477#>";
document.getElementById('desc_title').innerHTML = "<#3025#>";
document.getElementById('web_title').innerHTML = "<#944#> - <#3477#>";
document.getElementById('PC_enable').innerHTML = "<#3023#>";
}
if(isSupport("PC_SCHED_V3")){
$("#desc_title").html("<#3035#>");
var $desc_item = $("#desc_item").empty();
$("<li>").html("<#3036#>").appendTo($desc_item);
$("<li>").html("<#3027#>").appendTo($desc_item);
$("<li>").html("<#3037#>").appendTo($desc_item);
$("<li>").html("<#3038#>").appendTo($desc_item);
...
code +='<thead><tr><td colspan="4"><#1735#>&nbsp;(<#2768#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#3274#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#3274#></option>';
code += '<option value="0"><#1625#></option>';
code += '<option value="1"><#1877#></option>';
code += '<option value="2"><#1546#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1642#> (<#3119#>)</th>';
code +='<th width="20%"><#3032#></th>';
code +='<th width="20%"><#2767#></th></tr>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#3277#>">';
...
code += "<span class=\"clicked\"><#3477#></span>";
...
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#3477#></span>";
code += '</a>';
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#3477#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<div style="font-size:14px;margin-left:6px;margin-bottom:6px;"><#3040#></div>
