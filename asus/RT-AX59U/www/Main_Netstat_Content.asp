...
<script>
option_netstat = new Array("<#3340#>","<#3344#>","<#3345#>","<#3343#>","<#3346#>","<#3341#>","<#1884#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2948#>", "<#2949#>", "<#2950#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2970#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2962#> - Netstat</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2970#></div>
...
<option value="-a"><#3340#></option>
<option value="-ta"><#3344#></option>
<option value="-ua"><#3345#></option>
<option value="-w"><#3343#></option>
<option value="-xa"><#3346#></option>
<option value="-l"><#3341#></option>
<option value="-r"><#1884#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2977#> IP</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3278#>">
...
<option value="-r state" selected><#2955#></option>
<option value="-r src"><#2953#></option>
<option value="-r dst"><#2951#></option>
<option value="-r src-port"><#2954#></option>
<option value="-r dst-port"><#2952#></option>
</select>
</td>
</tr>
