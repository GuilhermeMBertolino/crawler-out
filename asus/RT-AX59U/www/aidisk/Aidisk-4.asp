...
case "0":
showtext(document.getElementById("dummyShareStr"), "\"<#3418#>\"");
break;
case "1":
showtext(document.getElementById("dummyShareStr"), "\"<#3419#>\"");
break;
case "2":
showtext(document.getElementById("dummyShareStr"), "\"<#3420#>\"");
break;
}
}
...
<input type="button" id="finish" value="<#1770#>" class="button_gen">
</div>
</td>
</tr>
</table>
