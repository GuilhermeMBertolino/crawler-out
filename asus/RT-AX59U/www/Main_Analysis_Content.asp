...
document.getElementById("cmdDesc").innerHTML = "<#2978#>";
}
else{
document.getElementById("pingCNT_tr").style.display = "none";
document.getElementById("cmdDesc").innerHTML = "<#2972#>";
}
update_ntool_unit();
}
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2962#> - <#2957#></div>
...
<div class="apply_gen">
<span><input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2968#>"></span>
