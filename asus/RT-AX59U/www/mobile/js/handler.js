...
$("#settingProfileBar").showSelectorHint("<#414#>");
return false;
}
if(
...
{
$("#settingProfileBar").showSelectorHint("<#3307#>");
return false;
}
...
httpUserInput.showTextHint("<#881#>");
return false;
}
/* check password */
if(!use_defpass){
...
if(!confirm("<#410#>")){
httpPassInput.showTextHint("<#1364#>");
return false;
}
}
}
...
$("#static_ipaddr").showTextHint("<#385#>");
return false;
}
...
if(sim_act == 2)
$(".sim_puk_apply").html("<#284#>");
else
$(".sim_pin_apply").html("<#284#>");
switch(sim_state){
case '1':
$("#sim_desc").html("<#2891#>");
$(".sim_pin_apply").html("<#293#>");
...
$("#verify_pincode_status").html("<#2915#>");
...
break;
case '4':
$("#verify_pincode_status").html("<#2853#>");
break;
case '6':
$("#verify_pincode_status").html("<#2913#>");
break;
case '-1':
$("#verify_pincode_status").html("<#2888#>");
break;
case '-2':
case '-10':
$("#verify_pincode_status").html("<#2886#>");
break;
default:
break;
}
...
$("#verify_pincode_status").html("<#2625#>");
$("#verify_pincode_status").css("display", "");
return false;
}
else{
...
$("#new_pincode_status").html("<#2859#>");
else
$("#new_pincode_status").html("<#2625#>");
...
if(!confirm("<#410#>")){
$("#wireless_key_" + band).showTextHint("<#1364#>");
return false;
}
}
return true;
...
$.get("http://localhost:55555/connectTo?ssid=" + qisPostData.wl0_ssid + "&password=" + qisPostData.wl0_wpa_psk);
...
if(pppoeAuthFail){
$(".btn_wireless_apply").html("<#284#>");
$(".btn_login_apply").html("<#284#>");
$("#wan_pppoe_passwd").showTextHint("<#794#>");
...
$("#login_name .titleMain").html("<#455#>");
$("#login_name #login_desc").html(str_local_login_desc);
$("#login_name #http_username_title").html("<#2445#>");
var find_local_login_pw = str_find_st.replace("%@", "<#572#>");
...
var str_HowFindPassword_Local = str_HowFindPassword.replace("%@", "<#572#>");
...
if(isSupport("concurrep"))
$("#siteSurvey_page").find(".titleSub").html("<#4384#>");
else
$("#siteSurvey_page").find(".titleSub").html("<#4052#>");
...
if(isSupport("RPMesh"))
$("#papList_page").find(".titleSub").html("<#4384#>");
else
$("#papList_page").find(".titleSub").html("<#4052#>");
genPAPList(systemVariable.papList, systemVariable.multiPAP.wlcOrder);
...
*/
if(isSupport("defpsk")){
var find_WiFi_pw = str_find_st.replace("%@", "<#573#>");
...
var str_HowFindPassword_WiFi = str_HowFindPassword.replace("%@", "<#573#>");
...
var applyBtn = (systemVariable.isNewFw == 2) ? "<#302#>" : "<#1788#>";
var abortBtn = (systemVariable.isNewFw == 2) ? "<#301#>" : "<#287#>";
...
$("#upgradeBtn").show();
$(".detectIcon").hide();
$("#liveUpdateStatus").html("<#408#>"); //<#276#><br/>
}
else{
errCount++;
setTimeout(arguments.callee, 1000);
...
$("#liveUpdateStatus").html("<#2258#>...");
setTimeout(arguments.callee, 1000);
}
else if(fwUpgradeInfo.webs_state_error != "0" && fwUpgradeInfo.webs_state_error != ""){
$("#upgradeBtn").show();
$(".detectIcon").hide();
$("#liveUpdateStatus").html("<#361#>");
}
else{
$("#liveUpdateStatus").html("<#362#>");
setTimeout(arguments.callee, 1000);
}
}, 500);
...
if(isSwMode("RP"))
$("#summary_page").find("#stepText2").html("<#551#>");
}
else{
$("#summary_page").find("#stepText1").html("<#549#> <#548#>");
$("#summary_page").find("#stepText2").html("<#551#>");
}
if(isSupport("lantiq")){
...
httpApi.checkCap("http://<#946#>", function(){
setTimeout(function(){
if(isPage("amasconncap_page")) window.location.href = "http://<#946#>/cfg_onboarding.cgi?flag=AMesh&id=" + systemVariable.macAddr.split(":").join("");
}, 3000);
...
if(isSupport("dsl")){
$('#noWan_desc').html("<#610#>");
$('#desktop_manual_applyBtn').html("<#299#>");
$('#desktop_manual_applyBtn').on("click", function() { goTo.Wireless(); });
$('#mobile_manual_applyBtn').html("<#299#>");
...
var $ssid = $("<div>").html(htmlEnDeCode.htmlEncode("<#660#>: " + function(){
...
var $key = $("<div>").html(htmlEnDeCode.htmlEncode("<#661#>: " + wl_item.key_new));
