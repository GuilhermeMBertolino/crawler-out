...
document.getElementById("VPN_conflict_span").innerHTML = "<#3722#>"+pptpd_clients;
}
}
if(yadns_support){
...
$("#GWStatic").html("<#2670#>&nbsp;(<#2768#>&nbsp;"+MaxRule_extend_limit+")");
}
...
alert("<#2628#> " + MaxRule_extend_limit + " <#2629#>");
return false;
}
...
if(policy_flag){
if(!confirm("Remove the client's IP binding will also delete the client's policy in the exception list of <#4348#>. Are you sure you want to delete?"))/*untranslated*/
return false;
}
}
...
if(confirm("<#2620#>")){ //Acceptable DHCP ip pool : "+default_pool[0]+"~"+default_pool[1]+"\n
...
<div class="formfontdesc"><#2654#></div>
<div id="router_in_pool" class="formfontdesc" class="hint-color" style="display:none;"><#2655#><span id="LANIP"></span></div>
<div id="VPN_conflict" class="formfontdesc" class="hint-color" style="display:none;"><span id="VPN_conflict_span"></span></div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#2670#>&nbsp;FAQ</a>
</div>
...
<tr id="dhcpEnable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,1);"><#2653#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,2);"><#2664#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,3);"><#2676#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,4);"><#2674#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,5);"><#2666#> (<#3270#>)</a></th>
<td>
...
<tr>
<th width="200"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,7);"><#2730#> 1</a></th>
<td>
...
<tr>
<th width="200"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,7);"><#2730#> 2</a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,8);"><#2748#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,9);"><#2668#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1642#> (<#3119#>)</a></th>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3280#>">
