...
document.getElementById("tmPath").innerHTML = '<div style="margin-left:5px;color:#FC0"><#1896#></div>';
...
htmlcode += '<tr height="300px"><td colspan="2" class="nohover"><span class="app_name" style="line-height:100%"><#2989#></span></td></tr>\n';
}
...
totalSpace = _total;
availSpace = _avail;
document.getElementById("maxVolSize").innerHTML = "<#1531#>: " + _avail + " GB";
...
<tr>
<td>
<div style="width:450px;font-family:Arial;font-size:13px;font-weight:bolder; margin-top:23px;margin-left:30px;"><#1896#> :</div>
</td>
</tr>
</table>
...
<input class="button_gen" type="button" style="margin-left:40%;margin-top:18px;" onclick="cancel_folderTree();" value="<#287#>">
</div>
</div>
...
<span class="formfonttitle"><#3478#></span>
<span id="returnBtn">
...
2. <#3488#> <br>
3. <#3490#><br>
4. <#3480#> ( <a id="faq2" href="" target="_blank" style="text-decoration:underline;"><#3479#></a> )<br>
5. <a id="faq" href="" target="_blank" style="text-decoration:underline;"><#3484#></a><br>
...
<th><#3481#></a></th>
<td>
<input class="button_gen" onclick="selPartition()" type="button" value="<#822#>"/>
...
<th><#3491#></a></th>
<td>
<input id="tm_vol_size" name="tm_vol_size" maxlength="5" class="input_6_table" type="text" maxLength="8" value="<% nvram_get("tm_vol_size"); %>" onKeyPress="return validator.isNumber(this,event);" placeholder="0" autocorrect="off" autocapitalize="off"/> GB (0: <#2761#>)
