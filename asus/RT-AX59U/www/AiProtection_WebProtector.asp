...
code += '<thead><tr>';
code += '<td colspan="5"><#1735#>&nbsp;(<#2768#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#3274#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1642#> (<#3119#>)</th>';
code += '<th width="40%"><#1324#></th>';
code += '<th width="10%"><#2767#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#4071#>/<#1625#>">';
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3477#></td></tr></table>
</div>
</a>
</div>
</td>
