...
$("#deregister_btn").click(function(){
if(orig_le_enable != "0"){
var confirm_msg = stringSafeGet("<#2698#>");
...
show_alert_block("<#2681#> '" + s.charAt(i) +"' !");
return false;
}
}
return true;
...
document.getElementById("le_desc").innerHTML = "<#2725#>";
...
document.getElementById("cert_status").innerHTML = "<#3765#>";
else
document.getElementById("cert_status").innerHTML = "<#3642#>";
setTimeout("get_cert_info();", 1000);
}
else{
...
$("<div>").addClass("title").html("<#2981#>").appendTo($popup_title_container);
...
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=168"><#2706#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=169"><#2707#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=170"><#2708#></a></div>'
...
<div class="formfontdesc hint-color" id="wan_ip_hide2" style="color:#FC0; display:none;"><#2705#><#2703#></div>
<div class="formfontdesc hint-color" id="lb_note" style="color:#FC0; display:none;"><#2754#></div>
...
<div style="color:#FFCC00">*<#2709#></div>
</td>
</tr>
<tr>
<th id="ddns_wan_unit_th"><#3896#></th>
...
<a id="link" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#2717#></a>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#2713#></a></th>
<td>
...
<th><#1822#></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="ddns_regular_period" value="<% nvram_get("ddns_regular_period"); %>" autocorrect="off" autocapitalize="off"> <#2817#>
</td>
</tr>
<tr style="display:none;">
<th><#2720#></th>
...
<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#2718#>" /></td>
</tr>
...
<div class="cert_status_title"><#3774#> :</div>
