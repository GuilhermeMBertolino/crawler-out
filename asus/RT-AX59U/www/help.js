...
statusmenu ="<span><#3960#></span>".replace("#WAN", "1G WAN");
else
statusmenu ="<span><#3960#></span>".replace("#WAN", "WAN");
}
else if(itemNum == 102){
statusmenu ="<span><#3961#></span>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
}
if(itemNum == 50){
statusmenu ="<span><#697#></span>";
}
if(itemNum == 85){
statusmenu ="<span><#991#></span>";
}
else if(itemNum == 86){
statusmenu ="<span><#994#><br><#983#></span>";
}
else if(itemNum == 87){
statusmenu ="<span><#1006#><br><#984#></span>";
}
else if(itemNum == 88){
statusmenu ="<span><#1008#><br><#986#></span>";
}
else if(itemNum == 89){
...
statusmenu ="<span><#983#></span>";
}
else if(itemNum == 92){
statusmenu ="<span><#984#></span>";
}
else if(itemNum == 93){
statusmenu ="<span><#985#></span>";
}
else if(itemNum == 94){
statusmenu ="<span><#986#></span>";
}
else if(itemNum == 95){
...
statusmenu ="<span><#1011#></span>";
}
else if(itemNum == 104){
statusmenu ="<span><#1010#></span>";
}
if(itemNum == 98){
...
statusmenu += "<div class='StatusHint'><#277#> <#2436#>: </div><span>" + decodeURIComponent(modem_act_provider) + "</span>";
}
else{
statusmenu += "<div class='StatusHint'><#308#></div>";
}
}
if(itemNum == 99){
if(sim_state == "1")
statusmenu += "<div class='StatusHint'><#2891#></div>";
else if(sim_state == "2"){
if( g3err_pin == "1" && pin_remaining_count < 3)
statusmenu += "<div class='StatusHint'>Wrong PIN code. Please input the correct PIN code.</div>";
else
statusmenu += "<div class='StatusHint'><#2852#></div>";
}
else if(sim_state == "3")
statusmenu += "<div class='StatusHint'><#2854#></div>";
else if(sim_state == "4")
statusmenu += "<div class='StatusHint'><#2853#></div>";
else if(sim_state == "5")
statusmenu += "<div class='StatusHint'><#2855#></div>";
else if(sim_state == "6")
statusmenu += "<div class='StatusHint'><#2913#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2888#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2886#></div>";
else
statusmenu += "<div><#2830#></div>";
}
if(itemNum == 24)
...
statusmenu += "<span><#1366#></span>";
else if(itemNum == 12)
statusmenu += "<span><#1365#></span>";
else if(itemNum == 11)
statusmenu += "<span><#1364#></span>";
else if(itemNum == 10)
statusmenu += "<span><#1363#></span>";
if(itemNum == 26)
statusmenu += "<span><#3182#></span>";
if(itemNum == "A"){
statusmenu = "<div class='StatusHint'><#1000#> :</div>";
if(bwdpi_app_rulelist.indexOf('game') != -1){
modeDesc = "<#1337#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('media') != -1){
modeDesc = "<#1338#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('web') != -1){
modeDesc = "<#1007#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('eLearning') != -1){
modeDesc = "<#1009#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('videoConference') != -1){
modeDesc = "<#997#>"; /* untranslated */
}
else{
modeDesc = "<#1795#>"; /* untranslated */
}
...
statusmenu += "<span>" + lineDesc + "</span>";
statusmenu += "<div class='StatusHint'><#2927#> :</div>";
lineDesc = ""; /* Untranslated */
...
wifiDesc = "<b>2.4GHz -</b> <#1626#>";
else
wifiDesc = "<b>2.4GHz -</b> <#1627#>";
if(wlan1_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1626#>";
else
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1627#>";
if(wlan2_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1626#>";
else
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1627#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else if(wl_info.band5g_support){
if(wlan0_radio_flag == "0" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1626#><br><br><b>5 GHz -</b><br><#1626#>";
else if(wlan0_radio_flag == "1" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1627#><br><br><b>5 GHz -</b><br><#1626#>";
else if(wlan0_radio_flag == "0" && wlan1_radio_flag == "1")
wifiDesc = "<b>2.4GHz -</b><br><#1626#><br><br><b>5 GHz -</b><br><#1627#>";
else
wifiDesc = "<b>2.4GHz -</b><br><#1627#><br><br><b>5 GHz -</b><br><#1627#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else{
if(wlan0_radio_flag == "0")
...
statusmenu += "<div><#1769#></div>";
if(monoClient != "monoClient=")
statusmenu += "<div><#3150#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
statusmenu += "<div><#1766#></div>";
}
if(statusmenu != "")
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2988#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2927#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1804#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2421#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2817#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2421#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2817#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2817#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2817#>';
}
statusmenu += ")</span><br>";
}
}
...
statusmenu += "<div class='StatusHint'><#374#>:</div><span><#1766#></span>";
}
if(itemNum == 3){
var eLAN_str = "<#2013#>".replace(/WAN/, "LAN");
(function(){
var wans_mode = '<%nvram_get("wans_mode");%>';
...
this.hint = "<#1638#> : <#3085#> "+wans_lanport;
}
else
this.hint = "<#3172#>";
}
...
statusmenu = "<div class='StatusHint'><#1978#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#2013#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3085#> "+wans_lanport+") - </div>";
else if( wans_dualwan_array[0] == "usb"){
if(gobi_support)
statusmenu += "<div class='StatusHint'><#2901#> - </div>";
else
statusmenu += "<b><#499#> - </b><br>";
}
statusmenu += "<span>" + connect_status.primary.hint + "</span>";
statusmenu += "<div class='StatusHint'><br><#1985#>:</div>";
...
statusmenu = "<div class='StatusHint'><#3409#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#2013#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3085#> "+wans_lanport+") - </div>";
...
return "<#2927#> : <span>0</span> <#2421#> <span>0</span> <#2817#>";
else
return "<#2927#> : <span>"+EHours+"</span> <#2421#> <span>"+EMinutes+"</span> <#2817#>";
}
...
statusmenu = "<span class='StatusClickHint' onclick='cancel_dblog();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2066#></span>";
_caption = "System Diagnostic capture";
}
else if(hint_show_id == 9){ //2015.07 Viz add for bwdpi : Adaptive QoS mode
statusmenu = "<span class='StatusClickHint' onclick='priority_change();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#990#></span><br>";
statusmenu += "<span class='StatusClickHint' onclick='qos_disable();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2027#></span>";
_caption = "<#1000#>";
}
else if(hint_show_id == 8){ //2014.10 Viz add for dsl dslx_diag_state
statusmenu = "<span class='StatusClickHint' onclick='cancel_diag();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2066#></span>";
...
if(gobi_support){
statusmenu += "<#2884#></span>"
_caption = "<#2901#>";
}
else{
statusmenu += "<#2354#></span>"
_caption = "<#499#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotocooler();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2038#></span>";
_caption = "Perfomance Tuning";
}
else if(hint_show_id == 4){
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2353#></span>";
...
statusmenu = "<span class='StatusClickHint' onclick='suspendconn(0, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1855#></span>";
else{
...
statusmenu += "<#3907#></span>";
}
}
else{
if(gobi_support){
if( wans_dualwan_array[0] == "wan")
statusmenu += "<div class='StatusHint'><#2013#>:</div>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3085#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<div class='StatusHint'><#2901#>:</div>";
...
statusmenu += "<b><#3085#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#499#> -</b><br>";
}
...
if(gobi_support){
if( wans_dualwan_array[1] == "wan")
statusmenu += "<div class='StatusHint'><br><#2013#>:</div>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#3085#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2901#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1985#>:</div>";
if( wans_dualwan_array[1] == "wan")
...
statusmenu += "<span class='StatusClickHint' onclick='suspendconn(1, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1855#></span>";
else{
...
statusmenu += "<#1989#> <span style='font-weight:normal'>"+ usbDevicesList[i].deviceName +"</span></div>";
}
}
if(statusmenu == "")
statusmenu = "<span class='StatusHint'><#1856#></span>";
...
statusmenu += "<ol>";
if(based_modelid == "RT-AXE7800")
statusmenu += "<li><#3964#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "1G WAN");
else
statusmenu += "<li><#3964#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "WAN");
statusmenu += "<li><#3965#></li>";
statusmenu += "<li><#3966#></li>";
statusmenu += "<li><#3967#></li>";
statusmenu += "</ol>";
statusmenu += "<#3968#>";
statusmenu += "</div>";
...
return overlib('<#305#>', HAUTO, VAUTO);
...
if (typeof ol_text=='undefined') var ol_text='<#1046#>';
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#1378#>"; }
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#567#></a>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#568#></a>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#569#></a>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#570#></a>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#571#></a>"; }
}
