...
if (Hours != 0)
value += Hours.toString() + " <#2421#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2817#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#3270#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
if(gobi_support){
pri_if = (pri_if == "USB")? "<#2901#>" : pri_if;
sec_if = (sec_if == "USB")? "<#2901#>": sec_if;
if((unit == "0" && pri_if == "<#2901#>") || (unit == "1" && sec_if == "<#2901#>"))
$("#wan_enable_title").text("<#2821#>");
}
...
<p class="formfonttitle_nwm"><#3938#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3936#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3898#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#4209#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3226#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2666#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2649#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2429#></p>
