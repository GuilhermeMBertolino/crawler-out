...
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#2550#></div>';
}
...
var Modified_wired_term = wired_span.replace("<#3502#>", "<#3894#>");
...
var Modified_wireless_term = wireless_span.replace("<#3503#>", "WiFi");
...
if(client.isWL > 0){
overlibStr += "<p><#3993#>:</p>" + isWL_map[client.isWL]["text"].replace("G", " GHz") + " (" + client.rssi + " dBm)";
if(stainfo_support) {
...
overlibStrTmp += "<p><span>.....................................</span></p><p style='margin-top:5px'><#2796#> :</p>";
...
<#3502#>&nbsp;(<b style="font-size:10px;" id="tabWiredNum">0</b>)
</span>
</div>
<script>
...
<#3503#>&nbsp;(<b style="font-size:10px;" id="tabWirelessNum">0</b>)
</span>
