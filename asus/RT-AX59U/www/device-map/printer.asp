...
showtext(document.getElementById("printerStatus"), '<#1766#>');
...
<p class="formfonttitle_nwm"><#3145#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3151#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" id="monoP" style="width:138px;"><#3150#></p>
<input id="monoBtn" type="button" class="button_gen" value="<#4071#>" onclick="cleanTask();">
...
<li><#3143#> <a id="faq" href="" target="_blank" style="text-decoration:underline;">FAQ</a></li>
<li>
<a id="faq1" href="" target="_blank" style="text-decoration:underline;"><#1514#> FAQ</a>
<br>
<a href="http://dlcdnet.asus.com/pub/ASUS/LiveUpdate/Release/Wireless/Printer.zip" style="text-decoration:underline;font-weight:bolder;color:#FC0"><#1911#></a>
</li>
<li>
<a id="faq2" href="" target="_blank" style="text-decoration:underline;"><#2782#> FAQ (Windows)</a>
</li>
<li>
<a id="faq3" href="" target="_blank" style="text-decoration:underline;"><#2782#> FAQ (MAC)</a>
</li>
</ul>
</div>
</form>
