...
if(risk_upnp>0){
document.getElementById('upnp_service').innerHTML = "<a href='"+redirect_page+"' target='_blank'><#274#></a>";
document.getElementById('upnp_service').className = "status_no_risk";
document.getElementById('upnp_service').onmouseover = function(){overHint(13);}
document.getElementById('upnp_service').onmouseout = function(){nd();}
}
...
<tr>
<th>
<div style="font-size:16px;"><#1296#></div>
</th>
</tr>
<td>
<div class="formfontdesc" style="font-size: 14px;"><#1344#></div>
</td>
<tr>
<td>
...
<input class="button_gen" type="button" onclick="close_alert_preference();" value="<#1762#>">
<input class="button_gen" type="button" onclick="apply_alert_preference();" value="<#284#>">
</div>
</td>
</tr>
</table>
...
<a id="faq" style="text-decoration:underline;" href="" target="_blank"><#1390#> FAQ</a>
</div>
</td>
<td>
