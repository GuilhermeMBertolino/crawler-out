...
$(".ipsec_inactive.renew_hint").show().html("<br><#3843#>");
}
}
});
...
html += "<div class='ipsec_connect_status_title'><#3408#></div>";
html += "<div class='ipsec_connect_status_title'><#976#></div>";
html += "<div class='ipsec_connect_status_title'><#3808#> <#3053#></div>";
...
<span class="hint-color"><#3817#></span>
</div>
...
<th><#3801#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3793#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#4071#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#4072#></label>
</td>
</tr>
...
<span class="hint-color">(10~900) <#3270#></span>
</td>
</tr>
</table>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable " style="margin-top:15px;">
...
<div><#3841#> : <span id="cert_issueTo"></span></div>
<div><#3840#> : <span id="cert_issueBy"></span></div>
<div><#3772#> : <span id="cert_expire"></span></div>
<div>
...
<label for="ipsec_export_cert_windows"><#3845#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3846#></label>
</div>
</td>
</tr>
<tr>
