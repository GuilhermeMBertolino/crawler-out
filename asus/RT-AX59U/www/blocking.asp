...
var category_info = [ ["Parental Controls", "1", "<#1314#>", "<#1316#>", "<#1551#>"],
["Parental Controls", "3", "<#1314#>", "<#1316#>", "<#1553#>"],
["Parental Controls", "4", "<#1314#>", "<#1316#>", "<#1554#>"],
["Parental Controls", "5", "<#1314#>", "<#1316#>", "<#1555#>"],
["Parental Controls", "6", "<#1314#>", "<#1316#>", "<#1556#>"],
["Parental Controls", "8", "<#1314#>", "<#1316#>", "<#1557#>"],
["Parental Controls", "9", "<#1314#>", "<#1317#>", "<#1558#>"],
["Parental Controls", "10", "<#1314#>", "<#1317#>", "<#1559#>"],
["Parental Controls", "14", "<#1314#>", "<#1317#>", "<#1560#>"],
["Parental Controls", "15", "<#1314#>", "<#1317#>", "<#1561#>"],
["Parental Controls", "16", "<#1314#>", "<#1317#>", "<#1562#>"],
["Parental Controls", "25", "<#1314#>", "<#1317#>", "<#1563#>"],
["Parental Controls", "26", "<#1314#>", "<#1317#>", "<#1564#>"],
["Parental Controls", "11", "<#1314#>", "<#1318#>", "<#1565#>"],
["Parental Controls", "24", "<#1329#>", "<#1319#>", "<#1566#>"],
["Parental Controls", "51", "<#1329#>", "<#1320#>", "<#1567#>"],
["Parental Controls", "53", "<#1329#>", "<#1321#>", "<#1568#>"],
["Parental Controls", "89", "<#1329#>", "<#1321#>", "<#1569#>"],
["Parental Controls", "42", "<#1329#>", "<#1322#>", "<#1570#>"],
["Parental Controls", "56", "<#1332#>", "<#1334#>", "<#1571#>"],
["Parental Controls", "70", "<#1332#>", "<#1334#>", "<#1572#>"],
["Parental Controls", "71", "<#1332#>", "<#1334#>", "<#1573#>"],
["Parental Controls", "57", "<#1332#>", "<#1335#>", "<#1574#>"],
["Parental Controls", "69", "<#1336#>", "<#1338#>", "<#1575#>"],
["Parental Controls", "23", "<#1336#>", "<#1339#>", "<#1576#>"],
["Home Protection", "91", "Anti-Trojan detecting and blocked", "", "<#1577#>"],
["Home Protection", "2", "Malicious site blocked", "", "<#1552#>"],
["Home Protection", "39", "Malicious site blocked", "", "<#1578#>"],
["Home Protection", "73", "Malicious site blocked", "", "<#1579#>"],
["Home Protection", "74", "Malicious site blocked", "", "<#1580#>"],
["Home Protection", "75", "Malicious site blocked", "", "<#1581#>"],
["Home Protection", "76", "Malicious site blocked", "", "<#1582#>"],
["Home Protection", "77", "Malicious site blocked", "", "<#1583#>"],
["Home Protection", "78", "Malicious site blocked", "", "<#1584#>"],
["Home Protection", "79", "Malicious site blocked", "", "<#1585#>"],
["Home Protection", "80", "Malicious site blocked", "", "<#1586#>"],
["Home Protection", "81", "Malicious site blocked", "", "<#1587#>"],
["Home Protection", "82", "Malicious site blocked", "", "<#1588#>"],
["Home Protection", "83", "Malicious site blocked", "", "<#1589#>"],
["Home Protection", "84", "Malicious site blocked", "", "<#1590#>"],
["Home Protection", "85", "Malicious site blocked", "", "<#1591#>"],
["Home Protection", "86", "Malicious site blocked", "", "<#1592#>"],
["Home Protection", "88", "Malicious site blocked", "", "<#1593#>"],
["Home Protection", "92", "Malicious site blocked", "", "<#1594#>"],
["Home Protection", "94", "Malicious site blocked", "", "<#1595#>"],
["Home Protection", "95", "Malicious site blocked", "", "<#1596#>"]
];
var target_info = {
url: "",
category_id: "",
...
var parental_string = "";
code = "<ul>";
code += "<li><div><span class='desc_info'><#1829#>:</span><br>" + target_info.desc + "</div></li>";
if(casenum != "")
code += "<li><div><span class='desc_info'>URL: </span>" + target_info.url +"</div></li>";
if(target_info.category_type == "Parental Controls")
code += "<li><div><span class='desc_info'><#1324#> :</span>" + target_info.content_category + "</div></li>";
code += "</ul>";
...
code_suggestion = "<ul>";
code_suggestion += "<li><span><#1605#></span></li>";
code_suggestion += "<li><span><#1610#></span></li>";
code_suggestion += '<li><#1384#><a href="https://global.sitesafety.trendmicro.com/index.php" target="_blank"><#1385#></a></li>';
code_suggestion += "</ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#1602#></div>";
code_suggestion = "<ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#909#></div>";
document.getElementById('main_reason').innerHTML = "<#908#>";
code = "";
code += "<div><#919#></div>";
document.getElementById('detail_info').innerHTML = code;
code_suggestion = "<ul>";
code_suggestion += "<li><span><#920#></span></li>";
code_suggestion += "<li><span><#921#></span></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
code_title = "<div class='er_title' style='height:auto;'><#1611#></div>"
code_suggestion = "<ul>";
if(bwdpi_support)
parental_string = "<#3477#>";
else
parental_string = "<#564#>";
code_suggestion += "<li><#1608#> "+ parental_string +" <#1609#></li>";
code_suggestion += "<li><#1610#></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
<div class="prod_madelName"><#945#></div>
<div id="main_reason" class="p1 title_gap"><#1598#></div>
<div ></div>
<div>
...
<div class="p1 title_gap"><#929#></div>
<div>
<div class="p1 title_gap"></div>
<div class="nologin">
...
<div id="go_btn" class='button' style="display:none;"><#1629#></div>
</div>
</body>
</html>
