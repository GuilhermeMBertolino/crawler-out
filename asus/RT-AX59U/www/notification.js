...
var port_mismatch_notice = "<#2591#>";
var port_mismatch_list = "<#2592#>";
if(wan_proto=="v6plus"){
port_confirm = port_confirm.replace("%0$@", "<#2589#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2589#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2589#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2589#>");
}
if(wan_proto=="ocnvc"){
...
break;
case "ssh" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#3086#></a></li>";
break;
case "openvpn" :
...
notification.desc[15] = '<#4227#>';
notification.action_desc[15] = '<#4228#>';
