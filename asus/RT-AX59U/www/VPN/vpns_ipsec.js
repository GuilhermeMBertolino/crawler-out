...
var clientlist_username = {"title":"<#3690#>", "type":"text", "id":"clientlist_username", "need_check":true, "maxlength":32};
...
var clientlist_password = {"title":"<#2438#>", "type":"text", "id":"clientlist_password", "need_check":true, "maxlength":32};
...
var clientlist_ike_options_parm = {"title": "<#3850#>", "id": "clientlist_ike", "options": clientlist_ike_options, "set_value": "3"};
...
var $container = $("<div>");
var $popup_title_container = $("<div>").addClass("popup_title_container").appendTo($container);
$("<div>").addClass("title").html("<#847#>").appendTo($popup_title_container);
var $close_btn = $("<div>").addClass("vpn_icon_all_collect close_btn");
$close_btn.appendTo($popup_title_container);
$close_btn.unbind("click").click(function(e){
e = e || event;
...
$("<div>").addClass("btn_container apply").appendTo($action_container).html("<#1761#>")
...
$("<div>").addClass("btn_container apply").appendTo($action_container).html("<#1780#>")
.unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
location.href = "/ipsec.log";
});
$("<div>").addClass("btn_container apply").appendTo($action_container).html("<#1782#>")
.unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
Get_Component_Pure_Text({"title":"<#3408#>", "text":value.conn_status}).appendTo($content_container);
Get_Component_Pure_Text({"title":"<#976#>", "text":value.conn_period}).appendTo($content_container);
...
$ipsec_preshared_key.show_validate_hint("<#414#>");
...
var ipConflict = checkIPConflict("LAN", ipsecLanIPAddr, ipsecLanNetMask);
if(ipConflict.state) {
$ipsec_clients_start.show_validate_hint("<#2617#>: " + ipConflict.ipAddr + ",\n" + "<#2961#>: " + ipConflict.netLegalRangeStart + " ~ " + ipConflict.netLegalRangeEnd);
$ipsec_clients_start.focus();
return false;
}
...
if($ipsec_dpd.val() == ""){
$ipsec_dpd.show_validate_hint("<#414#>");
$ipsec_dpd.focus();
return false;
}
...
var set_ddns_text = '<a href="/Advanced_ASUSDDNS_Content.asp" target="_blank" style="text-decoration: underline; font-family:Lucida Console;"><#3851#></a>';
...
$(_obj).find("#cert_status").html("<#1527#>");
...
var ipsec_server_addr_parm = {"title":"<#3996#>", "id":"ipsec_server_addr", "text":"-"};
Get_Component_Pure_Text(ipsec_server_addr_parm).appendTo($detail_general);
var ipsec_system_log_parm = {"title":"<#847#>", "id":"ipsec_system_log", "btn_text":"<#1760#>"};
...
var ipsec_preshared_key_parm = {"title":"<#3801#>", "type":"password", "id":"ipsec_preshared_key", "need_check":true, "maxlength":32, "placeholder":"<#3793#>"};
...
var ipsec_exchange_mode_parm = {"title":"<#3806#>", "id":"ipsec_exchange_mode", "text":"<#3807#>"};
Get_Component_Pure_Text(ipsec_exchange_mode_parm).appendTo($detail_general);
var ipsec_dead_peer_detection_parm = {"title":"<#3809#>", "type":"switch", "id":"ipsec_dead_peer_detection"};
...
var ipsec_dpd_parm = {"title":"<#3810#> (10~900 <#3270#>)", "type":"text", "id":"ipsec_dpd", "need_check":true,
...
var ipsec_export_cert_mode_options = [{"text":"<#3845#>","value":"0"},{"text":"<#3846#>","value":"1"}];
...
var ipsec_export_cert_parm = {"title":"<#3732#>", "id":"ipsec_export_cert", "btn_text":"<#1628#>"};
...
show_customize_alert("Certificate Status : <#1528#>");
return;
}
...
var ipsec_renew_cert_parm = {"title":"<#3842#>", "id":"ipsec_renew_cert", "btn_text":"<#295#>", "openHint":"33_2"};
...
$("<div>").addClass("item_hint").attr({"id":"ipsec_renew_hint"}).html("* <#3843#>").hide().appendTo($cert_status_bg);
...
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("<#3887#> (<#2768#>" + htmlEnDeCode.htmlEncode(ipsec_clientlist_limit) + ")");
...
show_customize_alert("<#4432#>".replace("#MAXNUM", ipsec_clientlist_limit));
return false;
}
...
var ipsec_ike_isakmp_parm = {"title":"<#3836#>", "id":"ipsec_ike_isakmp", "text":"500"};
Get_Component_Pure_Text(ipsec_ike_isakmp_parm).appendTo($detail_adv);
var ipsec_ike_isakmp_nat_parm = {"title":"<#3837#>", "id":"ike_isakmp_nat", "text":"4500"};
Get_Component_Pure_Text(ipsec_ike_isakmp_nat_parm).appendTo($detail_adv);
var ipsec_clients_parm = {"title":"<#3721#>",
...
ipsec_local_public_interface_options.push({"text":"<#1978#>","value":"wan"});
if(isSupport("dualwan")){
ipsec_local_public_interface_options.push({"text":"<#1985#>","value":"wan2"});
}
var ipsec_local_public_interface_parm = {"title": "<#3800#>", "id": "ipsec_local_public_interface", "options": ipsec_local_public_interface_options};
