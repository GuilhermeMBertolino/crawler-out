...
$("#restoreInit_text").html(`<#3297#>`);
}
}
function restoreRule(_flag){
var alert_string = "<#3294#>";
...
showtext(document.getElementById("loading_block2"), "<#3251#>");
...
showtext(document.getElementById("loading_block2"), "<#3292#>");
document.getElementById('loading_block3').style.display = "none";
...
/*if(findasus_support){
document.getElementById('loading_block3').innerHTML = "<div><#533#></div>";
}else{*/
document.getElementById('loading_block3').innerHTML = "<div><#466#>.<#443#></div>";
}
},
success: function(){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#506#> - <#511#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3305#></div>
<table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th width="25%" align="right">
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#3299#></a>
</th>
<td colspan = "4">
<div style="float:left;">
<input class="button_gen" onclick="restoreRule('restore');" type="button" value="<#1784#>" name="action1" />
</div>
...
<span><label for="restoreInit" id="restoreInit_text"><#3302#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#3304#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="button_gen" onclick="saveSetting('Router');" type="button" value="<#3304#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#3309#></span></label>
</div>
</div>
...
<div style="float:left;width:80%;">
<span><label for="transfer_ddns"><#1820#></span></label>
</div>
</div>
</div>
</td>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#3308#></a>
</th>
<td colspan = "4">
...
<tr>
<td style="border:0px">
<input type="button" class="button_gen" onclick="selectSetting();" value="<#1789#>"/>
</td>
