...
<div>
<input type="text" name="http_username_x" tabindex="1" class="form_input" maxlength="32" value="" autocapitalize="off" autocomplete="off" placeholder="<#818#>">
</div>
<div id="router_password_tr" class="ie_title">
<div><#565#></div>
</div>
<div>
<input type="password" autocapitalize="off" autocomplete="off" value="" name="http_passwd_x" tabindex="2" class="form_input" maxlength="33" onkeyup="" onpaste="return false;"/ onBlur="" placeholder="<#565#>">
</div>
<div id="router_password_confirm_tr" class="ie_title" >
<div><#1732#></div>
</div>
<div>
<input type="password" autocapitalize="off" autocomplete="off" value="" name="http_passwd_2_x" tabindex="3" class="form_input" maxlength="33" onkeyup="" onpaste="return false;"/ onBlur="" placeholder="<#1732#>">
</div>
...
<div class="btn_bg">
<div id="btn_modify">
<input name="btn_modify" type="button" class="button" tabindex="4" onclick="submitForm();" value="<#292#>">
</div>
