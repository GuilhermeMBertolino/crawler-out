...
add_option(document.form.KnownApps, "<#824#>", 0, 1);
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2549#></td></tr>';
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#500#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#479#></div>
<div class="formfontdesc"><#2160#></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,6);"><#2167#></a></th>
<td>
<input type="radio" value="1" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '1')" <% nvram_match("fw_enable_x", "1", "checked"); %>><#275#>
<input type="radio" value="0" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '0')" <% nvram_match("fw_enable_x", "0", "checked"); %>><#274#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,7);"><#2165#></a></th>
<td>
<input type="radio" value="1" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '1')" <% nvram_match("fw_dos_x", "1", "checked"); %>><#275#>
<input type="radio" value="0" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '0')" <% nvram_match("fw_dos_x", "0", "checked"); %>><#274#>
</td>
</tr>
<tr>
<th align="right"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,1);"><#2210#></a></th>
<td>
<select name="fw_log_x" class="input_option">
<option value="none" <% nvram_match("fw_log_x", "none","selected"); %>><#950#></option>
<option value="drop" <% nvram_match("fw_log_x", "drop","selected"); %>><#3010#></option>
<option value="accept" <% nvram_match("fw_log_x", "accept","selected"); %>><#3007#></option>
<option value="both" <% nvram_match("fw_log_x", "both","selected"); %>><#3008#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,5);"><#2214#></a></th>
<td>
<input type="radio" value="1" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '1')" <% nvram_match("misc_ping_x", "1", "checked"); %>><#275#>
<input type="radio" value="0" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '0')" <% nvram_match("misc_ping_x", "0", "checked"); %>><#274#>
</td>
</tr>
...
<th><#2168#></th>
<td>
<input type="radio" value="1" name="fw_wl_enable_x" <% nvram_match("fw_wl_enable_x", "1", "checked"); %>><#275#>
<input type="radio" value="0" name="fw_wl_enable_x" <% nvram_match("fw_wl_enable_x", "0", "checked"); %>><#274#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="7"><#2223#>&nbsp;(<#2767#>&nbsp;128)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2188#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#2189#></a></th>
<th><#2542#></th>
<th><#2766#></th>
</tr>
<tr>
...
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#505#></div>
<div>
<div class="formfontdesc"><#2221#></div>
<div class="formfontdesc"><#2222#></div>
</div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
<thead>
<tr>
...
<th><#2220#></th>
<td>
<input type="radio" value="1" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "1", "checked"); %>><#275#>
<input type="radio" value="0" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "0", "checked"); %>><#274#>
</td>
</tr>
<tr>
<th><#2548#></th>
...
<th><#1616#></th>
<th><#2224#></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2540#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#2189#></a></th>
<th><#2542#></th>
<th><#2766#></th>
</tr>
