...
var note_str = hint_str1.replace("%1$@", "<#2938#>").replace("%2$@", "IPTV") + " " + hint_str2;
...
document.getElementById("natAccelDesc").innerHTML = "<#2933#>";
}
else{
document.getElementById("natAccelDesc").innerHTML = "<#2929#>";
}
}
else if(mtk_support){
...
var nataccel_status = '<% nat_accel_status(); %>';
if(nataccel == '1' && nataccel_status == '1'){
document.getElementById("MTKnatAccelDesc").innerHTML = "<#2933#>";
}
else{
document.getElementById("MTKnatAccelDesc").innerHTML = "<#2929#>";
}
}
else{
...
if(ctf_disable == 1){
document.getElementById("ctfLevelDesc").innerHTML = "<#2929#>";
}
else{
if(ctf_fa_mode == '2')
...
<div>&nbsp;</div>
<div class="formfonttitle"><#485#> - <#3424#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3428#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr id="jumbo_tr">
<th><#2647#></th>
<td>
<select name="jumbo_frame_enable" class="input_option">
<option class="content_input_fd" value="0" <% nvram_match("jumbo_frame_enable", "0","selected"); %>><#4071#></option>
<option class="content_input_fd" value="1" <% nvram_match("jumbo_frame_enable", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr>
<tr id="ctf_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,2);"><#2927#></a></th>
<td>
<select name="ctf_disable_force" class="input_option" disabled>
<option class="content_input_fd" value="1" <% nvram_match("ctf_disable_force", "1","selected"); %>><#4071#></option>
...
<option class="content_input_fd" value="0" <% nvram_match("qca_sfe", "0","selected"); %>><#4071#></option>
<option class="content_input_fd" value="1" <% nvram_match("qca_sfe", "1","selected"); %>><#4070#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("hwnat", "0","selected"); %>><#4071#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,1);"><#2938#></a></th>
<td>
<select name="lacp_enabled" class="input_option" onchange="check_bonding_policy(this);" disabled>
<option class="content_input_fd" value="0" <% nvram_match("lacp_enabled", "0","selected"); %>><#4071#></option>
<option class="content_input_fd" value="1" <% nvram_match("lacp_enabled", "1","selected"); %>><#4070#></option>
</select>
<div id="lacp_desc" style="display:none"><span id="lacp_note"><#2941#></span><div>
</td>
</tr>
...
<option value="1"><#3427#></option>
<option value="2"><#3426#></option>
</select>
</td>
</tr>
</table>
