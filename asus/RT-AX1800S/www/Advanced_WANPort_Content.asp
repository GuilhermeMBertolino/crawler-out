...
var hint_str = "<#3096#>";
var confirm_str = hint_str.replace("%1$@", conflict_lanport_text).replace("%2$@", "<#489#>").replace("%3$@", "<#2938#>");
...
$("#fo_detection_count_hd").html("<#1951#>");
new_html_str = "<#1949#>".replace("$WANDOG_MAXFAIL", replace_html);
...
$("#fo_detection_count_hd").html("<#2966#>");
$("#wandog_maxfail_setting").html(new_html_str);
}
...
consume_warning_str = "<#306#> "+consume_bytes+" <#307#>";
...
<tr><td colspan="2"><#3396#></td></tr><tr><td colspan="2"><#3397#>&nbsp;:&nbsp;<span id="str_detect_time"></span>&nbsp;<#3269#>.</td></tr>
<tr>
<th style="width:30%;"><#3404#></th>
<td>
<input type="text" name="detect_interval" class="input_3_table" maxlength="1" value=""; placeholder="5" autocorrect="off" autocapitalize="off" onKeyPress="return validator.isNumber(this, event);" onblur="update_str_time();" style="width: 38px; margin: 0px;">&nbsp;&nbsp;<#3269#>
</td>
</tr>
<tr>
<th><#3406#></th>
...
<span id="detect_tail_msg">&nbsp;( Detection Time: <span id="detection_time_value"></span>&nbsp;&nbsp;<#3269#>)</span>
</td>
</tr>
</table>
<div style="padding-bottom:10px;width:100%;text-align:center;">
<input id="yesButton" class="button_gen" type="button" value="<#275#>" onclick="change_detect_settings();">
<input id="noButton" class="button_gen" type="button" value="<#274#>" onclick="remain_origins();">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#489#> - <#312#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#1943#><a id="dualwan_faq" href="" target="_blank" style="margin-left:5px; text-decoration: underline;"><#312#> FAQ</a></div>
<div id="wan_aggre_desc" class="formfontdesc" style="color:#FFCC00; display:none;"><#3961#></div>
...
<input type="radio" name="wans_usb_bk" class="input" value="1" <% nvram_match("wans_usb_bk", "1", "checked"); %>><#275#>
<input type="radio" name="wans_usb_bk" class="input" value="0" <% nvram_match("wans_usb_bk", "0", "checked"); %>><#274#>
</div>
<span id="usb_tethering_hint" style="display: none;"><#1988#></span>
</td>
</tr>
<tr id="wans_mode_tr">
<th><#1960#></th>
...
<option value="fo"><#1961#></option>
<option value="lb" <% nvram_match("wans_mode", "lb", "selected"); %>><#1962#></option>
</select>
<span id="wans_mode_fo" style="margin-left:5px; color:#FFF; display:none;"><#1961#></span>
<span id="fb_span" style="display:none"><input type="checkbox" id="fb_checkbox"><#1945#></span>
<script>
...
<div id="lb_note" style="color:#FFCC00; display:none;"><#1958#></div>
<div id="lb_note2" style="color:#FFCC00; display:none;"><#1959#></div>
</td>
</tr>
...
<option value="1" <% nvram_match("wans_standby", "1", "selected"); %>><#4070#></option>
<option value="0" <% nvram_match("wans_standby", "0", "selected"); %>><#4071#></option>
</select>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1978#>
<input type="radio" value="2" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1985#>
</td>
</tr>
<tr class="ISPProfile">
<th><#1954#></th>
...
<thead>
<tr>
<td colspan="2"><#1977#><div style="font-weight: normal; font-style: italic; margin-top: 5px;"><#2041#></div></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,3);"><#3405#></a></th>
<td id="retry_intervale_setting"><#347#>
<div><span id="consume_bytes_warning" style=""></span></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,5);"><div id="fo_detection_count_hd"><#1951#></div></a></th>
<td id="wandog_maxfail_setting"></td>
</tr>
<tr id="wandog_fb_count_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,6);"><div id="fb_detection_count_hd"><#1948#></div></a></th>
<td id="wandog_fbcount_setting"><#1947#></td>
</tr>
<tr>
<th><#2957#></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullPingTargetList(this);" title="<#3280#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<th><#1983#></th>
<td>
<input type="radio" value="1" name="wans_routing_enable" onClick="enable_lb_rules(this.value)" class="content_input_fd" <% nvram_match("wans_routing_enable", "1", "checked"); %>><#275#>
<input type="radio" value="0" name="wans_routing_enable" onClick="enable_lb_rules(this.value)" class="content_input_fd" <% nvram_match("wans_routing_enable", "0", "checked"); %>><#274#>
</td>
</tr>
</table>
