...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2767#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2627#> " + _createRuleCount + " <#2628#>");
return;
}
...
$titleHtml.html("<#2617#>");/*untranslated*/
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#3005#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2620#>");
return false;
}
}
