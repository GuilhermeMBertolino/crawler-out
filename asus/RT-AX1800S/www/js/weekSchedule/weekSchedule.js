...
$("#" + weekScheduleApi.obj_id + "").find("#timezone_hint").html("* <#2740#>");
}
else
return;
}
...
$no_data_bg.append($("<div>").addClass("no_data_text").html("<#2549#>"));
return $no_data_bg;
},
