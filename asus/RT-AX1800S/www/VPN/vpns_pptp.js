...
var $faq = $("<a/>").attr({"id":"faq", "target":"_blank", "href":faq_href}).html("<#258#> FAQ")
...
$("<div>").addClass("item_hint").html("* <#3734#>").appendTo($container);
return $container;
}
...
var pptpd_clientlist_username = {"title":"<#3689#>", "type":"text", "id":"pptpd_clientlist_username", "need_check":true, "maxlength":64};
...
.val(htmlEnDeCode.htmlEncode());
var pptpd_clientlist_password = {"title":"<#2437#>", "type":"text", "id":"pptpd_clientlist_password", "need_check":true, "maxlength":64};
...
$("<div>").addClass("profile_title_item").append($("<span>").html("Static Route (<#2107#>)")).appendTo($content_container);
var pptpd_sr_ipaddr = {"title":"<#3226#>", "type":"text", "id":"pptpd_sr_ipaddr", "maxlength":15, "openHint":"6_1"};
...
var pptpd_sr_netmask = {"title":"<#3227#>", "type":"text", "id":"pptpd_sr_netmask", "maxlength":15, "openHint":"6_2"};
...
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
var $btn_container_apply = $("<div>").addClass("btn_container apply").html("<#1779#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
testResult.isError = true;
testResult.errReason = "<#3711#> " + clients_start;
}
return testResult;
};
...
if($pptpd_dnsenable_x.hasClass("off")){
if($pptpd_dns1.val() == ""){
$pptpd_dns1.show_validate_hint("<#414#>");
$pptpd_dns1.focus();
return false;
}
...
if($pptpd_dns2.val() == ""){
$pptpd_dns2.show_validate_hint("<#414#>");
$pptpd_dns2.focus();
return false;
}
...
if($pptpd_winsenable_x.hasClass("off")){
if($pptpd_wins1.val() == ""){
$pptpd_wins1.show_validate_hint("<#414#>");
$pptpd_wins1.focus();
return false;
}
...
if($pptpd_wins2.val() == ""){
$pptpd_wins2.show_validate_hint("<#414#>");
$pptpd_wins2.focus();
return false;
}
...
if($pptpd_mru.val() == ""){
$pptpd_mru.show_validate_hint("<#414#>");
$pptpd_mru.focus();
return false;
}
...
if($pptpd_mtu.val() == ""){
$pptpd_mtu.show_validate_hint("<#414#>");
$pptpd_mtu.focus();
return false;
}
...
$pptpd_clients_start.show_validate_hint($pptpd_clients_start.val() + " <#428#>");
$pptpd_clients_start.focus();
return false;
}
$pptpd_clients_end.val($pptpd_clients_end.val().trim());
if($pptpd_clients_end.val() == ""){
$pptpd_clients_end.show_validate_hint("<#414#>");
...
if($pptpd_clientlist_username.val() == ""){
$pptpd_clientlist_username.show_validate_hint("<#414#>");
...
if($pptpd_clientlist_password.val() == ""){
$pptpd_clientlist_password.show_validate_hint("<#414#>");
...
$pptpd_sr_ipaddr.show_validate_hint("<#3724#> " + lan_ipaddr);
$pptpd_sr_ipaddr.focus();
return false;
}
}
...
result = "<#3722#> <b>"+pool_start+" ~ "+pool_end+"</b>";
}
...
var pptpd_ms_network_parm = {"title":"<#3736#>", "type":"switch", "id":"pptpd_ms_network"};
...
var pptpd_broadcast_parm = {"title":"<#3716#>", "type":"switch", "id":"pptpd_broadcast"};
Get_Component_Switch(pptpd_broadcast_parm).appendTo($detail_adv);
$("<div>").attr({"id": "PPTP_broadcast_hint"}).addClass("item_hint").html("* <#3136#>").appendTo($detail_adv).hide();
var pptpd_chap_options = [{"text":"<#241#>","value":"0"},{"text":"MS-CHAPv1","value":"1"},{"text":"MS-CHAPv2","value":"2"}];
var pptpd_chap_parm = {"title": "<#3104#>", "id": "pptpd_chap", "options": pptpd_chap_options, "set_value": "0"};
Get_Component_Custom_Select(pptpd_chap_parm).appendTo($detail_adv);
var pptpd_mppe_options = [{"text":"MPPE-128","value":"1"},{"text":"MPPE-40","value":"4"},{"text":"<#2986#>","value":"8"}];
var pptpd_mppe_parm = {"title": "<#2925#>", "id": "pptpd_mppe", "options": pptpd_mppe_options};
...
var pptpd_dnsenable_x_parm = {"title":"<#402#>", "type":"switch", "id":"pptpd_dnsenable_x", "slide_target":"pptpd_dns"};
...
var pptpd_dns1_parm = {"title":"<#388#>", "type":"text", "id":"pptpd_dns1", "need_check":true, "maxlength":15};
Get_Component_Input(pptpd_dns1_parm).appendTo($pptpd_dns_content_container)
.find("#" + pptpd_dns1_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var pptpd_dns2_parm = {"title":"<#390#>", "type":"text", "id":"pptpd_dns2", "need_check":true, "maxlength":15};
Get_Component_Input(pptpd_dns2_parm).appendTo($pptpd_dns_content_container)
.find("#" + pptpd_dns2_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var pptpd_winsenable_x_parm = {"title":"<#2567#>", "type":"switch", "id":"pptpd_winsenable_x", "slide_target":"pptpd_wins"};
...
var pptpd_wins1_parm = {"title":"<#2565#>", "type":"text", "id":"pptpd_wins1", "need_check":true, "maxlength":15};
Get_Component_Input(pptpd_wins1_parm).appendTo($pptpd_wins_content_container)
.find("#" + pptpd_wins1_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var pptpd_wins2_parm = {"title":"<#2566#>", "type":"text", "id":"pptpd_wins2", "need_check":true, "maxlength":15};
...
var pptpd_clients_parm = {"title":"<#3720#>", "type":"text", "start_id":"pptpd_clients_start", "start_maxlength":15, "end_id":"pptpd_clients_end", "end_maxlength":3,
...
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("<#3886#> (<#2767#>" + htmlEnDeCode.htmlEncode(pptpd_clientlist_limit) + ")");
...
show_customize_alert("<#4432#>".replace("#MAXNUM", pptpd_clientlist_limit));
return false;
}
