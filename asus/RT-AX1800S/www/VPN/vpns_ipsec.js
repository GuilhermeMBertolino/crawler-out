...
var clientlist_username = {"title":"<#3689#>", "type":"text", "id":"clientlist_username", "need_check":true, "maxlength":32};
...
var clientlist_password = {"title":"<#2437#>", "type":"text", "id":"clientlist_password", "need_check":true, "maxlength":32};
...
var clientlist_ike_options_parm = {"title": "<#3849#>", "id": "clientlist_ike", "options": clientlist_ike_options, "set_value": "3"};
...
Get_Component_Pure_Text({"title":"<#3407#>", "text":value.conn_status}).appendTo($content_container);
...
var ipConflict = checkIPConflict("LAN", ipsecLanIPAddr, ipsecLanNetMask);
if(ipConflict.state) {
$ipsec_clients_start.show_validate_hint("<#2616#>: " + ipConflict.ipAddr + ",\n" + "<#2960#>: " + ipConflict.netLegalRangeStart + " ~ " + ipConflict.netLegalRangeEnd);
$ipsec_clients_start.focus();
return false;
}
...
var set_ddns_text = '<a href="/Advanced_ASUSDDNS_Content.asp" target="_blank" style="text-decoration: underline; font-family:Lucida Console;"><#3850#></a>';
...
var ipsec_server_addr_parm = {"title":"<#3995#>", "id":"ipsec_server_addr", "text":"-"};
...
var ipsec_preshared_key_parm = {"title":"<#3800#>", "type":"password", "id":"ipsec_preshared_key", "need_check":true, "maxlength":32, "placeholder":"<#3792#>"};
...
var ipsec_exchange_mode_parm = {"title":"<#3805#>", "id":"ipsec_exchange_mode", "text":"<#3806#>"};
Get_Component_Pure_Text(ipsec_exchange_mode_parm).appendTo($detail_general);
var ipsec_dead_peer_detection_parm = {"title":"<#3808#>", "type":"switch", "id":"ipsec_dead_peer_detection"};
...
var ipsec_dpd_parm = {"title":"<#3809#> (10~900 <#3269#>)", "type":"text", "id":"ipsec_dpd", "need_check":true,
...
var ipsec_export_cert_mode_options = [{"text":"<#3844#>","value":"0"},{"text":"<#3845#>","value":"1"}];
...
var ipsec_export_cert_parm = {"title":"<#3731#>", "id":"ipsec_export_cert", "btn_text":"<#1628#>"};
...
var ipsec_renew_cert_parm = {"title":"<#3841#>", "id":"ipsec_renew_cert", "btn_text":"<#295#>", "openHint":"33_2"};
...
$("<div>").addClass("item_hint").attr({"id":"ipsec_renew_hint"}).html("* <#3842#>").hide().appendTo($cert_status_bg);
...
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("<#3886#> (<#2767#>" + htmlEnDeCode.htmlEncode(ipsec_clientlist_limit) + ")");
...
var ipsec_ike_isakmp_parm = {"title":"<#3835#>", "id":"ipsec_ike_isakmp", "text":"500"};
Get_Component_Pure_Text(ipsec_ike_isakmp_parm).appendTo($detail_adv);
var ipsec_ike_isakmp_nat_parm = {"title":"<#3836#>", "id":"ike_isakmp_nat", "text":"4500"};
Get_Component_Pure_Text(ipsec_ike_isakmp_nat_parm).appendTo($detail_adv);
var ipsec_clients_parm = {"title":"<#3720#>",
...
var ipsec_wins1_parm = {"title":"<#2565#>", "type":"text", "id":"ipsec_wins1", "maxlength":15};
Get_Component_Input(ipsec_wins1_parm).appendTo($detail_adv)
.find("#" + ipsec_wins1_parm.id + "").unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var ipsec_wins2_parm = {"title":"<#2566#>", "type":"text", "id":"ipsec_wins2", "maxlength":15};
...
var ipsec_local_public_interface_parm = {"title": "<#3799#>", "id": "ipsec_local_public_interface", "options": ipsec_local_public_interface_options};
