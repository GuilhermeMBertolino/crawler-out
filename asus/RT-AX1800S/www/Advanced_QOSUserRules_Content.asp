...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2810#> - <#2032#>";
}
else{
document.getElementById('content_title').innerHTML = "<#474#> - QoS";
}
showqos_rulelist();
load_QoS_rule();
...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#824#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#428#>");
return false;
}
}
}
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2790#>");
return false;
}
}
replace_symbol();
...
alert("<#3711#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#2418#></option>';
else
code += '<option value="0"><#2418#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#2417#></option>';
else
code += '<option value="1"><#2417#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2803#></option>';
else
code += '<option value="2"><#2803#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2779#></option>';
else
code += '<option value="3"><#2779#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2780#></option>';
else
code += '<option value="4"><#2780#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#3177#></option>
<option value="3"><#3176#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1615#>&nbsp;(<#2767#>&nbsp;32)</td>
...
<tr>
<th><#1616#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1617#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1618#></div></a></th>
<th><div class="table_text"><#2542#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#3693#></div></a></th>
<th><#1619#></th>
<th><#2766#></th>
</tr>
<tr>
<td width="20%">
<input type="text" maxlength="32" class="input_12_table" style="float:left;width:105px;" placeholder="<#824#>" name="qos_service_name_x_0" onKeyPress="return validator.isString(this, event)" autocorrect="off" autocapitalize="off">
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullQoSList(this);" title="<#3281#>">
...
<img id="pull_arrow_mac" class="pull_arrow"height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3276#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#2418#></option>
<option value='1' selected><#2417#></option>
<option value='2'><#2803#></option>
<option value='3'><#2779#></option>
<option value='4'><#2780#></option>
</select>
</td>
<td width="6%">
