...
$("#dhcpdns_hint_dnspriv").html("<span><#1850#></span>");
...
$("#dotPresets").children().remove().end().append("<option value='-1'><#827#></option>");
...
document.getElementById("yadns_hint").innerHTML = "<span><#4229#></span>";
if(dnspriv_support){
document.getElementById("yadns_hint_dnspriv").style.display = "";
document.getElementById("yadns_hint_dnspriv").innerHTML = "<span><#4229#></span>";
}
}
}
if(gobi_support){
document.getElementById("page_title").innerHTML = "<#3907#>";
document.getElementById("wan_inf_th").innerHTML = "<#3902#>";
}
...
{tag:"#ADGUARD_1",text:"<#393#>"},
{tag:"#ADGUARD_2",text:"<#394#>"},
{tag:"#CLOUDFLARE_1",text:"<#395#>"},
{tag:"#CLOUDFLARE_2",text:"<#396#>"},
{tag:"#CLOUDFLARE_3",text:"<#397#>"}
];
...
else if(obj.options[obj.selectedIndex].text == "<#2906#>"){
...
var msg_iptv = "<#3963#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(cur_wanports_bond));
}
else{
...
if(!is_ipv4 && !is_ipv6) {
alert(document.form.dnspriv_server_0.value + "<#430#>");
document.form.dnspriv_server_0.focus();
return false;
}
...
code +='<tr><td style="color:#FFCC00;" colspan="5"><#2554#></td></tr>';
else{
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='4'><#1768#>";
code += "</td></tr></thead>";
code += "<tr id='tr_default_title' height='40px'>";
code += "<th class='IE8HACK' width='5%'></th>";
code += "<th class='IE8HACK' width='15%'><#716#></th>";
code += "<th class='IE8HACK' width='80%'><#2433#></th></tr>";
...
code += "<th class='IE8HACK' width='5%'></th>";
code += "<th class='IE8HACK' width='15%'><#716#></th>";
code += "<th class='IE8HACK' width='15%'><#2433#></th>";
code += "<th class='IE8HACK' width='65%'><#1832#></th></tr>";
...
var description_temp = DNSService[idx].Description+" <a href='"+DNSService[idx].url+"' target='_blank' style='text-decoration:underline;'> <b><#2762#></b></a>";
...
code += "<input class='button_gen' type='button' onclick='closeDNSListView()' value='<#289#>'>";
code += "<input class='button_gen' type='button' onclick='Update_DNS_service()' style='margin-left:15px;' value='<#1783#>'>";
code += "</div>";
...
DSN_status_info += "<br><b><#1619#>:</b> "+DNSService[DNS_list_index].DNSService; /* Untranslated */
DSN_status_info += "<br><b><#587#>:</b> "+document.form.wan_dns1_x.value+", "+document.form.wan_dns2_x.value; /* Untranslated */
}
else{
DSN_status_info = "<b><#587#>:</b> "+document.form.wan_dns1_x.value; /* Untranslated */
...
function update_map(){
var msg = stringSafeGet("<#2802#>")+" <#1102#>";
if(confirm(msg)){
$.ajax({
url: "/s46reset.cgi",
success: function( response ) {
...
var aftrArray = [
["<#2609#> (dgw.xpass.jp)", "dgw.xpass.jp"], ["transix (gw.transix.jp)", "gw.transix.jp"]
];
...
document.getElementById("wan_s46_dslite_svc_span").innerHTML = (s46_dslite_svc_str=="xpass")? "<#2609#>":s46_dslite_svc_str;
}
setTimeout("update_info();", 1500);
}
}
...
<div id="page_title" class="formfontdesc" style="margin-bottom:0px;"><#2754#></div>
...
<tr>
<th id="wan_inf_th"><#3941#></th>
<td align="left">
<select class="input_option" name="wan_unit" onchange="change_wan_unit(this);"></select>
</td>
</tr>
</table>
<div id="basic_setting_desc" class="formfontdesc" style="margin-bottom:0px; margin-top: 15px;"><#3896#></div>
...
<option value="v6plus" <% nvram_match("wan_proto", "v6plus", "selected"); %>><#2593#></option>
<option value="ocnvc" <% nvram_match("wan_proto", "ocnvc", "selected"); %>><#2592#></option>
...
<div id="s46reset_btn" style="margin-left: 5px;"><input type="button" class="button_gen" onclick="update_map();" value="<#2801#>"></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,22);"><#1996#></a></th>
<td>
<input type="radio" name="wan_nat_x" class="input" value="1" onclick="change_nat(1);" <% nvram_match("wan_nat_x", "1", "checked"); %>><#277#>
<input type="radio" name="wan_nat_x" class="input" value="0" onclick="change_nat(0);" <% nvram_match("wan_nat_x", "0", "checked"); %>><#276#>
</td>
</tr>
<tr id="nat_type_tr" style="display:none;">
<th><#2329#>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="faq_nat" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">FAQ</a></th>
<td>
<select name="nat_type" class="input_option">
<option value="0" <% nvram_match("nat_type", "0", "selected"); %>><#2330#></option>
<option value="1" <% nvram_match("nat_type", "1", "selected"); %>><#2331#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,23);"><#1547#></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">UPnP&nbspFAQ</a></th>
<td>
...
<div id="wanAgg_desc" style="color:#FFCC00;"><#3958#></div>
...
<th><#4076#></th>
<td>
<input type="radio" name="ewan_dot1q" class="input" value="1" onclick="change_dsl_dhcp_enable();" <% nvram_match("ewan_dot1q", "1", "checked"); %>><#277#>
<input type="radio" name="ewan_dot1q" class="input" value="0" onclick="change_dsl_dhcp_enable();" <% nvram_match("ewan_dot1q", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th>VLAN ID</th>
...
<option value="0" <% nvram_match("wan_s46_dslite_mode", "0", "selected"); %>><#783#></option>
<option value="1" <% nvram_match("wan_s46_dslite_mode", "1", "selected"); %>><#2788#></option>
</td>
</tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullaftrList(this);" title="<#3287#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2575#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2597#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,12);"><#587#></a></th>
<td>
<div id="DNS_status"></div>
<div style="margin:10px 0 5px 5px;" class="splitLine_dns"></div>
<div class="assign_dns"><#1905#></div>
<div style="margin:-38px 0 5px 0;text-align:right;"><input type="button" class="button_gen" onclick="Assign_DNS_service()" value="<#288#>"></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,42);">Forward local domain queries to upstream DNS</a></th><td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,43);">Enable DNS Rebind protection</a></th><td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,44);">Enable DNSSEC support</a></th><td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,45);">Validate unsigned DNSSEC replies</a></th><td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,46);">Prevent client auto DoH</a></th><td>
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,35);"><#3929#></a></th>
<td align="left">
<select id="dnspriv_enable" class="input_option" name="dnspriv_enable" onChange="change_dnspriv_enable(this.value);">
<option value="0" <% nvram_match("dnspriv_enable", "0", "selected"); %>><#953#></option>
...
<div id="dnsfilter_hint_dnspriv" style="display:none;"><span><#346#></span></div>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,36);"><#3917#></a></th>
<td>
<input type="radio" name="dnspriv_profile" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'dnspriv_profile', 1)" <% nvram_match("dnspriv_profile", "1", "checked"); %> /><#3919#>
<input type="radio" name="dnspriv_profile" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'dnspriv_profile', 0)" <% nvram_match("dnspriv_profile", "0", "checked"); %> /><#3920#>
</td>
</tr>
<tr style="display:none" id="dot_presets_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,41);"><div class="table_text"><#3915#></a></th>
<td>
...
<thead>
<tr>
<td colspan="5"><#3921#>&nbsp;(<#2772#>&nbsp;8)</td>
</tr>
</thead>
<tr>
<th><a href="javascript:void(0);" onClick="openHint(7,37);"><div class="table_text"><#386#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,38);"><div class="table_text"><#3923#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,39);"><div class="table_text"><#3925#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,40);"><div class="table_text"><#3927#></div></a></th>
<th><#2771#></th>
</tr>
<tr>
...
<thead>
<tr><td colspan="2"><#2573#></td></tr>
</thead>
<tr>
<th width="40%"><#1853#> (<#2979#> 60):</th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,29);"><#3110#></a></th>
<td align="left">
<select class="input_option" name="wan_auth_x" onChange="change_wan_type(document.form.wan_proto.value);">
<option value="" <% nvram_match("wan_auth_x", "", "selected"); %>><#953#></option>
<option value="8021x-md5" <% nvram_match("wan_auth_x", "8021x-md5", "selected"); %>>802.1x MD5</option>
</select></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,4);"><#3695#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,5);"><#581#></a></th>
<td>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd);"><#717#></div>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#891#></a></th>
<td align="left">
...
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#3114#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,7);"><#3134#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,8);"><#3132#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,9);"><#3140#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,10);"><#3118#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);">Host-Uniq (<#2421#>)</a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,17);"><#3138#></a></th>
<td>
<select name="wan_pptp_options_x" class="input_option">
<option value="" <% nvram_match("wan_pptp_options_x", "","selected"); %>><#243#></option>
<option value="-mppc" <% nvram_match("wan_pptp_options_x", "-mppc","selected"); %>><#2992#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,31);"><#3122#></a></th>
<td>
<select name="wan_ppp_echo" class="input_option" onChange="ppp_echo_control();">
<option value="0" <% nvram_match("wan_ppp_echo", "0","selected"); %>><#1628#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,32);"><#3125#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,33);"><#3127#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,34);"><#3129#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);"><#3120#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,15);"><#3121#></a></th>
<td>
...
<tr>
<th ><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,16);"><#3124#></a></th>
<td>
...
<input type="button" class="button_gen" onclick="showMAC();" value="<#263#>">
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,30);"><#1848#></a></th>
<td>
<select name="wan_dhcp_qry" class="input_option">
<option value="0" <% nvram_match(" wan_dhcp_qry", "0","selected"); %>><#1851#></option>
<option value="1" <% nvram_match(" wan_dhcp_qry", "1","selected"); %>><#1849#></option>
<option value="2" <% nvram_match(" wan_dhcp_qry", "2","selected"); %>><#4305#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2020#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#3394#></a></th>
<td>
...
<input class="button_gen" id="apply_btn" onclick="applyRule();" type="button" value="<#286#>"/>
</div>
</td>
</tr>
</td>
