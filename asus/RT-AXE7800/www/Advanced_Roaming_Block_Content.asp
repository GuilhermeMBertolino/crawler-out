...
wlHintHtml += '<div class="prod_madelName"><div class="title_name"><div class="div_td img_gap"><div class="login_img"></div></div><div class="div_td"><#948#></div></div></div>';
...
<div>&nbsp;</div>
<div class="formfonttitle"><#480#> - <#3983#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3203#></div>
...
<th width="30%"><#3204#></th>
<td>
<label><input type="radio" name="enable_roaming" value="1" onclick="enable_roaming_block();" <% nvram_match("rast_static_cli_enable", "1","checked"); %>><#277#></label>
<label><input type="radio" name="enable_roaming" value="0" onclick="enable_roaming_block();" <% nvram_match("rast_static_cli_enable", "0","checked"); %>><#276#></label>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="2"><#3983#>&nbsp;(<#2772#>&nbsp;64)</td>
</tr>
</thead>
<tr>
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1645#> (<#3124#>)</a></th>
<th width="20%"><#2771#></th>
</tr>
<tr>
<td width="80%">
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullWLMACList(this);" title="<#3290#>">
