...
document.getElementById("loginMethod").innerHTML = "<#1077#>";
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 6)?"<#1016#>":"<#982#>";
}
...
<span class="formfonttitle"><#497#> - <#498#><span id="clouddiskstr"> / <#1718#></span></span>
...
<div class="formfontdesc" style="margin-top: 10px;"><#3254#></div>
<div id="smbv1_hint" class="formfontdesc"><#1026#>&nbsp;<#3255#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,2);"><#3321#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,3);"><#3334#></a>
</th>
<td>
...
<option class="content_input_fd" value="0" <% nvram_match("usb_fs_ntfs_sparse", "0","selected"); %>><#4077#></option>
<option class="content_input_fd" value="1" <% nvram_match("usb_fs_ntfs_sparse", "1","selected"); %>><#4076#></option>
</select>
</td>
</tr>
</table>
