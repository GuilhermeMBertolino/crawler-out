...
code += mals_count;
code += '<span style="font-size: 16px;padding-left: 5px;"><#1382#></span>';
...
if(code == ''){
code += '<div style="font-size:16px;text-align:center;margin-top:70px;color:#FC0"><#1315#></div>';
}
...
code += '<div style="display:table-cell;width:180px;padding-right:5px;"><#1880#></div>';
code += '<div style="display:table-cell;width:80px;padding-right:5px;"><#1313#></div>';
code += '<div style="display:table-cell;width:170px;padding-right:5px;"><#1312#></div>';
code += '<div style="display:table-cell;width:200px;padding-right:5px;"><#1311#></div>';
code += '<div style="display:table-cell;width:50px;padding-right:5px;"></div>';
code += '</div>';
if(dataObj == ""){
code += '<div style="text-align:center;font-size:16px;color:#FC0;margin-top:90px;"><#2554#></div>';
}
else{
...
code += '<div style="display:table-cell;width:200px;height:30px;vertical-align:middle;padding-right:5px;text-decoration:underline;cursor:pointer;" title="<#1423#>" onclick="checkEventSafe(\''+ dataObj[eventID].destination[0] +'\');">'+ dataObj[eventID].destination[0] +'</div>';
...
<div style="margin: 16px 24px;font-size:16px;"><#1310#></div>
<div style="display:flex;justify-content: flex-end;margin: 36px 24px;">
<div class="confirm-button" onclick="hideConfirm();"><#289#></div>
<div class="confirm-button" onclick="eraseDatabase();"><#1782#></div>
</div>
</div>
...
<tr>
<td align="left">
<span class="formfonttitle"><#1393#> - <#1390#></span>
</td>
</tr>
</table>
</div>
...
<div style="font-size:16px;margin:0 0 5px 5px;text-align:center"><#1309#></div>
</div>
...
<div style="text-align:center;font-size:16px;"><#1408#></div>
...
<div style="font-size:16px;margin:0 0 5px 5px;text-align:center;"><#1297#></div>
...
<div>
<div style="display:inline-block;margin:5px 10px"><#1382#></div>
</div>
<div style="width:90%">
<div>
...
<div style="text-align:center;font-size:16px;"><#1314#></div>
<div style="display: flex;">
<div style="margin: 0 8px;"><div id="save_icon" class="icon-container icon-save" title="<#1783#>" onclick="download(csvContent, 'MaliciousSitesBlocking.csv', 'data:text/csv;charset=utf-8');"></div></div>
<div style="margin: 0 8px;"><div id="delete_icon" class="icon-container icon-delete" onclick="showEraseConfirm();" title="<#1766#>"></div></div>
...
<div style="font-size: 24px;"><#3977#></div>
<div onclick="hideWhitelistField();"><img src="images/New_ui/icon_close.svg" alt="" style="width:32px;height:32px;cursor:pointer;"></div>
</div>
<div style="color: #CCCCCC;font-size: 16px;margin: 12px 0 24px 0;"><#1391#></div>
<div>
<div style="font-size: 14px;padding: 0 0 2px 4px;"><#1392#></div>
<div>
...
<input type="button" class="button_gen" value="<#1760#>" onclick="addWhitelist();">
</div>
<div style="width:100%;" class="line_horizontal"></div>
<div style="margin-top:24px;">
<span style="font-size: 24px;padding-right:12px;"><#3977#></span>
<span style="font-size: 14px;"><#2971#>: <b id="list_count">0</b> (<#2772#>&nbsp;64)</span>
</div>
...
<div style="display:table-cell;width:180px;padding-right:5px;"><#1880#></div>
<div style="display:table-cell;width:80px;padding-right:5px;"><#1313#></div>
<div style="display:table-cell;width:170px;padding-right:5px;"><#1312#></div>
<div style="display:table-cell;width:200px;padding-right:5px;"><#1311#></div>
