...
x.options[0].text = "<#4049#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#4049#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#4050#>", "upper");
...
x.options[0].text = "<#4050#>";
x.options[0].value = "upper";
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#4049#>", "lower");
...
else if(opts[opts.selectedIndex].text == "WPA2-Personal" || opts[opts.selectedIndex].text == "<#4469#>" || opts[opts.selectedIndex].text == "WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2/WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2-Enterprise")
algos = new Array("AES");
else
...
var auth_array = [["<#4469#>", "owe"], ["WPA3-Personal", "sae"]];
}
else{
