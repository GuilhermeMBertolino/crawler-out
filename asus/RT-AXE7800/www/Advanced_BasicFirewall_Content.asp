...
add_option(document.form.KnownApps, "<#827#>", 0, 1);
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2554#></td></tr>';
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#502#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#481#></div>
<div class="formfontdesc"><#2163#></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,6);"><#2170#></a></th>
<td>
<input type="radio" value="1" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '1')" <% nvram_match("fw_enable_x", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="fw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_enable_x', '0')" <% nvram_match("fw_enable_x", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,7);"><#2168#></a></th>
<td>
<input type="radio" value="1" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '1')" <% nvram_match("fw_dos_x", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="fw_dos_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_dos_x', '0')" <% nvram_match("fw_dos_x", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th align="right"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,1);"><#2213#></a></th>
<td>
<select name="fw_log_x" class="input_option">
<option value="none" <% nvram_match("fw_log_x", "none","selected"); %>><#953#></option>
<option value="drop" <% nvram_match("fw_log_x", "drop","selected"); %>><#3016#></option>
<option value="accept" <% nvram_match("fw_log_x", "accept","selected"); %>><#3013#></option>
<option value="both" <% nvram_match("fw_log_x", "both","selected"); %>><#3014#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(8,5);"><#2217#></a></th>
<td>
<input type="radio" value="1" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '1')" <% nvram_match("misc_ping_x", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="misc_ping_x" class="input" onClick="return change_common_radio(this, 'FirewallConfig', 'misc_ping_x', '0')" <% nvram_match("misc_ping_x", "0", "checked"); %>><#276#>
</td>
</tr>
...
<th><#2171#></th>
<td>
<input type="radio" value="1" name="fw_wl_enable_x" <% nvram_match("fw_wl_enable_x", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="fw_wl_enable_x" <% nvram_match("fw_wl_enable_x", "0", "checked"); %>><#276#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="7"><#2226#>&nbsp;(<#2772#>&nbsp;128)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2191#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#2192#></a></th>
<th><#2547#></th>
<th><#2771#></th>
</tr>
<tr>
...
<div class="formfontdesc" style="font-size:14px;font-weight:bold;margin-top:10px;"><#507#></div>
<div>
<div class="formfontdesc"><#2224#></div>
<div class="formfontdesc"><#2225#></div>
</div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
<thead>
<tr>
...
<th><#2223#></th>
<td>
<input type="radio" value="1" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="ipv6_fw_enable" <% nvram_match("ipv6_fw_enable", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th><#2553#></th>
...
<th><#1619#></th>
<th><#2227#></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2545#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#2192#></a></th>
<th><#2547#></th>
<th><#2771#></th>
</tr>
