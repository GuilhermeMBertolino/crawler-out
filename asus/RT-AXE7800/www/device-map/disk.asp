...
disk_list_array = { "info" : ["<#1868#>", "disk.asp"], "health" : ["<#1861#>", "disk_utility.asp"], "format" : ["<#1775#>", "disk_format.asp"]};
...
<p class="formfonttitle_nwm"><#2925#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#1534#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#3510#>:</p>
...
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#883#>:</p>
<input type="button" class="button_gen" onclick="goUPnP();" value="<#1632#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="aidisk_hyperlink">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1100#>:</p>
<input type="button" class="button_gen" onclick="gotoAidisk();" value="<#1632#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="dmLink" style="display:none;">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1904#>:</p>
<input type="button" class="button_gen" onclick="gotoDM();" value="<#1632#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; "><#3253#>:</p>
<input id="show_remove_button" class="button_gen" type="button" class="button" onclick="remove_disk_call();" value="<#1634#>">
<div id="show_removed_string" style="display:none;"><#3251#></div>
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; " onmouseover="parent.overHint(24);" onmouseout="parent.nd();"><#3289#></p>
...
<li><#1884#><a href="/" target="_parent"><#1885#></a><#1886#></li>
</ul>
</div>
