...
html += "<div class='aimesh_node_setting_info_title'><#4388#></div>";
...
case "ctrl_led" :
html += "<div style='margin-top:10px;'>";
html += "<div class='aimesh_node_setting_info_title'><#4414#></div>";
html += "<div class='aimesh_node_setting_info_content'>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2554#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
parent.$("#amesh_connect_msg").find(".amesh_hint_text.amesh_hint_title").html("<#1144#>");
}
});
});
}
...
code += "</div>";
code += "<div class='amesh_router_info_text'><#2254#>: ";
var re_client_num = 0;
...
code += "<div class='amesh_title offline' onclick='show_offline_msg(event);'><#1656#></div>";
}
code += "</div>";
code += "</div>";
code += "</div>";
...
description += "<#30#>";
description += "<br>";
description += "<a id='aimesh_link' style='font-weight:bolder;text-decoration:underline;color:#FC0;' href='' target='_blank'><#31#></a>";
...
$amesh_cancel.attr({"type" : "button", "value" : "<#1782#>"});
...
$amesh_wait_search_text.html("<#1137#>");
...
$amesh_cancel.attr({"type" : "button", "value" : "<#289#>"});
$amesh_action_bg.append($amesh_cancel);
$amesh_cancel.click(
function() {
initial_amesh_obj();
...
$amesh_apply.attr({"type" : "button", "value" : "<#286#>"});
...
$amesh_wpa3_text.append($("<div>").html("<#1118#>"));
...
$aimesh_illustration_bg.append(gen_text("<#1215#>", "backhaul_router"));
$aimesh_illustration_bg.append(gen_text("<#1143#>", "backhaul_node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1143#>", "backhaul_node for_dsl"));
}
...
result_text += "<li><#1140#></li>";
result_text += "<li><#1141#></li>";
result_text += "<li><#1209#></li>";
result_text += "<li><#1142#></li>";
result_text += "<li><#1130#></li>";
result_text += "</ol>";
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
result_text += "<#1127#>";
result_text += "<div style='margin-left: 20px;'>1. <#1128#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1129#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1130#></div>";
result_text += "<div style='margin-left: 20px;'>4. <#1131#></div>";
}
if(ameshRouter_support && ameshNode_support)
result_text += "b. ";
if(ameshNode_support){
result_text += "<#1132#>";
result_text += "<div style='margin-left: 20px;'>1. <#1133#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1134#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1135#></div>";
}
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
$aimesh_illustration_bg.append(gen_text("Modem", "modem"));
$aimesh_illustration_bg.append(gen_text("<#1215#>", "router"));
$aimesh_illustration_bg.append(gen_text("<#1143#>", "node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1143#>", "node for_dsl"));
}
var $amesh_clear_bg = $('<div>');
$amesh_clear_bg.css("clear", "both");
$aimesh_illustration_bg.append($amesh_clear_bg);
...
$amesh_apply.attr({"type" : "button", "value" : "<#1782#>"});
$amesh_action_bg.append($amesh_apply);
$amesh_apply.click(
function() {
initial_amesh_obj();
...
hint += "<#1288#>";
hint += "<br>";
hint += "<#1289#> <#1290#>".replace("#RE_MAXNUM", cfg_re_maxnum);
hint += "<br>";
hint += "<#1291#>";
...
code += "<div class='aimesh_node_static_info_title'><#1179#></div>";
...
code += "<div class='aimesh_node_static_info_title'><#386#></div>";
...
code += "<div>";
code += "<div class='aimesh_node_setting_info_title'><#465#></div>";
code += "<div id='aimesh_node_macaddr' class='aimesh_node_setting_info_content'></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#1165#></div>";
code += "<select id='aimesh_node_connection_priority' class='aimesh_node_input_select'>";
code += "<option value='3' class='aimesh_node_input_select_option'><#243#></option>";
code += "<option value='2' class='aimesh_node_input_select_option'><#1155#></option>";
code += "</select>";
code += "<div id='aimesh_node_connection_priority_hint' class='aimesh_node_setting_info_content'><#1781#></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#282#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_connection_type' class='text_hyperlink'></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#2263#></div>";
...
code += "<div class='aimesh_node_setting_info_title'><#479#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_usb_app' class='text_hyperlink'><#477#></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
...
code += "<th class='IE8HACK' width=" + aimesh_node_client_info_width[0] + "><#1646#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#3038#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3726#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3901#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2930#>");
...
block_chars_hint = block_chars_array[i] + " <#2627#>";
}
if(block_chars_hint != "") {
...
function() {
if(node_info.online == "1" && re_path > 0) {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1765#>" : "<#2930#>";
...
var led_table = ["<#1765#>", "<#2784#>", "<#2808#>", "<#2422#>"];
...
$amesh_close.attr({"type" : "button", "value" : "<#1765#>"});
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2554#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#4387#>" : nodeClientObj.ip;
...
option_array.push(gen_option_attr("3", ((_eap_flag) ? "<#243#> (<#1160#>)" : "<#243#>"), "auto"));
...
var option_text = (_eap_flag) ? "<#1170#>" : "<#1169#>";
...
option_array.push(gen_option_attr("2", ((_eap_flag) ? "<#1159#>" : "<#1155#>"), "eth"));
return option_array;
}
...
<tr>
<td colspan="2">
<div class="amesh_title"><#1122#></div>
<div class="amesh_title amesh_content"><#1125#></div>
</td>
</tr>
...
<tr>
<td width="50%">
<div class="amesh_title amesh_help" onclick="scenario();"><#1123#></div>
</td>
<td width="50%" height="32px;" style="text-align:center;">
<input id="searchReadyOnBoarding" type="button" class="button_gen" value="<#1789#>" onClick="searchReadyOnBoarding();">
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2554#></div></div>
</td>
</tr>
<tr>
</table>
