...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1807#> ";
if (Hours != 0)
value += Hours.toString() + " <#2425#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2822#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#3275#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
showtext(document.getElementById("dualwan_mode"), "<#1964#>");
...
wanlink_type_conv = "<#2593#>";
else if(wanlink_type_conv == "ocnvc")
wanlink_type_conv = "<#2592#>";
...
$("#ipv6_DNS_servers").prop('title', `<#2583#>`);
...
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#492#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#1947#></p>
...
<p class="formfonttitle_nwm"><#3943#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3941#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1966#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3903#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#4214#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3231#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2670#></p>
...
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1632#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1636#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1632#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
</table>
...
<p class="formfonttitle_nwm"><#845#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2653#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2433#></p>
...
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#703#>" style="float:right;margin: 5px 0;">
</td>
</tr>
</table>
</form>
