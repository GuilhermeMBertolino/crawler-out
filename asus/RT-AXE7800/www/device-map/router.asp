...
'triBandSmartConnect': [['0', '<#3359#>', '0']],
'dualBand6GHzSmartConnect': [['0', '2.4 / 5 GHz', '0'], ['2', '6 GHz', '2']],
'dualBandSmartConnect': [['0', '<#3358#>', '0']],
'triBand5GHzSmartConnect': [['0', '2.4 GHz', '0'], ['1', '5GHz Smart Connect', '1']],
'GT6-5GHzSmartConnect': [['2', '2.4 GHz', '2'], ['1', '5GHz Smart Connect', '1']],
'triBandMeshSmartConnect': [['0', '<#3358#>', '0'], ['2', '5 GHz-2', '2']],
'GT6triBandMeshSmartConnect': [['0', '<#3358#>', '0'], ['1', '5 GHz-2', '1']],
'triBand6GHzMeshSmartConnect': [['0', '<#3358#>', '0'], ['2', '6 GHz', '2']],
...
code += '<div class="button-right"><input type="button" class="button_gen" value="<#703#>" onclick="gotoSiteSurvey();"></div>';
code += '</div>';
...
code += '<div class="info-title"><#3356#></div>';
code += '<select class="input_option" onchange="enableSmartConnect(this.value)">'
code += '<option value="0" '+ (variable.smart_connect_x === '0' ? 'selected': '') +'><#1765#>';
code += '<option value="1" '+ (variable.smart_connect_x !== '0' ? 'selected': '') +'><#1772#>';
code += '</select>'
...
code += '<div class="info-block">';
code += '<div class="info-title"><#663#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4009#></div>';
...
code += '<span><#1116#> <a id="wl'+ unit +'_wpa3FaqLink" class="faq-link" target="_blank" href="">FAQ</a></span>';
code += '</div>';
}
...
if(!system.lyraHideSupport){
code += '<div class="info-block">';
code += '<div class="info-title"><#959#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4198#></div>';
...
if(dwb_info.mode == '1'){
if(isSupport("wifi6e")){
_optionArray = [['<#953#>', '0'], ['<#3359#>', '1'], ['<#3358#>', '3']];
}
else{
_optionArray = [['<#953#>', '0'], ['<#3358#>', '1']];
if(isSupport("amas_fronthaul_network")){
var fh_ap_enabled = httpApi.nvramGet(["fh_ap_enabled"]).fh_ap_enabled;
if(fh_ap_enabled == "2")
_optionArray[1][0] = '<#3359#>';
}
}
}
else{
...
_optionArray = [['<#953#>', '0'], ['<#3359#>', '1'], ['2.4 GHz and 5 GHz Smart Connect', '3']];
if(variable['smart_connect_selif_x'] == '3'){
_smart_connect_x = '3';
}
}
else{
_optionArray = [['<#953#>', '0'], ['<#3359#>', '1'], ['5GHz Smart Connect', '2']];
}
}
}
else{
...
<div id="status_tab" class="tab-block" onclick="switchTab(this.id)"><#833#></div>
