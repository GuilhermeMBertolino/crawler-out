...
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#1833#><img src="/images/InternetScan.gif"></div>';
else
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#2554#></div>';
}
...
var Modified_wired_term = wired_span.replace("<#3507#>", "<#3899#>");
...
var Modified_wireless_term = wireless_span.replace("<#3508#>", "WiFi");
...
if(client.isITunes)
overlibStr += "<p><#1834#></p>YES";
if(client.isWL > 0){
overlibStr += "<p><#3998#>:</p>" + isWL_map[client.isWL]["text"].replace("G", " GHz") + " (" + client.rssi + " dBm)";
if(stainfo_support) {
overlibStr += "<p>Tx Rate:</p>" + ((client.curTx != "") ? client.curTx : "-");
overlibStr += "<p>Rx Rate:</p>" + ((client.curRx != "") ? client.curRx : "-");
overlibStr += "<p><#979#>:</p>" + client.wlConnectTime;
}
}
return overlibStr;
}
...
overlibStrTmp += "<p><span>.....................................</span></p><p style='margin-top:5px'><#2800#> :</p>";
...
<#3507#>&nbsp;(<b style="font-size:10px;" id="tabWiredNum">0</b>)
</span>
</div>
<script>
...
<#3508#>&nbsp;(<b style="font-size:10px;" id="tabWirelessNum">0</b>)
</span>
...
<input type="button" id="refresh_list" class="button_gen" value="<#1785#>" style="margin-left:70px;">
<script>
