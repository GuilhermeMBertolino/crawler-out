...
var led_table = ["<#1628#>", "<#3160#>", "<#2808#>", "<#2422#>"];
...
var code = '';
if(system.INTELplatform){
code += '<div class="info-title"><#4388#></div>';
...
code += '<div class="info-block"><div class="info-title"><#2653#></div><div class="info-content">'+ _lanIP +'</div></div>';
code += '<div class="info-block"><div class="info-title"><#3061#></div><div class="info-content">'+ variable.secret_code +'</div></div>';
if(variable.serial_no != ''){
code += '<div class="info-block"><div class="info-title"><#3292#></div><div class="info-content">'+ variable.serial_no +'</div></div>';
}
code += '<div class="info-block"><div class="info-title">LAN <#465#></div><div class="info-content">'+ variable.lan_hwaddr +'</div></div>';
if(system.band2gSupport){
if(system.modelName === 'GT-AXE16000'){
code += '<div class="info-block"><div class="info-title">2.4 GHz <#465#></div><div class="info-content">'+ variable.wl3_hwaddr +'</div></div>';
}
else if(odmpid === 'GT6'){
code += '<div class="info-block"><div class="info-title">2.4 GHz <#465#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
else{
code += '<div class="info-block"><div class="info-title">2.4 GHz <#465#></div><div class="info-content">'+ variable.wl0_hwaddr +'</div></div>';
}
}
if(system.triBandSupport){
if(system.band6gSupport){
code += '<div class="info-block"><div class="info-title">5 GHz <#465#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">6 GHz <#465#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
else{
if(system.modelName == 'MAP-AC2200')
{
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#465#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#465#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
}
else if(odmpid === 'GT6'){
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#465#></div><div class="info-content">'+ variable.wl0_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#465#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
}
else
{
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#465#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#465#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
}
}
...
code += '<div class="info-block"><div class="info-title">LAN <#465#></div><div class="info-content">'+ variable.wl3_hwaddr +'</div></div>';
}
...
var modeDesc = ['<#4221#>', '<#4223#>', '<#4225#>', '', '<#1629#>'];
code += '<div class="division-block"><#4214#></div>';
...
code += '<div class="info-content"><#2254#> '+ yadns_clients[i] +'</div>';
code += '</div>';
}
}
...
var code = '<div class="division-block"><#839#></div>';
code += '<div>';
for(i=0;i<core_num;i++){
...
var code = '<div class="division-block"><#841#></div>';
code += '<div>';
code += '<div>';
code += '<div class="display-flex flex-a-center ram-content">';
code += '<div class="ram-text-width"><#842#></div>';
code += '<div class="ram-text-width"><#843#></div>';
code += '<div class="ram-text-width"><#844#></div>';
code += '</div>';
code += '<div class="display-flex flex-a-center ram-content">';
...
$("<div>").css({"margin-bottom":"6px"}).html("<#3093#> <#3094#>").appendTo($hint_text_bg);
...
$("<div>").css({"margin-bottom":"6px"}).html("<#3095#> :").appendTo($hint_text_bg);
var $help_item = $("<ol>").css({"margin":"0", "padding":"0", "margin-left":"24px"}).appendTo($hint_text_bg);
$("<li>").css({"color":"#64737c"}).html("<#3100#>".replace("#ETHCABLE", "Cat 5e")).appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3096#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3097#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3098#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3099#>").appendTo($help_item);
var $action_bg = $("<div>").css({"margin-top":"18px", "text-align":"right"}).appendTo($popup_hint_bg);
var $action_ok = $("<input/>").attr({"id":"action_ok", "type":"button", "value":"<#1782#>"}).addClass("button_gen");
...
$("#phy_ports").append('<div class="division-block" style="position:relative;"><span><#835#></span><div class="port_status_notice_icon"></div></div>');
...
$("<div>").addClass("conn").html("<#279#>").appendTo($port_status_icon_desc);
$("<div>").addClass("warn").html("<#3004#>").appendTo($port_status_icon_desc);/* untranslated */
$("<div>").addClass("unplug").html("<#838#>").appendTo($port_status_icon_desc);
if(show_notice){
...
var code = '<div class="division-block"><#835#></div>';
code += '<div>';
code += '<div class="display-flex flex-a-center table-header">';
code += '<div class="port-block-width table-content"><#836#></div>';
code += '<div class="port-block-width table-content"><#833#></div>';
code += '</div>';
...
var code = '<div class="division-block"><#4464#></div>';
code += '<div>';
code += '<div class="display-flex flex-a-center table-header">';
code += '<div class="port-block-width table-content"><#833#></div>';
code += '<div class="port-block-width table-content">Tx (<#2491#>)</div>';
code += '<div class="port-block-width table-content">Rx (<#2491#>)</div>';
code += '</div>';
...
<div id="wireless_tab" class="tab-block" onclick="switchTab(this.id)"><#480#></div>
<div id="status_tab" class="tab-block tab-click" onclick="switchTab(this.id)"><#833#></div>
