...
<div class="formfontdesc"><#2175#></div>
<div id="kwf_desc2" class="formfontdesc"><#2176#></div>
...
<th><#2174#></th>
<td>
<input type="radio" value="1" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "1", "checked"); %>><#1772#>
<input type="radio" value="0" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "0", "checked"); %>><#1769#>
</td>
</tr>
</table>
