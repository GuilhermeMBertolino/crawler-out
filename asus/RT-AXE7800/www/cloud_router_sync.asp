...
var invite_content = "";
var sync_rule_desc = "";
document.getElementById('invite_desc').innerHTML = "<#3460#>: " + htmlEnDeCode.htmlEncode(document.form.router_sync_desc.value);
...
document.getElementById('invite_rule').innerHTML = "<#3462#>: "+sync_rule_desc;
...
document.getElementById('invite_captcha').innerHTML = "<#3248#>: None";
else
document.getElementById('invite_captcha').innerHTML = "<#3248#>: "+captcha;
}
...
document.getElementById('invite_desc').innerHTML = "<#3460#>: "+router_synclist_desc[j];
...
document.getElementById('invite_captcha').innerHTML = "<#3248#>: "+ router_synclist_captcha[j];
...
mailtoCode += "<#3463#>%0D%0A".replace(/ /g, "%20");
mailtoCode += document.getElementById('invite_share').innerHTML.replace(/ /g, "%20") + "%0D%0A";
mailtoCode += '"><div onmouseover="" style="margin-right:15px;background-image:url(images/cloudsync/mail_send.png);background-repeat:no-repeat;width:64px;height:64px;"></div><div style="font-size:12px;margin-top:3px;margin-right:17px;"><#3291#></div></a>';
return mailtoCode;
}
...
var hint_string = "";
hint_string += "<#3242#><br><br>";
hint_string += "<#3244#><br><br>";
hint_string += "<#3243#>";
...
<input class="button_gen" type="button" onclick="confirm_folderTree();" value="<#1782#>">
</div>
</div>
<div id="invitation_block" class="panel_folder" >
<table><tr><td>
<div class="machineName" style="width:200px;font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:20px;margin-left:30px;"><#2475#></div>
</td></tr></table>
...
<tr>
<td>
<div style="margin-top:10px;width:440px;"><#3463#></div>
</td>
</tr>
<tr>
<td>
...
<input class="button_gen" type="button" onclick="close_invitation_block();" value="<#1765#>" style="margin-top:15px;margin-left:200px">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle">AiCloud 2.0 - <#3296#></div>
...
3. <#3454#><br>
4. <#3455#><br>
<span class="formfontdesc" id="wan_ip_hide2" style="color:#FFCC00;display:none;margin-left:0px;">5. <#3456#></span>
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<div style="margin-left:15px;margin-top:3px;"><#3458#></div>
</td>
</tr>
</table>
</div>
...
<tr style="height:40px;">
<th>
<div style="margin-top:5px;"><#3465#></div>
</th>
<td>
<input type="text" id="PATH" class="input_25_table" style="height: 25px;" name="cloud_dir" value="" autocorrect="off" autocapitalize="off">
<input name="button" type="button" class="button_gen" onclick="get_disk_tree();" value="<#1720#>"/>
<div id="noUSB" style="color:#FC0;display:none;margin-left:3px;font-size:12px;line-height:140%;"><#2994#></div>
</td>
</tr>
<tr style="height:40px;">
<th>
<div style="margin-top:5px;"><#1723#></div>
</th>
<td>
<select name="router_sync_rule" class="input_option" style="height:27px;">
<option value="0"><#3245#></option>
<option value="1"><#3247#></option>
<option value="2"><#3246#></option>
</select>
<span>
...
<option value="0"><#953#></option>
<option value="1"><#2789#></option>
<option value="2"><#3457#></option>
</select>
...
<input type="button" id="applyButton" class="button_gen" value="<#1776#>" onclick="domain_name_select();">
...
<a href="cloud_main.asp"><span style="font-family:Lucida Console;text-decoration:underline;color:#FC0"><#3239#></span></a><br><#3240#>
</div>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="6" id="cloud_synclist"><#3464#></td>
</tr>
</thead>
<tr>
<th width="10%"><#3163#></th>
<th width="25%"><#2522#></a></th>
...
<input name="applybutton" id="applybutton" type="button" class="button_gen" onclick="location.href='cloud_syslog.asp'" value="<#1763#>" style="word-wrap:break-word;word-break:normal;">
</div>
</div>
</td>
</tr>
