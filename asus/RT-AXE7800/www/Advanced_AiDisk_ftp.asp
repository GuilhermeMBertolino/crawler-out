...
document.getElementById("loginMethod").innerHTML = "<#1070#>";
...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='' target='_blank' style='text-decoration:underline;color:#FC0;'><#2045#></a>";
...
confirm_str_off= "<#1729#>"; //"<#1731#>"+ By Viz 2011.09
confirm_str_on = "<#1733#>";
}
else if(protocol == "ftp"){
status = this.FTP_status;
confirm_str_off = "<#1730#>";
confirm_str_on = "<#1734#>";
...
account_group_menu_code += '<div class="noAccount" id="noAccount"><#2995#></div>\n'
else{
...
alert("<#2632#> " + maximum_account + " <#2633#>");
return false;
}
else
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 11)?"<#1016#>":"<#982#>";
}
...
if(ftp_ssl_support){
document.getElementById("TLS_disabled").innerHTML = (flag==1)? "":"<#3690#>";
...
<div class="formfontdesc" style="margin-top: 10px;"><#2253#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,1);"><#3329#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,9);"><#3323#></a>
</th>
<td>
<select name="ftp_lang" class="input_option">
<option value="CN" <% nvram_match("ftp_lang", "CN", "selected"); %>>GBK</option><!-- <#3326#> -->
<option value="TW" <% nvram_match("ftp_lang", "TW", "selected"); %>>Big5</option><!-- <#3325#> -->
<option value="EN" <% nvram_match("ftp_lang", "EN", "selected"); %>>UTF-8</option><!--<#3324#>-->
<option value="RU" <% nvram_match("ftp_lang", "RU", "selected"); %>><#3327#></option>
<option value="CZ" <% nvram_match("ftp_lang", "CZ", "selected"); %>><#3328#></option>
</select>
</td>
</tr>
</table>
...
<td><div id="createAccountBtn" title="<#1016#>"></div></td>
<td><div id="deleteAccountBtn" title="<#1828#>"></div></td>
<td><div id="modifyAccountBtn" title="<#2924#>"></div></td>
</tr>
<tr id="trPMGroup" style="display:none;">
<td>
<select name="" id="user_type" class="input_option" onchange="switchUserType(this.value);">
<option value="group"><#3056#></option>
<option value="account"><#3058#></option>
</select>
</td>
</tr>
</table>
...
<table align="right">
<tr>
<td><div id="createFolderBtn" title="<#1018#>"></div></td>
<td><div id="deleteFolderBtn" title="<#1831#>"></div></td>
<td><div id="modifyFolderBtn" title="<#2928#>"></div></td>
</tr>
</table>
</td>
</tr>
...
<div id="machine_name" class="machineName"><#948#></div>
</td>
<td>
...
<input name="changePermissionBtn" id="changePermissionBtn" type="button" value="<#1783#>" class="button_gen_dis" disabled="disabled">
</div>
</td>
</tr>
</table>
