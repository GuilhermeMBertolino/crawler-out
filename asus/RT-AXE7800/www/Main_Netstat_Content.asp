...
<script>
option_netstat = new Array("<#3345#>","<#3349#>","<#3350#>","<#3348#>","<#3351#>","<#3346#>","<#1887#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2953#>", "<#2954#>", "<#2955#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2975#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2967#> - Netstat</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2975#></div>
...
<option value="-a"><#3345#></option>
<option value="-ta"><#3349#></option>
<option value="-ua"><#3350#></option>
<option value="-w"><#3348#></option>
<option value="-xa"><#3351#></option>
<option value="-l"><#3346#></option>
<option value="-r"><#1887#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2982#> IP</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3283#>">
...
<option value="-r state" selected><#2960#></option>
<option value="-r src"><#2958#></option>
<option value="-r dst"><#2956#></option>
<option value="-r src-port"><#2959#></option>
<option value="-r dst-port"><#2957#></option>
</select>
</td>
</tr>
