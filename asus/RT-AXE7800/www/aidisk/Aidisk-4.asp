...
case "0":
showtext(document.getElementById("dummyShareStr"), "\"<#3423#>\"");
break;
case "1":
showtext(document.getElementById("dummyShareStr"), "\"<#3424#>\"");
break;
case "2":
showtext(document.getElementById("dummyShareStr"), "\"<#3425#>\"");
break;
}
}
...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#3426#></td>
</tr>
<tr>
...
<input type="button" id="finish" value="<#1773#>" class="button_gen">
</div>
</td>
</tr>
</table>
