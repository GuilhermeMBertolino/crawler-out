...
<thead>
<tr>
<td><span style="color:#FFF"><#1828#>: </span><span style="color:#FFF" id="selected_account"></span><img src="../images/button-close.gif" onClick="parent.hidePop('OverlayMask');"></td>
</tr>
</thead>
<tbody>
<tr>
<td height="80" class="hint_word"><#1827#></td>
</tr>
</tbody>
<tr>
<td height="30" align="right">
<input id="Submit" type="button" class="button_gen" value="<#1766#>">
<input id="Cancel" type="button" class="button_gen" value="<#289#>">
</td>
</tr>
</table>
</form>
