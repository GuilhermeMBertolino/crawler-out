...
statusmenu ="<span><#3965#></span>".replace("#WAN", "1G WAN");
else
statusmenu ="<span><#3965#></span>".replace("#WAN", "WAN");
}
else if(itemNum == 102){
statusmenu ="<span><#3966#></span>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
}
if(itemNum == 50){
statusmenu ="<span><#700#></span>";
}
if(itemNum == 85){
statusmenu ="<span><#994#></span>";
}
else if(itemNum == 86){
statusmenu ="<span><#997#><br><#986#></span>";
}
else if(itemNum == 87){
statusmenu ="<span><#1009#><br><#987#></span>";
}
else if(itemNum == 88){
statusmenu ="<span><#1011#><br><#989#></span>";
}
else if(itemNum == 89){
...
statusmenu ="<span><#1013#></span>";
}
if(itemNum == 98){
var signal = parseInt(sim_signal);
if(isNaN(signal) || signal <= 0){
statusmenu += "<div class='StatusHint'><#2866#></div>";
}
else if(usb_state == 2 && usb_sbstate == 0 && usb_auxstate != 1){
statusmenu += "<div class='StatusHint'><#279#> <#2440#>: </div><span>" + modem_act_provider + "</span>";
}
else{
...
if(itemNum == 99){
if(sim_state == "1")
statusmenu += "<div class='StatusHint'><#2896#></div>";
else if(sim_state == "2"){
if( g3err_pin == "1" && pin_remaining_count < 3)
statusmenu += "<div class='StatusHint'>Wrong PIN code. Please input the correct PIN code.</div>";
else
statusmenu += "<div class='StatusHint'><#2857#></div>";
}
else if(sim_state == "3")
statusmenu += "<div class='StatusHint'><#2859#></div>";
else if(sim_state == "4")
statusmenu += "<div class='StatusHint'><#2858#></div>";
else if(sim_state == "5")
statusmenu += "<div class='StatusHint'><#2860#></div>";
else if(sim_state == "6")
statusmenu += "<div class='StatusHint'><#2918#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2893#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2891#></div>";
else
statusmenu += "<div><#2835#></div>";
}
if(itemNum == 24)
...
statusmenu += "<span>" + lineDesc + "</span>";
statusmenu += "<div class='StatusHint'><#2932#> :</div>";
lineDesc = ""; /* Untranslated */
...
wifiDesc = "<b>2.4GHz -</b><br><#1629#><br><br><b>5 GHz -</b><br><#1629#>";
else if(wlan0_radio_flag == "1" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1630#><br><br><b>5 GHz -</b><br><#1629#>";
else if(wlan0_radio_flag == "0" && wlan1_radio_flag == "1")
wifiDesc = "<b>2.4GHz -</b><br><#1629#><br><br><b>5 GHz -</b><br><#1630#>";
else
...
statusmenu += "<div><#1772#></div>";
if(monoClient != "monoClient=")
statusmenu += "<div><#3155#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2993#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2932#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1807#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2425#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2822#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2425#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2822#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2822#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2822#>';
}
statusmenu += ")</span><br>";
}
}
...
statusmenu += "<div class='StatusHint'><#376#>:</div><span><#1769#></span>";
}
if(itemNum == 3){
...
this.hint = "<#1641#> : <#3090#> "+wans_lanport;
}
else
this.hint = "<#3177#>";
}
...
statusmenu = "<div class='StatusHint'><#1981#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#2016#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3090#> "+wans_lanport+") - </div>";
else if( wans_dualwan_array[0] == "usb"){
if(gobi_support)
statusmenu += "<div class='StatusHint'><#2906#> - </div>";
else
statusmenu += "<b><#501#> - </b><br>";
}
statusmenu += "<span>" + connect_status.primary.hint + "</span>";
statusmenu += "<div class='StatusHint'><br><#1988#>:</div>";
...
statusmenu = "<div class='StatusHint'><#3414#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#2016#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3090#> "+wans_lanport+") - </div>";
...
if( statusmenu == "" )
statusmenu = "<div class='StatusHint'><#2994#></div>";
return overlib(statusmenu, OFFSETX, -160, LEFT, DELAY, 400);
});
}
if( statusmenu != "" )
...
return "<#2932#> : <span>0</span> <#2425#> <span>0</span> <#2822#>";
else
return "<#2932#> : <span>"+EHours+"</span> <#2425#> <span>"+EMinutes+"</span> <#2822#>";
}
...
statusmenu = "<span class='StatusClickHint' onclick='cancel_dblog();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2069#></span>";
_caption = "System Diagnostic capture";
}
else if(hint_show_id == 9){ //2015.07 Viz add for bwdpi : Adaptive QoS mode
statusmenu = "<span class='StatusClickHint' onclick='priority_change();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#993#></span><br>";
statusmenu += "<span class='StatusClickHint' onclick='qos_disable();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2030#></span>";
_caption = "<#1003#>";
}
else if(hint_show_id == 8){ //2014.10 Viz add for dsl dslx_diag_state
statusmenu = "<span class='StatusClickHint' onclick='cancel_diag();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2069#></span>";
...
if(gobi_support){
statusmenu += "<#2889#></span>"
_caption = "<#2906#>";
}
else{
statusmenu += "<#2357#></span>"
_caption = "<#501#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotocooler();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2041#></span>";
_caption = "Perfomance Tuning";
}
else if(hint_show_id == 4){
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2356#></span>";
...
statusmenu = "<span class='StatusClickHint' onclick='suspendconn(0, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1858#></span>";
else{
...
statusmenu += "<#3912#></span>";
}
}
else{
if(gobi_support){
if( wans_dualwan_array[0] == "wan")
statusmenu += "<div class='StatusHint'><#2016#>:</div>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3090#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<div class='StatusHint'><#2906#>:</div>";
...
statusmenu += "<b><#3090#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#501#> -</b><br>";
}
...
if(gobi_support){
if( wans_dualwan_array[1] == "wan")
statusmenu += "<div class='StatusHint'><br><#2016#>:</div>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#3090#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2906#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1988#>:</div>";
if( wans_dualwan_array[1] == "wan")
...
statusmenu += "<span class='StatusClickHint' onclick='suspendconn(1, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1858#></span>";
else{
...
statusmenu += "<#1992#> <span style='font-weight:normal'>"+ usbDevicesList[i].deviceName +"</span></div>";
}
}
if(statusmenu == "")
statusmenu = "<span class='StatusHint'><#1859#></span>";
...
statusmenu += "<ol>";
if(based_modelid == "RT-AXE7800")
statusmenu += "<li><#3969#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "1G WAN");
else
statusmenu += "<li><#3969#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "WAN");
statusmenu += "<li><#3970#></li>";
statusmenu += "<li><#3971#></li>";
statusmenu += "<li><#3972#></li>";
statusmenu += "</ol>";
statusmenu += "<#3973#>";
statusmenu += "</div>";
...
if (typeof ol_text=='undefined') var ol_text='<#1049#>';
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#1381#>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<#570#>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<#571#>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<#572#>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<#573#>"; }
}
else{
if (nScore >= 0 && nScore < 20) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#569#></a>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#570#></a>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#571#></a>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#572#></a>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#573#></a>"; }
}
