...
$(".ipsec_inactive.renew_hint").show().html("<br><#3848#>");
}
}
});
...
html += "<div class='ipsec_connect_status_title'><#3413#></div>";
html += "<div class='ipsec_connect_status_title'><#979#></div>";
html += "<div class='ipsec_connect_status_title'><#3813#> <#3058#></div>";
...
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1764#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1783#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1785#>"/>
</div>
</div>
...
<span class="hint-color"><#3822#></span>
</div>
...
<th><#850#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1763#>"/>
</td>
</tr>
<tr class="ipsec_setting_content">
<th><#885#></th>
...
<th><#3806#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3798#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<span class="hint-color"><#2110#></span>
</td>
</tr>
<tr>
<th><#392#></th>
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#4076#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#4077#></label>
</td>
</tr>
...
<span class="hint-color">(10~900) <#3275#></span>
</td>
</tr>
</table>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable " style="margin-top:15px;">
...
<th><#3737#></th>
<td>
<div><#833#> : <span id="cert_status"></span></div>
<div><#3846#> : <span id="cert_issueTo"></span></div>
<div><#3845#> : <span id="cert_issueBy"></span></div>
<div><#3777#> : <span id="cert_expire"></span></div>
<div>
<input class="button_gen_dis ipsec_active export" type="button" value="<#1631#>">
<span class="ipsec_inactive"><#831#></span>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_windows" class="input" value="0" checked>
<label for="ipsec_export_cert_windows"><#3850#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3851#></label>
</div>
</td>
</tr>
<tr>
...
<span class="ipsec_inactive renew_hint"><#831#></span>
