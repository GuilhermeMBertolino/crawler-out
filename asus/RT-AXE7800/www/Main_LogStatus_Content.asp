...
<div>&nbsp;</div>
<div class="formfonttitle"><#850#> - <#514#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2354#></div>
...
<tr>
<th><#2353#></a></th>
<td><span id="boot_days"></span> <#1807#> <span id="boot_hours"></span> <#2425#> <span id="boot_minutes"></span> <#2822#> <span id="boot_seconds"></span> <#3275#></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11,1)"><#2741#></a></th>
<td>
...
<div class="hint-color"><#2742#></div>
</td>
</tr>
</table>
</form>
<div style="margin-top: 5px; text-align: center;"><input class="button_gen" onclick="applySettings();" type="button" value="<#286#>" /></div>
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1764#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1783#>" class="button_gen">
</form>
</td>
</tr>
</table>
