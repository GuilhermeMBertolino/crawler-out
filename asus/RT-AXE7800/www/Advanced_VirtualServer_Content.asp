...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='" + usb_port_conflict_faq + "' target='_blank' style='text-decoration:underline;color:#FC0;'><#2045#></a>";
...
add_option(document.form.KnownGames, "<#827#>", 0, 1);
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2554#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2556#>&nbsp;(<#2772#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1619#></th>';
html += '<th width="15%"><#2558#></th>';
html += '<th width="15%"><#2560#></th>';
html += '<th width="17%"><#2561#></th>';
html += '<th width="8%"><#2547#></th>';
html += '<th width="17%"><#2555#></th>';
html += '<th width="6%"><#3173#></th>';
html += '<th width="6%"><#1766#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1981#></option>")
.append("<option value='1'><#1988#></option>")
...
$("#vts_port_x").parent().parent().find('th').html('<#2558#><div class="setup_info_icon" style="display:none;"></div>');
if((wan_proto == "v6plus" || wan_proto == "ocnvc") && s46_ports_check_flag && array_ipv6_s46_ports.length > 1){
$(".setup_info_icon").show();
$(".setup_info_icon").click(
function() {
...
<div>&nbsp;</div>
<div class="formfonttitle"><#491#> - <#494#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div>
<div id="ftpPortConflict" class="formfontdesc" style="display:none;color:#FFCC00;"></div>
<div class="formfontdesc"><#2544#></div>
<ul style="margin-left:-25px; *margin-left:10px;">
<div class="formfontdesc"><li><#2201#></div>
<div class="formfontdesc" id="FTP_desc"><li><#2173#></div>
</ul>
</div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#494#>&nbspFAQ</a>
</div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2760#></div>
...
<tr>
<th><#2543#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3889#>">
</div>
</td>
</tr>
</tbody>
...
<tr>
<th><#2558#><div class="setup_info_icon" style="display:none;"></div></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2560#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2561#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/arrow-down.gif" align="right" onclick="pullLANIPList(this);" title="<#3284#>">
...
<input class="button_gen" type="button" onclick="cancelProfile();" value="<#289#>">
<input id="saveProfile" class="button_gen" type="button" value="<#1782#>">
</div>
</div>
<div id="footer"></div>
</form>
