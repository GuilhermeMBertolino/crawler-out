...
code +='<thead><tr><td colspan="4"><#3369#></td></tr></thead>';
code +='<tr id="band_text"><th width="20%"><#2470#></th>';
if(start_band_idx == '1'){
if(band6g_support){
...
code +='<td>';
code +='<input onclick="change_lb(1,'+i+');" type="radio" name="wl'+i+'_bsd_steering_balance" value="1"><#277#>';
code +='<input onclick="change_lb(0,'+i+');" type="radio" name="wl'+i+'_bsd_steering_balance" value="0"><#276#>';
code +='</td>';
}
code +='</tr>';
code +='<tr><th><#3370#></th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#3018#></option>';
code +='<option value="1" class="content_input_fd"><#3017#></option>';
code +='</select></td>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_ld_t" style="display:none;"><#1628#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th><#3059#></th>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_gd_t" style="display:none;"><#1628#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#1504#></option>';
...
code +='<thead><tr><td colspan="4"><#3365#></td></tr></thead>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_ld_t" style="display:none;"><#1628#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th><#3059#></th>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_gd_t" style="display:none;"><#1628#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
code +='<tr id="target_band_text"><th width="20%"><#2471#></th>';
if('<% nvram_get("smart_connect_x"); %>' != 2 && (wl_info.band5g_2_support || wl_info.band6g_support)){
for(i = start_band_idx; i < wl_info.wl_if_total; i++){
...
vht_desc = ["<#1504#>","AC only","not-allowed"];
vht_value = [0,1,2];
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2967#> - <#3364#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3362#></div>
<div style="text-align:right;margin-top:-36px;padding-bottom:3px;"><input type="button" class="button_gen" value="<#3706#>" onClick="pop_clientlist_listview(true)"></div>
...
<th width="20%"><#3368#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="windows_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#3275#>
</td>
</tr>
<tr>
<th><#3366#></th>
...
<th><#3367#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="dwell_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#3275#>
</td>
</tr>
</table>
<div class="apply_gen">
<input type="button" id="restoreButton" class="button_gen" value="<#3306#>" onclick="restoreRule();">
