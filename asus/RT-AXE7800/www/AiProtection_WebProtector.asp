...
var category_name = ["<#1317#>", "<#1332#>", "<#1335#>", "<#1339#>"];
var sub_category_name = [["<#1319#>", "<#1320#>", "<#1321#>"],
["<#1322#>", "<#1323#>", "<#1324#>", "<#1325#>", "<#1326#>"],
["<#1337#>", "<#1338#>"],
["<#1340#>", "<#1341#>", "<#1342#>"]];
var category_desc = ["<#1318#>",
"<#1333#>",
"<#1336#>",
"<#1343#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1738#>&nbsp;(<#2772#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#3279#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1645#> (<#3124#>)</th>';
code += '<th width="40%"><#1327#></th>';
code += '<th width="10%"><#2771#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#4076#>/<#1628#>">';
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#566#> - <#1316#></div>
</td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1316#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3482#></td></tr></table>
</div>
</a>
</div>
</td>
...
<span><#1334#></span>
<div>
<a id="faq" href="" style="text-decoration:underline;" target="_blank"><#566#> FAQ</a>
</div>
</td>
</tr>
</table>
