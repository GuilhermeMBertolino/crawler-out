...
desc += "<#46#>";
desc += "<br>";
desc += "<span style=\"color:#FC0\"><#1845#></span>";
}
else
desc = "<#533#><br/><span style=\"color:#FC0\"><#1844#></span>";
$("#mode_desc").html(desc);
clearTimeout(id_WANunplungHint);
$("#Unplug-hint").css("display", "none");
...
pstaDesc += "<#549#>";
pstaDesc += "<br><#550#>";
pstaDesc += "<br/><span style=\"color:#FC0\"><#1846#></span>";
...
document.getElementById("wl0_desc_name").innerHTML = "2.4 GHz - <#824#>";
...
<input type="radio" value="1" id="smart_connect_t" name="smart_connect_t" class="input" onclick="return change_smart_con(this.value)" <% nvram_match("smart_connect_x", "1", "checked"); %>><#881#>
</td>
</tr>
<tr>
<td style="font-style:normal;font-size:13px;font-weight:bold;">
...
<tr>
<div class="description_down"><#814#></div>
</tr>
<tr>
<div class="QISGeneralFont" align="left"><#770#></div>
</tr>
<tr>
<div style="width: 640px; *width: 640px; height: 2px;margin:5px;*margin-left:-5px;" class="splitLine"></div>
</tr>
<tr>
<th width="180" id="wl0_desc_name">2.4GHz - <#824#></th>
<td class="QISformtd"></td>
</tr>
<tr>
<th width="180">
<span onmouseout="return nd();" onclick="openHint(0, 22);" style="cursor:help;"><#663#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span>
</th>
<td class="QISformtd">
...
<th id="wl_unit_field_1_1" width="180">5GHz - <#824#> </th>
<td class="QISformtd">
<input type="checkbox" id="sync_with_2ghz" name="sync_with_2ghz" class="input" onclick="setTimeout('Sync_2ghz(2);',0);" checked="checked"><span id="syncCheckbox"><#730#></span>
</td>
</tr>
...
<th id="5g2_title" width="180">5 GHz-2 - <#824#> </th>
<td class="QISformtd" id="wl_unit_field_4_2">
<input type="checkbox" id="sync_with_5ghz" name="sync_with_5ghz" tabindex="8" class="input" onclick="setTimeout('Sync_5ghz(2);',0);" checked="checked"><span id="syncCheckbox_5_2"><#730#></span>
</td>
</tr>
<tr id="wl_unit_field_5" style="display:none;">
<th width="180"><span onmouseout="return nd();" onclick="openHint(0, 22);" style="cursor:help;"><#663#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span></th>
<td class="QISformtd">
...
<tr>
<td colspan="2">
<div class="QISGeneralFont" ><#771#></div>
</td>
</tr>
</table>
...
<div class="formfontdesc"><#539#></div>
</td>
</tr>
...
<td>
<div id="Senario" >
<div id="Unplug-hint" style="border:2px solid red; background-color:#FFF; padding:3px;margin:0px 0px 0px 150px;width:250px; position:absolute; display:block; display:none;"><#934#></div>
</div>
<div class="apply_gen">
<input name="button" type="button" class="button_gen" onClick="saveMode();" value="<#1783#>">
</div>
</td>
</tr>
</table>
