...
<div>
<div class="policy_title"><#214#></u></b></div>
<div class="policy_desc"><#215#></div>
...
<div>
<div class="policy_title"><#154#></u></b></div>
<div class="policy_desc"><#155#></div>
<div class="policy_law">
<ol>
<li><#156#>
<ol>
...
Title: `<#3004#>`,
HTML: `<div class="d-flex flex-column gap-1">
<div class="thirdparty-pp-desc1"><#4494#></div>
<div class="thirdparty-pp-desc2"><#4495#></div>
<div class="thirdparty-pp-desc3"><#4496#></div>
</div>`,
Feature: {
'Speedtest': {
...
setTimeout(() => {
if (top.document.querySelector('policy-modal') != null) {
top.window.scrollTo(0, 0);
}
}, 2000);
...
top.document.getElementById('policy_popup_modal').appendChild(this.element);
}
}
}
...
top.window.scrollTo(0, 0);
setTimeout(() => {
if (top.document.querySelector('policy-withdraw-modal') != null) {
top.window.scrollTo(0, 0);
}
}, 2000);
top.document.body.style.overflow = 'hidden';
...
top.window.scrollTo(0, 0);
setTimeout(() => {
if (top.document.querySelector('policy-update-modal') != null) {
top.window.scrollTo(0, 0);
}
}, 2000);
top.document.body.style.overflow = 'hidden';
