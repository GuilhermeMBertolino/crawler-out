...
var $scan_title = $("<div>").addClass("scan_title").appendTo($scan_qr_code_block).html("<#4487#>");
...
$("<label>").attr("for","https_redirect_hint").html("<#4492#>").appendTo($cb_text_bg);
var $btn_bg = $("<div>").addClass("btn_bg").appendTo($action_bg);
var $btn_no = $("<div>").html("<#276#>").appendTo($btn_bg);
...
var $btn_yes = $("<div>").html("<#277#>").appendTo($btn_bg);
