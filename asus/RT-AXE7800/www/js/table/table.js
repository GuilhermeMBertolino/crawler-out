...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2772#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2632#> " + _createRuleCount + " <#2633#>");
return;
}
...
$titleHtml.html("<#2622#>");/*untranslated*/
...
$actionButtonCancelHtml.html("<#289#>");
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#3011#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2625#>");
return false;
}
}
