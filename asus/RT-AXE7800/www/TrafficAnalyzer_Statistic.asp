...
if(show_refresh){
document.getElementById('statistic_hint').innerHTML = "* <#3531#>";
}
else{
document.getElementById('statistic_hint').innerHTML = "* <#3530#>";
}
...
var description = "";
if(type == "router"){
document.getElementById('top_client_title').innerHTML = "<#465#>:";
if(period == "monthly"){
description = "<#3524#>";
}
...
if(top5_info == ""){
if(type == "router")
document.getElementById('top_client_name').innerHTML = "<#3517#>";
else
document.getElementById('top_client_name').innerHTML = "<#3516#>";
document.getElementById('top_client_traffic').innerHTML = "<#3518#>";
}
else{
...
if(type == "router")
code = "<option value='all' selected><#3514#></option>";
else
code = "<option value='all' selected><#3513#></option>";
top5_client_array = [];
top5_app_array = [];
...
code += '<th colspan="4"><#1645#>: '+ mac +'</th>';
else
code += '<th colspan="4"><#1645#>: '+ getClientCurrentName(mac); +'</th>';
}
else{
...
if(type == "router"){
code += "<th style='width:55%;text-align:left;'><#3515#></th>";
}
else{
code += '<th style="width:55%;text-align:left;"><#1645#></th>';
}
code += '<th style="width:15%;text-align:right;"><#3019#></th>';
code += '<th style="width:15%;text-align:right;"><#3015#></th>';
code += '<th style="width:15%;text-align:right;"><#3509#></th>';
code += '</tr>';
...
code = '<div style="width:110px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#3517#></div>';
}
else{
...
if(document.getElementById('duration_option').value == "monthly"){
document.getElementById('total_traffic_title').innerHTML = "<#3529#>";
}
else if(document.getElementById('duration_option').value == "weekly"){
document.getElementById('total_traffic_title').innerHTML = "<#3536#>";
}
else{ //daily
document.getElementById('total_traffic_title').innerHTML = "<#3528#>";
}
document.getElementById('current_traffic_title').innerHTML = "<#3526#>";
document.getElementById('current_traffic_percent_title').innerHTML = "<#3534#>";
}
...
<div class="formfontdesc"><#3527#></div>
<div style="margin-left:10px;">
<label style="font-size:16px;"><#3406#>:</label>
<input class="input_12_table" id="datepicker" value="">
<div id="statistic_hint" class="hint-color" style="text-align:right;margin-top:-21px;padding-right:15px;font-size:14px;">* <#3530#></div>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#3405#>:</div>
</td>
<td>
<div id="router" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter_pressed" onclick="switch_content(this);"><#3054#></div>
</td>
<td>
<div id="apps" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter" onclick="switch_content(this);"><#1512#></div>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#3407#>:</div>
</td>
<td>
<select class="input_option" id="traffic_option" onChange="change_traffic_direction(this);">
<option value="both" selected><#3014#></option>
<option value="down"><#3015#></option>
<option value="up"><#3019#></option>
</select>
</td>
<td>
<select class="input_option" id="duration_option" onChange="switch_date_type(this);">
<option value="monthly"><#1871#></option>
<option value="weekly"><#1883#></option>
<option value="daily" selected><#1863#></option>
</select>
</td>
<td>
...
<div onclick="change_top5_clients(0);" style="width:100px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#3517#></div>
</td>
<td>
...
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD" id="top_client_title"><#465#>:</th>
<td style="font-size:14px;" id="top_client_name"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#3535#>:</th>
<td style="font-size:14px;" id="top_client_traffic"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#3532#> :</th>
<td></td>
</tr>
</table>
...
<tr>
<td colspan="3">
<div class="hint-color" style="font-size:16px;text-align:center;" id="info_block_title"><#3522#></div>
</td>
</td>
</table>
</div>
