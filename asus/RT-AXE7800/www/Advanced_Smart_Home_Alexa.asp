...
var Amazon_URLs = [
{ "Region": "<#1481#>", "WebSite": "https://www.amazon.com.au/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1482#>", "WebSite": "https://www.amazon.ca/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1483#>", "WebSite": "https://www.amazon.fr/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1484#>", "WebSite": "https://www.amazon.de/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1485#>", "WebSite": "https://www.amazon.in/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1486#>", "WebSite": "https://www.amazon.it/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1487#>", "WebSite": "https://www.amazon.co.jp/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1488#>", "WebSite": "https://www.amazon.es/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1489#>", "WebSite": "https://www.amazon.com/ASUS-ROUTER/dp/B07285G1RK" },
{ "Region": "<#1490#>", "WebSite": "https://www.amazon.co.uk/ASUS-ROUTER/dp/B07285G1RK" }
]
function initial(){
show_menu();
...
document.getElementById("formfonttitle").innerHTML = "<#1500#>";
}
...
$("#alexa_ex1").html("<#1472#>".replace("ASUS ROUTER", "MY ROUTER"));
$("#alexa_ex2").html("<#1473#>".replace("ASUS ROUTER", "MY ROUTER"));
$("#alexa_ex3").html("<#1474#>".replace("ASUS ROUTER", "MY ROUTER"));
...
if(Amazon_URLs[i].Region == "<#1489#>")
selected = true;
else
selected = false;
if(is_OP_sku) {
if (Amazon_URLs[i].Region == "<#1481#>")
selected = true;
else
selected = false;
}
...
document.getElementById("thirdparty_pp").innerHTML=`<#4494#>`.replace("%1$@", thirdpartyPolicy).replace("[aa]%2$@[/aa]", `<a onclick="showThirdPartyPolicy('${thirdpartyPolicy}')" style="text-decoration: underline;cursor: pointer;">Alexa Terms of Use</a>`);
})
...
<div>&nbsp;</div>
<div id="formfonttitle" class="formfonttitle">Alexa & IFTTT - <#1500#></div>
<div id="divSwitchMenu" style="margin-top:-40px;float:right;"><div style="width:150px;height:30px;float:left;border-top-left-radius:8px;border-bottom-left-radius:8px;" class="block_filter_pressed"><div class="tab_font_color" style="text-align:center;padding-top:5px;font-size:14px"><#1500#></div></div><div style="width:110px;height:30px;float:left;border-top-right-radius:8px;border-bottom-right-radius:8px;" class="block_filter"><a href="Advanced_Smart_Home_IFTTT.asp"><div class="block_filter_name">IFTTT</div></a></div></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="div_table">
<div class="div_tr">
<div class="div_td div_desc" style="width:55%">
<div style="font-weight:bolder;font-size:16px;padding:20px 40px"><#1469#></div>
<div style="padding:0px 40px;font-family:Arial, Helvetica, sans-serif;font-size:13px;">
<span><#1470#></span>
<p style="font-size:13px;padding-top: 20px;font-style:italic;"><#1471#></p>
<p id="alexa_ex1" style="font-size:13px;padding-left: 20px;font-style:italic;">“<#1472#>”</p>
<p id="alexa_ex2" style="font-size:13px;padding-left: 20px;font-style:italic;">“<#1473#>”</p>
<p id="alexa_ex3" style="font-size:13px;padding-left: 20px;font-style:italic;">“<#1474#>”</p>
<a id="faq" href="" style="font-family:Arial, Helvetica, sans-serif;font-size:13px;padding-top: 2px;padding-left: 20px;font-style:italic;text-decoration: underline;cursor:pointer;" target="_blank"><#1478#></a>
...
<div style="text-align:center;padding-top:35px;font-family:Arial, Helvetica, sans-serif;font-style:italic;font-weight:lighter;font-size:18px;"><#1493#></div>
...
<input class="button_gen" style="margin-top: 10px;" type="button" onclick="window.open(document.form.service_region.value);" value="<#1778#>">
</div>
</div>
<div class="div_tr">
...
<span style="text-decoration:underline; cursor: pointer;" onclick="get_activation_code();"><#1501#></span>
</div>
</div>
<div class="div_tr">
<div class="div_td title_num_div">
...
<div class="div_td step_div"><#1502#></div>
</div>
...
<tr>
<th colspan="2">
<div style="font-size:14px;padding-bottom:8px;"><#1479#></div>
</th>
</tr>
<tr>
<td colspan="2">
...
<input class="button_gen" type="button" onclick="close_alert('alert_pin');" value="<#1765#>">
</div>
</td>
</tr>
</table>
