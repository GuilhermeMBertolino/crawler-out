...
var category_title = ["", "<#996#>", "<#1008#>", "<#1000#>", "<#1010#>","<#995#>", "<#1002#>", "<#1012#>"];
...
$("#dualwan_primary_title").html("<#1981#> - "+dualwan_primary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_primary_title").html("<#1981#> - "+dualwan_primary_display);
}
...
$("#dualwan_secondary_title").html("<#1988#> - "+dualwan_secondary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_secondary_title").html("<#1988#> - "+dualwan_secondary_display);
}
...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2815#> - <#1004#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#3183#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#3182#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#476#> - <#2815#>";
...
alert("<#3718#> "+ (qos_xobw_orig/1024).toFixed(2));
...
alert("<#3718#> "+(qos_xobw1_orig/1024).toFixed(2));
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2795#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#3077#>&nbsp;(<#2772#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1738#>&nbsp;(<#2772#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#3279#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1504#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1504#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2982#></th>';
else
code += '<th style="width:330px"><#2982#></th>';
code += '<th style="width:130px"><#1910#></th>';
code += '<th style="width:130px"><#3648#></th>';
code += '<th style="width:90px"><#2771#></th>';
code += '</tr>';
...
code += '<input type="text" style="margin-left:10px;float:left;width:255px;" class="input_20_table" name="PC_devicename" onkeyup="device_filter(this);check_field();" placeholder="<#1300#>" autocorrect="off" autocapitalize="off" autocomplete="off">';
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3282#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#2554#></td></tr>';
}
else{
...
<!--[if lte IE 6.5.]><script>alert("<#1468#>");</script><![endif]-->
</div>
...
<tr>
<div class="description_down"><#1003#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#1005#></div>
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2423#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2785#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" type="button" onclick="save_priority();" value="<#1783#>">
</div>
</td>
</tr>
</form>
...
<#2024#>
<ul>
<li id="function_int_desc"><#2025#></li>
<li id="qos_desc"><#2028#></li>
<li><#2026#></li>
</ul>
<#2027#>
</div>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#2032#></div>
</td>
</tr>
<tr id="router_boost_tr" style="display:none">
<th>RouterBoost</th>
<td colspan="2">
<input id="rb_on" name="rb_toggle" onClick="routerboost_enable_setting();" type="radio" <% nvram_match("rb_enable", "1","checked"); %>><label for="rb_on"><#1759#></label>
<input id="rb_off" name="rb_toggle" onClick="routerboost_enable_setting();" type="radio" <% nvram_match("rb_enable", "0","checked"); %>><label for="rb_off"><#1767#></label>
</td>
</tr>
<tr id="qos_type_tr" style="display:none">
<th><#3181#></th>
<td colspan="3">
<input id="int_type" name="qos_type_radio" value="1" onClick="change_qos_type(this.value);" style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link" class="hintstyle" style="display:none;" href="javascript:void(0);" onClick="openHint(20, 5);"><label for="int_type"><#1003#></label></a>
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#2035#></label></a>
...
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#3648#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1910#></a></th>
<td>
...
<div class="Quick_Setup_title"><#1340#></div>
</div>
<div style="width: 120px;height:174px;">
<div style="display:flex;height:132px;">
