...
var port_mismatch_notice = "<#2595#>";
var port_mismatch_list = "<#2596#>";
if(wan_proto=="v6plus"){
port_confirm = port_confirm.replace("%0$@", "<#2593#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2593#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2593#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2593#>");
}
if(wan_proto=="ocnvc"){
port_confirm = port_confirm.replace("%0$@", "<#2592#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2592#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2592#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2592#>");
}
...
break;
case "https" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#2222#></a></li>";
break;
case "ssh" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#3091#></a></li>";
break;
case "openvpn" :
items += "<li><a href='/Advanced_VPNServer_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OpenVPN</a></li>";
break;
case "ftp" :
items += "<li><a href='/Advanced_NATPassThrough_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#524#> - <#2252#></a></li>";
break;
case "ipsec" :
...
items += "<li><a href='/Advanced_Instant_Guard.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#4461#></a></li>";
}
break;
default :
break;
...
notification.desc[12] = "<#2849#>";
notification.action_desc[12] = "<#1525#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1518#>';
notification.action_desc[0] = '<#1525#>';
...
notification.desc[1] = '<#1519#>';
notification.action_desc[1] = '<#1526#>';
...
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1526#></a>';
...
notification.desc[2] = '<#1520#>';
notification.action_desc[2] = '<#1525#> (2.4GHz)';
...
notification.desc[3] = '<#1520#>';
if(band5g2_support)
notification.action_desc[3] = '<#1525#> (5GHz-1)';
else
notification.action_desc[3] = '<#1525#> (5GHz)';
...
notification.desc[19] = '<#1520#>';
notification.action_desc[19] = '<#1525#> (5GHz-2)';
...
notification.action_desc[4] = '<#927#>';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1521#>';
notification.action_desc[4] = '<#1525#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.action_desc[5] = '<#927#>';
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1523#>';
notification.action_desc[5] = '<#1525#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[8] = "<#1782#>";
...
notification.desc[15] = '<#4232#>';
notification.action_desc[15] = '<#4233#>';
