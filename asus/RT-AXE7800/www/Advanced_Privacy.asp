...
if(eula_status.PP >= "1"){
$("#pp").find('.btn_subusage').attr({'onclick':`show_policy_withdraw('PP')`,'value':`<#240#>`});
$("#pp").find('.eula_withdraw_content').append($('<div>').html(`<div><#141#> <#142#></div>`));
$("#pp").find('.eula_withdraw_content').append($('<div>').html(`<a style="cursor: pointer; color: #006ce1; text-decoration: underline;" onclick="show_policy('PP')"><#214#></a>`));
$("#pp").find('.eula_withdraw_content').append($('<div>').html(`<div style="margin-top: 1em;"><#143#></div>`));
} else {
$("#pp").find('.eula_withdraw_content').append($('<div>').html(`<div><#213#></div>`));
$("#pp").find('.btn_subusage').attr({'onclick':`show_policy('PP')`,'value':`<#212#>`});
}
...
<div>&nbsp;</div>
<div id="formfonttitle" class="formfonttitle"><#508#> - <#4386#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="eula" class="eula_withdraw">
<div class="eula_withdraw_title"><#153#> (EULA)</div>
<div class="eula_withdraw_content">
<div><#202#></div>
</div>
<div style="text-align: center;">
<div style="margin: 0px auto 10px;display: flex;justify-content: center;">
<input class="btn_subusage button_gen" onclick="show_policy('EULA');" type="button" value="<#212#>"/>
</div>
</div>
</div>
<div id="pp" class="eula_withdraw">
<div class="eula_withdraw_title"><#214#></div>
<div class="eula_withdraw_content">
</div>
<div style="text-align: center;">
<div style="margin: 0px auto 10px;display: flex;justify-content: center;">
<input class="btn_subusage button_gen" onclick="show_policy('PP');" type="button" value="<#212#>"/>
</div>
</div>
</div>
<div id="tm_eula" class="eula_withdraw" style="display:none;">
<div class="eula_withdraw_title"><#236#></div>
<div class="eula_withdraw_content">
<div><#237#></div>
<div style="margin-top:5px;"><#238#>
<div><#234#></div>
<div><#235#></div>
</div>
</div>
<div style="text-align:center;">
<div style="margin: 0px auto 10px;display: flex;justify-content: center;">
<input class="btn_subusage button_gen" id="tm_withdraw_btn" onclick="withdraw_eula('tm');" type="button" value="<#240#>"/>
