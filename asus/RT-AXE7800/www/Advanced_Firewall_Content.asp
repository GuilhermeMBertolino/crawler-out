...
add_option(document.form.LWKnownApps, "<#2540#>", "User Defined", 1);
...
alert(document.form.filter_lw_srcip_x_0.value + ": <#430#>");
document.form.filter_lw_srcip_x_0.focus();
document.form.filter_lw_srcip_x_0.select();
return false;
}
...
alert(document.form.filter_lw_dstip_x_0.value + ": <#430#>");
document.form.filter_lw_srcip_x_0.focus();
document.form.filter_lw_srcip_x_0.select();
return false;
}
...
<div>&nbsp;</div>
<div class="formfonttitle"><#502#> - <#505#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2162#></div>
<div class="formfontdesc"><#2164#></div>
<div class="formfontdesc" style="color:#FFCC00;"><#2165#></div>
<div id="svc_hint_div" style="display:none;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" style="color:#FFCC00;text-decoration:underline;cursor:pointer;"><#374#></span></div>
...
<thead>
<tr>
<td colspan="6" id="filter_lwlist"><#505#></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,5);"><#2186#></a></th>
<td>
<input type="radio" value="1" name="fw_lw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_lw_enable_x', '1')" <% nvram_match_x("FirewallConfig","fw_lw_enable_x", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="fw_lw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_lw_enable_x', '0')" <% nvram_match_x("FirewallConfig","fw_lw_enable_x", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,3);"><#2183#></a></th>
<td>
<select name="filter_lw_default_x" class="input_option">
<option value="DROP" <% nvram_match("filter_lw_default_x", "DROP","selected"); %>><#3977#></option>
<option value="ACCEPT" <% nvram_match("filter_lw_default_x", "ACCEPT","selected"); %>><#1548#></option>
</select>
</td>
</tr>
<tr>
...
<option value="User Defined"><#2540#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,1);"><#2179#></a></th>
<td>
<input type="checkbox" name="filter_lw_date_x_Mon" class="input" onclick="check_Timefield_checkbox()"><#1801#>
<input type="checkbox" name="filter_lw_date_x_Tue" class="input" onclick="check_Timefield_checkbox()"><#1805#>
<input type="checkbox" name="filter_lw_date_x_Wed" class="input" onclick="check_Timefield_checkbox()"><#1806#>
<input type="checkbox" name="filter_lw_date_x_Thu" class="input" onclick="check_Timefield_checkbox()"><#1804#>
<input type="checkbox" name="filter_lw_date_x_Fri" class="input" onclick="check_Timefield_checkbox()"><#1800#>
</td>
</tr>
<tr id="enable_time_week_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,2);"><#2181#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,1);"><#2179#></a></th>
<td>
<input type="checkbox" name="filter_lw_date_x_Sat" class="input" onclick="check_Timefield_checkbox()"><#1802#>
<input type="checkbox" name="filter_lw_date_x_Sun" class="input" onclick="check_Timefield_checkbox()"><#1803#>
</td>
</tr>
...
<tr>
<th ><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,4);"><#2188#></a></th>
<td>
...
<thead>
<tr>
<td colspan="6" id="filter_lwlist"><#2193#>&nbsp;(<#2772#>&nbsp;32)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,3);"><#2191#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><#2192#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,3);"><#2184#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><#2192#></a></th>
<th><#2547#></th>
<th><#2771#></th>
</tr>
