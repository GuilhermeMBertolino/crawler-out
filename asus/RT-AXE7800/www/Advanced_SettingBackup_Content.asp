...
$("#restoreInit_text").html(`<#3303#>`);
}
}
function restoreRule(_flag){
var alert_string = "<#3300#>";
...
showtext(document.getElementById("loading_block2"), "<#3257#>");
...
showtext(document.getElementById("loading_block2"), "<#3298#>");
document.getElementById('loading_block3').style.display = "none";
...
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#3305#></a>
</th>
<td colspan = "4">
<div style="float:left;">
<input class="button_gen" onclick="restoreRule('restore');" type="button" value="<#1787#>" name="action1" />
</div>
...
<span><label for="restoreInit" id="restoreInit_text"><#3308#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#3310#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="button_gen" onclick="saveSetting('Router');" type="button" value="<#3310#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#3315#></span></label>
</div>
</div>
...
<div style="float:left;width:80%;">
<span><label for="transfer_ddns"><#1823#></span></label>
</div>
</div>
</div>
</td>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#3314#></a>
</th>
<td colspan = "4">
...
<tr>
<td style="border:0px">
<input type="button" class="button_gen" onclick="selectSetting();" value="<#1792#>"/>
</td>
