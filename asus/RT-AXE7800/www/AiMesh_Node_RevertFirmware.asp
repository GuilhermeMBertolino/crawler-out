...
<title><#947#> - Revert Firmware</title>
...
notice = "<#2271#><br><br>If you would like to revert to previous firmware version, we suggest you temporarily disable auto firmware update to make sure you grant every upgrade."; //Untranslated
confirm_asus({
...
<form method="post" name="revert_fw" action="start_apply.htm" target="hidden_frame"><input type="hidden" name="productid" value="<% nvram_get("productid"); %>">
