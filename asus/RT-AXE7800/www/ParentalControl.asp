...
<title id="web_title"><#947#> - <#566#></title>
...
document.getElementById('content_title').innerHTML = "<#566#> - <#3482#>";
document.getElementById('desc_title').innerHTML = "<#3030#>";
document.getElementById('web_title').innerHTML = "<#947#> - <#3482#>";
document.getElementById('PC_enable').innerHTML = "<#3028#>";
}
if(isSupport("PC_SCHED_V3")){
$("#desc_title").html("<#3040#>");
var $desc_item = $("#desc_item").empty();
$("<li>").html("<#3041#>").appendTo($desc_item);
$("<li>").html("<#3032#>").appendTo($desc_item);
$("<li>").html("<#3042#>").appendTo($desc_item);
$("<li>").html("<#3043#>").appendTo($desc_item);
...
code +='<thead><tr><td colspan="4"><#1738#>&nbsp;(<#2772#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#3279#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#3279#></option>';
code += '<option value="0"><#1628#></option>';
code += '<option value="1"><#1880#></option>';
code += '<option value="2"><#1549#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1645#> (<#3124#>)</th>';
code +='<th width="20%"><#3037#></th>';
code +='<th width="20%"><#2771#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1628#></option>';
code += '<option value="1" selected><#1880#></option>';
code += '<option value="2"><#1549#></option>';
code += '</select>';
code += '</td>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#3282#>">';
...
code += '<option value="0" ' + ((client_time_obj.enable == "0") ? "selected" : "") + '><#1628#></option>';
code += '<option value="1" ' + ((client_time_obj.enable == "1") ? "selected" : "") + '><#1880#></option>';
code += '<option value="2" ' + ((client_time_obj.enable == "2")? "selected" : "") + '><#1549#></option>';
code += '</select>';
code += '</td>';
...
var hint = "<#4437#>".replace("#MAXNUM", weekScheduleApi.data_max);
hint += "\n";
hint += "<#4438#>";
alert(hint);
return false;
...
code += "<span class=\"clicked\"><#3482#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#1316#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#3482#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1316#></span>";
}
...
<tr>
<td align="left">
<div id="content_title" class="formfonttitle" style="width:400px"><#566#></div>
</td>
<td>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1316#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#3482#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<div style="font-size:14px;margin-left:6px;margin-bottom:6px;"><#3045#></div>
