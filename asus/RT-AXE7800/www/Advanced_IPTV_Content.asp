...
document.getElementById("iptv_configure_status").innerHTML = "<#950#>";
else
...
document.getElementById("voip_configure_status").innerHTML = "<#950#>";
else
...
alert_msg = hint_str1.replace("%1$@", "<#2944#>").replace("%2$@", "IPTV") + " " + hint_str2;
}
alert(alert_msg);
return true;
}
...
var msg = "<#3962#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wnaports_bond));
if(confirm(msg)){
...
msg = hint_str.replace("%1$@", port_list).replace("%2$@", "IPTV").replace("%3$@", "<#2944#>");
if(confirm(msg)){
document.form.lacp_enabled.disabled = false;
document.form.lacp_enabled.value = "0";
}
...
if(val == "12")
document.getElementById("gaming_note").innerHTML = "<#3217#>";
else if(val == "56")
document.getElementById("gaming_note").innerHTML = "<#3218#>";
...
if(improxy_support){
add_option(select, "<#4076#> IGMP", "1", 0);
add_option(select, "<#4076#> IGMP & MLD", "3", 0);
}
else
add_option(select, "<#4076#>", "1", 0);
select.value = val;
if(select.selectedIndex < 0)
select.selectedIndex = 0;
...
<option value="" <% nvram_match("wan_auth_x_now", "", "selected"); %>><#953#></option>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd_now);"><#717#></div>
</td>
</tr>
...
<input class="button_gen" type="button" onclick="save_connection_settings();" value="<#1782#>">
</div>
</div>
...
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#2663#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#2664#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#3216#></a></th>
<td>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#826#></a></th>
<td>
...
<th width="30%"><#1981#></th>
<td align="left">
<span style="color:#FFFFFF;"><#1984#></span>
<select id="wans_lanport1" name="wans_lanport1" class="input_option" style="margin-left:7px;"></select>
<div style="margin-top:2px;"><span style="color:#FFFFFF;">( <#1982#> : </span><span id="cur_primary" style="color:#FFFFFF;"></span><span style="color:#FFFFFF;"> )</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#4077#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#3224#></a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option" onChange="change_mr_enable(this.value);">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#4077#></option>
<!-- <option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#4076#></option> -->
</select>
<span id="mr_hint" style="display:none;">( <#3225#> )</span>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#4077#></span>
<span style="margin-left: 5px;"><#3226#></span>
</div>
</td>
</tr>
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,14);"><#3235#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,15);"><#3236#></a></th>
<td>
...
<option value="0" <% nvram_match("mr_qleave_x", "0","selected"); %> ><#4077#></option>
<option value="1" <% nvram_match("mr_qleave_x", "1","selected"); %> ><#4076#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#4077#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#4076#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#3238#></a></th>
<td>
