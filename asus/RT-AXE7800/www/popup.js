...
showtext(document.getElementById("proceeding_main_txt"), "<#466#>...");
...
showtext(document.getElementById("proceeding_main_txt"), "<#469#>");
showtext(document.getElementById("proceeding_txt"), Math.round(y)+"% <#466#>");
--seconds;
setTimeout("LoadingTime("+seconds+", '"+flag+"');", 1000);
}
else{
showtext(document.getElementById("proceeding_main_txt"), translate("<#468#>"));
