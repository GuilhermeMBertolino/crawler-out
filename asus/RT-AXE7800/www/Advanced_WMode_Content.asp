...
document.getElementById("repeaterModeHint_desc").innerHTML = "<#1781#>";
document.getElementById("repeaterModeHint").style.display = "";
}
else{
show_wl_wdslist();
...
code +='<tr><td style="color:#FFCC00;"><#2554#></td>';
}
else{
...
code += '<div style="text-decoration:underline;font-weight:bolder;" onclick="rescan();"><#1511#></div>';
}
else{
...
<div class="formfontdesc"><#4029#></div>
<div class="formfontdesc hint-color"><#1026#></div>
<div class="formfontdesc hint-color" style="margin-left:28px;">
<#4030#>&nbsp;<#4031#><br><#3317#>
</div>
<div class="formfontdesc"><#4032#>
<ol>
<li><#4033#></li>
<li><#4034#></li>
<li><#4035#></li>
...
<div id="wl_bw_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#4037#></div>
<div id="wl_ch_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#4038#></div>
...
<td id="repeaterModeHint_desc" colspan="2" class="hint-color" style="height:30px;" align="center"><#565#></td>
</tr>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#4088#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#4089#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#4090#></option>
</select>
</td>
</tr>
...
<td colspan="4"><#4057#>&nbsp;(<#2772#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#4057#></th>
<th class="edit_table" width="20%"><#2771#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3280#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
