...
var code = "";
code += "<tr>";
code += "<th style='width:20%;text-align:left'><#979#></th>";
code += "<th style='width:30%;text-align:left'><#3124#> / <#1645#></th>";
code += "<th style='width:50%;text-align:left'><#1908#></th>";
code += "</tr>";
...
var data = [["<#979#>", "<#465#>", "<#1645#>".replace(/&#39;/g, "'"), "<#1908#>"]];
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2815#> - <#998#></div>
...
<option value="all" selected><#1505#></option>
</select>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1764#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1785#>">
<input class="button_gen" onClick="exportWebHistoryLog()" type="button" value="<#1631#>" >
</div>
</div>
</td>
</tr>
