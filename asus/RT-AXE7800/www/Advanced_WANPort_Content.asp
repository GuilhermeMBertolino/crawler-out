...
var hint_str = "<#3102#>";
var confirm_str = hint_str.replace("%1$@", conflict_lanport_text).replace("%2$@", "<#491#>").replace("%3$@", "<#2944#>");
...
$("#fo_detection_count_hd").html("<#1954#>");
new_html_str = "<#1952#>".replace("$WANDOG_MAXFAIL", replace_html);
...
$("#fo_detection_count_hd").html("<#2972#>");
$("#wandog_maxfail_setting").html(new_html_str);
}
...
<tr><td colspan="2"><#3402#></td></tr><tr><td colspan="2"><#3403#>&nbsp;:&nbsp;<span id="str_detect_time"></span>&nbsp;<#3275#>.</td></tr>
<tr>
<th style="width:30%;"><#3410#></th>
<td>
<input type="text" name="detect_interval" class="input_3_table" maxlength="1" value=""; placeholder="5" autocorrect="off" autocapitalize="off" onKeyPress="return validator.isNumber(this, event);" onblur="update_str_time();" style="width: 38px; margin: 0px;">&nbsp;&nbsp;<#3275#>
</td>
</tr>
<tr>
<th><#3412#></th>
...
<span id="detect_tail_msg">&nbsp;( Detection Time: <span id="detection_time_value"></span>&nbsp;&nbsp;<#3275#>)</span>
</td>
</tr>
</table>
...
<div class="formfontdesc"><#1946#><a id="dualwan_faq" href="" target="_blank" style="margin-left:5px; text-decoration: underline;"><#314#> FAQ</a></div>
<div id="wan_aggre_desc" class="formfontdesc" style="color:#FFCC00; display:none;"><#3967#></div>
...
<span id="usb_tethering_hint" style="display: none;"><#1991#></span>
</td>
</tr>
<tr id="wans_mode_tr">
<th><#1963#></th>
...
<option value="fo"><#1964#></option>
<option value="lb" <% nvram_match("wans_mode", "lb", "selected"); %>><#1965#></option>
</select>
<span id="wans_mode_fo" style="margin-left:5px; color:#FFF; display:none;"><#1964#></span>
<span id="fb_span" style="display:none"><input type="checkbox" id="fb_checkbox"><#1948#></span>
<script>
...
<div id="lb_note" style="color:#FFCC00; display:none;"><#1961#></div>
<div id="lb_note2" style="color:#FFCC00; display:none;"><#1962#></div>
</td>
</tr>
...
<option value="1" <% nvram_match("wans_standby", "1", "selected"); %>><#4076#></option>
<option value="0" <% nvram_match("wans_standby", "0", "selected"); %>><#4077#></option>
</select>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1981#>
<input type="radio" value="2" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1988#>
</td>
</tr>
<tr class="ISPProfile">
<th><#1957#></th>
...
<thead>
<tr>
<td colspan="2"><#1980#><div style="font-weight: normal; font-style: italic; margin-top: 5px;"><#2044#></div></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,3);"><#3411#></a></th>
<td id="retry_intervale_setting"><#349#>
<div><span id="consume_bytes_warning" style=""></span></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,5);"><div id="fo_detection_count_hd"><#1954#></div></a></th>
<td id="wandog_maxfail_setting"></td>
</tr>
<tr id="wandog_fb_count_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,6);"><div id="fb_detection_count_hd"><#1951#></div></a></th>
<td id="wandog_fbcount_setting"><#1950#></td>
</tr>
<tr>
<th><#2963#></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullPingTargetList(this);" title="<#3286#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
