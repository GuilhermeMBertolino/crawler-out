...
if(wan_lanport_text != ""){
var hint_str1 = "<#3103#>";
var hint_str2 = "<#1640#>".replace("setting_link", "setting_link_1");
...
document.getElementById("setting_link_1").href = "http://"+"<#949#>"+"/Advanced_WANPort_Content.asp";
...
var hint_str1 = "<#3104#>";
var hint_str2 = "<#1640#>".replace("setting_link", "setting_link_2");
var note_str = hint_str1.replace("%1$@", "<#2944#>").replace("%2$@", "IPTV") + " " + hint_str2;
...
document.form.lacp_enabled.style.display = "none";
document.getElementById("lacp_note").innerHTML = note_str;
document.getElementById("setting_link_2").href = "http://"+"<#949#>"+"/Advanced_IPTV_Content.asp";
document.getElementById("lacp_desc").style.display = "";
...
var desc = [ "<#243#>", "1Gbps", "2.5Gbps", "10Gbps" ];
...
document.getElementById("natAccelDesc").innerHTML = "<#2935#>";
}
}
else{
...
if(ctf_disable == 1){
document.getElementById("ctfLevelDesc").innerHTML = "<#2935#>";
}
else{
if(ctf_fa_mode == '2')
document.getElementById("ctfLevelDesc").innerHTML = "<#2937#>";
else
document.getElementById("ctfLevelDesc").innerHTML = "<#2936#>";
}
}
if (re_mode == "1"){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#487#> - <#3430#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3434#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr id="jumbo_tr">
<th><#2652#></th>
<td>
<select name="jumbo_frame_enable" class="input_option">
<option class="content_input_fd" value="0" <% nvram_match("jumbo_frame_enable", "0","selected"); %>><#4077#></option>
<option class="content_input_fd" value="1" <% nvram_match("jumbo_frame_enable", "1","selected"); %>><#4076#></option>
</select>
</td>
</tr>
<tr id="ctf_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,2);"><#2933#></a></th>
<td>
<select name="ctf_disable_force" class="input_option" disabled>
<option class="content_input_fd" value="1" <% nvram_match("ctf_disable_force", "1","selected"); %>><#4077#></option>
...
<option class="content_input_fd" value="0" <% nvram_match("qca_sfe", "0","selected"); %>><#4077#></option>
<option class="content_input_fd" value="1" <% nvram_match("qca_sfe", "1","selected"); %>><#4076#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("hwnat", "0","selected"); %>><#4077#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,1);"><#2944#></a></th>
<td>
<select name="lacp_enabled" class="input_option" onchange="check_bonding_policy(this);" disabled>
<option class="content_input_fd" value="0" <% nvram_match("lacp_enabled", "0","selected"); %>><#4077#></option>
<option class="content_input_fd" value="1" <% nvram_match("lacp_enabled", "1","selected"); %>><#4076#></option>
</select>
<div id="lacp_desc" style="display:none"><span id="lacp_note"><#2947#></span><div>
</td>
</tr>
...
<option value="0"><#1768#></option>
<option value="1"><#3433#></option>
<option value="2"><#3432#></option>
</select>
</td>
</tr>
</table>
...
<option value="96" <% nvram_match("aqr_ipg", "96","selected"); %>><#1768#></option>
