...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2815#> - <#2035#>";
}
else{
...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#827#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2795#>");
return false;
}
}
replace_symbol();
...
alert("<#3717#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#2423#></option>';
else
code += '<option value="0"><#2423#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#2422#></option>';
else
code += '<option value="1"><#2422#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2808#></option>';
else
code += '<option value="2"><#2808#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2784#></option>';
else
code += '<option value="3"><#2784#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2785#></option>';
else
code += '<option value="4"><#2785#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#3183#></option>
<option value="3"><#3182#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1618#>&nbsp;(<#2772#>&nbsp;32)</td>
...
<tr>
<th><#1619#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1620#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1621#></div></a></th>
<th><div class="table_text"><#2547#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#3699#></div></a></th>
<th><#1622#></th>
<th><#2771#></th>
</tr>
<tr>
<td width="20%">
<input type="text" maxlength="32" class="input_12_table" style="float:left;width:105px;" placeholder="<#827#>" name="qos_service_name_x_0" onKeyPress="return validator.isString(this, event)" autocorrect="off" autocapitalize="off">
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullQoSList(this);" title="<#3287#>">
...
<img id="pull_arrow_mac" class="pull_arrow"height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3282#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#2423#></option>
<option value='1' selected><#2422#></option>
<option value='2'><#2808#></option>
<option value='3'><#2784#></option>
<option value='4'><#2785#></option>
</select>
</td>
<td width="6%">
