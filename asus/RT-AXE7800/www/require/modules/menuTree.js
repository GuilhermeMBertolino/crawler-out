...
tab: [
{url: "Guest_network.asp", tabName: "<#376#>"},
{url: "Captive_Portal.asp", tabName: "Free WiFi"},
{url: "Captive_Portal_Advanced.asp", tabName: "<#4258#>"},
...
tab: [
{url: "AiProtection_HomeProtection.asp", tabName: "<#1346#>"},
{url: "AiProtection_MaliciousSitesBlocking.asp", tabName: "<#1390#>"},
{url: "AiProtection_IntrusionPreventionSystem.asp", tabName: "<#1410#>"},
{url: "AiProtection_InfectedDevicePreventBlock.asp", tabName: "<#1303#>"},
...
index: "menu_QoS",
tab: [
{url: "QoS_EZQoS.asp", tabName: "<#2815#>"},
{url: "Main_TrafficMonitor_realtime.asp", tabName: "<#879#>"},
{url: "Main_TrafficMonitor_last24.asp", tabName: "__INHERIT__"},
{url: "Main_TrafficMonitor_daily.asp", tabName: "__INHERIT__"},
{url: "AdaptiveQoS_InternetSpeed.asp", tabName: "<#2477#>"},
...
{url: "Main_Spectrum_Content.asp", tabName: "<#3393#>"},
...
tab: [
{url: "AiProtection_WebProtector.asp", tabName: "<#1316#>"},
{url: "ParentalControl.asp", tabName: "<#3482#>"},
{url: "YandexDNS.asp", tabName: "<#4214#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
tab: [
{url: "AdaptiveQoS_Bandwidth_Monitor.asp", tabName: "<#1538#>"},
{url: "QoS_EZQoS.asp", tabName: "<#2815#>"},
{url: "AdaptiveQoS_WebHistory.asp", tabName: "<#998#>"},
{url: "AdaptiveQoS_ROG.asp", tabName: "<table style='margin-top:-7px;'><tr><td><img src='/images/ROG_Logo.png' style='border:0px;width:32px;'></td><td>ROG First</td></tr></table>"},
{url: "Main_Spectrum_Content.asp", tabName: "<#3393#>"},
{url: "Advanced_QOSUserPrio_Content.asp", tabName: "__INHERIT__"},
{url: "Advanced_QOSUserRules_Content.asp", tabName: "__INHERIT__"},
...
tab: [
{url: "TrafficAnalyzer_Statistic.asp", tabName: "<#3404#>"},
{url: "Main_TrafficMonitor_realtime.asp", tabName: "<#879#>"},
{url: "Main_TrafficMonitor_last24.asp", tabName: "__INHERIT__"},
{url: "Main_TrafficMonitor_daily.asp", tabName: "__INHERIT__"},
{url: "AdaptiveQoS_TrafficLimiter.asp", tabName: "Traffic Limiter"},
...
tab: [
{url: "GameBoost.asp", tabName: "<#2284#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "mediaserver.asp", tabName: "<#883#>"},
{url: "Advanced_AiDisk_samba.asp", tabName: "<#498#>".concat(WebDav_support?" / <#1718#>":"")},
{url: "Advanced_AiDisk_ftp.asp", tabName: "<#499#>"},
...
{url: "cloud_sync.asp", tabName: "<#3371#>"},
{url: "cloud_router_sync.asp", tabName: "<#3296#>"},
{url: "cloud_settings.asp", tabName: "<#3316#>"},
{url: "cloud_syslog.asp", tabName: "<#2779#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
/* ============================================================================================================ */
...
index: "menu_Wireless",
tab: [
{url: "Advanced_Wireless_Content.asp", tabName: "<#481#>"},
{url: "Advanced_WWPS_Content.asp", tabName: "<#482#>"},
{url: "Advanced_WMode_Content.asp", tabName: "WDS"},
{url: "Advanced_ACL_Content.asp", tabName: "<#484#>"},
{url: "Advanced_WSecurity_Content.asp", tabName: "<#485#>"},
{url: "Advanced_WAdvanced_Content.asp", tabName: "<#486#>"},
{url: "Advanced_WProxy_Content.asp", tabName: "<#3980#>"},
{url: "Advanced_Roaming_Block_Content.asp", tabName: "<#3983#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_LAN",
tab: [
{url: "Advanced_LAN_Content.asp", tabName: "<#488#>"},
{url: "Advanced_DHCP_Content.asp", tabName: "<#489#>"},
{url: "Advanced_MultiSubnet_Content.asp", tabName: "<#489#>"},
{url: "Advanced_GWStaticRoute_Content.asp", tabName: "<#490#>"},
{url: "Advanced_IPTV_Content.asp", tabName: "IPTV"},
{url: "Advanced_SwitchCtrl_Content.asp", tabName: "<#3430#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_WAN",
tab: [
{url: "Advanced_WAN_Content.asp", tabName: "<#492#>"},
{url: "Advanced_DSL_Content.asp", tabName: "<#492#>"},
{url: "Advanced_VDSL_Content.asp", tabName: "<#492#>"},
{url: "Advanced_Modem_Content.asp", tabName: "<#492#>"},
{url: "Advanced_MobileBroadband_Content.asp", tabName: "<#492#>"},
{url: "Advanced_WANPort_Content.asp", tabName: "<#314#>"},
{url: "Advanced_PortTrigger_Content.asp", tabName: "<#493#>"},
{url: "Advanced_VirtualServer_Content.asp", tabName: "<#494#>"},
{url: "Advanced_Exposed_Content.asp", tabName: "<#495#>"},
{url: "Advanced_ASUSDDNS_Content.asp", tabName: "<#496#>"},
{url: "Advanced_NATPassThrough_Content.asp", tabName: "<#524#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_VPN",
tab: [
{url: "Advanced_VPNServer_Content.asp", tabName: "<#260#>"},
{url: "Advanced_VPNClient_Content.asp", tabName: (vpn_fusion_support) ? "<#4353#>" : "<#3892#>"},
{url: "Advanced_TOR_Content.asp", tabName: "TOR"},
{url: "Advanced_Instant_Guard.asp", tabName: "<#4461#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_Firewall",
tab: [
{url: "Advanced_BasicFirewall_Content.asp", tabName: "<#481#>"},
{url: "Advanced_URLFilter_Content.asp", tabName: "<#503#>"},
{url: "Advanced_KeywordFilter_Content.asp", tabName: "<#506#>"},
{url: "Advanced_Firewall_Content.asp", tabName: "<#505#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_Setting",
tab: [
{url: "Advanced_OperationMode_Content.asp", tabName: "<#509#>"},
{url: "Advanced_System_Content.asp", tabName: "<#511#>"},
{url: "Advanced_FirmwareUpgrade_Content.asp", tabName: "<#512#>"},
{url: "Advanced_SettingBackup_Content.asp", tabName: "<#513#>"},
{url: "Advanced_PerformanceTuning_Content.asp", tabName: "<#2041#>"},
{url: "Advanced_ADSL_Content.asp", tabName: "<#475#>"},
{url: "Advanced_Feedback.asp", tabName: "<#2810#>"},
...
{url: "Advanced_Privacy.asp", tabName: "<#4385#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_Log",
tab: [
{url: "Main_LogStatus_Content.asp", tabName: "<#514#>"},
{url: "Main_WStatus_Content.asp", tabName: "<#516#>"},
{url: "Main_DHCPStatus_Content.asp", tabName: "<#515#>"},
{url: "Main_IPV6Status_Content.asp", tabName: "IPv6"},
{url: "Main_RouteStatus_Content.asp", tabName: "<#518#>"},
{url: "Main_IPTStatus_Content.asp", tabName: "<#517#>"},
{url: "Main_AdslStatus_Content.asp", tabName: "<#474#>"},
{url: "Main_ConnStatus_Content.asp", tabName: "<#1742#>"},
...
tab: [
{url: "Main_Analysis_Content.asp", tabName: "<#2962#>"},
{url: "Main_Netstat_Content.asp", tabName: "Netstat"},
{url: "Main_WOL_Content.asp", tabName: "<#2984#>"},
{url: "Advanced_Smart_Connect.asp", tabName: "<#3364#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
}
],
...
if(menuTree.list[i].menuName == '<#1003#>'){
menuTree.list[i].menuName = '<#2815#>';
}
}
}
...
for(i=0; i<menuTree.list.length; i++){
if(menuTree.list[i].menuName == '<#2284#>'){
...
var index = -1;
for(i=0;i<menuTree.list.length;i++){
if(menuTree.list[i].menuName == '<#1393#>'){
...
menuTree.list[i].tab[j].tabName = '<#566#>';
break;
}
}
...
for(i=0;i<menuTree.list.length;i++){
if(menuTree.list[i].menuName == '<#1003#>'){
menuTree.list[i].menuName = '<#476#>';
var index = menuTree.list[i].tab.length-1;
menuTree.list[i].tab[index] = {url: "Main_TrafficMonitor_realtime.asp", tabName: "<#879#>"};
...
else if(menuTree.list[i].menuName == '<#2815#>'){
var index = menuTree.list[i].tab.length-1;
menuTree.list[i].tab[index] = {url: "Main_TrafficMonitor_realtime.asp", tabName: "<#879#>"};
menuTree.list[i].tab.push({url: "Main_TrafficMonitor_last24.asp", tabName: "__INHERIT__"});
menuTree.list[i].tab.push({url: "Main_TrafficMonitor_daily.asp", tabName: "__INHERIT__"});
