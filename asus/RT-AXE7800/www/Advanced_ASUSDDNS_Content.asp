...
var ddns_accournt_remove_note = stringSafeGet("<#242#>");
function init(){
show_menu();
...
$("#deregister_btn").click(function(){
if(orig_le_enable != "0"){
var confirm_msg = stringSafeGet("<#2702#>");
...
document.getElementById("DDNSName").value = "<#241#>";
}
else{
...
document.getElementById("ddns_hostname_x").value = "<#241#>";
}
...
document.getElementById("ddns_status").innerHTML = "<#830#>";
if(inadyn)
show_deregister_btn();
}
}
...
if(ddns_server_x == "WWW.ASUS.COM"){
document.getElementById("ddns_status").innerHTML = "<#831#>";
if(ddnsStatus != "")
...
show_alert_block("<#2685#> '" + s.charAt(i) +"' !");
return false;
}
}
return true;
...
function cleandef(){
if(document.form.DDNSName.value == "<#241#>")
...
document.getElementById("le_desc").innerHTML = "<#2729#>";
...
case "2":
document.getElementById("cert_desc").style.display = "none";
html_code += '<div style="display:table-cell"><input class="button_gen" onclick="open_upload_window();" type="button" value="<#1792#>"/><img id="loadingicon" style="margin-left:5px;display:none;" src="/images/InternetScan.gif"></div>';
document.getElementById("cert_act").innerHTML = html_code;
document.getElementById("cert_act").style.display = "";
document.getElementById("CAcert_details").style.display = "";
document.getElementById("cert_details").style.display = "";
...
document.getElementById("cert_status").innerHTML = "<#3770#>";
else
document.getElementById("cert_status").innerHTML = "<#3647#>";
setTimeout("get_cert_info();", 1000);
}
else{
document.getElementById("cert_status").innerHTML = "<#830#>";
...
$("<div>").addClass("title").html("<#2986#>").appendTo($popup_title_container);
...
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=168"><#2710#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=169"><#2711#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=170"><#2712#></a></div>'
...
<div class="formfonttitle"><#491#> - <#496#> </div>
...
<div class="formfontdesc hint-color" id="wan_ip_hide2" style="color:#FC0; display:none;"><#2709#><#2707#></div>
<div class="formfontdesc hint-color" id="lb_note" style="color:#FC0; display:none;"><#2758#></div>
...
<div style="color:#FFCC00">*<#2713#></div>
</td>
</tr>
<tr>
<th id="ddns_wan_unit_th"><#3901#></th>
<td id="ddns_wan_unit_td">
<select name="ddns_wan_unit" class="input_option">
<option class="content_input_fd" value="-1" <% nvram_match("ddns_wan_unit", "-1","selected"); %>><#243#></option>
<option class="content_input_fd" value="0" <% nvram_match("ddns_wan_unit", "0","selected"); %>><#1981#></option>
<option class="content_input_fd" value="1"<% nvram_match("ddns_wan_unit", "1","selected"); %>><#1988#></option>
</select>
</td>
</tr>
<tr id="ddns_ipv6update_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,18);"><#1819#></a></th>
<td>
<input type="radio" name="ddns_ipv6_update" class="input" value="1" <% nvram_match("ddns_ipv6_update", "1", "checked"); %>><#277#>
<input type="radio" name="ddns_ipv6_update" class="input" value="0" <% nvram_match("ddns_ipv6_update", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th><#2720#></th>
...
<input id="deregister_btn" class="button_gen" style="display: none; margin-left: 5px;" type="button" value="<#290#>"/>
<a id="link" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#2721#></a>
<a id="linkToHome" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1808#></a>
</td>
</tr>
<tr id="ddns_hostname_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#2717#></a></th>
<td>
...
<th><#2728#></th>
<td>
<input type="radio" value="1" name="ddns_wildcard_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '1')" <% nvram_match("ddns_wildcard_x", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="ddns_wildcard_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '0')" <% nvram_match("ddns_wildcard_x", "0", "checked"); %>><#276#>
</td>
</tr>
<tr id="check_ddns_field" style="display:none;">
<th><#1824#></th>
<td>
<input type="radio" value="1" name="ddns_regular_check" onClick="change_ddns_setting(document.form.ddns_server_x.value);" <% nvram_match("ddns_regular_check", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="ddns_regular_check" onClick="change_ddns_setting(document.form.ddns_server_x.value);" <% nvram_match("ddns_regular_check", "0", "checked"); %>><#276#>
</td>
</tr>
<tr style="display:none;">
<th><#1825#></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="ddns_regular_period" value="<% nvram_get("ddns_regular_period"); %>" autocorrect="off" autocapitalize="off"> <#2822#>
</td>
</tr>
<tr style="display:none;">
<th><#2724#></th>
...
<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#2722#>" /></td>
</tr>
...
<input type="radio" value="1" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "1", "checked"); %>><#1811#>
</span>
<input type="radio" value="2" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "2", "checked"); %>><#1813#>
<span id="self_signed" style="color:#FFF;">
<input type="radio" value="0" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "0", "checked"); %>><#243#>
</span>
...
<div class="cert_status_title"><#3779#> :</div>
<div id="CAissueTo" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3778#> :</div>
<div id="CAissueBy" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3777#> :</div>
...
<td>
<div style="display: flex;">
<div class="cert_status_title"><#833#> :</div>
...
<div>
<input class="button_gen" onclick="save_cert_key();" type="button" value="<#1631#>" />
</div>
</td>
</tr>
</table>
<div class="apply_gen">
<input class="button_gen" onclick="apply_eula_check();" type="button" value="<#286#>" />
</div>
</div>
...
<div class="formfonttitle" style="margin-top: 15px; margin-left: 15px;"><#1813#></div>
<div class="formfontdesc" style="margin: 15px;"><#1814#></div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1815#> :</div>
<div style="display:table-cell;"><input type="file" name="file_key" class="input Upload_file"></div>
</div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1821#> :</div>
<div style="display:table-cell;"><input type="file" name="file_cert" class="input Upload_file"></div>
</div>
<div style="color: #FC0; margin-left: 15px; margin-top: 20px">* <#1816#></div>
<div align="center" style="margin-top:30px; padding-bottom:15px; display: flex; justify-content: center;">
<div style=""><input class="button_gen" type="button" onclick="hide_upload_window();" id="cancelBtn" value="<#289#>"></div>
<div style=""><input class="button_gen" type="button" onclick="upload_cert_key();" id="applyBtn" value="<#1782#>"></div>
</div>
</div>
</form>
</body>
