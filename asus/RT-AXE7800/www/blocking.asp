...
var category_info = [ ["Parental Controls", "1", "<#1317#>", "<#1319#>", "<#1554#>"],
["Parental Controls", "3", "<#1317#>", "<#1319#>", "<#1556#>"],
["Parental Controls", "4", "<#1317#>", "<#1319#>", "<#1557#>"],
["Parental Controls", "5", "<#1317#>", "<#1319#>", "<#1558#>"],
["Parental Controls", "6", "<#1317#>", "<#1319#>", "<#1559#>"],
["Parental Controls", "8", "<#1317#>", "<#1319#>", "<#1560#>"],
["Parental Controls", "9", "<#1317#>", "<#1320#>", "<#1561#>"],
["Parental Controls", "10", "<#1317#>", "<#1320#>", "<#1562#>"],
["Parental Controls", "14", "<#1317#>", "<#1320#>", "<#1563#>"],
["Parental Controls", "15", "<#1317#>", "<#1320#>", "<#1564#>"],
["Parental Controls", "16", "<#1317#>", "<#1320#>", "<#1565#>"],
["Parental Controls", "25", "<#1317#>", "<#1320#>", "<#1566#>"],
["Parental Controls", "26", "<#1317#>", "<#1320#>", "<#1567#>"],
["Parental Controls", "11", "<#1317#>", "<#1321#>", "<#1568#>"],
["Parental Controls", "24", "<#1332#>", "<#1322#>", "<#1569#>"],
["Parental Controls", "51", "<#1332#>", "<#1323#>", "<#1570#>"],
["Parental Controls", "53", "<#1332#>", "<#1324#>", "<#1571#>"],
["Parental Controls", "89", "<#1332#>", "<#1324#>", "<#1572#>"],
["Parental Controls", "42", "<#1332#>", "<#1325#>", "<#1573#>"],
["Parental Controls", "56", "<#1335#>", "<#1337#>", "<#1574#>"],
["Parental Controls", "70", "<#1335#>", "<#1337#>", "<#1575#>"],
["Parental Controls", "71", "<#1335#>", "<#1337#>", "<#1576#>"],
["Parental Controls", "57", "<#1335#>", "<#1338#>", "<#1577#>"],
["Parental Controls", "69", "<#1339#>", "<#1341#>", "<#1578#>"],
["Parental Controls", "23", "<#1339#>", "<#1342#>", "<#1579#>"],
["Home Protection", "91", "Anti-Trojan detecting and blocked", "", "<#1580#>"],
["Home Protection", "2", "Malicious site blocked", "", "<#1555#>"],
["Home Protection", "39", "Malicious site blocked", "", "<#1581#>"],
["Home Protection", "73", "Malicious site blocked", "", "<#1582#>"],
["Home Protection", "74", "Malicious site blocked", "", "<#1583#>"],
["Home Protection", "75", "Malicious site blocked", "", "<#1584#>"],
["Home Protection", "76", "Malicious site blocked", "", "<#1585#>"],
["Home Protection", "77", "Malicious site blocked", "", "<#1586#>"],
["Home Protection", "78", "Malicious site blocked", "", "<#1587#>"],
["Home Protection", "79", "Malicious site blocked", "", "<#1588#>"],
["Home Protection", "80", "Malicious site blocked", "", "<#1589#>"],
["Home Protection", "81", "Malicious site blocked", "", "<#1590#>"],
["Home Protection", "82", "Malicious site blocked", "", "<#1591#>"],
["Home Protection", "83", "Malicious site blocked", "", "<#1592#>"],
["Home Protection", "84", "Malicious site blocked", "", "<#1593#>"],
["Home Protection", "85", "Malicious site blocked", "", "<#1594#>"],
["Home Protection", "86", "Malicious site blocked", "", "<#1595#>"],
["Home Protection", "88", "Malicious site blocked", "", "<#1596#>"],
["Home Protection", "92", "Malicious site blocked", "", "<#1597#>"],
["Home Protection", "94", "Malicious site blocked", "", "<#1598#>"],
["Home Protection", "95", "Malicious site blocked", "", "<#1599#>"]
];
var target_info = {
url: "",
category_id: "",
...
var parental_string = "";
code = "<ul>";
code += "<li><div><span class='desc_info'><#1832#>:</span><br>" + target_info.desc + "</div></li>";
if(casenum != "")
code += "<li><div><span class='desc_info'>URL: </span>" + target_info.url +"</div></li>";
if(target_info.category_type == "Parental Controls")
code += "<li><div><span class='desc_info'><#1327#> :</span>" + target_info.content_category + "</div></li>";
code += "</ul>";
document.getElementById('detail_info').innerHTML = code;
if(target_info.category_type == "Parental Controls"){ //Webs Apps filter
code_title = "<div class='er_title' style='height:auto;'><#1609#></div>";
code_suggestion = "<ul>";
code_suggestion += "<li><span><#1608#></span></li>";
code_suggestion += "<li><span><#1613#></span></li>";
code_suggestion += '<li><#1387#><a href="https://global.sitesafety.trendmicro.com/index.php" target="_blank"><#1388#></a></li>';
code_suggestion += "</ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#1605#></div>";
code_suggestion = "<ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#912#></div>";
document.getElementById('main_reason').innerHTML = "<#911#>";
code = "";
code += "<div><#922#></div>";
document.getElementById('detail_info').innerHTML = code;
code_suggestion = "<ul>";
code_suggestion += "<li><span><#923#></span></li>";
...
code_title = "<div class='er_title' style='height:auto;'><#1614#></div>"
code_suggestion = "<ul>";
if(bwdpi_support)
parental_string = "<#3482#>";
else
parental_string = "<#566#>";
code_suggestion += "<li><#1611#> "+ parental_string +" <#1612#></li>";
code_suggestion += "<li><#1613#></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
<div class="prod_madelName"><#948#></div>
<div id="main_reason" class="p1 title_gap"><#1601#></div>
<div ></div>
<div>
...
<div class="p1 title_gap"><#932#></div>
<div>
<div class="p1 title_gap"></div>
<div class="nologin">
...
<div id="go_btn" class='button' style="display:none;"><#1632#></div>
</div>
</body>
</html>
