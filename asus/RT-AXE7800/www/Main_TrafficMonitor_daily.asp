...
grid += "<tr><th style=\"height:30px;\"><#1799#></th>";
grid += "<th><#3499#></th>";
grid += "<th><#3506#></th>";
grid += "<th><#3509#></th></tr>";
...
if(rows == 0)
grid +='<tr><td style="color:#FFCC00;" colspan="4"><#2554#></td></tr>';
...
<option value="3" selected><#2814#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="2" id="TriggerList" style="text-align:left;"><#2753#> <span style="color:#FFF;background-color:transparent;" id='last-dates'></span></td>
</tr>
</thead>
<tbody>
<tr class='even'><th width="40%"><#3499#></th><td id='last-dn'>-</td></tr>
<tr class='odd'><th width="40%"><#3506#></th><td id='last-up'>-</td></tr>
<tr class='footer'><th width="40%"><#3509#></th><td id='last-total'>-</td></tr>
</tbody>
</table>
</td>
</tr>
