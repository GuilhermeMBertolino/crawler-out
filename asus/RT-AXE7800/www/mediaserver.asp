...
<link rel="icon" href="images/favicon.png"><title><#947#> - <#883#></title>
...
<span class="formfonttitle" style="margin-left: 8px;"><#883#></span>
<span id="returnBtn">
...
<div id="upnp_desc_id" class="formfontdesc" style="margin-top: 10px; margin-left: 8px;"><#3653#></div>
</td>
</tr>
<tr>
<td>
...
<div id="noUSB" style="color:#FC0;display:none;margin-left:17px;padding-top:2px;padding-bottom:2px;"><#2994#></div>
</td>
</tr>
<tr>
<th><#1891#></th>
...
<th><#1893#></th>
<td>
<input type="radio" value="0" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "0", "checked"); %>><#1894#>
<input type="radio" value="1" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "1", "checked"); %>><#1892#>
</td>
</tr>
</table>
</div>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1892#>&nbsp;(<#2772#>&nbsp;10)</td>
</tr>
</thead>
<tr>
<th><#1889#></th>
...
<tr>
<td width="45%">
<input id="PATH" type="text" class="input_30_table" value="" onclick="get_disk_tree();" autocorrect="off" autocapitalize="off" readonly="readonly"/" placeholder="<#827#>" >
</td>
<td width="40%">
