...
<div>&nbsp;</div>
<div class="formfonttitle"><#2967#> - <#2984#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3354#></div>
...
<input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2985#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2978#>&nbsp;(<#2772#>&nbsp;32)</td>
</tr>
</thead>
<tr>
