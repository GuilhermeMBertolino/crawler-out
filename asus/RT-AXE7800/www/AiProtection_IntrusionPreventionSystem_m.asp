...
code += '<div class="table-cell"><#1350#></div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1350#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1312#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1311#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1313#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
$('#deleteData').hide();
code += '<div class="no-data"><#2554#></div>';
}
...
<div>
<div class="card-bg">
<div class="page-title"><#1410#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1832#></div>
<div class="description"><#1411#></div>
</div>
<div class="tm-logo">
