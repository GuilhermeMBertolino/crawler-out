...
country_array = [];
var country_selection_list = [["AA", "<#1648#>"], ["CN", "<#1650#>"], ["SG", "<#1654#>"], ["EU", "<#1651#>"], ["KR", "<#1652#>"], ["RU", "<#1653#>"], ["US", "<#1655#>"], ["AU", "<#1649#>"], ["XX", "<#1649#>"]];
...
country_selection_list.push(["GD", "<#1650#>"]);
}
if(EG_mode){
...
var MUMIMO2G_support = isSupport('mumimo_2g');
(function(){
if(Bcmwifi_support){
var _cap = '';
var _chipset = '';
...
document.getElementById('wl_txbf_desc').innerHTML = "<#3949#>";
}
else{
document.getElementById('wl_txbf_desc').innerHTML = "<#3950#>";
}
}
else
{
...
document.getElementById('wl_txbf_desc').innerHTML = "<#3984#>";
inputCtrl(document.form.wl_txbf, 1);
inputCtrl(document.form.wl_itxbf, 1);
}
}
...
if(based_modelid == "4G-AC86U" || based_modelid == "4G-AX56" || based_modelid == "RT-AX53U" || based_modelid == "RT-AX54" || based_modelid == "XD4S"){
inputCtrl(document.form.wl_itxbf, 1);
}
if(based_modelid == "RT-AX53U" || based_modelid == "RT-AX54" || based_modelid == "XD4S"){
inputCtrl(document.form.wl_txbf, 1);
...
else if ((based_modelid == 'RT-AX92U' || based_modelid == 'RT-AX95Q' || based_modelid == 'XT8PRO' || based_modelid == 'BM68' || based_modelid == 'XT8_V2' || based_modelid == 'RT-AXE95Q' || based_modelid == 'ET8PRO' || based_modelid == 'ET8_V2' || based_modelid == 'RT-AX56_XD4' || based_modelid == 'XD4PRO' || based_modelid == 'CT-AX56_XD4' || based_modelid == 'RT-AX56U' || based_modelid == "RP-AX56" || based_modelid == "RP-AX58") && (wl_unit_value == '0' || wl_unit_value == '1')){
document.getElementById("wl_MU_MIMO_field").style.display = "none";
document.form.wl_mumimo.disabled = true;
}
...
var value = ['0', '1', '3'];
var desc = ['<#3946#>', 'DL OFDMA only', 'DL OFDMA + MU-MIMO'];
add_options_x2(document.form.wl_ofdma, desc, value, document.form.wl_ofdma.value);
}
else if(Rawifi_support){
var value = ['0', '1', '4', '2','3'];
var desc = ['<#3946#>', 'DL OFDMA only', 'DL OFDMA + MU-MIMO', 'DL/UL OFDMA', 'DL/UL OFDMA + MU-MIMO'];
...
var name = country ? country.name : '<#4027#> ' + index;
if(tcode == index){
matched = true;
name += ' (<#3183#>)';
}
...
if(!matched){
code += '<option value='+ tcode +' ><#3183#></option>';
}
code += '</select>';
...
document.getElementById('wl_txPower_field_title').innerHTML = "<#3930#>&nbsp;&nbsp;&nbsp;&nbsp;<20dBm";
document.getElementById('tx_power_desc_EG').innerHTML = "<20dBm";
}
else{
document.getElementById('wl_txPower_field_title').innerHTML = "<#3930#>&nbsp;&nbsp;&nbsp;<23dBm";
...
power_table_desc = ["<#3931#>", "<#3932#>", "<#3933#>", "<#3934#>", "<#3935#>"];
...
var confirm_txt = "<#3925#>";
if(wl_unit_value == '1' || wl_unit_value == '2'){ // 5GHz up
if(band5g_11ax_support){
if(based_modelid == 'RT-AX92U'){
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3949#>");
}
else{
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3950#>");
}
}
else{
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3949#>");
...
confirm_txt = confirm_txt.replace("$Beamforming$", "<#3984#>");
}
...
var confirm_text = "<#1145#> <#1146#> <#1147#>\n<#3178#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#396#> - <#402#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="titl_desc" class="formfontdesc"><#3908#></div>
<div id="lantiq_ready" style="display:none;color:#FC0;margin-left:5px;font-size:13px;">Wireless is setting...</div>
<div id="svc_hint_div" style="display:none;margin-left:5px;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" class="hint-color" style="text-decoration:underline;cursor:pointer;"><#290#></span></div>
<div id="timezone_hint_div" style="margin-left:5px;display:none;"><span id="timezone_hint" onclick="location.href='Advanced_System_Content.asp?af=time_zone_select'" class="hint-color" style="text-decoration:underline;cursor:pointer;"></span></div>
...
<tr id="wl_rf_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 1);"><#4020#></a></th>
<td>
<input type="radio" value="1" name="wl_radio" class="input" onClick="control_TimeField();" <% nvram_match("wl_radio", "1", "checked"); %>><#194#>
<input type="radio" value="0" name="wl_radio" class="input" onClick="control_TimeField();" <% nvram_match("wl_radio", "0", "checked"); %>><#193#>
</td>
</tr>
<tr id="wl_sched_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 23);"><#4035#></a></th>
<td>
<input type="radio" value="1" name="wl_timesched" class="input" onClick="control_TimeField();return change_common_radio(this, 'WLANConfig11b', 'wl_timesched', '1');" <% nvram_match("wl_timesched", "1", "checked"); %>><#194#>
<input type="radio" value="0" name="wl_timesched" class="input" onClick="control_TimeField();return change_common_radio(this, 'WLANConfig11b', 'wl_timesched', '0')" <% nvram_match("wl_timesched", "0", "checked"); %>><#193#>
<span id="time_setting" style="padding-left:20px;cursor:pointer;text-decoration:underline" onclick="show_wifi_schedule();"><#3358#></span>
</td>
</tr>
<tr id="wl_ap_isolate_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 5);"><#3996#></a></th>
<td>
<input type="radio" value="1" name="wl_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_ap_isolate', '1')" <% nvram_match("wl_ap_isolate", "1", "checked"); %>><#194#>
<input type="radio" value="0" name="wl_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_ap_isolate', '0')" <% nvram_match("wl_ap_isolate", "0", "checked"); %>><#193#>
</td>
</tr>
<tr id="rssiTr" class="rept ew">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 31);"><#3082#></a></th>
<td>
<select id="wl_user_rssi_option" class="input_option" onchange="changeRSSI(this.value);">
<option value="1"><#3945#></option>
<option value="0" <% nvram_match("wl_user_rssi", "0","selected"); %>><#3946#></option>
</select>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,34);"><#3969#></a></th>
<td>
<select name="wl_btc_mode" class="input_option">
<option value="0" <% nvram_match("wl_btc_mode", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_btc_mode", "1","selected"); %> ><#3945#></option>
<option value="2" <% nvram_match("wl_btc_mode", "2","selected"); %> ><#3971#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 22);"><#3992#></a></th>
<td>
<select name="wl_igs" class="input_option">
<option value="1" <% nvram_match("wl_igs", "1","selected"); %>><#3945#></option>
<option value="0" <% nvram_match("wl_igs", "0","selected"); %>><#3946#></option>
</select>
</td>
</tr>
<tr id="wl_mrate_select">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 7);"><#3923#></a></th>
<td>
<select name="wl_mrate_x" class="input_option">
<option value="0" <% nvram_match("wl_mrate_x", "0", "selected"); %>><#160#></option>
</select>
</td>
</tr>
<tr id="wl_plcphdr_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,20);"><#4061#></a></th>
<td>
<select name="wl_plcphdr" class="input_option">
<option value="long" <% nvram_match("wl_plcphdr", "long", "selected"); %>><#4062#></option>
<option value="short" <% nvram_match("wl_plcphdr", "short", "selected"); %>><#4063#></option>
<!-- auto mode applicable for STA only
<option value="auto" <% nvram_match("wl_plcphdr", "auto", "selected"); %>><#160#></option>
-->
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 9);"><#3987#></a></th>
<td>
...
<option value="1" <% nvram_match("wl_ampdu_rts", "1", "selected"); %>><#3945#></option>
<option value="0" <% nvram_match("wl_ampdu_rts", "0", "selected"); %>><#3946#></option>
</select>
</td>
</tr>
<tr id="rts_threshold">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 10);"><#4033#></a></th>
<td>
...
<tr id="wl_dtim_field">
<th><a class="hintstyle" id="wl_dtim_th"><#3980#></a></th>
<td>
...
<tr id="wl_bcn_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 12);"><#3966#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 13);"><#4040#></a></th>
<td>
<select name="wl_frameburst" class="input_option">
<option value="off" <% nvram_match("wl_frameburst", "off","selected"); %>><#3946#></option>
<option value="on" <% nvram_match("wl_frameburst", "on","selected"); %>><#3945#></option>
</select>
</td>
</tr>
<tr id="PktAggregate"><th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 16);"><#4016#></a></th>
<td>
<select name="wl_PktAggregate" class="input_option">
<option value="0" <% nvram_match("wl_PktAggregate", "0","selected"); %>><#3946#></option>
<option value="1" <% nvram_match("wl_PktAggregate", "1","selected"); %>><#3945#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 14);"><#4043#></a></th>
<td>
<select name="wl_wme" id="wl_wme" class="input_option" onChange="enable_wme_check(this);">
<option value="auto" <% nvram_match("wl_wme", "auto", "selected"); %>><#160#></option>
<option value="on" <% nvram_match("wl_wme", "on", "selected"); %>><#3945#></option>
<option value="off" <% nvram_match("wl_wme", "off", "selected"); %>><#3946#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,15);"><#4012#></a></th>
<td>
<select name="wl_wme_no_ack" id="wl_wme_no_ack" class="input_option">
<option value="off" <% nvram_match("wl_wme_no_ack", "off","selected"); %>><#3946#></option>
<option value="on" <% nvram_match("wl_wme_no_ack", "on","selected"); %>><#3945#></option>
</select>
</td>
</tr>
<tr id="wl_wme_apsd_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,17);"><#3961#></a></th>
<td>
<select name="wl_wme_apsd" class="input_option">
<option value="off" <% nvram_match("wl_wme_apsd", "off","selected"); %> ><#3946#></option>
<option value="on" <% nvram_match("wl_wme_apsd", "on","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr id="DLSCapable" class="rept"> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,18);"><#3977#></a></th>
<td>
<select name="wl_DLSCapable" class="input_option">
<option value="0" <% nvram_match("wl_DLSCapable", "0","selected"); %>><#3946#></option>
<option value="1" <% nvram_match("wl_DLSCapable", "1","selected"); %>><#3945#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,21);"><#3983#></a></th>
<td>
<select name="wl_noisemitigation" class="input_option" onChange="">
<option value="0" <% nvram_match("wl_noisemitigation", "0","selected"); %>><#3946#></option>
<option value="1" <% nvram_match("wl_noisemitigation", "1","selected"); %>><#3945#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);"><#4036#></a></th>
<td>
<select name="traffic_5g" class="input_option">
<option value="1" <% nvram_match("traffic_5g", "1","selected"); %>><#3945#></option>
<option value="0" <% nvram_match("traffic_5g", "0","selected"); %>><#3946#></option>
</select>
</td>
</tr>
<tr id="wl_ampdu_mpdu_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,26);"><#3953#></a></th>
<td>
<select name="wl_ampdu_mpdu" class="input_option">
<option value="0" <% nvram_match("wl_ampdu_mpdu", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_ampdu_mpdu", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr id="wl_ack_ratio_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,27);"><#3951#></a></th>
<td>
<select name="wl_ack_ratio" class="input_option">
<option value="0" <% nvram_match("wl_ack_ratio", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_ack_ratio", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr>
<th id="turbo_qam_title"><a id="turbo_qam_hint" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,28);"><#4037#></a></th>
<td>
<select name="wl_turbo_qam" class="input_option">
<option value="0" <% nvram_match("wl_turbo_qam", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_turbo_qam", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr>
...
<option value="0" <% nvram_match("wl_turbo_qam_brcm_intop", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_turbo_qam_brcm_intop", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr id="wl_80211h_tr" style="display:none;">
<th><a class="hintstyle"><#3948#></a></th>
<td>
<select name="wl1_80211h" class="input_option">
<option value="0" <% nvram_match("wl1_80211h", "0","selected"); %>><#3946#></option>
<option value="1" <% nvram_match("wl1_80211h", "1","selected"); %>><#3945#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,32);"><#3962#></a></th>
<td>
<select name="wl_atf" class="input_option">
<option value="0" <% nvram_match("wl_atf", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_atf", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr id="wl_MU_MIMO_field" style="display:none">
<th><a class="hintstyle"><#3924#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_mumimo" class="input_option" onchange="handle_mimo(this.value)" disabled>
<option value="0" <% nvram_match("wl_mumimo", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_mumimo", "1","selected"); %> ><#3945#></option>
</select>
</div>
</td>
</tr>
<tr id="ofdma_field" style="display:none">
<th><a class="hintstyle"><#2890#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_ofdma" class="input_option">
<option value="0" <% nvram_match("wl_ofdma", "0","selected"); %>><#3946#></option>
...
<tr id="wl_txbf_field">
<th><a id="wl_txbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,24);"><#3984#></a></th>
<td>
<select name="wl_txbf" class="input_option" onchange="handle_beamforming(this.value)">
<option value="0" <% nvram_match("wl_txbf", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_txbf", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr id="wl_itxbf_field">
<th><a id="wl_itxbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,25);"><#4041#></a></th>
<td>
<select name="wl_itxbf" class="input_option" disabled>
<option value="0" <% nvram_match("wl_itxbf", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_itxbf", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("wl_ext_nss", "0","selected"); %>><#3946#></option>
<option value="2" <% nvram_match("wl_ext_nss", "2","selected"); %>>4x4@80MHz</option>
<option value="1" <% nvram_match("wl_ext_nss", "1","selected"); %>><#3945#></option>
</select>
</td>
</tr>
<tr id="wl_txPower_field">
<th><a id="wl_txPower_field_title" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 16);"><#3930#></a></th>
<td>
<div>
<table>
<tr>
...
<option value="0" <% nvram_match("wl_precacen", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_precacen", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr>
...
<option value="0" <% nvram_match("wl_hwol", "0","selected"); %> ><#3946#></option>
<option value="1" <% nvram_match("wl_hwol", "1","selected"); %> ><#3945#></option>
</select>
</td>
</tr>
<tr id="region_tr" style="display:none" class="rept ew">
<th><a class="hintstyle"><#4027#></a></th>
