...
var category_info = [ ["Parental Controls", "1", "<#1228#>", "<#1230#>", "<#1461#>"],
["Parental Controls", "3", "<#1228#>", "<#1230#>", "<#1463#>"],
["Parental Controls", "4", "<#1228#>", "<#1230#>", "<#1464#>"],
["Parental Controls", "5", "<#1228#>", "<#1230#>", "<#1465#>"],
["Parental Controls", "6", "<#1228#>", "<#1230#>", "<#1466#>"],
["Parental Controls", "8", "<#1228#>", "<#1230#>", "<#1467#>"],
["Parental Controls", "9", "<#1228#>", "<#1231#>", "<#1468#>"],
["Parental Controls", "10", "<#1228#>", "<#1231#>", "<#1469#>"],
["Parental Controls", "14", "<#1228#>", "<#1231#>", "<#1470#>"],
["Parental Controls", "15", "<#1228#>", "<#1231#>", "<#1471#>"],
["Parental Controls", "16", "<#1228#>", "<#1231#>", "<#1472#>"],
["Parental Controls", "25", "<#1228#>", "<#1231#>", "<#1473#>"],
["Parental Controls", "26", "<#1228#>", "<#1231#>", "<#1474#>"],
["Parental Controls", "11", "<#1228#>", "<#1232#>", "<#1475#>"],
["Parental Controls", "24", "<#1243#>", "<#1233#>", "<#1476#>"],
["Parental Controls", "51", "<#1243#>", "<#1234#>", "<#1477#>"],
["Parental Controls", "53", "<#1243#>", "<#1235#>", "<#1478#>"],
["Parental Controls", "89", "<#1243#>", "<#1235#>", "<#1479#>"],
["Parental Controls", "42", "<#1243#>", "<#1236#>", "<#1480#>"],
["Parental Controls", "56", "<#1246#>", "<#1248#>", "<#1481#>"],
["Parental Controls", "70", "<#1246#>", "<#1248#>", "<#1482#>"],
["Parental Controls", "71", "<#1246#>", "<#1248#>", "<#1483#>"],
["Parental Controls", "57", "<#1246#>", "<#1249#>", "<#1484#>"],
["Parental Controls", "69", "<#1250#>", "<#1252#>", "<#1485#>"],
["Parental Controls", "23", "<#1250#>", "<#1253#>", "<#1486#>"],
["Home Protection", "91", "Anti-Trojan detecting and blocked", "", "<#1487#>"],
["Home Protection", "2", "Malicious site blocked", "", "<#1462#>"],
["Home Protection", "39", "Malicious site blocked", "", "<#1488#>"],
["Home Protection", "73", "Malicious site blocked", "", "<#1489#>"],
["Home Protection", "74", "Malicious site blocked", "", "<#1490#>"],
["Home Protection", "75", "Malicious site blocked", "", "<#1491#>"],
["Home Protection", "76", "Malicious site blocked", "", "<#1492#>"],
["Home Protection", "77", "Malicious site blocked", "", "<#1493#>"],
["Home Protection", "78", "Malicious site blocked", "", "<#1494#>"],
["Home Protection", "79", "Malicious site blocked", "", "<#1495#>"],
["Home Protection", "80", "Malicious site blocked", "", "<#1496#>"],
["Home Protection", "81", "Malicious site blocked", "", "<#1497#>"],
["Home Protection", "82", "Malicious site blocked", "", "<#1498#>"],
["Home Protection", "83", "Malicious site blocked", "", "<#1499#>"],
["Home Protection", "84", "Malicious site blocked", "", "<#1500#>"],
["Home Protection", "85", "Malicious site blocked", "", "<#1501#>"],
["Home Protection", "86", "Malicious site blocked", "", "<#1502#>"],
["Home Protection", "88", "Malicious site blocked", "", "<#1503#>"],
["Home Protection", "92", "Malicious site blocked", "", "<#1504#>"],
["Home Protection", "94", "Malicious site blocked", "", "<#1505#>"],
["Home Protection", "95", "Malicious site blocked", "", "<#1506#>"]
];
var target_info = {
url: "",
category_id: "",
...
var parental_string = "";
code = "<ul>";
code += "<li><div><span class='desc_info'><#1734#>:</span><br>" + target_info.desc + "</div></li>";
if(casenum != "")
code += "<li><div><span class='desc_info'>URL: </span>" + target_info.url +"</div></li>";
if(target_info.category_type == "Parental Controls")
code += "<li><div><span class='desc_info'><#1238#> :</span>" + target_info.content_category + "</div></li>";
code += "</ul>";
document.getElementById('detail_info').innerHTML = code;
if(target_info.category_type == "Parental Controls"){ //Webs Apps filter
code_title = "<div class='er_title' style='height:auto;'><#1516#></div>";
code_suggestion = "<ul>";
code_suggestion += "<li><span><#1515#></span></li>";
code_suggestion += "<li><span><#1520#></span></li>";
code_suggestion += '<li><#1298#><a href="https://global.sitesafety.trendmicro.com/index.php" target="_blank"><#1299#></a></li>';
code_suggestion += "</ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#1512#></div>";
code_suggestion = "<ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#1521#></div>"
code_suggestion = "<ul>";
if(bwdpi_support)
parental_string = "<#3358#>";
else
parental_string = "<#482#>";
code_suggestion += "<li><#1518#> "+ parental_string +" <#1519#></li>";
code_suggestion += "<li><#1520#></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
<div id="main_reason" class="p1 title_gap"><#1508#></div>
<div ></div>
<div>
...
<div id="go_btn" class='button' style="display:none;"><#1539#></div>
</div>
</body>
</html>
