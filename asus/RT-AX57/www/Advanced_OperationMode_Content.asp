...
desc += "<#46#>";
desc += "<br>";
desc += "<span style=\"color:#FC0\"><#1747#></span>";
}
else
desc = "<#449#><br/><span style=\"color:#FC0\"><#1746#></span>";
$("#mode_desc").html(desc);
clearTimeout(id_WANunplungHint);
$("#Unplug-hint").css("display", "none");
...
pstaDesc += "<#465#>";
pstaDesc += "<br><#466#>";
pstaDesc += "<br/><span style=\"color:#FC0\"><#1748#></span>";
...
<div class="apply_gen">
<input name="button" type="button" class="button_gen" onClick="saveMode();" value="<#1687#>">
</div>
</td>
</tr>
</table>
