...
var port_mismatch_notice = "<#2487#>";
var port_mismatch_list = "<#2488#>";
if(wan_proto=="v6plus"){
port_confirm = port_confirm.replace("%0$@", "<#2485#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2485#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2485#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2485#>");
}
if(wan_proto=="ocnvc"){
port_confirm = port_confirm.replace("%0$@", "<#2484#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2484#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2484#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2484#>");
}
...
switch(key) {
case "pf" :
items += "<li><a href='/Advanced_VirtualServer_Content.asp' style='text-decoration:underline;cursor:pointer;'><#410#></a></li>";
break;
case "open_nat" :
items += "<li><a href='/GameProfile.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OPEN NAT</a></li>";
break;
case "pt" :
items += "<li><a href='/Advanced_PortTrigger_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#409#></a></li>";
break;
case "https" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#2119#></a></li>";
break;
case "ssh" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#2972#></a></li>";
break;
case "openvpn" :
items += "<li><a href='/Advanced_VPN_OpenVPN.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OpenVPN</a></li>";
break;
case "ftp" :
items += "<li><a href='/Advanced_NATPassThrough_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#440#> - <#2149#></a></li>";
break;
case "ipsec" :
...
items += "<li><a href='/Advanced_Instant_Guard.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#4326#></a></li>";
}
break;
default :
break;
...
notification.desc[12] = "<#2731#>";
notification.action_desc[12] = "<#1433#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1426#>';
notification.action_desc[0] = '<#1433#>';
...
notification.desc[1] = '<#1427#>';
notification.action_desc[1] = '<#1434#>';
...
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1434#></a>';
...
notification.desc[2] = '<#1428#>';
notification.action_desc[2] = '<#1433#> (2.4GHz)';
...
notification.desc[3] = '<#1428#>';
if(band5g2_support)
notification.action_desc[3] = '<#1433#> (5GHz-1)';
else
notification.action_desc[3] = '<#1433#> (5GHz)';
...
notification.desc[19] = '<#1428#>';
notification.action_desc[19] = '<#1433#> (5GHz-2)';
...
notification.ftp = 1;
notification.desc[4] = '<#1430#>';
notification.action_desc[4] = '<#840#>';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1429#>';
notification.action_desc[4] = '<#1433#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.desc[5] = '<#1432#>';
notification.action_desc[5] = '<#840#>';
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1431#>';
notification.action_desc[5] = '<#1433#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[18] = '<#206#>';
...
notification.action_desc[8] = "<#1686#>";
...
notification.desc[16] = '<#296#><#297#><#298#><#299#>';
...
notification.desc[15] = '<#4099#>';
notification.action_desc[15] = '<#4100#>';
