...
infolist = new Array();
infolist.push(["<#742#> ...","No_selected"]);
infolist.push(["<#2008#>","phone"]);
infolist.push(["QQ","qq"]);
infolist.push(["<#3848#>","wechat"]);
...
ptypelist = new Array();
ptypelist.push(["<#742#> ...", "No_selected"]);
ptypelist.push(["<#2013#>", "Setting_Problem"]);
ptypelist.push(["<#1957#>", "Connection_or_Speed_Problem"]);
ptypelist.push(["<#1949#>", "Compatibility_Problem"]);
ptypelist.push(["<#2017#>", "Suggestion"]);
ptypelist.push(["<#2028#>", "Technical_Support"]);
ptypelist.push(["<#915#>", "Other_Problem"]);
...
url_group = new Array();
timelist = new Array();
desclist.push(["<#742#> ...","No_selected"]);
url_group.push(["select"]);//false value
if(ptype == "Setting_Problem"){
desclist.push(["<#507#>","QIS"]);
url_group.push(["QIS"]);
desclist.push(["<#394#>","Network Map"]);
url_group.push(["index"]);
desclist.push(["<#292#>","Guest Network"]);
url_group.push(["Guest_network"]);
desclist.push(["<#1304#>","AiProtection"]);
url_group.push(["AiProtection"]);
desclist.push(["<#916#>","Adaptive QoS"]); //5
url_group.push(["AdaptiveQoS"]);
desclist.push(["<#1932#>","Traditional QoS"]);
url_group.push(["AiProtection"]);
desclist.push(["<#909#>","Gaming"]);
url_group.push(["GameBoost"]);
desclist.push(["<#3401#>/<#392#>","Traffic Analyzer/Manager"]);
url_group.push(["TrafficMonitor"]);
desclist.push(["<#482#>","Parental Ctrl"]);
url_group.push(["ParentalControl"]);
desclist.push(["<#393#>","USB Application"]); //10
...
desclist.push(["<#396#>","Wireless"]);
url_group.push(["ACL", "WAdvanced", "Wireless", "WMode", "WSecurity", "WWPS"]);
desclist.push(["<#407#>","WAN"]);
url_group.push(["WAN_", "PortTrigger", "VirtualServer", "Exposed", "NATPassThrough"]);
desclist.push(["<#230#>","Dual WAN"]); //15
url_group.push(["WANPort"]);
desclist.push(["<#403#>","LAN"]);
url_group.push(["LAN", "DHCP", "GWStaticRoute", "IPTV", "SwitchCtrl"]);
desclist.push(["<#417#>/<#3561#>","USB dongle"]);
url_group.push(["Modem"]);
desclist.push(["<#1806#>","DM"]);
url_group.push(["DownloadMaster"]);//false value
desclist.push(["<#412#>","DDNS"]);
url_group.push(["DDNS"]);
desclist.push(["IPv6","IPv6"]); //20
url_group.push(["IPv6"]);
desclist.push(["VPN","VPN"]);
url_group.push(["VPN"]);
desclist.push(["<#418#>","Firewall"]);
url_group.push(["Firewall", "KeywordFilter", "URLFilter"]);
desclist.push(["<#424#>","Administration"]);
url_group.push(["OperationMode", "System", "SettingBackup"]);
desclist.push(["<#764#>","System Log"]);
url_group.push(["System"]);
desclist.push(["<#2849#>","Network Tools"]); //25
url_group.push(["Status_"]);
desclist.push(["<#3072#>","Rescue"]);
url_group.push(["Rescue"]);//false value
desclist.push(["<#1953#>","Other Devices"]);
url_group.push(["Other_Device"]);//false value
desclist.push(["<#3847#>","Fail to access"]);
url_group.push(["GUI"]);//false value
desclist.push(["<#428#>","FW update"]);
url_group.push(["FirmwareUpgrade"]);
if(isSupport("Instant_Guard")){
desclist.push(["<#4326#>","Instant Guard"]); //30
url_group.push(["Instant_Guard"]);
}
}
else if(ptype == "Connection_or_Speed_Problem"){
desclist.push(["<#1958#>","Wireless speed"]);
desclist.push(["<#1959#>","Wired speed"]);
desclist.push(["<#1961#>","Unstable connection"]);
desclist.push(["<#1960#>","Router reboot"]);
desclist.push(["<#1962#>","Wireless disconnected"]);
}
else if(ptype == "Compatibility_Problem"){
desclist.push(["<#1952#>","modem"]);
desclist.push(["<#1954#>","other router"]);
desclist.push(["<#1950#>","OS or Application"]);
desclist.push(["<#1955#>","printer"]);
desclist.push(["<#1956#>","USB modem"]);
desclist.push(["<#1951#>","external hardware disk"]);
desclist.push(["<#1953#>","network devices"]);
}
else if(ptype == "Suggestion"){
desclist.splice(0,1);
desclist.push(["<#2020#>","Translation"]);
desclist.push(["<#2021#>","UI/UX"]);
desclist.push(["<#2018#>","Current Feature"]);
desclist.push(["<#2019#>","New Feature Request"]);
}
else if(ptype == "Technical_Support"){
desclist.splice(0,1);
desclist.push(["<#2026#>","tech_ASUS"]);
desclist.push(["<#2024#>","tech_Amazon"]);
desclist.push(["<#2027#>","tech_iOS"]);
desclist.push(["<#2025#>","tech_Android"]);
}
else{ //Other_Problem
desclist.splice(0,1);
desclist.push(["<#915#>","others"]);
}
...
timelist.push(["<#742#> ...","No_selected"]);
timelist.push(["<#2036#>","Just Now"]);
...
timelist.push(["<#2040#>","Today"]);
timelist.push(["<#2041#>","Recently"]);
timelist.push(["<#2042#>","I don’t recall"]);
...
bandlist.push(["<#1412#>","All"]);
bandlist.push(["<#1997#>","I am not sure"]);
bandlist.push(["<#1998#>","Issue with the main router"]);
bandlist.push(["<#1999#>","Issue with node(s)"]);
...
unstablelist.push(["<#742#> ...","No_selected"]);
unstablelist.push(["<#1995#>","All WiFi"]);
...
unstablelist.push(["<#1996#>","Both WiFi and WAN"]);
unstablelist.push(["<#1997#>","I am not sure"]);
unstablelist.push(["<#1998#>","Issue with the main router"]);
unstablelist.push(["<#1999#>","Issue with node(s)"]);
...
if(value) {
if(allUsbStatus.search("storage") == "-1"){
alert("USB disk required in order to store the debug log, please plug-in a USB disk to <#861#> and Enable DSL Line Diagnostic again.");/*untranslated*/
...
var remaining_time_str = "<#2814#> : ";
if(dblog_remaining == 0) {
remaining_time_str += "0" + " " + "(Prepare data...)"; //Untranslated
return remaining_time_str;
}
if(days)
remaining_time_str += days + " <#1711#> ";
if(hours)
remaining_time_str += hours + " <#2319#> ";
if(minutes)
remaining_time_str += minutes + " <#2704#> ";
if(seconds)
remaining_time_str += seconds + " <#3154#> ";
return remaining_time_str;
};
...
var dblog_service_mapping = ["", "WiFi", "<#1806#>", "<#797#>", "AiMesh"];
...
selectOption = {"1 <#2319#>" : hour_to_sec(1)};
}
if(usb_support && $("input[name=dblog_tousb_cb]").prop("checked")) {
baseOption = { "12 <#2319#>" : hour_to_sec(12), "1 <#1711#>" : hour_to_sec(24), "2 <#1711#>" : hour_to_sec(48), "3 <#1711#>" : hour_to_sec(72) };
}
else {
baseOption = { "6 <#2319#>" : hour_to_sec(6), "12 <#2319#>" : hour_to_sec(12), "24 <#2319#>" : hour_to_sec(24) };
}
...
$(".dblog_service_item.wifi").after(gen_appendix_option(16, "<#2033#>", "dhd"));
}
$("input[name=dblog_service_list]").prop("checked", true);
...
if($("input[name=dblog_tousb_cb]").prop("checked")) {
if(media_support)
$(".dblog_service_item.all").after(gen_service_option(4, "<#797#>", "noUSB"));
if(!nodm_support)
$(".dblog_service_item.all").after(gen_service_option(2, "<#1806#>", "noUSB"));
}
}
...
var auth_status_hint = "<#1439#>";
document.form.fb_email.value = "";
switch(_status) {
case "0" :
auth_status_hint = "<#560#>";
break;
case "1" :
auth_status_hint = "<#1438#>";
...
<tr>
<td>
<div class="drword" id="drword" style="height:110px;"><#385#> <#700#>...
<br/>
<br/>
</div>
</td>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#424#> - <#2693#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="fb_desc0" class="formfontdesc" style="display:none;"><#1978#></div>
<div id="fb_desc1" class="formfontdesc" style="display:none;"><#1979#></div>
<div id="fb_desc_disconnect" class="formfontdesc hint-color" style="display:none;"><#1980#> <a class="hint-color" href="mailto:router_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top">router_feedback@asus.com</a></div>
...
<th><#1984#> *</th>
<td>
<input type="checkbox" class="input" name="attach_syslog" id="attach_syslog_id"><label for="attach_syslog_id"><#764#></label>&nbsp;&nbsp;&nbsp;
<input type="checkbox" class="input" name="attach_cfgfile" id="attach_cfgfile_id"><label for="attach_cfgfile_id"><#2012#></label>&nbsp;&nbsp;&nbsp;
<span id="attach_iptables_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_iptables" id="attach_iptables_id"><label for="attach_iptables_id"><#1992#></label></span>
<span id="attach_modem_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_modemlog" id="attach_modemlog_id"><label for="attach_modemlog_id"><#1943#></label></span>
<input type="checkbox" class="input" name="attach_wlanlog" id="attach_wlanlog_id"><label for="attach_wlanlog_id"><#2032#></label>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(25,11);"><#1974#> *</a></th>
<td>
<input type="radio" name="dslx_diag_enable" class="input" value="1" onclick="change_dsl_diag_enable(1);"><#194#>
<input type="radio" name="dslx_diag_enable" class="input" value="0" onclick="change_dsl_diag_enable(0);" checked><#193#>
<br>
<span id="storage_ready" class="hint-color" style="display:none;">* <#3559#></span>
<span id="be_lack_storage" class="hint-color" style="display:none;">* <#2876#></span>
</td>
</tr>
...
<option value="0" selected><#160#></option>
<option value="3600">1 <#2319#></option>
<option value="18000">5 <#2319#></option>
<option value="43200">12 <#2319#></option>
<option value="86400">24 <#2319#></option>
<option value="172800">48 <#2319#></option>
</select>
</td>
</tr>
<tr class="dblog_support_class">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34, 1);"><#1975#></a></th>
<td>
<div class="dblog_disabled_status">
<input type='radio' name='dblog_enable' id='dblog_status_en' value="1" onclick="diag_change_dblog_status();"><label for='dblog_status_en'><#194#></label>
<input type='radio' name='dblog_enable' id='dblog_status_dis' value="0" onclick="diag_change_dblog_status();" checked><label for='dblog_status_dis'><#193#></label>
<label class="storeUSBHint hint-color"><input type="checkbox" name="dblog_tousb_cb" value="1" onclick="diag_change_storeUSB();" checked><#1976#></label>
<span class="noUSBHint hint-color">* <#2876#></span>
</div>
<div class="dblog_enabled_status">
<span>* <#1967#></span>
<br>
<span class="dblog_stop_text" onclick="dblog_stop();"><#1966#></span>
</div>
</td>
</tr>
...
<div class="dblog_disabled_status">
<label class="dblog_service_item all"><input type="checkbox" name="dblog_service_list_all" onclick="diag_change_service_list_all();"><#1412#></label>
</div>
<div class="dblog_enabled_status">
...
<option value="No_selected"><#742#> ...</option>
<option value="Stable_connection"><#2014#></option>
<option value="Occasional_interruptions"><#2006#></option>
<option value="Frequent_interruptions"><#1991#></option>
<option value="Unavailable"><#2029#></option>
</select>
</td>
</tr>
<tr>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2043#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2035#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#1994#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34,2);"><#1437#></a></th>
<td>
<input type="text" name="fb_serviceno" maxlength="32" class="input_20_table" value="" autocorrect="off" autocapitalize="off">
</td>
</tr>
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34,3);"><#2023#></a></th>
<td>
...
<span class="hint-color"><#2000#> : </span>
...
<div id="eula_content" style="margin-left: 20px;"><#2030#></div>
</div>
<input id="apply_button" class="button_gen" style="margin-left: 305px; margin-top:5px;" name="btn_send" onclick="applyRule()" type="button" value="<#1542#>"/>
<div id="loadingIcon" style="display:none;"><div class="loadingIcon" style="float: left; margin-left: 305px; margin-top:5px;"></div><div style="float: left; margin-left: 15px; margin-top:10px;"><span class="hint-color"><#387#>...</span></div></div>
</td>
</tr>
<tr>
<td colspan="2">
<strong><#2167#></strong>
<ul>
<li><#2005#><br><a id="call_link" style="font-weight: bolder;text-decoration:underline;cursor:pointer;" href="" target="_blank">https://www.asus.com/support/CallUs/</a></li>
</ul>
</td>
</tr>
</table>
