...
else if(aae_ddnsinfo == "ns1.asuscomm.cn")
...
case "2":
document.getElementById("cert_desc").style.display = "none";
html_code += '<div style="display:table-cell"><input class="button_gen" onclick="open_upload_window();" type="button" value="<#1696#>"/><img id="loadingicon" style="margin-left:5px;display:none;" src="/images/InternetScan.gif"></div>';
document.getElementById("cert_act").innerHTML = html_code;
document.getElementById("cert_act").style.display = "";
document.getElementById("CAcert_details").style.display = "";
document.getElementById("cert_details").style.display = "";
...
<option class="content_input_fd" value="0" <% nvram_match("ddns_wan_unit", "0","selected"); %>><#1880#></option>
<option class="content_input_fd" value="1"<% nvram_match("ddns_wan_unit", "1","selected"); %>><#1887#></option>
</select>
</td>
</tr>
<tr id="ddns_ipv6update_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,18);"><#1721#></a></th>
<td>
...
<a id="linkToHome" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1712#></a>
</td>
</tr>
...
<input type="radio" value="1" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "1", "checked"); %>><#1715#>
</span>
<input type="radio" value="2" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "2", "checked"); %>><#1717#>
<span id="self_signed" style="color:#FFF;">
<input type="radio" value="0" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "0", "checked"); %>><#160#>
</span>
...
<div>
<input class="button_gen" onclick="save_cert_key();" type="button" value="<#1538#>" />
</div>
</td>
</tr>
</table>
...
<div class="formfonttitle" style="margin-top: 15px; margin-left: 15px;"><#1717#></div>
<div class="formfontdesc" style="margin-left: 15px;"><#1718#></div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1719#> :</div>
<div style="display:table-cell;"><input type="file" name="file_key" class="input Upload_file"></div>
</div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1723#> :</div>
<div style="display:table-cell;"><input type="file" name="file_cert" class="input Upload_file"></div>
</div>
<div style="color: #FC0; margin-left: 15px; margin-top: 20px">* <#1720#></div>
...
<div style="display:table-cell; padding-left: 5px;"><input class="button_gen" type="button" onclick="upload_cert_key();" value="<#1686#>"></div>
</div>
</div>
</form>
</body>
