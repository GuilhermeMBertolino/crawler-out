...
code += '<div class="table-cell"><#1261#></div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1261#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1223#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1222#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1224#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
$('#deleteData').hide();
code += '<div class="no-data"><#2447#></div>';
}
...
<div>
<div class="card-bg">
<div class="page-title"><#1320#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1734#></div>
<div class="description"><#1321#></div>
</div>
<div class="tm-logo">
