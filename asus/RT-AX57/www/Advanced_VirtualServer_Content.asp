...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='" + usb_port_conflict_faq + "' target='_blank' style='text-decoration:underline;color:#FC0;'><#1942#></a>";
...
add_option(document.form.KnownGames, "<#742#>", 0, 1);
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2447#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2449#>&nbsp;(<#2656#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1526#></th>';
html += '<th width="15%"><#2451#></th>';
html += '<th width="15%"><#2453#></th>';
html += '<th width="17%"><#2454#></th>';
html += '<th width="8%"><#2440#></th>';
html += '<th width="17%"><#2448#></th>';
html += '<th width="6%"><#3054#></th>';
html += '<th width="6%"><#1670#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1880#></option>")
.append("<option value='1'><#1887#></option>")
...
$("#vts_port_x").parent().parent().find('th').html('<#2451#><div class="setup_info_icon" style="display:none;"></div>');
if((wan_proto == "v6plus" || wan_proto == "ocnvc") && s46_ports_check_flag && array_ipv6_s46_ports.length > 1){
$(".setup_info_icon").show();
$(".setup_info_icon").click(
function() {
...
<div>&nbsp;</div>
<div class="formfonttitle"><#407#> - <#410#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div>
<div id="ftpPortConflict" class="formfontdesc" style="display:none;color:#FFCC00;"></div>
<div class="formfontdesc"><#2437#></div>
<ul style="margin-left:-25px; *margin-left:10px;">
<div class="formfontdesc"><li><#2098#></div>
<div class="formfontdesc" id="FTP_desc"><li><#2070#></div>
</ul>
</div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#410#>&nbspFAQ</a>
</div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2644#></div>
...
<tr>
<th><#2436#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3761#>">
</div>
</td>
</tr>
</tbody>
...
<option value="0"><#1880#></option>
<option value="1"><#1887#></option>
...
<tr>
<th><#2451#><div class="setup_info_icon" style="display:none;"></div></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2453#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2454#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/arrow-down.gif" align="right" onclick="pullLANIPList(this);" title="<#3161#>">
...
<input class="button_gen" type="button" onclick="cancelProfile();" value="<#206#>">
<input id="saveProfile" class="button_gen" type="button" value="<#1686#>">
</div>
</div>
<div id="footer"></div>
</form>
