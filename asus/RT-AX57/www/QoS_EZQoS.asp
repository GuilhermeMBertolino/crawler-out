...
var category_title = ["", "<#909#>", "<#921#>", "<#913#>", "<#923#>","<#908#>", "<#915#>", "<#925#>"];
...
$("#dualwan_primary_title").html("<#1880#> - "+dualwan_primary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_primary_title").html("<#1880#> - "+dualwan_primary_display);
}
...
$("#dualwan_secondary_title").html("<#1887#> - "+dualwan_secondary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_secondary_title").html("<#1887#> - "+dualwan_secondary_display);
}
...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2698#> - <#917#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#3064#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#3063#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#392#> - <#2698#>";
...
alert("<#3593#> "+ (qos_xobw_orig/1024).toFixed(2));
...
alert("<#3593#> "+(qos_xobw1_orig/1024).toFixed(2));
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#346#>");
return false;
}
}
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2678#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#2958#>&nbsp;(<#2656#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1642#>&nbsp;(<#2656#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#3156#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1412#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1412#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2864#></th>';
else
code += '<th style="width:330px"><#2864#></th>';
code += '<th style="width:130px"><#1812#></th>';
code += '<th style="width:130px"><#3524#></th>';
code += '<th style="width:90px"><#2655#></th>';
code += '</tr>';
...
code += '<input type="text" style="margin-left:10px;float:left;width:255px;" class="input_20_table" name="PC_devicename" onkeyup="device_filter(this);check_field();" placeholder="<#1212#>" autocorrect="off" autocapitalize="off" autocomplete="off">';
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3159#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#2447#></td></tr>';
}
else{
...
<!--[if lte IE 6.5.]><script>alert("<#1376#>");</script><![endif]-->
</div>
...
<tr>
<div class="description_down"><#916#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#918#></div>
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2317#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2668#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" id="btn_cancel_priority" type="button" onclick="cancel_priority_panel();" value="<#206#>">
<input class="button_gen" type="button" onclick="save_priority();" value="<#1687#>">
</div>
</td>
</tr>
</form>
...
<#1921#>
<ul>
<li id="function_int_desc"><#1922#></li>
<li id="qos_desc"><#1925#></li>
<li><#1923#></li>
</ul>
<#1924#>
</div>
...
<th><#2247#></th>
<td colspan="2">
<input type="radio" name="nvgfn_enable" class="input" value="1" <% nvram_match("nvgfn_enable", "1", "checked"); %>><#194#>
<input type="radio" name="nvgfn_enable" class="input" value="0" <% nvram_match("nvgfn_enable", "0", "checked"); %>><#193#>
</td>
</tr>
<tr>
<th><#1901#></th>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#1929#></div>
</td>
</tr>
<tr id="qos_type_tr" style="display:none">
<th><#3062#></th>
<td colspan="3">
<input id="int_type" name="qos_type_radio" value="1" onClick="change_qos_type(this.value);" style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link" class="hintstyle" style="display:none;" href="javascript:void(0);" onClick="openHint(20, 5);"><label for="int_type"><#916#></label></a>
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#1932#></label></a>
<input id="bw_limit_type" name="qos_type_radio" value="2" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "2","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 7)"><label for="bw_limit_type"><#162#></label></a>
...
<th><#1450#></th>
<td colspan="2">
<input id="auto" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="auto"><#161#></label>
<input id="manu" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="manu"><#389#></label>
</td>
</tr>
...
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#3524#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1812#></a></th>
<td>
...
<tr>
<td height="30" align="left" valign="top" bgcolor="#4D595D">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#919#></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" >
<div style=" *width:136px;margin-left:300px;" class="titlebtn" align="center" onClick="submitQoS();"><span><#203#></span></div>
</td>
</tr>
</table>
</td>
