...
if(_type == "start")
$time_setting_title.html("<span><#4298#></span>");
else
$time_setting_title.html("<span><#4299#></span>");
var get_time_setting_component = function(_type, _unit){
var time_unit_parm = {
"text":{"hour":"<#2319#>", "minute":"<#2704#>"},
...
$routine_schedule_title.html("<#4311#>");
...
popupHint.init();
var hint = "<#4302#>".replace("#MAXNUM", weekScheduleApi.data_max);
hint += "<br>";
hint += "<#4303#>";
...
return $("<div>").addClass("offtime_schedule_text").html("<#4305#>");
},
"get_offtime_schedule_dis_text" : function(){
return $("<div>").addClass("offtime_schedule_text dis").html("<#1536#> <#4305#>");
},
...
var $title = $("<div>").addClass("title").html("<#4305#>");
...
$no_data_bg.append($("<div>").addClass("no_data_text").html("<#2447#>"));
return $no_data_bg;
},
...
.replace("MON", "<#1705#>").replace("TUE", "<#1709#>").replace("WED", "<#1710#>")
.replace("THU", "<#1708#>").replace("FRI", "<#1704#>").replace("SAT", "<#1706#>")
.replace("SUN", "<#1707#>");
else
display_title = week_group.replace("Daily", "<#4319#>").replace("Weekdays", "<#4318#>").replace("Weekend", "<#4317#>");
