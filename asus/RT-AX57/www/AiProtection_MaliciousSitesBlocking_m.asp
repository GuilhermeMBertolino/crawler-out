...
if(info_bar == ''){
$('#recountIcon').hide();
code += '<div class="no-data"><#1226#></div>';
}
else{
$('#recountIcon').show();
...
code += '<div class="table-cell"><#1782#></div>';
code += '<div class="table-cell"><#1224#></div>';
code += '<div class="table-cell"><#1223#></div>';
code += '<div class="table-cell"><#1222#></div>';
code += '</div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1224#>">'+ cat_id_array[cat_id_index].description +'</div>';
var _name = dataObj[eventID].source[0];
if(clientList[_name]){
_name = clientList[_name].name;
}
code += '<div class="table-cell" data-title="<#1223#>">'+ _name +'</div>';
code += '<div class="table-cell" data-title="<#1222#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '</div>';
}
}
else{
...
<div>
<div class="card-bg">
<div class="page-title"><#1301#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1734#></div>
<div class="description"><#1300#></div>
</div>
<div class="tm-logo">
...
<div class="event-hit"><#1293#></div>
</div>
<div class="card-lv1 card-lv1-bg">
<div class="flexbox flex-a-center flex-j-spaceB">
<div class="description"><#1319#></div>
...
<div class="page-title canvas-title"><#1209#></div>
</div>
<div class="canvas-bg">
<div class="chart-title"><#1293#></div>
