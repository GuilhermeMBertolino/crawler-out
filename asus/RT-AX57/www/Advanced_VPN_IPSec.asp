...
$(".ipsec_inactive.renew_hint").show().html("<br><#3723#>");
}
}
});
...
var set_ddns_text = '<a href="../Advanced_ASUSDDNS_Content.asp" target="_blank" style="text-decoration: underline; font-family:Lucida Console;"><#3731#></a>';
...
alert(document.form.ipsec_clients_start.value+" <#346#>");
...
ipConflict = checkIPConflict("LAN", ipsecLanIPAddr, ipsecLanNetMask);
if(ipConflict.state) {
alert("<#2513#>: " + ipConflict.ipAddr + ",\n" + "<#2848#>: " + ipConflict.netLegalRangeStart + " ~ " + ipConflict.netLegalRangeEnd);
document.form.ipsec_clients_start.focus();
document.form.ipsec_clients_start.select();
return false;
}
...
html += "<div class='ipsec_connect_status_title'><#3290#></div>";
html += "<div class='ipsec_connect_status_title'><#892#></div>";
html += "<div class='ipsec_connect_status_title'><#3688#> <#2939#></div>";
...
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1668#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1687#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1689#>"/>
</div>
</div>
...
<th><#764#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1667#>"/>
</td>
</tr>
<tr class="ipsec_setting_content">
<th><#799#></th>
...
<th><#3681#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3673#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<span class="hint-color"><#2007#></span>
</td>
</tr>
<tr>
<th><#308#></th>
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#3945#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#3946#></label>
</td>
</tr>
...
<span class="hint-color">(10~900) <#3154#></span>
</td>
</tr>
</table>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable " style="margin-top:15px;">
...
<th><#3612#></th>
<td>
<div><#748#> : <span id="cert_status"></span></div>
<div><#3721#> : <span id="cert_issueTo"></span></div>
<div><#3720#> : <span id="cert_issueBy"></span></div>
<div><#3652#> : <span id="cert_expire"></span></div>
<div>
<input class="button_gen_dis ipsec_active export" type="button" value="<#1538#>">
<span class="ipsec_inactive"><#746#></span>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_windows" class="input" value="0" checked>
<label for="ipsec_export_cert_windows"><#3725#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3726#></label>
</div>
</td>
</tr>
<tr>
...
<input class="button_gen_dis ipsec_active renew" type="button" value="<#213#>">
<span class="ipsec_inactive renew_hint"><#746#></span>
