...
if(show_refresh){
document.getElementById('statistic_hint').innerHTML = "* <#3526#>";
}
else{
document.getElementById('statistic_hint').innerHTML = "* <#3525#>";
}
...
var description = "";
if(type == "router"){
document.getElementById('top_client_title').innerHTML = "<#463#>:";
if(period == "monthly"){
description = "<#3519#>";
}
...
if(top5_info == ""){
if(type == "router")
document.getElementById('top_client_name').innerHTML = "<#3512#>";
else
document.getElementById('top_client_name').innerHTML = "<#3511#>";
document.getElementById('top_client_traffic').innerHTML = "<#3513#>";
}
else{
...
if(type == "router")
code = "<option value='all' selected><#3509#></option>";
else
code = "<option value='all' selected><#3508#></option>";
top5_client_array = [];
top5_app_array = [];
...
code += '<th colspan="4"><#1642#>: '+ mac +'</th>';
else
code += '<th colspan="4"><#1642#>: '+ getClientCurrentName(mac); +'</th>';
}
else{
...
if(type == "router"){
code += "<th style='width:55%;text-align:left;'><#3510#></th>";
}
else{
code += '<th style="width:55%;text-align:left;"><#1642#></th>';
}
code += '<th style="width:15%;text-align:right;"><#3014#></th>';
code += '<th style="width:15%;text-align:right;"><#3010#></th>';
code += '<th style="width:15%;text-align:right;"><#3504#></th>';
code += '</tr>';
...
code = '<div style="width:110px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#3512#></div>';
}
else{
...
if(document.getElementById('duration_option').value == "monthly"){
document.getElementById('total_traffic_title').innerHTML = "<#3524#>";
}
else if(document.getElementById('duration_option').value == "weekly"){
document.getElementById('total_traffic_title').innerHTML = "<#3531#>";
}
else{ //daily
document.getElementById('total_traffic_title').innerHTML = "<#3523#>";
}
document.getElementById('current_traffic_title').innerHTML = "<#3521#>";
document.getElementById('current_traffic_percent_title').innerHTML = "<#3529#>";
}
...
<div class="formfontdesc"><#3522#></div>
<div style="margin-left:10px;">
<label style="font-size:16px;"><#3401#>:</label>
<input class="input_12_table" id="datepicker" value="">
<div id="statistic_hint" class="hint-color" style="text-align:right;margin-top:-21px;padding-right:15px;font-size:14px;">* <#3525#></div>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#3400#>:</div>
</td>
<td>
<div id="router" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter_pressed" onclick="switch_content(this);"><#3049#></div>
</td>
<td>
<div id="apps" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter" onclick="switch_content(this);"><#1509#></div>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#3402#>:</div>
</td>
<td>
<select class="input_option" id="traffic_option" onChange="change_traffic_direction(this);">
<option value="both" selected><#3009#></option>
<option value="down"><#3010#></option>
<option value="up"><#3014#></option>
</select>
</td>
<td>
<select class="input_option" id="duration_option" onChange="switch_date_type(this);">
<option value="monthly"><#1868#></option>
<option value="weekly"><#1880#></option>
<option value="daily" selected><#1860#></option>
</select>
</td>
<td>
...
<div onclick="change_top5_clients(0);" style="width:100px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#3512#></div>
</td>
<td>
...
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD" id="top_client_title"><#463#>:</th>
<td style="font-size:14px;" id="top_client_name"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#3530#>:</th>
<td style="font-size:14px;" id="top_client_traffic"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#3527#> :</th>
<td></td>
</tr>
</table>
...
<tr>
<td colspan="3">
<div class="hint-color" style="font-size:16px;text-align:center;" id="info_block_title"><#3517#></div>
</td>
</td>
</table>
</div>
