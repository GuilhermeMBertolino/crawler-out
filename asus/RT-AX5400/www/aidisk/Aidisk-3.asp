...
<table>
<tr>
<td height="780" align="left" valign="top" bgcolor="#4d595d" style="padding-top:25px;"> <table width="740" height="225" border="0">
<tr>
<td>
...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#3416#></td>
</tr>
<tr>
<td>
<div style="margin-left:20px;">
<p><input type="radio" name="check_asus_ddns" id="c1" onClick="switch_ddns();" checked>
<label for="c1"><#1823#></label>
</p>
<br/>
...
<input type="button" id="prevButton" value="<#294#>" onclick="go_pre_page();" class="button_gen">
<input type="button" id="nextButton" value="<#293#>" onclick="apply_eula_check();"class="button_gen">
