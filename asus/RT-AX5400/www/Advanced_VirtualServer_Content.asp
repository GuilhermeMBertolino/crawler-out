...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2550#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2552#>&nbsp;(<#2768#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1616#></th>';
html += '<th width="15%"><#2554#></th>';
html += '<th width="15%"><#2556#></th>';
html += '<th width="17%"><#2557#></th>';
html += '<th width="8%"><#2543#></th>';
html += '<th width="17%"><#2551#></th>';
html += '<th width="6%"><#3168#></th>';
...
$("#vts_port_x").parent().parent().find('th').html('<#2554#><div class="setup_info_icon" style="display:none;"></div>');
if((wan_proto == "v6plus" || wan_proto == "ocnvc") && s46_ports_check_flag && array_ipv6_s46_ports.length > 1){
$(".setup_info_icon").show();
$(".setup_info_icon").click(
function() {
...
<div class="formfontdesc"><#2540#></div>
...
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2756#></div>
...
<tr>
<th><#2539#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3884#>">
</div>
</td>
</tr>
</tbody>
...
<tr>
<th><#2554#><div class="setup_info_icon" style="display:none;"></div></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2556#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2557#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/arrow-down.gif" align="right" onclick="pullLANIPList(this);" title="<#3279#>">
