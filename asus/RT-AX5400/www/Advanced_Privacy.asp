...
<div>&nbsp;</div>
<div id="formfonttitle" class="formfonttitle"><#506#> - <#4381#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="privacy_desc" style="font-size:14px; margin: 20px 10px auto 10px; display:none;"><#123#></div>
...
<input class="button_gen" id="asus_withdraw_btn" onclick="withdraw_eula('asus');" type="button" value="<#238#>"/>
...
<div class="eula_withdraw_title"><#234#></div>
<div class="eula_withdraw_content">
<div><#235#></div>
<div style="margin-top:5px;"><#236#>
<div><#232#></div>
<div><#233#></div>
</div>
</div>
<div style="text-align:center;">
<div style="margin: 0px auto 10px;">
<input class="button_gen" id="tm_withdraw_btn" onclick="withdraw_eula('tm');" type="button" value="<#238#>"/>
