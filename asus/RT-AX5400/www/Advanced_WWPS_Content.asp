...
loadXML();
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#2268#> <#4199#>";
...
document.getElementById("wps_band_hint").innerHTML = "* <#4175#>";
return false;
}
...
document.getElementById("enableWPSbtn").value = "<#4071#>";
...
document.getElementById("wps_enable_hint").innerHTML = "* <#2994#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#1629#></a>"
controlDisplayItem();
return;
}
...
document.getElementById("wps_enable_hint").innerHTML = "<#4202#><br><#4203#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#479#></a> <#4204#>"
controlDisplayItem();
return;
}
if(wps_enable_old == "0"){
document.getElementById("wps_state_tr").style.display = "";
document.getElementById("wps_state_td").innerHTML = "<#4201#>";
...
document.getElementById("wps_enable_hint").innerHTML = "* <#2994#>" + band_link + "";
...
document.getElementById("wps_enable_hint").innerHTML = "<#4202#><br><#4203#> " + band_link + " <#4204#>";
if (rej0 && rej1){
document.getElementById("wps_state_tr").style.display = "none";
document.getElementById("devicePIN_tr").style.display = "none";
document.getElementById("wpsmethod_tr").style.display = "none";
...
document.getElementById("wps_state_td").innerHTML = "<#4201#> / <#4201#>";
document.getElementById("WPSConnTble").style.display = "none";
document.getElementById("wpsDesc").style.display = "none";
}
else{
...
<div class="formfontdesc"><#4035#></div>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(13,1);"><#4173#></a></th>
<td>
...
<input type="button" class="button_gen" name="switchWPSbtn" id="switchWPSbtn" value="<#3424#>" class="button" onClick="SwitchBand();">
...
<br><span id="Reset_OOB_desc"><#4158#></span>
</td>
</tr></table>
</div>
</td>
...
<tr id="devicePIN_tr">
<th>
<span id="devicePIN_name"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,4);"><#4103#></a></span>
</th>
<td>
...
<tr id="wpsmethod_tr">
<th>
<span id="wps_method"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,2);"><#4179#></a></span>
</th>
<td>
<input type="radio" name="wps_method" onclick="changemethod(0);" value="0"><#4174#>
<input type="radio" name="wps_method" onclick="changemethod(1);" value="1"><#4181#>
...
<div id="starBtn" style="margin-top:10px;"><input class="button_gen" type="button" style="margin-left:5px;" onClick="configCommand();" id="addEnrolleebtn_client" name="addEnrolleebtn" value="<#4200#>"></div>
</td>
</tr>
</table>
</td>
