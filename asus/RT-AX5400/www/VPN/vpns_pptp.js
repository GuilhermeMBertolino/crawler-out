...
$("<div>").addClass("item_hint").html("* <#3735#>").appendTo($container);
return $container;
}
...
var pptpd_clientlist_username = {"title":"<#3690#>", "type":"text", "id":"pptpd_clientlist_username", "need_check":true, "maxlength":64};
...
.val(htmlEnDeCode.htmlEncode());
var pptpd_clientlist_password = {"title":"<#2438#>", "type":"text", "id":"pptpd_clientlist_password", "need_check":true, "maxlength":64};
...
var pptpd_sr_ipaddr = {"title":"<#3227#>", "type":"text", "id":"pptpd_sr_ipaddr", "maxlength":15, "openHint":"6_1"};
...
var pptpd_sr_netmask = {"title":"<#3228#>", "type":"text", "id":"pptpd_sr_netmask", "maxlength":15, "openHint":"6_2"};
...
testResult.isError = true;
testResult.errReason = "<#3712#> " + clients_start;
}
return testResult;
};
...
$pptpd_sr_ipaddr.show_validate_hint("<#3725#> " + lan_ipaddr);
$pptpd_sr_ipaddr.focus();
return false;
}
}
...
result = "<#3723#> <b>"+pool_start+" ~ "+pool_end+"</b>";
}
...
var pptpd_ms_network_parm = {"title":"<#3737#>", "type":"switch", "id":"pptpd_ms_network"};
...
var pptpd_broadcast_parm = {"title":"<#3717#>", "type":"switch", "id":"pptpd_broadcast"};
Get_Component_Switch(pptpd_broadcast_parm).appendTo($detail_adv);
$("<div>").attr({"id": "PPTP_broadcast_hint"}).addClass("item_hint").html("* <#3137#>").appendTo($detail_adv).hide();
var pptpd_chap_options = [{"text":"<#241#>","value":"0"},{"text":"MS-CHAPv1","value":"1"},{"text":"MS-CHAPv2","value":"2"}];
var pptpd_chap_parm = {"title": "<#3105#>", "id": "pptpd_chap", "options": pptpd_chap_options, "set_value": "0"};
Get_Component_Custom_Select(pptpd_chap_parm).appendTo($detail_adv);
var pptpd_mppe_options = [{"text":"MPPE-128","value":"1"},{"text":"MPPE-40","value":"4"},{"text":"<#2987#>","value":"8"}];
var pptpd_mppe_parm = {"title": "<#2926#>", "id": "pptpd_mppe", "options": pptpd_mppe_options};
...
var pptpd_winsenable_x_parm = {"title":"<#2568#>", "type":"switch", "id":"pptpd_winsenable_x", "slide_target":"pptpd_wins"};
...
var pptpd_wins1_parm = {"title":"<#2566#>", "type":"text", "id":"pptpd_wins1", "need_check":true, "maxlength":15};
Get_Component_Input(pptpd_wins1_parm).appendTo($pptpd_wins_content_container)
.find("#" + pptpd_wins1_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var pptpd_wins2_parm = {"title":"<#2567#>", "type":"text", "id":"pptpd_wins2", "need_check":true, "maxlength":15};
...
var pptpd_clients_parm = {"title":"<#3721#>", "type":"text", "start_id":"pptpd_clients_start", "start_maxlength":15, "end_id":"pptpd_clients_end", "end_maxlength":3,
...
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("<#3887#> (<#2768#>" + htmlEnDeCode.htmlEncode(pptpd_clientlist_limit) + ")");
