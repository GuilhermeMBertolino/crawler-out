...
var led_table = ["<#1625#>", "<#3155#>", "<#2804#>", "<#2418#>"];
...
var code = '';
if(system.INTELplatform){
code += '<div class="info-title"><#4383#></div>';
...
code += '<div class="info-block"><div class="info-title"><#2649#></div><div class="info-content">'+ _lanIP +'</div></div>';
code += '<div class="info-block"><div class="info-title"><#3056#></div><div class="info-content">'+ variable.secret_code +'</div></div>';
if(variable.serial_no != ''){
code += '<div class="info-block"><div class="info-title"><#3287#></div><div class="info-content">'+ variable.serial_no +'</div></div>';
}
code += '<div class="info-block"><div class="info-title">LAN <#463#></div><div class="info-content">'+ variable.lan_hwaddr +'</div></div>';
if(system.band2gSupport){
if(system.modelName === 'GT-AXE16000'){
code += '<div class="info-block"><div class="info-title">2.4 GHz <#463#></div><div class="info-content">'+ variable.wl3_hwaddr +'</div></div>';
}
else if(odmpid === 'GT6'){
code += '<div class="info-block"><div class="info-title">2.4 GHz <#463#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
else{
code += '<div class="info-block"><div class="info-title">2.4 GHz <#463#></div><div class="info-content">'+ variable.wl0_hwaddr +'</div></div>';
}
}
if(system.triBandSupport){
if(system.band6gSupport){
code += '<div class="info-block"><div class="info-title">5 GHz <#463#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">6 GHz <#463#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
else{
if(system.modelName == 'MAP-AC2200')
{
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#463#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#463#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
}
else if(odmpid === 'GT6'){
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#463#></div><div class="info-content">'+ variable.wl0_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#463#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
}
else
{
code += '<div class="info-block"><div class="info-title">5 GHz-1 <#463#></div><div class="info-content">'+ variable.wl1_hwaddr +'</div></div>';
code += '<div class="info-block"><div class="info-title">5 GHz-2 <#463#></div><div class="info-content">'+ variable.wl2_hwaddr +'</div></div>';
}
}
}
...
code += '<div class="info-block"><div class="info-title">LAN <#463#></div><div class="info-content">'+ variable.wl3_hwaddr +'</div></div>';
}
...
var modeDesc = ['<#4216#>', '<#4218#>', '<#4220#>', '', '<#1626#>'];
code += '<div class="division-block"><#4209#></div>';
...
code += '<div class="info-content"><#2251#> '+ yadns_clients[i] +'</div>';
code += '</div>';
}
}
...
var code = '<div class="division-block"><#836#></div>';
code += '<div>';
for(i=0;i<core_num;i++){
...
var code = '<div class="division-block"><#838#></div>';
code += '<div>';
code += '<div>';
code += '<div class="display-flex flex-a-center ram-content">';
code += '<div class="ram-text-width"><#839#></div>';
code += '<div class="ram-text-width"><#840#></div>';
code += '<div class="ram-text-width"><#841#></div>';
code += '</div>';
code += '<div class="display-flex flex-a-center ram-content">';
...
$("<div>").css({"margin-bottom":"6px"}).html("<#3088#> <#3089#>").appendTo($hint_text_bg);
...
$("<div>").css({"margin-bottom":"6px"}).html("<#3090#> :").appendTo($hint_text_bg);
var $help_item = $("<ol>").css({"margin":"0", "padding":"0", "margin-left":"24px"}).appendTo($hint_text_bg);
$("<li>").css({"color":"#64737c"}).html("<#3095#>".replace("#ETHCABLE", "Cat 5e")).appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3091#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3092#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3093#>").appendTo($help_item);
$("<li>").css({"color":"#64737c"}).html("<#3094#>").appendTo($help_item);
var $action_bg = $("<div>").css({"margin-top":"18px", "text-align":"right"}).appendTo($popup_hint_bg);
var $action_ok = $("<input/>").attr({"id":"action_ok", "type":"button", "value":"<#1779#>"}).addClass("button_gen");
...
$("#phy_ports").append('<div class="division-block" style="position:relative;"><span><#832#></span><div class="port_status_notice_icon"></div></div>');
...
$("<div>").addClass("conn").html("<#277#>").appendTo($port_status_icon_desc);
$("<div>").addClass("warn").html("<#2999#>").appendTo($port_status_icon_desc);/* untranslated */
$("<div>").addClass("unplug").html("<#835#>").appendTo($port_status_icon_desc);
if(show_notice){
...
var code = '<div class="division-block"><#4459#></div>';
code += '<div>';
code += '<div class="display-flex flex-a-center table-header">';
code += '<div class="port-block-width table-content"><#830#></div>';
code += '<div class="port-block-width table-content">Tx (<#2487#>)</div>';
code += '<div class="port-block-width table-content">Rx (<#2487#>)</div>';
code += '</div>';
...
<div id="wireless_tab" class="tab-block" onclick="switchTab(this.id)"><#478#></div>
<div id="status_tab" class="tab-block tab-click" onclick="switchTab(this.id)"><#830#></div>
