...
disk_list_array = { "info" : ["<#1865#>", "disk.asp"], "health" : ["<#1858#>", "disk_utility.asp"], "format" : ["<#1772#>", "disk_format.asp"]};
...
<p class="formfonttitle_nwm"><#2920#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#1531#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#3505#>:</p>
...
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#880#>:</p>
<input type="button" class="button_gen" onclick="goUPnP();" value="<#1629#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="aidisk_hyperlink">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1097#>:</p>
<input type="button" class="button_gen" onclick="gotoAidisk();" value="<#1629#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
<tr id="dmLink" style="display:none;">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#1901#>:</p>
<input type="button" class="button_gen" onclick="gotoDM();" value="<#1629#>" >
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; "><#3248#>:</p>
<input id="show_remove_button" class="button_gen" type="button" class="button" onclick="remove_disk_call();" value="<#1631#>">
<div id="show_removed_string" style="display:none;"><#3246#></div>
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; " onmouseover="parent.overHint(24);" onmouseout="parent.nd();"><#3284#></p>
...
<li><#1881#><a href="/" target="_parent"><#1882#></a><#1883#></li>
</ul>
</div>
