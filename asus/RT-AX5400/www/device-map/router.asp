...
'triBandSmartConnect': [['0', '<#3354#>', '0']],
'dualBand6GHzSmartConnect': [['0', '2.4 / 5 GHz', '0'], ['2', '6 GHz', '2']],
'dualBandSmartConnect': [['0', '<#3353#>', '0']],
'triBand5GHzSmartConnect': [['0', '2.4 GHz', '0'], ['1', '5GHz Smart Connect', '1']],
'GT6-5GHzSmartConnect': [['2', '2.4 GHz', '2'], ['1', '5GHz Smart Connect', '1']],
'triBandMeshSmartConnect': [['0', '<#3353#>', '0'], ['2', '5 GHz-2', '2']],
'GT6triBandMeshSmartConnect': [['0', '<#3353#>', '0'], ['1', '5 GHz-2', '1']],
'triBand6GHzMeshSmartConnect': [['0', '<#3353#>', '0'], ['2', '6 GHz', '2']],
...
code += '<div class="button-right"><input type="button" class="button_gen" value="<#700#>" onclick="gotoSiteSurvey();"></div>';
code += '</div>';
...
code += '<div class="info-title"><#3351#></div>';
code += '<select class="input_option" onchange="enableSmartConnect(this.value)">'
code += '<option value="0" '+ (variable.smart_connect_x === '0' ? 'selected': '') +'><#1762#>';
code += '<option value="1" '+ (variable.smart_connect_x !== '0' ? 'selected': '') +'><#1769#>';
code += '</select>'
...
code += '<div class="info-block">';
code += '<div class="info-title"><#660#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4004#></div>';
...
code += '<span><#1113#> <a id="wl'+ unit +'_wpa3FaqLink" class="faq-link" target="_blank" href="">FAQ</a></span>';
code += '</div>';
}
...
if(!system.lyraHideSupport){
code += '<div class="info-block">';
code += '<div class="info-title"><#956#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4193#></div>';
...
if(dwb_info.mode == '1'){
if(isSupport("wifi6e")){
_optionArray = [['<#950#>', '0'], ['<#3354#>', '1'], ['<#3353#>', '3']];
}
else{
_optionArray = [['<#950#>', '0'], ['<#3353#>', '1']];
if(isSupport("amas_fronthaul_network")){
var fh_ap_enabled = httpApi.nvramGet(["fh_ap_enabled"]).fh_ap_enabled;
if(fh_ap_enabled == "2")
_optionArray[1][0] = '<#3354#>';
}
}
}
else{
...
_optionArray = [['<#950#>', '0'], ['<#3354#>', '1'], ['2.4 GHz and 5 GHz Smart Connect', '3']];
if(variable['smart_connect_selif_x'] == '3'){
_smart_connect_x = '3';
}
}
else{
_optionArray = [['<#950#>', '0'], ['<#3354#>', '1'], ['5GHz Smart Connect', '2']];
}
}
}
else{
...
<div id="wireless_tab" class="tab-block tab-click" onclick="switchTab(this.id)"><#478#></div>
<div id="status_tab" class="tab-block" onclick="switchTab(this.id)"><#830#></div>
...
<input type="button" class="button_gen" value="<#284#>" onclick="apply();">
</div>
</div>
</body>
</html>
