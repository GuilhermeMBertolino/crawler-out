...
var code = '';
code += '<thead><tr><td colspan="4"><#2323#>&nbsp;(<#2768#>&nbsp;64)</td></tr></thead>';
code += '<tr>';
code += '<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1642#> (<#3119#>)</a></th>';
code += '<th><#2767#></th>';
code += '</tr>';
code += '<tr>';
code += '<td width="40%">';
...
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3280#>">';
...
<tr>
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2340#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2341#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2342#></div>
</td>
<td>
...
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2343#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2344#></div>
</td>
<td>
