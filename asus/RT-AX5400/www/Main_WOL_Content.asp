...
<div>&nbsp;</div>
<div class="formfonttitle"><#2962#> - <#2979#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3349#></div>
<div class="formfontdesc"><#3350#></div>
...
<input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2980#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2973#>&nbsp;(<#2768#>&nbsp;32)</td>
</tr>
</thead>
<tr>
