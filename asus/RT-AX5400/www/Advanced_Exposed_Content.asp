...
<th><#1991#></th>
<td>
<input type="radio" name="dmz_enable" class="input" onclick="dmz_on_off()" ><#275#>
<input type="radio" name="dmz_enable" class="input" onclick="dmz_on_off()" ><#274#>
</td>
</tr>
<tr id="wan_dmz_ip_tr">
<th colspan=2><#1978#></th>
</tr>
<tr id="dmz_ip_tr">
<th><#2528#></th>
<td>
