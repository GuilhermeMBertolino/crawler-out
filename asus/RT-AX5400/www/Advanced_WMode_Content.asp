...
code +='<tr><td style="color:#FFCC00;"><#2550#></td>';
}
else{
...
<div id="wl_bw_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#4032#></div>
<div id="wl_ch_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#4033#></div>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#4083#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#4084#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#4085#></option>
</select>
</td>
</tr>
...
<td colspan="4"><#4052#>&nbsp;(<#2768#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#4052#></th>
<th class="edit_table" width="20%"><#2767#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3275#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
