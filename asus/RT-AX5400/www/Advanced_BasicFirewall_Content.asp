...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2550#></td></tr>';
else{
...
<option value="drop" <% nvram_match("fw_log_x", "drop","selected"); %>><#3011#></option>
<option value="accept" <% nvram_match("fw_log_x", "accept","selected"); %>><#3008#></option>
<option value="both" <% nvram_match("fw_log_x", "both","selected"); %>><#3009#></option>
</select>
</td>
</tr>
<tr>
...
<th><#1616#></th>
<th><#2224#></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2541#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,24);"><#2189#></a></th>
<th><#2543#></th>
<th><#2767#></th>
</tr>
