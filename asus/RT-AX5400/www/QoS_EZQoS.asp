...
var category_title = ["", "<#993#>", "<#1005#>", "<#997#>", "<#1007#>","<#992#>", "<#999#>", "<#1009#>"];
...
$("#dualwan_primary_title").html("<#1978#> - "+dualwan_primary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_primary_title").html("<#1978#> - "+dualwan_primary_display);
}
...
$("#dualwan_secondary_title").html("<#1985#> - "+dualwan_secondary_display+" (LAN Port "+wans_lanport_orig+")");
}
else{
$("#dualwan_secondary_title").html("<#1985#> - "+dualwan_secondary_display);
}
...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2811#> - <#1001#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#3178#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#3177#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#474#> - <#2811#>";
...
alert("<#3713#> "+ (qos_xobw_orig/1024).toFixed(2));
...
alert("<#3713#> "+(qos_xobw1_orig/1024).toFixed(2));
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#428#>");
return false;
}
}
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2791#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#3072#>&nbsp;(<#2768#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1735#>&nbsp;(<#2768#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#3274#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1501#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1501#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2977#></th>';
else
code += '<th style="width:330px"><#2977#></th>';
code += '<th style="width:130px"><#1907#></th>';
code += '<th style="width:130px"><#3643#></th>';
code += '<th style="width:90px"><#2767#></th>';
code += '</tr>';
...
code += '<input type="text" style="margin-left:10px;float:left;width:255px;" class="input_20_table" name="PC_devicename" onkeyup="device_filter(this);check_field();" placeholder="<#1297#>" autocorrect="off" autocapitalize="off" autocomplete="off">';
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3277#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#2550#></td></tr>';
}
else{
...
<tr>
<div class="description_down"><#1000#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#1002#></div>
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#2419#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2781#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" id="btn_cancel_priority" type="button" onclick="cancel_priority_panel();" value="<#287#>">
<input class="button_gen" type="button" onclick="save_priority();" value="<#1780#>">
</div>
</td>
</tr>
</form>
...
<#2021#>
<ul>
<li id="function_int_desc"><#2022#></li>
<li id="qos_desc"><#2025#></li>
<li><#2023#></li>
</ul>
<#2024#>
</div>
...
<th><#2348#></th>
<td colspan="2">
<input type="radio" name="nvgfn_enable" class="input" value="1" <% nvram_match("nvgfn_enable", "1", "checked"); %>><#275#>
<input type="radio" name="nvgfn_enable" class="input" value="0" <% nvram_match("nvgfn_enable", "0", "checked"); %>><#274#>
</td>
</tr>
<tr>
<th><#2001#></th>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#2029#></div>
</td>
</tr>
<tr id="qos_type_tr" style="display:none">
<th><#3176#></th>
<td colspan="3">
<input id="int_type" name="qos_type_radio" value="1" onClick="change_qos_type(this.value);" style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link" class="hintstyle" style="display:none;" href="javascript:void(0);" onClick="openHint(20, 5);"><label for="int_type"><#1000#></label></a>
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#2032#></label></a>
<input id="bw_limit_type" name="qos_type_radio" value="2" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "2","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 7)"><label for="bw_limit_type"><#243#></label></a>
...
<th>RouterBoost</th>
<td colspan="2">
<input id="rb_on" name="rb_toggle" onClick="routerboost_enable_setting();" type="radio" <% nvram_match("rb_enable", "1","checked"); %>><label for="rb_on"><#1756#></label>
<input id="rb_off" name="rb_toggle" onClick="routerboost_enable_setting();" type="radio" <% nvram_match("rb_enable", "0","checked"); %>><label for="rb_off"><#1764#></label>
</td>
</tr>
<tr id="bandwidth_setting_tr" style="display:none">
<th><#1539#></th>
<td colspan="2">
<input id="auto" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="auto"><#242#></label>
<input id="manu" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="manu"><#471#></label>
</td>
</tr>
...
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#3643#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1907#></a></th>
<td>
...
<tr>
<td height="30" align="left" valign="top" bgcolor="#4D595D">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#1003#></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" >
<div style=" *width:136px;margin-left:300px;" class="titlebtn" align="center" onClick="submitQoS();"><span><#284#></span></div>
</td>
</tr>
</table>
</td>
