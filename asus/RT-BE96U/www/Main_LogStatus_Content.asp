...
<div>&nbsp;</div>
<div class="formfonttitle"><#851#> - <#514#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2357#></div>
...
<tr>
<th><#2356#></a></th>
<td><span id="boot_days"></span> <#1808#> <span id="boot_hours"></span> <#2429#> <span id="boot_minutes"></span> <#2826#> <span id="boot_seconds"></span> <#3279#></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11,1)"><#2745#></a></th>
<td>
...
<div class="hint-color"><#2746#></div>
</td>
</tr>
</table>
</form>
<div class="apply_gen" style="margin-top: 5px; text-align: center;"><input class="button_gen" onclick="applySettings();" type="button" value="<#286#>" /></div>
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1765#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1784#>" class="button_gen">
</form>
</td>
</tr>
</table>
