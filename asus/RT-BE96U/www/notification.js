...
var port_mismatch_notice = "<#2599#>";
var port_mismatch_list = "<#2600#>";
if(wan_proto=="v6plus"){
port_confirm = port_confirm.replace("%0$@", "<#2597#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2597#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2597#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2597#>");
}
if(wan_proto=="ocnvc"){
port_confirm = port_confirm.replace("%0$@", "<#2596#>");
port_range_hint = port_range_hint.replace("%1$@", "<#2596#>");
port_mismatch_notice = port_mismatch_notice.replace("%2$@", "<#2596#>");
port_mismatch_list = port_mismatch_list.replace("%3$@", "<#2596#>");
}
...
switch(key) {
case "pf" :
items += "<li><a href='/Advanced_VirtualServer_Content.asp' style='text-decoration:underline;cursor:pointer;'><#494#></a></li>";
break;
case "open_nat" :
items += "<li><a href='/GameProfile.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OPEN NAT</a></li>";
break;
case "pt" :
items += "<li><a href='/Advanced_PortTrigger_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#493#></a></li>";
break;
case "https" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#2223#></a></li>";
break;
case "ssh" :
items += "<li><a href='/Advanced_System_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#3095#></a></li>";
break;
case "openvpn" :
items += "<li><a href='/Advanced_VPNServer_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'>OpenVPN</a></li>";
break;
case "ftp" :
items += "<li><a href='/Advanced_NATPassThrough_Content.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#524#> - <#2253#></a></li>";
break;
case "ipsec" :
...
items += "<li><a href='/Advanced_Instant_Guard.asp' target='_blank' style='text-decoration:underline;cursor:pointer;'><#4481#></a></li>";
}
break;
default :
break;
...
notification.desc[12] = "<#2853#>";
notification.action_desc[12] = "<#1526#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1519#>';
notification.action_desc[0] = '<#1526#>';
...
noti_upgrade_flag = 1;
notification.desc[1] = '<#1520#>';
notification.action_desc[1] = '<#1527#>';
...
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1527#></a>';
...
notification.desc[2] = '<#1521#>';
notification.action_desc[2] = '<#1526#> (2.4GHz)';
...
notification.desc[3] = '<#1521#>';
if(band5g2_support)
notification.action_desc[3] = '<#1526#> (5GHz-1)';
else
notification.action_desc[3] = '<#1526#> (5GHz)';
...
notification.desc[19] = '<#1521#>';
notification.action_desc[19] = '<#1526#> (5GHz-2)';
...
notification.ftp = 1;
notification.desc[4] = '<#1523#>';
notification.action_desc[4] = '<#928#>';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1522#>';
notification.action_desc[4] = '<#1526#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.desc[5] = '<#1525#>';
notification.action_desc[5] = '<#928#>';
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1524#>';
notification.action_desc[5] = '<#1526#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[18] = '<#289#>';
...
notification.action_desc[8] = "<#1783#>";
...
notification.desc[16] = '<#380#><#381#><#382#><#383#>';
...
notification.desc[15] = '<#4251#>';
notification.action_desc[15] = '<#4252#>';
