...
<script>
option_netstat = new Array("<#3349#>","<#3353#>","<#3354#>","<#3352#>","<#3355#>","<#3350#>","<#1888#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2957#>", "<#2958#>", "<#2959#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2979#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2971#> - Netstat</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2979#></div>
...
<option value="-a"><#3349#></option>
<option value="-ta"><#3353#></option>
<option value="-ua"><#3354#></option>
<option value="-w"><#3352#></option>
<option value="-xa"><#3355#></option>
<option value="-l"><#3350#></option>
<option value="-r"><#1888#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2986#> IP</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3287#>">
<div id="ClientList_Block_PC" class="ClientList_Block_PC" style="margin-left:2px;"></div>
</td>
</tr>
...
<option value="-r state" selected><#2964#></option>
<option value="-r src"><#2962#></option>
<option value="-r dst"><#2960#></option>
<option value="-r src-port"><#2963#></option>
<option value="-r dst-port"><#2961#></option>
</select>
</td>
</tr>
...
<div class="apply_gen">
<input class="btn_subusage button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="Netstat">
