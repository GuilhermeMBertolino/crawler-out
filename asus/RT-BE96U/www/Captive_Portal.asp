...
$("#apply_button").val('<#286#>');
}
else {
captivePortalShowAndHide(0);
$("#apply_button").val('<#4325#>');
}
...
each_band_code += "<div class='gn_item_title'><#664#></div>";
...
each_band_code += "<div class='gn_item_unenabled'><#832#></div>";
}
...
code += "<div class='gn_group_title'><#376#> - " + (wl_idx + 1) + " - Used by " + third_party_wl_used[(wl_idx + 1)] + "</div>";
else
code += "<div class='gn_group_title'><#376#> - " + (wl_idx + 1) + "</div>";
...
code += "<input class='button_gen' onclick='cancel_gn_group();' type='button' value='<#289#>'/>";
code += "<input class='button_gen' onclick='save_gn_group();' type='button' value='<#286#>'/>";
code += "</div>";
...
code += "<div class='splash_item_title'>" + wl_nband_title[_wl_idx] + " <#664#></div>";
...
code = "";
code += "<div class='cp_item_title'><#4356#></div>";
...
code += "<option value='center'><#4332#></option>";
code += "<option value='extend'><#4363#></option>";
code += "</select>";
code += "</div>";
code += "<div id='splash_image_conent' class='splash_image_conent'>";
if(isSupportFileReader() && isSupportCanvas()) {
code += "<div id='splash_image_default' class='splash_image_default' onclick='splash_upload_image();' title='<#4364#>'>";
code += "<div class='splash_image_text'><#4364#></div>";
}
else {
...
code += "</div>";
code += "<div id='splash_image_canvas_content' class='splash_image_canvas_content' style='display:none;' onclick='preview_splash_page();' title='<#4364#>'>";
...
code += "</div>";
code += "<div class='splash_template_title'><#4369#>";
code += "</div>";
...
code += "</div>";
code += "<div class='splash_template_continue'><#4371#></div>";
code += "</div>";
code += "</div>";
code += "</div>";
code += "<div class='splash_image_hint'><#4334#>: < 10MB</div>";
code += "<div class='splash_image_hint'><#4338#>: jpg, png</div>";/*untranslated*/
code += "<div class='splash_image_hint'><#4337#>: 1152 x 864 px or above</div>";/*untranslated*/
if(isSupportFileReader() && isSupportCanvas()) {
code += "<div class='splash_preview'>";
code += "<input class='button_gen' onclick='splash_upload_image();' type='button' value='<#4275#>' style='margin: 0 5px'/>";
code += "<input class='button_gen' onclick='preview_splash_page();' type='button' value='<#4276#>' style='margin: 0 5px'/>";
code += "</div>";
...
code += "<div class='splash_content'>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4331#></div>";
...
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4365#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4358#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4355#></div>";
...
code += "<span class='splash_item_text'><#2826#></span>";
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#245#></div>";
code += "<span class='splash_item_hint' style='margin:0px;'>(<#2024#>)</span>";
code += "<div class='splash_item_title'><#3019#></div>";
...
code += "<div class='splash_item_title'><#3023#></div>";
...
code += "</div>";
code += "<div class='splash_item_content'>";
code += "<div class='splash_item_title'><#4335#> (<#4339#>)</div>";
...
code += "<input class='button_gen' onclick='apply();' type='button' value='<#286#>'/>";
code += "</div>";
$('#captive_portal_content').append(code);
}
function apply() {
...
html_landing += "</g>\n";
html_landing += "</svg>\n";
html_landing += "<div id='splash_template_title' class='splash_template_title'><#4369#></div>\n";
...
html_landing += "<div id='splash_template_continue' class='splash_template_continue' onclick='continue_action();'><#4371#></div>\n";
html_landing += "</div>\n";
html_landing += "</div>\n";
...
<div class='landing_folder_title'><#949#></div>
<div id='e0' class='folder_tree'></div>
<div class='landing_folder_bottom'>
<input class='button_gen' type='button' onclick='cancel_folderTree();' value='<#289#>'>
<input class='button_gen' type='button' style='margin-left:15px;' onclick='confirm_folderTree();' value='<#1783#>'>
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#376#> - Free WiFi</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="cp_page_intro_icon"></div>
<div style='float:left;width:80%;'>
<div class="cp_page_intro_txt" style="color:#FC0;"><#4359#></div>
<div class="cp_page_intro_txt"><#4360#></div>
