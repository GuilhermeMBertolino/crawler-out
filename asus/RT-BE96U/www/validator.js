...
document.getElementById("check_ip_input").innerHTML="<#430#>";
...
isValidHost: function(value) { //<#430#>
var err_count=0;
var alert_content = "<#430#>\n<#2643#>";
...
alert(document.form.wan_ipaddr_x.value + " <#430#>");
document.form.wan_ipaddr_x1.focus();
return false;
}
...
alert(document.form.wan_ipaddr_x1.value + "<#414#>");
document.form.wan_ipaddr_x1.focus();
document.form.wan_ipaddr_x1.select();
return false;
}
...
if(!groupChar(c)){
alert('<#436#> '+o.value.charAt(i)+' <#437#>');
o.focus();
o.select();
return false;
}
