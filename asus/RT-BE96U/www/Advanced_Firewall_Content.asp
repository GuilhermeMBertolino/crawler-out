...
add_option(document.form.LWKnownApps, "<#2544#>", "User Defined", 1);
...
<div class="formfontdesc hint-color" style="color:#FFCC00;"><#2166#></div>
<div id="svc_hint_div" class="warning_desc" style="display:none;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" style="color:#FFCC00;text-decoration:underline;cursor:pointer;"><#374#></span></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,5);"><#2187#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,3);"><#2184#></a></th>
<td>
<select name="filter_lw_default_x" class="input_option">
<option value="DROP" <% nvram_match("filter_lw_default_x", "DROP","selected"); %>><#3981#></option>
<option value="ACCEPT" <% nvram_match("filter_lw_default_x", "ACCEPT","selected"); %>><#1549#></option>
</select>
</td>
</tr>
<tr>
...
<option value="User Defined"><#2544#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,1);"><#2180#></a></th>
<td>
<input type="checkbox" name="filter_lw_date_x_Mon" class="input" onclick="check_Timefield_checkbox()"><#1802#>
<input type="checkbox" name="filter_lw_date_x_Tue" class="input" onclick="check_Timefield_checkbox()"><#1806#>
<input type="checkbox" name="filter_lw_date_x_Wed" class="input" onclick="check_Timefield_checkbox()"><#1807#>
<input type="checkbox" name="filter_lw_date_x_Thu" class="input" onclick="check_Timefield_checkbox()"><#1805#>
<input type="checkbox" name="filter_lw_date_x_Fri" class="input" onclick="check_Timefield_checkbox()"><#1801#>
</td>
</tr>
<tr id="enable_time_week_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,2);"><#2182#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,1);"><#2180#></a></th>
<td>
<input type="checkbox" name="filter_lw_date_x_Sat" class="input" onclick="check_Timefield_checkbox()"><#1803#>
<input type="checkbox" name="filter_lw_date_x_Sun" class="input" onclick="check_Timefield_checkbox()"><#1804#>
</td>
</tr>
...
<tr>
<th ><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,4);"><#2189#></a></th>
<td>
...
<thead>
<tr>
<td colspan="6" id="filter_lwlist"><#2194#>&nbsp;(<#2776#>&nbsp;32)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,3);"><#2192#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><#2193#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,3);"><#2185#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><#2193#></a></th>
<th><#2551#></th>
<th><#2775#></th>
</tr>
