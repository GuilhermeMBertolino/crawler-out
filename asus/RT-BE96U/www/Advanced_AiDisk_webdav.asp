...
<div class="formfontdesc"><#3662#></div>
...
<option value="0" <% nvram_match("enable_webdav", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("enable_webdav", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
