...
let channelSnippet = `<option value="0"><#243#></option>`;
...
${v1Type === "1" ? "selected" : ""}><#3363#> (2.4 GHz, 5 GHz and 6 GHz)</optio>
<option class="content_input_fd" value="3"
${v1Type === "3" ? "selected" : ""}><#3362#> (2.4 GHz and 5 GHz)</optio>
</select>
`;
...
<select class="input_option" id="smart_connect_x" onChange="smartConnectChange(this.value)">
<option class="content_input_fd" value="1"
${v1Type === "1" ? "selected" : ""}><#3363#> (2.4 GHz, 5 GHz-1 and 5 GHz-2)</optio>
${
aMeshPrelinkSupport
? ""
: `<option class="content_input_fd" value="2"
${v1Type === "2" ? "selected" : ""}><#3362#> (5 GHz-1 and 5 GHz-2)</optio>`
}
</select>
`;
} else {
...
<select class="input_option" id="smart_connect_x" onChange="smartConnectChange(this.value)">
<option class="content_input_fd" value="1"
${v1Type === "1" ? "selected" : ""}><#3362#> (2.4 GHz and 5 GHz)</optio>
</select>
`;
}
}
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 1);"><#664#></a>
</th>
<td>
...
? `<option value="2"
${fh_ap_enabled === "2" ? "selected" : ""}><#1173#></option>`
: ""
}
${
fronthaul_ap_option_off
? `<option value="0"
${fh_ap_enabled === "0" ? "selected" : ""}><#1174#></option>`
: ""
}
</select>
</td>
...
${
psc6g === "1" ? "checked" : ""
} onClick="pscChannelEnable(this.checked, '${prefix}')"><#4487#>
</span>
</div>
<div><span id="${prefix}_auto_suggest"><#4031#></span></div>
...
${prefix === "5g2" && acs_band3 === "1" ? "checked" : ""}><#4063#>
</span>
</div>
`;
}
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 5);"><#4028#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 6);"><#960#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 7);"><#4170#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 11);"><#4181#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 9);"><#4093#></a>
</th>
<td>
...
style="display:${wepEncryptValue === "1" ? "" : "none"}"><#958#></span>
<span id="${prefix}_wep_encrypt_desc_128"
style="display:${wepEncryptValue === "2" ? "" : "none"}"><#959#></span>
</td>
</tr>
`;
}
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 10);"><#956#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#4088#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#4089#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#4090#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 18);"><#4091#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 8);"><#4166#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(2,1);"><#4020#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(2,2);"><#4024#></a>
</th>
<td>
...
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(2,3);"><#4022#></a>
</th>
<td>
...
<div class="formfontdesc"><#1030#></div>
<table
width="100%"
border="1"
align="center"
