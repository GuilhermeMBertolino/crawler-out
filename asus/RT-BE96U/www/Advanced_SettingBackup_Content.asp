...
showtext(document.getElementById("loading_block2"), "<#3261#>");
...
showtext(document.getElementById("loading_block2"), "<#3302#>");
document.getElementById('loading_block3').style.display = "none";
if(!isSupport("demoui"))
...
/*if(findasus_support){
document.getElementById('loading_block3').innerHTML = "<div><#535#></div>";
}else{*/
document.getElementById('loading_block3').innerHTML = "<div><#468#>.<#445#></div>";
}
},
success: function(){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#508#> - <#513#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3315#></div>
<table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th width="25%" align="right">
<a id="factorydefault_hint" class="hintstyle" href="javascript:void(0);" onclick="openHint(19,4)"><#3309#></a>
</th>
<td colspan = "4">
<div style="float:left;">
<input class="btn_subusage button_gen" onclick="restoreRule('restore');" type="button" value="<#1788#>" name="action1" />
</div>
...
<span><label for="restoreInit"><#3312#></label></span>
</div>
</div>
...
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,2)"><#3314#></a>
</th>
<td>
<div style="float:left;display:table-cell">
<input class="btn_subusage button_gen" onclick="saveSetting('Router');" type="button" value="<#3314#>" name="action2" />
</div>
...
<span><label for="remove_passwd"><#3319#></span></label>
</div>
</div>
...
<div style="float:left;width:80%;">
<span><label for="transfer_ddns"><#1824#></span></label>
</div>
</div>
</div>
</td>
...
<tr>
<th align="right">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(19,3)"><#3318#></a>
</th>
<td colspan = "4">
...
<tr>
<td style="border:0px">
<input type="button" class="btn_subusage button_gen" onclick="selectSetting();" value="<#1793#>"/>
</td>
