...
<title id="web_title"><#948#> - <#567#></title>
...
document.getElementById('content_title').innerHTML = "<#567#> - <#3486#>";
document.getElementById('desc_title').innerHTML = "<#3034#>";
document.getElementById('web_title').innerHTML = "<#948#> - <#3486#>";
document.getElementById('PC_enable').innerHTML = "<#3032#>";
}
if(isSupport("PC_SCHED_V3")){
$("#desc_title").html("<#3044#>");
var $desc_item = $("#desc_item").empty();
$("<li>").html("<#3045#>").appendTo($desc_item);
$("<li>").html("<#3036#>").appendTo($desc_item);
$("<li>").html("<#3046#>").appendTo($desc_item);
$("<li>").html("<#3047#>").appendTo($desc_item);
...
code +='<thead><tr><td colspan="4"><#1739#>&nbsp;(<#2776#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#3283#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#3283#></option>';
code += '<option value="0"><#1629#></option>';
code += '<option value="1"><#1881#></option>';
code += '<option value="2"><#1550#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1646#> (<#3128#>)</th>';
code +='<th width="20%"><#3041#></th>';
code +='<th width="20%"><#2775#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1629#></option>';
code += '<option value="1" selected><#1881#></option>';
code += '<option value="2"><#1550#></option>';
code += '</select>';
code += '</td>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" style="position:absolute;" onclick="pullLANIPList(this);" title="<#3286#>">';
...
code += '<option value="0" ' + ((client_time_obj.enable == "0") ? "selected" : "") + '><#1629#></option>';
code += '<option value="1" ' + ((client_time_obj.enable == "1") ? "selected" : "") + '><#1881#></option>';
code += '<option value="2" ' + ((client_time_obj.enable == "2")? "selected" : "") + '><#1550#></option>';
code += '</select>';
code += '</td>';
...
$("#mainTable").fadeIn();
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="applyRule(1);" value="<#286#>">';
showDropdownClientList('setClientIP', 'mac', 'all', 'ClientList_Block_PC', 'pull_arrow', 'all');
showclock();
}
function selectAll(){
...
var hint = "<#4457#>".replace("#MAXNUM", weekScheduleApi.data_max);
hint += "\n";
hint += "<#4458#>";
alert(hint);
return false;
...
code += "<span class=\"clicked\"><#3486#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#1317#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#3486#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1317#></span>";
}
...
<tr>
<td align="left">
<div id="content_title" class="formfonttitle" style="width:400px"><#567#></div>
</td>
<td>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1317#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#3486#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<div style="font-size:14px;margin-left:6px;margin-bottom:6px;"><#3049#></div>
...
<div id="svc_hint_div" style="display:none;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" class="hint-color" style="text-decoration:underline;cursor:pointer;"><#374#></span></div>
