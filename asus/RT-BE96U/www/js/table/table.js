...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2776#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2636#> " + _createRuleCount + " <#2637#>");
return;
}
...
$titleHtml.html("<#2626#>");/*untranslated*/
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#3015#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2629#>");
return false;
}
}
