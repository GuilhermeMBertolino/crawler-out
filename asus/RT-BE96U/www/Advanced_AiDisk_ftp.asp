...
document.getElementById("loginMethod").innerHTML = "<#1072#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#1071#>";
...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='' target='_blank' style='text-decoration:underline;color:#FC0;'><#2046#></a>";
...
confirm_str_off= "<#1730#>"; //"<#1732#>"+ By Viz 2011.09
confirm_str_on = "<#1734#>";
}
else if(protocol == "ftp"){
status = this.FTP_status;
confirm_str_off = "<#1731#>";
confirm_str_on = "<#1735#>";
...
account_group_menu_code += '<div class="noAccount" id="noAccount"><#2999#></div>\n'
else{
...
alert("<#2636#> " + maximum_account + " <#2637#>");
return false;
}
else
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 11)?"<#1017#>":"<#983#>";
}
...
if(ftp_ssl_support){
document.getElementById("TLS_disabled").innerHTML = (flag==1)? "":"<#3694#>";
...
<span class="formfonttitle"><#497#> - <#499#></span>
<span id="returnBtn" class="returnBtn">
<img onclick="go_setting('/APP_Installation.asp')" align="right" title="<#477#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</span>
</div>
<div id="splitLine" class="splitLine"></div>
<div class="formfontdesc" style="margin-top: 10px;"><#2254#></div>
</td>
</tr>
<tr>
<td>
...
<th><#1089#></th>
<td>
<input type="radio" name="ftp_tls" class="input" value="1" <% nvram_match_x("", "ftp_tls", "1", "checked"); %> onChange="secure_check(1);"><#277#>
<input type="radio" name="ftp_tls" class="input" value="0" <% nvram_match_x("", "ftp_tls", "0", "checked"); %> onChange="secure_check(0);"><#276#>
<span id="TLS_disabled" style="color:#FC0;margin-left:10px;"></span>
</td>
</tr>
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,1);"><#3333#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,9);"><#3327#></a>
</th>
<td>
<select name="ftp_lang" class="input_option">
<option value="CN" <% nvram_match("ftp_lang", "CN", "selected"); %>>GBK</option><!-- <#3330#> -->
<option value="TW" <% nvram_match("ftp_lang", "TW", "selected"); %>>Big5</option><!-- <#3329#> -->
<option value="EN" <% nvram_match("ftp_lang", "EN", "selected"); %>>UTF-8</option><!--<#3328#>-->
<option value="RU" <% nvram_match("ftp_lang", "RU", "selected"); %>><#3331#></option>
<option value="CZ" <% nvram_match("ftp_lang", "CZ", "selected"); %>><#3332#></option>
</select>
</td>
</tr>
</table>
...
<td><div id="createAccountBtn" title="<#1017#>"></div></td>
<td><div id="deleteAccountBtn" title="<#1829#>"></div></td>
<td><div id="modifyAccountBtn" title="<#2928#>"></div></td>
</tr>
<tr id="trPMGroup" style="display:none;">
<td>
<select name="" id="user_type" class="input_option" onchange="switchUserType(this.value);">
<option value="group"><#3060#></option>
<option value="account"><#3062#></option>
</select>
</td>
</tr>
</table>
...
<table align="right">
<tr>
<td><div id="createFolderBtn" title="<#1019#>"></div></td>
<td><div id="deleteFolderBtn" title="<#1832#>"></div></td>
<td><div id="modifyFolderBtn" title="<#2932#>"></div></td>
</tr>
</table>
</td>
</tr>
...
<div id="machine_name" class="machineName"><#949#></div>
</td>
<td>
...
<input name="changePermissionBtn" id="changePermissionBtn" type="button" value="<#1784#>" class="button_gen_dis" disabled="disabled">
</div>
</td>
</tr>
</table>
