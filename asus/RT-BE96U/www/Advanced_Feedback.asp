...
infolist = new Array();
infolist.push(["<#828#> ...","No_selected"]);
infolist.push(["<#2112#>","phone"]);
infolist.push(["QQ","qq"]);
infolist.push(["<#3980#>","wechat"]);
...
ptypelist = new Array();
ptypelist.push(["<#828#> ...", "No_selected"]);
ptypelist.push(["<#2117#>", "Setting_Problem"]);
ptypelist.push(["<#2061#>", "Connection_or_Speed_Problem"]);
ptypelist.push(["<#2053#>", "Compatibility_Problem"]);
ptypelist.push(["<#2121#>", "Suggestion"]);
ptypelist.push(["<#2132#>", "Technical_Support"]);
ptypelist.push(["<#1003#>", "Other_Problem"]);
...
desclist.push(["<#501#>/<#3689#>","USB dongle"]);
url_group.push(["Modem"]);
desclist.push(["<#1905#>","DM"]);
...
desclist.push(["<#851#>","System Log"]);
url_group.push(["System"]);
desclist.push(["<#2971#>","Network Tools"]); //25
url_group.push(["Status_"]);
desclist.push(["<#3195#>","Rescue"]);
url_group.push(["Rescue"]);//false value
desclist.push(["<#2057#>","Other Devices"]);
url_group.push(["Other_Device"]);//false value
desclist.push(["<#3979#>","Fail to access"]);
url_group.push(["GUI"]);//false value
desclist.push(["<#512#>","FW update"]);
url_group.push(["FirmwareUpgrade"]);
if(isSupport("Instant_Guard")){
desclist.push(["<#4481#>","Instant Guard"]); //30
url_group.push(["Instant_Guard"]);
}
}
else if(ptype == "Connection_or_Speed_Problem"){
desclist.push(["<#2062#>","Wireless speed"]);
desclist.push(["<#2063#>","Wired speed"]);
desclist.push(["<#2065#>","Unstable connection"]);
desclist.push(["<#2064#>","Router reboot"]);
desclist.push(["<#2066#>","Wireless disconnected"]);
}
else if(ptype == "Compatibility_Problem"){
desclist.push(["<#2056#>","modem"]);
desclist.push(["<#2058#>","other router"]);
desclist.push(["<#2054#>","OS or Application"]);
desclist.push(["<#2059#>","printer"]);
desclist.push(["<#2060#>","USB modem"]);
desclist.push(["<#2055#>","external hardware disk"]);
desclist.push(["<#2057#>","network devices"]);
}
else if(ptype == "Suggestion"){
desclist.splice(0,1);
desclist.push(["<#2124#>","Translation"]);
desclist.push(["<#2125#>","UI/UX"]);
desclist.push(["<#2122#>","Current Feature"]);
desclist.push(["<#2123#>","New Feature Request"]);
}
else if(ptype == "Technical_Support"){
desclist.splice(0,1);
desclist.push(["<#2130#>","tech_ASUS"]);
desclist.push(["<#2128#>","tech_Amazon"]);
desclist.push(["<#2131#>","tech_iOS"]);
desclist.push(["<#2129#>","tech_Android"]);
}
else{ //Other_Problem
desclist.splice(0,1);
desclist.push(["<#1003#>","others"]);
}
...
timelist.push(["<#828#> ...","No_selected"]);
timelist.push(["<#2140#>","Just Now"]);
...
timelist.push(["<#2144#>","Today"]);
timelist.push(["<#2145#>","Recently"]);
timelist.push(["<#2146#>","I don’t recall"]);
...
bandlist.push(["<#1505#>","All"]);
bandlist.push(["<#2101#>","I am not sure"]);
bandlist.push(["<#2102#>","Issue with the main router"]);
bandlist.push(["<#2103#>","Issue with node(s)"]);
...
unstablelist.push(["<#828#> ...","No_selected"]);
unstablelist.push(["<#2099#>","All WiFi"]);
...
unstablelist.push(["<#2100#>","Both WiFi and WAN"]);
unstablelist.push(["<#2101#>","I am not sure"]);
unstablelist.push(["<#2102#>","Issue with the main router"]);
unstablelist.push(["<#2103#>","Issue with node(s)"]);
...
if(value) {
if(allUsbStatus.search("storage") == "-1"){
alert("USB disk required in order to store the debug log, please plug-in a USB disk to <#949#> and Enable DSL Line Diagnostic again.");/*untranslated*/
...
var dblog_service_mapping = ["", "WiFi", "<#1905#>", "<#884#>", "AiMesh"];
...
selectOption = {"1 <#2429#>" : hour_to_sec(1)};
}
if(usb_support && $("input[name=dblog_tousb_cb]").prop("checked")) {
baseOption = { "12 <#2429#>" : hour_to_sec(12), "1 <#1808#>" : hour_to_sec(24), "2 <#1808#>" : hour_to_sec(48), "3 <#1808#>" : hour_to_sec(72) };
}
else {
baseOption = { "6 <#2429#>" : hour_to_sec(6), "12 <#2429#>" : hour_to_sec(12), "24 <#2429#>" : hour_to_sec(24) };
}
...
$(".dblog_service_item.wifi").after(gen_appendix_option(16, "<#2137#>", "dhd"));
}
$("input[name=dblog_service_list]").prop("checked", true);
...
if($("input[name=dblog_tousb_cb]").prop("checked")) {
if(media_support)
$(".dblog_service_item.all").after(gen_service_option(4, "<#884#>", "noUSB"));
if(!nodm_support)
$(".dblog_service_item.all").after(gen_service_option(2, "<#1905#>", "noUSB"));
}
}
...
var auth_status_hint = "<#1532#>";
document.form.fb_email.value = "";
switch(_status) {
case "0" :
auth_status_hint = "<#646#>";
break;
case "1" :
auth_status_hint = "<#1531#>";
...
<tr>
<td>
<div class="drword" id="drword" style="height:110px;"><#469#> <#786#>...
<br/>
<br/>
</div>
</td>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#508#> - <#2814#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="fb_desc0" class="formfontdesc" style="display:none;"><#2082#></div>
<div id="fb_desc1" class="formfontdesc" style="display:none;"><#2083#></div>
<div id="fb_desc_disconnect" class="formfontdesc hint-color" style="display:none;"><#2084#> <a class="hint-color" href="mailto:router_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top">router_feedback@asus.com</a></div>
...
<th><#2088#> *</th>
<td>
<input type="checkbox" class="input" name="attach_syslog" id="attach_syslog_id"><label for="attach_syslog_id"><#851#></label>&nbsp;&nbsp;&nbsp;
<input type="checkbox" class="input" name="attach_cfgfile" id="attach_cfgfile_id"><label for="attach_cfgfile_id"><#2116#></label>&nbsp;&nbsp;&nbsp;
<span id="attach_iptables_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_iptables" id="attach_iptables_id"><label for="attach_iptables_id"><#2096#></label></span>
<span id="attach_modem_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_modemlog" id="attach_modemlog_id"><label for="attach_modemlog_id"><#2047#></label></span>
<input type="checkbox" class="input" name="attach_wlanlog" id="attach_wlanlog_id"><label for="attach_wlanlog_id"><#2136#></label>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(25,11);"><#2078#> *</a></th>
<td>
...
<br>
<span id="storage_ready" class="hint-color" style="display:none;">* <#3687#></span>
<span id="be_lack_storage" class="hint-color" style="display:none;">* <#2998#></span>
</td>
</tr>
...
<option value="3600">1 <#2429#></option>
<option value="18000">5 <#2429#></option>
<option value="43200">12 <#2429#></option>
<option value="86400">24 <#2429#></option>
<option value="172800">48 <#2429#></option>
</select>
</td>
</tr>
<tr class="dblog_support_class">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34, 1);"><#2079#></a></th>
<td>
...
<label class="storeUSBHint"><input type="checkbox" name="dblog_tousb_cb" value="1" onclick="diag_change_storeUSB();" checked><#2080#></label>
<span class="noUSBHint">* <#2998#></span>
</div>
<div class="dblog_enabled_status">
<span>* <#2071#></span>
<br>
<span class="dblog_stop_text" onclick="dblog_stop();"><#2070#></span>
</div>
</td>
</tr>
...
<div class="dblog_disabled_status">
<label class="dblog_service_item all"><input type="checkbox" name="dblog_service_list_all" onclick="diag_change_service_list_all();"><#1505#></label>
</div>
<div class="dblog_enabled_status">
...
<option value="No_selected"><#828#> ...</option>
<option value="Stable_connection"><#2118#></option>
<option value="Occasional_interruptions"><#2110#></option>
<option value="Frequent_interruptions"><#2095#></option>
<option value="Unavailable"><#2133#></option>
</select>
</td>
</tr>
<tr>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2147#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2139#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2098#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34,2);"><#1530#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34,3);"><#2127#></a></th>
<td>
...
<div id="eula_content" style="margin-left: 20px;"><#2134#></div>
</div>
<input class="btn_subusage button_gen" name="btn_send" onclick="applyRule()" type="button" value="<#1636#>"/>
</div>
</td>
</tr>
<tr>
...
<strong class="warning_title"><#2272#></strong>
<ul>
<li><#2109#><br><a id="call_link" style="font-weight: bolder;text-decoration:underline;cursor:pointer;" href="" target="_blank">https://www.asus.com/support/CallUs/</a></li>
</ul>
</div>
</td>
</tr>
