...
tabs.push([`speed-tab-WIRELESS${value}`, `<#3512#> (${tabLabel})`]);
});
}
tabs.sort((a, b) => {
const valueA = a[1];
...
var tabsort = [
"speed-tab-INTERNET,<#2476#>",
"speed-tab-INTERNET,<#1982#>",
"speed-tab-INTERNET1,<#1989#>",
...
"speed-tab-WIRELESS0,<#3512#> (2.4GHz)",
"speed-tab-WIRELESS1,<#3512#> (5GHz)",
"speed-tab-WIRELESS1,<#3512#> (5GHz-1)",
"speed-tab-WIRELESS2,<#3512#> (5GHz-2)",
"speed-tab-WIRELESS2,<#3512#> (6GHz)",
"speed-tab-WIRELESS3,<#3512#> (60GHz)",
