...
var tmp_wans_mt_ioport = '<% nvram_get("wans_mt_ioport"); %>'.split(" ");
var tmp_index = -1;
for( var i = 0; i < tmp_wans_mt_ioport.length; i++) {
if(tmp_wans_mt_ioport[i].indexOf("U") != -1){
tmp_index = i;
break;
}
}
if(tmp_index >= 0){
usb_index = (tmp_index == 0)? 0: (tmp_index + 50);
}
}
else
usb_index = wans_dualwan_array.getIndexByValue("usb");
...
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top" style="margin:7px 0 0 5px;"><#949#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:20px 0 0 10px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#861#></div></div></a>\n';
}
else{
banner_code +='<div style="margin-left:10px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#949#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:15px 0 0 15px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#861#></div></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin:15px 0 0 15px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#269#></div></div></a>\n';
}
}
else if(tuf_support){
if(CoBrand == "8")
...
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#949#></span></div>';
banner_code +='<div style="position: absolute;margin-left: 720px;"><a href="javascript:logout();"><div style="margin:20px 0 0 0;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 0;"><#861#></div></div></a></div>\n';
}
...
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:125px; *width:136px;" class="titlebtn" align="center"><span><#861#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#269#></span></div></a>\n';
}
else{
banner_code +='<div class="banner1" align="center"><img src="images/New_ui/asustitle.png" width="218" height="54" align="left">\n';
banner_code +='<div style="margin-top:13px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#949#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:25px; *width:136px;" class="titlebtn" align="center"><span><#861#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#269#></span></div></a>\n';
}
if(rog_support){
...
banner_code += '<div style="font-size: 14px;margin-left:12px;"><#4494#></div>';
...
banner_code += '<div style="padding: 2px 8px;margin: 0 0 2px 230px;width:735px;display:flex;justify-content:space-between;" class="radio_hint top_banner_hint">';
banner_code += '<div style="background-image: url(\'images/New_ui/exclamationmark.svg\');width:16px;height:16px;background-size: 100%;background-repeat:no-repeat;cursor: pointer"></div>';
banner_code += '<div style="font-size: 14px;margin-left:12px;"><#3050#></div>';
...
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#510#>:</span><span class="title_link" style="text-decoration: none;" id="op_link"><a href="/Advanced_OperationMode_Content.asp" style="color:white"><span id="sw_mode_span" style="text-decoration: underline;"></span></a></span>\n';
}
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#371#></span><a href="/Advanced_FirmwareUpgrade_Content.asp" style="color:white;"><span id="firmver" class="title_link"></span></a>\n';
...
banner_code +='<div style="padding:5px 0 5px 15px;font-size:14px;color:#BDBDBD"><#1516#></div>';
banner_code +='</div>';
banner_code +='</div>';
...
banner_code += "<#2853#>";
banner_code +='</div>';
banner_code +="<span><input style=\"margin-left:30px;\" type=\"checkbox\" name=\"stop_show_chk\" id=\"stop_show_chk\"><#2907#></input></span>";
...
footer_code +='<div align="center" class="copyright"><#369#></div><br>';
...
footer_code += '<td width="20" align="right"><div id="bottom_help_icon" style="margin-right:3px;"></div></td><td width="110" id="bottom_help_title" align="left"><#2420#> & <#3432#></td>';
...
footer_code += "&nbsp|&nbsp<a id=\"registration_link\" target=\"_blank\" rel=\"noreferrer\" href=\""+ href_reg_url +"\" target=\"_self\" style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\"><#3166#></a>";
if(dsl_support && frs_feedback_support){
footer_code += '&nbsp|&nbsp<a id="fb_link" href="/Advanced_Feedback.asp" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2814#></a>';
}
...
footer_code += '&nbsp|&nbsp<a id="fb_link" href="'+location_href+'" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2814#></a>';
}
footer_code += '</td>';
...
document.getElementById("elliptic_ssid_" + bandName[i].toLocaleLowerCase()).title = "<#3360#>"
...
document.getElementById("sw_mode_span").innerHTML = "<#953#>";
else if(sw_mode == "2"){
if(wlc_express == 1)
document.getElementById("sw_mode_span").innerHTML = "<#560#>";
else if(wlc_express == 2)
document.getElementById("sw_mode_span").innerHTML = "<#562#>";
else
document.getElementById("sw_mode_span").innerHTML = "<#558#>";
}
else if(sw_mode == "3")
document.getElementById("sw_mode_span").innerHTML = "<#536#>";
else if(sw_mode == "4")
document.getElementById("sw_mode_span").innerHTML = "<#545#>";
else
...
code +='<td><span id="proceeding_main_txt"><#469#></span><span id="proceeding_txt" style="color:#FFFFCC;"></span></td>\n';
code +='</tr>\n';
code +='</table>\n';
...
document.getElementById('selected_lang').innerHTML = "<#975#>";
}
...
if(document.getElementById("NM_connect_status")){
document.getElementById("NM_connect_status").innerHTML = "<#279#>";
...
if(document.getElementById("NM_connect_status")){
document.getElementById("NM_connect_status").innerHTML = "<#310#>";
...
code += '<div style="margin: 24px 0;"><#4495#></div>';
var _str = '<#4496#>';
var _str1 = '<#4497#>';
var _temp = _str.replace('%1$@', 'WiFi radio').replace('%2$@', _str1);
code += '<div style="margin: 24px 0;">'+ _temp +'</div>';
code += '<div style="margin: 32px 0;"><input id="radio_hint_checkbox" type="checkbox"><#4498#></div>';
code += '<div style="display:flex;justify-content:flex-end;margin:28px 0;">';
code += '<div id="cancelBtn" class="button-container button-container-sm" style="margin: 0 12px;" onclick="radio_disagree();"><div class="button-icon icon-cancel"></div><div class="button-text"><#289#></div></div>';
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;" onclick="radio_agree();"><div class="button-icon button-icon-check"></div><div class="button-text"><#4497#></div></div>';
code += '</div></div>';
obj.html(code);
}
...
code += '<div style="font-size: 16px;font-weight: bold;margin: 12px 0;"><#3050#></div>';
code += '<div style="margin: 18px 0;"><#3051#></div>';
code += '<div style="margin: 18px 0;"><#3052#></div>';
if(_flag == "1")
code += '<div style="margin: 18px 0;"><input id="radio_hint_checkbox" type="checkbox"><#4498#></div>';
code += '<div style="display:flex;justify-content:flex-end;margin-top:28px;">';
code += '<div id="cancelBtn" class="button-container button-container-sm" style="margin: 0 12px;"><div class="button-icon icon-cancel"></div><div class="button-text"><#289#></div></div>';
code += '<div id="applyBtn" class="button-container button-container-sm" style="margin: 0 12px;"><div class="button-icon button-icon-check"></div><div class="button-text"><#1629#></div></div>';
code += '</div></div>';
obj.html(code);
...
wlHintHtml += '<div class="prod_madelName"><div class="title_name"><div class="div_td img_gap"><div class="login_img"></div></div><div class="div_td"><#949#></div></div></div>';
wlHintHtml += '<div id="login_filed">';
wlHintHtml += "<div class='p1 title_gap'><#311#></div>";
