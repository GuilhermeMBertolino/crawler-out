...
<div>&nbsp;</div>
<div id="formfonttitle" class="formfonttitle"><#508#> - <#4405#></div>
...
<input class="btn_subusage button_gen" id="asus_withdraw_btn" onclick="withdraw_eula('asus');" type="button" value="<#240#>"/>
...
<div style="text-align: center;">
<div style="margin: 0px auto 10px;display: flex;justify-content: center;">
<input class="btn_subusage button_gen" id="asus_pp_withdraw_btn" onclick="show_eula_confirm('asus_pp');" type="button" value="<#240#>"/>
