...
var invite_content = "";
var sync_rule_desc = "";
document.getElementById('invite_desc').innerHTML = "<#3464#>: " + htmlEnDeCode.htmlEncode(document.form.router_sync_desc.value);
...
document.getElementById('invite_rule').innerHTML = "<#3466#>: "+sync_rule_desc;
...
document.getElementById('invite_captcha').innerHTML = "<#3252#>: None";
else
document.getElementById('invite_captcha').innerHTML = "<#3252#>: "+captcha;
}
...
document.getElementById('invite_desc').innerHTML = "<#3464#>: "+router_synclist_desc[j];
...
document.getElementById('invite_captcha').innerHTML = "<#3252#>: "+ router_synclist_captcha[j];
...
mailtoCode += "<#3467#>%0D%0A".replace(/ /g, "%20");
mailtoCode += document.getElementById('invite_share').innerHTML.replace(/ /g, "%20") + "%0D%0A";
mailtoCode += '"><div onmouseover="" style="margin-right:15px;background-image:url(images/cloudsync/mail_send.png);background-repeat:no-repeat;width:64px;height:64px;"></div><div style="font-size:12px;margin-top:3px;margin-right:17px;"><#3295#></div></a>';
return mailtoCode;
}
...
var hint_string = "";
hint_string += "<#3246#><br><br>";
hint_string += "<#3248#><br><br>";
hint_string += "<#3247#>";
...
<input class="button_gen" type="button" onclick="confirm_folderTree();" value="<#1783#>">
</div>
</div>
<div id="invitation_block" class="panel_folder" >
<table><tr><td>
<div class="machineName" style="width:200px;font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:20px;margin-left:30px;"><#2479#></div>
</td></tr></table>
...
<tr>
<td>
<div style="margin-top:10px;width:440px;"><#3467#></div>
</td>
</tr>
<tr>
<td>
...
<input class="button_gen" type="button" onclick="close_invitation_block();" value="<#1766#>" style="margin-top:15px;margin-left:200px">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle">AiCloud 2.0 - <#3300#></div>
...
3. <#3458#><br>
4. <#3459#><br>
<span class="formfontdesc" id="wan_ip_hide2" style="color:#FFCC00;display:none;margin-left:0px;">5. <#3460#></span>
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<div style="margin-left:15px;margin-top:3px;"><#3462#></div>
</td>
</tr>
</table>
</div>
...
<tr style="height:40px;">
<th>
<div style="margin-top:5px;"><#3469#></div>
</th>
<td>
<input type="text" id="PATH" class="input_25_table" style="height: 25px;" name="cloud_dir" value="" autocorrect="off" autocapitalize="off">
<input name="button" type="button" class="button_gen" onclick="get_disk_tree();" value="<#1721#>"/>
<div id="noUSB" style="color:#FC0;display:none;margin-left:3px;font-size:12px;line-height:140%;"><#2998#></div>
</td>
</tr>
<tr style="height:40px;">
<th>
<div style="margin-top:5px;"><#1724#></div>
</th>
<td>
<select name="router_sync_rule" class="input_option" style="height:27px;">
<option value="0"><#3249#></option>
<option value="1"><#3251#></option>
<option value="2"><#3250#></option>
</select>
<span>
...
<option value="1"><#2793#></option>
<option value="2"><#3461#></option>
</select>
...
<input type="button" id="applyButton" class="button_gen" value="<#1777#>" onclick="domain_name_select();">
...
<a href="cloud_main.asp"><span style="font-family:Lucida Console;text-decoration:underline;color:#FC0"><#3243#></span></a><br><#3244#>
</div>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="6" id="cloud_synclist"><#3468#></td>
</tr>
</thead>
<tr>
<th width="10%"><#3167#></th>
<th width="25%"><#2526#></a></th>
...
<input name="applybutton" id="applybutton" type="button" class="button_gen" onclick="location.href='cloud_syslog.asp'" value="<#1764#>" style="word-wrap:break-word;word-break:normal;">
</div>
</div>
</td>
</tr>
