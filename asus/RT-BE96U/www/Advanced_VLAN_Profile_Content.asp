...
var $table_thead_title = $("<td>").html("<#2407#>")
.attr('colSpan', '6')
.appendTo($table_thead_tr);
var $table_th_tr = $("<tr>").appendTo($table_bg);
var $table_th_name = $("<th>").html("<#664#>").css({'text-align':'center','width':'50%'}).appendTo($table_th_tr);
var $table_th_vid = $("<th>").html("<#3960#>").css({'text-align':'center','width':'20%'}).appendTo($table_th_tr);
var $table_th_iso = $("<th>").html("<#3718#>").css({'text-align':'center','width':'15%'}).appendTo($table_th_tr);
var $table_th_edit = $("<th>").html("<#2775#>").css({'text-align':'center','width':'15%'}).appendTo($table_th_tr); // / <#294#>
...
code += "<th class='IE8HACK' width='40%'><#664#></th>";
...
code += "<th><#3718#></th>";
code += "<td style='padding:10px;text-align:left;'>";
code += "<input type='radio' name='update_iso' class='input' value='1'><#277#>";
code += "<input type='radio' name='update_iso' class='input' value='0'><#276#>";
code += "</td>";
code += "</tr>";
code += "</table>";
code += "</td></tr></tbody></table>";
code += "<div style='margin-top:10px;margin-bottom:20px;width:100%;text-align:center;'>";
code += "<input class='button_gen' type='button' onclick='close_vlan_profile_View()' value='<#289#>'>";
code += "<input class='button_gen' type='button' onclick='Update_vlan_rl(\""+apgx_id_string+"\","+choosed_rl_index+","+choosed_rl_vid+","+choosed_rl_iso+")' style='margin-left:15px;' value='<#1783#>'>";
code += "</div>";
...
<div class="formfontdesc"><#3719#></div>
