...
var jscolor_attr = "{closable:true, closeText:\"<#1766#>\", onFineChange:\"edit_component_color_callback(this)\"}";
...
var captive_portal_list_row = captive_portal_adv_profile_list.split("<");
var auth_array = ["<#1629#>", "Account/Password", "Account/Password", "Account/Password"];/*untranslated*/
var code = "";
...
code += '<td id="td_wl_name" width="30%"><#954#></td>';
...
window.open('Captive_Portal_Advanced_Preview.asp', '<#4356#>', 'toolbar=no,scrollbars=no,resizable=yes,location=no,menubar=no,width=476,height=714');
...
code += "<div id='toolbar_template' title='<#4292#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_template' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4292#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc step1'>";
code += "<div class='help_desc_title'>1. <#4351#></div>";
code += "<div class='help_desc_text'><#4352#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_2' class='help_step' style='display:none;'>";
code += "<div class='help_frame step2'>";
code += "<div class='help_desc_title'>2. <#4353#></div>";
code += "<div class='help_desc_text'><#4354#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_3' class='help_step' style='display:none;'>";
code += "<div class='help_frame step3'>";
code += "<div id='toolbar_unit_image' title='<#1761#> <#4294#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_image' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_text' title='<#1761#> Text' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_text' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_account' title='<#1761#> <#3114#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_account' style='cursor:default;'></div>";
code += "<div id='toolbar_unit_eula' title='<#1761#> Eula' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_eula' style='cursor:default;'></div>";
code += "</div>";
code += "<div class='help_desc step3'>";
code += "<div class='help_desc_title'>3. <#4340#></div>";
code += "<div class='help_desc_text'><#4341#></div>";
code += "<div class='help_desc_text'><#4342#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_4' class='help_step' style='display:none;'>";
code += "<div class='help_frame step4'>";
code += "<div id='toolbar_background' title='<#4275#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_background' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4275#></div>";
code += "</div>";
code += "<div id='toolbar_editor' title='<#4293#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_editor' style='cursor:default;'>";
code += "<div class='splash_page_toolbar_unit_title'><#4293#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc step4'>";
code += "<div class='help_desc_title'>4. <#4343#></div>";
code += "<div class='help_desc_text'><#4344#></div>";
code += "<div class='help_desc_text'><#4345#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_5' class='help_step' style='display:none;'>";
code += "<div class='help_frame step5'>";
code += "<div title='<#4276#>' class='splash_page_toolbar_unit_preview' style='cursor:default;'></div>";
code += "</div>";
code += "<div class='help_desc step5'>";
code += "<div class='help_desc_title'>5. <#4346#></div>";
code += "<div class='help_desc_text'><#4347#></div>";
code += "<div class='help_desc_text'><#4348#></div>";
code += "</div>";
code += "</div>";
code += "<div id='help_step_6' class='help_step' style='display:none;'>";
code += "<div class='help_frame step6'>";
code += "<input class='button_gen' type='button' style='cursor:default;' value='<#1787#>' disabled/>";
code += "</div>";
code += "<div class='help_desc step6'>";
code += "<div class='help_desc_title'>6. <#4349#></div>";
code += "<div class='help_desc_text'><#4350#></div>";
code += "</div>";
code += "</div>";
code += "<div class='help_desc_action_bg'>";
code += "<div class='help_desc_action_idx'>1 / 6</div>";
code += "<div id='help_desc_action_close' class='help_desc_action' style='display:none;' onclick='help_close();'><#1766#></div>";
code += "<div id='help_desc_action_next' class='help_desc_action' onclick='switch_help(\"next\", event);'><#295#></div>";
code += "<div id='help_desc_action_pre' class='help_desc_action' style='display:none;' onclick='switch_help(\"pre\", event);'><#296#></div>";
code += "</div>";
...
code += "<div id='captive_portal_adv_step_1' onclick='switch_tab(1)'>1. <#4323#></div>";
code += "<div id='captive_portal_adv_step_2' onclick='switch_tab(2)'>2. <#4356#></div>";
code += "<div id='captive_portal_adv_step_3' onclick='switch_tab(3)'>3. <#584#></div>";
code += "</div>";
return code;
}
...
code += "<input id='captive_portal_adv_pre' class='button_gen' style='display:none;' onclick='preRule()' type='button' value='<#296#>'/>";
code += "<input id='captive_portal_adv_next' class='button_gen' style='display:none;' onclick='nextRule()' type='button' value='<#295#>'/>";
code += "<input id='captive_portal_adv_finsih' class='button_gen' style='display:none;' type='button' value='<#1774#>'/>";
code += "</div>";
return code;
}
...
var code = "";
code += "<tr>";
code += "<th>" + wl_nband_title[_unit] + " <#664#></th>";
code += "<td>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='2'><#4326#></td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(31, 2);'><#4333#></a></th>";
code += "<td>";
...
code += "<option value='hour'><#2429#></option>";
code += "<option value='minute'><#2826#></option>";
code += "</select>";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_away_timeout' id='cpa_away_timeout_unlimited' checked><label for='cpa_away_timeout_unlimited'><#2769#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(31, 3);'><#4355#></a></th>";
code += "<td>";
...
code += "<option value='day'><#1808#></option>";
code += "<option value='hour'><#2429#></option>";
code += "<option value='minute'><#2826#></option>";
code += "</select>";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_session_timeout' id='cpa_session_timeout_unlimited' checked><label for='cpa_session_timeout_unlimited'><#2769#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4290#></th>";
...
code += "&nbsp;&nbsp;Mb/s";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_bw_dl' id='cpa_bw_dl_unlimited' checked><label for='cpa_bw_dl_unlimited'><#2769#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4291#></th>";
...
code += "&nbsp;&nbsp;Mb/s";
code += "&nbsp;&nbsp;<input type='radio' name='cpa_bw_ul' id='cpa_bw_ul_unlimited' checked><label for='cpa_bw_ul_unlimited'><#2769#></label>";
code += "</td>";
code += "</tr>";
code += "<tr>";
code += "<th><#4335#> (<#4339#>)</th>";
code += "<td>";
...
code += "<span style='margin-left:5px;'>ex. http <#4297#> https ://www.asus.com</span>";
code += "</td>";
code += "</tr>";
code += "</table>";
return code;
...
var code = "<div class='edit_component_item_hint'><#4317#></div>";
...
add_hint_msg($('input[name="edit_eula_terms_service_title"]'), "<#416#>");
$('input[name="edit_eula_terms_service_title"]').focus();
return;
}
if(eula_terms_service == "") {
add_hint_msg($('textarea#edit_eula_terms_service'), "<#416#>");
$('textarea#edit_eula_terms_service').focus();
return;
}
if(eula_hyperlink == "") {
add_hint_msg($('input[name="edit_eula_hyperlink_label"]'), "<#416#>");
...
var code = "";
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'><#4303#></div>";
...
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<div class='edit_component_item_title'><#4308#> <span>(* <#4309#>)</span></div>";
code += "<div class='edit_component_item_content'>";
code += "<div class='edit_component_item_title' style='margin-top:5px;'><#4308#> title</div>";/*untranslated*/
...
code += "<div class='edit_component_item_title' style='margin-top:5px;'><#4358#></div>";
...
code += "</div>";
code += "<div style='width:49%;float:left;'>";
code += "<div class='edit_component_item_title'><#4311#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"eula\");' type='button' value='<#1765#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_eula"]) {
...
var code = "";
if(account_username == "") {
add_hint_msg($('input[name="edit_account_username_label"]'), "<#416#>");
$('input[name="edit_account_username_label"]').focus();
return;
}
else if(account_password == "") {
add_hint_msg($('input[name="edit_account_password_label"]'), "<#416#>");
...
code += "<div class='edit_component_item_title'><#4304#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4305#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<div class='edit_component_item_title'><#4306#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4307#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"account\");' type='button' value='<#1765#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_account"]) {
...
if(botton_label == "") {
add_hint_msg($('input[name="edit_button_label"]'), "<#416#>");
...
var code = "";
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'><#4312#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4313#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4314#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='captive_portal_adv_line'></div>";
code += "<div class='edit_component_item_title'><#4315#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "</div>";
code += "<div class='edit_component_item_title'><#4316#></div>";
code += "<div class='edit_component_item_content'>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"button\");' type='button' value='<#1765#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_account"]) {
...
add_hint_msg($('input[name="edit_image_walled_garden"]'), "" + image_walled_garden + " <#430#>");
...
add_hint_msg($('input[name="edit_image_walled_garden"]'), "" + image_walled_garden + "<#2632#>");
$("input[name=edit_image_walled_garden]").focus();
return;
}
}
...
code += "<input type='radio' name='edit_background_type' id='edit_background_image' value='image' onclick='showHideBackgroundType();' checked><label for='edit_background_image'><#4318#></label>";
code += "<input type='radio' name='edit_background_type' id='edit_background_color' value='color' onclick='showHideBackgroundType();'><label for='edit_background_color'><#4319#></label>";
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
...
code += "<div class='edit_drag_drop_text'><#4296#><br><#4297#><br><#4298#></div>";
code += "</div>";
code += "<div class='edit_drag_drop_hint'><#4334#>: < 10MB</div>";
code += "<div class='edit_drag_drop_hint'><#4338#>: jpg, png</div>";
code += "<div class='edit_drag_drop_hint'><#4337#>: 1152 x 864 px <#4297#> <#4320#></div>";
}
else {
...
code += "<div class='edit_component_item_title'><#4321#></div>";
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"background\");' type='button' value='<#1765#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
...
$("#splash_page_container_edit").html(code);
code += "<div class='edit_component_item_title'>";
code += "<input type='radio' name='edit_image_type' id='edit_image_image' value='image' onclick='showHideImageType();' checked><label for='edit_image_image'><#4294#></label>";
code += "<input type='radio' name='edit_image_type' id='edit_image_color' value='color' onclick='showHideImageType();'><label for='edit_image_color'><#4295#></label>";
code += "</div>";
code += "<div class='captive_portal_adv_line'></div>";
...
code += "<div class='edit_drag_drop_text edit_drag_drop_text_for_image'><#4296#><br><#4297#><br><#4298#></div>";
code += "</div>";
}
else {
...
code += "</div>";
code += "<div class='edit_component_item_title'><a style='cursor:help;color:#D0D6D8' href='javascript:void(0);' onClick='openHint(31, 5);'><#4299#></a></div>";
code += "<div class='edit_component_item_content'>";
...
add_hint_msg($('input[name="edit_text_walled_garden"]'), "" + text_walled_garden + " <#430#>");
...
add_hint_msg($('input[name="edit_text_walled_garden"]'), "" + text_walled_garden + "<#2632#>");
$("input[name=edit_text_walled_garden]").focus();
return;
}
}
...
code += "<div class='edit_action_bg'>";
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='edit_clear_content(\"text_" + _idx + "\");' type='button' value='<#1765#>'/>";
code += "</div>";
$("#splash_page_container_edit").html(code);
if(component_array["component_text"]) {
...
code += "<div class='component_title'><span><#4294#></span></div>";
...
code += "<div class='edit_component_item_title'><#4293#></div>";
...
code += "<div id='toolbar_unit_image' title='<#1761#> Image' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_image' onclick='edit_component_add(\"image\", event);'></div>";
code += "<div id='toolbar_unit_text' title='<#1761#> Text' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_text' onclick='edit_component_add(\"text\" , event);'></div>";
code += "<div id='toolbar_unit_account' title='<#1761#> <#3114#>' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_account' onclick='edit_component_add(\"account\" , event);'></div>";
code += "<div id='toolbar_unit_eula' title='<#1761#> Eula' class='splash_page_toolbar_unit_bg_left splash_page_toolbar_unit_eula' onclick='edit_component_add(\"eula\" , event);'></div>";
code += "<div title='<#4276#>' class='splash_page_toolbar_unit_preview' onclick='preview(event);'></div>";
code += "</div>";
...
code += "<input id='captive_portal_adv_reset' class='button_gen' onclick='reset_splash_page_layout()' type='button' value='<#1787#>'/>";
code += "<div id='splash_page_toolbar_unit_help' title='<#1778#>' class='splash_page_toolbar_unit_help' onclick='toolbar_unit_help(event);'></div>";
code +="</div>";
code += "</div>";
code += "<div class='splash_page_toolbar_bg_right' onclick='stop_propagation(event);'>";
code += "<div id='toolbar_template' title='<#4292#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_template' onclick='edit_component_template();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4292#></div>";
code += "</div>";
code += "<div id='toolbar_background' title='<#4275#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_background' onclick='edit_component_background();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4275#></div>";
code += "</div>";
code += "<div id='toolbar_editor' title='<#4293#>' class='splash_page_toolbar_unit_bg_right splash_page_toolbar_unit_editor' onclick='edit_component_editor();'>";
code += "<div class='splash_page_toolbar_unit_title'><#4293#></div>";
code += "</div>";
code += "</div>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='2'><#4329#></td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><#4330#></th>";
code += "<td>";
code += "<input type='radio' name='cpa_verification' id='cpa_verification_local' value='0' onclick='showHideVerification();' checked><label for='cpa_verification_local'><#4322#></label>";
...
code += "<thead>";
code += "<tr>";
code += "<td colspan='3'><#3700#>&nbsp;(<#2776#>&nbsp;32)</td>";
code += "</tr>";
code += "</thead>";
code += "<tr>";
code += "<th><#3699#></th>";
...
code += "</thead>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 1);'><#4020#></a></th>";
code += "<td>";
...
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 2);'><#4024#></a></th>";
code += "<td>";
...
code += "</tr>";
code += "<tr>";
code += "<th><a class='hintstyle' href='javascript:void(0);' onClick='openHint(2, 3);'><#4022#></a></th>";
code += "<td>";
...
captive_portal_adv_edit_idx = 1;
set_tab_and_action_btn();
alert("Please select at least one <#664#>.");/*untranslated*/
return false;
}
var wl_if = "";
...
gn_overwrite_hint += "<#376#> " + empty_wl_idx + " - " + wl_nband_title[0] + " will be overwrite.\n\n";
}
if(wl_info.band5g_support) {
if($("#cb_wl_1").prop("checked")) {
...
gn_overwrite_hint += "<#376#> " + empty_wl_idx + " - " + wl_nband_title[1] + " will be overwrite.\n\n";
}
}
if(wl_info.band5g_2_support) {
if($("#cb_wl_2").prop("checked")) {
...
gn_overwrite_hint += "<#376#> " + empty_wl_idx + " - " + wl_nband_title[2] + " will be overwrite.";
}
}
}
...
splash_page_adv_html += "<title><#4356#></title>\n";
...
splash_page_adv_html += "alert('<#416#>');\n";
...
gn_overwrite_hint += "<#376#> " + _wl_subunit + " - " + wl_nband_title[0] + " will be overwrite.\n\n";
break;
case "1" :
if(!check_gn_if_status(_wl_subunit, gn_array_5g))
gn_overwrite_hint += "<#376#> " + _wl_subunit + " - " + wl_nband_title[1] + " will be overwrite.\n\n";
break;
case "2" :
if(!check_gn_if_status(_wl_subunit, gn_array_5g_2))
gn_overwrite_hint += "<#376#> " + _wl_subunit + " - " + wl_nband_title[2] + " will be overwrite.";
break;
}
}
}
...
if(_array.length == 0)
code += '<tr><td style="color:#FFCC00;" colspan=' + _colspan_num[_connect_type] + '><#2558#></td></tr>';
else{
...
var data = [];
if(event_log_mode) {
data = [["<#465#>", "<#386#>", "<#3699#>", "<#3114#>", "<#4355#>", "<#4333#>", "<#4285#>", "<#4286#>", "<#4287#>"]];
}
else {
data = [["<#465#>", "<#386#>", "<#3699#>", "<#3114#>", "Failure Time"]];
}
...
code += "<thead><tr style='height:30px;'><td colspan='10'><#4288#>";
code += "</td></tr></thead>";
code += "<tr id='tr_auth_pass' style='cursor:pointer;height:40px;'>";
code += "<th id='th_macAddress_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");' style='cursor:pointer;'><#3128#></th>";
code += "<th id='th_ipAddress_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#386#></th>";
code += "<th id='th_userName_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#3699#></th>";
code += "<th id='th_auth_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#3114#></th>";
code += "<th id='th_session_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4355#></th>";
code += "<th id='th_awayTimeout_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4333#></th>";
code += "<th id='th_startTime_pass' width='20%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4285#></th>";
code += "<th id='th_receviedBytes_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4286#></th>";
code += "<th id='th_transmittedBytes_pass' width='10%' onclick='connect_status_sorter.addBorder(\"pass\", this);connect_status_sorter.doSorter(\"pass\");'><#4287#></th>";
code += "</tr>";
code += "</table>";
...
code += "<thead><tr style='height:30px;'><td colspan='5'><#4288#>";
code += "</td></tr></thead>";
code += "<tr id='tr_auth_failed' style='cursor:pointer;height:40px;'>";
code += "<th id='th_macAddress_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3128#></th>";
code += "<th id='th_ipAddress_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#386#></th>";
code += "<th id='th_userName_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3699#></th>";
code += "<th id='th_auth_failed' width='20%' onclick='connect_status_sorter.addBorder(\"failed\", this);connect_status_sorter.doSorter(\"failed\");'><#3114#></th>";
...
code += "<div class='captive_portal_adv_line'></div>";
code += "<input class='button_gen' onclick='exportConnectEventLog();' type='button' value='<#1632#>'/>";
code += "<input class='button_gen' onclick='update_connect_status();' type='button' value='<#1786#>'/>";
code += "</div>";
...
var code = "";
code += "<div class='edit_component_item_title'><#4300#></div>";
...
var code = "";
code += "<div class='edit_component_item_title' style='margin-bottom:8px;'><#4301#>: <span id='edit_component_level' class='edit_component_level'>" + $("#"+ _component_id + "").css("z-index") + "</span></div>";/*untranslated*/
...
<div>&nbsp;</div>
<div class="formfonttitle"><#376#> - <#4277#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="captive_portal_adv_intro_icon"></div>
<div style='float:left;width:80%;'>
<div class="captive_portal_adv_intro_txt" style="color:#FC0;"><#4278#></div>
<div class="captive_portal_adv_intro_txt"><#4279#></div>
<div class="captive_portal_adv_intro_txt brt_series">
<#2046#> : <a id="faq" href="" target="_blank" style="font-weight:bolder;text-decoration:underline;" href="" target="_blank">GO</a>
</div>
</div>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(31, 1);"><#4282#></a></th>
<td>
...
<span style="color:#FFCC00;">(<#4283#>: 60 - 800, <#3310#>: 300 <#3279#>)</span>
</td>
</tr>
<tr id="tr_event_log">
<th><#4281#></th>
<td>
<input class='button_gen' onclick='show_event_log();' type='button' value='<#2777#>'/>
</td>
</tr>
</table>
...
<span class='captive_portal_adv_add_title' onclick="editProfile('new')"><#3893#></span>
</div>
<table width="100%" align="center" cellpadding="4" cellspacing="0" class="FormTable_table">
<thead>
<tr>
<td id="td_profile_table_title" colspan="5"><#4284#> &nbsp;(<#2776#>&nbsp;1)</td>
</tr>
</thead>
<tr>
<th width="30%"><#4331#></th>
...
<input class='button_gen' onclick='cpa_apply();' type='button' value='<#286#>'/>
</div>
</td>
</tr>
</tbody>
