...
<div>&nbsp;</div>
<div class="formfonttitle"><#2971#> - <#2988#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3358#></div>
<div class="formfontdesc"><#3359#></div>
...
<input class="btn_subusage mt-1 mb-1 button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2989#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2982#>&nbsp;(<#2776#>&nbsp;32)</td>
</tr>
</thead>
<tr>
