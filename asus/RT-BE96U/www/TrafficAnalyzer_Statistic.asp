...
if(show_refresh){
document.getElementById('statistic_hint').innerHTML = "* <#3535#>";
}
else{
document.getElementById('statistic_hint').innerHTML = "* <#3534#>";
}
...
if(top5_info == ""){
if(type == "router")
document.getElementById('top_client_name').innerHTML = "<#3521#>";
else
document.getElementById('top_client_name').innerHTML = "<#3520#>";
document.getElementById('top_client_traffic').innerHTML = "<#3522#>";
}
else{
...
if(type == "router")
code = "<option value='all' selected><#3518#></option>";
else
code = "<option value='all' selected><#3517#></option>";
top5_client_array = [];
top5_app_array = [];
...
code += '<th colspan="4"><#1646#>: '+ mac +'</th>';
else
code += '<th colspan="4"><#1646#>: '+ getClientCurrentName(mac); +'</th>';
}
else{
...
if(type == "router"){
code += "<th style='width:55%;text-align:left;'><#3519#></th>";
}
else{
code += '<th style="width:55%;text-align:left;"><#1646#></th>';
}
code += '<th style="width:15%;text-align:right;"><#3023#></th>';
code += '<th style="width:15%;text-align:right;"><#3019#></th>';
code += '<th style="width:15%;text-align:right;"><#3513#></th>';
code += '</tr>';
...
code = '<div style="width:110px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#3521#></div>';
}
else{
...
if(document.getElementById('duration_option').value == "monthly"){
document.getElementById('total_traffic_title').innerHTML = "<#3533#>";
}
else if(document.getElementById('duration_option').value == "weekly"){
document.getElementById('total_traffic_title').innerHTML = "<#3540#>";
}
else{ //daily
document.getElementById('total_traffic_title').innerHTML = "<#3532#>";
}
document.getElementById('current_traffic_title').innerHTML = "<#3530#>";
document.getElementById('current_traffic_percent_title').innerHTML = "<#3538#>";
}
...
<div class="formfontdesc"><#3531#></div>
<div style="margin-left:10px;">
<label style="font-size:16px;"><#3410#>:</label>
<input class="input_12_table" id="datepicker" value="">
<div id="statistic_hint" class="hint-color" style="text-align:right;margin-top:-21px;padding-right:15px;font-size:14px;">* <#3534#></div>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#3409#>:</div>
</td>
<td>
<div id="router" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter_pressed" onclick="switch_content(this);"><#3058#></div>
</td>
<td>
<div id="apps" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter" onclick="switch_content(this);"><#1513#></div>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#3411#>:</div>
</td>
<td>
<select class="input_option" id="traffic_option" onChange="change_traffic_direction(this);">
<option value="both" selected><#3018#></option>
<option value="down"><#3019#></option>
<option value="up"><#3023#></option>
</select>
</td>
<td>
<select class="input_option" id="duration_option" onChange="switch_date_type(this);">
<option value="monthly"><#1872#></option>
<option value="weekly"><#1884#></option>
<option value="daily" selected><#1864#></option>
</select>
</td>
<td>
...
<div onclick="change_top5_clients(0);" style="width:100px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#3521#></div>
</td>
<td>
...
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#3539#>:</th>
<td style="font-size:14px;" id="top_client_traffic"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#3536#> :</th>
<td></td>
</tr>
</table>
...
<tr>
<td colspan="3">
<div class="hint-color" style="font-size:16px;text-align:center;" id="info_block_title"><#3526#></div>
</td>
</td>
</table>
</div>
