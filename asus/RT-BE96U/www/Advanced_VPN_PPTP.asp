...
document.getElementById("dualwan_ctrl").innerHTML = "<#3148#> <span class=\"formfontdesc\">Primary WAN IP : " + wan0_ipaddr + " </span><span class=\"formfontdesc\">Secondary WAN IP : " + wan1_ipaddr + "</span>";
...
document.getElementById("wan_ctrl").innerHTML = "<#3148#>" + wan_ipaddr;
...
$rowObj.children(":first").html("<#2558#>");
else
...
alert("<#3721#> " + document.form._pptpd_clients_start.value);
document.form._pptpd_clients_end.focus();
document.form._pptpd_clients_end.select();
setEnd();
return false;
...
document.getElementById("pptpd_conflict").innerHTML = "<#3734#> <b>"+origin_lan_ip+"</b>";
return;
}
...
document.getElementById("pptpd_conflict").innerHTML = "<#3732#> <b>"+pool_start+" ~ "+pool_end+"</b>";
return;
}
if(dhcp_staticlists != ""){
...
document.getElementById("pptpd_conflict").innerHTML = "<#3733#> <b>"+static_ip+"</b>";
return;
}
}
}
...
<div id="privateIP_notes" class="formfontdesc" style="display:none;color:#FC0;"><#3800#></div>
...
<div class="formfontdesc"><#3147#></div>
<div id="wan_ctrl" class="formfontdesc"></div>
<div id="dualwan_ctrl" style="display:none;" class="formfontdesc"></div>
<div class="formfontdesc" style="margin-top:-10px;"><#3149#></div>
<div class="formfontdesc" style="margin-top:-10px;">(7) <#3011#></div>
...
<span id="pptpd_broadcast_hint" style="font-family: Lucida Console;color: #FFCC00;display: none;"><#3146#></span>
</td>
</tr>
<tr>
<th><#3114#></th>
...
<input type="checkbox" class="input" name="pptpd_mppe_no" onClick="return changeMppe();"><#2996#>
</td>
</tr>
<tr>
<th><#404#></th>
...
<span id="pptpd_subnet" style="font-family: Lucida Console;color: #FFF;"></span><input type="text" maxlength="3" class="input_3_table" name="_pptpd_clients_end" value="" autocorrect="off" autocapitalize="off"/><span style="color:#FFCC00;"> <#3744#></span>
...
<thead>
<tr>
<td colspan="2"><#3231#> (<#2111#>)</td>
</tr>
</thead>
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6,1);"><#3236#></a></th>
<td>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6,2);"><#3237#></a></th>
<td>
...
<input class="button_gen" type="button" onclick="srConfirm();" value="<#1783#>">
</div>
</div>
</form>
<div id="footer"></div>
