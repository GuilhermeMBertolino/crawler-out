...
<link rel="icon" href="images/favicon.png"><title><#948#> - <#2285#></title>
...
var code = '';
code += '<thead><tr><td colspan="4"><#2327#>&nbsp;(<#2776#>&nbsp;64)</td></tr></thead>';
code += '<tr>';
code += '<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1646#> (<#3128#>)</a></th>';
code += '<th><#2775#></th>';
code += '</tr>';
code += '<tr>';
code += '<td width="40%">';
...
code += '<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3289#>">';
...
<div style="padding: 5px 0;font-size:20px;"><#2324#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2325#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2326#></div>
<div onclick="showGameListField();" class="btn" style="margin: 12px 0;width:100px;height:40px;line-height: 40px;text-align: center;border-radius: 5px;font-size:18px;"><#1761#></div>
</td>
<td>
...
<tr>
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2343#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2344#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2345#></div>
</td>
<td>
...
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2346#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2347#></div>
</td>
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameProfile.asp';"><#1633#></div>
</td>
</tr>
<tr style="height:50px;"></tr>
<tr id='wtfast_1' style="display:none">
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2300#></div>
</td>
<td colspan="2">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px; margin-top: 10px;"><#2323#></div>
<div style="font-size:16px;color:#949393;padding-left:10px; margin-top: 15px; margin-bottom: 10px;">*Please be aware this is a third-party service provided by WTFast®, and WTFast® is fully responsible for warranties and liabilities of this game server acceleration service.</div></td>
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="redirectSite('wtfast');"><#1633#></div>
</td>
</tr>
...
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameBoost_Tencent.asp';"><#1633#></div>
</td>
</tr>
...
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="redirectSite(outfox_site)"><#1633#></div>
</td>
</tr>
<tr style="display: none;" class="gearup">
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px; text-transform:uppercase;"><#2300#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66; text-transform:uppercase;"><#2351#></div>
</td>
</tr>
<tr style="display: none;" class="gearup">
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px; margin: 15px 0;"><#2352#></div>
</td>
<td>
<div class="switch" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px">
...
<div class="btn" style="margin:10px auto auto auto; width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="redirectSite('gearup');"><#1633#></div>
