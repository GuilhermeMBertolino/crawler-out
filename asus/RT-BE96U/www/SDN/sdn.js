...
var $pwd_strength_container = $("<div>").addClass("pwd_strength_container").attr("id", "scorebarBorder"+postfix).attr("title", "<#453#>");
...
var str_SDN_choose = stringSafeGet("<#2409#>");
var str_WiFi_sche = stringSafeGet("<#2415#>");
var str_Scheduled = stringSafeGet("<#3484#>");
var str_Scheduled_one_time = stringSafeGet("<#3485#>");
var str_noProfile_hint = stringSafeGet("<#2405#>");
var str_GuestNetwork_WiFi_Sche_desc = stringSafeGet("<#2416#>");
var str_Scenario_Classroom = stringSafeGet("<#3265#>");
var str_Scenario_coffee = stringSafeGet("<#3266#>");
var str_Scenario_Study = stringSafeGet("<#3272#>");
var str_Scenario_EV_charging = stringSafeGet("<#3267#>");
var str_Scenario_smartHome = stringSafeGet("<#3273#>");
var str_Scenario_branchOffice = stringSafeGet("<#3264#>");
var str_Scenario_Hotel = stringSafeGet("<#3269#>");
var str_Scenario_Mall = stringSafeGet("<#3270#>");
var str_Scenario_Friends = stringSafeGet("<#3268#>");
var str_GuestNetwork_Portal_desc2 = stringSafeGet("<#2395#>");
var str_GuestNetwork_Wizard_type_desc0 = stringSafeGet("<#2418#>");
var str_GuestNetwork_Employee_recommend = stringSafeGet("<#2385#>");
...
{"type":"Employee", "text":"<#2383#>", "desc":"<#2384#>"},
{"type":"Portal", "text":"<#2393#>", "desc":"<#2395#>"},
{"type":"Guest", "text":"<#376#>", "desc":"<#2376#>"},
{"type":"Kids", "text":"<#2391#>", "desc":"<#2392#>"},
{"type":"IoT", "text":"<#2387#>", "desc":"<#2389#>"},
{"type":"VPN", "text":"<#2398#>", "desc":"<#2399#>"},
{"type":"Customized", "text":"<#2382#>", "desc":""},
{"type":"MLO", "text":`<#3983#>`, "desc":`<#3986#>`}
];
if(isSupport("BUSINESS")){
...
specific_wizard_type.text = "<#2408#>";
...
show_customize_alert("<#4457#>".replace("#MAXNUM", sdn_maximum));
return false;
}
selected_sdn_idx = "";
...
$("<div>").addClass("main_info").html("<#2406#>").appendTo($item_text_container);
...
$("<div>").addClass("item_tag VPN").html("<#3896#>").appendTo($item_tag_cntr);
}
if(specific_data.sdn_rl.vpns_idx != "0"){
$("<div>").addClass("item_tag VPN").html("<#260#>").appendTo($item_tag_cntr);
}
...
$("<div>").addClass("item_tag no_icon").html(`<#2823#>`).appendTo($item_tag_cntr);
}
...
.attr({"title":"<#664#>: " + _profile_data.name})
...
show_customize_alert("<#3872#>".replace(/VPN/g, "<#2397#>").replace(/2/g, "1"));
return;
}
if(isSupport("mlo")){
...
show_customize_confirm(`<#3990#>`);
const $confirm_obj = $(".popup_container.popup_customize_alert");
$confirm_obj.find("[data-btn=ok]").html(`<#1766#>`);
$confirm_obj.find("[data-btn=cancel]").html(`<#1634#>`)
.click(()=>{
if(is_Web_iframe){
...
$("<div>").addClass("clients_num").attr({"title":"<#3010#>"})
...
band_info.text = `${((band == "2G") ? "2.4" : band.substring(0,1))} GHz <#3512#>`;
...
if(!is_wifi){
conn_type = [{"type": "LAN", "text": "<#3511#>"}];
return conn_type;
}
else{
if(_sdn_data.sdn_rl.wifi7_onoff == "1") conn_type.push({"type": "WiFi7", "text": `WiFi7`});
if(_sdn_data.sdn_rl.wifi_sched_on == "0"){
conn_type.push({"type": "WiFi_offline", "text": "<#3512#> (<#1657#>)"});
}
else{
conn_type.push({"type": "WiFi", "text": "<#3512#>"});
}
return conn_type;
}
}
...
var $item_text_container = $("<div>").addClass("item_text_container");
$item_text_container.appendTo($profile_item_container);
$("<div>").addClass("main_info").html("<#2382#>").appendTo($item_text_container);
...
var $item_text_container = $("<div>").addClass("item_text_container");
$item_text_container.appendTo($profile_item_container);
$("<div>").addClass("main_info").html("<#2413#>").appendTo($item_text_container);
var $item_action_container = $("<div>").addClass("item_action_container");
$item_action_container.appendTo($profile_item_container);
$("<div>").addClass("icon_add").appendTo($item_action_container);
return $profile_item_container;
...
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2413#>").addClass("Scenarios").appendTo($container)
...
$("<div>").html(htmlEnDeCode.htmlEncode("<#1628#>")).appendTo($title);
var $item_scenarios_cntr = $("<div>").addClass("item_scenarios_container").appendTo($content_container);
$("<div>").addClass("title").html("<#2410#>").appendTo($item_scenarios_cntr);
...
{"type":"Employee", "title":"<#2383#>", "desc":str_GuestNetwork_Wizard_type_desc0+" "+str_GuestNetwork_Employee_recommend},
{"type":"Portal", "title":"<#2393#>", "desc":str_GuestNetwork_Portal_desc2},
{"type":"Guest", "title":"<#376#>", "desc":"<#2376#>"},
{"type":"Sched", "title":"<#2408#>", "desc":str_GuestNetwork_WiFi_Sche_desc},
{"type":"IoT", "title":"<#2387#>", "desc":"<#2389#>"}
];
...
var $container = $("<div>").addClass("setting_content_container");
Get_Component_Popup_Profile_Title("<#398#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
$("<div>").addClass("btn_container apply").html("<#1783#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
$("<div>").addClass("service").html("<#717#>").appendTo($item_title_cntr);
$("<div>").addClass("server").html("<#2437#>").appendTo($item_title_cntr);
$("<div>").addClass("desc").html("<#1833#>").appendTo($item_title_cntr);
...
desc += "&nbsp;";
desc += $("<a/>").attr({"href":dns_item.url, "target":"_blank"}).css({"text-decoration":"underline"}).html("<b><#2766#></b>")[0].outerHTML;
}
...
var $cate_title = $("<div>").addClass("category_title").html("<#473#>").appendTo($dns_list_cntr);
var $item_title_cntr = $("<div>").addClass("item_container").appendTo($dns_list_cntr);
$("<div>").addClass("radio").appendTo($item_title_cntr);
$("<div>").addClass("service").html("<#717#>").appendTo($item_title_cntr);
$("<div>").addClass("server").html("<#2437#>").appendTo($item_title_cntr);
...
$("<div>").html("<#390#>").appendTo($service);
$("<div>").html("<#392#>").appendTo($service);
...
$("<div>").addClass("service").html("<#3310#>").appendTo($default_item_title_cntr);
...
$("<div>").html(htmlEnDeCode.htmlEncode("<#1628#>")).appendTo($btn_back_cntr);
...
var $FWF_change_bg = $("<div>").addClass("FWF_change_bg").attr({"title":"<#4298#>"}).appendTo($FWF_bg);
...
$("<div>").attr({"data-component":"FWF_brand_name"}).addClass("brand_name").html("<#4331#>").appendTo($FWF_text_info_cntr);
...
$("<div>").addClass("cb_text").html("<#4370#>").appendTo($cb_text_container);
...
$("<div>").addClass("btn_container").html("<#4371#>").appendTo($("<div>").addClass("action_container").appendTo($action_info_cntr))
return $container;
}
...
var $MB_change_bg = $("<div>").addClass("MB_change_bg").attr({"title":"<#4298#>"}).appendTo($MB_bg);
...
$("<div>").attr({"data-component":"MB_desc"}).addClass("MB_desc").html("<#1833#>").appendTo($MB_text_info_cntr);
var $action_info_cntr = $("<div>").addClass("action_info_cntr").appendTo($MB_portal_cntr);
$("<div>").addClass("btn_container").html("<#4371#>").appendTo($("<div>").addClass("action_container").appendTo($action_info_cntr))
return $container;
}
function Get_Upload_Image_Container(_callback){
var $bg_upload_image = $("<div>").addClass("bg_upload_image").attr({"title":"<#4364#>"});
...
{"type":"Employee", "title":"<#2383#>", "desc":str_GuestNetwork_Wizard_type_desc0+" "+str_GuestNetwork_Employee_recommend},
{"type":"Portal", "title":"<#2393#>", "desc":str_GuestNetwork_Portal_desc2+" "+stringSafeGet("<#2396#>")},
{"type":"Guest", "title":"<#376#>", "desc":"<#2376#> "+stringSafeGet("<#2377#>")},
{"type":"Kids", "title":"<#2391#>", "desc":str_GuestNetwork_WiFi_Sche_desc+" "+stringSafeGet("<#2417#>")},
{
"type":"IoT","title":`<#2387#>`,
"desc":`
...
enable the "<#2414#>" option. This is perfect for everyday control devices that require frequent monitoring and management.
<br>
To enhance security, disable the "<#2414#>" option and establish a dedicated,
isolated network that shields your IoT devices from external threats.
`/* untranslated */
},
{"type":"VPN", "title":"<#2398#>", "desc":stringSafeGet("<#2400#>")},
{"type":"MLO", "title":`<#3983#>`, "desc":`<#3985#>`}
];
if(isSwMode("ap")){
...
if(specific_wizard_type != undefined){
specific_wizard_type.type = "Sched";
specific_wizard_type.title = "<#2408#>";
}
}
else{
wizard_type_list = wizard_type_list.filter(function(item, index, array){
...
$("<div>").addClass("title").html("<#2990#>").appendTo($popup_title_container);
...
$("<div>").addClass("title").html("<#2992#>").appendTo($feature_desc_cntr);
$("<div>").addClass("desc").html(
stringSafeGet("<#3475#>")+" "+stringSafeGet("<#3476#>")+" "+stringSafeGet("<#3477#>")
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup")
$container.append(Get_Component_Popup_Profile_Title("<#780#>"));
...
if(isSupport("SMART_HOME_MASTER_UI")){
$("<div>").addClass("title").html(htmlEnDeCode.htmlEncode(`<#376#>`)).appendTo($content_container);
...
.html(htmlEnDeCode.htmlEncode(item.cp_text + " (<#843#>)"))
}
});
...
.after($("<div>").html("<#3872#>".replace(/VPN/g, "<#2397#>").replace(/2/g, "1")).addClass("item_hint"));
}
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2383#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2383#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#664#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
});
var security_options = [{"text":"<#2446#>","option_id":"pwd"}, {"text":"<#485#>","option_id":"radius"}];
var security_parm = {"title":"<#825#>", "options": security_options, "container_id":"security_employee"};
...
var wifi_auth_options_parm = {"title": "<#4028#>", "id": "wifi_auth", "options": wifi_auth_options, "set_value": "psk2"};
...
let wifi_auth_options_6G_parm = {"title": `<#4028#>`, "id": "wifi_auth_6G", "options": wifi_auth_options_6G, "set_value": "sae"};
...
var wifi_auth_radius_options_parm = {"title": "<#4028#>", "id": "wifi_auth_radius", "options": wifi_auth_radius_options, "set_value": "wpa2"};
...
let wifi_auth_radius_options_6G_parm = {"title": "<#4028#>", "id": "wifi_auth_radius_6G", "options": wifi_auth_radius_options_6G, "set_value": "wpa3"};
...
let sdn_pwd_parm = {"title":`<#665#>`, "type":"password", "id":"sdn_pwd", "need_check":true, "maxlength":64, "openHint":"0_7"};
...
var radius_ipaddr_parm = {"title":"<#4020#>", "type":"text", "id":"radius_ipaddr", "need_check":true, "maxlength":15, "openHint":"2_1"};
...
var radius_port_parm = {"title":"<#4024#>", "type":"text", "id":"radius_port", "need_check":true, "maxlength":5, "openHint":"2_2"};
...
var radius_key_parm = {"title":"<#4022#>", "type":"password", "id":"radius_key", "need_check":true, "maxlength":64, "openHint":"2_3"};
...
var more_config_parm = {"title":"<#2934#>", "id":"more_config", "slide_target":"more_config_cntr"};
...
let wifi_band_options_parm = {"title": "WiFi <#2474#>", "id": "wifi_band", "options": band_options, "set_value": "3"};
...
if(isSwMode("rt")){
var bw_enabled_parm = {"title":"<#245#>", "type":"switch", "id":"bw_enabled", "set_value":"off"};
...
var bw_parm = {"title":"<#1543#> (Mb/s)", "container_id":"container_bw",
...
var access_intranet_parm = {"title":"<#977#>", "type":"switch", "id":"access_intranet", "openHint":"0_26"};
Get_Component_Switch(access_intranet_parm).appendTo($more_config_cntr);
}
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
$("<div>").addClass("btn_container apply").html("<#286#>").appendTo($action_container);
...
var $container = $("<div>").addClass("setting_content_container");
var profile_title = ((isSupport("BUSINESS")) ? "<#2408#>" : "<#2391#>");
if(view_mode == "popup"){
...
if(isSwMode("rt")){
if(get_cp_type_support("4")){
var portal_options = [{"text":"<#954#>", "value":"0"}];
cp_type_rl_json.forEach(function(item){
if(item.cp_idx == "2")
return;
portal_options.push({"text":item.cp_text, "value":item.cp_idx});
});
var portal_options_parm = {"title": "<#2397#>", "id": "portal_type", "options": portal_options};
...
var MB_desc_parm = {"title":"<#1833#>", "type":"text", "id":"MB_desc", "need_check":true, "maxlength":80, "set_value":"<#1833#>"};
...
var access_intranet_parm = {"title":"<#977#>", "type":"switch", "id":"access_intranet", "openHint":"0_26", "set_value":"off"};
Get_Component_Switch(access_intranet_parm).appendTo($more_config_cntr);
}
var $action_container = $("<div>").addClass("action_container").appendTo($content_container);
$("<div>").addClass("btn_container apply").html("<#286#>").appendTo($action_container);
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("VPN <#2965#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("VPN <#2965#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#664#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2387#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2387#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#664#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
$("<div>").attr({"id":"sdn_pwd_strength", "data-group":"wifi_settings"}).append(Get_Component_PWD_Strength_Meter()).appendTo($content_container).hide();
if(isSwMode("rt")){
let use_main_subnet_parm = {"title":`<#2414#>`, "type":"switch", "id":"use_main_subnet", "set_value":"on"};
...
let wifi_band_options_parm = {"title": "WiFi <#2474#>", "id": "wifi_band", "options": band_options, "set_value": "1"};
var $sel_wifi_band = Get_Component_Custom_Select(wifi_band_options_parm).appendTo($more_config_cntr).find("#select_" + wifi_band_options_parm.id + "");
$sel_wifi_band.children("div").click(function(e){
var options = $(this).attr("value");
var $profile_setting = $(this).closest(".profile_setting");
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#376#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#376#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#664#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
var security_options = [{"text":"Open System","option_id":"open"}, {"text":"<#2446#>","option_id":"pwd"}];
var security_parm = {"title":"<#825#>", "options": security_options, "container_id":"security_guest"};
Get_Component_Switch_Text(security_parm).attr({"data-group":"wifi_settings"}).appendTo($content_container)
.find(".switch_text_container > .switch_text_item")
.click(function(e){
e = e || event;
...
.html(()=>{return ((options == "4" || options == "5" || options == "6") ? `<#4489#>` : `Open System`);});
}
}
if($wifi_settings_objs.find("#bw_enabled").length > 0){
if($wifi_settings_objs.find("#bw_enabled").hasClass("on")){
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2382#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2382#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#664#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
if(isSwMode("rt")){
let use_main_subnet_parm = {"title":`<#2414#>`, "type":"switch", "id":"use_main_subnet", "set_value":"off"};
...
var $container = $("<div>").addClass("setting_content_container");
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title("<#2393#>").appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title("<#2393#>").appendTo($container);
var $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
var sdn_name_parm = {"title":"<#664#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
...
var FWF_brand_name_parm = {"title":"<#4331#>", "type":"text", "id":"FWF_brand_name", "need_check":true, "maxlength":40};
...
sdn_profile.apg_rl.security = `<3>psk2sae>aes>${$sdn_pwd.val()}>${radius_idx}`;
sdn_profile.apg_rl.security += `<13>psk2sae>aes>${$sdn_pwd.val()}>${radius_idx}`;
sdn_profile.apg_rl.security += `<16>sae>aes>${$sdn_pwd.val()}>${radius_idx}`;
sdn_profile.apg_rl.security += `<96>sae>aes>${$sdn_pwd.val()}>${radius_idx}`;
sdn_profile.apg_rl.sched = schedule_handle_data.json_array_to_string(wizard_schedule.Get_Value());
if($(_obj).find("#wizard_schedule").hasClass("on")){
sdn_profile.apg_rl.timesched = ((sdn_profile.apg_rl.sched == "") ? "0" : "1");
}
...
if(view_mode == "popup"){
Get_Component_Popup_Profile_Title(`<#3983#>`).appendTo($container)
.find("#title_close_btn").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_container($container);
...
Get_Component_Profile_Title(`<#3983#>`).appendTo($container);
let $content_container = $("<div>").addClass("popup_content_container profile_setting").appendTo($container);
let sdn_name_parm = {"title":"<#664#>", "type":"text", "id":"sdn_name", "need_check":true, "maxlength":32, "openHint":"0_1"};
Get_Component_Input(sdn_name_parm).appendTo($content_container)
.find("#" + sdn_name_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
});
let sdn_pwd_parm = {"title":"<#665#>", "type":"password", "id":"sdn_pwd", "need_check":true, "maxlength":32, "openHint":"0_7"};
Get_Component_Input(sdn_pwd_parm).attr({"data-group":"wifi_settings"}).appendTo($content_container)
.find("#" + sdn_pwd_parm.id + "")
.unbind("keyup").keyup(function(){
chkPass($(this).val(), "rwd_vpn_pwd", $("#sdn_pwd_strength"));
...
$("<div>").attr({"id":"sdn_pwd_strength", "data-group":"wifi_settings"}).append(Get_Component_PWD_Strength_Meter()).appendTo($content_container).hide();
let more_config_parm = {"title":"<#2934#>", "id":"more_config", "slide_target":"more_config_cntr"};
Get_Component_Slide_Title(more_config_parm).appendTo($content_container);
...
let wifi_band_options_parm = {"title": "WiFi <#2474#>", "id": "wifi_band", "options": band_options};
...
$("<div>").addClass("profile_setting_item schedule_ui").attr({"id":"container_wizard_schedule", "data-group":"wifi_settings"}).append(wizard_schedule.Get_UI()).hide().appendTo($more_config_cntr);
if(isSwMode("rt")){
let bw_enabled_parm = {"title":"<#245#>", "type":"switch", "id":"bw_enabled", "set_value":"off"};
Get_Component_Switch(bw_enabled_parm).attr({"data-group":"wifi_settings"}).appendTo($more_config_cntr)
.find("#" + bw_enabled_parm.id + "").click(function(e){
e = e || event;
e.stopPropagation();
...
let bw_parm = {"title":"<#1543#> (Mb/s)", "container_id":"container_bw",
"type_1":"text", "id_1":"bw_dl", "maxlength_1":12, "need_check_1":true,
"type_2":"text", "id_2":"bw_ul", "maxlength_2":12, "need_check_2":true};
Get_Component_Bandwidth_Setting(bw_parm).attr({"data-group":"wifi_settings"}).hide().appendTo($more_config_cntr);
let access_intranet_parm = {"title":"<#977#>", "type":"switch", "id":"access_intranet", "openHint":"0_26", "set_value":"off"};
Get_Component_Switch(access_intranet_parm).appendTo($more_config_cntr);
let use_main_subnet_parm = {"title":`<#2414#>`, "type":"switch", "id":"use_main_subnet", "set_value":"off"};
...
$("<div>").addClass("title").attr({"data-container":"profile_title"}).html("<#1928#>").appendTo($title_cntr);
...
var general_parm = {"title":"<#481#>", "id":"category_general", "slide_target":"category_general_cntr"};
...
var adv_parm = {"title":"<#479#>", "id":"category_adv", "slide_target":"category_adv_cntr"};
...
$("<div>").attr({"data-component":"del_btn"}).addClass("btn_container delete mobile").appendTo($action_container).html("<#1767#>");
$("<div>").attr({"data-component":"apply_btn"}).addClass("btn_container apply").appendTo($action_container).html("<#286#>");
if(isSwMode("rt")){
...
var client_tab_options = [{"text":"<#1660#>","option_id":"all"}, {"text":"<#3511#>","option_id":"wired"}, {"text":"<#3512#>","option_id":"wireless"}];
var client_tab_parm = {"title":"<#1739#> : 0 <#1659#>", "options": client_tab_options, "container_id":"client_tab"};
...
$client_num.html("<#1739#> : " + sdn_clientlist_data.length + " <#1659#>");
...
Get_FWF_Change_BG_Container().hide().appendTo($FWF_ui_cntr);
var FWF_conntimeout_parm = {"title":"<#4355#> (<#2826#>)", "type":"text", "id":"FWF_conntimeout", "need_check":true, "maxlength":3, "set_value":"60", "openHint":"31_3"};
Get_Component_Input(FWF_conntimeout_parm).appendTo($freewifi_cntr)
.find("#" + FWF_conntimeout_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isNumber(this,event);
});
var FWF_redirecturl_parm = {"title":"<#4335#> (<#4339#>)", "type":"text", "id":"FWF_redirecturl", "maxlength":256};
Get_Component_Input(FWF_redirecturl_parm).appendTo($freewifi_cntr);
var FWF_passcode_enabled_parm = {"title":"<#4366#>", "type":"switch", "id":"FWF_passcode_enabled", "set_value":"off"};
...
var FWF_passcode_parm = {"title":"<#4365#>", "type":"text", "id":"FWF_passcode", "need_check":true, "maxlength":64, "container_id":"container_FWF_passcode"};
Get_Component_Input(FWF_passcode_parm).hide().appendTo($freewifi_cntr);
var FWF_terms_service_enabled_parm = {"title":"<#4336#>", "type":"switch", "id":"FWF_terms_service_enabled", "set_value":"on"};
...
"title":"<#4358#>", "id":"FWF_terms_service", "rows":"8", "cols":"55", "need_check":true, "maxlength":"5120", "set_value":parm_terms_service,
...
var MB_desc_parm = {"title":"<#1833#>", "type":"text", "id":"MB_desc", "need_check":true, "maxlength":80};
Get_Component_Input(MB_desc_parm).appendTo($message_board_cntr)
.find("#" + MB_desc_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
...
var $btn_container_delete_mobile = $("<div>").attr({"id":"del_btn"}).addClass("btn_container delete mobile").appendTo($action_container).html("<#1767#>");
var $btn_container_apply = $("<div>").attr({"id":"apply_btn"}).addClass("btn_container apply").appendTo($action_container).html("<#286#>");
$content_container.find("[need_check=true]").keyup(function(){
...
$("<div>").addClass("subtab_item").attr({"subtab":"net"}).html("<#2965#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
$("<div>").addClass("subtab_item").attr({"subtab":"client"}).html("<#2255#>").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
$(this).closest(".Setting_SubTab_Container").find(".subtab_item").removeClass("selected");
$(this).addClass("selected");
...
let wifi_band_options_parm = {"title": "WiFi <#2474#>", "id": "wifi_band", "options": wifi_band_options, "set_value": "3"};
...
var security_radius_options = [{"text":"<#2446#>","option_id":"pwd"}, {"text":"<#485#>","option_id":"radius"}];
var security_radius_parm = {"title":"<#825#>", "options": security_radius_options, "container_id":"security_employee"};
...
var wifi_auth_options_parm = {"title": "<#4028#>", "id": "wifi_auth", "options": wifi_auth_options, "set_value": "psk2"};
let $wifi_auth_default = Get_Component_Custom_Select(wifi_auth_options_parm).attr({"data-sec-option-id":"pwd","data-group":"wifi_settings","data-wifi-auth":"default"}).appendTo($net_mode_container);
let wifi_auth_options_6G = [{"text":`WPA3-Personal`,"value":"sae"}];
let wifi_auth_options_6G_parm = {"title": `<#4028#>`, "id": "wifi_auth_6G", "options": wifi_auth_options_6G, "set_value": "sae"};
let $wifi_auth_6G = Get_Component_Custom_Select(wifi_auth_options_6G_parm).attr({"data-sec-option-id":"pwd","data-group":"wifi_settings","data-wifi-auth":"6G"}).appendTo($net_mode_container);
let wifi_auth_options_MLO = [{"text":"WPA2/WPA3-Personal","value":"psk2sae"}, {"text":`WPA3-Personal`,"value":"sae"}];
let wifi_auth_options_MLO_parm = {"title": `<#4028#>`, "id": "wifi_auth_MLO", "options": wifi_auth_options_MLO, "set_value": "psk2sae"};
let $wifi_auth_MLO = Get_Component_Custom_Select(wifi_auth_options_MLO_parm).attr({"data-sec-option-id":"pwd","data-group":"wifi_settings","data-wifi-auth":"MLO"}).appendTo($net_mode_container);
let $help_icon = $("<div>").addClass("help_icon").unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
show_customize_alert(`Based on the WiFi7 standard, the wireless authentication method should be set to WPA2/WPA3-Personal, WPA3-Personal for optimal connectivity.`);
});
$wifi_auth_default.addClass("icon_item").find(".input_container").append($help_icon.clone(true));
$wifi_auth_6G.addClass("icon_item").find(".input_container").append($help_icon.clone(true));
$wifi_auth_MLO.addClass("icon_item").find(".input_container").append($help_icon.clone(true));
var wifi_auth_radius_options = [{"text":"WPA2-Enterprise","value":"wpa2"},{"text":"WPA/WPA2-Enterprise","value":"wpawpa2"}];
if(isSupport("wpa3-e")){
wifi_auth_radius_options.push({"text":"WPA3-Enterprise","value":"wpa3"});
wifi_auth_radius_options.push({"text":"WPA2/WPA3-Enterprise","value":"wpa2wpa3"});
...
if(!isMobile()){
var qrcode_btn_parm = {"title":`<#592#>`, "id":"qrcode_print_btn"};
Get_Component_Print_Btn(qrcode_btn_parm).appendTo($net_mode_container);
}
var bw_enabled_parm = {"title":"<#245#>", "type":"switch", "id":"bw_enabled"};
...
if(isSwMode("rt")){
var dhcp_enable_parm = {"title":"<#2661#>", "type":"switch", "id":"dhcp_enable", "openHint":"5_1"};
Get_Component_Switch(dhcp_enable_parm).appendTo($net_mode_container);
var ipaddr_parm = {"title":"<#2657#>", "type":"text", "id":"ipaddr", "need_check":true, "maxlength":15};
...
var netmask_options = [
{"text":"255.255.255.0 (253 <#2255#>)","value":"255.255.255.0"},
{"text":"255.255.255.128 (125 <#2255#>)","value":"255.255.255.128"},
{"text":"255.255.255.192 (61 <#2255#>)","value":"255.255.255.192"},
{"text":"255.255.255.224 (29 <#2255#>)","value":"255.255.255.224"},
{"text":"255.255.255.240 (13 <#2255#>)","value":"255.255.255.240"},
];
var netmask_parm = {"title": "<#408#>", "id": "netmask", "options": netmask_options, "set_value": "255.255.255.0", "openHint":"4_2"};
Get_Component_Custom_Select(netmask_parm).appendTo($net_mode_container);
const dhcp_lease_parm = {"title":`<#2674#> (<#3279#>)`, "type":"text", "id":"dhcp_lease", "need_check":true, "maxlength":6, "openHint":"5_5"};
...
var vid_parm = {"title":"<#3960#>", "type":"text", "id":"vlan_id", "need_check":true, "maxlength":4};//1-4093
if(is_Web_iframe){
if(isSupport("SMART_HOME_MASTER_UI")){
...
if(isSwMode("rt")){
var hide_ssid_parm = {"title":"<#4118#>", "type":"switch", "id":"hide_ssid"};
...
var ap_iso_parm = {"title":"<#4148#>", "type":"switch", "id":"ap_isolate", "openHint":"3_5"};
...
$(_obj).find("[data-container=profile_title]").html("<#1928#>");
...
$("<div>").addClass("title").html("<#3999#>").appendTo($popup_title_container);
...
$("<div>").addClass("qr_text").html("<#4505#>").appendTo($qrcode_cntr);
...
$(_obj).find("#select_wifi_auth")
.closest(".custom_select_container").attr("temp_disable", "disabled").addClass("temp_disable")
.closest(".profile_setting_item").show().find(".help_icon").remove();
}
set_apply_btn_status($(_obj).find(".profile_setting"));
...
var radius_idx = sdn_profile.apg_rl.apg_idx;
if(is_mlo_fh){
let mlo_wifi_auth = $(_obj).find("#select_wifi_auth_MLO").children(".selected").attr("value");
sdn_profile.apg_rl.security = `<3>${mlo_wifi_auth}>${wifi_crypto}>${wifi_pwd}>${radius_idx}`;
sdn_profile.apg_rl.security += `<13>${mlo_wifi_auth}>${wifi_crypto}>${wifi_pwd}>${radius_idx}`;
sdn_profile.apg_rl.security += `<16>sae>${wifi_crypto}>${wifi_pwd}>${radius_idx}`;
sdn_profile.apg_rl.security += `<96>sae>${wifi_crypto}>${wifi_pwd}>${radius_idx}`;
}
...
testResult.errReason = '<#439#>" '+ invalid_char +'" !';
return testResult;
}
if(str){
...
testResult.isError = true;
testResult.errReason = keywordArray + " <#2631#>";
return testResult;
}
}
}
...
if(psk_length < 8){
testResult.isError = true;
testResult.errReason = "<#422#>";
testResult.set_value = "00000000";
return testResult;
}
if(psk_length > 64){
testResult.isError = true;
testResult.errReason = "<#423#>";
return testResult;
}
if(psk_length != psk_length_trim){
testResult.isError = true;
testResult.errReason = stringSafeGet("<#425#>");
return testResult;
}
if(psk_length >= 8 && psk_length <= 63){
if(str.charAt(0) == '"'){
testResult.isError = true;
testResult.errReason = stringSafeGet(`<#438#> ["]`);
return testResult;
}
if(str.charAt(psk_length - 1) == '"'){
testResult.isError = true;
testResult.errReason = stringSafeGet(`<#440#> ["]`);
return testResult;
}
...
testResult.isError = true;
testResult.errReason = '<#436#> ' + ssid.charAt(i) + ' <#437#>';
return testResult;
}
}
}
...
if(!$.isNumeric(str)){
testResult.isError = true;
testResult.errReason = "<#3183#>";
return testResult;
}
if(str.split(".").length > 2 || parseFloat(str) < 0.1){
testResult.isError = true;
testResult.errReason = "<#2824#> : 0.1 Mb/s";
return testResult;
}
return testResult;
};
...
testResult.isError = true;
testResult.errReason = "<#2094#> ex. http or https ://www.asus.com";
return testResult;
}
};
...
if($sdn_name.val() == ""){
$sdn_name.show_validate_hint("<#416#>");
$sdn_name.focus();
return false;
}
...
$sdn_name.show_validate_hint("<#2629#>");
$sdn_name.focus();
return false;
}
var $sdn_pwd = $(_obj).find("#sdn_pwd");
...
if($sdn_pwd.val() == ""){
$sdn_pwd.show_validate_hint("<#416#>");
$sdn_pwd.focus();
return false;
}
...
$radius_ipaddr.show_validate_hint(($radius_ipaddr.val() + " <#430#>"));
$radius_ipaddr.focus();
return false;
}
}
...
if($radius_port.val() == ""){
$radius_port.show_validate_hint("<#416#>");
$radius_port.focus();
return false;
}
...
$ipaddr.show_validate_hint("<#2625#>");
$ipaddr.focus();
return false;
}
...
$ipaddr.show_validate_hint("<#2625#>".replace("LAN", "WAN"));
$ipaddr.focus();
return false;
}
var specific_data = sdn_all_rl_json.filter(function(item, index, array){
...
$ipaddr.show_validate_hint("<#3757#>");
$ipaddr.focus();
return false;
}
}
...
if($dhcp_lease.val() == ""){
$dhcp_lease.show_validate_hint("<#416#>");
$dhcp_lease.focus();
return false;
}
...
if($vlan_id.val() == ""){
$vlan_id.show_validate_hint("<#416#>");
$vlan_id.focus();
return false;
}
...
$vlan_id.show_validate_hint("<#2629#>");
$vlan_id.focus();
return false;
}
}
...
$FWF_conntimeout.show_validate_hint("<#416#>");
...
if($FWF_passcode.val() == ""){
$FWF_passcode.show_validate_hint("<#416#>");
$FWF_passcode.focus();
return false;
}
...
{tag:"#RESTAURANT",text:stringSafeGet("<#3274#>")},
{tag:"#GYM",text:stringSafeGet("<#1208#>")},
{tag:"#CHILDREN",text:stringSafeGet("<#3275#>")},
{tag:"#VOICE_ASSISTANT",text:stringSafeGet("<#3276#>")},
{tag:"#SURVEILLANCE_DEVICES",text:stringSafeGet("<#3277#>")},
{tag:"#WFH",text:stringSafeGet("<#3278#>")},
{tag:"#BRANCH_OFFICE",text:stringSafeGet("<#3264#>")}
];
setTimeout(function(){
...
$("<div>").html("<#416#>").addClass("validate_hint").insertAfter($AiMesh_List_cntr);
resize_iframe_height();
}
}).appendTo($node_cntr);
...
let sub_info_text = (node_info.online == "1") ? `<span>${node_info.ip}</span>` : `<span><#1657#> | ${node_info.mac}</span>`;
...
var hint = "* <#1234#> <#1236#>".replace("#MODELLIST", get_model_name(node_info));
...
{value:"Home",text:"<#1181#>"}, {value:"Living Room",text:"<#1182#>"}, {value:"Dining Room",text:"<#1183#>"},
{value:"Bedroom",text:"<#1184#>"}, {value:"Office",text:"<#1185#>"}, {value:"Stairwell",text:"<#1186#>"},
{value:"Hall",text:"<#1187#>"}, {value:"Kitchen",text:"<#1188#>"}, {value:"Attic",text:"<#1189#>"},
{value:"Basement",text:"<#1190#>"}, {value:"Yard",text:"<#1191#>"}, {value:"Master Bedroom",text:"<#1192#>"},
{value:"Guest Room",text:"<#1193#>"}, {value:"Kids Room",text:"<#1194#>"}, {value:"Study Room",text:"<#1195#>"},
{value:"Hallway",text:"<#1196#>"}, {value:"Walk-in Closet",text:"<#1197#>"}, {value:"Bathroom",text:"<#1198#>"},
{value:"First Floor",text:"<#1206#>"}, {value:"Second Floor",text:"<#1199#>"}, {value:"Third Floor",text:"<#1200#>"},
{value:"Storage",text:"<#1201#>"}, {value:"Balcony",text:"<#1202#>"}, {value:"Meeting Room",text:"<#1203#>"},
{value:"Garage",text:"<#1205#>"}, {value:"Gaming Room",text:"<#1207#>"}, {value:"Gym",text:"<#1208#>"},
{value:"Custom",text:"<#1204#>"}
];
}
var result = {"loc_text":"<#1181#>", "loc_css":"Home"};
var loc_text = "Home";
if(_isReNode){
...
$node_cntr.find(".icon_checkbox").addClass("closed");
$("<div>").addClass("node_hint")
.html(htmlEnDeCode.htmlEncode(`* <#1782#> - MLO`))
.appendTo($node_cntr);
}
});
}
...
$("<div>").addClass("title").html("<#3896#>").appendTo($vpnc_group);
var vpnc_options = [];
...
$("<div>").html("<#1634#>").appendTo($btn_cntr);
...
$("<div>").addClass("title").html("<#260#>").appendTo($vpns_group);
...
return $("<div>").addClass("no_client_hint").html("<#63#>");
}
else {
...
"continue_btn": encode_decode_text('<#4371#>', 'encode'),
...
splash_page_setting.splash_page_setting["terms_service_cb_text"] = encode_decode_text("<#4370#>", "encode");
splash_page_setting.splash_page_setting["terms_service_title"] = encode_decode_text("<#4308#>", 'encode');
splash_page_setting.splash_page_setting["agree_btn"] = encode_decode_text("<#1762#>", 'encode');
if(_setting.auth_type == "1"){
splash_page_setting.splash_page_setting["passcode_blank"] = encode_decode_text('<#4365#> : <#416#>', 'encode');
...
let result = {"time": 20, "disconnect": false};//restart_net_and_phy/reboot will disconnect and logout
if(_rc_service != undefined){
if(_rc_service.indexOf("restart_net_and_phy;") >= 0 || _rc_service.indexOf("reboot;") >= 0){
