...
x.options[0].text = "<#4068#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#4068#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#4069#>", "upper");
...
x.options[0].text = "<#4069#>";
x.options[0].value = "upper";
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#4068#>", "lower");
...
else if(opts[opts.selectedIndex].text == "WPA2-Personal" || opts[opts.selectedIndex].text == "<#4489#>" || opts[opts.selectedIndex].text == "WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2/WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2-Enterprise")
algos = new Array("AES");
else
...
var auth_array = [["<#4489#>", "owe"], ["WPA3-Personal", "sae"]];
}
else{
