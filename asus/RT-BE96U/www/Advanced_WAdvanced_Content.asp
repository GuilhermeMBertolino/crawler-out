...
country_array = [];
var country_selection_list = [["AA", "<#1745#>"], ["CN", "<#1747#>"], ["SG", "<#1751#>"], ["EU", "<#1748#>"], ["KR", "<#1749#>"], ["RU", "<#1750#>"], ["US", "<#1752#>"], ["AU", "<#1746#>"], ["XX", "<#1746#>"]];
...
country_selection_list.push(["GD", "<#1747#>"]);
}
if(EG_mode){
...
document.getElementById('wl_txbf_desc').innerHTML = "<#4099#>";
}
else{
document.getElementById('wl_txbf_desc').innerHTML = "<#4100#>";
}
}
else{
document.getElementById('wl_txbf_desc').innerHTML = "<#4099#>";
...
else if ((based_modelid == 'RT-AX92U' || based_modelid == 'RT-AX95Q' || based_modelid == 'XT8PRO' || based_modelid == 'BT12' || based_modelid == 'BT10' || based_modelid == 'BQ16' || based_modelid == 'BQ16_PRO' || based_modelid == 'BM68' || based_modelid == 'XT8_V2' || based_modelid == 'RT-AX56_XD4' || based_modelid == 'XD4PRO' || based_modelid == 'CT-AX56_XD4' || based_modelid == 'RT-AX56U' || based_modelid == 'XC5') && (is_unit_24g(wl_unit_value) || is_unit_5g(wl_unit_value))){
document.getElementById("wl_MU_MIMO_field").style.display = "none";
document.form.wl_mumimo.disabled = true;
}
}
...
var value = ['0', '1', '3'];
var desc = ['<#4096#>', 'DL OFDMA only', 'DL OFDMA + MU-MIMO'];
add_options_x2(document.form.wl_ofdma, desc, value, document.form.wl_ofdma.value);
}
else if(Rawifi_support){
var value = ['0', '1', '4', '2','3'];
var desc = ['<#4096#>', 'DL OFDMA only', 'DL OFDMA + MU-MIMO', 'DL/UL OFDMA', 'DL/UL OFDMA + MU-MIMO'];
...
var name = country ? country.name : '<#4179#> ' + index;
if(tcode == index){
matched = true;
name += ' (<#3310#>)';
}
...
if(!matched){
code += '<option value='+ tcode +' ><#3310#></option>';
}
code += '</select>';
...
document.getElementById('wl_txPower_field_title').innerHTML = "<#4080#>&nbsp;&nbsp;&nbsp;&nbsp;<20dBm";
document.getElementById('tx_power_desc_EG').innerHTML = "<20dBm";
}
else{
document.getElementById('wl_txPower_field_title').innerHTML = "<#4080#>&nbsp;&nbsp;&nbsp;<23dBm";
...
power_table_desc = ["<#4081#>", "<#4082#>", "<#4083#>", "<#4084#>", "<#4085#>"];
...
var confirm_txt = "<#4075#>";
if(is_unit_5g(wl_unit_value) || is_unit_5g_2(wl_unit_value)){ // 5GHz up
if(band5g_11ax_support){
if(based_modelid == 'RT-AX92U'){
confirm_txt = confirm_txt.replace("$Beamforming$", "<#4099#>");
}
else{
confirm_txt = confirm_txt.replace("$Beamforming$", "<#4100#>");
}
}
else{
confirm_txt = confirm_txt.replace("$Beamforming$", "<#4099#>");
...
confirm_txt = confirm_txt.replace("$Beamforming$", "<#4136#>");
}
...
var confirm_text = "<#1234#> <#1235#> <#1236#>\n<#3305#>";
...
_temp = ['<#243#>', 'AX only', 'N/AC/AX mixed', 'Legacy'];
_temp_value = ['0', '9', '8', '2'];
add_options_x2(document.form.wl_nmode_x, _temp, _temp_value, _nmode_x);
}
else if(is_unit_6g(wl_unit_value)){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#480#> - <#486#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="title_bg">
<div id="titl_desc" class="formfontdesc"><#4058#></div>
<div id="lantiq_ready" style="display:none;color:#FC0;margin-left:5px;font-size:13px;">Wireless is setting...</div>
<div id="svc_hint_div" style="display:none;margin-left:5px;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" style="color:#FFCC00;text-decoration:underline;cursor:pointer;"><#374#></span></div>
...
<tr id="wl_rf_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 1);"><#4172#></a></th>
<td>
<input type="radio" value="1" name="wl_radio" class="input" onClick="control_TimeField();" <% nvram_match("wl_radio", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="wl_radio" class="input" onClick="control_TimeField();check_mlo_status(this);" <% nvram_match("wl_radio", "0", "checked"); %>><#276#>
</td>
</tr>
<tr id="wl_sched_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 23);"><#4187#></a></th>
<td>
<input type="radio" value="1" name="wl_timesched" class="input" onClick="control_TimeField();check_mlo_status(this);return change_common_radio(this, 'WLANConfig11b', 'wl_timesched', '1');" <% nvram_match("wl_timesched", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="wl_timesched" class="input" onClick="control_TimeField();return change_common_radio(this, 'WLANConfig11b', 'wl_timesched', '0')" <% nvram_match("wl_timesched", "0", "checked"); %>><#276#>
<span id="time_setting" style="padding-left:20px;cursor:pointer;text-decoration:underline" onclick="show_wifi_schedule();"><#3486#></span>
</td>
</tr>
<tr id="wl_ap_isolate_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 5);"><#4148#></a></th>
<td>
<input type="radio" value="1" name="wl_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_ap_isolate', '1')" <% nvram_match("wl_ap_isolate", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="wl_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_ap_isolate', '0')" <% nvram_match("wl_ap_isolate", "0", "checked"); %>><#276#>
</td>
</tr>
<tr id="wl_bss_maxassoc_field" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 35);"><#4125#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 31);"><#3205#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select id="wl_user_rssi_option" class="input_option" onchange="changeRSSI(this.value);">
<option value="1"><#4095#></option>
<option value="0" <% nvram_match("wl_user_rssi", "0","selected"); %>><#4096#></option>
</select><br>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#4118#></a></th>
<td>
<input type="radio" value="1" name="wl_closed" class="input" <% nvram_match("wl_closed", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="wl_closed" class="input" <% nvram_match("wl_closed", "0", "checked"); %>><#276#>
<br>
<span id="dwb_band_hide_hint" style="display:none"><#59#></span>
</td>
</tr>
<tr>
<th><a id="wl_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4159#></a></th>
<td>
<select name="wl_nmode_x" class="input_option" onChange="wl_mode_change(this.value);">
<option value="0" <% nvram_match("wl_nmode_x", "0","selected"); %>><#243#></option>
...
<span id="wl_optimizexbox_span" style="display:none"><input type="checkbox" name="wl_optimizexbox_ckb" id="wl_optimizexbox_ckb" value="<% nvram_get("wl_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4161#></span>
<span id="wl_gmode_checkbox" style="display:none;"><input type="checkbox" name="wl_gmode_check" id="wl_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4160#></span>
...
<span id="wl_nmode_x_hint" style="display:none;"><br><#4207#><br></span>
<span id="wl_NOnly_note" style="display:none;"></span>
<br>
<span id="wl_AXOnly_note" style="display:none;"><#4211#></span>
...
<tr id="he_mode_field">
<th>
<a id="he_mode_text" class="hintstyle"><#4070#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl_11ax", "1","selected"); %>><#4095#></option>
<option value="0" <% nvram_match("wl_11ax", "0","selected"); %>><#4096#></option>
</select>
<span id="he_mode_faq" style="padding: 0 10px"><#4071#></span>
</div>
</td>
</tr>
<tr id="wifi7_mode_field" style="display:none">
<th>
<a id="wifi7_mode_text" class="hintstyle"><#4009#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_11be" class="input_option" onChange="wifi7_mode(this);">
<option value="1" <% nvram_match("wl_11be", "1","selected"); %>><#4095#></option>
<option value="0" <% nvram_match("wl_11be", "0","selected"); %>><#4096#></option>
</select>
</div>
</td>
</tr>
<tr id="mbo_field">
<th>
<a class="hintstyle"><#4025#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_mbo_enable" class="input_option">
<option value="1" <% nvram_match("wl_mbo_enable", "1","selected"); %>><#4095#></option>
<option value="0" <% nvram_match("wl_mbo_enable", "0","selected"); %>><#4096#></option>
</select>
</div>
</td>
</tr>
<tr id="twt_field">
<th>
<a class="hintstyle"><#4086#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_twt" class="input_option">
<option value="1" <% nvram_match("wl_twt", "1","selected"); %>><#4095#></option>
<option value="0" <% nvram_match("wl_twt", "0","selected"); %>><#4096#></option>
</select>
</div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,34);"><#4119#></a></th>
<td>
<select name="wl_btc_mode" class="input_option">
<option value="0" <% nvram_match("wl_btc_mode", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_btc_mode", "1","selected"); %> ><#4095#></option>
<option value="2" <% nvram_match("wl_btc_mode", "2","selected"); %> ><#4121#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 22);"><#4144#></a></th>
<td>
<select name="wl_igs" class="input_option">
<option value="1" <% nvram_match("wl_igs", "1","selected"); %>><#4095#></option>
<option value="0" <% nvram_match("wl_igs", "0","selected"); %>><#4096#></option>
</select>
</td>
</tr>
<tr id="wl_mrate_select">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 7);"><#4073#></a></th>
<td>
<select name="wl_mrate_x" class="input_option">
<option value="0" <% nvram_match("wl_mrate_x", "0", "selected"); %>><#243#></option>
</select>
</td>
</tr>
<tr id="wl_plcphdr_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,20);"><#4213#></a></th>
<td>
<select name="wl_plcphdr" class="input_option">
<option value="long" <% nvram_match("wl_plcphdr", "long", "selected"); %>><#4214#></option>
<option value="short" <% nvram_match("wl_plcphdr", "short", "selected"); %>><#4215#></option>
<!-- auto mode applicable for STA only
<option value="auto" <% nvram_match("wl_plcphdr", "auto", "selected"); %>><#243#></option>
-->
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 9);"><#4139#></a></th>
<td>
...
<tr id='ampdu_rts_tr'>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,30);">AMPDU RTS</a></th> <td>
<select name="wl_ampdu_rts" class="input_option" onchange="check_ampdu_rts();">
<option value="1" <% nvram_match("wl_ampdu_rts", "1", "selected"); %>><#4095#></option>
<option value="0" <% nvram_match("wl_ampdu_rts", "0", "selected"); %>><#4096#></option>
</select>
</td>
</tr>
<tr id="rts_threshold">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 10);"><#4185#></a></th>
<td>
...
<tr id="wl_dtim_field">
<th><a class="hintstyle" id="wl_dtim_th"><#4132#></a></th>
<td>
...
<tr id="wl_bcn_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 12);"><#4116#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 13);"><#4192#></a></th>
<td>
<select name="wl_frameburst" class="input_option">
<option value="off" <% nvram_match("wl_frameburst", "off","selected"); %>><#4096#></option>
<option value="on" <% nvram_match("wl_frameburst", "on","selected"); %>><#4095#></option>
</select>
</td>
</tr>
<tr id="PktAggregate"><th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 16);"><#4168#></a></th>
<td>
<select name="wl_PktAggregate" class="input_option">
<option value="0" <% nvram_match("wl_PktAggregate", "0","selected"); %>><#4096#></option>
<option value="1" <% nvram_match("wl_PktAggregate", "1","selected"); %>><#4095#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 14);"><#4195#></a></th>
<td>
<select name="wl_wme" id="wl_wme" class="input_option" onChange="enable_wme_check(this);">
<option value="auto" <% nvram_match("wl_wme", "auto", "selected"); %>><#243#></option>
<option value="on" <% nvram_match("wl_wme", "on", "selected"); %>><#4095#></option>
<option value="off" <% nvram_match("wl_wme", "off", "selected"); %>><#4096#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,15);"><#4164#></a></th>
<td>
<select name="wl_wme_no_ack" id="wl_wme_no_ack" class="input_option">
<option value="off" <% nvram_match("wl_wme_no_ack", "off","selected"); %>><#4096#></option>
<option value="on" <% nvram_match("wl_wme_no_ack", "on","selected"); %>><#4095#></option>
</select>
</td>
</tr>
<tr id="wl_wme_apsd_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,17);"><#4111#></a></th>
<td>
<select name="wl_wme_apsd" class="input_option">
<option value="off" <% nvram_match("wl_wme_apsd", "off","selected"); %> ><#4096#></option>
<option value="on" <% nvram_match("wl_wme_apsd", "on","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr id="DLSCapable" class="rept"> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,18);"><#4129#></a></th>
<td>
<select name="wl_DLSCapable" class="input_option">
<option value="0" <% nvram_match("wl_DLSCapable", "0","selected"); %>><#4096#></option>
<option value="1" <% nvram_match("wl_DLSCapable", "1","selected"); %>><#4095#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,21);"><#4135#></a></th>
<td>
<select name="wl_noisemitigation" class="input_option" onChange="">
<option value="0" <% nvram_match("wl_noisemitigation", "0","selected"); %>><#4096#></option>
<option value="1" <% nvram_match("wl_noisemitigation", "1","selected"); %>><#4095#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);"><#4188#></a></th>
<td>
<select name="traffic_5g" class="input_option">
<option value="1" <% nvram_match("traffic_5g", "1","selected"); %>><#4095#></option>
<option value="0" <% nvram_match("traffic_5g", "0","selected"); %>><#4096#></option>
</select>
</td>
</tr>
<tr id="wl_ampdu_mpdu_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,26);"><#4103#></a></th>
<td>
<select name="wl_ampdu_mpdu" class="input_option">
<option value="0" <% nvram_match("wl_ampdu_mpdu", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_ampdu_mpdu", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr id="wl_ack_ratio_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,27);"><#4101#></a></th>
<td>
<select name="wl_ack_ratio" class="input_option">
<option value="0" <% nvram_match("wl_ack_ratio", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_ack_ratio", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr>
<th id="turbo_qam_title"><a id="turbo_qam_hint" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,28);"><#4189#></a></th>
<td>
<select name="wl_turbo_qam" class="input_option">
<option value="0" <% nvram_match("wl_turbo_qam", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_turbo_qam", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr>
...
<option value="0" <% nvram_match("wl_turbo_qam_brcm_intop", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_turbo_qam_brcm_intop", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr id="wl_80211h_tr" style="display:none;">
<th><a class="hintstyle"><#4098#></a></th>
<td>
<select name="wl1_80211h" class="input_option">
<option value="0" <% nvram_match("wl1_80211h", "0","selected"); %>><#4096#></option>
<option value="1" <% nvram_match("wl1_80211h", "1","selected"); %>><#4095#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,32);"><#4112#></a></th>
<td>
<select name="wl_atf" class="input_option">
<option value="0" <% nvram_match("wl_atf", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_atf", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr id="wl_MU_MIMO_field" style="display:none">
<th><a class="hintstyle"><#4074#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_mumimo" class="input_option" onchange="handle_mimo(this.value)" disabled>
<option value="0" <% nvram_match("wl_mumimo", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_mumimo", "1","selected"); %> ><#4095#></option>
</select>
</div>
</td>
</tr>
<tr id="ofdma_field" style="display:none">
<th><a class="hintstyle"><#3013#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_ofdma" class="input_option">
<option value="0" <% nvram_match("wl_ofdma", "0","selected"); %>><#4096#></option>
...
<option value="0" <% nvram_match("wl_be_ofdma", "0","selected"); %>><#4096#></option>
...
<option value="0" <% nvram_match("wl_be_mumimo", "0","selected"); %>><#4096#></option>
...
<tr id="wl_txbf_field">
<th><a id="wl_txbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,24);"><#4136#></a></th>
<td>
<select name="wl_txbf" class="input_option" onchange="handle_beamforming(this.value)">
<option value="0" <% nvram_match("wl_txbf", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_txbf", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr id="wl_itxbf_field">
<th><a id="wl_itxbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,25);"><#4193#></a></th>
<td>
<select name="wl_itxbf" class="input_option" disabled>
<option value="0" <% nvram_match("wl_itxbf", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_itxbf", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("wl_ext_nss", "0","selected"); %>><#4096#></option>
<option value="2" <% nvram_match("wl_ext_nss", "2","selected"); %>>4x4@80MHz</option>
<option value="1" <% nvram_match("wl_ext_nss", "1","selected"); %>><#4095#></option>
</select>
</td>
</tr>
<tr id="wl_txPower_field">
<th><a id="wl_txPower_field_title" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 16);"><#4080#></a></th>
<td>
<div>
<table>
<tr>
...
<option value="0" <% nvram_match("wl_hwol", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("wl_hwol", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr id="region_tr" style="display:none" class="rept ew">
<th><a class="hintstyle"><#4179#></a></th>
