...
document.getElementById("loginMethod").innerHTML = "<#1079#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#1078#>";
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 6)?"<#1017#>":"<#983#>";
}
...
<span class="formfonttitle"><#497#> - <#498#><span id="clouddiskstr"> / <#1719#></span></span>
...
<div class="formfontdesc" style="margin-top: 10px;"><#3258#></div>
<div id="smbv1_hint" class="formfontdesc"><#1027#>&nbsp;<#3259#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,2);"><#3325#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,3);"><#3338#></a>
</th>
<td>
...
<option class="content_input_fd" value="0" <% nvram_match("usb_fs_ntfs_sparse", "0","selected"); %>><#4096#></option>
<option class="content_input_fd" value="1" <% nvram_match("usb_fs_ntfs_sparse", "1","selected"); %>><#4095#></option>
</select>
</td>
</tr>
</table>
