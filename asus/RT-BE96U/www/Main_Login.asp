...
if(flag == 3){
document.getElementById("error_status_field").innerHTML ="* <#2641#>";
}
else if(flag == 7){
...
<div class="div_td"><#300#></div>
</div>
<div class="prod_madelName"><#949#></div>
<div id="login_filed">
<div class="p1 title_gap"><#829#></div>
<div id="name_title_ie" style="display:none;margin:20px 0 -10px 78px;" class="p1 title_gap"><#3699#></div>
<div class="title_gap">
<input type="text" id="login_username" name="login_username" tabindex="1" class="form_input" maxlength="128" autocapitalize="off" autocomplete="off" placeholder="<#3699#>">
</div>
<div id="password_title_ie" style="display:none;margin:20px 0 -20px 78px;" class="p1 title_gap"><#2446#></div>
<div class="password_gap">
<input type="password" name="login_passwd" tabindex="2" class="form_input" maxlength="128" placeholder="<#2446#>" autocapitalize="off" autocomplete="off">
</div>
...
<div class="button" onclick="preLogin();"><#300#></div>
</div>
