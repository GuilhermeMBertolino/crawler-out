...
var msg = "";
msg = hint_str.replace("%1$@", "<#3961#>").replaceAll("%2$@", get_default_wan_name());
...
/*
var profile_name_parm = {"title":"<#3805#>", "type":"text", "id":"profile_name", "need_check":true};
$content_container.append(Get_Component_Input(profile_name_parm));
*/
if(type == "user_defined")
var connection_type_options = [{"text":"<#257#>","value":"dhcp", "title":"DHCP"}, {"text":"<#258#>","value":"static"},
{"text":"PPPoE","value":"pppoe"}, {"text":"Bridge","value":"bridge"}];
else{
var connection_type_options = [{"text":"<#257#>","value":"dhcp"}, {"text":"<#258#>","value":"static"},
{"text":"PPPoE","value":"pppoe"}, {"text":"PPTP","value":"pptp"}, {"text":"L2TP","value":"l2tp"}];
if(Softwire46_support){
connection_type_options.push({"text":"<#2597#>","value":"v6plus"});
if(ocnvc_support)
connection_type_options.push({"text":"<#2596#>","value":"ocnvc"});
}
}
var connection_type_parm = {"title": "<#455#>", "id": "wan_proto", "options": connection_type_options, "set_value": "dhcp"}
...
var wan_enabled_parm = {"title":"<#2004#>", "type":"switch", "id":"wan_enable"};
...
var nat_enabled_parm = {"title":"<#1997#>", "type":"switch", "id":"wan_nat_x", "openHint":"7_22", "container_id":"nat_enable_container"};
...
var upnp_enabled_parm = {"title":"<#1548#>", "type":"switch", "id":"wan_upnp_enable", "openHint":"7_23"};
...
if(wan_bonding_support){
var bond_wan_parm = {"title":"<#3961#>", "type":"switch", "id":"bond_wan"};
...
var dhcpfilter_enabled_parm = {"title":"<#1548#>", "type":"switch", "id":"wan_dhcpfilter_enable", "container_id":"dhcpfilter_enable_container"};
...
var dot1q_enabled_parm = {"title":"<#4095#>", "type":"switch", "id":"wan_dot1q"};
...
var vid_parm = {"title":"<#3960#> (2-4094)", "type":"text", "id":"wan_vid", "need_check":true, "maxlength":4};
...
$wan_ip_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#2538#>")));
var dhcp_enabled_parm = {"title":"<#2759#>", "type":"switch", "id":"wan_dhcpenable_x", "container_id":"dhcp_enabled_container"};
...
var ip_parm = {"title":"<#386#>", "type":"text", "id":"wan_ipaddr_x", "need_check":true, "maxlength": 15, "openHint":"7_1"};
Get_Component_Input(ip_parm).appendTo($static_wanip_container)
.find("#" + ip_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var subnetmask_parm = {"title":"<#408#>", "type":"text", "id":"wan_netmask_x", "need_check":true, "maxlength": 15, "openHint":"7_2"};
Get_Component_Input(subnetmask_parm).appendTo($static_wanip_container)
.find("#" + subnetmask_parm.id)
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var gateway_parm = {"title":"<#406#>", "type":"text", "id":"wan_gateway_x", "need_check":true, "maxlength": 15, "openHint":"7_3"};
...
$dns_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#2572#>")));
var wandns_enabled_parm = {"title":"<#404#>", "type":"switch", "id":"wan_dnsenable_x", "openHint":"7_12", "container_id": "dnsenable_container"};
...
var dnsserver1_parm = {"title":"<#390#>", "type":"text", "id":"wan_dns1_x", "need_check":true, "maxlength": 15, "openHint":"7_13"};
Get_Component_Input(dnsserver1_parm).appendTo($dns_server_container)
.find("#" + dnsserver1_parm.id)
.unbind("keypress").keypress(function(){
return validator.isIPAddr(this, event);
});
var dnsserver2_parm = {"title":"<#392#>", "type":"text", "id":"wan_dns2_x", "need_check":true, "maxlength": 15, "openHint":"7_14"};
...
if(type == "internet"){
var dns_fwd_local_parm = {"title":"<#3917#>", "type":"switch", "id":"dns_fwd_local", "openHint":"7_42"};
...
var dns_norebind_parm = {"title":"<#3936#>", "type":"switch", "id":"dns_norebind", "openHint":"7_43"};
...
var dnssec_enabled_parm = {"title":"<#3938#>", "type":"switch", "id":"dnssec_enable", "openHint":"7_44"};
...
var dnssec_check_unsigned_parm = {"title":"<#3940#>", "type":"switch", "id":"dnssec_check_unsigned_x", "openHint":"7_45", "container_id":"dnssec_check_unsigned_container"};
...
if(type == "internet"){
var dns_priv_override_options = [{"text":"<#243#>","value":"0"}, {"text":"<#277#>","value":"1"}, {"text":"<#276#>","value":"2"}];
var dns_priv_override_parm = {"title":"<#3942#>", "id":"dns_priv_override", "options": dns_priv_override_options, "set_value": "0", "openHint":"7_46"};
Get_Component_Custom_Select(dns_priv_override_parm).appendTo($dns_container);
}
if(dnspriv_support && type == "internet"){
var dnspriv_options = [{"text":"<#954#>","value":"0"}, {"text":"DNS-over-TLS (DoT)","value":"1"}];
var dnspriv_parm = {"title":"<#3933#>", "id":"dnspriv_enable", "options": dnspriv_options, "set_value": "0", "openHint":"7_35"};
...
var dnspriv_profile_options = [{"text":"<#3923#>","value":"1"}, {"text":"<#3924#>","value":"0"}];
var dnspriv_profile_parm = {"title":"<#3921#>", "id":"dnspriv_profile", "options": dnspriv_profile_options, "set_value": "1", "openHint":"7_36", "container_id":"dnspriv_profile_container"};
...
$dhcp_option_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#2577#>")));
var wan_vendorid_parm = {"title":"<#1854#> (<#2983#> 60)", "type":"text", "id":"wan_vendorid", "need_check":true, "maxlength":126};
...
$("<div>").addClass("title").html(htmlEnDeCode.htmlEncode("<#1855#> (<#2983#> 61)")).appendTo($client_id_container);
...
$account_settings_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#584#>")));
var username_parm = {"title":"<#3699#>", "type":"text", "id":"wan_pppoe_username", "need_check":true, "maxlength":64, "openHint":"7_4"};
Get_Component_Input(username_parm).appendTo($account_settings_container)
.find("#" + username_parm.id)
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
});
var pwd_parm = {"title":"<#582#>", "type":"password", "id":"wan_pppoe_passwd", "need_check":true, "maxlength":64, "openHint":"7_5"};
Get_Component_Input(pwd_parm).appendTo($account_settings_container)
var ppp_auth_options = [{"text":"<#243#>","value":""}, {"text":"PAP","value":"pap"}, {"text":"CHAP","value":"chap"}];
var ppp_auth_parm = {"title": "<#892#>", "id": "wan_pppoe_auth", "options": ppp_auth_options, "set_value": ""}
$account_settings_container.append(Get_Component_Custom_Select(ppp_auth_parm));
var pppoe_idletime_parm = {"title":"<#3118#>", "type":"text", "id":"wan_pppoe_idletime", "need_check":true, "maxlength":10, "openHint":"7_6", "container_id": "idletime_container"};
...
var pppoe_mtu_parm = {"title":"<#3138#> (128 - 1492)", "type":"text", "id":"wan_pppoe_mtu", "need_check":true, "maxlength":5, "openHint":"7_7"};
...
var pppoe_mru_parm = {"title":"<#3136#> (128 - 1492)", "type":"text", "id":"wan_pppoe_mru", "need_check":true, "maxlength":5, "openHint":"7_8"};
...
var pppoe_service_parm = {"title":"<#3144#>", "type":"text", "id":"wan_pppoe_service", "need_check":true, "maxlength":32, "openHint":"7_9"};
...
var pppoe_ac_parm = {"title":"<#3122#>", "type":"text", "id":"wan_pppoe_ac", "need_check":true, "maxlength":32, "openHint":"7_10"};
...
var pppoe_hostuniq_parm = {"title":"Host-Uniq (<#2425#>)", "type":"text", "id":"wan_pppoe_hostuniq", "need_check":true, "maxlength":256, "openHint":"7_18"};
...
var pptp_options = [{"text":"<#243#>","value":"0"}, {"text":"<#2996#>","value":"-mppc"}, {"text":"MPPE 40","value":"+mppe-40"}, {"text":"MPPE 128","value":"+mppe-128"}];
var pptp_option_parm = {"title": "<#3142#>", "id": "wan_pptp_options_x", "options": pptp_options, "set_value": "", "openHint":"7_17", "container_id":"pptp_option_container"}
$account_settings_container.append(Get_Component_Custom_Select(pptp_option_parm));
var ppp_echo_options = [{"text":"<#1629#>","value":"0"}, {"text":"PPP Echo","value":"1"}, {"text":"DNS Probe","value":"2"}];
var ppp_echo_parm = {"title": "<#3126#>", "id": "wan_ppp_echo", "options": ppp_echo_options, "set_value": "0", "openHint":"7_31"}
$account_settings_container.append(Get_Component_Custom_Select(ppp_echo_parm));
var echo_interval_parm = {"title":"<#3129#>", "type":"text", "id":"wan_ppp_echo_interval", "need_check":true, "maxlength":6, "openHint":"7_32"};
Get_Component_Input(echo_interval_parm).appendTo($account_settings_container)
.find("#" + echo_interval_parm.id)
.unbind("keypress").keypress(function(){
return validator.isNumber(this, event);
});
var echo_fail_parm = {"title":"<#3131#>", "type":"text", "id":"dns_delay_round", "need_check":true, "maxlength":6, "openHint":"7_34"};
Get_Component_Input(echo_fail_parm).appendTo($account_settings_container)
.find("#" + echo_fail_parm.id)
.unbind("keypress").keypress(function(){
return validator.isNumber(this, event);
});
var pppoe_options_parm = {"title":"<#3124#>", "type":"text", "id":"wan_pppoe_options_x", "need_check":true, "maxlength":255, "openHint":"7_18"};
...
$special_isp_container.append($("<div>").addClass("profile_title_item").append($("<span>").html("<#586#>")));
var vpndhcp_parm = {"title":"<#3145#>", "type":"switch", "id":"wan_vpndhcp", "container_id":"vpndhcp_container"};
...
var vpn_parm = {"title":"<#260#>", "type":"text", "id":"wan_heartbeat_x", "need_check":true, "maxlength":256, "openHint":"7_19", "container_id":"vpn_container"};
Get_Component_Input(vpn_parm).appendTo($special_isp_container)
.find("#" + vpn_parm.id + "")
.unbind("keypress").keypress(function(){
return validator.isString(this, event);
});
var host_name_parm = {"title":"<#3125#>", "type":"text", "id":"wan_hostname", "need_check":true, "maxlength":32, "openHint":"7_15"};
...
$("<a>").addClass("hintstyle").attr({"href":"javascript:void(0);"}).html(htmlEnDeCode.htmlEncode("<#3128#>")).unbind("click").click(function(){
openHint(7,16);
...
.html(htmlEnDeCode.htmlEncode("<#263#>"))
.click(function(){
$("#wan_hwaddr_x").val(login_mac_str());
applyData.wan_hwaddr_x = $("#wan_hwaddr_x").val();
})
.appendTo($mac_settings_container);
var wan_dhcp_qry_options = [{"text":"<#1852#>","value":"0"}, {"text":"<#1850#>","value":"1"}, {"text":"<#4324#>","value":"2"}];
var wan_dhcp_qry_parm = {"title": "<#1849#>", "id": "wan_dhcp_qry", "options": wan_dhcp_qry_options, "set_value": "1", "openHint":"7_30"}
Get_Component_Custom_Select(wan_dhcp_qry_parm).attr({"data-sec-option-id":"dhcp-only"}).appendTo($special_isp_container)
if(type == "internet"){
var ttl_inc_parm = {"title":"<#2021#>", "type":"switch", "id":"ttl_inc_enable", "set_value": "off"};
...
var ttl_spoof_parm = {"title":"<#3398#>", "type":"switch", "id":"ttl_spoof_enable", "set_value": "off"};
...
var wan_mtu_parm = {"title":"<#3138#> (1280-1500)", "type":"text", "id":"wan_mtu", "need_check":true, "maxlength":4};
...
var $btn_container_delete_mobile = $("<div>").addClass("btn_container delete mobile").appendTo($action_container).html("<#1767#>");
var $btn_container_apply = $("<div>").addClass("btn_container apply").attr({"id":"apply_btn"}).appendTo($action_container).html("<#287#>");
...
var var_item0 = new Option("<#257#>", "dhcp");
var var_item1 = new Option("<#258#>", "static");
...
if(Softwire46_support){
var var_item5 = new Option("<#2597#>", "v6plus");
document.form.wan_proto.options.add(var_item5);
if(ocnvc_support){
var var_item6 = new Option("<#2596#>", "ocnvc");
...
if (MSWANList[i][2]=="1") cell[1].innerHTML = "<center><#277#></center>";
else cell[1].innerHTML = "<center><#276#></center>";
...
else if (MSWANList[i][1]=="dhcp") cell[3].innerHTML = "<center><#257#></center>";
else if (MSWANList[i][1]=="bridge") cell[3].innerHTML = "<center>Bridge</center>";
else if (MSWANList[i][1]=="static") cell[3].innerHTML = "<center><#258#></center>";
...
else if (MSWANList[i][1]=="v6plus") cell[3].innerHTML = "<center><#2597#></center>";
else if (MSWANList[i][1]=="ocnvc") cell[3].innerHTML = "<center><#2596#></center>";
...
$("#dotPresets").children().remove().end().append("<option value='-1'><#828#></option>");
...
document.form.wan_unit_x.options[i] = new Option(port_name, wan_port_unit);
if(load_wan_unit == wan_port_unit){
document.form.wan_unit_x.selectedIndex = i;
}
break;
}
}
...
document.form.wan_unit_x.options[i] = new Option("10G base-T", i);
else if(wans_dualwan_NAME == "SFP+")
document.form.wan_unit_x.options[i] = new Option("10G SFP+", i);
} else if (based_modelid == "TUF-AX4200" || based_modelid == "TUF-AX6000") {
if (wans_dualwan_NAME == "WAN")
document.form.wan_unit_x.options[i] = new Option("2.5G WAN", i);
}
}
...
{
document.getElementById("WANscap").style.display = "none";
document.form.wan_unit_x.value = 0; //avoid wan_unit=1 case
}
}
}
...
var msg_iptv = "<#3967#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(cur_wanports_bond));
}
else{
...
document.getElementById("check_mac").innerHTML="<#448#>";
return false;
}else if(flag ==2){
var childsel=document.createElement("div");
childsel.setAttribute("id","check_mac");
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac").innerHTML="<#409#>";
return false;
}else{
...
code +='<tr><td style="color:#FFCC00;" colspan="5"><#2558#></td></tr>';
else{
...
function update_map(){
var msg = stringSafeGet("<#2806#>")+" <#1103#>";
if(confirm(msg)){
$.ajax({
url: "/s46reset.cgi",
success: function( response ) {
...
var aftrArray = [
["<#2613#> (dgw.xpass.jp)", "dgw.xpass.jp"], ["transix (gw.transix.jp)", "gw.transix.jp"]
];
...
document.getElementById("wan_s46_dslite_svc_span").innerHTML = (s46_dslite_svc_str=="xpass")? "<#2613#>":s46_dslite_svc_str;
}
setTimeout("update_info();", 1500);
}
}
...
var DNSListTableCategory=["<#399#>", "<#400#>", "<#401#>", "Safe", "<#402#>"];
var code="";
code += "<div style='margin-top:15px;margin-left:15px;float:left;font-size:15px;color:#93A9B1;'><#398#></div>";
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='4'><#1769#>";
code += "</td></tr></thead>";
code += "<tr id='tr_default_title' height='40px'>";
code += "<th width='5%'></th>";
code += "<th width='15%'><#717#></th>";
code += "<th width='80%'><#2437#></th></tr>";
code += "<tr id='tr_auto_option' height='40px'>";
code += "<td><input name='DNS_service_opt' id='dns_auto' type='radio' class='input'></td>";
code += "<td>ISP</td>";
code += "<td style='padding:10px;text-align:left;'><#388#></td></tr>";
code += "</table>";
code += "</td></tr>";
...
code += "<th width='5%'></th>";
code += "<th width='15%'><#717#></th>";
code += "<th width='15%'><#2437#></th>";
code += "<th width='65%'><#1833#></th></tr>";
...
var description_temp = "<a href='"+DNSService[idx].url+"' target='_blank' style='text-decoration:underline;'> <b><#2766#></b></a>";
...
code += "<tr><td>";
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='4'><#473#>";
code += "</td></tr></thead>";
...
code += "<input id='button_dns_cancel' class='button_gen' type='button' onclick='closeDNSListView()' value='<#289#>'>";
code += "<input id='button_dns_ok' class='button_gen' type='button' onclick='Update_DNS_service()' style='margin-left:15px;' value='<#1784#>'>";
code += "</div>";
...
DSN_status_info="<b>Default status :</b> <#388#>";
}
else{
DNS_list_index=DNSList_match(document.form.wan_dns1_x.value, document.form.wan_dns2_x.value);
if(DNS_list_index >= 0){
DSN_status_info = "<b><#337#>:</b> "+DNSService[DNS_list_index].FilterMode; /* Untranslated */
DSN_status_info += "<br><b><#1620#>:</b> "+DNSService[DNS_list_index].DNSService; /* Untranslated */
DSN_status_info += "<br><b><#588#>:</b> "+document.form.wan_dns1_x.value+", "+document.form.wan_dns2_x.value; /* Untranslated */
}
else{
DSN_status_info = "<b><#588#>:</b> "+document.form.wan_dns1_x.value; /* Untranslated */
...
<input class="button_gen" type="button" value="<#289#>" onclick="close_autowan_hint();">
<input class="button_gen" type="button" value="<#1783#>" onclick="confirm_autowan_change();">
</div>
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#491#> - <#492#></div>
<div style="margin: 10px 0 10px 5px;" class="splitLine"></div>
<div id="desc_default" class="formfontdesc"><#1935#></div>
<div id="desc_edit" class="formfontdesc"><#2758#></div>
...
<th style="width:20%;"><center><#2551#></center></th>
<th style="width:10%;"><center><#2476#></center></th>
<th style="width:10%;"><center><#3177#></center></th>
<th style="width:10%;" id="MS_WAN_add_del"><center><#1767#></center></th>
</tr>
</table>
<table id="t2BC" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<thead>
<tr>
<td colspan="2">Internet Settings</td></tr>
</thead>
<tr>
<th>Profile</th>
...
<option value="dhcp" <% nvram_match("wan_proto", "dhcp", "selected"); %>><#257#></option>
<option value="static" <% nvram_match("wan_proto", "static", "selected"); %>><#258#></option>
...
<div id="s46reset_btn" style="margin-left: 5px;"><input type="button" class="button_gen" onclick="update_map();" value="<#2805#>"></div>
...
<th><#2004#></th>
<td>
<input type="radio" name="wan_enable" class="input" value="1" <% nvram_match("wan_enable", "1", "checked"); %>><#277#>
<input type="radio" name="wan_enable" class="input" value="0" <% nvram_match("wan_enable", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,22);"><#1997#></a></th>
<td>
<input type="radio" name="wan_nat_x" class="input" value="1" <% nvram_match("wan_nat_x", "1", "checked"); %>><#277#>
<input type="radio" name="wan_nat_x" class="input" value="0" <% nvram_match("wan_nat_x", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,23);"><#1548#></a></th>
<td>
<input type="radio" name="wan_upnp_enable" class="input" value="1" onclick="return change_common_radio(this, 'LANHostConfig', 'wan_upnp_enable', '1')" <% nvram_match("wan_upnp_enable", "1", "checked"); %>><#277#>
<input type="radio" name="wan_upnp_enable" class="input" value="0" onclick="return change_common_radio(this, 'LANHostConfig', 'wan_upnp_enable', '0')" <% nvram_match("wan_upnp_enable", "0", "checked"); %>><#276#>
</td>
</tr>
<tr style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#1548#></a></th>
<td>
<input type="radio" name="wan_dhcpfilter_enable" class="input" value="1" <% nvram_match("wan_dhcpfilter_enable", "1", "checked"); %>><#277#>
<input type="radio" name="wan_dhcpfilter_enable" class="input" value="0" <% nvram_match("wan_dhcpfilter_enable", "0", "checked"); %>><#276#>
</td>
</tr>
<tr style="display:none;">
<th><#3963#></th>
<td>
<input type="radio" name="bond_wan_radio" class="input" value="1" onclick="return change_common_radio(this, 'LANHostConfig', 'bond_wan', '1')" <% nvram_match("bond_wan", "1", "checked"); %>><#277#>
<input type="radio" name="bond_wan_radio" class="input" value="0" onclick="return change_common_radio(this, 'LANHostConfig', 'bond_wan', '0')" <% nvram_match("bond_wan", "0", "checked"); %>><#276#>
<div id="wanAgg_desc" style="color:#FFCC00;"><#3962#></div>
...
<th><#4095#></th>
<td>
<input type="radio" name="wan_dot1q" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'wan_dot1q', 1);" <% nvram_match("wan_dot1q", "1", "checked"); %>><#277#>
<input type="radio" name="wan_dot1q" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'wan_dot1q', 0);" <% nvram_match("wan_dot1q", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th>VLAN ID</th>
...
<th><#2759#></th>
<td>
<input type="radio" name="wan_dhcpenable_x" class="input" value="1" onclick="change_wan_dhcp_enable(0);" <% nvram_match("wan_dhcpenable_x", "1", "checked"); %>><#277#>
<input type="radio" name="wan_dhcpenable_x" class="input" value="0" onclick="change_wan_dhcp_enable(0);" <% nvram_match("wan_dhcpenable_x", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,1);"><#386#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,2);"><#408#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,3);"><#406#></a></th>
<td>
...
<option value="0" <% nvram_match("wan_s46_dslite_mode", "0", "selected"); %>><#784#></option>
<option value="1" <% nvram_match("wan_s46_dslite_mode", "1", "selected"); %>><#2792#></option>
</td>
</tr>
...
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullaftrList(this);" title="<#3291#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<th><#2759#></th>
<td>
<input type="radio" name="wan_s46_dhcpenable_x" class="input" value="1" onclick="change_wan_dhcp_enable(0);" <% nvram_match("wan_dhcpenable_x", "1", "checked"); %>><#277#>
<input type="radio" name="wan_s46_dhcpenable_x" class="input" value="0" onclick="change_wan_dhcp_enable(0);" <% nvram_match("wan_dhcpenable_x", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
...
<a id="s46_ipaddr_hint" class="hintstyle" href="javascript:void(0);" onClick="openHint(7,1);" style="display:none"><#386#></a>
</th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2579#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2601#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,12);"><#588#></a></th>
<td>
<div id="DNS_status"></div>
<div id="DNS_Assign_splitLine" style="margin:10px 0 5px 0;"></div>
<div id="DNS_Assign_desc"><#1906#></div>
<div id="DNS_Assign_button" style="text-align:right;"><input id="assign_button" type="button" class="button_gen" onclick="Assign_DNS_service()" value="<#288#>"></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,42);"><#3917#></a></th>
<td>
<input type="radio" value="1" name="dns_fwd_local" <% nvram_match("dns_fwd_local", "1", "checked"); %> /><#277#>
<input type="radio" value="0" name="dns_fwd_local" <% nvram_match("dns_fwd_local", "0", "checked"); %> /><#276#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,43);"><#3936#></a></th>
<td>
<input type="radio" value="1" name="dns_norebind" <% nvram_match("dns_norebind", "1", "checked"); %> /><#277#>
<input type="radio" value="0" name="dns_norebind" <% nvram_match("dns_norebind", "0", "checked"); %> /><#276#>
</td>
</tr>
<tr id="dnssec_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,44);"><#3938#></a></th>
<td>
<input type="radio" value="1" name="dnssec_enable" onclick="showhide('dnssec_strict_tr',1);" <% nvram_match("dnssec_enable", "1", "checked"); %> /><#277#>
<input type="radio" value="0" name="dnssec_enable" onclick="showhide('dnssec_strict_tr',0);" <% nvram_match("dnssec_enable", "0", "checked"); %> /><#276#>
</td>
</tr>
<tr id="dnssec_strict_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,45);"><#3940#></a></th>
<td>
<input type="radio" value="1" name="dnssec_check_unsigned_x" <% nvram_match("dnssec_check_unsigned_x", "1", "checked"); %> /><#277#>
<input type="radio" value="0" name="dnssec_check_unsigned_x" <% nvram_match("dnssec_check_unsigned_x", "0", "checked"); %> /><#276#>
</td>
</tr>
<tr id="dns_priv_override_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,46);"><#3942#></a></th>
<td>
<select id="dns_priv_override" class="input_option" name="dns_priv_override">
<option value="0" <% nvram_match("dns_priv_override", "0", "selected"); %>><#243#></option>
<option value="1" <% nvram_match("dns_priv_override", "1", "selected"); %>><#277#></option>
<option value="2" <% nvram_match("dns_priv_override", "2", "selected"); %>><#276#></option>
</select>
</td>
</tr>
<tr style="display:none">
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,35);"><#3933#></a>
</th>
<td align="left">
<select id="dnspriv_enable" class="input_option" name="dnspriv_enable" onChange="change_dnspriv_enable(this.value);">
<option value="0" <% nvram_match("dnspriv_enable", "0", "selected"); %>><#954#></option>
...
<tr style="display:none">
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,36);"><#3921#></a>
</th>
<td>
<input type="radio" name="dnspriv_profile" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'dnspriv_profile', 1)" <% nvram_match("dnspriv_profile", "1", "checked"); %> /><#3923#>
<input type="radio" name="dnspriv_profile" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'dnspriv_profile', 0)" <% nvram_match("dnspriv_profile", "0", "checked"); %> /><#3924#>
</td>
</tr>
<tr style="display:none" id="dot_presets_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,41);"><div class="table_text"><#3919#></a></th>
<td>
...
<thead>
<tr>
<td colspan="5"><#3925#>&nbsp;(<#2776#>&nbsp;8)</td>
</tr>
</thead>
<tr>
<th><a href="javascript:void(0);" onClick="openHint(7,37);"><div class="table_text"><div class="table_text"><#386#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,38);"><div class="table_text"><div class="table_text"><#3927#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,39);"><div class="table_text"><div class="table_text"><#3929#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(7,40);"><div class="table_text"><div class="table_text"><#3931#></div></a></th>
<th><#2775#></th>
</tr>
<tr>
...
<thead>
<tr><td colspan="2"><#2577#></td></tr>
</thead>
<tr>
<th width="40%"><#1854#> (<#2983#> 60):</th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,29);"><#3114#></a>
</th>
<td align="left">
<select class="input_option" name="wan_auth_x" onChange="change_wan_type(document.form.wan_proto.value);">
<option value="" <% nvram_match("wan_auth_x", "", "selected"); %>><#954#></option>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,4);"><#3699#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,5);"><#582#></a>
</th>
<td>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd);"><#718#></div>
</td>
</tr>
<tr style="display:none">
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#892#></a>
</th>
<td>
<select class="input_option" name="wan_pppoe_auth">
<option value="" <% nvram_match("wan_pppoe_auth", "", "selected"); %>><#243#></option>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#3118#></a>
</th>
<td>
<input type="text" maxlength="10" class="input_12_table" name="wan_pppoe_idletime" value="<% nvram_get("wan_pppoe_idletime"); %>" onkeypress="return validator.isNumber(this,event)" autocorrect="off" autocapitalize="off"/>&nbsp<#3279#>
<input type="checkbox" style="margin-left:30;display:none;" name="wan_pppoe_idletime_check" value="" />
</td>
</tr>
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,7);"><#3138#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,8);"><#3136#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,9);"><#3144#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,10);"><#3122#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);">Host-Uniq (<#2425#>)</a>
</th>
<td align="left">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,17);"><#3142#></a>
</th>
<td>
<select name="wan_pptp_options_x" class="input_option">
<option value="" <% nvram_match("wan_pptp_options_x", "","selected"); %>><#243#></option>
<option value="-mppc" <% nvram_match("wan_pptp_options_x", "-mppc","selected"); %>><#2996#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,31);"><#3126#></a></th>
<td>
<select name="wan_ppp_echo" class="input_option" onChange="ppp_echo_control();">
<option value="0" <% nvram_match("wan_ppp_echo", "0","selected"); %>><#1629#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,32);"><#3129#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,33);"><#3131#></a></th>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);"><#3124#></a>
</th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,19);"><#260#></a></th>
<td>
...
<tr id="vpn_dhcp">
<th><#3145#></th>
<td><input type="radio" name="wan_vpndhcp" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'wan_vpndhcp', 1)" <% nvram_match("wan_vpndhcp", "1", "checked"); %> /><#277#>
<input type="radio" name="wan_vpndhcp" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'wan_vpndhcp', 0)" <% nvram_match("wan_vpndhcp", "0", "checked"); %> /><#276#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,15);"><#3125#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,16);"><#3128#></a></th>
<td>
...
<input type="button" class="btn_subusage my-1 button_gen" style="margin-top: 5px;" onclick="showMAC();" value="<#263#>">
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,30);"><#1849#></a></th>
<td>
<select name="wan_dhcp_qry" class="input_option">
<option value="0" <% nvram_match("wan_dhcp_qry", "0","selected"); %>><#1852#></option>
<option value="1" <% nvram_match("wan_dhcp_qry", "1","selected"); %>><#1850#></option>
<option value="2" <% nvram_match("wan_dhcp_qry", "2","selected"); %>><#4324#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2021#></a></th>
<td>
<input type="radio" name="ttl_inc_enable" class="input" value="1" <% nvram_match("ttl_inc_enable", "1", "checked"); %>><#277#>
<input type="radio" name="ttl_inc_enable" class="input" value="0" <% nvram_match("ttl_inc_enable", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#3398#></a></th>
<td>
<input type="radio" name="ttl_spoof_enable" class="input" value="1" <% nvram_match("ttl_spoof_enable", "1", "checked"); %>><#277#>
<input type="radio" name="ttl_spoof_enable" class="input" value="0" <% nvram_match("ttl_spoof_enable", "0", "checked"); %>><#276#>
</td>
</tr>
<tr>
<th>
...
<input class="actionButtonCancel button_gen" onclick="exit_to_main();" type="button" value="<#289#>">
<input class="button_gen" onclick="applyRule();" type="button" value="<#1783#>"/>
</div>
</td>
</tr>
</tbody>
