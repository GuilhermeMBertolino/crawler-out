...
var $ok = $("<div>").addClass("ok btn").html("<#1783#>");
...
$("<div>").attr({"data-btn":"ok"}).addClass("ok btn").html("<#1783#>")
.unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_customize_alert();
}).appendTo($action_btn_container);
$("<div>").attr({"data-btn":"cancel"}).addClass("cancel btn").html("<#289#>")
.unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
close_popup_customize_alert();
...
var $desc = $("<div>").addClass("desc").html("<#4392#>");
$desc.appendTo($del_profile);
var $action_btn_container = $("<div>").addClass("action_btn_container");
$action_btn_container.appendTo($del_profile);
var $del = $("<div>").attr({"data-btn":"del"}).addClass("del btn").html("<#1767#>");
$del.appendTo($action_btn_container);
var $cancel = $("<div>").addClass("cancel btn").html("<#289#>");
