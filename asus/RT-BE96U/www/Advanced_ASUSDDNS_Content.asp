...
$("#deregister_btn").click(function(){
if(orig_le_enable != "0"){
var confirm_msg = stringSafeGet("<#2706#>");
...
if(ddns_server_x == "WWW.ASUS.COM"){
document.getElementById("ddns_status").innerHTML = "<#832#>";
if(ddnsStatus != "")
...
show_alert_block("<#2689#> '" + s.charAt(i) +"' !");
return false;
}
}
return true;
...
document.getElementById("le_desc").innerHTML = "<#2733#>";
...
case "2":
document.getElementById("cert_desc").style.display = "none";
html_code += '<div style="display:table-cell"><input class="btn_subusage button_gen" onclick="open_upload_window();" type="button" value="<#1793#>"/><img id="loadingicon" style="margin-left:5px;display:none;" src="/images/InternetScan.gif"></div>';
document.getElementById("cert_act").innerHTML = html_code;
document.getElementById("cert_act").style.display = "";
document.getElementById("CAcert_details").style.display = "";
document.getElementById("cert_details").style.display = "";
...
document.getElementById("cert_status").innerHTML = "<#3774#>";
else
document.getElementById("cert_status").innerHTML = "<#3651#>";
setTimeout("get_cert_info();", 1000);
}
else{
document.getElementById("cert_status").innerHTML = "<#831#>";
...
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=168"><#2714#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=169"><#2715#></a></div>'+
'<div class="text-list"><div class="icon-circle-mask"><i class="icon-comments"></i></div><a target="_blank" href="https://nw-dlcdnet.asus.com/support/forward.html?model=&type=Faq&lang='+ui_lang+'&kw=&num=170"><#2716#></a></div>'
...
<div class="formfontdesc hint-color" id="wan_ip_hide2" style="color:#FC0; display:none;"><#2713#><#2711#></div>
<div class="formfontdesc hint-color" id="lb_note" style="color:#FC0; display:none;"><#2762#></div>
...
<div style="color:#FFCC00">*<#2717#></div>
</td>
</tr>
<tr>
<th id="ddns_wan_unit_th"><#3905#></th>
...
<option class="content_input_fd" value="0" <% nvram_match("ddns_wan_unit", "0","selected"); %>><#1982#></option>
<option class="content_input_fd" value="1"<% nvram_match("ddns_wan_unit", "1","selected"); %>><#1989#></option>
</select>
</td>
</tr>
<tr id="ddns_ipv6update_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,18);"><#1820#></a></th>
<td>
...
<a id="link" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#2725#></a>
<a id="linkToHome" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1809#></a>
</td>
</tr>
<tr id="ddns_hostname_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#2721#></a></th>
<td>
...
<th><#1826#></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="ddns_regular_period" value="<% nvram_get("ddns_regular_period"); %>" autocorrect="off" autocapitalize="off"> <#2826#>
</td>
</tr>
<tr style="display:none;">
<th><#2728#></th>
...
<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#2726#>" /></td>
</tr>
...
<input type="radio" value="1" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "1", "checked"); %>><#1812#>
</span>
<input type="radio" value="2" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "2", "checked"); %>><#1814#>
...
<div class="cert_status_title"><#3783#> :</div>
<div id="CAissueTo" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3782#> :</div>
<div id="CAissueBy" class="cert_status_val"></div>
</div>
<div style="display: flex;">
<div class="cert_status_title"><#3781#> :</div>
...
<td>
<div style="display: flex;">
<div class="cert_status_title"><#834#> :</div>
...
<div>
<input class="button_gen" onclick="save_cert_key();" type="button" value="<#1632#>" />
</div>
</td>
</tr>
</table>
...
<div class="formfonttitle" style="margin-top: 15px; margin-left: 15px;"><#1814#></div>
<div class="formfontdesc" style="margin: 15px;"><#1815#></div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1816#> :</div>
<div style="display:table-cell;"><input type="file" name="file_key" class="input Upload_file"></div>
</div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1822#> :</div>
<div style="display:table-cell;"><input type="file" name="file_cert" class="input Upload_file"></div>
</div>
<div style="color: #FC0; margin-left: 15px; margin-top: 20px">* <#1817#></div>
...
<div style=""><input class="button_gen" type="button" onclick="upload_cert_key();" id="applyBtn" value="<#1783#>"></div>
</div>
</div>
</form>
</body>
