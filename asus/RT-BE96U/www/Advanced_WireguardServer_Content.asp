...
<title><#948#> - WireGuard Server</title>
...
<td>
<input class="button_gen" type="button" value="<#1632#>" onClick="exportConfig();"/>
...
<div class="apply_gen">
<input type="button" onClick="location.reload();" value="<#1786#>" class="button_gen">
</div>
</td>
</tr>
</table>
