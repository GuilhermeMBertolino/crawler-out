...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1808#> ";
if (Hours != 0)
value += Hours.toString() + " <#2429#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2826#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#3279#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
if(gobi_support){
pri_if = (pri_if == "USB")? "<#2910#>" : pri_if;
sec_if = (sec_if == "USB")? "<#2910#>": sec_if;
if((unit == "0" && pri_if == "<#2910#>") || (unit == "1" && sec_if == "<#2910#>"))
$("#wan_enable_title").text("<#2830#>");
}
...
showtext(document.getElementById("dualwan_mode"), "<#1966#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1965#>");
...
if(lanproto == "static")
showtext(document.getElementById("LanProto"), "<#258#>");
else
showtext(document.getElementById("LanProto"), "<#257#>");
...
wanlink_type_conv = "<#257#>";
else if(wanlink_type_conv == "static")
wanlink_type_conv = "<#258#>";
...
$("#ipv6_DNS_servers").prop('title', `<#2587#>`);
...
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;" id="wan_enable_title"><#492#></div>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<div style="display:flex; align-items:center; justify-content:space-between;">
<div class="formfonttitle_nwm" style="width:80%; margin-bottom: 0px;"><#1948#></div>
...
<p class="formfonttitle_nwm"><#3947#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3945#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1964#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1967#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" ><#282#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3907#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#408#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#4233#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3235#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2674#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2767#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#315#></p>
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1633#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1637#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1633#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
</table>
...
<p class="formfonttitle_nwm"><#846#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2657#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#406#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2437#></p>
...
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#704#>" style="float:right;margin: 5px 0;">
</td>
</tr>
</table>
</form>
