...
html += "<div class='aimesh_node_setting_info_title'><#4407#></div>";
...
case "ctrl_led" :
html += "<div style='margin-top:10px;'>";
html += "<div class='aimesh_node_setting_info_title'><#4434#></div>";
html += "<div class='aimesh_node_setting_info_content'>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2558#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
parent.$("#amesh_connect_msg").find(".amesh_hint_text.amesh_hint_title").html("<#1145#>");
}
});
});
}
...
code += "</div>";
code += "<div class='amesh_router_info_text'><#2255#>: ";
var re_client_num = 0;
...
code += "<div class='amesh_title offline' onclick='show_offline_msg(event);'><#1657#></div>";
}
code += "</div>";
code += "</div>";
code += "</div>";
...
$amesh_cancel.attr({"type" : "button", "value" : "<#1783#>"});
...
$amesh_wait_search_text.html("<#1138#>");
...
$amesh_wpa3_text.append($("<div>").html("<#1119#>"));
...
$aimesh_illustration_bg.append(gen_text("<#1216#>", "backhaul_router"));
$aimesh_illustration_bg.append(gen_text("<#1144#>", "backhaul_node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1144#>", "backhaul_node for_dsl"));
}
...
result_text += "<#1128#>";
result_text += "<div style='margin-left: 20px;'>1. <#1129#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1130#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1131#></div>";
result_text += "<div style='margin-left: 20px;'>4. <#1132#></div>";
}
if(ameshRouter_support && ameshNode_support)
result_text += "b. ";
if(ameshNode_support){
result_text += "<#1133#>";
result_text += "<div style='margin-left: 20px;'>1. <#1134#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#1135#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#1136#></div>";
}
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
$aimesh_illustration_bg.append(gen_text("Modem", "modem"));
$aimesh_illustration_bg.append(gen_text("<#1216#>", "router"));
$aimesh_illustration_bg.append(gen_text("<#1144#>", "node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#1144#>", "node for_dsl"));
}
var $amesh_clear_bg = $('<div>');
$amesh_clear_bg.css("clear", "both");
$aimesh_illustration_bg.append($amesh_clear_bg);
...
$amesh_apply.attr({"type" : "button", "value" : "<#1783#>"});
$amesh_action_bg.append($amesh_apply);
$amesh_apply.click(
function() {
initial_amesh_obj();
...
hint += "<#1289#>";
hint += "<br>";
hint += "<#1290#> <#1291#>".replace("#RE_MAXNUM", cfg_re_maxnum);
hint += "<br>";
hint += "<#1292#>";
...
code += "<div class='aimesh_node_static_info_title'><#1180#></div>";
...
code += "<div class='aimesh_node_setting_info_title'><#1166#></div>";
...
code += "<option value='2' class='aimesh_node_input_select_option'><#1156#></option>";
code += "</select>";
code += "<div id='aimesh_node_connection_priority_hint' class='aimesh_node_setting_info_content'><#1782#></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
...
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#2264#></div>";
...
code += "<th class='IE8HACK' width=" + aimesh_node_client_info_width[0] + "><#1647#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#3042#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3730#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3905#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2934#>");
...
block_chars_hint = block_chars_array[i] + " <#2631#>";
}
if(block_chars_hint != "") {
...
function() {
if(node_info.online == "1" && re_path > 0) {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1766#>" : "<#2934#>";
...
var led_table = ["<#1766#>", "<#2788#>", "<#2812#>", "<#2426#>"];
...
$amesh_close.attr({"type" : "button", "value" : "<#1766#>"});
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2558#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#4406#>" : nodeClientObj.ip;
...
option_array.push(gen_option_attr("3", ((_eap_flag) ? "<#243#> (<#1161#>)" : "<#243#>"), "auto"));
...
var option_text = (_eap_flag) ? "<#1171#>" : "<#1170#>";
...
option_array.push(gen_option_attr("2", ((_eap_flag) ? "<#1160#>" : "<#1156#>"), "eth"));
return option_array;
}
...
<tr>
<td colspan="2">
<div class="amesh_title"><#1123#></div>
<div class="amesh_title amesh_content"><#1126#></div>
</td>
</tr>
...
<tr>
<td width="50%">
<div class="amesh_title amesh_help" onclick="scenario();"><#1124#></div>
</td>
<td width="50%" height="32px;" style="text-align:center;">
<input id="searchReadyOnBoarding" type="button" class="button_gen" value="<#1790#>" onClick="searchReadyOnBoarding();">
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2558#></div></div>
</td>
</tr>
<tr>
</table>
