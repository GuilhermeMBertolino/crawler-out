...
loadXML();
document.getElementById('WPS_hideSSID_hint').innerHTML = "<#2272#> <#4223#>";
...
document.getElementById("wps_band_hint").innerHTML = "* <#4199#>";
return false;
}
...
if(wps_enable_old == "1"){
document.getElementById("wps_enable_word").innerHTML = "<#1631#>";
document.getElementById("enableWPSbtn").value = "<#1629#>";
...
document.getElementById("wps_enable_word").innerHTML = "<#1630#>"
document.getElementById("enableWPSbtn").value = "<#4095#>";
...
document.getElementById("wps_enable_hint").innerHTML = "* <#3003#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#1633#></a>"
controlDisplayItem();
return;
}
...
document.getElementById("wps_enable_hint").innerHTML = "<#4226#><br><#4227#> <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(" + htmlEnDeCode.htmlEncode(wps_infos[12].firstChild.nodeValue) + ");\"><#481#></a> <#4228#>"
controlDisplayItem();
return;
}
if(wps_enable_old == "0"){
document.getElementById("wps_state_tr").style.display = "";
document.getElementById("wps_state_td").innerHTML = "<#4225#>";
...
document.getElementById("wps_config_td").innerHTML = "<#1630#>";
else
document.getElementById("wps_config_td").innerHTML = "<#1631#>";
}
...
if(radio_2 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(0);\"><#1633#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a>"
}
if(radio_5 !== "1") {
band_link += " <a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_advanced_unit_status(1);\"><#1633#> " + get_band_str(wps_infos1[12].firstChild.nodeValue) + "</a>"
}
document.getElementById("wps_enable_hint").innerHTML = "* <#3003#>" + band_link + "";
...
if(rej0)
band_link += "<a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(0);\"><#481#> " + get_band_str(wps_infos0[12].firstChild.nodeValue) + "</a> ";
if(rej1)
band_link += "<a style='color:#FC0; text-decoration: underline; font-family:Lucida Console;cursor:pointer;' onclick=\"_change_wl_unit_status(1);\"><#481#> " + get_band_str(wps_infos1[12].firstChild.nodeValue) + "</a> ";
document.getElementById("wps_enable_hint").innerHTML = "<#4226#><br><#4227#> " + band_link + " <#4228#>";
if (rej0 && rej1){
document.getElementById("wps_state_tr").style.display = "none";
document.getElementById("devicePIN_tr").style.display = "none";
document.getElementById("wpsmethod_tr").style.display = "none";
...
document.getElementById("wps_state_td").innerHTML = "<#4225#> / <#4225#>";
document.getElementById("WPSConnTble").style.display = "none";
document.getElementById("wpsDesc").style.display = "none";
}
else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#480#> - <#482#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#4059#></div>
...
<tr>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(13,1);"><#4197#></a></th>
<td>
...
if( !SG_mode || (SG_mode && confirm(stringSafeGet("<#3004#>")))){
...
<tr id="wps_band_tr">
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,5);"><#1796#></th>
<td id="wps_switch">
<span class="devicepin" style="color:#FFF;" id="wps_band_word"></span>&nbsp;&nbsp;
<input type="button" class="button_gen" name="switchWPSbtn" id="switchWPSbtn" value="<#3433#>" class="button" onClick="SwitchBand();">
...
<td style="border:0px">
<input class="btn_subusage button_gen" type="button" onClick="resetWPS();" id="Reset_OOB" name="Reset_OOB" value="<#1787#>" style="padding:0 0.3em 0 0.3em;" >
<div id="Reset_OOB_desc"><#4182#></div>
</td>
</tr></table>
</div>
</td>
...
<tr id="devicePIN_tr">
<th>
<span id="devicePIN_name"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,4);"><#4127#></a></span>
</th>
<td>
...
<tr id="wpsmethod_tr">
<th>
<span id="wps_method"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,2);"><#4203#></a></span>
</th>
<td>
<label><input type="radio" name="wps_method" onclick="changemethod(0);" value="0"><#4198#></label>
<label><input type="radio" name="wps_method" onclick="changemethod(1);" value="1"><#4205#></label>
...
<div id="starBtn" style="margin-top:10px;"><input class="button_gen" type="button" style="margin-left:5px;" onClick="configCommand();" id="addEnrolleebtn_client" name="addEnrolleebtn" value="<#4224#>"></div>
