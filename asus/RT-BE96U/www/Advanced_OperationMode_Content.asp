...
"label" : {
"text" : (amesh_support && ameshRouter_support) ? "<#543#>" : "<#542#>"
},
"mode" : "1",
"express" : "0",
...
"label" : {
"text" : (amesh_support && ameshRouter_support) ? "<#537#>" : "<#536#>"
},
"mode" : "3",
"express" : "0",
"css_list" : {"margin":"0px 10px 5px 0px", "display":"block"}
...
function saveMode(){
let sdn_change_mode_hint = `<#1394#>, <#3896#>, <#260#>, and <#2038#> are not available. The profile list of ${Guest_Network_naming} will be cleared. Please reconfigure it. We recommend that you download and save the configuration file before switching to #OPMODE.\n<#3305#>`;
...
$("#Senario").css({"height": height, "background": "url(" + url + ") center no-repeat", "margin": "auto", "margin-bottom": "30px"});
/*if(findasus_support){
$("#mode_desc").html("<#533#><br/><span style=\"color:#FC0\"><#535#></span>");
}else{*/
var desc = "";
if(amesh_support && ameshRouter_support) {
desc += "<#534#>";
...
desc += "<#46#>";
desc += "<br>";
desc += "<span style=\"color:#FC0\"><#1846#></span>";
}
else
desc = "<#533#><br/><span style=\"color:#FC0\"><#1845#></span>";
$("#mode_desc").html(desc);
clearTimeout(id_WANunplungHint);
$("#Unplug-hint").css("display", "none");
...
pstaDesc += "<#550#>";
pstaDesc += "<br><#551#>";
pstaDesc += "<br/><span style=\"color:#FC0\"><#1847#></span>";
...
document.getElementById("wl0_desc_name").innerHTML = "2.4 GHz - <#825#>";
...
<input type="radio" value="1" id="smart_connect_t" name="smart_connect_t" class="input" onclick="return change_smart_con(this.value)" <% nvram_match("smart_connect_x", "1", "checked"); %>><#882#>
</td>
</tr>
<tr>
<td style="font-style:normal;font-size:13px;font-weight:bold;">
...
<tr>
<div class="description_down"><#815#></div>
</tr>
<tr>
<div class="QISGeneralFont" align="left"><#771#></div>
</tr>
<tr>
<div style="width: 640px; *width: 640px; height: 2px;margin:5px;*margin-left:-5px;" class="splitLine"></div>
</tr>
<tr>
<th width="180" id="wl0_desc_name">2.4GHz - <#825#></th>
<td class="QISformtd"></td>
</tr>
<tr>
<th width="180">
<span onmouseout="return nd();" onclick="openHint(0, 22);" style="cursor:help;"><#664#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span>
</th>
<td class="QISformtd">
...
<th width="180">
<span onmouseout="return nd();" onclick="openHint(0, 23);" style="cursor:help;"><#525#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span>
</th>
<td class="QISformtd">
...
<th id="wl_unit_field_1_1" width="180">5GHz - <#825#> </th>
<td class="QISformtd">
<input type="checkbox" id="sync_with_2ghz" name="sync_with_2ghz" class="input" onclick="setTimeout('Sync_2ghz(2);',0);" checked="checked"><span id="syncCheckbox"><#731#></span>
</td>
</tr>
...
<th id="5g2_title" width="180">5 GHz-2 - <#825#> </th>
<td class="QISformtd" id="wl_unit_field_4_2">
<input type="checkbox" id="sync_with_5ghz" name="sync_with_5ghz" tabindex="8" class="input" onclick="setTimeout('Sync_5ghz(2);',0);" checked="checked"><span id="syncCheckbox_5_2"><#731#></span>
</td>
</tr>
<tr id="wl_unit_field_5" style="display:none;">
<th width="180"><span onmouseout="return nd();" onclick="openHint(0, 22);" style="cursor:help;"><#664#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span></th>
<td class="QISformtd">
...
<th width="180"><span onmouseout="return nd();" onclick="openHint(0, 23);" style="cursor:help;"><#525#><img align="right" style="cursor:pointer;margin-top:-14px\9;" src="/images/New_ui/helpicon.png"></span></th>
<td class="QISformtd">
...
<tr>
<td colspan="2">
<div class="QISGeneralFont" ><#772#></div>
</td>
</tr>
</table>
<div style="margin-top:20px;text-align:center;background-color:#2B373B">
<input type="button" value="<#289#>" class="button_gen" onclick="cancel_SSID_Block();">
<input type="button" id="btn_next_step" value="<#286#>" class="button_gen" onclick="applyRule();">
</div>
</div>
...
<td>
<div>&nbsp;</div>
<div class="formfonttitle"><#508#> - <#510#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="op_title_desc"><#539#></div>
</td>
</tr>
...
<td>
<div id="Senario" >
<div id="Unplug-hint" style="border:2px solid red; background-color:#FFF; padding:3px;margin:0px 0px 0px 150px;width:250px; position:absolute; display:block; display:none;"><#935#></div>
</div>
<div class="apply_gen">
<input name="button" type="button" class="button_gen" onClick="saveMode();" value="<#1784#>">
</div>
</td>
</tr>
</table>
