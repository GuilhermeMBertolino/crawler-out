...
{url: "Captive_Portal_Advanced.asp", tabName: "<#4277#>"},
...
tab: [
{url: "AiProtection_HomeProtection.asp", tabName: "<#1347#>"},
{url: "AiProtection_MaliciousSitesBlocking.asp", tabName: "<#1391#>"},
{url: "AiProtection_IntrusionPreventionSystem.asp", tabName: "<#1411#>"},
{url: "AiProtection_InfectedDevicePreventBlock.asp", tabName: "<#1304#>"},
...
index: "menu_QoS",
tab: [
{url: "QoS_EZQoS.asp", tabName: "<#2819#>"},
{url: "Main_TrafficMonitor_realtime.asp", tabName: "<#880#>"},
...
{url: "Main_Spectrum_Content.asp", tabName: "<#3397#>"},
...
tab: [
{url: "AiProtection_WebProtector.asp", tabName: "<#1317#>"},
{url: "ParentalControl.asp", tabName: "<#3486#>"},
{url: "YandexDNS.asp", tabName: "<#4233#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
tab: [
{url: "AdaptiveQoS_Bandwidth_Monitor.asp", tabName: "<#1539#>"},
{url: "QoS_EZQoS.asp", tabName: "<#2819#>"},
{url: "AdaptiveQoS_WebHistory.asp", tabName: "<#999#>"},
{url: "AdaptiveQoS_ROG.asp", tabName: "<table style='margin-top:-7px;'><tr><td><img src='/images/ROG_Logo.png' style='border:0px;width:32px;'></td><td>ROG First</td></tr></table>"},
{url: "Main_Spectrum_Content.asp", tabName: "<#3397#>"},
{url: "Advanced_QOSUserPrio_Content.asp", tabName: "__INHERIT__"},
{url: "Advanced_QOSUserRules_Content.asp", tabName: "__INHERIT__"},
{url: "AdaptiveQoS_Adaptive.asp", tabName: "__INHERIT__"},
{url: "AdaptiveQoS_InternetSpeed.asp", tabName: "<#2481#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
tab: [
{url: "TrafficAnalyzer_Statistic.asp", tabName: "<#3408#>"},
{url: "Main_TrafficMonitor_realtime.asp", tabName: "<#880#>"},
{url: "Main_TrafficMonitor_last24.asp", tabName: "__INHERIT__"},
{url: "Main_TrafficMonitor_daily.asp", tabName: "__INHERIT__"},
{url: "AdaptiveQoS_TrafficLimiter.asp", tabName: "Traffic Limiter"},
...
tab: [
{url: "GameBoost.asp", tabName: "<#2285#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "mediaserver.asp", tabName: "<#884#>"},
{url: "Advanced_AiDisk_samba.asp", tabName: "<#498#>".concat(WebDav_support?" / <#1719#>":"")},
...
{url: "cloud_sync.asp", tabName: "<#3375#>"},
{url: "cloud_router_sync.asp", tabName: "<#3300#>"},
{url: "cloud_settings.asp", tabName: "<#3320#>"},
{url: "cloud_syslog.asp", tabName: "<#2783#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Advanced_WProxy_Content.asp", tabName: "<#3995#>"},
{url: "Advanced_Roaming_Block_Content.asp", tabName: "<#3998#>"},
...
{url: "Advanced_SwitchCtrl_Content.asp", tabName: "<#3434#>"},
...
{url: "Advanced_VPNClient_Content.asp", tabName: (vpn_fusion_support) ? "<#4372#>" : "<#3896#>"},
{url: "Advanced_TOR_Content.asp", tabName: "TOR"},
{url: "Advanced_Instant_Guard.asp", tabName: "<#4481#>"},
...
{url: "Advanced_PerformanceTuning_Content.asp", tabName: "<#2042#>"},
{url: "Advanced_ADSL_Content.asp", tabName: "<#475#>"},
{url: "Advanced_Feedback.asp", tabName: "<#2814#>"},
...
{url: "Advanced_Privacy.asp", tabName: "<#4404#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "Main_ConnStatus_Content.asp", tabName: "<#1743#>"},
...
tab: [
{url: "Main_Analysis_Content.asp", tabName: "<#2966#>"},
{url: "Main_Netstat_Content.asp", tabName: "Netstat"},
{url: "Main_WOL_Content.asp", tabName: "<#2988#>"},
{url: "Advanced_Smart_Connect.asp", tabName: "<#3368#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
}
],
...
if(menuTree.list[i].menuName == '<#1004#>'){
menuTree.list[i].menuName = '<#2819#>';
}
}
}
...
for(i=0; i<menuTree.list.length; i++){
if(menuTree.list[i].menuName == '<#2285#>'){
...
var index = -1;
for(i=0;i<menuTree.list.length;i++){
if(menuTree.list[i].menuName == '<#1394#>'){
...
menuTree.list[i].tab[j].tabName = '<#567#>';
break;
}
}
...
menuTree.list[i].tab[index] = {url: "Main_TrafficMonitor_realtime.asp", tabName: "<#880#>"};
...
else if(menuTree.list[i].menuName == '<#2819#>'){
var index = menuTree.list[i].tab.length-1;
menuTree.list[i].tab[index] = {url: "Main_TrafficMonitor_realtime.asp", tabName: "<#880#>"};
menuTree.list[i].tab.push({url: "Main_TrafficMonitor_last24.asp", tabName: "__INHERIT__"});
menuTree.list[i].tab.push({url: "Main_TrafficMonitor_daily.asp", tabName: "__INHERIT__"});
