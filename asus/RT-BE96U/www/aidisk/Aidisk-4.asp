...
case "0":
showtext(document.getElementById("dummyShareStr"), "\"<#3427#>\"");
break;
case "1":
showtext(document.getElementById("dummyShareStr"), "\"<#3428#>\"");
break;
case "2":
showtext(document.getElementById("dummyShareStr"), "\"<#3429#>\"");
break;
}
}
...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#3430#></td>
</tr>
<tr>
...
<input type="button" id="finish" value="<#1774#>" class="button_gen">
</div>
</td>
</tr>
</table>
