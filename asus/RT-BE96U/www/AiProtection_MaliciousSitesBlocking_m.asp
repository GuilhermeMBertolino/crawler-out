...
if(info_bar == ''){
$('#recountIcon').hide();
code += '<div class="no-data"><#1316#></div>';
}
else{
$('#recountIcon').show();
...
code += '<div class="table-cell"><#1881#></div>';
code += '<div class="table-cell"><#1314#></div>';
code += '<div class="table-cell"><#1313#></div>';
code += '<div class="table-cell"><#1312#></div>';
code += '</div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1314#>">'+ cat_id_array[cat_id_index].description +'</div>';
var _name = dataObj[eventID].source[0];
if(clientList[_name]){
_name = clientList[_name].name;
}
code += '<div class="table-cell" data-title="<#1313#>">'+ _name +'</div>';
code += '<div class="table-cell" data-title="<#1312#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '</div>';
}
}
else{
...
<div>
<div class="card-bg">
<div class="page-title"><#1391#></div>
<div class="split-Line"></div>
<div class="description-bar">
<div class="description-title"><#1833#></div>
<div class="description"><#1390#></div>
</div>
<div class="tm-logo">
...
<div class="event-hit"><#1383#></div>
</div>
<div class="card-lv1 card-lv1-bg">
<div class="flexbox flex-a-center flex-j-spaceB">
<div class="description"><#1409#></div>
...
<div class="page-title canvas-title"><#1298#></div>
</div>
<div class="canvas-bg">
<div class="chart-title"><#1383#></div>
