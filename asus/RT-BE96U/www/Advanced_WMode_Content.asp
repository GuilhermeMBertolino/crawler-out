...
document.getElementById("repeaterModeHint_desc").innerHTML = "<#1782#>";
document.getElementById("repeaterModeHint").style.display = "";
}
else{
show_wl_wdslist();
...
code +='<tr><td style="color:#FFCC00;"><#2558#></td>';
}
else{
...
code += '<div style="text-decoration:underline;font-weight:bolder;" onclick="rescan();"><#1512#></div>';
}
else{
...
document.getElementById("check_mac").innerHTML="<br><br><#448#>";
...
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac").innerHTML="<br><br><#409#>";
document.getElementById("check_mac").style.display = "";
return false;
}else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#480#> - <#483#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#4048#></div>
<div class="formfontdesc hint-color"><#1027#></div>
<div class="formfontdesc hint-color" style="margin-left:28px;">
<#4049#>&nbsp;<#4050#><br><#3321#>
</div>
<div class="formfontdesc"><#4051#>
<ol>
<li><#4052#></li>
<li><#4053#></li>
<li><#4054#></li>
...
<div id="wl_bw_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#4056#></div>
<div id="wl_ch_hint" class="hint-color" style="font-size:13px;margin-left:28px;"><#4057#></div>
...
<td id="repeaterModeHint_desc" colspan="2" class="hint-color" style="height:30px;" align="center"><#566#></td>
</tr>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#4107#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#4108#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#4109#></option>
</select>
</td>
</tr>
...
<td>
<input type="radio" value="1" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "1", "checked"); %>><#277#>
<input type="radio" value="0" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "0", "checked"); %>><#276#>
</td>
</tr>
</table>
...
<td colspan="4"><#4076#>&nbsp;(<#2776#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#4076#></th>
<th class="edit_table" width="20%"><#2775#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullLANIPList(this);" title="<#3284#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<div class="apply_gen">
<input class="button_gen" id="submitBtn" onclick="applyRule()" type="button" value="<#286#>" />
</div>
</td>
</tr>
</tbody>
