...
document.getElementById("iptv_configure_status").innerHTML = "<#951#>";
else
...
document.getElementById("voip_configure_status").innerHTML = "<#951#>";
else
...
alert_msg = hint_str1.replace("%1$@", "<#2948#>").replace("%2$@", "IPTV") + " " + hint_str2;
}
alert(alert_msg);
return true;
}
...
var msg = "<#3966#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
if(confirm(msg)){
...
msg = hint_str.replace("%1$@", port_list).replace("%2$@", "IPTV").replace("%3$@", "<#2948#>");
if(confirm(msg)){
document.form.lacp_enabled.disabled = false;
document.form.lacp_enabled.value = "0";
}
...
if(val == "12")
document.getElementById("gaming_note").innerHTML = "<#3221#>";
else if(val == "56")
document.getElementById("gaming_note").innerHTML = "<#3222#>";
...
if(improxy_support){
add_option(select, "<#4095#> IGMP", "1", 0);
add_option(select, "<#4095#> IGMP & MLD", "3", 0);
}
else
add_option(select, "<#4095#>", "1", 0);
select.value = val;
if(select.selectedIndex < 0)
select.selectedIndex = 0;
...
<tr>
<td>
<div class="drword" id="drword" style="height:110px;"><#469#> <#466#>...
<br/>
<br/>
</div>
...
<option value="dhcp"><#257#></option>
<option value="static"><#258#></option>
...
<tr id="dnsenable_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,12);"><#404#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,13);"><#390#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,14);"><#392#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,29);"><#3114#></a></th>
<td align="left">
<select class="input_option" name="wan_auth_x_now" onChange="change_wan_type(document.form.wan_proto_now.value);">
<option value="" <% nvram_match("wan_auth_x_now", "", "selected"); %>><#954#></option>
<option value="8021x-md5" <% nvram_match("wan_auth_x_now", "8021x-md5", "selected"); %>>802.1x MD5</option>
</select></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,4);"><#3699#></a></th>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,5);"><#582#></a></th>
<td>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd_now);"><#718#></div>
</td>
</tr>
<tr style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,6);"><#3118#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,7);"><#3138#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,8);"><#3136#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,9);"><#3144#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,10);"><#3122#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,17);"><#3142#></a></th>
<td>
<select name="wan_pptp_options_x_now" class="input_option">
<option value=""><#243#></option>
<option value="-mppc"><#2996#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);"><#3124#></a></th>
...
<input class="button_gen" type="button" onclick="hide_connection_settings();" value="<#289#>">
<input class="button_gen" type="button" onclick="save_connection_settings();" value="<#1783#>">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#487#> - IPTV</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#2667#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#2668#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#3220#></a></th>
<td>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#827#></a></th>
<td>
...
<th width="30%"><#1982#></th>
<td align="left">
<span style="color:#FFFFFF;"><#1985#></span>
<select id="wans_lanport1" name="wans_lanport1" class="input_option" style="margin-left:7px;"></select>
<div style="margin-top:2px;"><span style="color:#FFFFFF;">( <#1983#> : </span><span id="cur_primary" style="color:#FFFFFF;"></span><span style="color:#FFFFFF;"> )</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#4096#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#3228#></a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option" onChange="change_mr_enable(this.value);">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#4096#></option>
<!-- <option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#4095#></option> -->
</select>
<span id="mr_hint" style="display:none;">( <#3229#> )</span>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#4096#></span>
<span style="margin-left: 5px;"><#3230#></span>
</div>
</td>
</tr>
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,14);"><#3239#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,15);"><#3240#></a></th>
<td>
...
<option value="0" <% nvram_match("mr_qleave_x", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("mr_qleave_x", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#4096#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#4095#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#3242#></a></th>
<td>
