...
$(".ipsec_inactive.renew_hint").show().html("<br><#3852#>");
}
}
});
...
alert(document.form.ipsec_clients_start.value+" <#430#>");
...
html += "<div class='ipsec_connect_status_title'><#3417#></div>";
html += "<div class='ipsec_connect_status_title'><#980#></div>";
html += "<div class='ipsec_connect_status_title'><#3817#> <#3062#></div>";
...
<input class="button_gen" onclick="cancel_viewLog();" type="button" value="<#289#>"/>
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1765#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1784#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1786#>"/>
</div>
</div>
...
<th><#851#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1764#>"/>
</td>
</tr>
<tr class="ipsec_setting_content">
<th><#886#></th>
...
<th><#3810#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="password" autocapitalization="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);" class="input_25_table" maxlength="32" placeholder="<#3802#>" autocomplete="off" autocorrect="off" autocapitalize="off">
...
<br>
<span class="hint-color">The access setting will be applied to both IPSec VPN and Instant Guard.</span></td>
</tr>
</table>
...
<span class="hint-color"><#2111#></span>
</td>
</tr>
<tr>
<th><#392#></th>
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#4095#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#4096#></label>
</td>
</tr>
...
<span class="hint-color">(10~900) <#3279#></span>
</td>
</tr>
</table>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable " style="margin-top:15px;">
...
<th><#3741#></th>
<td>
<div><#834#> : <span id="cert_status"></span></div>
<div><#3850#> : <span id="cert_issueTo"></span></div>
<div><#3849#> : <span id="cert_issueBy"></span></div>
<div><#3781#> : <span id="cert_expire"></span></div>
<div>
<input class="button_gen_dis ipsec_active export" type="button" value="<#1632#>">
<span class="ipsec_inactive"><#832#></span>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_windows" class="input" value="0" checked>
<label for="ipsec_export_cert_windows"><#3854#></label>
<input type="radio" name="ipsec_export_cert" id="ipsec_export_cert_mobile" class="input" value="1">
<label for="ipsec_export_cert_mobile"><#3855#></label>
</div>
</td>
</tr>
<tr>
...
<input class="button_gen_dis ipsec_active renew" type="button" value="<#297#>">
<span class="ipsec_inactive renew_hint"><#832#></span>
