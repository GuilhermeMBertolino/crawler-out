...
var clientlist_username = {"title":"<#3699#>", "type":"text", "id":"clientlist_username", "need_check":true, "maxlength":32};
...
var clientlist_password = {"title":"<#2446#>", "type":"text", "id":"clientlist_password", "need_check":true, "maxlength":32};
...
var clientlist_ike_options_parm = {"title": "<#3859#>", "id": "clientlist_ike", "options": clientlist_ike_options, "set_value": "3"};
...
var $container = $("<div>");
var $popup_title_container = $("<div>").addClass("popup_title_container").appendTo($container);
$("<div>").addClass("title").html("<#851#>").appendTo($popup_title_container);
var $close_btn = $("<div>").addClass("vpn_icon_all_collect close_btn");
$close_btn.appendTo($popup_title_container);
$close_btn.unbind("click").click(function(e){
e = e || event;
...
$("<div>").addClass("btn_container apply").appendTo($action_container).html("<#1765#>")
...
$("<div>").addClass("btn_container apply").appendTo($action_container).html("<#1784#>")
.unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
location.href = "/ipsec.log";
});
$("<div>").addClass("btn_container apply").appendTo($action_container).html("<#1786#>")
.unbind("click").click(function(e){
e = e || event;
e.stopPropagation();
...
Get_Component_Pure_Text({"title":"<#3417#>", "text":value.conn_status}).appendTo($content_container);
Get_Component_Pure_Text({"title":"<#980#>", "text":value.conn_period}).appendTo($content_container);
...
$ipsec_preshared_key.show_validate_hint("<#416#>");
...
var ipConflict = checkIPConflict("LAN", ipsecLanIPAddr, ipsecLanNetMask);
if(ipConflict.state) {
$ipsec_clients_start.show_validate_hint("<#2625#>: " + ipConflict.ipAddr + ",\n" + "<#2970#>: " + ipConflict.netLegalRangeStart + " ~ " + ipConflict.netLegalRangeEnd);
$ipsec_clients_start.focus();
return false;
}
...
if($ipsec_dpd.val() == ""){
$ipsec_dpd.show_validate_hint("<#416#>");
$ipsec_dpd.focus();
return false;
}
...
var set_ddns_text = '<a href="/Advanced_ASUSDDNS_Content.asp" target="_blank" style="text-decoration: underline; font-family:Lucida Console;"><#3860#></a>';
...
$(_obj).find("#cert_status").html("<#1531#>");
...
var ipsec_server_addr_parm = {"title":"<#4020#>", "id":"ipsec_server_addr", "text":"-"};
Get_Component_Pure_Text(ipsec_server_addr_parm).appendTo($detail_general);
var ipsec_system_log_parm = {"title":"<#851#>", "id":"ipsec_system_log", "btn_text":"<#1764#>"};
...
var ipsec_preshared_key_parm = {"title":"<#3810#>", "type":"password", "id":"ipsec_preshared_key", "need_check":true, "maxlength":32, "placeholder":"<#3802#>"};
...
var ipsec_exchange_mode_parm = {"title":"<#3815#>", "id":"ipsec_exchange_mode", "text":"<#3816#>"};
Get_Component_Pure_Text(ipsec_exchange_mode_parm).appendTo($detail_general);
var ipsec_dead_peer_detection_parm = {"title":"<#3818#>", "type":"switch", "id":"ipsec_dead_peer_detection"};
...
var ipsec_dpd_parm = {"title":"<#3819#> (10~900 <#3279#>)", "type":"text", "id":"ipsec_dpd", "need_check":true,
...
var ipsec_export_cert_mode_options = [{"text":"<#3854#>","value":"0"},{"text":"<#3855#>","value":"1"}];
...
var ipsec_export_cert_parm = {"title":"<#3741#>", "id":"ipsec_export_cert", "btn_text":"<#1632#>"};
...
show_customize_alert("Certificate Status : <#1532#>");
return;
}
...
var ipsec_renew_cert_parm = {"title":"<#3851#>", "id":"ipsec_renew_cert", "btn_text":"<#297#>", "openHint":"33_2"};
...
$("<div>").addClass("item_hint").attr({"id":"ipsec_renew_hint"}).html("* <#3852#>").hide().appendTo($cert_status_bg);
...
$Add_Client_Title_obj.find("#vpns_clientlist_title").html("<#3896#> (<#2776#>" + htmlEnDeCode.htmlEncode(ipsec_clientlist_limit) + ")");
...
show_customize_alert("<#4457#>".replace("#MAXNUM", ipsec_clientlist_limit));
return false;
}
...
var ipsec_ike_isakmp_parm = {"title":"<#3845#>", "id":"ipsec_ike_isakmp", "text":"500"};
Get_Component_Pure_Text(ipsec_ike_isakmp_parm).appendTo($detail_adv);
var ipsec_ike_isakmp_nat_parm = {"title":"<#3846#>", "id":"ike_isakmp_nat", "text":"4500"};
Get_Component_Pure_Text(ipsec_ike_isakmp_nat_parm).appendTo($detail_adv);
var ipsec_clients_parm = {"title":"<#3730#>",
...
ipsec_local_public_interface_options.push({"text":"<#1982#>","value":"wan"});
if(isSupport("dualwan")){
ipsec_local_public_interface_options.push({"text":"<#1989#>","value":"wan2"});
}
var ipsec_local_public_interface_parm = {"title": "<#3809#>", "id": "ipsec_local_public_interface", "options": ipsec_local_public_interface_options};
