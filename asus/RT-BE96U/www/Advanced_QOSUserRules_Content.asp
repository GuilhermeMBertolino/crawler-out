...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2819#> - <#2036#>";
}
else{
document.getElementById('content_title').innerHTML = "<#476#> - QoS";
}
showqos_rulelist();
load_QoS_rule();
...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#828#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#430#>");
return false;
}
}
}
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2799#>");
return false;
}
}
replace_symbol();
...
alert("<#3721#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#2427#></option>';
else
code += '<option value="0"><#2427#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#2426#></option>';
else
code += '<option value="1"><#2426#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2812#></option>';
else
code += '<option value="2"><#2812#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2788#></option>';
else
code += '<option value="3"><#2788#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2789#></option>';
else
code += '<option value="4"><#2789#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#3187#></option>
<option value="3"><#3186#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1619#>&nbsp;(<#2776#>&nbsp;32)</td>
...
<tr>
<th><#1620#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1621#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1622#></div></a></th>
<th><div class="table_text"><#2551#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#3703#></div></a></th>
<th><#1623#></th>
<th><#2775#></th>
</tr>
<tr>
<td width="20%">
<input type="text" maxlength="32" class="input_12_table" style="float:left;width:105px;" placeholder="<#828#>" name="qos_service_name_x_0" onKeyPress="return validator.isString(this, event)" autocorrect="off" autocapitalize="off">
<img id="pull_arrow" height="14px;" src="/images/unfold_more.svg" onclick="pullQoSList(this);" title="<#3291#>">
...
<img id="pull_arrow_mac" class="pull_arrow"height="14px;" src="/images/unfold_more.svg" onclick="pullLANIPList(this);" title="<#3286#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#2427#></option>
<option value='1' selected><#2426#></option>
<option value='2'><#2812#></option>
<option value='3'><#2788#></option>
<option value='4'><#2789#></option>
</select>
</td>
<td width="6%">
