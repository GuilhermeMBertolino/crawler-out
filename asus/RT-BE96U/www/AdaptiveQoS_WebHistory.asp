...
var code = "";
code += "<tr>";
code += "<th style='width:20%;text-align:left'><#980#></th>";
code += "<th style='width:30%;text-align:left'><#3128#> / <#1646#></th>";
code += "<th style='width:50%;text-align:left'><#1909#></th>";
code += "</tr>";
...
var data = [["<#980#>", "<#465#>", "<#1646#>".replace(/&#39;/g, "'"), "<#1909#>"]];
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2819#> - <#999#></div>
...
<option value="all" selected><#1506#></option>
</select>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1765#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1786#>">
<input class="button_gen" onClick="exportWebHistoryLog()" type="button" value="<#1632#>" >
</div>
</div>
</td>
</tr>
