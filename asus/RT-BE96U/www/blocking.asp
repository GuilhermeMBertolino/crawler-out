...
var category_info = [ ["Parental Controls", "1", "<#1318#>", "<#1320#>", "<#1555#>"],
["Parental Controls", "3", "<#1318#>", "<#1320#>", "<#1557#>"],
["Parental Controls", "4", "<#1318#>", "<#1320#>", "<#1558#>"],
["Parental Controls", "5", "<#1318#>", "<#1320#>", "<#1559#>"],
["Parental Controls", "6", "<#1318#>", "<#1320#>", "<#1560#>"],
["Parental Controls", "8", "<#1318#>", "<#1320#>", "<#1561#>"],
["Parental Controls", "9", "<#1318#>", "<#1321#>", "<#1562#>"],
["Parental Controls", "10", "<#1318#>", "<#1321#>", "<#1563#>"],
["Parental Controls", "14", "<#1318#>", "<#1321#>", "<#1564#>"],
["Parental Controls", "15", "<#1318#>", "<#1321#>", "<#1565#>"],
["Parental Controls", "16", "<#1318#>", "<#1321#>", "<#1566#>"],
["Parental Controls", "25", "<#1318#>", "<#1321#>", "<#1567#>"],
["Parental Controls", "26", "<#1318#>", "<#1321#>", "<#1568#>"],
["Parental Controls", "11", "<#1318#>", "<#1322#>", "<#1569#>"],
["Parental Controls", "24", "<#1333#>", "<#1323#>", "<#1570#>"],
["Parental Controls", "51", "<#1333#>", "<#1324#>", "<#1571#>"],
["Parental Controls", "53", "<#1333#>", "<#1325#>", "<#1572#>"],
["Parental Controls", "89", "<#1333#>", "<#1325#>", "<#1573#>"],
["Parental Controls", "42", "<#1333#>", "<#1326#>", "<#1574#>"],
["Parental Controls", "56", "<#1336#>", "<#1338#>", "<#1575#>"],
["Parental Controls", "70", "<#1336#>", "<#1338#>", "<#1576#>"],
["Parental Controls", "71", "<#1336#>", "<#1338#>", "<#1577#>"],
["Parental Controls", "57", "<#1336#>", "<#1339#>", "<#1578#>"],
["Parental Controls", "69", "<#1340#>", "<#1342#>", "<#1579#>"],
["Parental Controls", "23", "<#1340#>", "<#1343#>", "<#1580#>"],
["Home Protection", "91", "Anti-Trojan detecting and blocked", "", "<#1581#>"],
["Home Protection", "2", "Malicious site blocked", "", "<#1556#>"],
["Home Protection", "39", "Malicious site blocked", "", "<#1582#>"],
["Home Protection", "73", "Malicious site blocked", "", "<#1583#>"],
["Home Protection", "74", "Malicious site blocked", "", "<#1584#>"],
["Home Protection", "75", "Malicious site blocked", "", "<#1585#>"],
["Home Protection", "76", "Malicious site blocked", "", "<#1586#>"],
["Home Protection", "77", "Malicious site blocked", "", "<#1587#>"],
["Home Protection", "78", "Malicious site blocked", "", "<#1588#>"],
["Home Protection", "79", "Malicious site blocked", "", "<#1589#>"],
["Home Protection", "80", "Malicious site blocked", "", "<#1590#>"],
["Home Protection", "81", "Malicious site blocked", "", "<#1591#>"],
["Home Protection", "82", "Malicious site blocked", "", "<#1592#>"],
["Home Protection", "83", "Malicious site blocked", "", "<#1593#>"],
["Home Protection", "84", "Malicious site blocked", "", "<#1594#>"],
["Home Protection", "85", "Malicious site blocked", "", "<#1595#>"],
["Home Protection", "86", "Malicious site blocked", "", "<#1596#>"],
["Home Protection", "88", "Malicious site blocked", "", "<#1597#>"],
["Home Protection", "92", "Malicious site blocked", "", "<#1598#>"],
["Home Protection", "94", "Malicious site blocked", "", "<#1599#>"],
["Home Protection", "95", "Malicious site blocked", "", "<#1600#>"]
];
var target_info = {
url: "",
category_id: "",
...
var parental_string = "";
code = "<ul>";
code += "<li><div><span class='desc_info'><#1833#>:</span><br>" + target_info.desc + "</div></li>";
if(casenum != "")
code += "<li><div><span class='desc_info'>URL: </span>" + target_info.url +"</div></li>";
if(target_info.category_type == "Parental Controls")
code += "<li><div><span class='desc_info'><#1328#> :</span>" + target_info.content_category + "</div></li>";
code += "</ul>";
document.getElementById('detail_info').innerHTML = code;
if(target_info.category_type == "Parental Controls"){ //Webs Apps filter
code_title = "<div class='er_title' style='height:auto;'><#1610#></div>";
code_suggestion = "<ul>";
code_suggestion += stringSafeGet("<li><span><#1609#></span></li>");
code_suggestion += "<li><span><#1614#></span></li>";
code_suggestion += '<li><#1388#><a href="https://global.sitesafety.trendmicro.com/index.php" target="_blank"><#1389#></a></li>';
code_suggestion += "</ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#1606#></div>";
code_suggestion = "<ul>";
...
code_title = "<div class='er_title' style='height:auto;'><#913#></div>";
document.getElementById('main_reason').innerHTML = "<#912#>";
code = "";
code += "<div><#923#></div>";
document.getElementById('detail_info').innerHTML = code;
code_suggestion = "<ul>";
code_suggestion += "<li><span><#924#></span></li>";
code_suggestion += "<li><span><#925#></span></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
code_title = "<div class='er_title' style='height:auto;'><#1615#></div>"
code_suggestion = "<ul>";
if(bwdpi_support)
parental_string = "<#3486#>";
else
parental_string = stringSafeGet("<#567#>");
code_suggestion += "<li><#1612#> "+ parental_string +" <#1613#></li>";
code_suggestion += "<li><#1614#></li>";
code_suggestion += "</ul>";
$("#go_btn").click(function(){
...
<div class="prod_madelName"><#949#></div>
<div id="main_reason" class="p1 title_gap"><#1602#></div>
<div ></div>
<div>
...
<div class="p1 title_gap"><#933#></div>
<div>
<div class="p1 title_gap"></div>
<div class="nologin">
...
<div id="go_btn" class='button' style="display:none;"><#1633#></div>
</div>
</body>
</html>
