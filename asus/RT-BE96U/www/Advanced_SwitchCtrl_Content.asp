...
hint_str2 = "<#1641#>".replace("setting_link", "setting_link_1");
...
document.getElementById("setting_link_1").href = "http://"+"<#950#>"+"/Advanced_WANPort_Content.asp";
...
hint_str2 = "<#1641#>".replace("setting_link", "setting_link_3");
note_str = hint_str1.replace("%1$@", conflict_lanport_text).replace("%2$@", "WAN") + " " + hint_str2;
...
$("#setting_link_3").attr("href", "http://"+"<#950#>"+"/Advanced_WANPort_Content.asp");
}
else if(disable_two_10g_option){// disable two 10g opton
hint_str2 = "<#1641#>".replace("setting_link", "setting_link_4");
note_str = hint_str1.replace("%1$@", conflict_lanport_text).replace("%2$@", "WAN") + " " + hint_str2;
...
$("#setting_link_4").attr("href", "http://"+"<#950#>"+"/Advanced_WANPort_Content.asp");
}
}
...
if(disable_lacp){
hint_str2 = "<#1641#>".replace("setting_link", "setting_link_2");
note_str = hint_str1.replace("%1$@", "<#2948#>").replace("%2$@", "IPTV") + " " + hint_str2
document.form.lacp_enabled.style.display = "none";
document.getElementById("lacp_note").innerHTML = note_str;
document.getElementById("setting_link_2").href = "http://"+"<#950#>"+"/Advanced_IPTV_Content.asp";
document.getElementById("lacp_desc").style.display = "";
...
document.getElementById("natAccelDesc").innerHTML = "<#2943#>";
}
else{
document.getElementById("natAccelDesc").innerHTML = "<#2939#>";
}
}
else if(mtk_support){
...
var nataccel_status = '<% nat_accel_status(); %>';
if(nataccel == '1' && nataccel_status == '1'){
document.getElementById("MTKnatAccelDesc").innerHTML = "<#2943#>";
}
else{
document.getElementById("MTKnatAccelDesc").innerHTML = "<#2939#>";
}
}
else{
...
if(ctf_disable == 1){
document.getElementById("ctfLevelDesc").innerHTML = "<#2939#>";
}
else{
if(ctf_fa_mode == '2')
document.getElementById("ctfLevelDesc").innerHTML = "<#2941#>";
else
document.getElementById("ctfLevelDesc").innerHTML = "<#2940#>";
}
}
if (re_mode == "1"){
...
var msg = "";
if(is_GTBE_series)
msg = hint_str.replace("%1$@", "<#2948#>").replaceAll("%2$@", "2.5G WAN");
else
msg = hint_str.replace("%1$@", "<#2948#>").replaceAll("%2$@", get_default_wan_name());
...
<div>&nbsp;</div>
<div class="formfonttitle"><#487#> - <#3434#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3438#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr id="jumbo_tr">
<th><#2656#></th>
<td>
<select name="jumbo_frame_enable" class="input_option">
<option class="content_input_fd" value="0" <% nvram_match("jumbo_frame_enable", "0","selected"); %>><#4096#></option>
<option class="content_input_fd" value="1" <% nvram_match("jumbo_frame_enable", "1","selected"); %>><#4095#></option>
</select>
</td>
</tr>
<tr id="ctf_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,2);"><#2937#></a></th>
<td>
<select name="ctf_disable_force" class="input_option" disabled>
<option class="content_input_fd" value="1" <% nvram_match("ctf_disable_force", "1","selected"); %>><#4096#></option>
<option class="content_input_fd" value="0" <% nvram_match("ctf_disable_force", "0","selected"); %>><#243#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("qca_sfe", "0","selected"); %>><#4096#></option>
<option class="content_input_fd" value="1" <% nvram_match("qca_sfe", "1","selected"); %>><#4095#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("hwnat", "0","selected"); %>><#4096#></option>
<option class="content_input_fd" value="1" <% nvram_match("hwnat", "1","selected"); %>><#243#></option>
</select>
&nbsp
...
<th><#3439#></th>
<td>
<input type="radio" name="gro_disable_force" value="0" <% nvram_match("gro_disable_force", "0", "checked"); %>><#277#>
<input type="radio" name="gro_disable_force" value="1" <% nvram_match("gro_disable_force", "1", "checked"); %>><#276#>
</td>
</tr>
...
<option value="0" <% nvram_match("aqr_hwnat_type", "0","selected"); %>><#243#></option>
...
<option value="0" <% nvram_match("aqr_link_speed", "0","selected"); %>><#243#></option>
...
<option value="96" <% nvram_match("aqr_ipg", "96","selected"); %>><#1769#></option>
...
<option value="0" <% nvram_match("sfpp_hwnat_type", "0","selected"); %>><#243#></option>
...
<option value="0" <% nvram_match("sfpp_max_speed", "0","selected"); %>><#243#></option>
...
<input type="radio" name="sfpp_force_on" value="0" <% nvram_match("sfpp_force_on", "0", "checked"); %>><#243#>
<input type="radio" name="sfpp_force_on" value="1" <% nvram_match("sfpp_force_on", "1", "checked"); %>>ON</td>
</tr>
<tr id="lacp_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,1);"><#2948#></a></th>
<td>
<select name="lacp_enabled" class="input_option" onchange="show_related_settings(this);" disabled>
<option class="content_input_fd" value="0" <% nvram_match("lacp_enabled", "0","selected"); %>><#4096#></option>
<option class="content_input_fd" value="1" <% nvram_match("lacp_enabled", "1","selected"); %>><#4095#></option>
</select>
<div id="lacp_desc" style="display:none; margin-top: 5px;"><span id="lacp_note"><#2951#></span></div>
...
<option value="0"><#1769#></option>
<option value="1"><#3437#></option>
<option value="2"><#3436#></option>
</select>
</td>
</tr>
</table>
