...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#570#>"; }
...
safe_count++;
document.getElementById('wireless_encryption').innerHTML = "<#573#>";
document.getElementById('wireless_encryption').className = "status_yes";
}
else{
danger_count++;
document.getElementById('wireless_encryption').innerHTML = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#571#></a>";
...
<tr>
<td>
<div class="weakness_router_status"><#1352#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<input class="button_gen" type="button" onclick="close_weakness_status();" value="<#1766#>">
</td>
<td>
<input id="all_security_btn" class="button_gen" type="button" onclick="enable_whole_security();" value="<#1791#>">
</td>
</tr>
</table>
</td>
...
<tr>
<th>
<div style="font-size:16px;"><#1300#></div>
</th>
</tr>
<td>
<div class="formfontdesc" style="font-size: 14px;"><#1348#></div>
</td>
<tr>
<td>
...
<span style="color: #FFF;"><#1411#></span>
</div>
<div>
...
<input class="button_gen" type="button" onclick="close_alert_preference();" value="<#1766#>">
...
<tr>
<td align="left">
<span class="formfonttitle"><#1394#></span>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="width:430px"><#1349#></div>
<div style="width:430px">
<a id="faq" style="text-decoration:underline;" href="" target="_blank"><#1394#> FAQ</a>
</div>
</td>
<td>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1352#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1353#></div>
</td>
<td width="6px">
...
<td style="width:20%;">
<div>
<input class="button_gen" type="button" onclick="showWeaknessTable();" value="<#1789#>">
</div>
</td>
<td>
<div class="line_vertical"></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1391#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1390#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size: 16px;"><#1383#></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1411#></div>
<div style="font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1412#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1304#></div>
<div style="font-size: 14px;color:#FC0;height:auto;;padding-top:5px;"><#1303#></div>
</td>
<td>
<div class="line_vertical"></div>
</td>
...
<input class="button_gen" type="button" onclick="show_alert_preference();" value="<#1300#>">
</div>
</div>
