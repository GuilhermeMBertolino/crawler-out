...
var str_port_binding_note = stringSafeGet("<#3717#>");
var str_modify = stringSafeGet(" <#929#>");
var rate_map = [
...
link_rate_tmp = (link_rate_tmp == undefined)? rate_map[0]:link_rate_tmp; //<#839#>
...
max_rate_tmp = (max_rate_tmp == undefined)? rate_map[0]:max_rate_tmp; //<#839#>
var ui_display_tmp = "";
...
$port_table_thead2.html("<#1144#>");
} else {
$port_table_thead2.html("<#1216#>");
}
...
note_wans_lanport += "</b>: ";
str_port_binding_note_tmp = str_port_binding_note.replace("%@", "<#314#>");
...
note_wan_aggregation += ": ";
str_port_binding_note_tmp = str_port_binding_note.replace("%@", "<#3961#>");
...
note_link_aggregation += ": ";
str_port_binding_note_tmp = str_port_binding_note.replace("%@", "<#2948#>");
...
note_iptv += ": ";
str_port_binding_note_tmp = str_port_binding_note.replace("%@", "<#2813#>");
...
note_WAN_port += ": ";
str_port_binding_note_tmp = str_port_binding_note.replace("%@", "<#2017#>");
...
.text("Allow all tagging(<#3310#>)") // Untranslated
);
$.each(VLAN_Profile_select, function(i, VLAN_Profile_select) {
if(VLAN_Profile_select.apgIdx != ""){ //except pure VLAN profile
text = VLAN_Profile_select.name;
...
<div class="formfontdesc"><#3720#></div>
