...
var category_name = ["<#1318#>", "<#1333#>", "<#1336#>", "<#1340#>"];
var sub_category_name = [["<#1320#>", "<#1321#>", "<#1322#>"],
["<#1323#>", "<#1324#>", "<#1325#>", "<#1326#>", "<#1327#>"],
["<#1338#>", "<#1339#>"],
["<#1341#>", "<#1342#>", "<#1343#>"]];
var category_desc = ["<#1319#>",
"<#1334#>",
"<#1337#>",
"<#1344#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1739#>&nbsp;(<#2776#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#3283#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1646#> (<#3128#>)</th>';
code += '<th width="40%"><#1328#></th>';
code += '<th width="10%"><#2775#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#4095#>/<#1629#>">';
...
code += '</tr>';
if(apps_filter == ""){
code += '<tr><td class="tableNoRule" style="color:#FFCC00;" colspan="10"><#2558#></td></tr>';
}
else{
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#567#> - <#1317#></div>
</td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1317#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3486#></td></tr></table>
</div>
</a>
</div>
</td>
...
<span><#1335#></span>
<div>
<a id="faq" class="notInBusiness" href="" style="text-decoration:underline;" target="_blank"><#567#> FAQ</a>
</div>
</td>
</tr>
</table>
...
<div id="ctrlBtn" class="apply_gen" style="text-align:center;margin-top:20px;">
<input class="button_gen" type="button" onclick="applyRule();" value="<#286#>">
