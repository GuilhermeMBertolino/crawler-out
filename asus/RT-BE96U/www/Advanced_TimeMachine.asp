...
document.getElementById("tmPath").innerHTML = '<div style="margin-left:5px;color:#FC0"><#1900#></div>';
...
htmlcode += '<tr height="300px"><td colspan="2" class="nohover"><span class="app_name" style="line-height:100%"><#2998#></span></td></tr>\n';
}
...
totalSpace = _total;
availSpace = _avail;
document.getElementById("maxVolSize").innerHTML = "<#1535#>: " + _avail + " GB";
...
<tr>
<td>
<div style="width:450px;font-family:Arial;font-size:13px;font-weight:bolder; margin-top:23px;margin-left:30px;"><#1900#> :</div>
</td>
</tr>
</table>
...
<span class="formfonttitle"><#3487#></span>
<span id="returnBtn">
...
2. <#3497#> <br>
3. <#3499#><br>
4. <#3489#> ( <a id="faq2" href="" target="_blank" style="text-decoration:underline;"><#3488#></a> )<br>
5. <a id="faq" href="" target="_blank" style="text-decoration:underline;"><#3493#></a><br>
...
<th><#3490#></a></th>
<td>
<input class="button_gen" onclick="selPartition()" type="button" value="<#826#>"/>
...
<th><#3500#></a></th>
<td>
<input id="tm_vol_size" name="tm_vol_size" maxlength="5" class="input_6_table" type="text" maxLength="8" value="<% nvram_get("tm_vol_size"); %>" onKeyPress="return validator.isNumber(this,event);" placeholder="0" autocorrect="off" autocapitalize="off"/> GB (0: <#2769#>)
