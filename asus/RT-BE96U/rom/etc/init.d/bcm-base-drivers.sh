...
insmod /lib/modules/4.19.275/kernel/drivers/mtd/mtdoops.ko mtddev=$mtdoops record_size=$rec_size
fi
...
# General
insmod /lib/modules/4.19.275/extra/bcm_bp3drv.ko modparam_license_dir="/rom/etc/licenses" 
...
insmod /lib/modules/4.19.275/extra/pcap.ko  
...
insmod /lib/modules/4.19.275/extra/bcmflex.ko  
insmod /lib/modules/4.19.275/extra/bcmspu.ko  
