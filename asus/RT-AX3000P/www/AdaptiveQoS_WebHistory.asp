...
var code = "";
code += "<tr>";
code += "<th style='width:20%;text-align:left'><#892#></th>";
code += "<th style='width:30%;text-align:left'><#3005#> / <#1552#></th>";
code += "<th style='width:50%;text-align:left'><#1810#></th>";
code += "</tr>";
...
var data = [["<#892#>", "<#381#>", "<#1552#>".replace(/&#39;/g, "'"), "<#1810#>"]];
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2698#> - <#911#></div>
...
<option value="all" selected><#1413#></option>
</select>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1668#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1689#>">
<input class="button_gen" onClick="exportWebHistoryLog()" type="button" value="<#1538#>" >
</div>
</div>
</td>
</tr>
