...
x.options[0].text = "<#3918#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#3918#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#3919#>", "upper");
...
x.options[0].text = "<#3919#>";
x.options[0].value = "upper";
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#3918#>", "lower");
...
else if(opts[opts.selectedIndex].text == "WPA2-Personal" || opts[opts.selectedIndex].text == "<#4333#>" || opts[opts.selectedIndex].text == "WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2/WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2-Enterprise")
algos = new Array("AES");
else
...
var auth_array = [["<#4333#>", "owe"], ["WPA3-Personal", "sae"]];
}
else{
