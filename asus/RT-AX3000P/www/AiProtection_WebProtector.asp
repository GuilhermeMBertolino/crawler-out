...
var category_name = ["<#1228#>", "<#1243#>", "<#1246#>", "<#1250#>"];
var sub_category_name = [["<#1230#>", "<#1231#>", "<#1232#>"],
["<#1233#>", "<#1234#>", "<#1235#>", "<#1236#>", "<#1237#>"],
["<#1248#>", "<#1249#>"],
["<#1251#>", "<#1252#>", "<#1253#>"]];
var category_desc = ["<#1229#>",
"<#1244#>",
"<#1247#>",
"<#1254#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1642#>&nbsp;(<#2656#>&nbsp;'+MaxRule_bwdpi_wrs+')</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#3156#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1552#> (<#3005#>)</th>';
code += '<th width="40%"><#1238#></th>';
code += '<th width="10%"><#2655#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#3945#>/<#1535#>">';
...
code += "<span style=\"margin-left:10px\" class=\"click\"><#1227#></span>";
code += '</a>';
}
else{
...
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1227#></span>";
}
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#482#> - <#1227#></div>
</td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1227#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#3358#></td></tr></table>
</div>
</a>
</div>
</td>
...
<span><#1245#></span>
<div>
<a id="faq" href="" style="text-decoration:underline;" target="_blank"><#482#> FAQ</a>
</div>
</td>
</tr>
</table>
...
<input class="button_gen" type="button" onclick="applyRule();" value="<#203#>">
