...
<link rel="icon" href="images/favicon.png"><title><#860#> - <#2180#></title>
...
var code = '';
code += '<thead><tr><td colspan="4"><#2222#>&nbsp;(<#2656#>&nbsp;64)</td></tr></thead>';
code += '<tr>';
code += '<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1552#> (<#3005#>)</a></th>';
code += '<th><#2655#></th>';
code += '</tr>';
code += '<tr>';
code += '<td width="40%">';
...
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2220#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2221#></div>
<div onclick="showGameListField();" class="btn" style="margin: 12px 0;width:100px;height:40px;line-height: 40px;text-align: center;border-radius: 5px;font-size:18px;"><#1664#></div>
</td>
<td>
...
<tr>
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2239#></div>
</td>
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2240#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2241#></div>
</td>
<td>
...
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66"><#2242#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#2243#></div>
</td>
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameProfile.asp';"><#1539#></div>
</td>
</tr>
<tr style="height:50px;"></tr>
<tr id='wtfast_1' style="display:none">
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#2195#></div>
</td>
<td colspan="2">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px; margin-top: 10px;"><#2218#></div>
...
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="redirectSite('wtfast');"><#1539#></div>
</td>
</tr>
...
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameBoost_Tencent.asp';"><#1539#></div>
</td>
</tr>
...
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="redirectSite(outfox_site)"><#1539#></div>
</td>
</tr>
</tbody>
</table>
