...
var msg = "<#3834#>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wnaports_bond));
if(confirm(msg)){
...
<input class="button_gen" type="button" onclick="save_connection_settings();" value="<#1686#>">
</div>
</div>
...
<th width="30%"><#1880#></th>
<td align="left">
<span style="color:#FFFFFF;"><#1883#></span>
<select id="wans_lanport1" name="wans_lanport1" class="input_option" style="margin-left:7px;"></select>
<div style="margin-top:2px;"><span style="color:#FFFFFF;">( <#1881#> : </span><span id="cur_primary" style="color:#FFFFFF;"></span><span style="color:#FFFFFF;"> )</span></div>
</td>
</tr>
