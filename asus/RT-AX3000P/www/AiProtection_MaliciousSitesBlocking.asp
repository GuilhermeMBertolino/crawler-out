...
code += mals_count;
code += '<span style="font-size: 16px;padding-left: 5px;"><#1293#></span>';
...
if(code == ''){
code += '<div style="font-size:16px;text-align:center;margin-top:70px;color:#FC0"><#1226#></div>';
}
...
code += '<div style="display:table-cell;width:180px;padding-right:5px;"><#1782#></div>';
code += '<div style="display:table-cell;width:80px;padding-right:5px;"><#1224#></div>';
code += '<div style="display:table-cell;width:170px;padding-right:5px;"><#1223#></div>';
code += '<div style="display:table-cell;width:200px;padding-right:5px;"><#1222#></div>';
code += '<div style="display:table-cell;width:50px;padding-right:5px;"></div>';
code += '</div>';
if(dataObj == ""){
code += '<div style="text-align:center;font-size:16px;color:#FC0;margin-top:90px;"><#2447#></div>';
}
else{
...
code += '<div style="display:table-cell;width:200px;height:30px;vertical-align:middle;padding-right:5px;text-decoration:underline;cursor:pointer;" title="<#1333#>" onclick="checkEventSafe(\''+ dataObj[eventID].destination[0] +'\');">'+ dataObj[eventID].destination[0] +'</div>';
...
<tr>
<td align="left">
<span class="formfonttitle"><#1304#> - <#1301#></span>
</td>
</tr>
</table>
</div>
...
<div style="font-size:16px;margin:0 0 5px 5px;text-align:center"><#1220#></div>
</div>
...
<div style="text-align:center;font-size:16px;"><#1319#></div>
...
<div>
<div style="display:inline-block;margin:5px 10px"><#1293#></div>
</div>
<div style="width:90%">
<div>
...
<div style="text-align:center;font-size:16px;"><#1225#></div>
<div style="display: flex;">
<div style="margin: 0 8px;"><div id="save_icon" class="icon-container icon-save" title="<#1687#>" onclick="download(csvContent, 'MaliciousSitesBlocking.csv', 'data:text/csv;charset=utf-8');"></div></div>
<div style="margin: 0 8px;"><div id="delete_icon" class="icon-container icon-delete" onclick="showEraseConfirm();" title="<#1670#>"></div></div>
...
<div style="font-size: 24px;"><#3849#></div>
<div onclick="hideWhitelistField();"><img src="images/New_ui/icon_close.svg" alt="" style="width:32px;height:32px;cursor:pointer;"></div>
</div>
<div style="color: #CCCCCC;font-size: 16px;margin: 12px 0 24px 0;"><#1302#></div>
<div>
<div style="font-size: 14px;padding: 0 0 2px 4px;"><#1303#></div>
<div>
...
<input type="button" class="button_gen" value="<#1664#>" onclick="addWhitelist();">
</div>
<div style="width:100%;" class="line_horizontal"></div>
<div style="margin-top:24px;">
<span style="font-size: 24px;padding-right:12px;"><#3849#></span>
<span style="font-size: 14px;"><#2853#>: <b id="list_count">0</b> (<#2656#>&nbsp;64)</span>
</div>
...
<div style="display:table-cell;width:180px;padding-right:5px;"><#1782#></div>
<div style="display:table-cell;width:80px;padding-right:5px;"><#1224#></div>
<div style="display:table-cell;width:170px;padding-right:5px;"><#1223#></div>
<div style="display:table-cell;width:200px;padding-right:5px;"><#1222#></div>
