...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#742#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
code += '<option value="0" selected><#2317#></option>';
else
code += '<option value="0"><#2317#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#2316#></option>';
else
code += '<option value="1"><#2316#></option>';
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1525#>&nbsp;(<#2656#>&nbsp;32)</td>
...
<tr>
<th><#1526#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1527#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1528#></div></a></th>
<th><div class="table_text"><#2440#></div></th>
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#2317#></option>
<option value='1' selected><#2316#></option>
