...
<div class="formfontdesc"><#2072#></div>
<div id="kwf_desc2" class="formfontdesc"><#2073#></div>
...
<th><#2071#></th>
<td>
<input type="radio" value="1" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "1", "checked"); %>><#1676#>
<input type="radio" value="0" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "0", "checked"); %>><#1673#>
</td>
</tr>
</table>
