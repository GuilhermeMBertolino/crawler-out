...
<div class="formfontdesc"><#2250#></div>
...
<tr>
<th><#2249#></a></th>
<td><span id="boot_days"></span> <#1711#> <span id="boot_hours"></span> <#2319#> <span id="boot_minutes"></span> <#2704#> <span id="boot_seconds"></span> <#3154#></td>
</tr>
<tr>
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1668#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1687#>" class="button_gen">
</form>
</td>
</tr>
</table>
