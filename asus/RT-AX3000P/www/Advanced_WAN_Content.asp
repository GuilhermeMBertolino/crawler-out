...
$("#dhcpdns_hint_dnspriv").html("<span><#1752#></span>");
...
document.getElementById("yadns_hint").innerHTML = "<span><#4096#></span>";
if(dnspriv_support){
document.getElementById("yadns_hint_dnspriv").style.display = "";
document.getElementById("yadns_hint_dnspriv").innerHTML = "<span><#4096#></span>";
}
}
}
if(gobi_support){
...
code +='<tr><td style="color:#FFCC00;" colspan="5"><#2447#></td></tr>';
else{
...
code += "<th class='IE8HACK' width='5%'></th>";
code += "<th class='IE8HACK' width='15%'><#631#></th>";
code += "<th class='IE8HACK' width='15%'><#2327#></th>";
code += "<th class='IE8HACK' width='65%'><#1734#></th></tr>";
...
DSN_status_info += "<br><b><#1526#>:</b> "+DNSService[DNS_list_index].DNSService; /* Untranslated */
...
function update_map(){
var msg = stringSafeGet("<#2685#>")+" <#1014#>";
if(confirm(msg)){
$.ajax({
url: "/s46reset.cgi",
success: function( response ) {
...
var aftrArray = [
["<#2501#> (dgw.xpass.jp)", "dgw.xpass.jp"], ["transix (gw.transix.jp)", "gw.transix.jp"]
];
...
document.getElementById("wan_s46_dslite_svc_span").innerHTML = (s46_dslite_svc_str=="xpass")? "<#2501#>":s46_dslite_svc_str;
}
setTimeout("update_info();", 1500);
}
}
...
<option value="v6plus" <% nvram_match("wan_proto", "v6plus", "selected"); %>><#2485#></option>
<option value="ocnvc" <% nvram_match("wan_proto", "ocnvc", "selected"); %>><#2484#></option>
...
<div id="s46reset_btn" style="margin-left: 5px;"><input type="button" class="button_gen" onclick="update_map();" value="<#2684#>"></div>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,22);"><#1893#></a></th>
<td>
...
<th><#2225#>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="faq_nat" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">FAQ</a></th>
<td>
<select name="nat_type" class="input_option">
<option value="0" <% nvram_match("nat_type", "0", "selected"); %>><#2226#></option>
<option value="1" <% nvram_match("nat_type", "1", "selected"); %>><#2227#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,23);"><#1454#></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;">UPnP&nbspFAQ</a></th>
<td>
...
<option value="0" <% nvram_match("wan_s46_dslite_mode", "0", "selected"); %>><#160#></option>
<option value="1" <% nvram_match("wan_s46_dslite_mode", "1", "selected"); %>><#2671#></option>
</td>
</tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullaftrList(this);" title="<#3164#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2468#></a></th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(-1,-1);"><#2489#></a></th>
...
<thead>
<tr><td colspan="2"><#2466#></td></tr>
</thead>
<tr>
<th width="40%"><#1755#> (<#2861#> 60):</th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,18);">Host-Uniq (<#2315#>)</a></th>
...
<option value="0" <% nvram_match("wan_ppp_echo", "0","selected"); %>><#1535#></option>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,30);"><#1750#></a></th>
<td>
<select name="wan_dhcp_qry" class="input_option">
<option value="0" <% nvram_match(" wan_dhcp_qry", "0","selected"); %>><#1753#></option>
<option value="1" <% nvram_match(" wan_dhcp_qry", "1","selected"); %>><#1751#></option>
<option value="2" <% nvram_match(" wan_dhcp_qry", "2","selected"); %>><#4172#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#1917#></a></th>
<td>
