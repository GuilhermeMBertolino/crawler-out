...
'GT6triBandMeshSmartConnect': [['0', '<#3235#>', '0'], ['1', '5 GHz-2', '1']],
...
code += '<option value="0" '+ (variable.smart_connect_x === '0' ? 'selected': '') +'><#1669#>';
code += '<option value="1" '+ (variable.smart_connect_x !== '0' ? 'selected': '') +'><#1676#>';
code += '</select>'
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4065#></div>';
