...
document.getElementById("auto_channel").innerHTML = "<#3865#>: " + temp;
}
...
if(radio_value) {
confirm_flag=7;
confirm_content="<#1025#>";
}
}
else {
if(radio_value) {
confirm_flag=6;
confirm_content="<#1024#>";
}
}
}
else {
...
confirm_asus({
title: "<#3968#>",
contentA: confirm_content+"<br><br><#1031#> <#1014#>",
contentC: "",
left_button: "<#1686#>",
...
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4054#>';
else{
if(band5g_11ac_support)
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4057#>';
else
document.getElementById('wl_NOnly_note').innerHTML = '<br>* <#4058#>';
}
...
if(flag == 1 || flag == 2){
if(based_modelid == "RT-AC87U"){
obj.options[0] = new Option("<#160#>", 0);
...
var tmo2nmode = [["0", "<#160#>"],["6", "B Only"],["5", "G Only"],["1", "N Only"],["2", "B/G Mixed"],["4", "G/N Mixed"]];
var tmo5nmode = [["0", "<#160#>"],["7", "A Only"],["1", "N Only"],["3", "AC Only"],["4", "A/N Mixed"]];
...
if(wl_info.band2g_support && wl_info.band5g_support && (wl_info.band5g_2_support || wl_info.band6g_support)){
if(band6g_support){
desc = ["<#3236#> (2.4 GHz, 5 GHz and 6 GHz)"];
value = ["1"];
}
else{
desc = ["<#3236#> (2.4 GHz, 5 GHz-1 and 5 GHz-2)", "5 GHz Smart Connect (5 GHz-1 and 5 GHz-2)"];
value = ["1", "2"];
}
}
else if(wl_info.band2g_support && wl_info.band5g_support){
desc = ["<#3235#> (2.4 GHz and 5 GHz)"];
value = ["1"];
}
}
...
free_options(document.form.wl_nmode_x);
document.form.wl_nmode_x.options[0] = new Option("<#160#>", 0);
...
$("#auto_channel").html("<#3865#>: " + cur_control_channel[wl_unit]);
...
$selectObj.append($('<option>', {value: "2", text: "<#1084#>"}));
/*
if(select_node_capability.fronthaul_ap_option_auto)
$selectObj.append($('<option>', {value: "1", text: "<#160#>"}));
*/
if(select_node_capability.fronthaul_ap_option_off)
$selectObj.append($('<option>', {value: "0", text: "<#1085#>"}));
if(meshBackhaulAutoSupport ){
$selectObj.append($('<option>', {value: "1", text: "", hidden: true}));
}
if($selectObj.find("option").length > 0){
var $trObj = $("<tr>").addClass("fronthaul_ap");
var $thObj = $("<th>").html("<#1083#>");
var $tdObj = $("<td>");
$trObj.append($thObj).append($tdObj.append($selectObj));
if(meshBackhaulAutoSupport ){
var fh_connect_obj ='<div id="fh_connection_hint" style="color:#FC0;"><input id="fh_connection_hint_checkbox" type="checkbox" onchange="handleFhConnectionHint(this.checked)"><#1086#></div>';
...
if(dwb_info.band == wl_unit){
var value = ["1"];
var desc = ["<#3235#> (2.4 GHz and 5 GHz)"];
if($(this).val() == "2")
desc = ["<#3236#>"];
...
<div>&nbsp;</div>
<div class="formfonttitle"><#396#> - <#397#></div>
<div style="margin: 10px 0 10px 5px" class="splitLine"></div>
<div class="formfontdesc"><#942#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0,27);"><#3238#></a></th>
<td>
...
<div id="radio_smartcon_enable" class="left" style="width: 94px;display:table-cell;"></div><div id="smartcon_rule_link" style="display:table-cell; vertical-align: middle;"><a href="Advanced_Smart_Connect.asp" style="font-family:Lucida Console;color:#FC0;text-decoration:underline;cursor:pointer;"><#3241#></a></div>
<div class="clear"></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wl_bss_enabled", "0","selected"); %>><#3946#></option>
<option class="content_input_fd" value="1" <% nvram_match("wl_bss_enabled", "1","selected"); %>><#3945#></option>
</select>
</td>
</tr-->
<tr id="wl_ssid_field">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 2);"><#3968#></a></th>
<td>
<input type="radio" value="1" name="wl_closed" class="input" <% nvram_match("wl_closed", "1", "checked"); %>><#194#>
<input type="radio" value="0" name="wl_closed" class="input" <% nvram_match("wl_closed", "0", "checked"); %>><#193#>
<br>
<span id="dwb_band_hide_hint"><#59#></span>
</td>
</tr>
<tr>
<th><a id="wl_mode_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 4);"><#4007#></a></th>
<td>
...
<span id="wl_optimizexbox_span" style="display:none"><input type="checkbox" name="wl_optimizexbox_ckb" id="wl_optimizexbox_ckb" value="<% nvram_get("wl_optimizexbox"); %>" onclick="document.form.wl_optimizexbox.value=(this.checked==true)?1:0;"> <#4009#></span>
<span id="wl_gmode_checkbox" style="display:none;"><input type="checkbox" name="wl_gmode_check" id="wl_gmode_check" value="" onClick="wl_gmode_protection_check();"> <#4008#></span>
...
<span id="wl_nmode_x_hint" style="display:none;"><br><#4055#><br></span>
<span id="wl_NOnly_note" style="display:none;"></span>
<br>
<span id="wl_AXOnly_note" style="display:none;"><#4059#></span>
...
<th>
<a id="he_mode_text" class="hintstyle"><#3920#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_11ax" class="input_option" onChange="he_frame_mode(this);">
<option value="1" <% nvram_match("wl_11ax", "1","selected"); %>><#3945#></option>
<option value="0" <% nvram_match("wl_11ax", "0","selected"); %>><#3946#></option>
</select>
<span id="he_mode_faq" style="padding: 0 10px"><#3921#></span>
</div>
</td>
</tr>
<tr id="mbo_field" style="display:none">
<th>
<a class="hintstyle"><#3878#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_mbo_enable" class="input_option" onChange="handleMFP();">
<option value="1" <% nvram_match("wl_mbo_enable", "1","selected"); %>><#3945#></option>
<option value="0" <% nvram_match("wl_mbo_enable", "0","selected"); %>><#3946#></option>
</select>
</div>
</td>
</tr>
...
<th>
<a class="hintstyle"><#3936#></a>
</th>
<td>
<div style="width:465px;display:flex;align-items: center;">
<select name="wl_twt" class="input_option">
<option value="1" <% nvram_match("wl_twt", "1","selected"); %>><#3945#></option>
<option value="0" <% nvram_match("wl_twt", "0","selected"); %>><#3946#></option>
</select>
</div>
</td>
</tr>
...
<span id="enable_160_field" style="display:none"><input type="checkbox" onClick="enable_160MHz(this);" id="enable_160mhz" ><#3891#></span>
</td>
</tr>
<tr>
<th>
<a id="wl_channel_select" class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 3);"><#867#></a>
</th>
<td>
...
<div><span id="dfs_checkbox" style="display:none"><input type="checkbox" onClick="check_DFS_support(this);" name="acs_dfs_checkbox" <% nvram_match("acs_dfs", "1", "checked"); %>><#3913#></span></div>
<div><span id="acs_band1_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band1_support(this);" <% nvram_match("acs_band1", "1", "checked"); %>><#3911#></span></div>
<div><span id="acs_band3_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_band3_support(this);" <% nvram_match("acs_band3", "1", "checked"); %>><#3912#></span></div>
<div><span id="acs_ch13_checkbox" style="display:none;"><input type="checkbox" onClick="check_acs_ch13_support(this);" <% nvram_match("acs_ch13", "1", "checked"); %>><#3910#></span></div>
<div><span id="psc6g_field" style="display:none;"><input id="psc6g_checkbox" type="checkbox" onClick="wl_chanspec_list_change();" <% nvram_match("psc6g", "1", "checked"); %>><#4331#> <#4332#></span></div>
<div><span id="acs_unii4_field" style="display:none;"><input id="acs_unii4_checkbox" type="checkbox" onClick="handleUNII4Hint(this.checked)" <% nvram_match("acs_unii4", "1", "checked"); %>><#3914#></span></div>
</td>
</tr>
...
<option value="owe" <% nvram_match("wl_auth_mode_x", "owe", "selected"); %>><#4333#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 7);"><#4018#></a></th>
<td>
...
<option value="0" <% nvram_match("wl_mfp", "0", "selected"); %>><#3946#></option>
<option value="1" <% nvram_match("wl_mfp", "1", "selected"); %>><#4000#></option>
<option value="2" <% nvram_match("wl_mfp", "2", "selected"); %>><#4001#></option>
</select>
...
<span id="mbo_notice" style="display:none"><#3879#></span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 11);"><#4029#></a></th>
...
nvram_match("acs_ch13", "1" , "checked" ); %>><#3910#></span>
</td>
</tr>
...
nvram_match("acs_dfs", "1" , "checked" ); %>><#3913#></span>
</td>
</tr>
...
<span id="band2_acsDFS"><input id="band2_acsDFS_checkbox" type="checkbox" <% nvram_match("acs_band3", "1" , "checked" ); %>><#3913#></span>
<span id="band2_psc6g" style="display:none"><input id="band2_psc6g_checkbox" type="checkbox" onclick="separateGenChannel('2', document.form.band2_channel.value, document.form.band2_bw.value);" <% nvram_match("psc6g", "1" , "checked" ); %>><#4331#> <#4332#></span>
<span id="band2_acs_unii4_field" style="display:none;"><br><input id="band2_acs_unii4_checkbox" type="checkbox" onClick="handleUNII4Hint(this.checked)" <% nvram_match("acs_unii4", "1", "checked"); %>><#3914#></span>
</td>
</tr>
