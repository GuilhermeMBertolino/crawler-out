...
code +='<tr id="band_text"><th width="20%"><#2364#></th>';
if(start_band_idx == '1'){
if(band6g_support){
...
code +='<div id="wl'+i+'_bsd_steering_phy_ld_t" style="display:none;"><#1535#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th><#2940#></th>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_gd_t" style="display:none;"><#1535#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#1412#></option>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_ld_t" style="display:none;"><#1535#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th><#2940#></th>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_gd_t" style="display:none;"><#1535#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
code +='<tr id="target_band_text"><th width="20%"><#2365#></th>';
if('<% nvram_get("smart_connect_x"); %>' != 2 && (wl_info.band5g_2_support || wl_info.band6g_support)){
for(i = start_band_idx; i < wl_info.wl_if_total; i++){
...
vht_desc = ["<#1412#>","AC only","not-allowed"];
vht_value = [0,1,2];
