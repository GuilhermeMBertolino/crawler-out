...
code +='<thead><tr><td colspan="4"><#1642#>&nbsp;(<#2656#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
...
code += '<option value="0"><#1535#></option>';
code += '<option value="1"><#1782#></option>';
code += '<option value="2"><#1456#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1552#> (<#3005#>)</th>';
...
code += '<option value="0"><#1535#></option>';
code += '<option value="1" selected><#1782#></option>';
code += '<option value="2"><#1456#></option>';
code += '</select>';
code += '</td>';
...
code += '<option value="0" ' + ((client_time_obj.enable == "0") ? "selected" : "") + '><#1535#></option>';
code += '<option value="1" ' + ((client_time_obj.enable == "1") ? "selected" : "") + '><#1782#></option>';
code += '<option value="2" ' + ((client_time_obj.enable == "2")? "selected" : "") + '><#1456#></option>';
code += '</select>';
code += '</td>';
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1227#></td></tr></table>
</div>
</a>
