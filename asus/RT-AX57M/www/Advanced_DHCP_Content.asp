...
document.getElementById("VPN_conflict_span").innerHTML = "<#3721#>"+pptpd_clients;
}
}
if(yadns_support){
...
$("#GWStatic").html("<#2669#>&nbsp;(<#2767#>&nbsp;"+MaxRule_extend_limit+")");
}
...
alert("<#2627#> " + MaxRule_extend_limit + " <#2628#>");
return false;
}
...
if(policy_flag){
if(!confirm("Remove the client's IP binding will also delete the client's policy in the exception list of <#4347#>. Are you sure you want to delete?"))/*untranslated*/
return false;
}
}
...
if(confirm("<#2619#>")){ //Acceptable DHCP ip pool : "+default_pool[0]+"~"+default_pool[1]+"\n
...
<div>&nbsp;</div>
<div class="formfonttitle"><#485#> - <#487#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2653#></div>
<div id="router_in_pool" class="formfontdesc" class="hint-color" style="display:none;"><#2654#><span id="LANIP"></span></div>
<div id="VPN_conflict" class="formfontdesc" class="hint-color" style="display:none;"><span id="VPN_conflict_span"></span></div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#2669#>&nbsp;FAQ</a>
</div>
...
<tr id="dhcpEnable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,1);"><#2652#></a></th>
<td>
<input type="radio" value="1" name="dhcp_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'LANHostConfig', 'dhcp_enable_x', '1')" <% nvram_match("dhcp_enable_x", "1", "checked"); %>><#275#>
<input type="radio" value="0" name="dhcp_enable_x" class="content_input_fd" onClick="return change_common_radio(this, 'LANHostConfig', 'dhcp_enable_x', '0')" <% nvram_match("dhcp_enable_x", "0", "checked"); %>><#274#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,2);"><#2663#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,3);"><#2675#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,4);"><#2673#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,5);"><#2665#> (<#3269#>)</a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,6);"><#404#></a></th>
<td>
...
<tr>
<th width="200"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,7);"><#2729#> 1</a></th>
<td>
...
<tr>
<th width="200"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,7);"><#2729#> 2</a></th>
<td>
...
<th><#452#></th>
<td>
<input type="radio" value="1" name="dhcpd_dns_router" class="content_input_fd" onClick="return change_common_radio(this, 'LANHostConfig', 'dhcpd_dns_router', '1')" <% nvram_match("dhcpd_dns_router", "1", "checked"); %>><#275#>
<input type="radio" value="0" name="dhcpd_dns_router" class="content_input_fd" onClick="return change_common_radio(this, 'LANHostConfig', 'dhcpd_dns_router', '0')" <% nvram_match("dhcpd_dns_router", "0", "checked"); %>><#274#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,8);"><#2747#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,9);"><#2667#></a></th>
<td colspan="2" style="text-align:left;">
<input type="radio" value="1" name="dhcp_static_x" onclick="return change_common_radio(this, 'LANHostConfig', 'dhcp_static_x', '1')" <% nvram_match("dhcp_static_x", "1", "checked"); %> /><#275#>
<input type="radio" value="0" name="dhcp_static_x" onclick="return change_common_radio(this, 'LANHostConfig', 'dhcp_static_x', '0')" <% nvram_match("dhcp_static_x", "0", "checked"); %> /><#274#>
</td>
</tr>
</table>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1642#> (<#3118#>)</a></th>
<th class="sort_border" onClick="sortClientIP()"><#384#></th>
<th><#2729#> (Optional)</th>
<th><#2712#> (Optional)</th>
<th><#2766#></th>
</tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3279#>">
...
<div class="apply_gen">
<input type="button" name="button" class="button_gen" onclick="applyRule();" value="<#284#>"/>
</div>
</td>
</tr>
</tbody>
