...
<script>
option_netstat = new Array("<#3339#>","<#3343#>","<#3344#>","<#3342#>","<#3345#>","<#3340#>","<#1884#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2947#>", "<#2948#>", "<#2949#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2969#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2961#> - Netstat</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2969#></div>
...
<option value="-a"><#3339#></option>
<option value="-ta"><#3343#></option>
<option value="-ua"><#3344#></option>
<option value="-w"><#3342#></option>
<option value="-xa"><#3345#></option>
<option value="-l"><#3340#></option>
<option value="-r"><#1884#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2976#> IP</th>
<td>
...
<option value="-r state" selected><#2954#></option>
<option value="-r src"><#2952#></option>
<option value="-r dst"><#2950#></option>
<option value="-r src-port"><#2953#></option>
<option value="-r dst-port"><#2951#></option>
</select>
</td>
</tr>
