...
text += "<br>";
text += "<a id='ftp_port_conflict_faq' href='" + usb_port_conflict_faq + "' target='_blank' style='text-decoration:underline;color:#FC0;'><#2042#></a>";
...
add_option(document.form.KnownGames, "<#824#>", 0, 1);
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2549#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2551#>&nbsp;(<#2767#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1616#></th>';
html += '<th width="15%"><#2553#></th>';
html += '<th width="15%"><#2555#></th>';
html += '<th width="17%"><#2556#></th>';
html += '<th width="8%"><#2542#></th>';
html += '<th width="17%"><#2550#></th>';
html += '<th width="6%"><#3167#></th>';
html += '<th width="6%"><#1763#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1978#></option>")
.append("<option value='1'><#1985#></option>")
...
$("#vts_port_x").parent().parent().find('th').html('<#2553#><div class="setup_info_icon" style="display:none;"></div>');
if((wan_proto == "v6plus" || wan_proto == "ocnvc") && s46_ports_check_flag && array_ipv6_s46_ports.length > 1){
$(".setup_info_icon").show();
$(".setup_info_icon").click(
function() {
...
<div>&nbsp;</div>
<div class="formfonttitle"><#489#> - <#492#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div>
<div id="ftpPortConflict" class="formfontdesc" style="display:none;color:#FFCC00;"></div>
<div class="formfontdesc"><#2539#></div>
<ul style="margin-left:-25px; *margin-left:10px;">
<div class="formfontdesc"><li><#2198#></div>
<div class="formfontdesc" id="FTP_desc"><li><#2170#></div>
</ul>
</div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#492#>&nbspFAQ</a>
</div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2755#></div>
...
<tr>
<th><#2538#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3883#>">
</div>
</td>
</tr>
</tbody>
...
<tr>
<th><#2553#><div class="setup_info_icon" style="display:none;"></div></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2555#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2556#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/arrow-down.gif" align="right" onclick="pullLANIPList(this);" title="<#3278#>">
...
<input class="button_gen" type="button" onclick="cancelProfile();" value="<#287#>">
<input id="saveProfile" class="button_gen" type="button" value="<#1779#>">
</div>
</div>
<div id="footer"></div>
</form>
