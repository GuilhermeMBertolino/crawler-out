...
document.getElementById("cmdDesc").innerHTML = "<#2974#>";
}
else if(_val == "traceroute"){
document.getElementById("pingCNT_tr").style.display = "none";
document.getElementById("cmd_for_ipv6").style.display = "";
document.getElementById("cmdDesc").innerHTML = "<#2977#>";
}
else{
document.getElementById("pingCNT_tr").style.display = "none";
document.getElementById("cmd_for_ipv6").style.display = "none";
document.getElementById("cmdDesc").innerHTML = "<#2971#>";
}
update_ntool_unit();
}
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2961#> - <#2956#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2974#></div>
...
<option class="content_input_fd" value="0" <% nvram_match("wans_ntool_unit", "0","selected"); %>><#1978#></option>
<option class="content_input_fd" value="1" <% nvram_match("wans_ntool_unit", "1","selected"); %>><#1985#></option>
</select>
</td>
</tr>
<tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#3280#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
<div id="ClientList_Block_PC" class="ClientList_Block_PC"></div>
<div id="cmd_for_ipv6" style="color:#FFCC00;display:none;"><input id="cmd_for_ipv6_checkbox" type="checkbox">for IPv6 address</div> </td>
</tr>
<tr id="pingCNT_tr">
<th width="20%"><#2965#></th>
<td>
...
<div class="apply_gen">
<span><input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2967#>"></span>
