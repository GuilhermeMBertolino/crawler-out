...
code +='<thead><tr><td colspan="4"><#3363#></td></tr></thead>';
code +='<tr id="band_text"><th width="20%"><#2465#></th>';
if(start_band_idx == '1'){
if(band6g_support){
...
code +='<option selected="" value="0" class="content_input_fd"><#3012#></option>';
code +='<option value="1" class="content_input_fd"><#3011#></option>';
code +='</select></td>';
...
code +='<thead><tr><td colspan="4"><#3359#></td></tr></thead>';
...
var code="";
code +='<table cellspacing="0" cellpadding="4" bordercolor="#6b8fa3" border="1" align="center" width="100%" class="FormTable" id="MainTable2" style="margin-top:10px">';
code +="<thead><tr><td colspan=\"4\"><#3357#></td></tr></thead>";
code +='<tr id="target_band_text"><th width="20%"><#2466#></th>';
if('<% nvram_get("smart_connect_x"); %>' != 2 && (wl_info.band5g_2_support || wl_info.band6g_support)){
for(i = start_band_idx; i < wl_info.wl_if_total; i++){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2961#> - <#3358#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3356#></div>
<div style="text-align:right;margin-top:-36px;padding-bottom:3px;"><input type="button" class="button_gen" value="<#3700#>" onClick="pop_clientlist_listview(true)"></div>
...
<th width="20%"><#3362#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="windows_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#3269#>
</td>
</tr>
<tr>
<th><#3360#></th>
...
<th><#3361#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="dwell_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#3269#>
</td>
</tr>
</table>
<div class="apply_gen">
<input type="button" id="restoreButton" class="button_gen" value="<#3300#>" onclick="restoreRule();">
