...
document.getElementById("leftBtn").title = "<#3141#>";
}
if(endNum == client_list_row.length){
document.getElementById("rightBtn").style.visibility = "hidden";
}else{
document.getElementById("rightBtn").style.visibility = "";
document.getElementById("rightBtn").title = "<#2985#>";
}
}
...
code += '<td width="6%" class="border4"><div border="0px"><a title="<#3278#>" target="_blank" href="http://'+ client_list_col[2] +'"><img src="../images/arrow-right.png" width="32px" hight="20px" style="border:0px"></a></div></td>';
}
else
code += '';
}
