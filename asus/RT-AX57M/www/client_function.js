...
code += '<span title="Change to default client icon" onclick="card_setDefaultIcon();"><#1765#></span>';
code += '<span id="card_changeIconTitle" title="Change client icon" style="margin-left:10px;" onclick="card_show_custom_image();"><#1759#></span>';
code += '</div>';
}
code += '</td>';
...
code += "<span onmouseover='return overlib(\"" + htmlEnDeCode.htmlEncode(block_internet_hint) +"\");' onmouseout='return nd();'><#1645#></span>";
code += '</div>';
...
code += '<div id="card_internetTimeScheduling" class="internetTimeEdit" style="float:right;margin-right:10px;" title="<#3476#>"></div>';
code += '</div>';
code += '<div class="clientList_line"></div>';
code += '<div style="height:33px;width:100%;margin:5px 0;">';
code += '<div style="width:65%;float:left;line-height:33px;">';
code += "<span onmouseover='return overlib(\"" + htmlEnDeCode.htmlEncode(ip_binding_hint) +"\");' onmouseout='return nd();'><#1648#></span>";
code += '</div>';
...
code += '<input class="button_gen" type="button" style="margin-right:5px;" onclick="card_closeClientListView();" value="<#287#>">';
code += '<input id="card_client_confirm" class="button_gen" type="button" value="<#284#>">';
...
switch(rssi_t) {
case 1:
connectModeTip = "<#812#>: <#568#>\n";
break;
case 2:
connectModeTip = "<#812#>: <#569#>\n";
break;
case 3:
connectModeTip = "<#812#>: <#570#>\n";
break;
case 4:
connectModeTip = "<#812#>: <#571#>\n";
break;
}
if(stainfo_support) {
if(clientInfo.curTx != "")
...
connectModeTip += "<#976#>: " + clientInfo.wlConnectTime + "";
}
}
if(sw_mode != 4){
...
document.getElementById("card_client_ipMethod").style.display = "";
document.getElementById("card_client_ipMethod").innerHTML = "<#1653#>";
...
document.getElementById("card_client_login").innerHTML = "<#1651#>";
}
if(clientInfo.isPrinter) {
document.getElementById("card_client_printer").style.display = "";
document.getElementById("card_client_printer").innerHTML = "<#1652#>";
}
...
var opModeDes = ["none", "<#949#>", "<#555#>", "<#534#>", "<#542#>"];
...
if(confirm(stringSafeGet("<#1649#>".replace("64", manually_dhcp_maximum)))) {
...
if(confirm(stringSafeGet("<#1646#>".replace("16", parentctrl_maximum)))) {
...
document.getElementById("card_changeIconTitle").innerHTML = "<#1759#>";
}
}
}
...
code += '<thead><tr>';
code += '<td colspan="4">Client upload icon&nbsp;(<#2767#>&nbsp;100)</td>'; /*untranslated*/
code += '</tr></thead>';
code += '<tr>';
code += '<th width="45%"><#3032#></th>';
code += '<th width="30%"><#3030#></th>';
code += '<th width="15%"><#1643#></th>';
code += '<th width="10%"><#1763#></th>';
code += '</tr>';
code += '</table>';
code += '<div id="card_usericons_block"></div>';
code += '<div style="margin-top:15px;padding-bottom:10px;width:100%;text-align:center;">';
code += '<input class="button_gen" type="button" onclick="uploadIcon_cancel();" value="<#287#>">';
code += '<input class="button_gen" type="button" onclick="uploadIcon_confirm();" value="<#1779#>">';
...
code +='<tr><td style="color:#FFCC00;" colspan="4"><#2549#></td></tr>';
...
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#1501#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter clientlist_ByInterface' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#3895#></div>";
drawSwitchModeHtml += "</div>";
}
else {
drawSwitchModeHtml += "<div class='block_filter clientlist_All' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#1501#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter_pressed clientlist_ByInterface'>";
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#3895#></div>";
drawSwitchModeHtml += "</div>";
}
drawSwitchModeHtml += "</div>";
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='" + wl_colspan + "'><#1656#>";
code += "<a id='all_expander'class='clientlist_expander' onclick='showHideContent(\"clientlist_all_list_Block\", this);'>[ <#1657#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_all_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2467#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1643#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"all_list\");' style='cursor:pointer;'><#3032#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"all_list\");' style='cursor:pointer;'><#3720#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"all_list\");' style='cursor:pointer;'><#3030#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"all_list\");' style='cursor:pointer;'><#3895#></th>";
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"num\", \"all_list\");' style='cursor:pointer;'><#976#></th>";
}
code += "</tr>";
code += "</table>";
...
case "ByInterface" :
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='" + wl_colspan + "'><#3501#>";
code += "<a id='wired_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wired_list_Block\", this);'>[ <#1657#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_wired_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2467#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1643#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wired_list\");' style='cursor:pointer;'><#3032#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wired_list\");' style='cursor:pointer;'><#3720#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wired_list\");' style='cursor:pointer;'><#3030#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " ><#3895#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + "><#976#></th>";
}
code += "</tr>";
code += "</table>";
...
code += "<a id='wl" + wl_map[wl_nband_title[i]] + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wl" + wl_map[wl_nband_title[i]] + "_list_Block\", this);'>[ <#1657#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_wl" + wl_map[wl_nband_title[i]] + "_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2467#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1643#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3032#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3720#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3030#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3895#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#976#></th>";
}
code += "</tr>";
code += "</table>";
...
for(var i=1; i<multissid_count+1; i++){
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='23px'><td colspan='" + wl_colspan + "'><#374#> - " + i;
code += "<a id='gn" + i + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_gn" + i + "_list_Block\", this);'>[ <#1657#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_gn" + i + "_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2467#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1643#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3032#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3720#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3030#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3895#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#976#></th>";
}
code += "</tr>";
code += "</table>";
...
if(!top.isIE8)
code += "<div style='text-align:center;margin-top:15px;'><input type='button' class='button_gen' onclick='exportClientListLog();' value='<#1628#>'></div>";
code += "</td></tr></tbody>";
code += "</table>";
divObj.innerHTML = code;
...
document.getElementById("all_expander").innerHTML = "[ <#1658#> ]";
}
}
else {
$.each(isWL_map, function(index, value){
...
document.getElementById("wired_expander").innerHTML = "[ <#1658#> ]";
}
}
else{
if(!sorter["wl"+index+"_display"]){
document.getElementById("clientlist_wl"+index+"_list_Block").style.display = "none";
document.getElementById("wl"+index+"_expander").innerHTML = "[ <#1658#> ]";
}
}
});
if(isSupport("amas")){
...
document.getElementById("gn"+i+"_expander").innerHTML = "[ <#1658#> ]";
}
}
}
}
...
clientListCode += "<tr id='tr_" + objID + "'><td style='color:#FFCC00;' colspan='" + wl_colspan + "'><#2549#></td></tr>";
}
else {
...
document.getElementById(_obj).innerText = "<#3004#>";
}
else {
slideFlag = true;
slideUp(_controlObj, 100);
document.getElementById(_obj).innerText = "<#3005#>";
}
}
}
...
htmlCode += "<div id='" + _containerID + "_clientlist_dropdown_expand' class='clientlist_dropdown_expand' onclick='expand_hide_Client(\"" + _containerID + "_clientlist_dropdown_expand\", \"" + _containerID + "_clientlist_offline\");' onmouseover='over_var=1;' onmouseout='over_var=0;'><#3005#></div>";
...
if(document.getElementById("" + _containerID + "_clientlist_dropdown_expand").innerText == "<#3005#>") {
...
{tag:"#CLIENTLIST_ELECTRONIC_DEVICES",text:"<#1659#>"},
{tag:"#CLIENTLIST_DESKTOP",text:"<#1660#>"},
{tag:"#CLIENTLIST_WINDOWS_DESKTOP",text:"<#1661#>"},
{tag:"#CLIENTLIST_LINUX_DESKTOP",text:"<#1662#>"},
{tag:"#CLIENTLIST_LINUX_DEVICE",text:"<#1663#>"},
{tag:"#CLIENTLIST_SMARTPHONE",text:"<#1664#>"},
{tag:"#CLIENTLIST_IPHONE",text:"<#1665#>"},
{tag:"#CLIENTLIST_ASUS_SMARTPHONE",text:"<#1666#>"},
{tag:"#CLIENTLIST_WINDOWS_PHONE",text:"<#1667#>"},
{tag:"#CLIENTLIST_ANDROID_PHONE",text:"<#1668#>"},
{tag:"#CLIENTLIST_PAD",text:"<#1669#>"},
{tag:"#CLIENTLIST_IPAD",text:"<#1670#>"},
{tag:"#CLIENTLIST_ASUS_PAD",text:"<#1671#>"},
{tag:"#CLIENTLIST_ANDROID_TABLET",text:"<#1672#>"},
{tag:"#CLIENTLIST_REPEATER",text:"<#1673#>"},
{tag:"#CLIENTLIST_NAS_SERVER",text:"<#1674#>"},
{tag:"#CLIENTLIST_NB",text:"<#1675#>"},
{tag:"#CLIENTLIST_WINDOWS_NB",text:"<#1676#>"},
{tag:"#CLIENTLIST_MACBOOK",text:"<#1677#>"},
{tag:"#Clientlist_ASUS_NB",text:"<#1678#>"},
{tag:"#CLIENTLIST_SD_CARD",text:"<#1679#>"},
{tag:"#CLIENTLIST_ROG_DEVICE",text:"<#1680#>"},
{tag:"#CLIENTLIST_SCANNER",text:"<#1681#>"},
{tag:"#CLIENTLIST_APPLE_DEVICE",text:"<#1682#>"},
{tag:"#CLIENTLIST_ANDROID_DEVICE",text:"<#1683#>"},
{tag:"#CLIENTLIST_WINDOWS_DEVICE",text:"<#1684#>"},
{tag:"#CLIENTLIST_ASUS_DEVICE",text:"<#1685#>"},
{tag:"#CLIENTLIST_MEDIA_ENTERTAINMENT",text:"<#1686#>"},
{tag:"#CLIENTLIST_ELECTRONIC_EQUIPMENT",text:"<#1687#>"},
{tag:"#CLIENTLIST_AIR_CONDITIONER",text:"<#1688#>"},
{tag:"#CLIENTLIST_REFRIGERATOR",text:"<#1689#>"},
{tag:"#CLIENTLIST_WEIGHT_SCALE",text:"<#1690#>"},
{tag:"#CLIENTLIST_ELECTRIC_POT",text:"<#1691#>"},
{tag:"#CLIENTLIST_MICROWAVE_OVEN",text:"<#1692#>"},
{tag:"#CLIENTLIST_AIR_PURIFIER",text:"<#1693#>"},
{tag:"#CLIENTLIST_FAN",text:"<#1694#>"},
{tag:"#CLIENTLIST_DEHUMIDIFIER",text:"<#1695#>"},
{tag:"#CLIENTLIST_WASHING_MACHINE",text:"<#1696#>"},
{tag:"#CLIENTLIST_WATER_HEATER",text:"<#1697#>"},
{tag:"#CLIENTLIST_ELECTRIC_KETTLE",text:"<#1698#>"},
{tag:"#CLIENTLIST_SMART_BULB",text:"<#1699#>"},
{tag:"#CLIENTLIST_SMART_TV",text:"<#1700#>"},
{tag:"#CLIENTLIST_CLEANING_ROBOT",text:"<#1701#>"},
{tag:"#CLIENTLIST_SECURITY",text:"<#1702#>"},
{tag:"#CLIENTLIST_SEISMOGRAPH",text:"<#1703#>"},
{tag:"#CLIENTLIST_SMART_LOCK",text:"<#1704#>"},
{tag:"#CLIENTLIST_WEARABLES",text:"<#1705#>"},
{tag:"#CLIENTLIST_SMART_BRACELET",text:"<#1706#>"},
{tag:"#CLIENTLIST_WATCH",text:"<#1707#>"},
{tag:"#CLIENTLIST_WALL_SWITCH",text:"<#1708#>"},
{tag:"#CLIENTLIST_WINDOW_SENSOR",text:"<#1709#>"},
{tag:"#CLIENTLIST_TEMPERATURE_HUMIDITY_SENSOR",text:"<#1710#>"},
{tag:"#CLIENTLIST_BODY_SENSOR",text:"<#1711#>"},
{tag:"#CLIENTLIST_SMART_PLUG",text:"<#1712#>"},
{tag:"#CLIENTLIST_ROBOT",text:"<#1713#>"},
{tag:"#PRINTER",text:"<#1652#>"},
{tag:"#ROUTER",text:"<#1835#>"},
{tag:"#NAS",text:"<#1837#>"},
{tag:"#IPCAM",text:"<#1838#>"}
];
...
$upload_category.append($("<div>").addClass("category_title").html("<#3013#>"));
