...
var _temp = new Array();
var typeObj = {
'triBandSmartConnect': [['0', '<#3353#>', '0']],
'dualBand6GHzSmartConnect': [['0', '2.4 / 5 GHz', '0'], ['2', '6 GHz', '2']],
'dualBandSmartConnect': [['0', '<#3352#>', '0']],
'triBand5GHzSmartConnect': [['0', '2.4 GHz', '0'], ['1', '5GHz Smart Connect', '1']],
'triBandMeshSmartConnect': [['0', '<#3352#>', '0'], ['2', '5 GHz-2', '2']],
'triBand6GHzMeshSmartConnect': [['0', '<#3352#>', '0'], ['2', '6 GHz', '2']],
...
code += '<div class="info-title"><#3350#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4003#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4192#></div>';
...
code += '<div class="info-block">';
code += '<div class="info-title"><#4068#></div>';
...
if(system.band5g2Support){
if(dwb_info.mode == '1'){
_optionArray = [['<#950#>', '0'], ['<#3352#>', '1']];
if(isSupport("amas_fronthaul_network")){
var fh_ap_enabled = httpApi.nvramGet(["fh_ap_enabled"]).fh_ap_enabled;
if(fh_ap_enabled == "2")
_optionArray[1][0] = '<#3353#>';
}
}
else{
if(isSupport("wifi6e")){
_optionArray = [['<#950#>', '0'], ['<#3353#>', '1'], ['<#3352#>', '3']];
}
else if(system.modelName == 'RT-BE96U'){
_optionArray = [['<#950#>', '0'], ['<#3353#>', '1'], ['2.4 GHz and 5 GHz Smart Connect', '3']];
if(variable['smart_connect_selif_x'] == '3'){
_smart_connect_x = '3';
}
}
else{
_optionArray = [['<#950#>', '0'], ['<#3353#>', '1'], ['5GHz Smart Connect', '2']];
}
}
}
else{
