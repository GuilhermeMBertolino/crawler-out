...
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#1830#><img src="/images/InternetScan.gif"></div>';
else
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#2549#></div>';
}
...
var Modified_wired_term = wired_span.replace("<#3501#>", "<#3893#>");
...
var Modified_wireless_term = wireless_span.replace("<#3502#>", "WiFi");
...
var overlibStr = "<p><#463#>:</p>" + client.mac.toUpperCase();
if(client.ssid)
overlibStr += "<p>SSID:</p>" + client.ssid.replace(/"/g, '&quot;');
if(client.isLogin)
overlibStr += "<p>Logged In User:</p>YES";
if(client.isPrinter)
overlibStr += "<p><#1832#></p>YES";
if(client.isITunes)
overlibStr += "<p><#1831#></p>YES";
if(client.isWL > 0){
overlibStr += "<p><#3992#>:</p>" + isWL_map[client.isWL]["text"].replace("G", " GHz") + " (" + client.rssi + " dBm)";
if(stainfo_support) {
overlibStr += "<p>Tx Rate:</p>" + ((client.curTx != "") ? client.curTx : "-");
overlibStr += "<p>Rx Rate:</p>" + ((client.curRx != "") ? client.curRx : "-");
overlibStr += "<p><#976#>:</p>" + client.wlConnectTime;
}
}
return overlibStr;
}
...
overlibStrTmp += "<p><span>.....................................</span></p><p style='margin-top:5px'><#2795#> :</p>";
...
<#3501#>&nbsp;(<b style="font-size:10px;" id="tabWiredNum">0</b>)
</span>
</div>
<script>
...
<#3502#>&nbsp;(<b style="font-size:10px;" id="tabWirelessNum">0</b>)
</span>
...
<input type="button" id="refresh_list" class="button_gen" value="<#1782#>" style="margin-left:70px;">
<script>
