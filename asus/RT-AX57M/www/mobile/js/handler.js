...
{
$("#settingProfileBar").showSelectorHint("<#3306#>");
return false;
}
...
$("#verify_pincode_status").html("<#2914#>");
...
break;
case '4':
$("#verify_pincode_status").html("<#2852#>");
break;
case '6':
$("#verify_pincode_status").html("<#2912#>");
break;
case '-1':
$("#verify_pincode_status").html("<#2887#>");
break;
case '-2':
case '-10':
$("#verify_pincode_status").html("<#2885#>");
break;
default:
break;
}
...
$("#verify_pincode_status").html("<#2624#>");
$("#verify_pincode_status").css("display", "");
return false;
}
else{
...
$("#new_pincode_status").html("<#2858#>");
else
$("#new_pincode_status").html("<#2624#>");
...
$("#login_name #http_username_title").html("<#2444#>");
...
if(isSupport("concurrep"))
$("#siteSurvey_page").find(".titleSub").html("<#4383#>");
else
$("#siteSurvey_page").find(".titleSub").html("<#4051#>");
...
if(isSupport("RPMesh"))
$("#papList_page").find(".titleSub").html("<#4383#>");
else
$("#papList_page").find(".titleSub").html("<#4051#>");
genPAPList(systemVariable.papList, systemVariable.multiPAP.wlcOrder);
