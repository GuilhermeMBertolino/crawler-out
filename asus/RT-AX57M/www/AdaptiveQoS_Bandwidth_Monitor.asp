...
setTimeout(function(){
if(loop_count >= 60) {
$("#sortable").html("<div style='text-align:center;color:#FFCC00'><#2549#></div>");
return false;
}
if(totalClientNum.online != 0)
show_clients();
...
<div style="font-size: 14px;margin-right:8px;"><#3401#></div>
<div>
...
<div style="margin:-10px 0 5px 70px;font-size:16px;text-align:center;"><#3642#></div>
...
<div style="font-size:14px;margin-right:8px;"><#3252#></div>
<div>
...
<table>
<tr>
<td><div class="qos_tab" style="width:110px;border-radius:10px;"><#3331#></div></td>
</tr>
</table>
</div>
</td>
