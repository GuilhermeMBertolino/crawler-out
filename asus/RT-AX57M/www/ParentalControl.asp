...
<title id="web_title"><#944#> - <#564#></title>
...
document.getElementById('content_title').innerHTML = "<#564#> - <#3476#>";
document.getElementById('desc_title').innerHTML = "<#3024#>";
document.getElementById('web_title').innerHTML = "<#944#> - <#3476#>";
document.getElementById('PC_enable').innerHTML = "<#3022#>";
}
if(isSupport("PC_SCHED_V3")){
$("#desc_title").html("<#3034#>");
var $desc_item = $("#desc_item").empty();
$("<li>").html("<#3035#>").appendTo($desc_item);
$("<li>").html("<#3026#>").appendTo($desc_item);
$("<li>").html("<#3036#>").appendTo($desc_item);
$("<li>").html("<#3037#>").appendTo($desc_item);
...
code +='<thead><tr><td colspan="4"><#1735#>&nbsp;(<#2767#>&nbsp;'+MaxRule_parentctrl+')</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#3273#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#3273#></option>';
code += '<option value="0"><#1625#></option>';
code += '<option value="1"><#1877#></option>';
code += '<option value="2"><#1546#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1642#> (<#3118#>)</th>';
code +='<th width="20%"><#3031#></th>';
code +='<th width="20%"><#2766#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1625#></option>';
code += '<option value="1" selected><#1877#></option>';
code += '<option value="2"><#1546#></option>';
code += '</select>';
code += '</td>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#3276#>">';
...
code += '<option value="0" ' + ((client_time_obj.enable == "0") ? "selected" : "") + '><#1625#></option>';
code += '<option value="1" ' + ((client_time_obj.enable == "1") ? "selected" : "") + '><#1877#></option>';
code += '<option value="2" ' + ((client_time_obj.enable == "2")? "selected" : "") + '><#1546#></option>';
code += '</select>';
code += '</td>';
...
$("#mainTable").fadeIn();
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="applyRule(1);" value="<#284#>">';
showDropdownClientList('setClientIP', 'mac', 'all', 'ClientList_Block_PC', 'pull_arrow', 'all');
showclock();
}
function selectAll(){
...
var hint = "<#4432#>".replace("#MAXNUM", weekScheduleApi.data_max);
hint += "\n";
hint += "<#4433#>";
alert(hint);
return false;
...
code += "<span class=\"clicked\"><#3476#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#1313#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#3476#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1313#></span>";
}
...
<tr>
<td align="left">
<div id="content_title" class="formfonttitle" style="width:400px"><#564#></div>
</td>
<td>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1313#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#3476#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<div style="font-size:14px;margin-left:6px;margin-bottom:6px;"><#3039#></div>
...
<div id="svc_hint_div" style="display:none;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" class="hint-color" style="text-decoration:underline;cursor:pointer;"><#372#></span></div>
