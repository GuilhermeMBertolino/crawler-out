...
<div class="formfontdesc"><#2942#></div>
...
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_pptp", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_l2tp", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_ipsec", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_rtsp", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_h323", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr>
<tr>
...
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_sip", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr>
<tr>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,11);"><#3130#></a></th>
<td>
...
<option class="content_input_fd" value="1"<% nvram_match("fw_pt_pppoerelay", "1","selected"); %>><#4070#></option>
</select>
</td>
</tr>
<tr>
