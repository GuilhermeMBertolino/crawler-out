...
document.getElementById('NM_connect_title').innerHTML = "<#3015#> :";
}
else{
...
if(gobi_support)
document.getElementById("first_wan_title").innerHTML = "<#2900#>:";
else
...
if(gobi_support)
document.getElementById("second_wan_title").innerHTML = "<#2900#>:";
else
...
document.getElementById("ddnsHostName").innerHTML = '<a style="color:#FFF;text-decoration:underline;" href="/Advanced_ASUSDDNS_Content.asp?af=DDNSName"><#3338#></a>';
...
if(sw_mode == "3"){
showtext(document.getElementById("NM_connect_status"), "<div style='margin-top:10px;'><#4081#></div>");
}
else if(sw_mode == "2"){
...
if(bwdpi_support) {
document.getElementById("time_scheduling_title").innerHTML = "<#3476#>";
}
...
<thead>
<tr>
<td colspan="4">Client upload icon&nbsp;(<#2767#>&nbsp;100)</td>
</tr>
</thead>
<tr>
<th width="45%"><#1642#></th>
...
<div style="height:32px;width:100%;margin:5px 0;">
<div style="width:65%;float:left;line-height:32px;">
<span id="time_scheduling_title" onmouseover='return overlib("<#3024#>");' onmouseout="return nd();"><#564#></span>
</div>
<div align="center" class="left" style="cursor:pointer;float:right;" id="radio_TimeScheduling_enable"></div>
<div id="internetTimeScheduling" class="internetTimeEdit" style="float:right;margin-right:10px;" title="<#3476#>" onclick="redirectTimeScheduling(document.getElementById('macaddr_field').value);" ></div>
</div>
<div class="clientList_line"></div>
<div style="height:32px;width:100%;margin:5px 0;">
<div style="width:65%;float:left;line-height:32px;">
...
<div>
<span id="NM_connect_title" style="font-size:12px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#3408#>:</span>
<br>
...
<span style="font-size:12px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#2599#>:</span><br>
...
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#2465#>:</span>
...
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#3270#>: </span>
<br/>
...
<div class="block_all_icon"><div><#3043#></div></div>
...
<input type="button" class="button_gen" value="<#3700#>" style="margin-top:15px;" onClick="pop_clientlist_listview(true)">
