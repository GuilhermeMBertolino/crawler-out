...
desclist.push(["<#3519#>/<#474#>","Traffic Analyzer/Manager"]);
...
desclist.push(["<#499#>/<#3679#>","USB dongle"]);
...
if(hours)
remaining_time_str += hours + " <#2420#> ";
if(minutes)
remaining_time_str += minutes + " <#2816#> ";
if(seconds)
remaining_time_str += seconds + " <#3269#> ";
return remaining_time_str;
};
...
selectOption = {"1 <#2420#>" : hour_to_sec(1)};
}
if(usb_support && $("input[name=dblog_tousb_cb]").prop("checked")) {
baseOption = { "12 <#2420#>" : hour_to_sec(12), "1 <#1804#>" : hour_to_sec(24), "2 <#1804#>" : hour_to_sec(48), "3 <#1804#>" : hour_to_sec(72) };
}
else {
baseOption = { "6 <#2420#>" : hour_to_sec(6), "12 <#2420#>" : hour_to_sec(12), "24 <#2420#>" : hour_to_sec(24) };
}
...
<div>&nbsp;</div>
<div class="formfonttitle"><#506#> - <#2805#></div>
...
<br>
<span id="storage_ready" class="hint-color" style="display:none;">* <#3677#></span>
<span id="be_lack_storage" class="hint-color" style="display:none;">* <#2988#></span>
</td>
</tr>
...
<option value="3600">1 <#2420#></option>
<option value="18000">5 <#2420#></option>
<option value="43200">12 <#2420#></option>
<option value="86400">24 <#2420#></option>
<option value="172800">48 <#2420#></option>
</select>
</td>
</tr>
...
<span class="noUSBHint hint-color">* <#2988#></span>
</div>
