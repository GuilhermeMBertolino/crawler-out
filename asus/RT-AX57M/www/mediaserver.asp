...
<link rel="icon" href="images/favicon.png"><title><#944#> - <#880#></title>
...
<td><div id="modifyFolderBtn" class="modifyFolderBtn" title="<#2922#>"></div></td>
</tr>
</table>
</div>
</td></tr></table>
...
<span class="formfonttitle" style="margin-left: 8px;"><#880#></span>
<span id="returnBtn">
<img id="returnBtn" onclick="go_setting('/APP_Installation.asp')" align="right" title="<#475#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</span>
</div>
<div id="splitLine" class="splitLine"></div>
<div id="upnp_desc_id" class="formfontdesc" style="margin-top: 10px; margin-left: 8px;"><#3647#></div>
</td>
</tr>
<tr>
<td>
...
<div id="noUSB" style="color:#FC0;display:none;margin-left:17px;padding-top:2px;padding-bottom:2px;"><#2988#></div>
</td>
</tr>
<tr>
<th><#1888#></th>
...
<th><#1890#></th>
<td>
<input type="radio" value="0" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "0", "checked"); %>><#1891#>
<input type="radio" value="1" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "1", "checked"); %>><#1889#>
</td>
</tr>
</table>
</div>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1889#>&nbsp;(<#2767#>&nbsp;10)</td>
</tr>
</thead>
<tr>
<th><#1886#></th>
...
<tr>
<td width="45%">
<input id="PATH" type="text" class="input_30_table" value="" onclick="get_disk_tree();" autocorrect="off" autocapitalize="off" readonly="readonly"/" placeholder="<#824#>" >
</td>
<td width="40%">
...
<div id="apply_btn">
<input type="button" class="button_gen" onclick="applyRule()" value="<#284#>"/>
</div>
</td>
</tr>
<tr>
