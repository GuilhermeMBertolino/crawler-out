...
code += '<div class="table-cell"><#1347#></div>';
...
code += '</div></div>';
code += '<div class="table-cell" data-title="<#1347#>">'+ dataObj[eventID].level +'</div>';
code += '<div class="table-cell" data-title="Type">'+ direct_type[dataObj[eventID].attackType] +'</div>';
code += '<div class="table-cell" data-title="<#1309#>">'+ dataObj[eventID].source[0] +'</div>';
code += '<div class="table-cell" data-title="<#1308#>">'+ dataObj[eventID].destination[0] +'</div>';
code += '<div class="table-cell" data-title="<#1310#>">'+ dataObj[eventID].title +'</div>';
code += '</div>';
}
}
else{
$('#deleteData').hide();
code += '<div class="no-data"><#2549#></div>';
}
