...
statusmenu ="<span><#3959#></span>".replace("#WAN", "1G WAN");
else
statusmenu ="<span><#3959#></span>".replace("#WAN", "WAN");
}
else if(itemNum == 102){
statusmenu ="<span><#3960#></span>".replace(/LAN-*\D* 4/, wanAggr_p2_name(orig_wanports_bond));
}
if(itemNum == 50){
...
statusmenu += "<div class='StatusHint'><#2860#></div>";
}
else if(usb_state == 2 && usb_sbstate == 0 && usb_auxstate != 1){
statusmenu += "<div class='StatusHint'><#277#> <#2435#>: </div><span>" + decodeURIComponent(modem_act_provider) + "</span>";
}
else{
...
statusmenu += "<div class='StatusHint'><#2912#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2887#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2885#></div>";
else
statusmenu += "<div><#2829#></div>";
}
if(itemNum == 24)
...
statusmenu += "<span>" + lineDesc + "</span>";
statusmenu += "<div class='StatusHint'><#2926#> :</div>";
lineDesc = ""; /* Untranslated */
...
statusmenu += "<div><#3149#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2987#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2926#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1804#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2420#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2816#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#2420#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2816#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2816#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2816#>';
}
statusmenu += ")</span><br>";
}
}
...
this.hint = "<#1638#> : <#3084#> "+wans_lanport;
}
else
this.hint = "<#3171#>";
}
...
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3084#> "+wans_lanport+") - </div>";
...
statusmenu = "<div class='StatusHint'><#3408#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#2013#> - </b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#3084#> "+wans_lanport+") - </div>";
...
if( statusmenu == "" )
statusmenu = "<div class='StatusHint'><#2988#></div>";
return overlib(statusmenu, OFFSETX, -160, LEFT, DELAY, 400);
});
}
if( statusmenu != "" )
...
return "<#2926#> : <span>0</span> <#2420#> <span>0</span> <#2816#>";
else
return "<#2926#> : <span>"+EHours+"</span> <#2420#> <span>"+EMinutes+"</span> <#2816#>";
}
...
if(gobi_support){
statusmenu += "<#2883#></span>"
_caption = "<#2900#>";
}
else{
statusmenu += "<#2353#></span>"
_caption = "<#499#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#2352#></span>";
...
statusmenu += "<b><#3084#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#499#> -</b><br>";
}
...
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#3084#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2900#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1985#>:</div>";
if( wans_dualwan_array[1] == "wan")
...
statusmenu += "<ol>";
if(based_modelid == "RT-AXE7800")
statusmenu += "<li><#3963#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "1G WAN");
else
statusmenu += "<li><#3963#></li>".replace("LAN 4", wanAggr_p2_name(orig_wanports_bond)).replace("#WAN", "WAN");
statusmenu += "<li><#3964#></li>";
