...
code += '</div>';
if(dataObj == ""){
code += '<div style="text-align:center;font-size:16px;color:#FC0;margin-top:90px;"><#2549#></div>';
}
else{
...
<div style="font-size: 24px;"><#3971#></div>
...
<span style="font-size: 24px;padding-right:12px;"><#3971#></span>
<span style="font-size: 14px;"><#2965#>: <b id="list_count">0</b> (<#2767#>&nbsp;64)</span>
</div>
