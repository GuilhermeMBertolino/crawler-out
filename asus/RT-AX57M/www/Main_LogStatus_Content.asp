...
<div>&nbsp;</div>
<div class="formfonttitle"><#847#> - <#512#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2350#></div>
...
<tr>
<th><#2349#></a></th>
<td><span id="boot_days"></span> <#1804#> <span id="boot_hours"></span> <#2420#> <span id="boot_minutes"></span> <#2816#> <span id="boot_seconds"></span> <#3269#></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11,1)"><#2736#></a></th>
<td>
...
<div class="hint-color"><#2737#></div>
</td>
</tr>
</table>
</form>
<div style="margin-top: 5px; text-align: center;"><input class="button_gen" onclick="applySettings();" type="button" value="<#284#>" /></div>
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1761#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1780#>" class="button_gen">
</form>
</td>
</tr>
</table>
