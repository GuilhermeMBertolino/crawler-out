...
document.getElementById("loginMethod").innerHTML = "<#1075#>";
document.getElementById("accountMask").style.display = "none";
}
else{
document.getElementById("loginMethod").innerHTML = "<#1074#>";
...
document.getElementById("createAccountBtn").onmouseover = function(){};
document.getElementById("createAccountBtn").onmouseout = function(){};
document.getElementById("createAccountBtn").title = (accounts.length < 6)?"<#1013#>":"<#979#>";
}
...
<span class="formfonttitle"><#495#> - <#496#><span id="clouddiskstr"> / <#1715#></span></span>
...
<div class="formfontdesc" style="margin-top: 10px;"><#3249#></div>
<div id="smbv1_hint" class="formfontdesc"><#1023#>&nbsp;<#3250#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,2);"><#3316#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(17,3);"><#3329#></a>
</th>
<td>
...
<option class="content_input_fd" value="0" <% nvram_match("usb_fs_ntfs_sparse", "0","selected"); %>><#4072#></option>
<option class="content_input_fd" value="1" <% nvram_match("usb_fs_ntfs_sparse", "1","selected"); %>><#4071#></option>
</select>
</td>
</tr>
</table>
