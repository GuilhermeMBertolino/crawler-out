...
showtext(document.getElementById("proceeding_main_txt"), "<#464#>...");
...
showtext(document.getElementById("proceeding_main_txt"), "<#467#>");
showtext(document.getElementById("proceeding_txt"), Math.round(y)+"% <#464#>");
--seconds;
setTimeout("LoadingTime("+seconds+", '"+flag+"');", 1000);
}
else{
showtext(document.getElementById("proceeding_main_txt"), translate("<#466#>"));
