...
<div>&nbsp;</div>
<div class="formfonttitle"><#478#> - <#3978#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3198#></div>
...
<thead>
<tr>
<td colspan="2"><#3978#>&nbsp;(<#2768#>&nbsp;64)</td>
</tr>
</thead>
<tr>
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1642#> (<#3119#>)</a></th>
<th width="20%"><#2767#></th>
</tr>
<tr>
<td width="80%">
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullWLMACList(this);" title="<#3285#>">
