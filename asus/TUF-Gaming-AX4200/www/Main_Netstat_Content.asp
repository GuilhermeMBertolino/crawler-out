...
<th width="20%"><#2974#></th>
<td>
<input type="checkbox" class="options" value="00000001"><#3341#>
<br>
<input type="checkbox" class="options" value="00000010"><#3340#>
<br>
<input type="checkbox" class="options" value="00001000"><#3344#>
<br>
<input type="checkbox" class="options" value="00010000"><#3345#>
<br>
<input type="checkbox" class="options" value="00100000"><#3343#>
<br>
<input type="checkbox" class="options" value="01000000"><#3346#>
<br>
<input type="checkbox" class="options" value="10000000"><#1884#>
<br>
<input type="checkbox" class="options" value="00000100"><#3342#>
</td>
</tr>
</table>
<div class="apply_gen" style="height:40px">
<input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2968#>">
<script>
