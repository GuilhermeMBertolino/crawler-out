...
<title><#944#> - WireGuard Client</title>
...
<td>
<input type="radio" value="1" name="wgc_enable" class="input" <% nvram_match("wgc_enable", "1", "checked"); %>><#275#></input>
<input type="radio" value="0" name="wgc_enable" class="input" <% nvram_match("wgc_enable", "0", "checked"); %>><#274#></input>
</td>
</tr>
<tr id="wgc_nat">
<th><#1993#></th>
<td>
<input type="radio" value="1" name="wgc_nat" class="input" <% nvram_match("wgc_nat", "1", "checked"); %>><#275#></input>
<input type="radio" value="0" name="wgc_nat" class="input" <% nvram_match("wgc_nat", "0", "checked"); %>><#274#></input>
</td>
</tr>
</table>
