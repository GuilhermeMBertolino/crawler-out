...
document.getElementsByClassName("model-name")[0].innerHTML = "<#945#>";
}
...
if(flag == 3){
document.getElementById("error_status_field").innerHTML ="<div class='error-text'>* <#2633#></div>";
}
else if(flag == 7){
...
return "<div>* <#2776#> " + loginUserIp + hostName + "</div>";
};
document.getElementById("login_filed").style.display ="none";
document.getElementById("hint_field").style.display ="";
var element = document.createElement('div');
...
<div class="login-title" style="display:none"><#298#></div>
<div id="login_filed">
<div class="login-title-desc"><#825#></div>
<div id="name_title_ie" style="display:none" class="p1"><#3690#></div>
<div class="input-container">
<input type="text" id="login_username" name="login_username" tabindex="1" class="form-input" maxlength="128" autocapitalize="off" autocomplete="off" placeholder="<#3690#>">
</div>
<div id="password_title_ie" style="display:none" class="p1"><#2438#></div>
<div class="input-container">
<input type="password" name="login_passwd" tabindex="2" class="form-input" maxlength="128" placeholder="<#2438#>" autocapitalize="off" autocomplete="off">
</div>
...
<div id="button" class="login-btn-bg" onclick="login();"><#298#></div>
</div>
