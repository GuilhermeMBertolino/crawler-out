...
if(wan_lanport_text!= ""){
var hint_str1 = "<#3098#>";
var hint_str2 = "<#1637#>".replace("setting_link", "setting_link_1");
...
document.getElementById("setting_link_1").href = "http://"+"<#946#>"+"/Advanced_WANPort_Content.asp";
...
var hint_str1 = "<#3099#>";
var hint_str2 = "<#1637#>".replace("setting_link", "setting_link_2");
var note_str = hint_str1.replace("%1$@", "<#2939#>").replace("%2$@", "IPTV") + " " + hint_str2;
...
document.form.lacp_enabled.style.display = "none";
document.getElementById("lacp_note").innerHTML = note_str;
document.getElementById("setting_link_2").href = "http://"+"<#946#>"+"/Advanced_IPTV_Content.asp";
document.getElementById("lacp_desc").style.display = "";
...
var desc = [ "<#241#>", "1Gbps", "2.5Gbps", "10Gbps" ];
...
document.getElementById("natAccelDesc").innerHTML = "<#2934#>";
}
else{
document.getElementById("natAccelDesc").innerHTML = "<#2930#>";
}
}
else if(mtk_support){
...
var nataccel_status = '<% nat_accel_status(); %>';
if(nataccel == '1' && nataccel_status == '1'){
document.getElementById("MTKnatAccelDesc").innerHTML = "<#2934#>";
}
else{
document.getElementById("MTKnatAccelDesc").innerHTML = "<#2930#>";
}
}
else{
...
if(ctf_disable == 1){
document.getElementById("ctfLevelDesc").innerHTML = "<#2930#>";
}
else{
if(ctf_fa_mode == '2')
document.getElementById("ctfLevelDesc").innerHTML = "<#2932#>";
else
document.getElementById("ctfLevelDesc").innerHTML = "<#2931#>";
}
}
if (re_mode == "1"){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#485#> - <#3425#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3429#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr id="jumbo_tr">
<th><#2648#></th>
<td>
<select name="jumbo_frame_enable" class="input_option">
<option class="content_input_fd" value="0" <% nvram_match("jumbo_frame_enable", "0","selected"); %>><#4072#></option>
<option class="content_input_fd" value="1" <% nvram_match("jumbo_frame_enable", "1","selected"); %>><#4071#></option>
</select>
</td>
</tr>
<tr id="ctf_tr" style="display: none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,2);"><#2928#></a></th>
<td>
<select name="ctf_disable_force" class="input_option" disabled>
<option class="content_input_fd" value="1" <% nvram_match("ctf_disable_force", "1","selected"); %>><#4072#></option>
<option class="content_input_fd" value="0" <% nvram_match("ctf_disable_force", "0","selected"); %>><#241#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("qca_sfe", "0","selected"); %>><#4072#></option>
<option class="content_input_fd" value="1" <% nvram_match("qca_sfe", "1","selected"); %>><#4071#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("hwnat", "0","selected"); %>><#4072#></option>
<option class="content_input_fd" value="1" <% nvram_match("hwnat", "1","selected"); %>><#241#></option>
</select>
&nbsp
...
<th><#3430#></th>
<td>
<input type="radio" name="gro_disable_force" value="0" <% nvram_match("gro_disable_force", "0", "checked"); %>><#275#>
<input type="radio" name="gro_disable_force" value="1" <% nvram_match("gro_disable_force", "1", "checked"); %>><#274#>
</td>
</tr>
<tr id="lacp_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,1);"><#2939#></a></th>
<td>
<select name="lacp_enabled" class="input_option" onchange="check_bonding_policy(this);" disabled>
<option class="content_input_fd" value="0" <% nvram_match("lacp_enabled", "0","selected"); %>><#4072#></option>
<option class="content_input_fd" value="1" <% nvram_match("lacp_enabled", "1","selected"); %>><#4071#></option>
</select>
<div id="lacp_desc" style="display:none"><span id="lacp_note"><#2942#></span><div>
</td>
</tr>
...
<option value="0"><#1765#></option>
<option value="1"><#3428#></option>
<option value="2"><#3427#></option>
</select>
</td>
</tr>
</table>
...
<option value="0" <% nvram_match("aqr_hwnat_type", "0","selected"); %>><#241#></option>
...
<option value="0" <% nvram_match("aqr_link_speed", "0","selected"); %>><#241#></option>
...
<option value="96" <% nvram_match("aqr_ipg", "96","selected"); %>><#1765#></option>
...
<option value="0" <% nvram_match("sfpp_hwnat_type", "0","selected"); %>><#241#></option>
...
<option value="0" <% nvram_match("sfpp_max_speed", "0","selected"); %>><#241#></option>
...
<th>TX clock</th><td>
<input type="radio" name="sfpp_force_on" value="0" <% nvram_match("sfpp_force_on", "0", "checked"); %>><#241#>
