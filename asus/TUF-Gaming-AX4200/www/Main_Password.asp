...
<div class="login-title"><#3045#></div>
</div>
<div class="login-title-desc">
<div class="desc"><#945#> is currently not protected and uses an unsafe default username and password.</div>
<div class="desc"><#689#></div>
<div id="KRHint" class="desc" style="display: none;"><#431#></div>
</div>
<div>
<div id="router_name_tr" style="display:none" class="p1"><#818#></div>
<div class="input-container">
<input type="text" id="http_username_x" name="http_username_x" tabindex="1" class="form-input" maxlength="32" autocapitalize="off" autocomplete="off" placeholder="<#818#>">
</div>
<div id="router_password_tr" style="display:none" class="p1"><#565#></div>
<div class="input-container">
<input type="password" id="http_passwd_x" name="http_passwd_x" tabindex="2" class="form-input" maxlength="33" autocapitalize="off" autocomplete="off" placeholder="<#565#>">
</div>
<div id="router_password_confirm_tr" style="display:none" class="p1"><#1732#></div>
<div class="input-container">
<input type="password" id="http_passwd_2_x" name="http_passwd_2_x" tabindex="3" class="form-input" maxlength="33" autocapitalize="off" autocomplete="off" placeholder="<#1732#>">
</div>
...
<div id="btn_modify" class="login-btn-bg" onclick="submitForm();"><#292#></div>
