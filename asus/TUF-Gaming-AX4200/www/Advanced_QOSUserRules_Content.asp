...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2811#> - <#2032#>";
}
else{
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2791#>");
return false;
}
}
replace_symbol();
...
alert("<#3712#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#2419#></option>';
else
code += '<option value="0"><#2419#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#2418#></option>';
else
code += '<option value="1"><#2418#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2804#></option>';
else
code += '<option value="2"><#2804#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2780#></option>';
else
code += '<option value="3"><#2780#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2781#></option>';
else
code += '<option value="4"><#2781#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#3178#></option>
<option value="3"><#3177#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1615#>&nbsp;(<#2768#>&nbsp;32)</td>
...
<th><div class="table_text"><#2543#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#3694#></div></a></th>
<th><#1619#></th>
<th><#2767#></th>
</tr>
<tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullQoSList(this);" title="<#3282#>">
...
<img id="pull_arrow_mac" class="pull_arrow"height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#3277#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#2419#></option>
<option value='1' selected><#2418#></option>
<option value='2'><#2804#></option>
<option value='3'><#2780#></option>
<option value='4'><#2781#></option>
</select>
</td>
<td width="6%">
