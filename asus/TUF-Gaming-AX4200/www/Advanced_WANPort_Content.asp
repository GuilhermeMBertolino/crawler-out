...
var hint_str = "<#3097#>";
var confirm_str = hint_str.replace("%1$@", conflict_lanport_text).replace("%2$@", "<#489#>").replace("%3$@", "<#2939#>");
...
$("#fo_detection_count_hd").html("<#2967#>");
$("#wandog_maxfail_setting").html(new_html_str);
}
...
<tr><td colspan="2"><#3397#></td></tr><tr><td colspan="2"><#3398#>&nbsp;:&nbsp;<span id="str_detect_time"></span>&nbsp;<#3270#>.</td></tr>
<tr>
<th style="width:30%;"><#3405#></th>
<td>
<input type="text" name="detect_interval" class="input_3_table" maxlength="1" value=""; placeholder="5" autocorrect="off" autocapitalize="off" onKeyPress="return validator.isNumber(this, event);" onblur="update_str_time();" style="width: 38px; margin: 0px;">&nbsp;&nbsp;<#3270#>
</td>
</tr>
<tr>
<th><#3407#></th>
...
<span id="detect_tail_msg">&nbsp;( Detection Time: <span id="detection_time_value"></span>&nbsp;&nbsp;<#3270#>)</span>
</td>
</tr>
</table>
...
<div id="wan_aggre_desc" class="formfontdesc" style="color:#FFCC00; display:none;"><#3962#></div>
...
<option value="1" <% nvram_match("wans_standby", "1", "selected"); %>><#4071#></option>
<option value="0" <% nvram_match("wans_standby", "0", "selected"); %>><#4072#></option>
</select>
</td>
</tr>
<tr>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,3);"><#3406#></a></th>
...
<img id="pull_arrow" class="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullPingTargetList(this);" title="<#3281#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
