...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2768#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2628#> " + _createRuleCount + " <#2629#>");
return;
}
...
$titleHtml.html("<#2618#>");/*untranslated*/
...
$actionButtonCancelHtml.html("<#287#>");
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#3006#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2621#>");
return false;
}
}
