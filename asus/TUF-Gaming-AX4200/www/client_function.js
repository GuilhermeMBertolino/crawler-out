...
code += '<div id="card_internetTimeScheduling" class="internetTimeEdit" style="float:right;margin-right:10px;" title="<#3477#>"></div>';
code += '</div>';
code += '<div class="clientList_line"></div>';
code += '<div style="height:33px;width:100%;margin:5px 0;">';
code += '<div style="width:65%;float:left;line-height:33px;">';
...
code += '<thead><tr>';
code += '<td colspan="4">Client upload icon&nbsp;(<#2768#>&nbsp;100)</td>'; /*untranslated*/
code += '</tr></thead>';
code += '<tr>';
code += '<th width="45%"><#3033#></th>';
code += '<th width="30%"><#3031#></th>';
...
code +='<tr><td style="color:#FFCC00;" colspan="4"><#2550#></td></tr>';
...
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#3896#></div>";
drawSwitchModeHtml += "</div>";
}
else {
...
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#3896#></div>";
drawSwitchModeHtml += "</div>";
}
drawSwitchModeHtml += "</div>";
...
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2468#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1643#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"all_list\");' style='cursor:pointer;'><#3033#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"all_list\");' style='cursor:pointer;'><#3721#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"all_list\");' style='cursor:pointer;'><#3031#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"all_list\");' style='cursor:pointer;'><#3896#></th>";
...
case "ByInterface" :
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='" + wl_colspan + "'><#3502#>";
...
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2468#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1643#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wired_list\");' style='cursor:pointer;'><#3033#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wired_list\");' style='cursor:pointer;'><#3721#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wired_list\");' style='cursor:pointer;'><#3031#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " ><#3896#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2468#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1643#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3033#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3721#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3031#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3896#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#2468#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1643#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3033#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3721#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3031#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"gn"+i+"_list\");' style='cursor:pointer;'><#3896#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
clientListCode += "<tr id='tr_" + objID + "'><td style='color:#FFCC00;' colspan='" + wl_colspan + "'><#2550#></td></tr>";
}
else {
...
document.getElementById(_obj).innerText = "<#3006#>";
}
}
}
...
htmlCode += "<div id='" + _containerID + "_clientlist_dropdown_expand' class='clientlist_dropdown_expand' onclick='expand_hide_Client(\"" + _containerID + "_clientlist_dropdown_expand\", \"" + _containerID + "_clientlist_offline\");' onmouseover='over_var=1;' onmouseout='over_var=0;'><#3006#></div>";
...
if(document.getElementById("" + _containerID + "_clientlist_dropdown_expand").innerText == "<#3006#>") {
...
$upload_category.append($("<div>").addClass("category_title").html("<#3014#>"));
