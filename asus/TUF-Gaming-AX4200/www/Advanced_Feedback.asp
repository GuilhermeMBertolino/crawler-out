...
infolist = new Array();
infolist.push(["<#824#> ...","No_selected"]);
infolist.push(["<#2108#>","phone"]);
infolist.push(["QQ","qq"]);
infolist.push(["<#3971#>","wechat"]);
...
ptypelist = new Array();
ptypelist.push(["<#824#> ...", "No_selected"]);
ptypelist.push(["<#2113#>", "Setting_Problem"]);
ptypelist.push(["<#2057#>", "Connection_or_Speed_Problem"]);
ptypelist.push(["<#2049#>", "Compatibility_Problem"]);
ptypelist.push(["<#2117#>", "Suggestion"]);
ptypelist.push(["<#2128#>", "Technical_Support"]);
ptypelist.push(["<#999#>", "Other_Problem"]);
...
url_group = new Array();
timelist = new Array();
desclist.push(["<#824#> ...","No_selected"]);
url_group.push(["select"]);//false value
if(ptype == "Setting_Problem"){
desclist.push(["<#589#>","QIS"]);
url_group.push(["QIS"]);
desclist.push(["<#476#>","Network Map"]);
url_group.push(["index"]);
desclist.push(["<#374#>","Guest Network"]);
url_group.push(["Guest_network"]);
desclist.push(["<#1390#>","AiProtection"]);
url_group.push(["AiProtection"]);
desclist.push(["<#1000#>","Adaptive QoS"]); //5
url_group.push(["AdaptiveQoS"]);
desclist.push(["<#2032#>","Traditional QoS"]);
url_group.push(["AiProtection"]);
desclist.push(["<#993#>","Gaming"]);
url_group.push(["GameBoost"]);
desclist.push(["<#3520#>/<#474#>","Traffic Analyzer/Manager"]);
url_group.push(["TrafficMonitor"]);
desclist.push(["<#564#>","Parental Ctrl"]);
url_group.push(["ParentalControl"]);
desclist.push(["<#475#>","USB Application"]); //10
...
desclist.push(["<#478#>","Wireless"]);
url_group.push(["ACL", "WAdvanced", "Wireless", "WMode", "WSecurity", "WWPS"]);
desclist.push(["<#489#>","WAN"]);
url_group.push(["WAN_", "PortTrigger", "VirtualServer", "Exposed", "NATPassThrough"]);
desclist.push(["<#312#>","Dual WAN"]); //15
url_group.push(["WANPort"]);
desclist.push(["<#485#>","LAN"]);
url_group.push(["LAN", "DHCP", "GWStaticRoute", "IPTV", "SwitchCtrl"]);
desclist.push(["<#499#>/<#3680#>","USB dongle"]);
url_group.push(["Modem"]);
desclist.push(["<#1901#>","DM"]);
url_group.push(["DownloadMaster"]);//false value
desclist.push(["<#494#>","DDNS"]);
url_group.push(["DDNS"]);
desclist.push(["IPv6","IPv6"]); //20
url_group.push(["IPv6"]);
desclist.push(["VPN","VPN"]);
url_group.push(["VPN"]);
desclist.push(["<#500#>","Firewall"]);
url_group.push(["Firewall", "KeywordFilter", "URLFilter"]);
desclist.push(["<#506#>","Administration"]);
url_group.push(["OperationMode", "System", "SettingBackup"]);
desclist.push(["<#847#>","System Log"]);
url_group.push(["System"]);
desclist.push(["<#2962#>","Network Tools"]); //25
url_group.push(["Status_"]);
desclist.push(["<#3186#>","Rescue"]);
url_group.push(["Rescue"]);//false value
desclist.push(["<#2053#>","Other Devices"]);
url_group.push(["Other_Device"]);//false value
desclist.push(["<#3970#>","Fail to access"]);
url_group.push(["GUI"]);//false value
desclist.push(["<#510#>","FW update"]);
url_group.push(["FirmwareUpgrade"]);
if(isSupport("Instant_Guard")){
desclist.push(["<#4456#>","Instant Guard"]); //30
url_group.push(["Instant_Guard"]);
}
}
else if(ptype == "Connection_or_Speed_Problem"){
desclist.push(["<#2058#>","Wireless speed"]);
desclist.push(["<#2059#>","Wired speed"]);
desclist.push(["<#2061#>","Unstable connection"]);
desclist.push(["<#2060#>","Router reboot"]);
desclist.push(["<#2062#>","Wireless disconnected"]);
}
else if(ptype == "Compatibility_Problem"){
desclist.push(["<#2052#>","modem"]);
desclist.push(["<#2054#>","other router"]);
desclist.push(["<#2050#>","OS or Application"]);
desclist.push(["<#2055#>","printer"]);
desclist.push(["<#2056#>","USB modem"]);
desclist.push(["<#2051#>","external hardware disk"]);
desclist.push(["<#2053#>","network devices"]);
}
else if(ptype == "Suggestion"){
desclist.splice(0,1);
desclist.push(["<#2120#>","Translation"]);
desclist.push(["<#2121#>","UI/UX"]);
desclist.push(["<#2118#>","Current Feature"]);
desclist.push(["<#2119#>","New Feature Request"]);
}
else if(ptype == "Technical_Support"){
desclist.splice(0,1);
desclist.push(["<#2126#>","tech_ASUS"]);
desclist.push(["<#2124#>","tech_Amazon"]);
desclist.push(["<#2127#>","tech_iOS"]);
desclist.push(["<#2125#>","tech_Android"]);
}
else{ //Other_Problem
desclist.splice(0,1);
desclist.push(["<#999#>","others"]);
}
...
timelist.push(["<#824#> ...","No_selected"]);
timelist.push(["<#2136#>","Just Now"]);
...
timelist.push(["<#2140#>","Today"]);
timelist.push(["<#2141#>","Recently"]);
timelist.push(["<#2142#>","I don’t recall"]);
...
bandlist.push(["<#1501#>","All"]);
bandlist.push(["<#2097#>","I am not sure"]);
bandlist.push(["<#2098#>","Issue with the main router"]);
bandlist.push(["<#2099#>","Issue with node(s)"]);
...
unstablelist.push(["<#824#> ...","No_selected"]);
unstablelist.push(["<#2095#>","All WiFi"]);
...
unstablelist.push(["<#2096#>","Both WiFi and WAN"]);
unstablelist.push(["<#2097#>","I am not sure"]);
unstablelist.push(["<#2098#>","Issue with the main router"]);
unstablelist.push(["<#2099#>","Issue with node(s)"]);
...
if(value) {
if(allUsbStatus.search("storage") == "-1"){
alert("USB disk required in order to store the debug log, please plug-in a USB disk to <#945#> and Enable DSL Line Diagnostic again.");/*untranslated*/
...
var remaining_time_str = "<#2927#> : ";
if(dblog_remaining == 0) {
remaining_time_str += "0" + " " + "(Prepare data...)"; //Untranslated
return remaining_time_str;
}
if(days)
remaining_time_str += days + " <#1804#> ";
if(hours)
remaining_time_str += hours + " <#2421#> ";
if(minutes)
remaining_time_str += minutes + " <#2817#> ";
if(seconds)
remaining_time_str += seconds + " <#3270#> ";
return remaining_time_str;
};
...
var dblog_service_mapping = ["", "WiFi", "<#1901#>", "<#880#>", "AiMesh"];
...
selectOption = {"1 <#2421#>" : hour_to_sec(1)};
}
if(usb_support && $("input[name=dblog_tousb_cb]").prop("checked")) {
baseOption = { "12 <#2421#>" : hour_to_sec(12), "1 <#1804#>" : hour_to_sec(24), "2 <#1804#>" : hour_to_sec(48), "3 <#1804#>" : hour_to_sec(72) };
}
else {
baseOption = { "6 <#2421#>" : hour_to_sec(6), "12 <#2421#>" : hour_to_sec(12), "24 <#2421#>" : hour_to_sec(24) };
}
...
$(".dblog_service_item.wifi").after(gen_appendix_option(16, "<#2133#>", "dhd"));
}
$("input[name=dblog_service_list]").prop("checked", true);
...
if($("input[name=dblog_tousb_cb]").prop("checked")) {
if(media_support)
$(".dblog_service_item.all").after(gen_service_option(4, "<#880#>", "noUSB"));
if(!nodm_support)
$(".dblog_service_item.all").after(gen_service_option(2, "<#1901#>", "noUSB"));
}
}
...
var auth_status_hint = "<#1528#>";
document.form.fb_email.value = "";
switch(_status) {
case "0" :
auth_status_hint = "<#642#>";
break;
case "1" :
auth_status_hint = "<#1527#>";
...
<tr>
<td>
<div class="drword" id="drword" style="height:110px;"><#467#> <#782#>...
<br/>
<br/>
</div>
</td>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#506#> - <#2806#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="fb_desc0" class="formfontdesc" style="display:none;"><#2078#></div>
<div id="fb_desc1" class="formfontdesc" style="display:none;"><#2079#></div>
<div id="fb_desc_disconnect" class="formfontdesc hint-color" style="display:none;"><#2080#> <a class="hint-color" href="mailto:router_feedback@asus.com?Subject=<%nvram_get("productid");%>" target="_top">router_feedback@asus.com</a></div>
...
<th><#2084#> *</th>
<td>
<input type="checkbox" class="input" name="attach_syslog" id="attach_syslog_id"><label for="attach_syslog_id"><#847#></label>&nbsp;&nbsp;&nbsp;
<input type="checkbox" class="input" name="attach_cfgfile" id="attach_cfgfile_id"><label for="attach_cfgfile_id"><#2112#></label>&nbsp;&nbsp;&nbsp;
<span id="attach_iptables_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_iptables" id="attach_iptables_id"><label for="attach_iptables_id"><#2092#></label></span>
<span id="attach_modem_span" style="color:#FFFFFF;"><input type="checkbox" class="input" name="attach_modemlog" id="attach_modemlog_id"><label for="attach_modemlog_id"><#2043#></label></span>
<input type="checkbox" class="input" name="attach_wlanlog" id="attach_wlanlog_id"><label for="attach_wlanlog_id"><#2132#></label>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(25,11);"><#2074#> *</a></th>
<td>
<input type="radio" name="dslx_diag_enable" class="input" value="1" onclick="change_dsl_diag_enable(1);"><#275#>
<input type="radio" name="dslx_diag_enable" class="input" value="0" onclick="change_dsl_diag_enable(0);" checked><#274#>
<br>
<span id="storage_ready" class="hint-color" style="display:none;">* <#3678#></span>
<span id="be_lack_storage" class="hint-color" style="display:none;">* <#2989#></span>
</td>
</tr>
...
<option value="0" selected><#241#></option>
<option value="3600">1 <#2421#></option>
<option value="18000">5 <#2421#></option>
<option value="43200">12 <#2421#></option>
<option value="86400">24 <#2421#></option>
<option value="172800">48 <#2421#></option>
</select>
</td>
</tr>
<tr class="dblog_support_class">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34, 1);"><#2075#></a></th>
<td>
<div class="dblog_disabled_status">
<input type='radio' name='dblog_enable' id='dblog_status_en' value="1" onclick="diag_change_dblog_status();"><label for='dblog_status_en'><#275#></label>
<input type='radio' name='dblog_enable' id='dblog_status_dis' value="0" onclick="diag_change_dblog_status();" checked><label for='dblog_status_dis'><#274#></label>
<label class="storeUSBHint hint-color"><input type="checkbox" name="dblog_tousb_cb" value="1" onclick="diag_change_storeUSB();" checked><#2076#></label>
<span class="noUSBHint hint-color">* <#2989#></span>
</div>
<div class="dblog_enabled_status">
<span>* <#2067#></span>
<br>
<span class="dblog_stop_text" onclick="dblog_stop();"><#2066#></span>
</div>
</td>
</tr>
...
<div class="dblog_disabled_status">
<label class="dblog_service_item all"><input type="checkbox" name="dblog_service_list_all" onclick="diag_change_service_list_all();"><#1501#></label>
</div>
<div class="dblog_enabled_status">
...
<option value="No_selected"><#824#> ...</option>
<option value="Stable_connection"><#2114#></option>
<option value="Occasional_interruptions"><#2106#></option>
<option value="Frequent_interruptions"><#2091#></option>
<option value="Unavailable"><#2129#></option>
</select>
</td>
</tr>
<tr>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2143#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2135#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#2094#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34,2);"><#1526#></a></th>
<td>
...
<tr style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(34,3);"><#2123#></a></th>
<td>
...
<span class="hint-color"><#2100#> : </span>
...
<div id="eula_content" style="margin-left: 20px;"><#2130#></div>
</div>
<input id="apply_button" class="button_gen" style="margin-left: 305px; margin-top:5px;" name="btn_send" onclick="applyRule()" type="button" value="<#1632#>"/>
<div id="loadingIcon" style="display:none;"><div class="loadingIcon" style="float: left; margin-left: 305px; margin-top:5px;"></div><div style="float: left; margin-left: 15px; margin-top:10px;"><span class="hint-color"><#469#>...</span></div></div>
</td>
</tr>
<tr>
<td colspan="2">
<strong><#2268#></strong>
<ul>
<li><#2105#><br><a id="call_link" style="font-weight: bolder;text-decoration:underline;cursor:pointer;" href="" target="_blank">https://www.asus.com/support/CallUs/</a></li>
</ul>
</td>
</tr>
</table>
