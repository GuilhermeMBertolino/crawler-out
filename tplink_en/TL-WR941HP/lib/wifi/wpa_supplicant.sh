...
wpa_supplicant_setup_vif() {
	...
	config_get device_name "$vif" wps_device_name "TP-Link AP"
	config_get manufacturer "$vif" wps_manufacturer "TP-Link"
	...
	s_device_type="device_type=$device_type"
	s_device_name="device_name=$device_name"
	s_manufacturer="manufacturer=$manufacturer"
	s_model_name="model_name=$model_name"
	s_model_number="model_number=$model_number"
	s_serial_number="serial_number=$serial_number"
