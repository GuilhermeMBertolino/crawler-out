	...
	DateTimePicker.prototype = {
		...
		_modifyPicker: function()
		{
			...
			for(var iTempIndex = 0; iTempIndex < iNumberOfColumns; iTempIndex++)
			{
				...
				sDTPickerComp += "<a class='dtpicker-compButton increment uparrow'>" + dtPickerObj.settings.incrementButtonContent + "</a>";
				sDTPickerComp += "<input type='text' class='dtpicker-compValue'></input>";
				sDTPickerComp += "<a class='dtpicker-compButton decrement downarrow'>" + dtPickerObj.settings.decrementButtonContent + "</a>";
				sDTPickerComp += "</div>";
				sDTPickerComp += "</div>";
			}
