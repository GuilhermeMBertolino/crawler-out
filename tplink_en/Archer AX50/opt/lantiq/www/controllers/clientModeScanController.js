myapp.controller("clientModeScanController", function ($scope, $http, $route, $routeParams, localStorageService, modifyService, $translate, $rootScope, $interval, clientModeService) {
   ...
   $scope.DeviceWiFiEndPoint1Profiletable = [];
    ...
    $scope.getSSIDs = function (setParams,reqParams) {
        ...
        $http.get(URL + post).
                success(function (data, status, headers, config) {
                    ...
                    $scope.selectedItem = $scope.DeviceWiFiEndPoint2Profiletable[0];
                        ...
                        $scope["clientmodescan" + "popup"] = true;
                        $scope["clientmodescan" + "popupval"] = data.Objects[0].Param[0].ParamValue;
                    }
                    else if (status === 206) {
                        if (data.Objects.length < 2 && data.Objects[0].Param.length < 2) {
                            ...
                            $scope["clientmodescan" + "popupval"] = popupvalue;
                        }
                    }
