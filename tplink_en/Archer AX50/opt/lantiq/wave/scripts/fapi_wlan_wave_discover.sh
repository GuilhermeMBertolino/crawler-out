...
PCI_LTQ_COUNT=$((PCI_LTQ_COUNT_WAVE300+PCI_LTQ_COUNT_WAVE500+PCI_LTQ_COUNT_WAVE600))
...
then
	...
	then
		...
		echo "fapi_wlan_wave_discover.sh: ##########################################" > $TRACE_OUT
...
##For WAVE600 no AHB
echo "$script_name:TBD disable AHB only for gen6 driver- WAVE600:AHB_WLAN_COUNT=0" > $TRACE_OUT
AHB_WLAN_COUNT=0
