(function($){
	...
	$.su.CHAR.HELP = {
		...
		STATUS_WIRELESS: {
			TITLE: "2.4GHz/5GHz/60GHz Wireless",
			CONTENT: [{
				type: "paragraph",
		...
		DDNS: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Dynamic DNS (Domain Name System) allows you to assign a fixed host and domain name to a dynamic Internet IP address. It is useful when you are hosting your own website, FTP server, or another server behind the router. To begin, you need to sign up with a Dynamic DNS service provider such as www.dyndns.com. Then, enter your registration information."
			},{
				type: "step",
				...
				content: [
					...
					"3. Enter domain name you registered with the Dynamic DNS service provider.",
					"4. Select the time interval in which the Dynamic DNS update request will be sent.",
					"5. If your service provider is NO-IP, select WAN IP Binding to ensure that the domain name is bound to the WAN IP of this router.",
		...
		WIRELESS_24G: {	
			...
			CONTENT: [{
				...
				content: "Select this checkbox to enable the 2.4GHz wireless radio frequency. If disabled, WPS function is not supported in this band."
			},{
				type: "name",
				title: "Network Name (SSID)",
				...
				type: "name",
				title: "Hide SSID",
				content: "Select this checkbox if you want to hide the 2.4GHz network name (SSID) from the Wi-Fi network list. If selected, WPS function is not supported in this band."
			},{
				type: "name",
				title: "Security",
				...
				children: [{
					...
					children: [{
						...
						children: [{
							...
							type: "name",
							title: "WPA-PSK",
							content: "This option provides a good level of security. If selected, WPS function is not supported in this band."
						},{
							type: "name",
							title: "WPA2-PSK",
						...
						type: "name",
						title: "Encryption",
						content: "Select a security encryption type: TKIP (Temporal Key Integrity Protocol), AES (Advanced Encryption Standard), or Auto (for both TKIP and AES). It is NOT recommended to use the TKIP encryption if the router operates in 802.11n mode, because TKIP is not supported by 802.11n specification. If TKIP is selected, WPS function is not supported in this band."
					},{
						type: "name",
						title: "Password",
					...
					content: "Select this option to enable the more advanced authentication method using a RADIUS (Remote Authentication Dial In User Service) server. If selected, WPS function is not supported in this band.",
					children: [{
						type: "name",
						title: "Version",
						content: "Select a security version for your wireless network.",
						children:[{
							...
							type: "name",
							title: "WPA",
							content: "This option provides a good level of security."
						},{
							type: "name",
							title: "WPA2",
							content: "This option provides a better level of security than WPA-PSK and is recommended."
						...
						type: "name",
						title: "Encryption",
						content: "Select a security encryption type: TKIP (Temporal Key Integrity Protocol), AES (Advanced Encryption Standard), or Auto (for both TKIP and AES). It is NOT recommended to use the TKIP encryption if the router operates in 802.11n mode, because TKIP is not supported by 802.11n specification."
					},{
						type: "name",
				...
				type: "name",
				title: "WEP",
				content: "Select this option to enable basic authentication method if any of your client devices can only access the wireless using WEP (Wired Equivalent Privacy). If selected, WPS function is not supported in this band.",
				children: [{
					type: "name",
					title: "Type",
					...
					content: "Either use ASCII format or select Hexadecimal. ASCII format is a combination of ASCII characters. Hexadecimal format is a combination of the number (0-9) and letters (A-F, a-f)."
				},{
					type: "name",
					title: "Key Type",
		...
		WIRELESS_5G: {	
			...
			CONTENT: [{
				type: "name",
				title: "Enable Wireless Radio",
				content: "Select this checkbox to enable the 5GHz wireless radio frequency. If disabled, WPS function is not supported in this band."
			},{
				type: "name",
				title: "Network Name (SSID)",
				content: "You can leave the default Network Name (SSID) as it is or enter a new name (up to 32 characters). This field is case-sensitive."
				...
				type: "name",
				title: "Hide SSID",
				content: "Select this checkbox if you want to hide the 5GHz network name (SSID) from the Wi-Fi network list. If selected, WPS function is not supported in this band."
			},{
				type: "name",
				title: "Security",
				content: "Select one of the following security options:",
		...
		WIRELESS_60G: {	
			TITLE: "60GHz Wireless",
			CONTENT: [{
				type: "name",
				title: "Enable Wireless Radio",
				content: "Select this checkbox to enable the 60GHz wireless radio frequency. If disabled, WPS function is not supported in this band."
			},{
				type: "name",
				title: "Network Name (SSID)",
				content: "You can leave the default Network Name (SSID) as it is or enter a new name (up to 32 characters). This field is case-sensitive."
				...
				type: "name",
				title: "Hide SSID",
				content: "Select this checkbox if you want to hide the 60GHz network name (SSID) from the Wi-Fi network list. If selected, WPS function is not supported in this band."
			},{
				type: "name",
				title: "Security",
				content: "Select one of the following security options:",
				children: [{
					...
					type: "name",
					title: "WPA2-Personal",
					content: "Select this option to enable the standard authentication method based on a Pre-shared Key (PSK), also called passphrase. The encryption type is GCMP. This option is recommended. If selected, configure the following.",
					children: [{
						type: "name",
						title: "Password",
						content: "Enter a wireless password between 8 and 63 ASCII characters, or between 8 and 64 hexadecimal characters into this field."
					...
					content: "Select this option to enable the more advanced authentication method using a RADIUS (Remote Authentication Dial In User Service) server. The encryption type is GCMP. If selected, WPS function is not supported in this band.",
					children: [{
						type: "name",
						title: "RADIUS Server IP",
						content: "Enter the IP address of the RADIUS server."
				...
				type: "name",
				title: "Channel",
				content: "Select an operating channel for the 60GHz wireless network. It is recommended to leave the channel to Auto, if you are not experiencing the intermittent wireless connection issue."
			},{
				type: "paragraph",
				content: "Click Save to save all your settings."
			}]
		...
		WPS_WIZARD: {
			...
			CONTENT:[{
				type: "paragraph",
				content: "WPS only supports the following config: enable <Enable Wireless Radio>, disable <Hide SSID> and security is <No Security> or <WPA/WPA2-Personal>(WPA2-PSK or auto + AES or auto) in the condition that WPS function is enabled."
			},{
				type: "name",
		...
		WIRELESS_STATISTICS: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Connection Type",
				content: "Displays the wireless frequency band (2.4GHz, 5GHz or 60GHz) of the associated wireless client."
			},{
				type: "name",
				title: "Security",
		...
		FOLDER_SHARE_SETTINGS: {
			...
			CONTENT: [{
				...
				content: "Displays the name used to access the connected USB storage device. The name must be consists of alphanumeric characters, underlines or hyphens from 4 to 15 in length."
			},{
				type: "name",
				title: "Enable",
		...
		OFFLINE_DOWNLOAD: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "With Offline Download enabled, the router can download files without keeping your computer powered on all the time. "
			},{
				type: "name",
				title:"Status",
				...
				type: "name",
				title:"Folder Path",
				content: "Select a directory path to store or cache your downloads.",
				children:[
			{
				type: "note",
				title: "Note",
				...
				content: "Enter a value between 1 and 10  to set the maximum number of active downloads."
			},{
				type: "name",
				title:"Speed Limits",
				content: "Specify the maximum download and upload speed for your Internet connection."
			},{
				type: "name",
				title:"Maximum Download Speed",
				content: "Enter a value to set the maximum download speed."
			},{
				type: "name",
				title:"Maximum Upload Speed",
				content: "Enter a value to set the maximum upload speed."
			},{
				type: "name",
				...
				content: "Enter a value to set the global maximum number of connections."
			},{
				type: "name",
				title: "Maximum Number of Connected Peers per Torrent",
				content: "Enter a value set the maximum number of connected peers per torrent."
			},{
				type: "name",
				...
				content: "Enable this feature to improve the communication efficiency among your group of peers so that you can increase the download speed."
			},{
				type: "name",
		...
		OFFLINE_DOWNLOAD_ITEMS: {
			...
			CONTENT: [{
				...
				type: "name",
				title:"Speed",
					content: "Displays the the current download (or upload) speed of the download."
			},{
				type: "name",
				title: "Completed",
				...
				content: [
					"1. Click Add.",
					"2. Select your source of download, torrent from PC, torrent from USB, or URL.",
		...
		PARENTAL_CONTROL_RESTRICTION: {
			...
			CONTENT: [{
				...
				type: "note",
				title: "Note",
				content: "Keywords can also be domain names, for example, mail.google.com or www.facebook.com."
			},{
				type: "paragraph",
		...
		ACCESS_DEVICE: {
			...
			CONTENT: [{
				...
				content: "In the Online Devices table, select all devices that you wish to block, click Block above the table. The device will be automatically added to the Devices in Blacklist."
			}],
		},
		...
		FIRMWARE: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "It's recommended to upgrade the router to the latest firmware for best performance and enhancements when a new update becomes available."
			},{
				type: "step",
		...
		FIRMWARE_UPGRADE_ONLINE:{
			TITLE:"To upgrade the firmware via Internet",
			CONTENT:[{
				type: "paragraph",
				content: [
		...
		FIRMWARE_UPGRADE: {
			TITLE:"To manually upgrade the firmware",
			CONTENT:[{
				type:"step",
				content: [
					"1. Click Support at the bottom of the page and download the latest firmware to the computer. Please make sure that the firmware version you're downloading matches the router's hardware version as shown on the page.",
		...
		BACKUP_RESTORE:{	
			...
			CONTENT: [{
				type: "paragraph",
				content: "The Backup feature allows you to save the router's current configuration to your computer as a backup just in case something happens; the Restore feature allows you to restore the router to a previous status while Factory Default Restore can restore the router to default values."
			},{
				type: "note",
				title:"Note",
				content: "Please do NOT power off the router during a backup or restore process."
			}]
		},
		BACKUP: {	
			TITLE: "Backup",
		...
		RESTORE: {
			...
			CONTENT: [{
				type:"paragraph",
				content:"You can restore the router to a previous state from a backup file."
			},{
				type: "step",
		...
		FACTORY: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Factory Default Restore allows you to restore the settings you have configured for the router according to your needs."
			},{
				type: "paragraph",
				content: [
		...
		ADMIN_REMOTE: {	
			...
			CONTENT: [{
				...
				content: "Enter a valid IP address to be allowed to access the router."
			},{
				type: "paragraph",
				content: "Click Save to save all your settings."
			}]
		...
		SYSTEM_PARA_WIRELESS: {	
			...
			CONTENT: [{
				...
				content: "The technology allows the router to establish a point-to-point connection with up to three devices at once. It drastically improves speeds and reduces device wait times in comparison to traditional architecture, allowing the router to serve more Wi-Fi clients simultaneously while minimizing bandwidth bottlenecks."
			},{
				type: "name",
				title: "WMM Feature",
		...
		BASIC_NETWORK_ROUTER: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "SSID",
				content: "Displays the current wireless network name of the 2.4GHz/5GHz/60GHz band frequency."
			},{
				type: "name",
				title: "Channel",
				content: "Displays the channel of which the wireless 2.4GHz/5GHz/60GHz network broadcasts."
			},{
				type: "name",
				title: "MAC",
				content: "Displays the current MAC address of the wireless 2.4GHz/5GHz/60GHz."
			},{
				type: "title",
				title: "2.4GHz/5GHz Guest Network"
			},{
		...
		BASIC_NETWORK_USB: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Total",
				content: "Displays the total storage capacity of the connected USB storage device."
			},{
				type: "name",
				title: "Available",
				content: "Displays the available storage capacity of the connected USB storage device."
			}]
		},
		BASIC_INTERNET: {
			TITLE: "Internet",
		...
		BASIC_WIRELESS: {
			...
			CONTENT: [{
				type: "name",
				title: "Enable Wireless Radio",
				content: "Select this checkbox to enable the 2.4GHz/5GHz/60GHz wireless radio frequency."
			},{
				type: "name",
				title: "Network Name (SSID)",
				...
				type: "name",
				title: "Hide SSID",
				content: "Select this checkbox if you want to hide the 2.4GHz/5GHz/60GHz network name (SSID) from the Wi-Fi network list."
			},{
				type: "name",
				title: "Password",
				content: "Enter a wireless password which is corresponding to the security type into this field (case-sensitive)."
			},{
				type:"paragraph",
				content:"Click Save to save all your settings."
			}]
