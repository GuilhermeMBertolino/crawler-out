(function($){
	...
	$.su.CHAR = {
		LOGIN: {
			...
			USER_CONFLICT_INFO_1: 		"User %USER% (%MAC%) is currently logged into the router. You cannot login at the same time. Please try again later.",
		...
		INIT: {
			...
			INIT_NOTE_CONTENT: 			"Please set up your %PRODUCT% to connect to the Internet first. To begin with, create an administrator password to manage your %PRODUCT%."
		...
		INDEX: {
			...
			REBOOTING: 						"Rebooting... <br/>Please do NOT operate during this process.",
		...
		VTYPETEXT: {
			...
			PPTP_INVALID_IP:			"Invalid IP address.",
			MAC: 						"Invalid format.",
			MULTI_MAC:					"Invalid format.",
			MAC_INVALID_BROADCAST:		"MAC shouldn't be broadcast address.",
			MAC_INVALID_MULTICAST:		"MAC shouldn't be multicast address.",
			DATE: 						"Invalid format.",
		...
		ERROR: {			
			...
			"00000046": 				"IP address and MAC address should not be NULL. Please enter again.",
			...
			"00000059": 				"Invalid IP address and Subnet Mask, please enter a valid one.",
			...
			"00000083": 				"Gateway cannot be the same with IP.",
			"00000084": 				"Primary DNS cannot be the same with IP.",
			"00000085": 				"Secondary DNS cannot be the same with IP.",
			"00000086": 				"Primary DNS cannot be the same with secondary DNS.",
			...
			"00002100": 				"The 60GHz network is unavailable due to restrictions in your region/country.",
			...
			"00002102": 				"Your wireless function is off. If you want to use this function, please switch ON the Wi-Fi button.",
			...
			"00000122": 				"The username or password is empty, are you sure you want to continue?",
			...
			"00000137": 				"Invalid IP address, please enter a valid one.",
			...
			"00000150": 				"Path not exist.",
			"00000151": 				"Allocation path not set.",
			"00000152": 				"Some problem with this path.",
			"00000153": 				"Volumn not found.",
			"00000154": 				"No USB device.",
			
			"00000155": 				"PPTP VPN client IP address and LAN IP address cannot be in the same subnet. <br/>Please enter another one.",
			"00000156": 				"PPTP VPN client IP address and OpenVPN client IP address cannot be in the same subnet. <br/>Please enter another one.",
			"00000213": 				"DNS server IP address and LAN IP address cannot be in the same subnet. <br/>Please enter another one.",
			"00000222":  				"Maximum entries.",
			"00000224": 				"File size exceeds.",
			"00000231": 				"Duplicated entry.",
			"00000232": 				"Invalid URL.",
			"00000233":					"Please select at least one day.",

			"00000301": 				"Maximum sharing folder entry.",
			"00000302": 				"Maximum sharing folder entry in a volumn.",
			"00000303": 				"Duplicated sharing folder path.",
			"00000304": 				"Duplicated sharing folder name.",

			"00001000":					"Upgrade operation is running, please wait.",
			"00001001": 				"The WDS function can work either at 2.4GHz or 5GHz band.",
			"00001002":					"Incorrect code.",

			"00001123": 				"The input application rule item is null, please enter at least one rule item.",
			"00001124": 				"The input physical port rule item is null, please choose at least one rule item. ",

            "00002000": 				"This item conflicts with ISP-specified static routing, are you sure you want to continue?",

            "00003000":                 "IPv6 Pass-Through conflicts with IPTV! If you want to use this function, please turn off IPTV settings.",
			"00004139": 				"No Internet connection",
			//"00004139": 				"Please activate this account by checking the email we sent you first.",
			"00004140": 				"Request timed out. Please check your Internet connection and  try again later.",
			"00004141": 				"Unknown error.",
			"00004142": 				"Incorrect verification code.",
			"00004143": 				"Invalid password.",
			"00004144": 				"Username already exists.",
			"00004145": 				"Invalid password.",//new password
			"00004146": 				"Unable to unbind this device. Please try again later.",
			"00004147": 				"This device has been bound to another account.",
			"00004148": 				"Invalid input.",
			"00004149": 				"This domain name already exists.",
			"00004150": 				"Unable to download the firmware. Please check your Internet connection and try again later.",
			"00004151": 				"No more than 1000 domain names can be registered by the same cloud account.",
			"00004152": 				"This device has been bound to another domain name.",
			"00004153": 				"This domain name has been bound to another device.",
			"00004154": 				"No response from the server. Please try again later.",
			"00004155": 				"Account doesn't exist.",
			"00004156": 				"Unable to start the cloud application. Please reboot this device and try again later.",
			"00004157": 				"Unable to connect to the cloud server. Please check your Internet connection and try again later.",
			"00004158": 				"The WAN port is unplugged.",
			"00004159": 				"Unable to connect to the Internet. Please contact your service provider or try again later. ",
			"00004160": 				"Unable to obtain IP address from the DHCP Server. Please check the WAN connection type or try again later.",
			"00004161": 				"PPPoE authentication failed. Please check your username and password.",
			"00004162": 				"Unable to connect to the PPPoE server.",
			"00004164": 				"PPTP authentication failed. Please check your username and password.",
			"00004165": 				"Unable to connect to the PPTP server.",
			"00004167": 				"L2TP authentication failed. Please check your username and password.",
			"00004168": 				"Unable to connect to the L2TP server.",
			"00004169": 				"Unknown error. Please try again later.",
			"00004170": 				"The WAN port is unplugged.",
			"00004171": 				"No Internet connection.",
			"00004172": 				"Connection failed.",
			"00004173": 				"Incorrect username or password.",
			"00004174": 				"Invalid email format.",
			"00004175": 				"Invalid username format.",
			"00004176": 				"Email already exists",
			"00004177": 				"Unable to access the account information. Please refresh the page.",
			"00004178":   				"System error. Please refresh the page and try again.",
			"00004179":   				"Unable to bind this device. Please try again later.",
			"00004180":   				"This device has been unbound from this Cloud account. Please log in with your account again to bind the device with your account.",
			"00004181":   				"The device is offline. Please check your Internet settings.",
			"00004182":   				"Unable to send the email. Please check your Internet connection and try again.",
			"00004183":   				"Account should contain  to  characters. ",
			"00004184":   				"You have entered the password incorrectly for 20 times. Please try again in 2 hours.",
			"00004185":   				"You have obtained the verification code for 10 times in 1 hour. Please try again in 24 hours.",
			"00004186":   				"Sorry, unable to active your account. Please resend the verification email.",
			"00004187":   				"Sorry, the link is outdated. Please resend the verification email.",
			"00004188":   				"Sorry, the link is outdated. Please resend the email.",
			"00004189":   				"Sorry, unable to reset your password. Please resend the email.",
			"00004190":   				"",
			"00004191":   				"",
			"00004192": 				"Firmware upgrade error.",
			"99999999":					"",
			...
			"E20506": 					"Operation failed. The device is already bound to another cloud account.",
			"E20507": 					"This device is unbound from the account.",
			"E20508": 					"The number of bound accounts has already reached the maximum limit.",
			"E20509": 					"User accounts do not have the right to bind new users.",
			...
			"E20602": 					"This account is not yet activated.",
			"E20603": 					"This email is already registered.",
			"E20604": 					"Invalid username. Please enter an email address or phone number.",
			"E20606": 					"Unable to send the account activation email.",
			"E20615": 					"Invalid password. Please enter 6-32 ASCII characters without spaces.",
			"E20616": 					"Invalid password. Please enter 6-32 ASCII characters without spaces.",
			...
			"E20672": 					"Unable to verify account. The account activation link has expired. Please submit a new request.",
			"E20673": 					"The password reset link has expired. Please submit a new request.",
			"E20674": 					"Unable to reset password.",
			"E20675": 					"This account is currently logged in elsewhere.",
			"E22000": 					"Invalid input.",
			"E22001": 					"Domain name is already registered.",
			"E22002": 					"The number of registered domain names has already reached the maximum limit.",
		...
		QUICK_SETUP: {
			...
			DYNAMIC_IP_INFO: 			"If your ISP only allows Internet access to a specific MAC address, you need to clone the MAC address of the primary computer. If you are not sure, select <strong>Do NOT clone MAC Address</strong>.",
			...
			WIRELESS_60GHZ_SSID: 		"Wireless 60GHz SSID",
			WIRELESS_60GHZ_PASSWORD: 	"Wireless 60GHz Password",
		...
		BASIC_PARENTAL_CTR:{
			...
			CHOOSE: 					"Choose",
			ADD_A_NEW_KEYWORD: 			"Add a New Keyword to Block",
			ADD_A_NEW_DOMAIN_NAME: 		"Add a New Domain Name to Access",
		...
		INTERNET: {
			...
			CUSTOM: 					"Custom",
		    AFTR_NAME: 					"AFTR Name",
            PPP_SHARE_V6:               "Use the same session with IPv4 connection",
            PPP_SHARE_V4:               "Use the same session with IPv6 connection",
		...
		DHCP_SERVER: {
			...
			LEASENOTE: 					"minutes. (2-2880. The default value is 120.)",
		...
		DDNS: {
			...
			CONTENT: 					"To use our superior TP-LINK DDNS service, please <a id=\"tp-link-login-btn\" class=\"link\" href=\"javascript:void(0);\">Log in</a> with your TP-LINK Cloud account, or choose another service provider.",
		...
		WIRELESS: {
			...
			NOT_SUPPORT_5G: 			"The region only support 2.4GHz. Please ensure you select the correct region.",
			NOT_SUPPORT_60G: 			"The region does not support 60GHz.",
			ENABLE_TIPS: 				"You should turn on wireless radio.",
			ENABLE_TIPS_2G: 				"Please enable your 2.4GHz wireless network on the wireless page first.",
			ENABLE_TIPS_5G: 				"Please enable your 5GHz wireless network on the wireless page first.",
			...
			WPA2_PERSONAL: 			    "WPA2-Personal (Recommended)",
		...
		WPS: {
			...
			SWITCH_NOTE:				"To connect using WPS, please turn on the wireless function through WIFI button.",
			...
			NOTE: 						"Note:",
			BUTTON: 					"WIFI Button is off",
			ENABLE: 					"Wireless function is not enabled",
			HIDDEN: 					"Hide SSID is on",
			ENCRYPTION: 				"Encryption is not right",
			WPS: 						"WPS is disabled in System Parameters page",
		...
		VIRTUAL_SERVERS:{
			...
			NOTICE_INVALID_REMOTE:		"Remote management is invalid due to the 80 port conflict with virtual server. Please change the remote management port.",
			NOTICE_ENTER_ANOTHER:		"In conflict with the remote management port. Please enter another port.",
			NOTICE_PPTP_CONFLICT:		"In conflict with the PPTP VPN port. Please enter another port.",
			NOTICE_OPENVPN_CONFLICT:	"In conflict with the OPENVPN port. Please enter another port.",
		...
		OFFLINE_DOWNLOAD: {
			...
			SEED:						"Keep Uploading After Task Completed",
			UNIT:						"KB/s",
			MODIFY:						"Action",
			PC:							"PC",
			USB:						"USB",
			...
			NONE_COMPLETE:				"No completed download",
			PROTOCOL:					"Protocol"
		...
		PRINT:{
			...
			NOTE3_US: 					"Install the TP-LINK USB Printer Controller Utility. Please download it from our official website: <a class=\"link\" href=\"http://www.tp-link.us/Support/\" target=\"_blank\">http://www.tp-link.us/Support/</a>."
            },
		...
		LED_CONTROL: {
			...
			LED_TIME_SETTINGS:			"Before enabling the LED Control, make sure <a class=\"link\" href=\"javascript:void(0);\" id=\"go-to-time\">Time Settings</a> is correct.",
		},
		...
		FIRMWARE:{
			...
			FIRMWARE_UPDATING_NOTE: 	"1.Firmware Updating...",
			REBOOTING_NOTE: 			"2.Rebooting...",
			SCREEN_UPDATING_NOTE: 		"3.Screen Updating...",
		...
		BACKUP:{
			...
			RESTORE_WARN:				"Router Restoring... <br/>Please do NOT operate during this process.",
			RESTORE_CONFIRM_CONTENT: 	"Are you sure you want to restore the router from the backup file?",
			
			FILE: 						"File",

			FACTORY: 					"Factory Default Restore",
			FACTORYTIP: 				"Restore all configuration settings to default values.",
			...
			FACTORY_WARN:				"Router Restoring... <br/>Please do NOT operate during this process.",
		...
		ACCOUNT:{
			...
			NOTICE_ENTER_ANOTHER:		"In conflict with the virtual server port. Please enter another port.",
		...
		VPN:{
			...
			LAN_CONFLICT_WITH_OPENVPN: 	"The LAN IP address and OPENVPN IP address cannot be in the same subnet. <br/>Please enter again.",
			LAN_CONFLICT_WITH_PPTPVPN: 	"The LAN IP address and PPTP VPN IP address cannot be in the same subnet. <br/>Please enter again.",
			...
			NOTICE_VS_CONFLICT:			"In conflict with the virtual server external port. Please enter another port.",
			NOTICE_PT_CONFLICT:			"In conflict with the port triggering external port. Please enter another port.",
			NOTICE_VS_MODIFY:			"In conflict with the virtual server external port(1723). Please go to the <a onclick=\"$.su.menu.advanced.goTo('virtual-servers');\" class=\"link\" style=\"cursor:pointer;\"  src=\"void(0)\">Virtual Servers</a> page and modify the virtual server external port.",
			NOTICE_PT_MODIFY:			"In conflict with the port triggering external port(1723). Please go to the <a onclick=\"$.su.menu.advanced.goTo('port-triggering');\" class=\"link\" style=\"cursor:pointer;\" src=\"void(0)\">Port Triggering</a> page and modify the port triggering external port.",
