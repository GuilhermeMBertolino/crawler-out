...
fw_load_global() {
    ...
    fw add 4 f zone_wan_offline_download
    ...
    # offline_download pass
    fw s_add 4 f zone_wan zone_wan_offline_download 1
	# vpn pass
    fw s_add 4 f zone_wan zone_wan_vpn_access 1
	fw s_add 4 f forwarding_rule forwarding_rule_vpn 1
    # #bridge pass
    fw s_add 4 f forwarding_rule ACCEPT 1 { "-m physdev --physdev-is-bridged" }  
