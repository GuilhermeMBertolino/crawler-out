...
local function proto_cfg_pppoe(proto, proto_name)
    ...
    local macaddr = sys.exec("getfirm MAC")
    local mac_num = {}
    string.gsub(macaddr,"(%x+)",function (w)
    ...
    if proto.snd_conn == "none" then
        ...
        if uci_r:get("wireless", "radio0", "country") == "GB" then
...
local function proto_cfg_pppoeshare(proto, proto_name)
    ...
    if proto.snd_conn == "none" then
     ...
     if proto.dns_mode == "static" then
         pppoe_wan.dnsv6 = dns_concat(proto.static_pridnsv6, proto.static_snddnsv6)
     end
    ...
    dnsv6_mode  = proto.dnsv6_mode,
         ipaddr      = proto.ip_mode == "static" and proto.specific_ip or "",
         dns         = proto.dns_mode == "static" and dns_concat(proto.dns, proto.static_pridns, proto.static_snddns) or proto.dns,
         keepalive   = (proto.interval == "0" or proto.interval == nil) and "" or (5 .. " " .. proto.interval),
         auto        = "0",
    conn_mode   = proto.conn_mode,
         connectable = proto.connectable,
...
local function proto_cfg_6rd(proto, proto_name)
    ...
    if proto.ip_mode == "auto" then
        ...
        tunnel_6rd_wanv6.ip6prefix    = "2001:55c::"
...
local function proto_cfg_dslite(proto, proto_name)
    ...
    elseif proto.snd_conn == "static" then
        ...
        if proto.pppoe_dns_mode == "static" then
            dslite_wanv6.dns = dns_concat(proto.pppoe_static_pridns, proto.pppoe_static_snddns)
        end
    end
