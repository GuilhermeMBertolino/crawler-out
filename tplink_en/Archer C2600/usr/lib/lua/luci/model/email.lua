...
-- local MODEL   = uci_r:get("locale", "sysinfo", "model") or "AC1900"
local MODEL = cfgtool.getsysinfo("product_name") or "AC1900"
...
function format_params(params)
	...
	local domain_name = luci.sys.hostname() or MODEL
	--domain name can not contain any space
	domain_name = string.gsub(domain_name, " ", "")
