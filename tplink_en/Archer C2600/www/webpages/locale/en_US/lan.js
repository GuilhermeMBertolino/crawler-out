(function($){
	...
	$.su.CHAR = {
		LOGIN: {
			...
			FIRST_TIME: 				"Welcome to use Archer AD7200 designed by TP-LINK in China. To begin, create a device password to manage it.",
		...
		ERROR: {			
			...
			"00000151": 				"Allocation path no set.",
		...
		DDNS: {
			...
			STATU_FAIL_DDNS: 			"Failed to update DynDNS.",
		...
		OFFLINE_DOWNLOAD: {
			...
			TORRENT_PC:					"Torrent from PC",
			TORRENT_USB:				"Torrent from USB",
			SOURCE_URL:					"URL",	
			URL:						"URL",	
			AMULE:						"aMule",
			...
			SCHEDULE:					"Schedule",
			MAXACTIVE:					"Maximum Number of Active Tasks",
			MAXACTIVENUM:				"(1-10)",
			TIMEZONE:					"Time Zone",
		...
		FIRMWARE:{
			...
			WARNING:					"Firmware upgrading... <br/> To avoid any damage , keep the device powered on and wait without any operation during this process.",
			REBOOTING: 					"Rebooting... <br/> To avoid any damage, keep the device powered on and wait without any operation during this process.",
