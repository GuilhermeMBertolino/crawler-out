(function($){
	...
	$.su.CHAR.HELP = {
		...
		DDNS: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Dynamic DNS allows you to assign a fixed host and domain name to a dynamic Internet IP address. It is useful when you are hosting your own website, FTP server, or another server behind the router. First, you need to sign up with a Dynamic DNS service provider such as dyn.com."
			},{
				type: "step",
		...
		OFFLINE_DOWNLOAD: {	
			...
			CONTENT: [{
				type: "name",
				title:"Status",
				content: "Toggle On to enable Offline Download feature."
			},{
				type: "name",
				title:"Folder Path",
				content: "Working directory of the offline download function. You have to choose a directory path after the status button is turned on, or the item operating table will keep invisible which means you can do nothing more. Once the working directory is set, all the files created by following operations are saved or cached in the directory. If there are active items, the working directory can not be changed, and you are recommended not extract the USB storage which may cause fatal errors beyond recovery."
			},{
				type: "name",
				title:"Schedule",
				content: "If selected, you can set the download time periods. The time schedule takes effect based on the router's system time which can be set in \"System Tools -> Time Settings\"."
			},{
				type: "name",
				title:"Keep Seeding after Task Completed",
				content: "If selected, the completed task will keep seeding."
			},{
				type: "name",
				title: "Maximum Number of Active Tasks",
				content: "Displays the maximum number of active tasks."
			},{
				type: "name",
				title:"Maximum Download Speed",
				content: "Displays the maximum download speed."
			},{
				type: "name",
				title:"Maximum Upload Speed",
				content: "Displays the minimum speed upload speed."
			},{
				type: "name",
				title: "Number of Connections",
				content: "Displays the connections settings."
			},{
				type: "name",
				title: "Global Maximum Number of Connections",
				content: "Modify to limit the maximum number of connections of all tasks."
			},{
				type: "name",
				title: "Maximum Number of Connected Peers per Torrent",
				content: "Modify to limit the maximum number of connected peers per task."
			},{
				type: "name",
				title: "Enable DHT Network",
				content: "If selected, DHT is enabled."
			},{
				type: "name",
				title: "Enable Peer Exchange",
				content: "If selected, peer information exchange is enabled."
			},{
				type: "name",
				title: "Enable BitTorrent Protocol Encryption",
				content: "If selected, BitTorrent protocol encryption is enabled."
			},{
				type: "name",
				title:"aMule Server",
				content: "Enter the IP address and port of aMule server to connect."
			}]
		},
		...
		OFFLINE_DOWNLOAD_ITEMS: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Displays the download items."
			},{
				type: "name",
				title: "File",
				content: "Displays the download file name."
			},{
				type: "name",
				title:"Speed",
				content: "Displays the upload and download speed."
			},{
				type: "name",
				title: "Completed",
				content: "Displays the completed size and total size."
			},{
				type: "name",
				title:"Remaining Time",
				content: "Displays the remainting time before download is completed."
			},{
				type: "name",
				title:"Connected Peers",
				content: "Displays the peers connected information."
			},{
				type: "name",
				title: "Status",
				content: "Displays the task status."
			},{
				type: "name",
				title: "Source",
				content: "Displays the download type."
			},{
				type: "step",
				title: "To add a download item",
				content: [
					"1. Click Add.",
					"2. Select download source type:",
					"1) Torrent from PC: Click Browse to select a torrent file from PC.",
					"2) Torrent from USB: Select a volume and click Browse to select a torrent file from USB.",
					"3) URL: Enter URL(HTTP, HTTPS, FTP, ed2k).",
					"3. Click OK."
				]
			}]
		},
		...
		FIRMWARE: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "Before upgrading the firmware of the router, you will need to download the latest firmware update from the <a class=\"link\" href=\"javascript:void(0);\" id=\"update_url\" target=\"_blank\">TP-LINK Support</a> website to your computer."
			},{
				type: "step",
