(function($){
	...
	$.su.CHAR.HELP = {
		...
		STATUS_WIRELESS: {
			TITLE: "2,4 GHz:n/5 GHz:n/60 GHz:n langaton verkko",
			CONTENT: [{
				type: "paragraph",
				...
				type: "name",
				title: "Kanava",
				content: "Nykyinen langattoman verkon kanava"
			},{
				type: "name",
				title: "MAC-osoite",
		...
		INTERNET_INTERNET: {
			...
			CONTENT: [{
				...
				content: "Jos ISP:si antaa tietyn (kiinteän) DNS IP -osoitteen, valitse Käytä seuraavaa DNS-osoitetta ja täytä Ensisijainen DNS ja Toissijainen DNS -kentät sen mukaisesti. Valitse muussa tapauksessa Hanki dynaamisesti ISP:ltä saadaksesi palvelimen määräämät DNS IP -osoitteet automaattisesti."
			},{
				type: "name",
				title: "Yhteystila",
		...
		IPTV:{
			...
			CONTENT: [{
				...
				},
				{
					type: "name",
					title: "Tila",
					content: "Valitse ISP:n ilmoittama tila. Tuettuja IPTV-tiloja on kuusi:",
					children: [
						{
							type: "name",
							title: "Välitili",
						...
						},
						{
							type: "name",
							title: "Venäjä",
							content: "Valitse, jos ISP:si on Venäjällä ja tarpeelliset parametrit on määritetty valmiiksi, mukaanlukien Internet/IP-Phone/IPTV VLAN -tunnukset ja Prioriteetti sekä LAN (1/2/3/4) -porttien ominaisuudet.",
							children: [{
								type: "name",
		...
		DHCP_SERVER_SETTINGS: {
			...
			CONTENT: [{
				...
				content: "Syötä aika, jonka verran IP-osoite liisataan asiakkaalle, 2-2880 minuuttia. Oletusasetus on 120 minuuttia."
			},{
				type: "name",
				title: "Oletusyhdyskäytävä",
		...
		DDNS: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Dynaamisella DNS:llä voit määrätä kiinteän isäntä- ja verkkoaluenimen dynaamiselle Internetin IP-osoitteelle. Siitä on hyötyä, kun isännöit reitittimen takana omaa sivustoasi, FTP-palvelinta tai muuta palvelinta. Ensin sinun tulee rekisteröityä dynaamisen DNS-palveluntarjoajan, kuten dyn.com, kanssa."
			},{
				type: "step",
				...
				content: [
					...
					"5. Napsauta Kirjaudu ja Tallenna."
				]
			},{
				type: "paragraph",
				content: "Voit vaihtaa tilejä kirjautumalla ensin ulos nykyiseltä tililtä ja kirjautumalla sitten toiselle tilille uudella käyttäjätunnuksella ja salasanalla."
			}]
		},
		...
		WIRELESS_24G: {	
			...
			CONTENT: [{
				...
				content: "Valitse tämä valintaruutu ottaaksesi käyttöön 2,4 GHz:n langattoman radiotaajuuden. Jos tämä poistetaan käytöstä, tällä taajuusalueella ei tueta WPS-toimintoa."
			},{
				type: "name",
				...
				type: "name",
				title: "Piilota SSID",
				content: "Valitse tämä valintaruutu, jos haluat piilottaa 2,4 GHz:n verkon nimen (SSID) Wi-Fi-verkkojen luettelosta. Jos tämä valitaan, tällä taajuusalueella ei tueta WPS-toimintoa."
			},{
				type: "name",
				title: "Suojaus",
				...
				children: [{
					...
					children: [{
						...
						children: [{
							...
							type: "name",
							title: "WPA-PSK",
							content: "Tämä asetus takaa hyvän suojaustason. Jos tämä valitaan, tällä taajuusalueella ei tueta WPS-toimintoa."
						},{
							type: "name",
							title: "WPA2-PSK",
							content: "Tämä asetus tarjoaa paremman turvallisuustason kuin WPA-PSK, ja sitä suositellaan."
						}]
					},{
						type: "name",
						title: "Salaus",
						content: "Valitse suojauksen salaustyyppi: TKIP (Temporal Key Integrity Protocol), AES (Advanced Encryption Standard) tai Auto (sekä TKIP että AES). TKIP-salauksen käyttöä EI suositella, jos reititin toimii 802.11n-tilassa, koska 802.11n-määritys ei tue TKIP:iä. Jos TKIP valitaan, tällä taajuusalueella ei tueta WPS-toimintoa."
					},{
						type: "name",
						title: "Salasana",
					...
					content: "Valitse tämä asetus ottaaksesi käyttöön edistyneempi todennusmenetelmä, jossa  hyödynnetään RADIUS-palvelinta (Remote Authentication Dial In User Service). Jos tämä valitaan, tällä taajuusalueella ei tueta WPS-toimintoa.",
					children: [{
						type: "name",
						title: "Versio",
						content: "Valitse langattoman verkkosi suojausversio.",
						children:[{
							...
							type: "name",
							title: "WPA",
							content: "Tämä asetus takaa hyvän suojaustason."
						},{
							type: "name",
							title: "WPA2",
							content: "Tämä asetus tarjoaa paremman turvallisuustason kuin WPA-PSK, ja sitä suositellaan."
						...
						type: "name",
						title: "Salaus",
						content: "Valitse suojauksen salaustyyppi: TKIP (Temporal Key Integrity Protocol), AES (Advanced Encryption Standard) tai Auto (sekä TKIP että AES). TKIP-salausta EI suositella, jos reititin toimii 802.11n-tilassa, koska 802.11n ei tue TKIP:iä."
					},{
						type: "name",
				...
				type: "name",
				title: "WEP",
				content: "Valitse tämä asetus ottaaksesi käyttöön perustodennusmenetelmän, jos joku asiakaslaite voi käyttää langatonta verkkoa ainoastaan WEP:illä (Wired Equivalent Privacy). Jos tämä valitaan, tällä taajuusalueella ei tueta WPS-toimintoa.",
				children: [{
					type: "name",
					title: "Tyyppi",
					...
					content: "Käytä joko ASCII-muotoa tai valitse Hexadecimal (Heksadesimaalinen). ASCII-muodo on ASCII-merkkien yhdistelmä. Heksadesimaalimuoto on numeroiden (0-9) ja kirjainten (A-F, a-f) yhdistelmä."
				},{
					type: "name",
		...
		WIRELESS_5G: {	
			...
			CONTENT: [{
				type: "name",
				title: "Ota langaton radio käyttöön",
				content: "Valitse tämä valintaruutu ottaaksesi käyttöön 5 GHz:n langattoman radiotaajuuden. Jos tämä poistetaan käytöstä, tällä taajuusalueella ei tueta WPS-toimintoa."
			},{
				type: "name",
				title: "Langattoman verkon nimi (SSID)",
				content: "Voit jättää verkon oletusnimen (SSID) silleen tai antaa uuden nimen (enintään 32 merkkiä). Tämä kenttä erottelee kirjainkoon."
				...
				type: "name",
				title: "Piilota SSID",
				content: "Valitse tämä valintaruutu, jos haluat piilottaa 5 GHz:n verkon nimen (SSID) Wi-Fi-verkkojen luettelosta. Jos tämä valitaan, tällä taajuusalueella ei tueta WPS-toimintoa."
			},{
				type: "name",
				title: "Suojaus",
				content: "Valitse jokin seuraavista suojausvaihtoehdoista:",
		...
		WIRELESS_60G: {	
			TITLE: "60 GHz:n langaton verkko",
			CONTENT: [{
				type: "name",
				title: "Ota langaton radio käyttöön",
				content: "Valitse tämä valintaruutu ottaaksesi käyttöön 60 GHz:n langattoman radiotaajuuden. Jos tämä poistetaan käytöstä, tällä taajuusalueella ei tueta WPS-toimintoa."
			},{
				type: "name",
				title: "Langattoman verkon nimi (SSID)",
				content: "Voit jättää verkon oletusnimen (SSID) silleen tai antaa uuden nimen (enintään 32 merkkiä). Tämä kenttä erottelee kirjainkoon."
				...
				type: "name",
				title: "Piilota SSID",
				content: "Valitse tämä valintaruutu, jos haluat piilottaa 60 GHz:n verkon nimen (SSID) Wi-Fi-verkkojen luettelosta. Jos tämä valitaan, tällä taajuusalueella ei tueta WPS-toimintoa."
			},{
				type: "name",
				title: "Suojaus",
				content: "Valitse jokin seuraavista suojausvaihtoehdoista:",
				children: [{
					...
					type: "name",
					title: "WPA2 – Personal",
					content: "Valitse tämä vaihtoehto ottaaksesi käyttöön vakiotodennusmenetelmän, joka perustuu PSK:hon (Pre-shared Key); kutsutaan myös salasanaksi. Salaustyyppi on GCMP. Tätä vaihtoehtoa suositellaan. Jos valitset sen, konfiguroi seuraavat.",
					children: [{
						type: "name",
						title: "Salasana",
						content: "Anna tähän kenttään langattoman verkon salasana pituudeltaan 8-63 ASCII-merkkiä tai 8-64 heksadesimaalista merkkiä."
					...
					content: "Valitse tämä vaihtoehto ottaaksesi käyttöön edistyneemmän todennusmenetelmän, joka hyödyntää RADIUS (Remote Authentication Dial In User Service) -palvelinta. Salaustyyppi on GCMP. Jos tämä valitaan, tällä taajuusalueella ei tueta WPS-toimintoa.",
					children: [{
						type: "name",
						title: "RADIUS-palvelimen IP-osoite",
						content: "Anna RADIUS-palvelimen IP-osoite."
				...
				type: "name",
				title: "Kanava",
				content: "Valitse 60 GHz:n langattoman verkon kanava. Suositellaan, että kanavaksi jätetään Auto, jos langaton yhteys ei katkeile."
			},{
				type: "paragraph",
				content: "Tallenna kaikki asetukset napsauttamalla Tallenna."
			}]
		...
		WPS_WIZARD: {
			...
			CONTENT:[{
				type: "paragraph",
				content: "WPS tukee ainoastaan seuraavaa kokoonpanoa: ota käyttöön <Ota käyttöön langaton radio>, poista käytöstä <Piilota SSID> ja suojaus on <Ei suojausta> tai <WPA/WPA2-Personal> (WPA2-PSK tai auto + AES tai auto), jos WPS-toiminto on käytössä."
			},{
				type: "name",
		...
		WIRELESS_STATISTICS: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Yhteystyyppi",
				content: "Näyttää kyseisen langattoman asiakaslaitteen langattoman yhteyden taajuusalueen (2,4 GHz, 5 GHz tai 60 GHz)."
			},{
				type: "name",
				title: "Suojaus",
		...
		FOLDER_SHARE_ACCOUNT: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Käyttäjätunnus/salasana",
				content: "Anna käyttäjätunnus välillä 1-15 aakkosnumeerista merkkiä tai alaviivaa ja salasanan välillä 1-15 ASCII-merkkiä. Näissä kentissä erotellaan isot ja pienet kirjaimet."
			},{
				type: "name",
		...
		FOLDER_SHARE_SETTINGS: {
			...
			CONTENT: [{
				...
				content: "Näyttää nimen, jolla liitettyä USB-lattennuslaitetta käytetään. Nimen on muodostuttava aakkosnumeerisista merkeistä, alaviivoista ja tavuviivoista ja oltava 4-15 merkkiä pitkä."
			},{
				type: "name",
				title: "Ota käyttöön",
		...
		OFFLINE_DOWNLOAD: {	
			...
			CONTENT: [{
				type: "name",
				title:"Tila",
				content: "Kytke päälle ottaaksesi käyttöön Offline Download (Offline-lataus) -ominaisuuden."
			},{
				type: "name",
				title:"Kansion polku",
				content: "Offline download (Offline-lataus) -toiminnon työhakemisto. Voit valita hakemistopolun, kun tilapainike on päällä; muutoin kohteen toimintotaulukko pysyy näkymättömänä, jolloin et voi tehdä mitään muuta. Kun työhakemisto on valittu, kaikki seuraavien toimintojen luomat tiedostot tallennetaan hakemistoon tai sen välimuistiin. Jos aktiivisia kohteita on, työhakemistoa ei voi muuttaa, ja suositellaan että et irrota USB-tallennuslaitetta, mikä voisi aiheuttaa vakavia virheitä, joita ei voi korjata."
			},{
				type: "name",
				title:"Aikataulu",
				content: "Jos valittu, voit valita latausaikajaksot. Aikataulu astuu voimaan reitittimen järjestelmäajan mukaisesti, joka voidaan määrittää kohdasta \"System Tools -> Time Settings\" (Järjestelmätyökalut -> Aika-asetukset)."
			},{
				type: "name",
				title:"Jatka alkuarvon antamista tehtävän suorittamisen jälkeen",
				content: "Jos valittu, suoritettu tehtävä jatkaa siementen lisäämistä."
			},{
				type: "name",
				title: "Aktiivisten tehtävien maksimimäärä",
				content: "Näyttää aktiivisten tehtävien maksimimäärän."
			},{
				type: "name",
				title:"Suurin latausnopeus",
				content: "Näyttää suurimman latausnopeuden."
			},{
				type: "name",
				title:"Suurin lähetysnopeus",
				content: "Näyttää pienimmän lähetysnopeuden."
			},{
				type: "name",
				title: "Yhteyksien määrä",
				content: "Näyttää yhteysasetukset."
			},{
				type: "name",
				title: "Yhteyksien globaali maksimimäärä",
				content: "Muuta rajoittaaksesi kaikkien tehtävien yhteyksien maksimimäärää."
			},{
				type: "name",
				title: "Yhdistettyjen vertaislaitteiden maksimimäärä virtaa kohden",
				content: "Muuta rajoittaaksesi tehtävän yhteydessä olevien vertaislaitteiden maksimimäärää."
			},{
				type: "name",
				title: "Ota DHT-verkko käyttöön",
				content: "Jos valittu, DHT on käytössä."
			},{
				type: "name",
				title: "Ota vertaislaitteiden vaihto käyttöön",
				content: "Jos valittu, vertaislaitteen tietojen vaihto on käytössä."
			},{
				type: "name",
				title: "Ota BitTorrent-protokollan salaus käyttöön",
				content: "Jos valittu, BitTorrent-protokollan salaus on käytössä."
			},{
				type: "name",
				title:"aMule-palvelin",
				content: "Anna aMule-palvelimen IP-osoite ja portti muodostaaksesi yhteyden."
			}]
		},
		...
		OFFLINE_DOWNLOAD_ITEMS: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Näyttää ladattavat kohteet."
			},{
				type: "name",
				title: "Tiedosto",
				content: "Näyttää ladattavan tiedoston nimen."
			},{
				type: "name",
				title:"Nopeus",
				content: "Näyttää lähetys- ja latausnopeuden."
			},{
				type: "name",
				title: "Valmis",
				content: "Näyttää valmiin koon ja kokonaiskoon."
			},{
				type: "name",
				title:"Jäljellä oleva aika",
				content: "Näyttää latauksen jäljellä olevan ajan."
			},{
				type: "name",
				title:"Yhdistetyt vertaislaitteet",
				content: "Näyttää yhdistettyjen vertaislaitteiden tiedot."
			},{
				type: "name",
				title: "Tila",
				content: "Näyttää tehtävän tilan."
			},{
				type: "name",
				title: "Lähde",
				content: "Näyttää lataustyypin."
			},{
				type: "step",
				title: "Ladattavan kohteen lisääminen",
				content: [
					"1. Napsauta Lisää.",
					"2. Valitse latauksen lähdetyyppi:",
					"1) Virta PC:ltä: Napsauta Browse (Selaa) valitaksesi virtatiedoston PC:ltä.",
					"2) Virta USB:ltä: Valitse asema ja napsauta Browse (Selaa) valitaksesi virtatiedoston USB:ltä.",
					"3) URL: Kirjoita URL (HTTP, HTTPS, FTP, ed2k).",
					"3. Napsauta OK."
				]
			}]
		},
		...
		PARENTAL_CONTROL_DEVICES: {
			...
			CONTENT: [{
				...
				content: [
					...
					"5. Valitse Ota käyttöön.",
					"6. Tallenna syöte napsauttamalla OK."
				]
			},{
				type: "paragraph",
		...
		PARENTAL_CONTROL_RESTRICTION: {
			...
			CONTENT: [{
				...
				type: "note",
				title: "Huomautus",
				content: "Hakusanat voivat olla myös verkkotunnusten nimiä, kuten mail.google.com ja www.facebook.com."
			},{
				type: "paragraph",
				content: "Tallenna määritykset napsauttamalla Tallenna."
			}]
		},
		...
		QOS_RULE: {
			...
			CONTENT: [{
				...
				type: "step",
				title: "Säännön määrittäminen korkealle/keskitason/matalalle prioriteetille fyysisen portin mukaan",
				content: [
					"1. Napsauta Lisää.",
					"2. Valitse Fyysisen portin mukaan.",
					"3. Valitse haluamasi portti.",
					"4. Napsauta OK."
				]
			}]
		},
		...
		ACCESS_DEVICE: {
			...
			CONTENT: [{
				...
				content: "Valitse Online Devices (Online-laitteet) -taulukosta kaikki estettävät palvelut ja napsauta Block (Estä) taulukon päältä. Laite lisätään automaattisesti mustan listan laitteisiin."
			}],
		},
		...
		IPV6: {
			...
			CONTENT: [{
				...
				type: "title",
				title: "Internet-yhteystyyppi: 6RD"
			},{
				type: "name",
				title: "6RD",
				content: "Valitse tämä tyyppi, jos ISP käyttää 6RD-käyttöönottoa ja antaa IPv4-osoitteen sekä IPv6-osoitteen etulitteet."
			},{
				type: "name",
				title: "Määritystyyppi",
				content: "Valitse Auto tai Manuaalinen määrittääksesi 6RD-kanavan parametrit ISP:n tietojen mukaan. Jos alla oleva oletusparametri vastaa ISP:n tietoja, voit valita Auto; muussa tapauksessa valitse Manual ja anna ISP:n antamat parametrit."
			},{
				type: "name",
				title: "IPv4-peitteen pituus/6RD-etuliite/6RD-etuliitteen pituus/Border Reply IPv4 -osoite",
				content: "Merkitse, jos esiasetetut parametrit vastaavat ISP:ltä saatuja. Voit joko pitää oletusarvot tai syöttää parametrit manuaalisesti ISP:n tietojen mukaan."
			},{
				type: "title",
				...
				type: "name",
				title: "DS-Lite",
				content: "Valitse tämä tyyppi, jos ISP käyttää DS-Lite-käyttöönottoa ja antaa AFTR-toimialueen nimen tai IPv6-osoitteen IPv4-in-IPv6-tunnelin määrittämiseksi IPv6-verkkoon, jotta IPv4-liikenne tai IPv6-liikenne kulkisi omassa verkossaan."
			},{
				type: "name",
				title: "AFTR-nimi",
				content: "AFTR on lyhenne sanoista Address Family Transition Router. Anna tähän kenttään AFTR-toimialueen nimi tai IPv6-osoite, jonka sait ISP:ltä."
			},{
				type: "name",
				title: "Toissijainen yhteys",
				content: "Valitse toissijainen yhteystyyppi ISP:n tietojen mukaan.",
				children :[ 
				{
					type: "name",
					title: "Dynaaminen IP-osoite",
					content: "Valitse, antaako ISP dynaamisen IP:n toissijaiseksi yhteystyypiksi, ja ISP:n DHCPv6 -palvelin määrittää parametrit, IPv6-osoitteen, ensisijaisen DNS:n ja/tai toissijaisen DNS:n automaattisesti."
				},
				{
					type: "name",
					title: "Staattinen IP-osoite",
					content: "Valitse, antaako ISP staattisen IP:n toissijaiseksi yhteystyypiksi, ja anna IPv6-osoite, oletusyhdyskäytävä, ensisijainen DNS ja/tai toissijainen DNS ISP:n tietojen mukaan, ja määritä sitten MTU-koko manuaalisesti (tarvittaessa) tai säilytä oletusarvo."
				},{
					type: "name",
					title: "PPPoE",
					content: "Valitse, jos ISP antaa PPPoE:n toissijaiseksi yhteystyypiksi, ja anna ISP:ltä saatu käyttäjätunnus ja salasana. IPv6-osoite annetaan automaattisesti, kun napsautat Yhdistä."
				}]
			}*/,{
				type: "title",
		...
		FIRMWARE: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "Ennen kuin päivität reitittimen laiteohjelmiston, sinun on ladattava tietokoneeseesi tuorein laiteohjelmistopäivitys <a class=\"link\" href=\"javascript:void(0);\" id=\"update_url\" target=\"_blank\">TP-LINKin tuki</a> -sivustosta."
			},{
				type: "step",
		...
		ADMIN_REMOTE: {	
			...
			CONTENT: [{
				...
				content: "Anna kelvollinen IP-osoite, jotta voit käyttää reititintä."
			},{
				type: "paragraph",
				content: "Tallenna kaikki asetukset napsauttamalla Tallenna."
			}]
		...
		SYSTEM_PARA_WIRELESS: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Usean käyttäjän MIMO",
				content: "Tekniikka sallii reitittimen muodostaa pisteestä pisteeseen -yhteyden enintään kolmeen laitteeseen samanaikaisesti. Se parantaa nopeuksia merkittävästi ja vähentää laitteiden odotusaikaa verrattuna perinteiseen arkkitehtuuriin, sallien reitittimen palvella useampaa Wi-Fi-asiakasta samanaikaisesti minimoiden samalla kaistanleveyden pullonkaulat."
			},{
				type: "name",
		...
		SYSTEM_PARA_WDS: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "WDS-tila",
				content: "Valitse WDS-tila, Auto, WDS1 tai WDS2."
			},{
				type: "name",
				title: "Suojaus",
		...
		OPEN_VPN:{
			...
			CONTENT: [{
				...
				content: "Valitse ottaaksesi OpenVPN-palvelin käyttöön."
			},{
				type: "name",
				title: "Palvelun tyyppi",
		...
		OPEN_VPN_CERTIFICATE:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Käytä etäasiakkaiden VPN-yhteyden tiedoille ja identiteetille sertifikaattia."
			},{
				type: "name",
				title: "Luo",
		...
		OPEN_VPN_CONF:{
			...
			CONTENT: [{
				...
				type: "name",
				title: "Vie",
				content: "Napsauta tallentaaksesi OpenVPN-konfigurointitiedosto."
			}]
		},
		OPEN_VPN_GUIDE:{
			...
			CONTENT: [{
				...
				content:[{
					...
					"1. Valitse Enable VPN Server (Ota VPN-palvelin käyttöön).",
					"2. Määritä OpenVPN-palvelimen parametrit (Service Type (Palvelutyyppi), Service Port (Palveluportti), Client Access (Asiakaspääsy) ja VPN Subnet/Netmask (VPN:n aliverkko/peite)) ja napsauta Save (Tallenna).",
					"3. Tallenna kokoonpanotiedosto napsauttamalla Export (Vie).",
		...
		PPTP_VPN:{
			...
			CONTENT: [{
				...
				type: "name",
				title: "Ota VPN-palvelin käyttöön",
				content: "Valitse ottaaksesi PPTP VPN -palvelin käyttöön."
			},{
				type: "name",
		...
		PPTP_ACCOUNT_LIST:{
			...
			CONTENT: [{
				...
				type: "name",
				title: "muokkaaminen",
				content: "Näyttää vaihtoehdot muokata tai poistaa vastaavan tilin."
			}*/
			{
				type: "step",
		...
		PPTP_VPN_GUIDE:{
			...
			CONTENT: [{
				...
				content:[{
					...
					"1. Valitse Enable VPN Server (Ota VPN-palvelin käyttöön).",
					"2. Määritä PPTP VPN -palvelimen parametrit ja napsauta Save (Tallenna).",
		...
		BASIC_NETWORK_ROUTER: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "SSID",
				content: "Näyttää 2,4 GHz:n/5 GHz:n/60 GHz:n taajuusalueen langattoman verkon nimen."
			},{
				type: "name",
				title: "Kanava",
				content: "Näyttää kanavan, jolla langaton 2,4 GHz:n/5 GHz:n/GHz:n verkko lähettää."
			},{
				type: "name",
				title: "MAC",
				content: "Näyttää langattoman 2,4 GHz:n/5 GHz:n/60 GHz:n verkon MAC-osoitteen."
			},{
				type: "title",
				title: "Vierasverkko 2,4 Ghz/5 GHz"
			},{
		...
		BASIC_NETWORK_USB: {
			...
			CONTENT: [{
				type: "name",
				title: "USB-levy",
				content: "Näyttää reitittimeen liitetyn USB-aseman nimen."
			},{
				type: "name",
				title: "Yhteensä",
				content: "Näyttää liitetyn USB-tallennuslaitteen kokonaistallennuskapasiteetin."
			},{
				type: "name",
				title: "Käytettävissä",
				content: "Näyttää liitetyn USB-tallennuslaitteen vapaan tallennuskapasiteetin."
			}]
		},
		BASIC_INTERNET: {
			TITLE: "Internet",
		...
		BASIC_WIRELESS: {
			...
			CONTENT: [{
				type: "name",
				title: "Ota langaton radio käyttöön",
				content: "Valitse tämä valintaruutu ottaaksesi käyttöön 2,4 GHz:n/5 GHz:n/60 GHz:n langattoman radiotaajuuden."
			},{
				type: "name",
				title: "Langattoman verkon nimi (SSID)",
				...
				type: "name",
				title: "Piilota SSID",
				content: "Valitse tämä valintaruutu, jos haluat piilottaa 2,4 GHz:n/5 GHz:n/60 GHz:n verkon nimen (SSID) Wi-Fi-verkkojen luettelosta."
			},{
				type: "name",
				title: "Salasana",
				content: "Syötä tähän kenttään suojaustyyppiä vastaava langattoman verkon salasana (kirjainkoosta riippuvainen)."
			},{
				type:"paragraph",
				content:"Tallenna kaikki asetukset napsauttamalla Tallenna."
			}]
		...
		BASIC_GUEST_NETWORK: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Salasana",
				content: "Luo salasana, jossa on 8-63 ASCII-merkkiä tai 8-64 heksadesimaalimerkkiä (0-9, a-f, A-F) suojataksesi vierasverkon."
			},{
				type:"paragraph",
				content:"Tallenna kaikki asetukset napsauttamalla Tallenna."
			}]
