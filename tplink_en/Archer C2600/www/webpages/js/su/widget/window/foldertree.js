...
$.su.Widget("foldertree",{
	...
	initRoot: function(me, params){
		...
		var	inHTML =	"<div class=\"foldertree-root\">";
			...
			inHTML +=			"<span class=\"icon\"></span>";
			inHTML +=			"<span class=\"text folder-display-name\">"+data.name+"</span>";
			inHTML +=		"</a>";
			inHTML +=		"<ul class=\"foldertree-wrap root-node foldertree-root-wrap\" data-path=\""+data.path+"\"></ul>";
			inHTML +=		"<ul class=\"foldertree-wrap root-node foldertree-leaf-wrap\" data-path=\""+data.path+"\"></ul>";
			inHTML +=	"</div>";
