...
$.su.Widget("progressbar", {
	...
	//console.log(arguments)
		...
		var	percentageStart = parseInt(arguments[1]*100, 10),
			percentageEnd = parseInt(arguments[2]*100, 10),
			duration = $.type(parseInt(arguments[3], 10)) === "number" ? parseInt(arguments[3], 10) : 500,
