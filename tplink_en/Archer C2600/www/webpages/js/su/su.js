...
$.su.vtype.types = {
	...
	mac: {
		...
		disallowAllMultiText: $.su.CHAR.VTYPETEXT.MAC_INVALID_MULTICAST,
		validator: function(value){
			var patternBroad = /^([fF]{2}\-){5}[fF]{2}$/
			if (patternBroad.test(value))
			{
				return $.su.CHAR.VTYPETEXT.MAC_INVALID_BROADCAST;
			}
	...
	string_ip_domain_no_loop:{
		...
		validator: function(value){
			...
			{
				return $.su.vtype.types["ip"].validator(value);
			}
...
$.su.format = {
	...
	ip: function(ipStr){
		...
		for (var i = 0; i < len; i++) 
		{
			...
			{
				resultArr.push(parseInt(arr[i],10));
			}
			else
			{
				if(arr[i] == "")
...
$.su.cloudError = function(errorcode){
	var errorMsg = "";
	switch(errorcode){
		case "-10100":
		case "-10101":
		...
		case "-20106":
		case "-20107":
			errorMsg = $.su.CHAR.ERROR["00004178"];
			break;
		case "-20502":
			errorMsg = $.su.CHAR.ERROR["00004179"];
			break;
		case "-20507":
			errorMsg = $.su.CHAR.ERROR["00004180"];
			break;
		case "-20571":
			errorMsg = $.su.CHAR.ERROR["00004181"];
			break;
		case "-20606":
			errorMsg = $.su.CHAR.ERROR["00004182"];
			break;
		case "-20609":
			errorMsg = $.su.CHAR.ERROR["00004182"];
			break;
		case "-20608":
			errorMsg = $.su.CHAR.ERROR["00004183"];
			break;
		case "-20661":
			errorMsg = $.su.CHAR.ERROR["00004184"];
			break;
		case "-20662":
			errorMsg = $.su.CHAR.ERROR["00004185"];
			break;
		case "-20671":
			errorMsg = $.su.CHAR.ERROR["00004186"];
			break;
		case "-20672":
			errorMsg = $.su.CHAR.ERROR["00004187"];
			break;
		case "-20673":
			errorMsg = $.su.CHAR.ERROR["00004188"];
			break;
		case "-20674":
			errorMsg = $.su.CHAR.ERROR["00004189"];
			break;
		...
		case "-22000":
			errorMsg = $.su.CHAR.ERROR["00004148"];
			break;
		case "-22001":
			errorMsg = $.su.CHAR.ERROR["00004149"];
			break;
		case "-22002":
			errorMsg = $.su.CHAR.ERROR["00004151"];
			break;
		case "-22003":
			errorMsg = $.su.CHAR.ERROR["00004152"];
			break;
		case "-22004":
			errorMsg = $.su.CHAR.ERROR["00004153"];
			break;
		case "-22006":
			errorMsg = $.su.CHAR.ERROR["00004154"];
			break;
		case "-20200":
			errorMsg = $.su.CHAR.ERROR["00004174"];
			break;
		case "-20202":
			errorMsg = $.su.CHAR.ERROR["00004175"];
			break;
		case "-20503": 
			errorMsg = $.su.CHAR.ERROR["00004146"];	
			break;
		case "-20506": 
			errorMsg = $.su.CHAR.ERROR["00004147"];	
			break;
		case "-20600": 
			errorMsg = $.su.CHAR.ERROR["00004155"];
			break;
		case "-20601": 
			errorMsg = $.su.CHAR.ERROR["00004173"];
			break;
		case "-20602": 
			errorMsg = $.su.CHAR.ERROR["00004139"];
			break;
		case "-20607": 
			errorMsg = $.su.CHAR.ERROR["00004142"];
			break;
		case "-20615": 
			errorMsg = $.su.CHAR.ERROR["00004143"];			
			break;
		case "-20616": 
			errorMsg = $.su.CHAR.ERROR["00004145"];			
			break;
		case "-20621":
			errorMsg = $.su.CHAR.ERROR["00004176"];
			break;
		case "-20622":
			errorMsg = $.su.CHAR.ERROR["00004144"];
			break;
		case "-50101":
			errorMsg = $.su.CHAR.ERROR["00004158"];
			break;
		case "-50102":
			errorMsg = $.su.CHAR.ERROR["00004159"];
			break;
		case "-50103":
			errorMsg = $.su.CHAR.ERROR["00004160"];
			break;
		case "-50111":
			errorMsg = $.su.CHAR.ERROR["00004161"];
			break;
		case "-50112":
			errorMsg = $.su.CHAR.ERROR["00004162"];
			break;
		case "-50121":
			errorMsg = $.su.CHAR.ERROR["00004164"];
			break;
		case "-50122":
			errorMsg = $.su.CHAR.ERROR["00004165"];
			break;
		case "-50131":
			errorMsg = $.su.CHAR.ERROR["00004167"];
			break;
		case "-50132":
			errorMsg = $.su.CHAR.ERROR["00004168"];
			break;
		case "-50140":
			errorMsg = $.su.CHAR.ERROR["00004169"];
			break;
		case "-51200": 
			errorMsg = $.su.CHAR.ERROR["00004156"];			
			break;
		case "-51211": 
			errorMsg = $.su.CHAR.ERROR["00004150"];			
			break;
		case "-51215": 
			errorMsg = $.su.CHAR.ERROR["00004140"];			
			break;
		case "-51218": 
			errorMsg = $.su.CHAR.ERROR["00004157"];			
			break;
		case "-10000": 
			errorMsg = $.su.CHAR.ERROR["00004192"];			
			break;
		default:
			errorMsg = $.su.CHAR.ERROR["00004192"];
	}
