(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Fate clic su Aggiungi.",
                "2. Fate clic su Scansiona per selezionare un servizio dall'elenco per popolare automaticamente il numero porta appropriato nei campi Porta Esterna e Porta Interna. Se il servizio non è elencato, immettete il numero Porta Esterna (es. 21) o un range di porte (es. 21-25). Lasciate la Porta Interna vuota se è uguale alla Porta Esterna o immettete un numero porta specifico (es. 21) se la Porta Esterna è una porta singola. Immettete l'indirizzo IP del computer che usa il servizio applicativo in formato decimale puntato nel campo IP Interno.",
       ...
       content: [{                      
                ...
                "1. Fate clic su Aggiungi.",
                "2. Fate clic su Scansiona per selezionare un'applicazione dall'elenco per popolare automaticamente il valori di default nei campi appropriati. Se volete aggiungere un'applicazione non elencata, immettete manualmente Applicazione, Porta Triggering, Protocollo Triggering, Porta Esterna e Protocollo Esterno.",
       ...
       content: [ 
                ...
                "Nota: L'icona Condividi appare quando sono connessi al router più di 5 volumi. Fate clic sull'icona per disabilitare i volumi che non volete condividere."]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Metodo di accesso",
                           content: "Vi sono 4 metodi per accedere al dispositivo di storage USB condiviso.",
       children: [{                      
                           type: "name",
                           title: "Risorse di rete",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "Selezionate questa opzione per abilitare la funzione server SFTP che permette a client e utenti SFTP della rete di accedere al dispositivo di storage USB tramite l'indirizzo SFTP mostrato nella colonna Indirizzi."
                       }]
} ,{                      
                           type: "name",
                           title: "Indirizzo",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "Nota",
                           content: "L'icona Condividi appare nella sezione Impostazioni Dispositivo quando sono connessi al router più di 5 volumi. Fate clic sull'icona Condividi per disabilitare i volumi che non volete condividere."
                       }]
},
       FOLDER_SHARING :{ 
       ...
       content: [ 
                ...
                "La Username deve contenere fra 1 e 15 caratteri usando lettere e cifre."]
                           ...
                           type: "name",
                           title: "Consentiaccesso a rete ospiti",
                           content: "Spostate su Acceso per permettere agli utenti della Rete Ospiti di accedere alle cartelle condivise."
                       } ,{                      
                           type: "name",
                           title: "Attiva condivisione file multimediali",
