(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Klicken Sie Hinzufügen.",
                "2. Klicken Sie Suchen, um einen Dienst aus der Liste auszuwählen und die Portnummernfelder automatisch ausfüllen zu lassen. Ist Ihr gewünschter Dienst nicht aufgeführt, geben Sie den Externen Port (z.B. 21) oder einen Portbereich (z.B. 21-25) ein. Lassen Sie das Feld Interner Port frei, wenn dieser dem Externen Port entspricht. Geben Sie die lokale IP-Adresse des Gerätes, auf dem der Dienst läuft, in das Feld Interne IP-Adresse ein.",
       ...
       content: [{                      
                ...
                "1. Klicken Sie Hinzufügen.",
                "2. Klicken Sie Suchen, um eine Anwendung aus der Liste auszuwählen und die Standardwerte automatisch eintragen zu lassen. Möchten Sie eine nicht aufgeführte Anwendung nutzen, gaben Sie Namen, Applikation, Triggerport, Triggerprotokoll, Externer Port und Externes Protokoll von Hand ein.",
       ...
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Zugriffsmethode",
                           content: "Es gibt vier Möglichkeiten auf den freigegebenen USB-Datenträger zuzugreifen.",
       children: [{                      
                           type: "name",
                           title: "Samba/UNC",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "Wählen Sie diese Option, um den SFTP-Server zu aktivieren, so dass SFTP-Clients und -Benutzer über die in der Adressspalte sichtbare SFTP-Adresse SFTP-Zugriff auf den USB-Datenträger erhalten."
                       }]
} ,{                      
                           type: "name",
                           title: "Adresse",
       ...
       content: [ 
                ...
                "Das Passwort darf 1 bis 15 Buchstaben, Ziffern und Unterstriche enthalten."]
                           ...
                           type: "name",
                           title: "Zugriff aus dem Gastnetz erlauben",
                           content: "Aktivieren Sie dies, um auch Gastnetzteilnehmern den Zugriff auf die freigegebenen Ordner zu ermöglichen."
                       } ,{                      
                           type: "name",
                           title: "Medienfreigabe",
