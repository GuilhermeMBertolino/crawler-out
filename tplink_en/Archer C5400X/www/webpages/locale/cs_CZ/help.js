(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Klikněte na Přidat.",
                "2. Klikněte na Scan, čímž zvolíte službu ze seznamu pro automatické vyplnění čísla portu do polí Externí port a Interní port. Jestliže není služba na seznamu, vložte číslo externího portu (např.: 21) nebo rozsah portů (např.: 21-25). Pole interního portu nechte prázdné, jestliže se jedná o stejný jako externí, nebo vložte konkrétní číslo portu (např.:21) v případě, že externí port je jediný. Vložte IP adresu počítače, na kterém běží aplikace této služby v desetinném formátu s tečkami do pole Interní IP.",
       ...
       content: [{                      
                ...
                "1. Klikněte na Přidat.",
                "2. Klikněte na Scan, čímž zvolíte aplikaci ze seznamu pro automatické vyplnění výchozích hodnot do příslušných polí. Jestliže chcete přidat aplikaci, která není na seznamu, vložte manuálně Application, Triggering Port, Triggering Protocol, External Port a External Protocol.",
                "3. Vyberte Povolit.",
                "4. Klikněte na Uložit."]
} ,{                      
                           type: "note",
       ...
       content: [ 
                ...
                "Poznámka: Ikona Sdílet se objevuje, když je připojeno více než 5 svazků k routeru. Můžete kliknout na ikonu pro zakázání svazků, které nepotřebujete sdílet."]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Metoda přístupu",
                           content: "Existují 4 metody přístupu ke sdílenému USB úložišti.",
       children: [{                      
                           type: "name",
                           title: "Okolní počítače",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "Zvolte tuto možnost pro povolení funkce SFTP server, která umožňuje SFTP klientům a uživatelům v síti přistupovat k USB úložištím pomocí SFTP adresy zobrazené ve sloupci Adresa."
                       }]
} ,{                      
                           type: "name",
                           title: "Adresa",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "Poznámka",
                           content: "Ikona Sdílení se zobrazuje v sekci Nastavení Zařízení, když je více než 5 svazků připojeno k routeru. Můžete kliknout na ikonu sdílení pro zakázání svazků, které nepotřebujete sdílet."
                       }]
},
       FOLDER_SHARING :{ 
       ...
       content: [ 
                ...
                "Heslo by mělo obsahovat 1 až 15 znaků - písmen, číslic nebo podtržítek."]
                           ...
                           type: "name",
                           title: "Povolit přístup klientům sítě pro hosty",
                           content: "Zapněte pro umožnění uživatelům sítě pro hosty přistupovat ke všem sdíleným složkám."
                       } ,{                      
                           type: "name",
                           title: "Povolit sdílení médií",
