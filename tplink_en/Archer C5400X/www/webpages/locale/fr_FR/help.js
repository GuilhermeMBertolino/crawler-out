(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Cliquer sur Ajouter.",
                "2. Cliquer sur Détecter pour choisir un service et compléter automatique le N° de port interne et externe dans les champs dédiés. Si le Service n'est pas listé, saisir manuellement les N° de port (ex : 21) ou plages de ports (ex : 21-25). Laisser le N° de port interne vierge s'il est identique au port externe sinon saisir le N° de port spécifique si le port externe est unique. Saisir l'adresse IP de l'ordinateur fournissant le service au format xxx.xxx.xxx.xxx dans le champ IP interne.",
       ...
       content: [{                      
                ...
                "1. Cliquer sur Ajouter.",
                "2. Cliquer sur Détecter pour choisir une application et compléter automatique les informations dans les champs dédiés. Si l'application n'est pas listée, saisir manuellement les informations adéquates dans les champs : Application, Port de déclenchement, Protocole de déclenchement, port et protocole externe.",
       ...
       content: [ 
                ...
                "Remarque : l'icône partage apparait quand plus de 5 volumes sont connectés au routeur. Vous pouvez cliquer sur l'icône pour désactiver les volumes que vous ne souhaitez pas partager."]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Méthode d'accès",
                           content: "Il existe quatre méthodes d'accès aux périphériques de stockage USB partagés.",
       children: [{                      
                           type: "name",
                           title: "Voisinage réseau",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "Sélectionner cette option pour activer fonctionnalité serveur SFTP permettant aux clients et utilisateurs SFTP d'accéder au périphérique de stockage USB via l'adresse SFTP affichée dans la colonne adresse."
                       }]
} ,{                      
                           type: "name",
                           title: "Adresse",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "Remarque",
                           content: "L'icône partage apparait quand plus de 5 volumes sont connectés au routeur. Vous pouvez cliquer sur l'icône pour désactiver les volumes que vous ne souhaitez pas partager."
                       }]
},
       FOLDER_SHARING :{ 
       ...
       content: [ 
                ...
                "Le mot de passe doit contenir 1 à 15 caractères comprenant lettres, chiffres et _."]
                           ...
                           type: "name",
                           title: "Permettre l'accès au réseau invités",
                           content: "Basculer sur On pour autoriser les clients du réseau invité à accéder aux dossiers partagés par le routeur."
                       } ,{                      
                           type: "name",
                           title: "Autoriser le partage de médias",
