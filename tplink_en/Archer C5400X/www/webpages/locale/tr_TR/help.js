(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Ekle'ye tıklayın.",
                "2. Harici Port ve Dahili Port alanlarında uygun port numarasını otomatik olarak doldurmak için Tara butonuna tıklayarak bir servis seçiniz. İstediğiniz servis listede yoksa, Harici Port numarasını (ör. 21) veya port aralığını (ör. 21-25) giriniz. Harici Port, Dahili Port ile aynı ise boş bırakınız veya Harici Port tekli bir port ise (ör. 21) belirli bir port numarası giriniz. Dahili IP alanına noktalı ondalık formatta servisin çalıştığı bilgisayarın IP adresini giriniz. ",
       ...
       content: [{                      
                ...
                "1. Ekle'ye tıklayın.",
                "2. Uygun alanlara varsayılan değerleri otomatik olarak doldurmak için Tara butonuna tıklayarak listeden bir uygulama seçiniz. Eklemek istediğiniz uygulama listede yoksa, Uygulama, Tetikleyici Port, Tetikleyici Protokol, Harici Port ve Harici Protokol değerlerini manuel olarak giriniz.",
       ...
       content: [ 
                ...
                "Uyarı: Paylaş ikonu router’a bağlı depolama aygıtında 5 birimden daha fazla olduğunda görüntülenmektedir. Birimleri paylaşmak istemiyorsanız devre dışı bırakmak için ikona tıklayabilirsiniz."]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Erişim Yöntemi",
                           content: "Paylaşılan USB depolama aygıtına erişmek için 4 yöntem vardır.",
       children: [{                      
                           type: "name",
                           title: "Ağ Komşuları",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "SFTP istemcilerinin ve ağdaki kullanıcıların Adres sütununun altında gösterilen SFTP adresi üzerinden USB depolama aygıtına erişmesine izin veren SFTP sunucu özelliğini etkinleştirmek için bu seçeneği belirleyin."
                       }]
} ,{                      
                           type: "name",
                           title: "Adres ",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "Uyarı",
                           content: "Paylaş ikonu router’a bağlı depolama aygıtında 5 birimden daha fazla olduğunda görüntülenmektedir. Birimleri paylaşmak istemiyorsanız devre dışı bırakmak için ikona tıklayabilirsiniz."
                       }]
},
       FOLDER_SHARING :{ 
       ...
       content: [ 
                ...
                "Parola, harf, sayı ve alt çizgiler içeren 1 ila 15 karakterden oluşmalıdır."]
                           ...
                           type: "name",
                           title: "Misafir Ağ Erişimine İzin Ver",
                           content: "Misafir ağındaki kullanıcıların paylaşılan tüm klasörlere erişebilmesi için anahtarı etkin konuma getirin."
                       } ,{                      
                           type: "name",
                           title: "Medya Paylaşımını Etkinleştir",
