(function($){
    ...
    $.su = $.su || {};    $.su.CHAR = {
       ...
       QOS :{ 
           ...
           NOTES:"Huomautukset",
           NOTE1:"GeForce NOW on valittu oletusasetukseksi, jotta voimme optimoida pilvipelikokemuksesi. Saat lisää tietoa ja voit liittyä GeForce NOW -palveluun osoitteessa <a class=\"link\" href=\"http://www.geforcenow.com\" target=\"_blank\">www.geforcenow.com</a>.",
           NOTE2:"Valitse pelitila (Gaming) priorisoidaksesi muuta pelaamista kuin GeForce NOW -pilvipelaamista.",
           NOTE3:"Vaihda tilaa tarpeidesi mukaan valitsemalla mikä tahansa yllä olevista kuvakkeista.",
      ...
      ANTI_VIRUS :{ 
       ...
       SPEED_TEST :{ 
           ...
           UNAVAILABLE_TIP:
               "Alkaen {date} nopeustestitoiminnon tuki päättyy, koska teemme tietä uudelle ja paremmalle työkalulle. Siihen asti se toimii normaalisti. Pahoittelemme tästä aiheutuvaa vaivaa ja takaamme, että teemme kovasti töitä uuden työkalun julkaisemiseksi pian. Jos sinulla on kysyttävää, ota yhteyttä tekniseen tukeemme."
},
       BASIC_QOS :{ 
      QOS: "QoS",
           APPLICATION_PRIORITY:"Sovellusprioriteetti",
