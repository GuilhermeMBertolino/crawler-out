(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Kattintson a Hozzáadás gombra.",
                "2. A Szkennelés gombra kattintva kiválaszthat egy szolgáltatást a listáról, hogy automatikusan kitöltse a megfelelő portszámot a Külső Port és a Belső Port mezőkben. Ha a szolgáltatás nincs felsorolva, adja meg a külső portszámot (például 21) vagy a portok tartományát (például 21-25). Hagyja a belső portot üresen, ha megegyezik a külső porttal, vagy adja meg az adott portszámot (például 21), ha a külső port egyetlen port. Írja be a kiszolgáló alkalmazást futtató számítógép pontozott decimális formátumú IP-címét a Belső IP mezőbe.",
       ...
       content: [{                      
                ...
                "1. Kattintson a Hozzáadás gombra.",
                "2. Kattintson a Szkennelés gombra egy alkalmazás kiválasztásához a listából, hogy az alapértelmezett értékeket automatikusan kitöltse a megfelelő mezőkbe. Ha nem listázott alkalmazást szeretne felvenni, kézzel adja meg az Alkalmazást, a Trigger Portot, a Trigger protokollt, a Külső portot és a Külső protokollt.",
       ...
       content: [ 
                ...
                "Megjegyzés: A Megosztás ikon akkor jelenik meg, ha több mint 5 kötet van csatlakoztatva a routerhez. Az ikonra kattintva letilthatja azokat a köteteket, amelyeket nem szeretne megosztani."]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Hozzáférési mód",
                           content: "A megosztott USB-tárolóeszköz eléréséhez 4 mód érhető el.",
       children: [{                      
                           type: "name",
                           title: "Hálózati helyek",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "Jelölje be ezt az opciót az SFTP-kiszolgáló funkció engedélyezéséhez, amely lehetővé teszi, hogy az SFTP-ügyfelek és a hálózaton lévő felhasználók hozzáférjenek az USB-tárolóeszközhöz a Cím oszlopban látható SFTP-cím segítségével."
                       }]
} ,{                      
                           type: "name",
                           title: "Cím",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "Megjegyzés ",
                           content: "A Megosztás ikon megjelenik az Eszközbeállítások részben, ha több mint 5 kötet csatlakozik az útválasztóhoz. A Megosztás ikonra kattintva letilthatja azokat a köteteket, amelyeket nem szeretne megosztani."
                       }]
},
       FOLDER_SHARING :{ 
       ...
       content: [ 
                ...
                "A jelszónak 1-15 karaktert kell tartalmaznia betűkkel, számjegyekkel és aláhúzással."]
                           ...
                           type: "name",
                           title: "Vendéghálózati hozzáférés engedélyezése",
                           content: "Kapcsolja be, hogy a vendég hálózati felhasználók hozzáférjenek az összes megosztott mappához."
                       } ,{                      
                           type: "name",
                           title: "Média megosztás bekapcsolása",
