(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Apăsați Adaugă.",
                "2. Apăsați Scanare pentru a selecta un serviciu din listă și a popula automat numărul portului corespunzător în câmpurile Port Extern și Port Intern. În cazul în care serviciul nu este listat, introduceți numărul portului extern (de exemplu, 21), sau o serie de porturi (de exemplu, 21-25). Lăsați liber câmpul Port Intern în cazul în care este același ca și Portul Extern sau introduceți un anumit număr de port (de exemplu, 21), în cazul în care Portul Extern este un singur port. Introduceți adresa IP a computerului care rulează aplicația serviciului în format zecimal cu puncte în câmpul de IP intern.",
       ...
       content: [{                      
                ...
                "1. Apăsați Adaugă.",
                "2. Apăsați Scanare pentru a selecta o aplicație din listă și a popula automat valorile implicite în câmpurile corespunzătoare. În cazul în care doriți să adăugați o aplicație nelistată, completați câmpurile Application, Triggering Port, Triggering Protocol, Port Extern și Protocol Extern.",
       ...
       content: [ 
                ...
                "Notă: Pictograma Partajare apare atunci când mai mult de 5 volume sunt conectate la router. Aveți posibilitatea să apăsați pe pictogramă pentru a dezactiva volumele pe care nu doriți să le partajați."]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Metoda de Acces",
                           content: "Există 4 metode pentru a accesa dispozitivul de stocare USB partajat.",
       children: [{                      
                           type: "name",
                           title: "Rețea Locală",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "Selectează această opțiune pentru a activa funcția de server SFTP, ce permite clienților SFTP și utilizatorilor din rețea să acceseze dispozitivul de stocarea USB folosind adresa SFTP afișată în coloana Adresă."
                       }]
} ,{                      
                           type: "name",
                           title: "Adresă",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "Notă",
                           content: "Pictograma Partajare apare în secțiunea Setări Dispozitiv atunci când mai mult de 5 volume sunt conectate la router. Aveți posibilitatea să apăsați pe pictograma Partajare pentru a dezactiva volumele pe care nu doriți să le partajați."
                       }]
},
       FOLDER_SHARING :{ 
       ...
       content: [ 
                ...
                "Parola trebuie să conțină 1 până la 15 caractere folosind litere, cifre și caracterul _."]
                           ...
                           type: "name",
                           title: "Acces Guest Network",
                           content: "Activați pentru a permite utilizatorilor rețelei vizitatori să acceseze toate folderele partajate."
                       } ,{                      
                           type: "name",
                           title: "Activare Partajare Documente Media",
