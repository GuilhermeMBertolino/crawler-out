(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Bấm chọn Thêm.",
                "2. Bấm chọn Quét để chọn một dịch vụ từ danh sách để tự động xác định số cổng thích hợp tại trường Cổng trong và ngoài. Nếu dịch vụ không có trong danh sách, nhập số Cổng trong (ví dụ 21) hoặc khoảng cổng (ví dụ 21-25). Để trống trường Cổng trong nếu thông số giống với Cổng ngoài hoặc nhập một số cổng xác định (ví dụ 21) nếu Cổng ngoài là cổng đơn. Nhập địa chỉ IP của máy tính chạy ứng dụng dịch vụ theo dạng thập phân có dấu chấm vào trường IP nội bộ.",
       ...
       content: [{                      
                ...
                "1. Bấm chọn Thêm.",
                "2. Bấm chọn Quét để chọn một ứng dụng từ danh sách thả xuống để tự động xác định giá trị mặc định vào trường tương ứng. Nếu bạn muốn thêm một ứng dụng không có trong danh sách, vui lòng nhập Ứng dụng, Cổng kích hoạt, Giao thức kích hoạt, Cổng ngoài và Cồng trong theo cách thủ công.",
                "3. Chọn Kích hoạt.",
                "4. Nhấp vào Lưu."]
} ,{                      
                           type: "note",
       ...
       content: [ 
                ...
                "Lưu ý: Biểu tượng Chia sẻ xuất hiện khi có hơn 5 nhãn đang kết nối đến router. Bạn có thể bấm biểu tượng để vô hiệu hóa nhãn nếu bạn không muốn chia sẻ."]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Phương pháp tiếp cận",
                           content: "Có 4 phương pháp để truy cập thiết bị lưu trữ USB chia sẻ.",
       children: [{                      
                           type: "name",
                           title: "Mạng khu vực",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "Chọn tùy chọn này để kích hoạt tính năng máy chủ SFTP cho phép người dùng và máy khách SFTP trên mạng truy cập thiết bị lưu trữ USB thông qua địa chỉ SFTP được hiển thị trong cột Địa chỉ."
                       }]
} ,{                      
                           type: "name",
                           title: "Địa chỉ",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "Lưu ý",
                           content: "Biểu tượng chia sẻ xuất hiện trong mục Cài đặt thiết bị khi có hơn 5 nhãn đang kết nối đến router. Bạn có thể bấm biểu tượng Chia sẻ để vô hiệu hóa nhãn bạn không muốn chia sẻ."
                       }]
},
       FOLDER_SHARING :{ 
       ...
       content: [ 
                ...
                "Mật mã phải bao gồm 1 - 15 ký tự bằng chữ cái, chữ số và gạch dưới."]
                           ...
                           type: "name",
                           title: "Cho phép truy cập mạng khách",
                           content: "Chuyển sang Mở để cho phép người dùng mạng khách truy cập thư mục chia sẻ."
                       } ,{                      
                           type: "name",
                           title: "Kích hoạt chia sẻ đa phương tiện",
