(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. Clique em Adicionar.",
                "2. Clique em Procurar para selecionar um serviço a partir da lista por forma a preencher automaticamente o número da porta adequado nos campos da porta externa e porta interna. Se o serviço não estiver na lista, digite o número da porta externa (por exemplo 21) ou um intervalo de portas (por exemplo, 21-25). Deixe o espaço em branco da porta interna se for a mesma da porta externa ou insira um número de porta específico (por exemplo 21) se a porta externa é uma única porta. Digite o endereço IP do computador que executa o aplicativo de serviço no formato decimal com pontos no campo IP interno.",
       ...
       content: [{                      
                ...
                "1. Clique em Adicionar.",
                "2. Clique em Procurar para selecionar um aplicativo da lista para preencher automaticamente os valores predefinidos nos campos apropriados. Se pretender adicionar uma aplicação não listada, digite manualmente a aplicação, Porto Trigerring, protocolo de Triggering, porta externa e protocolo externo.",
                "3. Selecione Ativar.",
                "4. Clique em Gravar."]
} ,{                      
                           type: "note",
       ...
       content: [ 
                ...
                "Nota: O ícone Partilhar aparece quando 5 ou mais volumes estiverem ligados ao Router. Pode clicar no ícone para desativar os volumes que não pretende partilhar."]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Método de Acesso",
                           content: "Há 4 métodos para aceder ao dispositivo de armazenamento USB partilhado.",
       children: [{                      
                           type: "name",
                           title: "Vizinhança de Rede",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "Selecione esta opção para ativar a função de Servidor FTP, do qual permite que aplicações SFTP e utilizadores na sua rede acedam ao dispositivo de armazenamento USB, através do endereço do Servidor FTP apresentado na coluna de endereços."
                       }]
} ,{                      
                           type: "name",
                           title: "Endereço",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "Nota",
                           content: "O ícone Partilhar aparece na secção de Definições do Dispositivo quando 5 ou mais volumes estão ligados ao Router. Pode clicar no ícone Partilhar para desativar os volumes que não pretende partilhar."
                       }]
},
       FOLDER_SHARING :{ 
       ...
       content: [ 
                ...
                "A senha deve conter de 1 a 15 caracteres incluindo letras, dígitos e traço sublinhado."]
                           ...
                           type: "name",
                           title: "Permitir Acesso da Rede de Convidados",
                           content: "Ative para permitir que os utilizadores da rede de convidados possam aceder a todas as pastas partilhadas."
                       } ,{                      
                           type: "name",
                           title: "Ativar a Partilha de Média",
