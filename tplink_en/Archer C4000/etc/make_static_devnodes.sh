...
mknod /dev/mmcblk0boot0  b 179 8
mknod /dev/mmcblk0boot1  b 179 16
mknod /dev/mmcblk0gp0    b 179 32
mknod /dev/mmcblk0gp1    b 179 48
mknod /dev/mmcblk0gp2    b 179 64
mknod /dev/mmcblk0gp3    b 179 80