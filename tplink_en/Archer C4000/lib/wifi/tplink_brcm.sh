...
wifi_smart() {
    echo "=====>>>>> you have set smart connect" >$STDOUT
    wifi_smart_config
}
...
wifi_reload() {
	...
	#set initial dutycycle 100%
	wl -i eth6 dutycycle_thermal 100
	wl -i eth7 dutycycle_thermal 100
	wl -i eth8 dutycycle_thermal 100
