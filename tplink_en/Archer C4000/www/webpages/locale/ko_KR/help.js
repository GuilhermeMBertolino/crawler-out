(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       content: [ 
                "1. 추가 버튼을 클릭하십시오.",
                "2. 스캔을 클릭하여 목록에서 서비스를 선택하면 외부 포트 및 내부 포트 영역에 알맞은 포트 번호가 자동 입력됩니다. 서비스가 목록에 존재하지 않는 경우, 외부 포트 번호(예: 21) 또는 포트 범위(예: 21-25)를 입력하십시오. 내부 포트가 외부 포트와 동일한 경우 내부 포트 영역을 비워두거나, 외부 포트가 유일한 포트인 경우에는 특정 포트 번호(예: 21)를 입력하십시오. 서비스 애플리케이션을 실행하는 컴퓨터의 IP 주소를 점으로 구분한 십진수 형태로 내부 IP 영역에 입력하십시오. ",
       ...
       content: [{                      
                ...
                "1. 추가 버튼을 클릭하십시오.",
                "2. 스캔을 클릭하여 목록에서 애플리케이션을 선택하면 기본값들이 해당 영역으로 자동 입력됩니다. 목록에 존재하지 않는 애플리케이션을 추가하려면 애플리케이션, 트리거링 포트, 트리거링 프로토콜, 외부 포트, 외부 프로토콜 등을 직접 입력하십시오. ",
                "3. 상태 사용함을 선택하십시오.",
                "4. 저장을 클릭합니다."]
} ,{                      
                           type: "note",
       ...
       content: [ 
                ...
                "참고: 5 개 이상의 볼륨이 공유기에 연결된 경우 '공유' 아이콘이 나타납니다. '공유' 아이콘을 클릭하면 공유하지 않아도 되는 볼륨이 비활성화 됩니다. "]
}]
},
       BASIC_SHARING_SETTINGS :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "접근 방법",
                           content: "공유 USB 스토리지 장치에 액세스하는 4 가지 방법이 있습니다.",
       children: [{                      
                           type: "name",
                           title: "네트워크 이웃",
                           ...
                           type: "name",
                           title: "SFTP",
                           content: "SFTP 클라이언트와 네트워크 사용자가 주소 열에 표시된 SFTP 주소를 통해 USB 저장 장치에 액세스 할 수있게하는 SFTP 서버 기능을 사용하려면이 옵션을 선택합니다."
                       }]
} ,{                      
                           type: "name",
                           title: "주소",
       ...
       BASIC_FOLDER_SHARING :{ 
               ...
               CONTENT: [{
                           ...
                           type: "note",
                           title: "참고:",
                           content: "5개 이상의 볼륨이 공유기에 연결되는 경우, '공유' 아이콘이 '단말기 환경설정' 섹션에 나타납니다. '공유' 아이콘을 클릭하면 공유가 필요 없는 볼륨이 비활성화 됩니다. "
                       }]
},
       FOLDER_SHARING :{ 
               TITLE:"공유 컨텐츠 및 보안",
       ...
       content: [ 
                ...
                "암호는 문자, 숫자, 밑줄을 포함하여 1-15자여야 합니다."]
                           ...
                           type: "name",
                           title: "게스트 네트워크 액세스 허용",
                           content: "클릭하여 게스트 네트워크 사용자가 모든 공유 폴더에 액세스할 수 있도록 허용합니다."
                       } ,{                      
                           type: "name",
                           title: "미디어 공유 사용함",
