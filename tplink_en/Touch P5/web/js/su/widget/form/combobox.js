	...
	create: function(defaults, options){
		...
		me.each(function(i, obj){
			...
			if (this.fieldLabel !== null){
				...
				inHTML +=				"<input class=\"combobox-text "+obj.inputCls+"\" type=\"text\" tabindex=\"-1\" "+(this.readOnly ? "readonly=\"true\"" : "")+ " value=\"" + (this.noneSelectedRemind ? obj.noneSelectedText+ "\"": "\"") + " />";	//ç›®å‰å…ˆåšæˆreadonly
				inHTML +=				"<input class=\"combobox-hidden hidden\" name=\""+obj.name+"\" type=\"checkbox\" checked=\"true\" disabled=\"disabled\"/>";
