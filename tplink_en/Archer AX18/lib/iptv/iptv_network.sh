...
iptv_proto_set_ifname()
{
    ...
    lua /lib/iptv/iptv_config.lua set protocol passthrough ifname "$1"
    lua /lib/iptv/iptv_config.lua set protocol dslite ifname "$1"
    lua /lib/iptv/iptv_config.lua set protocol v6plus ifname "$1"
    lua /lib/iptv/iptv_config.lua set protocol pppoeshare ifname "$1"
    lua /lib/iptv/iptv_config.lua set protocol 6rd ifname "$1"
    
    lua /lib/iptv/iptv_config.lua set protocol static ifname "$1"
    lua /lib/iptv/iptv_config.lua set protocol dhcp ifname "$1" 
    lua /lib/iptv/iptv_config.lua set protocol pppoe ifname "$1" 
    lua /lib/iptv/iptv_config.lua set protocol pptp ifname "$1" 
    lua /lib/iptv/iptv_config.lua set protocol l2tp ifname "$1"
}
