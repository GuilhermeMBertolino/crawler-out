...
PROTO_TBL = {
    ...
    dslite = {
        ...
        {key = "AFTR_name",},
        {key = "is_support_dynamic_mode",},
        {key = "dynamic_mode",}
    },
    v6plus = {
        proto = "v6plus", wan_type = "v6plus"
    },
    staticv6 = {
    ...
    pppoeshare = {
        proto = "pppoeshare", wan_type = "pppoeshare",
        {key = "username"},
        {key = "password"},
        {key = "inet_ip", readonly = true},
        {key = "ip6addr", readonly = true},
...
local function get_default_mac()
    local mac = sys.call("network_get_firm wan")
    if mac == nil or not chk.check_mac(mac) then
        mac = "0c-4a-08-11-12-13"
    end
    mac = util.trim(mac)
    return mac:gsub("-", ":")
end
...
local function proto_cfg_xxtp(proto, proto_name)
    ...
    if proto.snd_conn == "dynamic" then
        ...
        xxtp_wan.dns = dns_concat(proto.static_pridns or "", proto.static_snddns or "")
    end
...
local function proto_cfg_pppoe(proto, proto_name)
    ...
    if pppoe_wan.macaddr == nil or not chk.check_mac(pppoe_wan.macaddr) then
        proto.macaddr = get_default_mac()
    end
    string.gsub(proto.macaddr,"(%x+)",function (w)
        table.insert(mac_num,w)
    end)
    mac5 = tonumber(mac_num[5],16)%255+1
    mac6 = tonumber(mac_num[6],16)%255+1

    if proto.snd_conn == "none" then
        pppoe_wan.proto = "none"
        if wlan.wireless_get_country() == "GB" and (mac5 and mac6) then
            pppoe_wan.proto = "static"
            pppoe_wan.ipaddr = "169.254."..tostring(mac5).."."..tostring(mac6)
            pppoe_wan.netmask = "255.255.255.0"
        end
    ...
    local pppoe_inet = {
        ...
        dns         = proto.dns_mode == "static" and dns_concat(proto.static_pridns or "", proto.static_snddns or "") or "",
...
local function proto_cfg_dhcp(proto, proto_name)
    ...
    if proto.dns_mode == "static" then
        dhcp_wan.dns = dns_concat(proto.manual_pridns or "", proto.manual_snddns or "")
    end
...
local function proto_cfg_static(proto, proto_name)
    local static_wan = {
        ...
        dns         = dns_concat(proto.pri_dns or "", proto.snd_dns or ""),
        conn_mode   = "auto",
        connectable = "1",
    }
...
local function proto_cfg_dhcpv6(proto, proto_name)
    ...
    if proto.dns_mode == "static" then
        dhcpv6_wanv6.dns = dns_concat(proto.static_pridns or "", proto.static_snddns or "")
    end
...
local function proto_cfg_pppoev6(proto, proto_name)
    ...
    if proto.dns_mode == "static" then
        pppoe_wanv6.dns = dns_concat(proto.static_pridns or "", proto.static_snddns or "")
    end
...
local function proto_cfg_pppoeshare(proto, proto_name)
    local pppoe_wan = {
        wan_type = PROTO_TBL[proto_name].wan_type,
        ifname   = proto.ifname,
        macaddr  = proto.macaddr,
    ...
    if proto.snd_conn == "none" then
        pppoe_wan.proto = "none"
	    if uci_r:get("wireless", "eth1", "country") == "GB" and pppoe_wan.macaddr ~= nil then
            pppoe_wan.proto = "static"
            pppoe_wan.ipaddr = "169.254."..tostring(mac5).."."..tostring(mac6)
            pppoe_wan.netmask = "255.255.255.0"
        end
    ...
    if proto.ip_config == "specified" then
        pppoe_wan.ip6addr = proto.specific_ipv6
    end

    if proto.dns_mode == "static" then
        pppoe_wan.dnsv6 = dns_concat(proto.static_pridnsv6 or "", proto.static_snddnsv6 or "")
    end
    ...
    local pppoe_inet = {
        ...
        ip_mode     = proto.ip_mode,
        dns_mode    = proto.dns_mode,
        ipv6_mode   = proto.ipv6_mode,
        dnsv6_mode  = proto.dnsv6_mode,
        ipaddr      = proto.ip_mode == "static" and proto.specific_ip or "",
        dns         = proto.dns_mode == "static" and dns_concat(proto.dns or "", proto.static_pridns or "", proto.static_snddns or "") or proto.dns,
        keepalive   = (proto.interval == "0" or proto.interval == nil) and "" or (5 .. " " .. proto.interval),
        auto        = "0",
	conn_mode   = proto.conn_mode,
        connectable = proto.connectable,
...
local function proto_cfg_6to4(proto, proto_name)
    ...
    if proto.dns_mode == "static" then
        tunnel_wanv6.dns = dns_concat(proto.pri_dns or "", proto.snd_dns or "")
    end
...
local function proto_cfg_dslite(proto, proto_name)
    local dslite_wan = {
        ...
        conn_mode       = "auto",
        parent          = "wanv6",
        dynamic_mode    = proto.dynamic_mode,
        is_support_dynamic_mode = proto.is_support_dynamic_mode
    }
    if proto.dynamic_mode == "0" then
        if chk.check_ipv6(proto.AFTR_name) then
            dslite_wan.peeraddr = proto.AFTR_name
        else
            dslite_wan.AFTR_name = proto.AFTR_name
        end
    end
    local dslite_wanv6 = {
        connectable = proto.connect,
    ...
    if proto.snd_conn == "dynamic" then
        ...
        if proto.dynamic_dns_mode == "static" then
            dslite_wanv6.dns = dns_concat(proto.dynamic_static_pridns or "", proto.dynamic_static_snddns or "")
        end
    elseif proto.snd_conn == "static" then
        ...
        dslite_wanv6.dns         = dns_concat(proto.static_pri_dns or "", proto.static_snd_dns or "")
    else 
        ...
        if proto.pppoe_ip_config == "specified" then
            dslite_wanv6.ip6addr = proto.pppoe_specific_ip
        end
    end
    return {wan = dslite_wan ,  wanv6= dslite_wanv6}
end

local function proto_cfg_v6plus(proto, proto_name)
    local v6plus_wan = {
        proto          = PROTO_TBL[proto_name].proto,
        wan_type       = PROTO_TBL[proto_name].wan_type,
        parent          = "wanv6",
	...
	if proto.snd_conn == "dynamic" then
        v6plus_wanv6.proto       = "dhcp6c"
        v6plus_wanv6.wan_type    = "dhcp6c"
        v6plus_wanv6.ip_config   = proto.dynamic_ip_config
        v6plus_wanv6.ip_mode     = proto.dynamic_ip_mode
        v6plus_wanv6.dns_mode    = proto.dynamic_dns_mode
        v6plus_wanv6.peerdns     = proto.dynamic_dns_mode == "static" and "0" or "1"
        v6plus_wanv6.connectable = proto.connect
        if proto.dynamic_dns_mode == "static" then
            v6plus_wanv6.dns = dns_concat(proto.dynamic_static_pridns or "", proto.dynamic_static_snddns or "")
        end
    elseif proto.snd_conn == "static" then
        v6plus_wanv6.proto       = 'static'
        v6plus_wanv6.wan_type    = 'static'
        v6plus_wanv6.mtu         = proto.static_mtu
		v6plus_wanv6.ip6addr     = proto.static_ip6addr
        v6plus_wanv6.ip6gw       = proto.static_ip6gw
        v6plus_wanv6.dns         = dns_concat(proto.static_pri_dns or "", proto.static_snd_dns or "")
    else 
        v6plus_wanv6.proto       = 'pppoev6'
        v6plus_wanv6.wan_type    = 'pppoev6'
        v6plus_wanv6.mru         = 1492
        v6plus_wanv6.keeplive    = proto.keeplive
        v6plus_wanv6.dns_mode    = proto.pppoe_dns_mode
        v6plus_wanv6.ip_mode     = proto.pppoe_ip_mode
        v6plus_wanv6.ip_config   = proto.pppoe_ip_config
        v6plus_wanv6.username    = proto.pppoe_username
        v6plus_wanv6.password    = proto.pppoe_password
        if proto.pppoe_ip_config == "specified" then
            v6plus_wanv6.ip6addr = proto.pppoe_specific_ip
        end
    end

    return {wan = v6plus_wan, wanv6 = v6plus_wanv6, hgw = v6plus_dhcp}
end
...
PROTO_CFG_TBL = {
    ...
    ["pppoeshare"]  = proto_cfg_pppoeshare,
    ["6to4"]        = proto_cfg_6to4,
    ["6rd"]         = proto_cfg_6rd,
    ["dslite"]      = proto_cfg_dslite,
    ["v6plus"]      = proto_cfg_v6plus,
