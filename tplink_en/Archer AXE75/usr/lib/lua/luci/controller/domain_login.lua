...
local function tips_get()
    ...
    if conflict then
       uci_c:set("domain_login", "tp_domain", "conflict", "off")
       uci_c:commit("domain_login") 
    end
    ...
    local hide_forgetpassword = uci_c:get_profile("administration", "hide_password_recovery") or "no"
    ...
    return {
                ...
                ["domain"] = domain,
                ["dst_addr"] = dst_addr,
                ["dst_webpath"] = dst_wpath,
                ["new_addr"] = mngr_addr,
                ["redirect"] = redirect,
                ["hide_forgetpassword"] = hide_forgetpassword
           }
end
