...
var ERR_SYS_DAYLIGHTSAVING_INPUT_FAIL 						=18006
var ERR_SYS_DAYLIGHTSAVING_GET_FAIL							=18007
var ERR_SYS_DAYLIGHTSAVING_WRONG							=18008
...
var ERR_INVALID_FLODER_PATH									=33005				/* ftp share folder invalid */
...
str_err[ERR_REMOTE_MANAGE_PORT_OUT_OF_RANGE]	=	"Port is out of range (1-65535), or specific ports(e.g. 21/25/110) browser doesn't support. Please input another one.";
...
str_err[ERR_SYS_DAYLIGHTSAVING_INPUT_FAIL]		=	"The input time's format is invalid. Please input another one.";
str_err[ERR_SYS_DAYLIGHTSAVING_GET_FAIL]		=	"Get current time failure.";
str_err[ERR_SYS_DAYLIGHTSAVING_WRONG]			=	"Time setting is invalid. Please input another one.";
...
str_err[ERR_INVALID_FLODER_PATH]				= 	"Invalid share folder";
...
str_err[ERR_IPV6_STATICIP_ERROR_GATEWAY]		= 	"The IPv6 default gateway is error."
