if (!$.paramsloaded)
{
	var menulist = ["status.htm", "qsStart.htm", "sysMode.htm", "iptv.htm", "ethIptv.htm", 
					...
					"backNRestore.htm", "defaultCfg.htm", "softup.htm", "restart.htm", "stat.htm", 
                    "ledControl.htm", "languageSelect.htm"];
	$.paramsloaded = true;
	if (!$.find)
