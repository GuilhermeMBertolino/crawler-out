...
var ManageControlHelpRpm =
{
	...
	"management_0": "<B>Remote Management IP Address</B> - This is the current address you will use when accessing your Router from the Internet. ",
...
var WlanAdvHelpRpm =
{
	...
	"brief": "<B>Transmit Power</B> - Here you can specify the transmit power of the Router. You can select 100%, 75% or 50% which you would like.",
...
var QsModeHelpRpm =
{
	...
	"mode_router": "<B>Wireless Router(Default)</B>: In this mode, the device enables multiple users to share the Internet connection via ADSL/Cable Modem. The LAN devices share the same IP from ISP through Wireless port. While connecting to Internet, the LAN/WAN Ethernet port works as a WAN port at Wireless Router mode.",
