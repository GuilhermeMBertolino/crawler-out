...
e_str[ERR_DHCP_PRESVR_IP_CONFLICT] = "Địa chỉ IP không thể nằm cùng lớp mạng với địa chỉ IP LAN.";
...
e_str[ERR_MULTI_MODE_ALREADY] = "Chế độ được chọn đã áp dụng.";
...
e_str[ERR_SNMP_RCOMMUNITY_NOT_ASCII]	= "Đọc chung phải ở định dạng ký tự ASCII.";
e_str[ERR_SNMP_SCOMMUNITY_NOT_ASCII]	= "Cài đặt chung phải ở định dạng ký tự ASCII";

// 86050-86099 PingWatchDog
e_str[ERR_PING_WATCHDOG_IPADDR_INVALID]			= "Địa chỉ IP không khả dụng!";
e_str[ERR_PING_WATCHDOG_INTERVAL_INVALID] 		= "Giá trị khoảng thời gian từ 10 đến 300 giây!";
e_str[ERR_PING_WATCHDOG_STARTDELAY_INVALID] 	= "Giá trị hoãn từ 60 đến 300 giây!";
e_str[ERR_PING_WATCHDOG_FAILCOUNT_INVALID] 		= "Giá trị đếm thất bại từ 1 đến 65535!";
...
e_str[ERR_LAN6_DHCP6S_START_ID_INVALID]		= "ID giao diện IPv6 bắt đầu không hợp lệ! Please input a hexadecimal number in range(1-FFFE).";
e_str[ERR_LAN6_DHCP6S_END_ID_INVALID]		= "ID giao diện IPv6 kết thúc không hợp lệ! Vui lòng nhập số định dạng thập lục phân nằm trong khoảng (1-FFFE).";
...
e_str[ERR_WLAN_BEACONINTERVAL_OUTRANGE]="Giá trị mốc báo khoảng cách phải nằm trong phạm vi 40-1000. Vui lòng kiểm tra đầu vào.";
...
e_str[ERR_WLAN_DTIMTH_OUTRANGE]="Giá trị khoảng DTIM phải nằm trong phạm vi 1-15. Vui lòng kiểm tra đầu vào.";
...
e_str[ERR_WLAN_MSSID_VLAN_INVALID]="Giá trị ID VLAN chứa ký tự không hợp lệ. Xin vui lòng kiểm tra.";
e_str[ERR_WLAN_MSSID_VLAN_OUTRANGE]="Giá trị ID VLAN phải nằm trong khoảng 1-4094. Xin vui lòng kiểm tra.";
e_str[ERR_WLAN_REGION_IS_EMPTY]="Chọn khu vực từ trình đơn thả xuống. Nếu quốc gia hoặc khu vực của bạn không có trong danh sách, việc sử dụng vô tuyến không dây trong khu vực này có thể sẽ bị hạn chế.";
