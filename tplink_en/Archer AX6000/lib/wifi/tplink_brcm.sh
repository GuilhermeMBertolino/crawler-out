...
wifi_country() {
	...
	if [ "$cmd_flag" = "0" ]; then
		...
		for dev in ${DEVICES}; do
			...
			#Add for Evalulate,CC Code: US/1, DE/1
			local evaluate_flag=`nvram get tp_evaluateflag`
			if [ "$evaluate_flag" = "1" ]; then
				if [ "$tmpCode" = "DE" ]; then
					nvram set ${HOME_WIFI}_country_code="DE"
...
#vifs is wl01 wl02 wl03 wl04 wl11 wl12 wl13	wl14
				for vif in $vifs; do
					config_get_bool enable $vif enable
					config_get ifname $vif ifname  
#ifname is eth6 wl0.3 wl0.2 eth7 wl1.3 wl1.2					
...
init_nvram_lan() {
	...
	nvram set lan_ifnames="eth1 eth2 eth3 eth4 eth5 eth6 eth7"
...
init_nvram_ax6000_only() {
	...
	local evaluate_flag=`nvram get tp_evaluateflag`
	if [ "$evaluate_flag" = "1" ]; then
		#For Evalulate boardlimit
		nvram set 1:maxp2ga0="0x6a"
		nvram set 1:maxp2ga1="0x6a"
		nvram set 1:maxp2ga2="0x6a"
		nvram set 1:maxp2ga3="0x6a"
		nvram set 1:maxp5gb0a0="106"
		nvram set 1:maxp5gb0a1="106"
		nvram set 1:maxp5gb0a2="106"
		nvram set 1:maxp5gb0a3="106"
		nvram set 1:maxp5gb1a0="106"
		nvram set 1:maxp5gb1a1="106"
		nvram set 1:maxp5gb1a2="106"
		nvram set 1:maxp5gb1a3="106"
		nvram set 1:maxp5gb2a0="106"
		nvram set 1:maxp5gb2a1="106"
		nvram set 1:maxp5gb2a2="106"
		nvram set 1:maxp5gb2a3="106"
		nvram set 1:maxp5gb3a0="106"
		nvram set 1:maxp5gb3a1="106"
		nvram set 1:maxp5gb3a2="106"
		nvram set 1:maxp5gb3a3="106"
		nvram set 1:maxp5gb4a0="106"
		nvram set 1:maxp5gb4a1="106"
		nvram set 1:maxp5gb4a2="106"
		nvram set 1:maxp5gb4a3="106"
		nvram set 2:maxp2ga0="0x6a"
		nvram set 2:maxp2ga1="0x6a"
		nvram set 2:maxp2ga2="0x6a"
		nvram set 2:maxp2ga3="0x6a"
	else
		nvram set 1:maxp2ga0="0x66"
		nvram set 1:maxp2ga1="0x66"
		nvram set 1:maxp2ga2="0x66"
		nvram set 1:maxp2ga3="0x66"
		nvram set 1:maxp5gb0a0="0x66"
		nvram set 1:maxp5gb0a1="0x66"
		nvram set 1:maxp5gb0a2="0x66"
		nvram set 1:maxp5gb0a3="0x66"
		nvram set 1:maxp5gb1a0="0x66"
		nvram set 1:maxp5gb1a1="0x66"
		nvram set 1:maxp5gb1a2="0x66"
		nvram set 1:maxp5gb1a3="0x66"
		nvram set 1:maxp5gb2a0="0x66"
		nvram set 1:maxp5gb2a1="0x66"
		nvram set 1:maxp5gb2a2="0x66"
		nvram set 1:maxp5gb2a3="0x66"
		nvram set 1:maxp5gb3a0="0x66"
		nvram set 1:maxp5gb3a1="0x66"
		nvram set 1:maxp5gb3a2="0x66"
		nvram set 1:maxp5gb3a3="0x66"
		nvram set 1:maxp5gb4a0="0x66"
		nvram set 1:maxp5gb4a1="0x66"
		nvram set 1:maxp5gb4a2="0x66"
		nvram set 1:maxp5gb4a3="0x66"
		nvram set 2:maxp2ga0="0x66"
		nvram set 2:maxp2ga1="0x66"
		nvram set 2:maxp2ga2="0x66"
		nvram set 2:maxp2ga3="0x66"
	fi
	#end
...
# Wireless phy_ed_thresh for AX6000 AC-PHY
# For (wl is_edcrs_eu)
...
init_nvram_run() {
	...
	nvram set landevs="eth1 eth2 eth3 eth4 eth5 eth6 eth7"
	nvram set wfi_cmd=""
	nvram set wfi_error=""
	nvram set coma_sleep=""
	nvram set partialboots="0"
	nvram set br0_ifname="br-lan"
	nvram set br0_ifnames="eth1 eth2 eth3 eth4 eth5 eth6 eth7"
}
...
wifi_smart_config()
{
	...
	if [ "${smart_enable}" = "on" ]; then
	    stop_bsd
	    # only for AX6000, bsd has some problem, use band-steering in nrd instead
	    # start_bsd
...
wifi_led_set() {
	...
	if [ "$wifi_2g_off" = "1" -a "$wifi_5g_off" = "1" ] ; then
		ledcli WIFI_ALLOFF
	else
