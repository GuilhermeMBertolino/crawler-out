...
bcm_4908_set_wan_phy_mode ()
{
	...
	if [ $1 == "auto" ] ; then
		params1="auto"
	elif [[ $1 == "1000F" || $1 == "1000H" || $1 == "100F" || $1 == "100H" || $1 == "10F" || $1 == "10H" ]] ; then 
		params1="${1}D"
	else
	...
	cmd="ethctl eth0 media-type ${params1} &"
...
# valid input param
# auto, 2500F, 1000F, 100F
#
bcm_4908_phy2g5_set_wan_mode ()
{
	local err_pre="***error bcm_4908_set_wan_2G5_phy_mode()"
	local cmd=""
	local params1=""
	...
	if [ $1 == "auto" ] ; then
		params1="auto"
	elif [[ $1 == "2500F" || $1 == "1000F" || $1 == "100F" ]] ; then 
		params1="${1}D"
	else
		echo  "${err_pre}: invalid value $1" >&2
		return 1		
