    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                    ...
                    type: "name",
                    title: "2,4GHz | 5 GHz-1 | 5 GHz-2 Vierasverkko",
                    content: "Ota 2,4GHz | 5 GHz-1 | 5 GHz-2 vierasverkko käyttöön napsauttamalla vastaavaa painiketta."
                }, {
                    type: "name",
                    ...
                    type: "paragraph",
                    content: "Yllä olevat 2,4 GHz vierasverkon ohjeet koskevat myös 5 GHz-1 | 5 GHz-2 vierasverkkoa."
                }, {
                    type: "name",
                    title: "Tallenna",
                    content: "Tallenna kaikki asetukset napsauttamalla."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                ...
                content: "Aseta sen langattomat lisäasetukset valitsemalla 2,4GHz | 5 GHz-1 | 5 GHz-2."
            }, {
                type: "name",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                    ...
                    type: "name",
                    title: "2,4GHz | 5GHz-1 | 5GHz-2",
                    content: "Aseta sen langattoman yhteyden aikataulu valitsemalla 2,4GHz | 5 GHz-1 | 5 GHz-2."
                }, {
                    type: "name",
                    title: "Langaton aikataulu",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                    ...
                    type: "name",
                    title: "2,4GHz | 5GHz-1 | 5GHz-2",
                    content: "Vaihda vastaavat asetukset valitsemalla 2,4GHz | 5 GHz-1 | 5 GHz-2."
                }, {
                    type: "name",
                    title: "Langaton radio",
                    content: "Ota 2,4GHz | 5 GHz-1 | 5 GHz-2 langaton radiotaajuus käyttöön valitsemalla tämä valintaruutu."
                }, {
                    type: "name",
                    ...
                    type: "name",
                    title: "Piilota SSID",
                    content: "Valitse tämä valintaruutu, jos haluat piilottaa 2,4GHz | 5 GHz-1 | 5 GHz-2 verkon nimen (SSID) Wi-Fi-verkon luettelosta."
                }, {
                    type: "name",
                    title: "Suojaus",
                    content: "Valitse jokin seuraavista suojausasetuksista:",
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Langaton verkko 2,4GHz | 5 GHz-1 | 5 GHz-2",
                content: "Ota 2,4GHz | 5 GHz-1 | 5 GHz-2 vierasverkko käyttöön valitsemalla vastaava painike."
            }, {
                type: "name",
                title: "Vierasverkko SSID",
                content: "Käytä oletus-SSID:tä tai luo uusi nimi käyttäen 1-32 merkkiä. Tämä kenttä on isot ja pienet kirjaimet erotteleva."
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                type: "title2",
                content: "2,4 GHz | 5 GHz-1 | 5 GHz-2 Langaton"
            }, {/*
                type: "name",
                title: "Tila",
                content: "Näyttää, onko 2,4 GHz | 5 GHz-1 | 5 GHz-2 langaton yhteys päällä (käytössä) tai pois päältä (pois käytöstä)."
            }, {*/
                type: "name",
                title: "SSID",
                content: "Näyttää nykyisen langattoman verkon nimen taajuuskaistalle 2,4GHz | 5 GHz-1 | 5 GHz-2."
            }, {
                type: "name",
                title: "Kanava",
                content: "Näyttää kanavan, johon langaton 2,4 GHz | 5 GHz-1 | 5 GHz-2 verkko lähettää."
            }, {
                type: "name",
                title: "MAC",
                content: "Näyttää langattoman 2,4GHz | 5 GHz-1 | 5 GHz-2 verkon nykyisen MAC-osoitteen."
            }, {
                type: "title2",
                content: "2,4GHz | 5 GHz-1 | 5 GHz-2 Vierasverkko"
            }, {
                type: "name",
                title: "Tila",
                content: "Näyttää, onko 2,4 GHz | 5 GHz-1 | 5 GHz-2 vierasverkko päällä (käytössä) tai pois päältä (pois käytöstä)."
            }, {
                type: "name",
                title: "SSID",
        ...
        wirelessBasic: {
            ...
            CONTENT: [{
                type: "name",
                title: "2,4GHz | 5GHz-1 | 5GHz-2 Langaton verkko",
                content: "Ota 2,4GHz | 5 GHz-1 | 5 GHz-2 langaton radiotaajuus käyttöön valitsemalla tämä valintaruutu."
            }, {
                type: "name",
                title: "Langattoman verkon nimi (SSID)",
                ...
                type: "name",
                title: "Piilota SSID",
                content: "Valitse tämä valintaruutu, jos haluat piilottaa 2,4GHz | 5 GHz-1 | 5 GHz-2 SSID:n Wi-Fi-verkon luettelosta."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
               ...
               /* type: "name",
                ...
                content: "Valitse näyttääksesi 2,4GHz | 5 GHz-1 | 5 GHz-2 langattoman verkon asetukset ja tiedot."
            }, {
                type: "name",
                title: "Verkon nimi",
                ...
                type: "name",
                title: "2,4G | 5G-1 | 5G-2",
                content: "Valitse näyttääksesi 2,4GHz | 5 GHz-1 | 5 GHz-2 vierasverkon asetukset ja tiedot."
            }, {
                type: "name",
                title: "Vierasverkko SSID",
                ...
                type: "paragraph",
                display: "$.sysMode == 'DSL'",
                content: "Näyttää DSL-yhteyden tietoja."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Linjan tila",
                content: "Näyttää onko DSL-liittymä kytketty vai katkaisu."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "DSL-modulaatiotyyppi",
                content: "Näyttää DSL-toiminnon modulaatiotyypin, jota DSL-yhteys käyttää."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Liitetyyppi",
                content: "Näyttää DSL-toiminnon liitetyypin, jota DSL-yhteys käyttää."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Nykyinen nopeus (kbps)",
                content: "Näyttää DSL-yhteyden nykyisen lataus verkkoon- ja lataus verkosta-nopeuden."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Maksiminopeus (kbps)",
                content: "Näyttää DSL-yhteyden lataus verkkoon- ja lataus verkosta-maksiminopeuden."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "SNR-marginaali (dB)",
                content: "Näyttää DSL-yhteyden lataus verkkoon- ja lataus verkosta-SNR-marginaalin."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Linjavaimennus (dB)",
                content: "Näyttää DSL-yhteyden linjavaimennuksen."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Virheet (paketit)",
                content: "Näyttää DSL-yhteyden lataus verkkoon- ja lataus verkosta-virheiden määrän."
            }]
        },
        time: {
        ...
        ddns: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "Dynaamisen DNS:n (toimialueen nimijärjestelmä) avulla voit määrittää kiinteän isännän ja verkkotunnuksen dynaamiseen Internet IP-osoitteeseen. Siitä on hyötyä, kun isännöit omaa sivustoa, FTP-palvelinta tai toista reitittimen palvelinta. Sinun täytyy ensin kirjautua sisään DDNS-palveluntarjoajana kuten <a href='http://www.dyndns.com'>www.dyndns.com</a>."
            }, {
                type: "name",
                title: "Palveluntarjoaja",
                content: "Valitse DDNS-palveluntarjoaja. Jos et ole rekisteröitynyt DDNS-tiliä, valitse <b>Siirry rekisteröitymään</b>"
            }, {
                type: "name",
                title: "Käyttäjänimi / Salasana",
                content: "Anna DDNS-tilisi käyttäjänimi ja salasana."
            }, {
                type: "name",
                title: "Verkkotunnus",
                content: "Anna DDNS-palveluntarjoajan antama verkkotunnus."
            }, {
                type: "name",
                title: "Kirjaudu sisään / ulos",
                content: "Kirjaudu sisään tai kirjaudu ulos DDNS-palvelusta napsauttamalla."
            }, {
                type: "name",
                title: "Tallenna",
                content: "Tallenna kaikki asetukset napsauttamalla."
                ...
                type: "paragraph",
                content: "Voit siirtyä DDNS-tilien välillä napsauttamalla Kirjaudu ulos, jolloin kirjaudut ulos nykyisestä tilistä, ja kirjautumalla takaisin sisään toisella tilillä."
            }]
        },
        dhcp: {
            TITLE: "DHCP-palvelin",
        ...
        sysconf: {
            TITLE: "Langattoman yhteyden lisäasetukset 2,4GHz | 5 GHz-1 | 5 GHz-2",
            CONTENT: [{
                type: "name",
                title: "Jäljiteaikaväli",
                content: "Anna arvo väliltä 25 ja 1 000 millisekuntia määrittääksesi kuinka kauan paketit lähetetään reitittimellä langattoman verkon synkronoimiseksi. Oletusarvo on 100 millisekuntia."
