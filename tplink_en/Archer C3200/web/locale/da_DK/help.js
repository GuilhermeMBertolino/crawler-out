    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                    ...
                    type: "name",
                    title: "2,4GHz | 5GHz-1 | 5GHz-2 gæstenetværk",
                    content: "Klik på den tilhørende knap for at aktivere gæstenetværk på 2,4Ghz | 5GHz-1 | 5GHz-2."
                }, {
                    type: "name",
                    ...
                    type: "paragraph",
                    content: "Vejledningen for 2,4GHz gæstenetværket ovenfor gælder også for gæstenetværk for 5GHz-1 | 5GHz-2."
                }, {
                    type: "name",
                    title: "Gem",
                    content: "Klik for at gemme alle dine indstillingerne."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                    ...
                    content: "Vælg 2,4Ghz, 5GHz-1 eller 5GHz-2 for at indstille deres avancerede trådløse indstillinger."
                }, {
                    type: "name",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                    ...
                    type: "name",
                    title: "2,4GHz | 5GHz-1 | 5GHz-2",
                    content: "Vælg 2,4Ghz, 5GHz-1 eller 5GHz-2 for at indstille dets trådløse plan."
                }, {
                    type: "name",
                    title: "Trådløs plan",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                    type: "name",
                    title: "Område",
                    content: "Vælg din region fra rullelisten. Dette felt angiver det område, hvor routerens trådløse funktion kan bruges. Det kan være ulovligt at benytte routerens trådløse funktion i et andet område end et af dem, der er specificeret i dette felt. Hvis dit land eller område ikke er på listen, bedes du kontakte dit lokale offentlige kontor for at få hjælp."
                }, */{
                    type: "name",
                    title: "Smart Connect",
                    ...
                    type: "name",
                    title: "2,4GHz | 5GHz-1 | 5GHz-2",
                    content: "Vælg 2,4GHz | 5GHz-1 | 5GHz-2 for at ændre de tilsvarende indstillinger."
                }, {
                    type: "name",
                    title: "Trådløs radio",
                    content: "Marker dette afkrydsningsfelt for at aktivere den trådløse 2,4GHz | 5GHz-1 | 5GHz-2 radiofrekvens."
                }, {
                    type: "name",
                    ...
                    type: "name",
                    title: "Skjul SSID",
                    content: "Marker dette afkrydsningsfelt, hvis du vil skjule 2,4GHz | 5GHz-1 | 5GHz-2 netværksnavnet (SSID) fra listen over trådløse netværk."
                }, {
                    type: "name",
                    title: "Sikkerhed",
                    content: "Vælg én af følgende sikkerhedsfunktioner:",
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                    ...
                    type: "name",
                    title: "Trådløst netværk 2,4GHz | 5GHz-1 | 5GHz-2",
                    content: "Vælg den tilhørende knap for at aktivere gæstenetværket på 2,4Ghz | 5GHz-1 | 5GHz-2."
                }, {
                    type: "name",
                    title: "Gæstenetværks SSID",
                    content: "Du kan enten bruge standard SSID eller oprette et nyt navn med op til 32 tegn. Dette felt skelner mellem store og små bogstaver."
        ...
        networkMap: {
            ...
            CONTENT: [{
                    ...
                    type: "title2",
                    content: "2,4GHz | 5GHz-1 | 5GHz-2 trådløs"
                }, {/*
                    type: "name",
                    title: "Status",
                    content: "Viser hvorvidt 2,4GHz | 5GHz-1 | 5GHz-2 trådløst er tændt (aktiveret) eller slukket (deaktiveret)."
                }, {*/
                    type: "name",
                    title: "SSID",
                    content: "Viser det aktuelle trådløse netværksnavn på 2,4GHz | 5GHz-1 | 5GHz-2 frekvensen."
                }, {
                    type: "name",
                    title: "Kanal",
                    content: "Viser den kanal som det trådløse 2,4GHz | 5GHz-1 | 5GHz-2 netværk udsender."
                }, {
                    type: "name",
                    title: "MAC",
                    content: "Viser den aktuelle MAC-adressen for det trådløse 2,4GHz | 5GHz-1 | 5GHz-2."
                }, {
                    type: "title2",
                    content: "2,4GHz | 5GHz-1 | 5GHz-2 gæstenetværk"
                }, {
                    type: "name",
                    title: "Status",
                    content: "Viser hvorvidt 2,4GHz | 5GHz-1 | 5GHz-2 gæstenetværk er tændt (aktiveret) eller slukket (deaktiveret)."
                }, {
                    type: "name",
                    title: "SSID",
        ...
        wirelessBasic: {
            ...
            CONTENT: [{
                    type: "name",
                    title: "2,4GHz | 5GHz-1 | 5GHz-2 trådløst netværk",
                    content: "Marker dette afkrydsningsfelt for at aktivere den trådløse 2,4GHz | 5GHz-1 | 5GHz-2 radiofrekvens."
                }, {
                    type: "name",
                    title: "SSID (Navn på trådløst netværk)",
                    ...
                    type: "name",
                    title: "Skjul SSID",
                    content: "Marker dette afkrydsningsfelt, hvis du vil skjule 2,4GHz | 5GHz-1 | 5GHz-2 SSIDet fra listen over trådløse netværk."
                }
        ...
        status: {
            ...
            CONTENT: [{
                ...
                /*type: "name",
                title: "Navn",
                content: "Viser navnet på routerens internetport."
            }, {*/
                type: "name",
                title: "MAC-adresse",
                ...
                content: "Vælg for at få vist de 2,4 Ghz | 5GHz-1 | 5GHz-2 trådløse indstillinger og oplysninger."
            }, {
                type: "name",
                title: "Netværksnavn",
                ...
                type: "name",
                title: "2,4G | 5G-1 | 5G-2",
                content: "Vælg for at få vist de 2,4 Ghz | 5GHz-1 | 5GHz-2 gæstenetværkets indstillinger og oplysninger."
            }, {
                type: "name",
                title: "Gæstenetværks SSID",
                ...
                type: "paragraph",
                display: "$.sysMode == 'DSL'",
                content: "Viser oplysninger om DSL-forbindelsen."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Linjestatus",
                content: "Viser om DSL-forbindelsen er tilsluttet eller frakoblet."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "DSL-modulationstype",
                content: "Viser DSL-modulationstypen for drift , som din DSL-forbindelse bruger."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Annekstype",
                content: "Viser DSL-annekstypen for drift , som din DSL-forbindelse bruger."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Aktuelle hastighed (kbps)",
                content: "Viser den aktuelle upload og download hastighed via DSL-forbindelsen."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Maks. hastighed (kbps)",
                content: "Viser den maksimale upload og download hastighed via DSL-forbindelsen."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "SNR-margen (dB)",
                content: "Viser SNR-margen for upload og download via DSL-forbindelsen."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Linjedæmpning (dB)",
                content: "Viser linjedæmpningen af DSL-forbindelsen."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Fejl (pkts)",
                content: "Viser antallet af upstream- og downstreamfejl på DSL-forbindelsen."
            }]
        },
        time: {
        ...
        DIGNOSTIC: {
            ...
            CONTENT: [{
                    type: "paragraph",
                    content: "Routeren har to fejlfindingsværktøj, ping og trace."
                }, {
                    type: "note",
                    title: "Sådan diagnosticerer man ved hjælp af Ping værktøjet",
                    content: [
                        "Marker alternativknappen før ping.",
                        "Indtast IP-adressen eller domænenavnet.",
                        "Klik på ikonet før Avanceret for at få vist Ping-tælleren, Ping-pakkestørrelsen og timeout for Ping. Behold disse parametre på deres standardværdier eller konfigurere dem efter dine behov.",
                        "Klik på knappen Start for at starte diagnosticering."
                    ]
                }, {
                    type: "paragraph",
                    content: "ELLER"
                    ...
                    type: "note",
                    title: "Sådan diagnosticerer man ved hjælp af Traceroute værktøjet",
                    content: [
                        "Marker alternativknappen før traceroute.",
                        "Indtast IP-adressen eller domænenavnet.",
                        "Klik på ikonet før Avanceret for at få vist Traceroute Max TTL. Behold disse standardværdier eller konfigurere dem efter dine behov.",
                        "Klik på knappen Start for at starte diagnosticering."
                    ]
                }
        ...
        ddns: {
            ...
            CONTENT: [{
                    type: "paragraph",
                    content: "Dynamisk DNS (Domain Name System) giver dig mulighed for at tildele et fast host- og domænenavn til en dynamisk internet-IP-adresse. Det er nyttigt hvis du hoster dit eget websted, FTP-server eller en anden server bagved routeren. Først skal du tilmelde dig en DDNS-tjenesteudbyder, som f. eks. <a href='http://www.dyndns.com'>www.dyndns.com</a>."
                }, {
                    type: "name",
                    title: "Serviceudbyder",
                    content: "Vælg din DDNS-tjenesteudbyder. Hvis du ikke har registreret en DDNS-konto, skal du klikke på <b>Registrer her</b>"
                }, {
                    type: "name",
                    title: "Brugernavn/adgangskode",
                    content: "Indtast brugernavnet og adgangskoden til din DDNS-konto."
                }, {
                    type: "name",
                    title: "Domænenavn",
                    content: "Indtast domænenavnet, som du har modtaget fra DDNS-tjenesteudbyderen."
                }, {
                    type: "name",
                    title: "Log ind/Log ud",
                    content: "Klik for at logge ind eller logge ud af DDNS-tjenesteudbyderen."
                }, {
                    type: "name",
                    title: "Gem",
                    content: "Klik for at gemme alle indstillingerne."
                }, {
                    type: "paragraph",
                    content: "For at skifte mellem din DDNS-konti, skal du klikke på Log ud for at logge ud af den aktuelle konto, og derefter logge på igen med en anden konto."
                }
        ...
        iptv: {
            ...
            CONTENT: [{
                    ...
                    children: [{
                        ...
                        /*type: "name",
                        title: "Rusland",
                        content: "Vælg denne indstilling, hvis din internetudbyder er fra Rusland og de nødvendige parametre er forudbestemt, herunder Internet/IP-telefon/IPTV-VLAN-id'er og prioriteret, og LAN-port (1/2/3/4).",
                        children: [{
                            type: "name",
        ...
        sysconf: {
            TITLE: "Trådløse avancerede indstillinger for 2,4GHz | 5GHz-1 | 5GHz-2",
            CONTENT: [{
                    type: "name",
                    title: "Statusinterval",
                    content: "Indtast en værdi mellem 25 og 1000 i millisekunder til at bestemme varigheden mellem statuspakker, der udsendes af routeren for at synkronisere det trådløse netværk. Standardværdien er 100 millisekunder."
