    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2 Gast Netwerk",
                content: "Klik op de corresponderende knop om het 2.4GHz | 5GHz-1 | 5GHz-2 Gastnetwerk in te schakelen."
            }, {
                type: "name",
                ...
                type: "paragraph",
                content: "De insctructies voor het 2.4GHz gastnetwerk bovenstaand gelden ook voor het 5GHz-1 | 5GHz-2 gastnetwerk."
            }, {
                type: "name",
                title: "Opslaan",
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                ...
                content: "Selecteer 2.4GHz | 5GHz-1 | 5GHz-2 om zijn geavanceerde draadloze instellingen in te stellen."
            }, {
                type: "name",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Selecteer 2.4GHz, 5GHz-1 or 5GHz-2 om zijn draadloze schema in te stellen."
            }, {
                type: "name",
                title: "Draadloos Schema",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                ...
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Selecteer 2.4GHz | 5GHz-1 | 5GHz-2 om de corresponderende instellingen te wijzigen."
            }, {
                type: "name",
                title: "Wireless Radio",
                content: "Selecteer deze checkbox om de 2.4GHz | 5GHz-1 | 5GHz-2 draadloze radio frequentie in te schakelen."
            }, {
                type: "name",
                ...
                type: "name",
                title: "Verberg SSID",
                content: "Selecteer deze checkbox wanneer u de 2.4GHz | 5GHz-1 | 5GHz-2  netwerk naam (SSID) van de Wi-Fi netwerk lijst wilt verbergen."
            }, {
                type: "name",
                title: "Beveiliging",
                content: "Selecteer één van de volgende beveiligings opties:",
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Draadloos Netwerk 2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Selecteer de corresponderende knop om het  2.4GHz | 5GHz-1 | 5GHz-2 gastnetwerk in te schakelen."
            }, {
                type: "name",
                title: "Gastnetwerk SSID",
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                type: "title2",
                content: "2.4GHz | 5GHz-1 | 5GHz-2 Draadloos."
            }, {/*
                type: "name",
                title: "Status",
                content: "Geeft aan of de 2.4GHz | 5GHz-1 | 5GHz-2 wireless aan (ingeschakeld) of uit (uitgeschakeld) is."
            }, {*/
                type: "name",
                title: "SSID",
                content: "Geeft de huidige draadloze netwerk naam van de 2.4GHz | 5GHz-1 | 5GHz-2 verbinding frequentie weer."
            }, {
                type: "name",
                title: "Kanaal",
                content: "Geeft het kanaal weer waarop het draadloze 2.4GHz | 5GHz-1 | 5GHz-2 netwerk uitzendt."
            }, {
                type: "name",
                title: "MAC",
                content: "Geeft het huidige MAC adres van het draadloos 2.4GHz | 5GHz-1 | 5GHz-2 weer."
            }, {
                type: "title2",
                content: "2.4GHz | 5GHz-1 | 5GHz-2 Gastnetwerk"
            }, {
                type: "name",
                title: "Status",
                content: "Geeft aan of de 2.4GHz | 5GHz-1 | 5GHz-2 wireless aan (ingeschakeld) of uit (uitgeschakeld) is."
        ...
        wirelessBasic: {
            ...
            CONTENT: [{
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2 Draadloos Netwerk",
                content: "Selecteer deze checkbox om de 2.4GHz | 5GHz-1 | 5GHz-2 draadloze radio frequentie in te schakelen."
            }, {
                type: "name",
                ...
                type: "name",
                title: "Verberg SSID",
                content: "Selecteer deze checkbox als u de 2.4GHz | 5GHz-1 | 5GHz-2 SSID van de Wi-Fi netwerk lijst wilt verbergen."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
                ...
                content: "Selecteer om de draadloze instellingen en informatie van 2.4GHz | 5GHz-1 | 5GHz-2 te bekijken."
            }, {
                type: "name",
                title: "Netwerknaam",
                ...
                type: "name",
                title: "2.4G | 5G-1 | 5G-2",
                content: "Selecteer om de draadloze instellingen en informatie van het Gastnetwerk 2.4GHz | 5GHz-1 | 5GHz-2 te bekijken."
            }, {
                type: "name",
                title: "Gastnetwerk SSID",
                ...
                display: "$.sysMode == 'DSL'",
                type: "paragraph",
                content: "Toont informatie over de DSL verbinding."
            }, {
                display: "$.sysMode == 'DSL'",
                type: "name",
                title: "Lijn status",
                content: "Toont of de DSL verbinding is verbonden of verbroken."
            }, {
                display: "$.sysMode == 'DSL'",
                type: "name",
                title: "DSL Modulatie type",
                content: "Toont de DSL operatie Modulatie type welke uw DSLverbinding gebruikt."
            }, {
                display: "$.sysMode == 'DSL'",
                type: "name",
                title: "Annex type",
                content: "Toont de DSL operatie Annex type welke uw DSLverbinding gebruikt."
            }, {
                display: "$.sysMode == 'DSL'",
                type: "name",
                title: "Huidige snelheid(kbps)",
                content: "Toont de huidige upload en download snelheid van de DSL verbinding."
            }, {
                display: "$.sysMode == 'DSL'",
                type: "name",
                title: "Maximale snelheid(kbps)",
                content: "Toont de maximale upload en download snelheid via de DSL verbinding."
            }, {
                display: "$.sysMode == 'DSL'",
                type: "name",
                title: "SNR marge (dB)",
                content: "Toont de upload en download SNR Marge van de DSL verbinding."
            }, {
                display: "$.sysMode == 'DSL'",
                type: "name",
                title: "Lijn demping (dB)",
                content: "Toont de lijndemping van de DSL verbinding."
            }, {
                display: "$.sysMode == 'DSL'",
                type: "name",
                title: "Fouten (pkts)",
                content: "Toont het aantal upstream en downstream fouten van de DSL verbinding. "
            }]
        },
        time: {
        ...
        ddns: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "Dynamische DNS (Domain Name System) staat u toe om een vaste host en domein naam toe te wijzen aan een dynamisch Internet IP adres.  Dit is handig wanneer u uw eigen website, FTP server of andere server host achter uw router. Eerst dient u zich in te schrijven bij een DDNS service provider zoals <a href='http://www.dyndns.com'>www.dyndns.com</a>."
            }, {
                type: "name",
                title: "Service Provider",
                content: "Selecteer uw DDNS service provider. Als u zich nog niet voor een DDNS account heeft geregistreerd, klik <b>Ga naar registreren</b>."
            }, {
                type: "name",
                title: "Gebruikersnaam/wachtwoord",
                content: "Voer de gebruikersnaam en wachtwoord van uw DDNS account in."
            }, {
                type: "name",
                title: "Domein naam",
                content: "Voer de domein naam in die u verkregen heeft van de DDNS service provider."
            }, {
                type: "name",
                title: "Log in/Log uit",
                content: "Klik om in te loggen of uit te loggen van de DDNS service."
            }, {
                type: "name",
                title: "Opslaan",
                content: "Klik om alle instellingen op te slaan."
            }, {
                type: "paragraph",
                content: "Om te wisselen tussen uw DDNS accounts, klik op Log uit om uit te loggen van het huidige account, log daarna in met een ander account."
            }]
        },
        dhcp: {
            TITLE: "DHCP Server",
        ...
        sysconf: {
            TITLE: "Draadloos geavanceerde instellingen 2.4 GHz | 5 GHz - 1 | 5 GHz - 2 ",
            CONTENT: [{
                type: "name",
                title: "Beacon Interval",
