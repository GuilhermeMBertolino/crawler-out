    ...
    $.helpContent = {
        ...
        virtualServer: {
            ...
            CONTENT: [{
                ...
                content: [
                    "Klicka på Lägg till.",
                    "Välj ett gränssnittsnamn från rullgardinslistan.",
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2,4GHz | 5GHz-1 | 5GHz-2 gästnätverk",
                content: "Klicka på motsvarande knapp för att göra det möjligt för 2,4 GHz | 5GHz-1 | 5GHz-2 Gästnätverk."
            }, {
                type: "name",
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            type: "name",
                            title: "Auto",
                            content: "Det här alternativet stöder flera typer av WPA (Wi-Fi Protected Access), som WPA och WPA2."
                        }, {
                            type: "name",
                            title: "WPA2-PSK",
                        ...
                        type: "name",
                        title: "kryptering",
                        content: "Välj en säkerhetskryptering: Auto (för både TKIP och AES), TKIP (Temporal Key Integrity Protocol), eller AES (Advanced Encryption Standard). Det rekommenderas INTE  att använda TKIP-kryptering om routern fungerar i 802.11n-läge, eftersom TKIP inte stöds av 802.11n-specifikationen. Om TKIP är vald, kommer WPS-funktionen att inaktiveras."
                    }]
                }]
            }, {
                type: "name",
                ...
                type: "paragraph",
                content: "Instruktionerna för 2.4GHz gästnätverk ovan gäller också för 5GHz-1 | 5GHz-2 gästnätverk."
            }, {
                type: "name",
                title: "Spara",
                content: "Klicka för att spara alla dina inställningar."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                ...
                content: "Välj 2,4GHz | 5GHz-1 | 5GHz-2 för att ställa sina avancerade trådlösa inställningar."
            }, {
                type: "name",
                ...
                type: "name",
                title: "Group Key uppdateringsperiod",
                ...
                type: "name",
                title: "Spara",
                content: "Klicka för att spara inställningarna."
            }]
        },
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2,4GHz | 5GHz-1 | 5GHz-2",
                content: "Välj 2,4GHz, 5 GHz-1 eller 5 GHz-2 för att ställa sin trådlösa scheman."
            }, {
                type: "name",
                title: "Trådlöst schema",
        ...
        wirelessSettings: {
            TITLE: "Trådlös inställning",
            CONTENT: [/*{
                type: "name",
                title: "Region",
                content: "Välj din region från listrutan. Detta fält anger den region där den trådlösa funktionen av routern kan användas. Det kan vara olagligt att använda den trådlösa funktionen av routern i ett annat språk än ett av de som anges i detta område region. Om ditt land eller din region inte finns med i listan, kontakta din lokala myndighet för att få hjälp."
            }, */{
                type: "name",
                title: "Smart Connect",
                ...
                type: "name",
                title: "2,4GHz | 5GHz-1 | 5GHz-2",
                content: "Välj 2,4GHz | 5GHz-1 | 5GHz-2 för att ändra motsvarande inställningar."
            }, {
                type: "name",
                title: "trådlös Radio",
                content: "Markera kryssrutan för att aktivera 2,4GHz | 5GHz-1 | 5GHz-2 radiofrekvensen."
            }, {
                type: "name",
                title: "Namn på trådlöst nätverk (SSID)",
                content: "Du kan lämna standardnätverksnamnet (SSID) som är, eller skapa ett nytt namn (upp till 32 tecken). Det här fältet är skiftlägeskänsligt."
            }, {
                type: "name",
                title: "Göm SSID",
                content: "Markera den här kryssrutan om du vill dölja 2,4GHz | 5GHz-1 | 5GHz-2 nätverksnamn (SSID) från nätverket listan Wi-Fi."
            }, {
                type: "name",
                title: "Säkerhet",
                content: "Välj en av följande säkerhetsalternativ:",
                children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            type: "name",
                            title: "Auto",
                            content: "Det här alternativet stöder flera genomförande av WPA (Wi-Fi Protected Access) standard, såsom WPA och WPA2."
                        }, {
                            type: "name",
                            title: "WPA2-PSK",
                            content: "Det här alternativet stöder AES-kryptering som ger en högre säkerhet än WPA-PSK och rekommenderas."
                        ...
                        type: "name",
                        title: "Kryptering",
                        content: "Välj en säkerhetskryptering: Auto (för både TKIP och AES), TKIP (Temporal Key Integrity Protocol), eller AES (Advanced Encryption Standard). Det är INTE rekommenderat att använda TKIP-kryptering om routern arbetar i 802.11n-läge, eftersom TKIP inte stöds av 802.11n. Om TKIP är vald, kommer WPS-funktionen inaktiveras."
                    }, {
                        type: "name",
                        title: "Lösenord",
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Trådlös nätverks 2,4GHz | 5GHz-1 | 5GHz-2",
                content: "Välj motsvarande knapp för att göra det möjligt för 2,4 GHz | 5GHz-1 | 5GHz-2 gästnätverk."
            }, {
                type: "name",
                title: "Gästnätverk SSID",
                content: "Använd antingen standard-SSID eller skapa ett nytt namn med hjälp av en till 32 tecken. Det här fältet är skiftlägeskänsligt."
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                type: "title2",
                content: "2,4GHz | 5GHz-1 | 5GHz-2 Trådlöst"
            }, {/*
                type: "name",
                title: "Status",
                content: "Visar om 2,4GHz | 5GHz-1 | 5GHz-2 trådlöst är På eller Av."
            }, {*/
                type: "name",
                title: "SSID",
                content: "Visar det trådlösa nätverkets namn på 2,4GHz | 5GHz-1 | 5GHz-2 frekvensband."
            }, {
                type: "name",
                title: "Kanal",
                content: "Visar den kanal som det trådlösa 2,4 GHz | 5GHz-1 | 5GHz-2 nätverket sänder på."
            }, {
                type: "name",
                title: "MAC",
                content: "Visar den aktuella MAC-adressen för den trådlösa 2,4 GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "title2",
                content: "2,4GHz | 5GHz-1 | 5GHz-2 gästnätverk"
            }, {
                type: "name",
                title: "Status",
                content: "Visar om 2,4GHz | 5GHz-1 | 5GHz-2 gästnätverk är På eller Av."
            }, {
                type: "name",
                title: "SSID",
        ...
        wirelessBasic: {
            ...
            CONTENT: [{
                type: "name",
                title: "2,4GHz | 5GHz-1 | 5GHz-2 trådlöst nätverk",
                content: "Markera kryssrutan för att aktivera 2,4GHz | 5GHz-1 | 5GHz-2 radiofrekvens."
            }, {
                type: "name",
                title: "Namn på trådlöst nätverk (SSID)",
                ...
                type: "name",
                title: "Göm SSID",
                content: "Markera den här kryssrutan om du vill dölja 2,4GHz | 5GHz-1 | 5GHz-2 SSID från Wi-Fi nätverkslistan."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
                ...
                type: "name",
                title: "MAC-adress",
                content: "Den unika fysiska adress som tilldelats porten Internet (WAN) i routern."
            }, {
                type: "name",
                title: "IP-adress",
                ...
                content: "IP-adressen används för att ansluta routern till nätverket."
            }, {
                type: "name",
                ...
                type: "name",
                title: "Anslutningstyp",
                content: "Den aktuella anslutningstyp till Internet."
            }, {
                type: "title2",
                content: "IPv6"
            }, {
                ...
                content: "Välj om du vill visa 2,4GHz | 5GHz-1 | 5GHz-2 trådlösa inställningar och information."
            }, {
                type: "name",
                title: "Nätverksnamn",
                ...
                type: "name",
                title: "2.4G | 5G-1 | 5G-2",
                content: "Välj om du vill visa 2,4GHz | 5GHz-1 | 5GHz-2 gästnätverksinställningar och information."
            }, {
                type: "name",
                title: "Gästnätverk SSID",
                ...
                type: "paragraph",
                display: "$.sysMode == 'DSL'",
                content: "Visar information om DSL-anslutning."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Linjestatus",
                content: "Visar om DSL-anslutningen är ansluten eller frånkopplad."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "DSL moduleringstyp",
                content: "Visar DSL moduleringstyp som DSL-anslutning använder."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Bilaga typ",
                content: "Visar DSL drift Annextyp som DSL-anslutning använder."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Aktuell frekvens (kbps)",
                content: "Visar den aktuell upp och nedladdningshastighet genom DSL-anslutning."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Max hast (kbps)",
                content: "Visar maximal upp- och nedladdningshastighet genom DSL-anslutning."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "SNR marginal (dB)",
                content: "Visar uppladdning och nedladdning SNR marginal DSL-anslutningen."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Linjedämpning (dB)",
                content: "Visar linjedämpning av DSL-anslutning."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Fel (paket)",
                content: "Visar antalet uppströms och nedströms fel i DSL-anslutning."
            }]
        },
        time: {
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        type: "name",
                        title: "Lokala anläggningens namn",
        ...
        manageCtrl: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "På denna sida kan du ändra ditt lösenord för inloggning."
            }, {
                type: "name",
                title: "Gammalt användarnamn",
                ...
                type: "paragraph",
                content: "Den lokala administrationen kan specifikt tilldela en klientenhet i nätverket för att komma åt och hantera routern genom MAC-adres-baserad autentisering."
            }, {
                type: "name",
                title: "Port",
                content: "Ange portnumret som ska användas för att komma åt routern mellan 1024 och 65535. Standard är 80."
            }, {
                type: "name",
                title: "IP/MAC-adress",
                content: "Ange giltig lokal IP-adress eller MAC-adressen för den enhet som ska tillåtas åtkomst till routern."
            }, {
                type: "title",
                content: "Fjärrhantering"
            }, {
                type: "paragraph",
                content: "Med funktionen fjärrhantering kan du komma åt och konfigurera routern på distans via Internet."
            }, {
                type: "name",
                title: "Fjärrhantering",
                content: "Markera kryssrutan för att aktivera funktionen Fjärradministration."
            }, {
                type: "name",
                title: "Port",
                content: "Ange portnumret som ska användas för att komma åt routern med större säkerhet mellan 1024 och 65535. Normala webbläsare använder standard HTTP-tjänsten port 80."
            }, {
                type: "name",
                title: "IP/MAC-adress",
                content: "Ange en giltig IP-adress eller MAC-adress att få åtkomst till routern."
            }]
        },
        snmp: {
        ...
        ethWan: {
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    content: "Standard och typiska MTU-storlek (Maximum Transmission Unit) är för de flesta Ethernet-nätverk <b>1500 Bytes</b>. Det rekommenderas inte att ändra standard MTU-storleken om det inte krävs av ISP."
                }, {
                    type: "name",
                    title: "IGMP proxy",
                    content: "IGMP (Internet Group Management Protocol) används för att hantera multicasting på TCP/IP-nätverk. Vissa Internetleverantörer använder IGMP för att utföra fjärrkonfiguration på en router. Den är aktiverad som standard."
                }, {
                    type: "name",
                ...
                children: [{
                    ...
                    type: "name",
                    title: "MTU Storlek (i byte)",
                    content: "Den typiska MTU (Maximum Transmission Unit) storlek för Ethernet-nätverk är 1480 byte.",
                    children: [{
                        type: "paragraph",
        ...
        route: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Ändra",
                content: "Visar alternativen <b>Ändra</b> eller <b>Ta bort</b> motsvarande post."
            }, {
                type: "note",
        ...
        ddns: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "Med dynamisk DNS (Domain Name System) kan du tilldela en fast värd och domännamn till en dynamisk IP-adress. Det är användbart när du är värd för din egna webbplats, FTP-server eller en annan server bakom routern. Först måste du logga in med ett DDNS tjänsteleverantör som <a href='http://www.dyndns.com'> www.dyndns.com </a>."
            }, {
                type: "name",
                title: "Tjänsteleverantör",
                content: "Välj din DDNS leverantör. Om du inte har registrerat ett DDNS-konto klickar du på <b> Registrera</b>"
            }, {
                type: "name",
                title: "Användarnamn/lösenord",
                content: "Ange användarnamn och lösenord för ditt DDNS-konto."
            }, {
                type: "name",
                title: "Domännamn",
                content: "Ange domännamnet som tillhandahålls av DDNS tjänsteleverantör."
            }, {
                type: "name",
                title: "Logga in/logga ut",
                content: "Klicka här för att logga in eller logga ut från DDNS-tjänsten."
            }, {
                type: "name",
                title: "Spara",
                content: "Klicka för att spara alla inställningar."
            }, {
                type: "paragraph",
                content: "För att växla mellan dina DDNS-konton klicka Logga ut för att logga ut från det aktuella kontot, logga sedan in igen med ett annat konto."
            }]
        },
        dhcp: {
            TITLE: "DHCP-server",
            CONTENT: [{
                ...
                type: "name",
                title: "Ändra",
                content: "Visar alternativen <b>Ändra</b> eller <b>Ta bort </b>motsvarande klienten."
            }, {
                type: "note",
                ...
                title: "",
                content: [
                    "Klicka på <b> Redigera </b> eller <b> Papperskorgen </b> i motsvarande post."
                ]
            }, {*/
                type: "title",
                content: "Statuspool"
        ...
        usbManage: {
            ...
            CONTENT: [{
                ...
                content: "Växla På för att aktivera autentisering som kräver att användare ska ange ett giltigt användarnamn och lösenord för att komma åt alla delade mappar."
            }, {
                type: "name",
                title: "Mappnamn",
        ...
        ipsec: {
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    content: "Välj en av följande integritetsalgoritmer för IKE förhandlingar.",
                    children: [{
                        type: "name",
                        title: "MD5",
                    ...
                    content: "Ange tidsperioden (i sekunder) att passera innan en ny IPSec säkerhetsassociation (SA) etableras med fjärr -lutpunkt. Standardvärdet är 3600."
                }, {
                    type: "title2",
                    content: "Fas 2"
                }, {
        ...
        wanBasic: {
            ...
            CONTENT: [{
                ...
                type: "title",
                title: "Internet-anslutning Typ: dynamisk IP"
            }, {
                type: "name",
        ...
        sysconf: {
            TITLE: "Trådlösa avancerade inställningar 2,4 GHz | 5GHz-1 | 5GHz-2",
            CONTENT: [{
                type: "name",
                title: "Beacon-intervall",
		...
		openvpnServer: {
			...
			CONTENT: [{
				...
				type: "paragraph",
				content: "Klicka på Save (spara) alla dina inställningar."
            },{
                type: "title",
                content: "Certifikat"
            },{
