    ...
    $.helpContent = {
        trafficCtrl: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Tùy chỉnh",
                content: "Hiển thị tùy chọn để Chỉnh sửa hoặc Xóa điều luật tương ứng."
            }, {
                type: "note",
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Mạng không dây 2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Bấm nút tương ứng để kích hoạt Mạng khách 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            type: "name",
                            title: "Tự động",
                            content: "Tùy chọn này hỗ trợ đa thực thi của chuẩn WPA (Wi-Fi Protected Access), như là WPA và WPA2"
                        }, {
                            type: "name",
                            title: "WPA2-PSK",
                ...
                type: "paragraph",
                content: "Hướng dẫn cho Mạng khách 2.4GHz ở trên cũng được áp dụng cho Mạng khách 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "Lưu",
                content: "Bấm để lưu tất cả cài đặt của bạn."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                ...
                content: "Chọn 2.4GHz | 5GHz-1 | 5GHz-2 để thiết lập cài đặt không dây nâng cao."
            }, {
                type: "name",
                ...
                content: "Nhập một giá trị từ 1 đến 255 để xác định khoảng thời gian Delivery Traffic Indication Message (DTIM). 1 báo hiệu Khoảng thời gian DTIM giống với Khoảng thời gian Beacon."
            }, {
                type: "name",
                ...
                type: "name",
                title: "Bảo mật",
                content: "Chọn một trong các tùy chọn bảo mật sau:",
                children: [{
                    type: "name",
                    title: "Không",
                    content: "Chọn tùy chọn này để vô hiệu hóa bảo mật không dây. Chúng tôi rất khuyến nghị bạn kích hoạt bảo mật không dây để bảo vệ mạng không dây của bạn khỏi các truy cập trái phép."
                }, {
                    type: "name",
                    title: "WPA / WPA2 Cá nhân",
                    content: "Chọn tùy chọn này để kích hoạt phương pháp xác thực chuẩn dựa trên một Pre-shared Key (PSK), còn được gọi là mật mã. Nếu chọn, cấu hình các mục sau.",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Chọn 2.4GHz, 5GHz-1 or 5GHz-2 để cài đặt thời gian biểu không dây tương ứng."
            }, {
                type: "name",
                title: "Thời gian biểu không dây",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                type: "name",
                title: "Khu",
                content: "Chọn khu vực tChọn khu vực của bạn từ bảng danh sách thả xuống. Phần này chỉ ra khu vực nơi chức năng không dây của Router có thể được sử dụng. Sử dụng chức năng không dây của Router trong các khu vực khác không có trong bảng danh sách có thể là không hợp pháp. Nếu quốc gia hoặc khu vực của bạn không có trong danh sách, vui lòng liên hệ với văn phòng địa phương để được hỗ trợừ danh sách thả xuống"
            }, */{
                type: "name",
                ...
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Chọn 2.4GHz | 5GHz-1 | 5GHz-2 để thay đổi cài đặt tương ứng."
            }, {
                type: "name",
                title: "Vô tuyến không dây",
                content: "Chọn hộp chọn này để kích hoạt tần số vô tuyến không dây 2.4GHz | 5GHz-1 | 5GHz-2 ."
            }, {
                type: "name",
                title: "Tên mạng không dây (SSID)",
                content: "Bạn có thể sử dụng tên mạng (SSID) mặc định hoặc tạo tên mới (lên đến 32 ký tự). Mục này phân biệt chữ hoa và chữ thường."
            }, {
                type: "name",
                title: "ẩn SSID",
                content: "Chọn hộp chọn này nếu bạn muốn giấu tên mạng (SSID) 2.4GHz | 5GHz-1 | 5GHz-2 khỏi danh sách mạng Wi-Fi."
            }, {
                type: "name",
                title: "Bảo mật",
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                type: "title2",
                content: "Không dây 2.4GHz | 5GHz-1 | 5GHz-2"
            }, {/*
                type: "name",
                title: "Trạng thái",
                content: "Hiển thị nếu mạng không dây 2.4GHz | 5GHz-1 | 5GHz-2 đang mở (kích hoạt) hoặc tắt (vô hiệu hóa)."
            }, {*/
                type: "name",
                title: "SSID",
                content: "Hiển thị tên mạng không dây hiện tại của băng tần 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "Kênh",
                content: "Hiện thị kênh mạng không dây 2.4GHz | 5GHz-1 | 5GHz-2 quảng bá."
            }, {
                type: "name",
                title: "MAC",
                content: "Hiển thị địa chỉ MAC hiện tại của mạng không dây 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "title2",
                content: "Mạng khách 2.4GHz | 5GHz-1 | 5GHz-2"
            }, {
                type: "name",
                title: "Trạng thái",
                content: "Hiển thị nếu Mạng khách 2.4GHz | 5GHz-1 | 5GHz-2 đang mở (kích hoạt) hoặc tắt (vô hiệu hóa)."
            }, {
                type: "name",
                title: "SSID",
        ...
        wirelessBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "ẩn SSID",
                content: "Chọn hộp chọn này nếu bạn muốn giấu SSID 2.4GHz | 5GHz-1 | 5GHz-2 khỏi danh sách mạng Wi-Fi."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
               ...
               /* type: "name",
                ...
                type: "name",
                title: "Địa chỉ MAC",
                content: "Địa chỉ vật lý duy nhất được gán cho cổng Internet của router."
            }, {
                type: "name",
                title: "Địa chỉ IP",
                ...
                content: "Địa chỉ IP được sử dụng để kết nối router đến mạng."
            }, {
                type: "name",
                ...
                content: "Chọn để xem cài đặt và thông tin không dây 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "Tên mạng không dây (SSID)",
                ...
                type: "paragraph",
                display: "$.sysMode == 'DSL'",
                content: "Hiển thị thông tin về kết nối DSL."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Tình trạng đường",
                content: "Hiển thị nếu kết nối DSL đã kết nối hoặc đã ngắt kết nối."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "DSL Modulation Loại",
                content: "Hiển thị Dạng điều chế hoạt động DSL mà kết nối DSL của bạn sử dụng"
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Loại phụ lục",
                content: "Hiển thị Dạng Annex hoạt động DSL mà kết nối DSL của bạn sử dụng"
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Tỷ lệ hiện tại (kbps)",
                content: "Hiển thị tốc độ tải lên và tải về hiện tại thông qua kết nối DSL"
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Max Rate (kbps)",
                content: "Hiển thị tốc độ tải lên và tải về cao nhất thông qua kết nối DSL"
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "SNR Margin (dB)",
                content: "Hiển thị Margin SNR tải lên và tải về của kết nối DSL"
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Dòng Attenuation (dB)",
                content: "Hiển thị suy hao đường truyền của kết nối DSL"
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Lỗi (pkts)",
                content: "Hiển thị số lỗi dòng tải lên và tải về của kết nối DSL"
            }]
        },
        time: {
       ...
       backNRestore: {
        ...
        ethWan: {
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    type: "name",
                    title: "Kích thước MTU (byte)",
                    content: "MTU (Maximum Transmission Unit) kích thước điển hình cho các mạng Ethernet là 1480 byte.",
                    children: [{
                        type: "paragraph",
                        content: "<b> Lưu ý </b>: Trong một trường hợp hiếm hoi, ISP của bạn có thể yêu cầu bạn phải điều chỉnh kích thước MTU cho hiệu suất mạng tốt hơn. Bạn không nên thay đổi các giá trị trừ khi nó là hoàn toàn cần thiết."
                    }]
                }, {
                    type: "name",
                    title: "IGMP Proxy",
        ...
        ddns: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "Dynamic DNS (Domain Name System) cho phép bạn chỉ định một máy chủ cố định và các tên miền đến một địa chỉ IP Internet động. Nó rất hữu ích khi bạn đang lưu trữ trang web của riêng bạn, máy chủ FTP, hoặc một máy chủ ở phía sau router. Trước tiên, bạn cần phải đăng ký với một nhà cung cấp dịch vụ DDNS như <a href='http://www.dyndns.com'> www.dyndns.com </a>."
            }, {
                type: "name",
                title: "Nhà cung cấp dịch vụ",
                content: "Chọn nhà cung cấp dịch vụ DDNS của bạn. Nếu bạn chưa đăng ký một tài khoản DDNS, nhấp vào <b> Đi đăng ký </b>"
            }, {
                type: "name",
                title: "Tên đăng nhập / Mật mã",
                content: "Nhập tên người dùng và mật mã của tài khoản DDNS của bạn."
            }, {
                type: "name",
                title: "Tên miền",
                content: "Nhập tên miền được cung cấp bởi các nhà cung cấp dịch vụ DDNS."
            }, {
                type: "name",
                title: "Đăng nhập / Đăng xuất",
                content: "Nhấn vào đây để đăng nhập hoặc đăng xuất của dịch vụ DDNS."
            }, {
                type: "name",
                title: "Lưu",
                content: "Nhấn vào đây để lưu lại tất cả các thiết lập."
            }, {
                type: "paragraph",
                content: "Để chuyển đổi giữa các tài khoản DDNS của bạn, kích Log Out để đăng xuất khỏi tài khoản hiện tại, sau đó đăng nhập lại với một tài khoản khác."
            }]
        },
        dhcp: {
            TITLE: "Máy chủ DHCP",
        ...
        iptv: {
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    /*type: "name",
                    title: "Nga",
                    content: "Hãy chọn điều này nếu ISP của bạn là từ Nga và các thông số cần thiết được xác định trước, bao gồm Internet / IP-Phone ID / IPTV VLAN và ưu tiên, và (1/2/3/4) cổng LAN.",
                    children: [{
                        type: "name",
        ...
        wanBasic: {
            ...
            CONTENT: [{
                ...
                type: "title",
                title: "Dạng kết nối Internet: Static IP"
            }, {
                type: "name",
        ...
        sysconf: {
            TITLE: "Cài đặt nâng câo không dây 2.4GHz | 5GHz-1 | 5GHz-2",
            CONTENT: [{
                type: "name",
                ...
                type: "paragraph",
                content: "Nhấn Save để lưu lại các thiết lập của bạn."
            }, {
                type: "title",
                title: "LED"
            }, {
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        type: "name",
                        title: "Mã hóa",
                        content: "Bạn có thể chọn hoặc Tự động, hoặc TKIP hoặc AES."
                    }, {
                        type: "name",
       ...
       diagnostic: {
            ...
            CONTENT: [{
                ...
                content: [
                    "Nhập địa chỉ IP đích hoặc tên miền.",
        ...
        ipv6: {
            ...
            CONTENT: [{
                ...
                content: "Chọn dạng kết nối của kết nối IPv6."
            }, {
                type: "name",
                title: "MTU (byte)",
                content: "Kích thước MTU (Maximum Transmission Unit) mặc định và điển hình cho hầu hết các mạng Ethernet là 1500 byte. Không thay đổi  kích thước MTU mặc định trừ khi được yêu cầu bởi ISP của bạn."
