(function($) {
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "Red de Invitados permite configurar una red inalámbrica independiente con un nombre de red (SSID) y contraseña independientes que los invitados pueden utilizar para acceder a Internet."
            }, {
                type: "title",
                ...
                type: "name",
                title: "Red de Invitados 2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Haga clic en el botón correspondiente para habilitar la red de invitado 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "SSID de la Red de Invitados",
                content: "Utilice el SSID predeterminado o cree un nombre nuevo de entre 1 y 32 caracteres. Este campo distingue entre mayúsculas y minúsculas."
            }, {
                type: "name",
                title: "Seguridad",
                ...
                type: "paragraph",
                content: "Las instrucciones previas para la red de invitado 2.4GHz también se aplican a la red de invitado 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "Guardar",
                content: "Haga clic para guardar la configuración."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                ...
                content: "Seleccione 2.4GHz | 5GHz-1 | 5GHz-2 para establecer la configuración Wi-Fi avanzada."
            }, {
                type: "name",
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            type: "name",
                            title: "WPA2-PSK",
                            content: "Esta opción admite el cifrado AES, que ofrece un nivel de seguridad más alto que WPA-PSK y está recomendada."
                        }]
                    }, {
                        type: "name",
                        title: "Cifrado",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Seleccione 2.4GHz, 5GHz-1 o 5GHz-2 para establecer la programación inalámbrica."
            }, {
                type: "name",
                title: "Programación Inalámbrica",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                ...
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Seleccione 2.4GHz | 5GHz-1 | 5GHz-2 para modificar la configuración correspondiente."
            }, {
                type: "name",
                title: "Emisión Inalámbrica",
                content: "Seleccione esta casilla de verificación para habilitar la frecuencia de emisión inalámbrica 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "Nombre de Red Wi-Fi (SSID)",
                content: "Puede dejar el nombre de red (SSID) predeterminado como está o crear un nuevo nombre (hasta 32 caracteres). Este campo distingue entre mayúsculas y minúsculas."
            }, {
                type: "name",
                title: "Ocultar SSID",
                content: "Seleccione esta casilla de verificación si desea ocultar el nombre de red (SSID) 2.4GHz | 5GHz-1 | 5GHz-2 de la lista de redes Wi-Fi."
            }, {
                type: "name",
                title: "Seguridad",
                content: "Seleccione una de las siguientes opciones de seguridad:",
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Seleccione el botón correspondiente para habilitar la Red de Invitados 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "SSID de la Red de Invitados",
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Estado",
                content: "Muestra si la red inalámbrica 2.4GHz | 5GHz-1 | 5GHz-2 está habilitada (Sí) o deshabilitada (No)."
            }, {*/
                type: "name",
                title: "SSID",
                content: "Muestra el nombre de la red inalámbrica actual de la frecuencia de bandas 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "Canal",
                content: "Muestra el canal del cual transmite la red inalámbrica 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "MAC",
                content: "Muestra la dirección MAC actual de la red inalámbrica 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "title2",
                content: "Red de Invitados 2.4GHz | 5GHz-1 | 5GHz-2"
            }, {
                type: "name",
                title: "Estado",
                content: "Muestra si la Red de Invitados 2.4GHz | 5GHz-1 | 5GHz-2 está habilitada (Sí) o deshabilitada (No)."
            }, {
                type: "name",
                title: "SSID",
        ...
        wirelessBasic: {
            ...
            CONTENT: [{
                type: "name",
                title: "Wi-Fi en 2.4GHz | 5GHz-1 | 5GHz-2",
                content: "Seleccione esta casilla de verificación para habilitar la frecuencia de emisión inalámbrica 2.4GHz | 5GHz-1 | 5GHz-2."
            }, {
                type: "name",
                title: "Nombre de Red Wi-Fi (SSID)",
                ...
                type: "name",
                title: "Ocultar SSID",
                content: "Seleccione esta casilla de verificación si desea ocultar el SSID 2.4GHz | 5GHz-1 | 5GHz-2 de la lista de redes Wi-Fi."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
                ...
                content: "Seleccione esta opción para ver la configuración e información de Wi-Fi 2.4G | 5G-1 | 5G-2."
            }, {
                type: "name",
                title: "Nombre de red",
                ...
                type: "name",
                title: "2.4G | 5G-1 | 5G-2",
                content: "Seleccione esta opción para ver la configuración e información de la Red de Invitados 2.4G | 5G-1 | 5G-2."
            }, {
                type: "name",
                title: "SSID de la Red de Invitados",
                ...
                type: "paragraph",
                display: "$.sysMode == 'DSL'",
                content: "Muestra información sobre de la Conexión DSL."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Estado de línea",
                content: "Muestra si la Conexión DSL está conectada o desconectada."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Tipo de modulación DSL",
                content: "Muestra el tipo de modulación de funcionamiento DSL que utiliza la conexión DSL."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Tipo de anexo",
                content: "Muestra el tipo de anexo de funcionamiento DSL que utiliza la conexión DSL."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Velocidad actual (kbps)",
                content: "Muestra la velocidad de carga y descarga a través de la conexión DSL."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Velocidad máx. (kbps)",
                content: "Muestra la velocidad máxima de carga y descarga a través de la conexión DSL."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Margen SNR (dB)",
                content: "Muestra el Margen SNR de carga y descarga de la conexión DSL."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Atenuación de línea (dB)",
                content: "Muestra la atenuación de línea de la conexión DSL."
            }, {
                type: "name",
                display: "$.sysMode == 'DSL'",
                title: "Errores (paq.)",
                content: "Muestra el número de errores de subida y bajada de la conexión DSL."
            }]
        },
        time: {
        ...
        ethWan: {
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    type: "name",
                    title: "Tamaño de MTU (en bytes)",
                    content: "El tamaño de unidad de transmisión máxima (MTU) típico para las redes Ethernet es 1480 bytes.",
                    children: [{
                        type: "paragraph",
                        content: "<b>Nota</b>: en algunos casos, su ISP puede pedirle que ajuste el tamaño de MTU para un mejor rendimiento de la red. No cambie el valor a menos que sea absolutamente necesario."
                    }]
                }, {
                    type: "name",
                    title: "Proxy IGMP",
                ...
                children: [{
                    type: "name",
                    title: "IP Dinámica",
                    content: "Seleccione esta opción si la dirección IP y máscara de subred son proporcionadas automáticamente por su ISP."
                }, {
                    type: "name",
                    title: "IP Estática",
                ...
                type: "name",
                title: "IP de servidor VPN/Nombre de dominio",
        ...
        ddns: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "DNS dinámico permite asignar un nombre de dominio y host fijo a una dirección IP de Internet dinámica. Es práctico cuando se aloja un sitio web, servidor FTP u otro servidor detrás del router. En primer lugar, es necesario registrarse con un proveedor de servicios DDNS como <a href='http://www.dyndns.com'>www.dyndns.com</a>."
            }, {
                type: "name",
                title: "Proveedor de Servicios",
                content: "Seleccione su proveedor de servicios DDNS. Si no tiene una cuenta DDNS registrada, haga clic en <b>Registrar</b>"
            }, {
                type: "name",
                title: "Nombre de Usuario/Contraseña",
                content: "Introduzca el nombre de usuario y contraseña de su cuenta DDNS."
            }, {
                type: "name",
                title: "Nombre de Dominio",
                content: "Introduzca el nombre de dominio proporcionado por el proveedor de servicios DDNS."
            }, {
                type: "name",
                title: "Iniciar Sesión/Cerrar Sesión",
                content: "Haga clic aquí para iniciar sesión o cerrar sesión en el servicio DDNS."
            }, {
                type: "name",
                title: "Guardar",
                content: "Haga clic aquí para guardar la configuración."
                ...
                type: "paragraph",
                content: "Para cambiar entre sus cuentas DDNS, haga clic en Cerrar sesión para cerrar la sesión de la cuenta actual y luego vuelva a iniciar sesión con una cuenta distinta."
            }]
        },
        dhcp: {
            TITLE: "Servidor DHCP",
        ...
        ipsec: {
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    type: "name",
                    title: "Grupo Diffie-Hellman para Intercambio de Clave",
        ...
        sysconf: {
            TITLE: "Configuración avanzada de Wi-Fi 2.4GHz | 5GHz-1 | 5GHz-2",
            CONTENT: [{
                type: "name",
                title: "Intervalo de Señalización",
                content: "Introduzca un valor entre 25 y 1000 en milisegundos para determinar el intervalo en que el router transmitirá los paquetes de señalización con el fin de sincronizar la red inalámbrica. El valor predeterminado es 100 milisegundos."
        ...
        diagnostic: {
            ...
            CONTENT: [{
                ...
                content: [
                    "Introduzca la dirección IP o nombre de dominio de destino.",
		...
		openvpnServer: {
			...
			CONTENT: [{
				...
				type: "paragraph",
				content: "Haga click en Guardar para guardar todos los ajustes."
            },{
                type: "title",
                content: "Certificado"
            },{
