...
var DateTimeCfgHelpRpm =
{
	...
	"s_4": "In daylight saving configuration, start time and end time shall be within one year and start time shall be earlier than end time.",
...
{
	"header": "DDNS Help",
	"brief": "The Router offers a Dynamic Domain Name System (<B>DDNS</B>) feature. DDNS lets you assign a fixed host and domain name to a dynamic Internet IP address. It is useful when you are hosting your own website, FTP server, or other server behind the Router. Before using this feature, you need to sign up with DDNS service providers such as <a href=\"#\" onClick=\"openWindow1();\" class=L1>dyn.com/dns/</a>. The Dynamic DNS client service provider will give you a password or key.",
	"s_0": "Follow these instructions to set up DDNS:",
	"service_prov": "If your selected dynamic DNS <b>Service Provider</b> is <a href=\"#\" onClick=\"openWindow1();\" class=L1>dyn.com/dns/</a>.",
	"user_name": "Enter the <B>User Name</B> for your DDNS account.",
	"password": "Enter the <B>Password</B> for your DDNS account.",
...
var GuestNetWirelessCfgHelpRpm =
{
	...
	"acce_time": "<B>Schedule</B> - If the countdown timer hits zero, guest network will close.",
	"timeout": "<B>Timeout</B> - After this time the Guest Network will close.",
	"note": "<B>Note</B>:",
...
var MiscHelpRpm =
{
	...
	"statistics": "<font color=\"#ff0000\">Note 1: FLOOD Filtering will take effect only when the <b>Statistics</b> in <b>System Tools</b> is enabled.</font>",
	...
	"forbid": "<B>Forbid Ping Packet From LAN Port</B> - Enable or Disable Forbid Ping Packet From LAN Port. The default setting is disabled. If enabled, the ping packet from LAN cannot access the Router. (Defends against some viruses).",
...
var NoipDdnsHelpRpm =
{
	...
	"s_0": "Follow these instructions to set up DDNS:",
	"service_prov": "If your selected dynamic DNS <b>Service Provider</b> is <a href=\"#\" onClick=\"openWindow1();\" class=L1>www.no-ip.com</a>.&nbsp;",
	"user_name": "Enter the <B>User Name</B> for your DDNS account.",
	"password": "Enter the <B>Password</B> for your DDNS account.",
	"doma_name": "Enter the <B>Domain Name</B> you received from dynamic DNS service provider.",
	"login": "Click the <B>Login</B> button to login to the DDNS service.",
...
{
	"header": "Add or Modify Parental Control Entry Help",
	"brief": "The Router, providing convenient parental control function to control the internet activities of the child, can limit the child to access certain website and restrict the time of the surfing. On this page, you can create the rule.",
	...
	"save": "Click <B>Save</B> to complete the settings.",
	"back": "Click <B>Back</B> to return to the Parental Control Settings page."
};
var ParentCtrlHelpRpm =
{
	"header": "Parent Control Help",
	"brief": "you can configure the parental control in the page. The Parental Control function can be used to control the internet activities of the child, limit the child to access certain websites and restrict the time of surfing.",
	"parental": "<B>Enable Parental Control</B> Check the box if you want this function to take effect. This function is disabled by default.",
...
var StatusHelpRpm =
{
	...
	"wireless": "<B>Wireless 2.4GHz/5GHz</B> - These are the current settings or information for Wireless.You can configure them in the <B>Wireless 2.4GHz/5GHz -&gt; Basic Settings</B> page.",
