    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                ...
                content: "Clique no botão correspondente para ativar a Rede de Convidados 2.4GHz | 5GHz"
            }, {
                type: "name",
                ...
                type: "paragraph",
                content: "As instruções para a Rede de Convidados 2.4GHz acima também se aplicam aos 5GHz Rede de Convidados."
            }, {
                type: "name",
                title: "Guardar",
                content: "Clique para guardar todas as suas definições."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Selecione 2.4GHz | 5GHz para ajustar as suas definições sem fios avançadas."
            }, {
                type: "name",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Selecione 2.4GHz or 5GHz para definir o seu horário sem fios."
            }, {
                type: "name",
                title: "Agendamento Sem Fios",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Selecione 2.4GHz | 5GHz para alterar as definições correspondentes."
            }, {
                type: "name",
                title: "Rádio sem fios",
                content: "Marque esta caixa de seleção para ativar a frequência de rádio sem fios 2.4GHz | 5GHz."
            }, {
                type: "name",
                ...
                type: "name",
                title: "Ocultar SSID",
                content: "Marque esta caixa de seleção se pretender ocultar o nome da rede (SSID) 2.4GHz | 5GHz a partir da lista de redes Wi-Fi."
            }, {
                type: "name",
                title: "Segurança",
                content: "Selecione uma das seguintes opções de segurança:",
        ...
        qos: {
            ...
            CONTENT: [{
                ...
                type: "title",
                content: "Prioridade de Aplicações"
            }, {
                type: "paragraph",
                ...
                type: "title",
                content: "Prioridade de Dispositivos"
            }, {
                type: "paragraph",
                content: "Escolha o(s) dispositivo(s) que deseja definir a prioridade e o período tempo em que a mesma será aplicada."
            }, {
                type: "note",
                title: "<strong>Definir a prioridade do dispositivo</strong>",
                content: [
                    "Localize o dispositivo que pretende definiir a prioridade na lista e ative em Prioridade.",
                    "Selecione o período tempo em que a prioridade será aplicada na coluna Temporização."
                ]
            }]
        },
        antiVirus: {
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Rede Wi-Fi de 2.4GHz | 5GHz",
                content: "Selecione o botão correspondente para ativar a Rede de Convidados 2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "SSID da Rede de Convidados",
                content: "Use o SSID predefinido ou crie um novo nome usando de 1 a 32 caracteres. Este campo é sensível a maiúsculas e minúsculas."
		...
		display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",
	       ...
	       display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",                 
                ...
                type: "title2",
                content: "Rede Wi-Fi 2.4GHz | 5GHz"
            }, {/*
                type: "name",
                title: "Estado",
                content: "Exibe se a rede Wi-Fi 2.4GHz | 5GHz está ligado (ativado) ou desligado (desativado)."
            }, {*/
                type: "name",
                title: "SSID",
                content: "Exibe o nome da rede Wi-Fi atual da frequência de banda  2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "Canal",
                content: "Exibe o canal do qual a rede Wi-Fi 2.4GHz | 5GHz difunde."
            }, {
                type: "name",
                title: "MAC",
                content: "Exibe o endereço MAC atual da rede Wi-Fi 2.4GHz | 5GHz."
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "title2",
                content: "Rede de Convidados 2.4GHz | 5GHz"
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "Estado",
                content: "Exibe se a Rede de Convidados 2.4GHz | 5GHz está ligada (ativada) ou desligada (desativada)."
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "SSID",
        ...
        wirelessBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Ocultar SSID",
                content: "SMarque esta caixa de seleção se pretender ocultar o SSID 2.4GHz | 5GHz a partir da lista de redes Wi-Fi."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
               ...
               /* type: "name",
                ...
                type: "name",
                title: "2.4G | 5G",
                content: "Selecione para exibir as definições e a informação da rede Wi-Fi 2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "Nome da rede",
                ...
                type: "name",
                title: "2.4G | 5G",
                content: "Selecione para exibir as definições e a informação da Rede de Convidados 2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "SSID da Rede de Convidados",
        ...
        ddns: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "DNS dinâmico permite atribuir um host fixo e nome de domínio para um endereço IP dinâmico da Internet. É útil quando está a alojar o seu próprio site, servidor FTP, câmara IP ou outro servidor atrás do router. Primeiro, precisa criar uma conta num fornecedor de serviços DDNS, como www.dyndns.com."
            }, {
                type: "step",
                title: "Para configurar um DNS Dinâmico",
                content: [
                    "Selecione o fornecedor de serviços de DNS Dinâmico.",
                    "Enter the Username and Password of the Dynamic DNS account.",
                    "Insira o Nome de Domínio que recebeu do fornecedor do serviço DDNS.",
                    "Click Log in and click Save."
                ]
            }, {
                type: "paragraph",
                title: "Note:",
                content: "Caso pretenda utilizar uma nova conta de DDNS, termine primeiro a sessão e de seguida inicie a sessão com a sua nova conta."
            }]
        },
        dhcp: {
            TITLE: "Servidor DHCP",
        ...
        sysconf: {
            TITLE: "Definições avançadas da rede Wi-Fi 2.4GHz | 5GHz",
            CONTENT: [{
                type: "name",
                title: "Intervalo de sinalização",
				...
				"type": "name",
                "title": "Funcionalidade Airtime Fairness",
                "content": "Selecione esta opção para ativar a funcionalidade Airtime Fairness (ATF) que permite otimizar a utilização dos recursos Wi-Fi."
			},  {
				display: INCLUDE_MU_MIMO,
				"type": "name",
                "title": "Funcionalidade Multi-utilizador MIMO",
                "content": "Clique em ativar para ativar a funcionalidade Multi-utilizador MIMO"
			},  {
				"type": "name",
				"title": "Redução da Interferência USB 3.0",
				"content": "Clique em Ativar para reduzir a interferência USB 3.0"
			}, {
                type: "title",
                title: "WPS"
            }, {
        ...
        lan: {
            ...
            CONTENT: [{
				...
				display: INCLUDE_LINK_AGGREGATION,
                type: "title",
                content: "Agregação de Ligações"
            }, {
            	display: INCLUDE_LINK_AGGREGATION,
                type: "paragraph",
                ...
                content: [
                    "Altere o estado do botão para ativar a funcionalidade de Agregação de Ligações.",
                    "Selecione o modo de agregação de ligações.<br><b> LACP activo:</b> Ativa o LACP (Link Aggregation Control Protocol) incondicionalmente.<br><b> LACP passivo:</b> Ativa apenas o LACP apenas quando um dispositivo LACP é detetado.",
					"Especifique duas portas para agregação de ligações.",
					"Clique em guardar."
                ]
            }]
        },
        ...
        cloudBasic: {
            ...
            CONTENT: [{
                ...
                type: "title",
                display: "$.helpControl.cloudLogin",
                content: "Informação do Dispositivo"
            }, {
                type: "paragraph",
                display: "$.helpControl.cloudLogin",
                ...
                content: [
                    "Clique em Vincular",
                    "Introduza o endereço registado que pretende vincular.",
                    "Clique em guardar."
                ]
            }]
        }
