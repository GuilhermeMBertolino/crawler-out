    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
               ...
               /* "type": "name",
                ...
                content: "Click the corresponding button to enable the 2.4GHz | 5GHz Guest Network."
            }, {
                    type: "name",
...

                {
                    ...
                    type: "paragraph",
                    content: "The instructions for 2.4GHz Guest Network above also apply to 5GHz Guest Network."
                }, {
                    type: "name",
                    title: "Save",
                    content: "Click to save all your settings."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Select 2.4GHz | 5GHz to set its advanced wireless settings."
            }, {
                type: "name",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                content: "The Effective Time Schedule is based on the time of the Router. The time can be set in System Tools -> Time Settings"
                    ...
                    type: "name",
                    title: "2.4GHz | 5GHz",
                    content: "Select 2.4GHz or 5GHz to set its wireless schedule."
            }, {
                    type: "name",
                title: "Wireless Schedule",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Select 2.4GHz | 5GHz to change the corresponding settings."
            }, {
                type: "name",
        ...
        qos:{
            ...
            CONTENT:[{
                ...
                content:["Find the device you want to prioritize in the list and toggle on Priority.",
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                content: "Select the corresponding button to enable the 2.4GHz | 5GHz Guest Network."
            }, {
                type: "name",
                title: "Guest Network SSID",
                content: "Either use the default SSID or create a new name using 1 to 32 characters. This field is case-sensitive."
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "MAC Address",
                "content": "Displays the unique physical address of the router."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "IP address",
                "content": "Displays the IP address of the router, which can be used to log in to the router's web management page."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "Subnet Mask",
                "content": "Displays the subnet mask of the router."
            }, {
				display: "$.routerMode == 'AP'",
				"type": "name",
                "title": "Address Type",
                "content": "Displays the configuration type of the router's IP address."
            }, {
		...
		type: 'title',
			...
			content: "Test Again - Click to perform a speed test."
                ...
                type: 'name',
                title: 'Status',
                content: 'Displays whether the 2.4GHz | 5GHz wireless is on (enabled) or off (disabled).'
            }, {
                type: 'name',
                title: 'SSID',
	    	...
	    	display: "$.routerMode == 'Router'",
                type: 'title2',
                content: '2.4GHz | 5GHz Guest Network'
            }, {
	    	display: "$.routerMode == 'Router'",
                type: 'name',
                title: 'Status',
                content: 'Displays whether the 2.4GHz | 5GHz Guest Network is on (enabled) or off (disabled).'
            }, {
	    	display: "$.routerMode == 'Router'",
                type: 'name',
                title: 'SSID',
        ...
        wirelessBasic: {
            ...
            CONTENT: [{/*
                ...
                type: "name",
                title: "Hide SSID",
                content: "Select this checkbox if you want to hide the 2.4GHz | 5GHz SSID from the Wi-Fi network list."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
                    ...
                    type: "name",
                    title: "2.4G | 5G",
                    content: "Select to view the 2.4GHz | 5GHz wireless settings and information."
                }, {
                    type: "name",
                    title: "Network Name",
                    ...
                    type: "name",
                    title: "2.4G | 5G",
                    content: "Select to view the 2.4GHz | 5GHz Guest network settings and information."
                }, {
                    type: "name",
                    title: "Guest Network SSID",
  	...
  	ethWan: {
        ...
        "iptv": {
            ...
            "CONTENT": [{
                ...
                "children": [{
                    ...
                    "type": "name",
                    "title": "New Zealand-UFB",
                    "content": "Select this if your ISP is UFB from New Zealand and the necessary parameters are predetermined, including Internet/IP-Phone/IPTV VLAN IDs and Priority, and LAN (1/2/3/4) port."
                }, {                    
                    "type": "name",
                    "title": "Australia-NBN",
                    "content": "Select this if your ISP is NBN from Australia and the necessary parameters are predetermined, including Internet/IP-Phone/IPTV VLAN IDs and Priority, and LAN (1/2/3/4) port."    
                }, {
                    "type": "name",
                    "title": "Custom",
       ...
       "PRINT_SERVER": {
        ...
        "sysconf": {
            "TITLE": "Wireless Advanced Settings 2.4GHz | 5GHz",
            "CONTENT": [{
                "type": "name",
                "title": "Beacon Interval",
             ...
             /*add by wuzeyu for Reducing USB 3.0 Interference */
                "type": "name",
...
*/
        ...
        "lan": {
            ...
            "CONTENT": [{
                ...
                "type": "name",
                "title": "Address Type",
                "content": "The way to configure the router's IP address. You can configure it manually(Static IP) or automatically(Smart DHCP). "
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "LAN IP",
                "content": "Keeps the router's default IP address (192.168.0.254) or enter a new one. This IP address can be used to log in to the router's web management page."
            },  {
                "type": "name",
                "title": "Subnet Mask",
                ...
                content: [
                    "Toggle on to enable the Link Aggregation feature.",
                    "Select the mode of link aggregation.<br><b>	LACP active:</b> enables LACP (Link Aggregation Control Protocol) unconditionally.<br><b>	LACP passive:</b> enables LACP only when an LACP device is detected.",
					"Specify two ports for link aggregation.",
					"Click Save."
                ]
            }]
        },
		...
		openvpnServer: {
			...
			CONTENT: [{
				...
				type: "step",
				title: "To enable and connect your client devices to the OpenVPN server:"
			},{
				type: "paragraph",
				...
				content:[
					...
					"On your client devices, download and install the OpenVPN client utility from <a class=\"link\" href=\"http://openvpn.net/index.php/download/community-downloads.html\">http://openvpn.net/index.php/download/community-downloads.html</a><br> The official supported platforms include Windows, Mac OSX, Linux.",
					"Launch the OpenVPN client utility and add a new VPN connection using the saved configuration file to connect your client device to the VPN server."
				]
			},{	
				type: "paragraph",
				title: "Note:",
		...
		pptpvpnServer: {
			...
			CONTENT: [{
				...
				type: "step",
				title: "To enable and connect your client devices to the PPTP VPN server:"
			},{
				type: "paragraph",
				...
				content:[
					...
					"On your client devices, create a PPTP VPN connection. The official supported platforms include Windows, Mac OSX, Linux, iOS, and Android.",
					"Launch the PPTP VPN program, add a new connection and enter the domain name of the registered DDNS service or the static IP address that assigned to the WAN port, to connect your client device to the PPTP VPN server."
				]				
			}]
		},
