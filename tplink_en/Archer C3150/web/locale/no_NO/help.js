    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2,4 GHz | 5 GHz Gjestenettverk",
                content: "Klikk på den samsvarende knappen for å aktivere 2,4 GHz | 5 GHz Gjestenettverket."
            }, {
                type: "name",
                ...
                type: "paragraph",
                content: "Instruksjonene for 2,4 GHz gjestenettverket ovenfor gjelder også for 5GHz gjestenettverkene."
            }, {
                type: "name",
                title: "Lagre",
                content: "Klikk for å lagre alle innstillingene dine."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                type: "name",
                title: "2,4 GHz | 5 GHz",
                content: "Velg 2,4 GHz | 5 GHz for å angi de tilhørende avanserte trådløse innstillingene."
            }, {
                type: "name",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2,4 GHz | 5 GHz",
                content: "Velg 2,4 GHz eller 5 GHz for å angi dens trådløse plan."
            }, {
                type: "name",
                title: "Trådløs plan",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                ...
                type: "name",
                title: "2,4 GHz | 5 GHz",
                content: "Velg 2,4 GHz | 5 GHz for å endre de samsvarende innstillingene."
            }, {
                type: "name",
                title: "Trådløs radio",
                content: "Velg denne avmerkingsboksen for å aktivere den trådløse 2,4 GHz | 5 GHz-radiofrekvensen."
            }, {
                type: "name",
                ...
                type: "name",
                title: "Skjul SSID",
                content: "Velg denne avmerkingsboksen hvis du ønsker å skjule navnet på 2,4 GHz | 5 GHz-nettverket (SSID) fra Wi-Fi-nettverkslisten."
            }, {
                type: "name",
                title: "Sikkerhet",
                content: "Velg en av følgende sikkerhetsalternativer:",
        ...
        parentCtrl: {
            ...
            CONTENT: [{
                ...
                type: "note",
                title: "<strong>For å sette opp foreldrekontroll på en ny enhet</strong>",
                content: [
                    "Klikk Legg til.",
                    "Skriv inn et navn for denne profilen, og klikk «+» for å legge til enheten(e) til profilen.",
                    ...
                    "Aktiver og angi Tidsbegrensninger hvis du ønsker å begrense den totale tiden denne profilen kan bruke på nettet. Du kan også bruke Sengetid til å sette en daglig periode som enheter under denne profilen ikke kan bruke internett.",
                    "Klikk Lagre."
                ]
            }, {
                type: "note",
                title: "<strong>For å se en profils detaljerte internetthistorikk</strong>",
                content: [
                    "Klikk på den tilhørende Innsikt-knappen i Innsikt-kolonnen.",
                    "Hvis du ønsker å se flere oppføringer, klikker du på Historikk <span class=\"ptl-ctr-help-icon history\"></span>-knappen.",
                    "Du kan blokkere eller oppheve blokkering av nettsteder ved å klikke på <span class=\"ptl-ctr-help-icon block\"></span> eller <span class=\"ptl-ctr-help-icon unblock\"></span>-knappen."
                ]
            }, {
                type: "note",
                title: "<strong>For å deaktivere eller aktivere internettilgang umiddelbart</strong>",
                content: [
        ...
        qos: {
            ...
            CONTENT: [{
                ...
                type: "title",
                content: "Enhetsprioritet"
            }, {
                type: "paragraph",
                content: "Velg enheten(e) du ønsker å prioritere og hvor lenge de skal bli prioritert."
            }, {
                type: "note",
                title: "<strong>Prioritere en enhet</strong>",
                content: [
                    "Finn den enheten du ønsker å prioritere i listen og veksle på Prioritet.",
                    "Velg hvor lenge enheten skal bli prioritert i Timing-kolonnen."
                ]
            }]
        },
        antiVirus: {
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Trådløst nettverk 2,4 GHz | 5 GHz",
                content: "Klikk på den samsvarende knappen for å aktivere 2,4 GHz | 5 GHz Gjestenettverket …"
            }, {
                type: "name",
                title: "SSID for gjestenettverk",
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "MAC-adresse",
                "content": "Viser den unike fysiske adressen til ruteren."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "IP-adresse",
                "content": "Viser IP-adressen til ruteren, som kan brukes til å logge på ruterens web-administrasjonsside."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "Nettverksmaske",
                "content": "Viser ruterens subnettmaske."
            }, {
				display: "$.routerMode == 'AP'",
				"type": "name",
                "title": "Adressetype",
                "content": "Viser konfigurasjonstypen til ruterens IP-adresse."
            }, {
		...
		display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",
	       ...
	       display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",                 
                ...
                type: "title2",
                content: "2,4 GHz | 5 GHz Trådløst"
            }, {/*
                type: "name",
                title: "Status",
                content: "Viser om 2,4 GHz | 5 GHz trådløst er påslått (aktivert) er avslått (deaktivert)."
            }, {*/
                type: "name",
                title: "SSID",
                content: "Viser det gjeldende trådløse nettverksnavnet for 2,4 GHz | 5 GHz-båndfrekvensen."
            }, {
                type: "name",
                title: "Kanal",
                content: "Viser kanalen som sender de trådløse 2,4 GHz | 5 GHz-nettverksendingene."
            }, {
                type: "name",
                title: "MAC",
                content: "Viser den gjeldende MAC-adressen til det trådløse 2,4 GHz | 5 GHz-nettverket."
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "title2",
                content: "2,4 GHz | 5 GHz Gjestenettverk"
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "Status",
                content: "Viser om 2,4 GHz | 5 GHz-gjestenettverket er påslått (aktivert) er avslått (deaktivert)."
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "SSID",
		...
		sysMode: {
            TITLE: "Operasjonsmodus",
            CONTENT: [{
                type: "name",
                title: "Ruter",
                content: "I denne modusen kobles ruteren direkte til Internett via en dynamisk IP, statisk IP, PPPoE, L2TP eller PPTP og deler tilgangen til Internett med flere kablede eller trådløse enheter. NAT, brannmur og DHCP-server er aktivert som standard. Velg denne modusen hvis du er førstegangsbruker eller hvis du for øyeblikket ikke benytter deg av noen andre rutere."
            }, {
                type: "name",
                title: "Aksesspunkt",
                content: "I denne modusen kobles ruteren til en kablet eller trådløs ruter via en nettverkskabel og utvider den trådløse rekkevidden til ditt eksisterende nettverk. Funksjoner som NAT, foreldrekontroll og QoS er ikke støttet i denne modusen. Denne ruterens IP-adresse tildeles av primærruterens DHCP-server. Hvis du ikke vet IP-adressen til denne ruteren, kan du bruke http://tplinkwifi.net for å logge deg på web-administrasjonssiden."
            }]
        },
        wirelessBasic: {
            TITLE: "Trådløse innstillinger",
            CONTENT: [{
                type: "name",
                title: "2,4 GHz | 5 GHz Trådløst nettverk",
                content: "Velg denne avmerkingsboksen for å aktivere den trådløse 2,4 GHz | 5 GHz-radiofrekvensen."
            }, {
                type: "name",
                title: "Navn på trådløst nettverk (SSID)",
                ...
                type: "name",
                title: "Skjul SSID",
                content: "Velg denne avmerkingsboksen hvis du ønsker å skjule SSID-en til 2,4 GHz | 5 GHz fra Wi-Fi-nettverkslisten."
            }]
        },
        status: {
            TITLE: "Internett",
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Velg for å se de trådløse innstillingene og informasjonen om 2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "Nettverksnavn",
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Velg for å se innstillingene om gjestenettverket og informasjonen om 2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "SSID for gjestenettverk",
        ...
        ddns: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "Dynamisk DNS gir deg mulighet til å tildele en fast vert og domenenavn til en dynamisk IP-adresse. Det er nyttig når du er vert for ditt eget nettsted, FTP-server eller en annen server bak ruteren. Først må du registrere deg med en DDNS-tjenesteleverandør slik som www.dyndns.com."
            }, {
                type: "step",
                title: "Konfigurere en dynamisk DNS",
                content: [
                    "Velg dynamisk DNS-tjenesteleverandør.",
                    "Enter the Username and Password of the Dynamic DNS account.",
                    "Angi domenenavnet du mottok fra DDNS-tjenestelevereandøren.",
                    "Click Log in and click Save."
                ]
            }, {
                type: "paragraph",
                title: "Note:",
                content: "Hvis du ønsker å benytte deg av en nu DDNS-konto, vennligst logg ut først, for så å logge deg på igjen med den nye kontoen."
            }]
        },
        dhcp: {
            TITLE: "DHCP-server",
        ...
        sysconf: {
            TITLE: "Avanserte trådløse innstillinger 2.4GHz | 5GHz",
            CONTENT: [{
                type: "name",
                title: "Signalintervall",
                ...
                "content": "Velg dette alternativet for å aktivere Airtime Fairness (ATF)-funksjonen, som lar deg optimalisere systemkapasiteten for hver flyt. ATF-trafikkprogrammet bruker mål for sendetid per bestemmelsessted, for å balansere sendetidsbruk på tvers av strømningsdestinasjonene."
			},  {
				display: INCLUDE_MU_MIMO,
				"type": "name",
                "title": "MIMO-funksjon for flere brukere",
                "content": "Klikk for å aktivere funksjonen MIMO for flere brukere."
			},  {
				"type": "name",
        ...
        lan: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "Adressetype",
                "content": "Måten ruterens IP-adresse konfigureres på. Du kan konfigurere den manuelt (statisk IP) eller automatisk (smart DHCP)."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "LAN-IP",
                "content": "Beholder ruterens standard IP-adresse (192.168.0.254) eller skriver inn en ny en. Denne IP-adressen kan bli brukt for å logge inn på ruterens webbehandlingsside."
            }, {
                type: "name",
                title: "Nettverksmaske",
                ...
                content: [
                    "Skru på for å aktivere Link-aggregering.",
                    "Velg modus for link-aggregeringen.<br><b> LACP aktiv:</b> Aktiverer LACP (Link Aggregation Control Protocol) uavhengig.<br><b> LACP passiv:</b> aktiverer LACP kun når en LACP-enhet er registrert.",
					"Angi to porter for link-aggregering.",
					"Klikk Lagre."
                ]
            }]
        },
        ...
        cloudBasic: {
            ...
            CONTENT: [{
                ...
                type: "title",
                display: "$.helpControl.cloudLogin",
                content: "Kontoinformasjon"
            }, {
                type: "paragraph",
                display: "$.helpControl.cloudLogin",
                content: "Viser TP-Link ID-informasjon. Du kan redigere kontoinformasjonen ved å klikke Rediger-ikonet."
            }, {
                type: "title",
                display: "$.helpControl.cloudLogin",
                content: "Informasjon om enhet"
            }, {
                type: "paragraph",
                display: "$.helpControl.cloudLogin",
                ...
                content: [
                    "Klikk Bind.",
                    "Skriv inn den registrerte e-postadressen du vil binde.",
                    "Klikk på Lagre."
                ]
            }]
        }
