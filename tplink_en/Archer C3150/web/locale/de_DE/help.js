    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4 GHz | 5 GHz Gastnetz",
                content: "Klicken Sie auf die entsprechende Schaltfläche, um das 2.4 GHz | 5 GHz Gastnetz zu aktivieren."
            }, {
                type: "name",
                title: "Gastnetz-SSID",
                ...
                type: "paragraph",
                content: "Die Hinweise für das 2.4-GHz-Gastnetz oben gelten auch für Ihre beiden 5GHz Gastnetz."
            }, {
                type: "name",
                title: "Speichern",
                content: "Klicken Sie hierauf, um alle Ihre Einstellungen zu speichern."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Wählen Sie 2.4GHz | 5GHz aus, um die erweiterten WLAN-Einstellungen festzulegen."
            }, {
                type: "name",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                    ...
                    type: "name",
                    title: "2.4GHz | 5GHz",
                    content: "Wählen Sie 2.4GHz | 5GHz aus, um das WLAN-Band für Ihre WLAN-Zeitplanung festzulegen."
                }, {
                    type: "name",
                    title: "WLAN-Zeitplanung",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                    ...
                    type: "name",
                    title: "2.4GHz | 5GHz",
                    content: "Wählen Sie 2.4GHz | 5GHz aus, um die entsprechenden Einstellungen zu ändern."
                }, {
                    type: "name",
                    title: "WLAN-Frequenz",
                    content: "Markieren Sie dieses Kontrollkästchen, um Ihr 2.4GHz | 5GHz WLAN-Funkfrequenz zu aktivieren."
                }, {
                    type: "name",
                    ...
                    title: "SSID verbergen",
               	    content: "Markieren Sie dieses Kontrollkästchen, um den Namen des 2.4GHz | 5GHz WLANs (SSID) aus der WLAN-Liste auszublenden."
                }, {
                    type: "name",
                    title: "Sicherheit",
                    content: "Wählen Sie eine der folgenden Sicherheitsoptionen:",
        ...
        qos: {
            ...
            CONTENT: [{
                ...
                type: "title",
                content: "Gerätepriorität"
            }, {
                type: "paragraph",
                content: "Wählen Sie das/die zu priorisierende(n) Gerät/Geräte und geben Sie einen Gültigkeitszeitraum an."
            }, {
                type: "note",
                title: "<strong>Priorisieren eines Geräts</strong>",
                content: [
                    "Wählen Sie das zu priorisierende Gerät aus und aktivieren Sie Priorität.",
                    "Wählen Sie in der Spalte Timing, wie lange dieses Gerät priorisiert werden soll."
                ]
            }]
        },
        antiVirus: {
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "WLAN 2.4GHz | 5GHz",
                content: "Klicken Sie auf die entsprechende Schaltfläche, um das 2.4GHz | 5GHz Gastnetz zu aktivieren."
            }, {
                type: "name",
                title: "Gastnetz-SSID",
                content: "Sie können entweder die standardmäßige SSID verwenden oder einen neuen Namen mit 1 bis 32 Zeichen erstellen. Dieses Feld unterscheidet zwischen Groß- und Kleinschreibung."
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "MAC-Adresse",
                "content": "Die eindeutige physische Adresse Ihres Routers."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "IP-Adresse",
                "content": "Die IP-Adresse Ihres Routers. Über diese loggen Sie sich in die Weboberfläche ein."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "Subnetzmaske",
                "content": "Die Subnetzmaske Ihres Routers."
            }, {
				display: "$.routerMode == 'AP'",
				"type": "name",
                "title": "Adresstyp",
                "content": "Konfigurationstyp der Router-IP-Adresse."
            },{
		...
		display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",
                ...
                type: "title2",
                content: "2.4GHz | 5GHz WLAN"
            }, {/*
                type: "name",
                title: "Status",
                content: "Zeigt an, ob das 2,4/5GHz WLAN eingeschaltet (aktiviert) oder ausgeschaltet (deaktiviert) ist."
            }, {*/
                type: "name",
                title: "SSID",
                content: "Zeigt den aktuellen WLAN-Namen auf 2.4GHz | 5GHz an."
            }, {
                type: "name",
                title: "Kanal",
                content: "Zeigt den Kanal an, auf dem das 2.4GHz | 5GHz WLAN überträgt."
            }, {
                type: "name",
                title: "MAC",
                content: "Zeigt die aktuelle MAC-Adresse Ihres 2.4GHz | 5GHz WLANs."
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "title2",
                content: "2.4GHz | 5GHz Gastnetz"
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "Status",
                content: "Zeigt an, ob das 2.4GHz | 5GHz Gastnetz eingeschaltet (aktiviert) oder ausgeschaltet (deaktiviert) ist."
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "SSID",
		...
		sysMode: {
            ...
            CONTENT: [{
                type: "name",
                title: "Router",
                content: "In dieser Betriebsart verbindet Ihr Router sich direkt mit dem Internet über dynamische/statische IP-Adresse, PPPoE, L2TP oder PPTP und stellt so mehreren kabellosen oder kabelgebundenen Geräten Internetzugriff bereit. NAT, Firewall und DHCP-Server sind standardmäßig aktiv. Wählen Sie dies aus, wenn Sie in Ihrem Netz noch keinen Router haben."
            }, {
                type: "name",
                title: "Accesspoint",
                content: "In dieser Betriebsart verbindet Ihr Router sich über Ethernetkabel mit einem Router und gibt dessen Internetverbindung drahtlos weiter. Funktionen wie NAT, Kindersicherung und QoS werden in dieser Betriebsart nicht unterstützt. Die IP-Adresse dieses Routers wird vom DHCP-Server Ihres Hauptrouters zugewiesen. Wissen Sie die IP-Adresse dieses Routers nicht, loggen Sie sich unter http://tplinkwifi.net ein."
            }]
		},
        wirelessBasic: {
            TITLE: "WLAN-Einstellungen",
            CONTENT: [{
                ...
                type: "name",
                title: "SSID verbergen",
                content: "Markieren Sie dieses Kontrollkästchen, um die Namen des 2.4GHz | 5GHz SSID aus der WLAN-Liste auszublenden."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Wählen Sie hier, um die 2.4GHz | 5GHz WLAN-Einstellungen und -Informationen anzuzeigen."
            }, {
                type: "name",
                title: "Netzwerkname",
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Wählen Sie hier, um die 2.4GHz | 5GHz Gastnetz-Einstellungen und -Informationen anzuzeigen."
            }, {
                type: "name",
                title: "Gastnetz-SSID",
        ...
        ddns: {
            ...
            CONTENT: [{
                ...
                content: [
                    "Wählen Sie den DDNS-Anbieter aus.",
                    "Enter the Username and Password of the Dynamic DNS account.",
                    "Geben Sie Ihren DDNS-Domänennamen ein.",
        ...
        sysconf: {
            TITLE: "Erweiterte WLAN-Einstellungen 2.4GHz | 5GHz",
            CONTENT: [{
                type: "name",
                title: "Ortungsintervall",
                ...
                "content": "Aktivieren Sie dies, um Airtime-Fairness (ATF) zu aktivieren und so den Durchsatz zu optimieren. Der ATF-Trafficscheduler verteilt die zugewiesene Sendezeit gerecht unter den angemeldeten Teilnehmern."
			},  {
				display: INCLUDE_MU_MIMO,
				"type": "name",
                "title": "Multi-User-MIMO",
                "content": "Aktivieren des Multi-User-MIMO."
			},  {
				"type": "name",
				"title": "USB3-Interferenzreduktion",
				"content": "Aktivieren Sie dies, um die USB3-Interferenzen zu minimieren."
			}, {
                type: "title",
                title: "WPS"
            }, {
        ...
        lan: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "Adresstyp",
                "content": "Die Art und Weise, wie die IP-Adresse Ihres Routers konfiguriert wird. Sie können sie manuell (Statische IP-Adresse) oder automatisch (Smart-DHCP) konfigurieren."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "LAN-IP-Adresse",
                "content": "Belassen Sie die Standard-IP-Adresse des Routers (192.168.0.254) oder geben Sie eine neue ein. Diese IP-Adresse kann verwendet werden, um sich in die Weboberfläche des Routers einzuloggen."
            },{
                type: "name",
                title: "Subnetzmaske",
                ...
                type: "paragraph",
                title: "Anmerkung",
                content: "Wenn die neue LAN-IP-Adresse nicht im selben Subnetz liegt wie die alte, wird der IP-Adresspool des DHCP-Servers automatisch geändert. Allerdings werden virtuelle Server und der DMZ-Host erst wirksam, nachdem sie neu konfiguriert wurden."
            }, {
                ...
                content: [
                    "Aktivieren Sie Link-Aggregation.",
                    "Wählen Sie den Link-Aggregationsmodus.<br><b> LACP aktiv:</b> aktiviert LACP (Link Aggregation Control Protocol) bedingungslos.<br><b> LACP passiv:</b> aktiviert LACP nur, wenn ein LACP-Gerät erkannt wird.",
					"Geben Sie zwei für Link-Aggregation zu verwendende Ports an.",
					"Klicken Sie Speichern."
                ]
            }]
        },
        ...
        cloudBasic: {
            ...
            CONTENT: [{
                ...
                type: "paragraph",
                display: "$.helpControl.cloudLogin",
                content: "Zeigt Informationen zu Ihrem TP-Link-ID. Durch Klicken auf Bearbeiten können Sie diese bearbeiten."
            }, {
                type: "title",
                display: "$.helpControl.cloudLogin",
                ...
                content: [
                    "Klicken Sie Binden.",
                    "Geben Sie eine zuvor registrierte E-Mail-Adresse ein, um diese zu binden.",
                    "Klicken Sie Speichern."
                ]
            }]
        }
