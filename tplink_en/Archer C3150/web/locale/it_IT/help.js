    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                ...
                content: "Fare clic sul pulsante corrispondente per abilitare la rete ospiti 2.4GHz | 5GHz."
            }, {
                type: "name",
                ...
                type: "paragraph",
                content: "Le precedenti istruzioni relative alla rete ospiti 2.4GHz si applicano anche alle reti guest 5GHz."
            }, {
                type: "name",
                title: "Salva",
                content: "Fare clic per salvare tutte le impostazioni."
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Selezionare 2.4GHz | 5GHz per impostare le relative impostazioni wireless avanzate."
            }, {
                type: "name",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "Selezionare 2.4GHz | 5GHz per impostare la pianificazione della connessione wireless."
            }, {
                type: "name",
                title: "Pianificazione connessione wireless",
        ...
        wirelessSettings: {
            ...
            CONTENT: [/*{
                    ...
                    type: "name",
                    title: "2.4GHz | 5GHz",
                    content: "Selezionare 2.4GHz | 5GHz per modificare le relative impostazioni."
                }, {
                    type: "name",
                    title: "Radio wireless",
                    content: "Selezionare questa casella di controllo per abilitare la frequenza 2.4GHz | 5GHz per la radio wireless."
                }, {
                    type: "name",
                    ...
                    type: "name",
                    title: "Nascondi SSID",
                    content: "Selezionare questa casella di controllo se si desidera nascondere il nome della rete (SSID) 2.4GHz | 5GHz nell'elenco delle reti Wi-Fi."
                }, {
                    type: "name",
                    title: "Protezione",
                    content: "Selezionare una delle seguenti opzioni di protezione:",
        ...
        qos: {
            ...
            CONTENT: [{
                ...
                type: "title",
                content: "Priorità Dispositivo"
            }, {
                type: "paragraph",
                content: "Scegliete il/i dispositivo/i cui volete dare priorità e per quanto tempo avrà la priorità."
            }, {
                type: "note",
                title: "<strong>Per dare priorità sd un dispositivo</strong>",
                content: [
                    "Trovate nella lista il dispositivo cui volete assegnare la priorità e spostate su Priorità.",
                    "Selezionate quanto a lungo il dispositivo avrà la priorità assegnata nella colonna Tempo."
                ]
            }]
        },
        antiVirus: {
        ...
        wlGuestDulBandBasic: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "Rete wireless 2.4GHz | 5GHz",
                content: "Selezionare il pulsante corrispondente per abilitare la rete ospiti 2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "SSID Rete Ospiti",
                content: "Usare il SSID predefinito o creare un nuovo nome usando da 1 a 32 caratteri. Questo campo è sensibile all'uso di caratteri maiuscoli/minuscoli."
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "Indirizzo MAC",
                "content": "Mostra l'indirizzo fisico univoco del router."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "Indirizzo IP",
                "content": "Mostra l'indirizzo IP del router, che può essere usato per fare login alla pagina di gestione web del router."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "Subnet Mask",
                "content": "Mostra la subnet mask del router."
            }, {
				display: "$.routerMode == 'AP'",
				"type": "name",
                "title": "Tipo Indirizzo",
                "content": "Mostra il tipo di configurazione dell'indirizzo IP del router."
            }, {
		...
		display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",
	       ...
	       display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",                 
                ...
                type: "name",
                title: "SSID",
                content: "Visualizza il nome corrente della rete wireless della frequenza di banda 2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "Canale",
                content: "Visualizza il canale di trasmissione della rete wireless 2.4GHz | 5GHz."
            }, {
                type: "name",
                title: "MAC",
                content: "Visualizza l'indirizzo MAC corrente wireless 2.4GHz | 5GHz."
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "title2",
                content: "Rete Ospiti 2.4GHz | 5GHz"
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "Stato",
                content: "Visualizza se la rete ospiti 2.4GHz | 5GHz è attivata (abilitata) o disattivata (disabilitata)."
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "SSID",
		...
		sysMode: {
            ...
            CONTENT: [{
                type: "name",
                title: "Router",
                content: "In questa modalità il vostro router si connette direttamente a Internet tramite IP Dinamico, IP Statico, PPPoE, L2TP o PPTP e condivide l'accesso a Internet fra più dispositivi cablati o wireless. NAT, firewall e server DHCP sono abilitati di default. Selezionate questa modalità se siete un utente poco esperto o non state usando un altro router."
            }, {
                type: "name",
                title: "Access Point",
                content: "In questa modalità il vostro router si connette ad un router preesistente tramite un cavo Ethernet, riuscendo così ad aumentare la copertura wireless della vostra rete. Funzioni quali NAT, Parental Controls e QoS non sono supportati in questa modalità. L'indirizzo IP viene assegnato a questo router dal server DHCP del router principale. Se non sapete qual'è l'indirizzo IP di questo router, usate http://tplinkwifi.net per fare login alla pagina di gestione web."
            }]
        },
        wirelessBasic: {
            TITLE: "Impostazioni wireless",
            CONTENT: [{
                ...
                type: "name",
                title: "Nascondi SSID",
                content: "Selezionare questa casella di controllo se si desidera nascondere il SSID 2.4GHz | 5GHz nell'elenco delle reti Wi-Fi."
            }]
        },
        status: {
            TITLE: "Internet",
            CONTENT: [{
                    ...
                    type: "name",
                    title: "2.4G | 5G",
                    content: "Selezionare questa opzione per visualizzare le informazioni e le impostazioni wireless 2.4GHz | 5GHz."
                }, {
                    type: "name",
                    title: "Nome rete",
                    ...
                    type: "name",
                    title: "2.4G | 5G",
                    content: "Selezionare questa opzione per visualizzare le informazioni e le impostazioni della rete ospiti 2.4GHz | 5GHz."
                }, {
                    type: "name",
                    title: "SSID Rete Ospiti",
        ...
        sysconf: {
            TITLE: "Impostazioni avanzate wireless 2.4GHz | 5GHz",
            CONTENT: [{
                type: "name",
                title: "Intervallo beacon",
                content: "Immettere un valore compreso tra 25 e 1000 millisecondi per stabilire l'intervallo in base al quale i pacchetti beacon vengono trasmessi dal router per la sincronizzazione della rete wireless. Il valore predefinito è 100 millisecondi."
                ...
                "content": "Selezionate questa casella di controllo per abilitare la funzione Airtime Fairness (ATF) che vi permette di ottimizzare la banda di ogni flusso. Lo scheduler di traffico ATF usa i target di destinazione airtime per bilanciare l'utilizzo di airtime sui flussi di destinazione."
			},  {
				display: INCLUDE_MU_MIMO,
				"type": "name",
                "title": "Funzione MIMO Multi-Utente",
                "content": "Fate clic per abilitare la Funzione MIMO Multi-Utente."
			},  {
				"type": "name",
				"title": "Riduzione Interferenze USB 3.0",
				"content": "Fate clic per abilitare la riduzione delle interferenze USB 3.0."
			}, {
                type: "title",
                title: "WPS"
            }, {
        ...
        lan: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "Tipo Indirizzo",
                "content": "Potete configurare l'indirizzo IP del router in modalità manuale (IP Statico) o automatica (Inteligente DHCP)."
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "IP LAN",
                "content": "Mantenere l'indirizzo IP predefinito del router (192.168.0.254) o immetterne uno nuovo. Con questo indirizzo IP è possibile accedere alla pagina Web di gestione del router."
            }, {
                type: "name",
                title: "Subnet mask",
                ...
                content: [
                    "Spostate il tasto per abilitare la funzione Link Aggregation.",
                    " Selezionate la modalità di link aggregation.<br><b> LACP attivo:</b> Abilita LACP (Link Aggregation Control Protocol) senza condizioni.<br><b> LACP passivo:</b> Abilita LACP solo quando viene rilevato un dispositivo LACP.",
					"Specificate 2 porte per il link aggregation.",
					"Fate clic su Salva."
                ]
            }]
        },
        ...
        cloudBasic: {
            ...
            CONTENT: [{
                ...
                type: "title",
                display: "$.helpControl.cloudLogin",
                content: "Informazioni Account"
            }, {
                type: "paragraph",
                display: "$.helpControl.cloudLogin",
                content: "Mostra le informazioni del vostro TP-Link ID. Potete editare l'account facendo clic sull'icona Edita."
            }, {
                type: "title",
                display: "$.helpControl.cloudLogin",
                content: "Geräteinformationen"
            }, {
                type: "paragraph",
                display: "$.helpControl.cloudLogin",
                ...
                content: [
                    "Fate clic su Lega.",
                    "Immettete l'email registrata che volete legare.",
                    "Fate clic su Salva."
                ]
            }]
        }
