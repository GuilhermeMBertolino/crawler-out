...
e_str[CMM_APP_PORT_ALREADY_IN_USE] = 'Указанный вами порт уже используется, укажите другое значение.';
...
e_str[CMM_WLAN_INVALID_DFS_CHANNEL] = "Данный канал DFS нельзя использовать, так как был обнаружен радар. Вы можете выбрать другой канал или подождать ответа системы.";