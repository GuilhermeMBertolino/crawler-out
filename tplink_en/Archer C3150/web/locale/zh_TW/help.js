    ...
    $.helpContent = {
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz 訪客網路",
                content: "點選對應的按鈕以啟用2.4GHz | 5GHz訪客網路。"
            }, {
                type: "name",
                title: "訪客網路SSID",
                ...
                type: "paragraph",
                content: "上方給2.4GHz訪客網路的說明，也同樣適用於5GHz訪客網路。"
            }, {
                type: "name",
                title: "儲存",
                content: "點選以儲存您所有的設定。"
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "選擇2.4GHz | 5GHz以設定它的進階無線設定。"
            }, {
                type: "name",
                title: "信標間隔",
        ...
        wirelessSchedule: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "選擇2.4GHz或5GHz以設定它的無線排程。"
            }, {
                type: "name",
                title: "無線排程",
        ...
        wirelessSettings: {
            ...
            CONTENT: [{
                ...
                type: "name",
                title: "2.4GHz | 5GHz",
                content: "選擇2.4GHz | 5GHz以變更對應設定。"
            }, {
                type: "name",
                title: "無線射頻",
                content: "勾選核取方塊以啟用2.4GHz | 5GHz無線射頻。"
            }, {
                type: "name",
                title: "無線網路名稱（SSID）",
                ...
                type: "name",
                title: "隱藏SSID",
                content: "如果您想從Wi-Fi網路列表中隱藏2.4GHz | 5GHz網路名稱（SSID），請勾選核取方塊。"
            }, {
                type: "name",
                title: "安全性",
        ...
        parentCtrl: {
            ...
            CONTENT: [{
                ...
                type: "note",
                title: "<strong>若要套用家長監護到新設備</strong>",
                content: [
                    "點選 增加。",
                    "請為設定檔輸入名稱，接著點選「+」以增加在此設定檔下的設備。",
                ...
                type: "note",
                title: "<strong>若要查看設定檔的詳細網際網路歷史</strong>",
                content: [
                    "在洞悉欄中，點選對應的洞悉按鈕。",
                    "如果您想要看到更多記錄，請點選歷史 <span class=\"ptl-ctr-help-icon history\"></span> 按鈕。",
                    "透過點選 <span class=\"ptl-ctr-help-icon block\"></span> 或 <span class=\"ptl-ctr-help-icon unblock\"></span> 按鈕，您可以封鎖或解鎖網站。"
                ]
            }, {
                type: "note",
                title: "<strong>若要立即停用或啟用網際網路存取</strong>",
                content: [
        ...
        qos: {
            ...
            CONTENT: [{
                ...
                type: "note",
                title: "<strong>若要優先化設備</strong>",
                content: [
                    "在列表中找到您要優先化的設備，並開啟優先級開關。",
                    "在時間欄中選擇該設備將會被優先化多長時間。"
                ]
            }]
        },
        antiVirus: {
        ...
        networkMap: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "MAC位址",
                "content": "顯示路由器獨一無二的實體位址。"
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "IP位址",
                "content": "顯示路由器的IP位址，這可以讓您用來登入至網頁管理頁面。"
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "子網路遮罩",
		...
		display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",
	       ...
	       display: INCLUDE_SPEEDTEST && "$.routerMode == 'Router'",                 
                ...
                type: "title2",
                content: "2.4GHz | 5GHz無線"
            }, {/*
                type: "name",
                title: "狀態",
                content: "顯示2.4GHz | 5GHz無線是開（啟用）或關（停用）。"
            }, {*/
                type: "name",
                title: "SSID",
                content: "顯示2.4GHz | 5GHz頻段頻率目前的無線網路名稱。"
            }, {
                type: "name",
                title: "頻道",
                content: "顯示無線2.4GHz | 5GHz網路廣播的頻道。"
            }, {
                type: "name",
                title: "MAC",
                content: "顯示無線2.4GHz | 5GHz目前的MAC位址。"
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "title2",
                content: "2.4GHz | 5GHz訪客網路"
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "狀態",
                content: "顯示2.4GHz | 5GHz訪客網路是開（啟用）或關（停用）。"
            }, {
	    	display: "$.routerMode == 'Router'",
                type: "name",
                title: "SSID",
		...
		sysMode: {
            ...
            CONTENT: [{
                type: "name",
                title: "路由器",
                content: "在此模式下，您的路由器透過浮動IP、固定IP、PPPoE、L2TP或PPTP直接連線至網際網路，並將網際網路連線分享給多個有線或無線設備。NAT、防火牆與DHCP伺服器預設為啟用。如果您是初次使用者或您目前沒有任何其他正在使用中的路由器，請選擇此模式。"
            }, {
                type: "name",
                title: "基地台",
                content: "在此模式下，您的路由器透過「網路線」連接至有線或無線路由器，並擴展您現有網路的無線覆蓋範圍。而在此模式下，將不支援NAT、家長監護與QoS等功能。本路由器的IP位址將由來源路由器的DHCP伺服器分配。如果您不知道本路由器的IP位址，您可以使用http://tplinkwifi.net以登入至網頁管理頁面。"
            }]
		},
        wirelessBasic: {
            TITLE: "無線設定",
            CONTENT: [{
                ...
                type: "name",
                title: "隱藏SSID",
                content: "如果您想從Wi-Fi網路列表中隱藏2.4GHz | 5GHz網路名稱（SSID），請勾選此核取方塊。"
            }]
        },
        status: {
            TITLE: "網際網路",
            CONTENT: [{
                ...
                type: "name",
                title: "2.4G | 5G",
                content: "選擇以查看2.4GHz | 5GHz無線設定與資訊。"
            }, {
                type: "name",
                title: "網路名稱",
                ...
                type: "name",
                title: "2.4G | 5G",
                content: "選擇以查看2.4GHz | 5GHz訪客網路設定與資訊。"
            }, {
                type: "name",
                title: "訪客網路SSID",
        ...
        ddns: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "本路由器具有動態網域名稱服務（DDNS）功能，DDNS功能可以讓您在浮動IP的情況下也可以擁有固定的網域名稱，對於要架站、架設IP攝影機或對分享器進行遠端監控...等，卻沒有固定IP的使用者來說是十分方便的功能。在使用這項功能前，您必須在 DDNS服務提供商網站進行註冊，並瞭解如何使用。例如：www.dyndns.com這個網站。"
            }, {
                type: "step",
                title: "設定 動態DNS",
                content: [
        ...
        sysconf: {
            ...
            CONTENT: [{
				...
				"type": "name",
                "title": "通訊公平功能",
                "content": "勾選核取方塊以啟用通訊公平（ATF）功能，這可以讓您優化每個流量的吞吐量。ATF流量排程使用預先目的地通訊目標以平衡跨越流量目的地的通訊使用"
			},  {
				display: INCLUDE_MU_MIMO,
				"type": "name",
                "title": "多使用者MIMO功能",
                "content": "點選啟用以使用多使用者MIMO功能。"
			},  {
				"type": "name",
				"title": "減少對USB 3.0的影響",
				"content": "點選能夠減少對USB 3.0的影響。"
			}, {
                type: "title",
                title: "WPS"
            }, {
        ...
        lan: {
            ...
            CONTENT: [{
                ...
                "type": "name",
                "title": "位址類型",
                "content": "設定路由器IP位址的方式。您可以手動（固定IP）或自動（智能DHCP）設定它。"
            }, {
				display: "$.routerMode == 'AP'",
                "type": "name",
                "title": "LAN IP",
                "content": "保持路由器的預設IP位址（192.168.0.254）或輸入一個新的位址。此IP位址被用於登入路由器的網頁管理頁面。"
            }, {
                type: "name",
                title: "子網路遮罩",
                ...
                content: [
                    "切換至「開」以啟用鏈路聚合功能。",
                    "選擇鏈路聚合的模式。<br><b> LACP主動：</b>無條件啟用LACP （鏈路聚合控制協定）<br><b> LACP被動：</b>只有當LACP設備被偵測到時，才啟用LACP。",
					"請為鏈路聚合指定2個連接埠。",
					"點選儲存。"
                ]
            }]
        ...
        cloudBasic: {
            ...
            CONTENT: [{
                ...
                type: "paragraph",
                display: "$.helpControl.cloudLogin",
                content: "顯示您的TP-Link ID資訊。您可以透過扁選「編輯」圖示編輯帳號資訊。"
            }, {
                type: "title",
                display: "$.helpControl.cloudLogin",
                content: "設備資訊"
