...
jQuery.extend({
    tablePages: function(id, size) {
        ...
        $table.bind("repaginate", function() {
            $table.find("tbody tr:not(.nd):not(.not-paging)").hide().slice(currentPage * pageSize, (currentPage + 1) * pageSize).show();
        ...
        var $pager = $("<div class='table-bottom-pages'><span id='" + prevIconId + "' class='page left'></span></div>");
