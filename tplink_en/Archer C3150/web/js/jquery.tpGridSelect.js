(function($) {
    ...
    $.fn.tpGridSelect = function(options) {
        ...
        var sel = defaultOptions.selectedColor;
        ...
        var timeExam = $(this).next('.timeExam');
        timeExam.css({
            'float': 'left',
            'height': '20px',
            'width': '20px',
        ...
        return {
            ...
            initGridSelectVal: function(array) {
                var reverse = true;
                if (reverse === true) {
                    if (array == null || array == undefined || array.length != options.colHeads.length) {
                        return;
                    }
