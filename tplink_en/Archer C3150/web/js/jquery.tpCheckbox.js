(function($) {
    ...
    TPCheckbox.prototype = {
        ...
        labelMouseEnter: function() {
            ...
            if (self.$checkbox.prop('data-checked') === true) {
        ...
        labelClick: function(e) {
            ...
            if (self.$checkbox.prop('data-checked') === false) {
                self.$checkbox.prop('data-checked', true);
                self.$label.find('.text').addClass('span-click');
                self.$label.find('.icon').addClass('checkbox-click');
            } else {
                self.$checkbox.prop('data-checked', false);
