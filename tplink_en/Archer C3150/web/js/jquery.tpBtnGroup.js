    ...
    TPBtnGroup.prototype = {
        ...
        init: function(id) {
            ...
            var errorTips = '<div class="widget-error-tips" id="' + self.$btngroup.attr('id') + '_tips">' +
                ...
                '</div>';
            self.$btngroup.find('.button-group-wrap').wrap('<div style="display: inline-block">').after(errorTips);
            self.refresh();
        ...
        registerHandlers: function() {
            ...
            self.$btngroup.find("div.button-group-wrap").children("ul.button-group-cover").on('click.tpBtnGroup', function(e) {
