...
var AccessCtrlAccessRulesHelpRpm =
{
	...
	"for_exam": "<B>For example</B>: If you desire to allow the host with MAC address <font color=\"#C11C66\">00:11:22:33:44:AA</font> to access <b>www.google.com</b> only from <b>18:00</b> to <b>20:00</b> on <b>Saturday and Sunday</b>, and <b>forbid</b> other hosts in the LAN to access the Internet, you should follow the settings below:",
...
var AccessCtrlAccessTargetsHelpRpm =
{
	...
	"for_exam": "<B>For example</B>: If you desire to restrict the internet activities of host with MAC address <font color=\"#C11C66\">00:11:22:33:44:AA</font> in the LAN to access <B>www.google.com</B> only, you should first follow the settings below:",
...
var AccessCtrlHostsListsHelpRpm =
{
	...
	"edit": "<B>Edit </B> - To edit an existing entry.",
	"for_exam": "<B>For example</B>: If you desire to restrict the internet activities of host with MAC address <font color=\"#C11C66\">00:11:22:33:44:AA</font>, you should first follow the settings below:",
...
var AssignedIpAddrListHelpRpm =
{
	...
	"brief": "This page shows <B>Client Name</B>, <B>MAC Address</B>, <B>Assigned IP</B> and <B>Lease Time</B> of each DHCP Client connected to the device.",
	"clie_name": "<B>Client Name</B> - The name of the DHCP client.",
	"mac_addr": "<B>MAC Address</B> - The MAC address of the DHCP client.",
	"assi_ip": "<B>Assigned IP</B> - The IP address that the device has allocated to the DHCP client.",
...
var BackNRestoreHelpRpm =
{
	...
	"s_0": "To restore the device\'s configuration, follow these instructions:",
...
var ChangeLoginPwdHelpRpm =
{
	...
	"brief": "It is strongly recommended that you change the factory default user name and password of the device. All users who try to access the device\'s web-based utility will be prompted for the device\'s user name and password.",
	"note": "<b>Note</b>: The new user name and password must not exceed 32 characters in length and must not include any spaces. Enter the new Password twice to confirm it.",
...
var FixMapCfgHelpRpm =
{
	...
	"ip_addr": "<B>IP Address</B> - The IP address that the device reserved.",
...
{
	"header": "Yandex.DNS",
	"brief": "On this page you can configure Yandex.DNS filter which will secure your devices from malicious websites and will restrict adult websites for your children devices. You can configure a general filter for all devices or a separate filter for each device.",
	"brief2": "Please visit dns.yandex.ru to know more about Yandex.DNS service.",
	"dev_all": "<b>Enable Yandex DNS for all devices</b> - This Yandex.DNS filter will be enabled on all devices, which does not exist in Yandex.DNS rule list.",
	"disabled": "<b>Disabled</b> - Means, that no any Yandex.DNS filter will work on all devices.",
	"basic": "<b>Basic</b> - Means, that Basic Yandex.DNS filter will work on all devices.",
	"safe": "<b>Safe</b> - Means, that Safe Yandex.DNS filter will work on all devices.",
	"child": "<b>Child</b> - Means, that Child Yandex.DNS filter will work on all devices.",
	"mac_addr": "<B>MAC Address</B> - Display device’s MAC address on which Yandex.DNS filter will work.",
	"description": "<B>Client Name</B> - Display device description for better device identification.",
	"mode": "<b>Control Mode</b> - Disaply chosen Yandex.DNS filter for special device.",
	"edit": "<b>Edit</b> - To edit or delete an existing entry.",
	"steps": "To configure specific Yandex.DNS filter for special device click Add. You can chose device from Scan list or enter MAC address manually. Select special control mode (basic, safe, child) and give a little description to rule."
};
var GuestNetUsbCfgHelpRpm =
{
	...
	"s_2": "Make sure the Service Status on the page USB Settings->Storage Sharing is <SPAN style=\"color:#C11C66\">Started</SPAN>.",
	"s_3": "Make sure the Access shared storage with password on the page USB Settings->Storage Sharing is <SPAN style=\"color:#C11C66\">enable</SPAN>.",
	...
	"partition": "<B>Partition</B> - The volume that the folder resides. <SPAN style=\"color:#C11C66\">Volume 1-8</SPAN> is mapping to USB port 1, <SPAN style=\"color:#C11C66\">Volume 9-16</SPAN> is mapping to USB port 2.",
	...
	"note": "<B>Note</B>:",
	"s_5": "If you want guests visit folders of Guest Network Storage Sharing with guest account, you must <SPAN style=\"color:#C11C66\">enable</SPAN> Access shared storage with password on the page USB Setings->Storage Sharing,or the guests can\'t access to the Guest Network Storage Sharing.",
...
var GuestNetWirelessCfgHelpRpm =
{
	...
	"network_0": "<B>Guest Network(2.4G/5G)</B> - Enabled or disable the Guest Network function here .",
	"network_0_2g": "<B>Guest Network</B> - Enabled or disable the Guest Network function here .",
	...
	"facebook": "<B>Facebook Wi-Fi</B> - Facebook Wi-Fi allows customers to easily connect to your Wi-Fi by redirecting them to your company's Facebook page. Here, they are encouraged to check in and like your page before receiving free web access. This raises the profile of your business on Facebook and increases customer engagement with promotional content on your page.",
	"facebook_setup_title":"<B>To set up Facebook Wi-Fi</B>",
	"facebook_wifi":"1. Enable Facebook wifi.",
	"facebook_config":"2. Click <B>Set Up on Facebook</B> then follow the instructions to complete Facebook Wi-Fi Configuration.",
	"facebook_checkin":"3. When Facebook Wi-Fi Configuration is complete, the name of the Facebook Page will display as the Facebook Check-in Location. Click Save.",
	"note": "<B>Note</B>:",
...
var GuestNetWirelessCfgHelpRpmWithFacebook =
{
	"header": "Guest Network Wireless Settings",
	"brief": "You can configure Guest Network Wireless Settings on this page.",
	"network": "<B>Allow Guests To Access My Local Network</B> - If enabled, guests can communicate with hosts.",
...
var IPv6StatusHelpRpm =
{
	...
	"conn_status": "<B>Connection Status</B> - - The status of IPv6 connection.",
...
var LanDhcpServerHelpRpm =
{
	...
	"brief": "The device is set up by default as a DHCP (Dynamic Host Configuration Protocol) server, which provides the TCP/IP configuration for all the PCs that are connected to the device in the LAN.",
	...
	"default_gate": "<B>Default Gateway - </B>(Optional) Suggest to input the IP Address of the LAN port of the device, default value is 192.168.0.1.",
	...
	"note": "<B>Note</B>: To use the DHCP server function of the device, you should configure all computers in the LAN as \"Obtain an IP Address automatically\" mode. This function will take effect until the device reboots.",
...
var LanDhcpServerHelpRpm_AP = {
	...
	"leas_time": "<B>Lease Time</B> - The <B>Address Lease Time</B> is the length of time a network user will be allowed to keep connecting to the device with the current DHCP Address. Enter the amount of time, in minutes, that the DHCP address will be \"leased\". The time range is 1~2880 minutes. The default value is 1 minutes.",
	"default_gate": "<B>Default Gateway - </B>(Optional) Suggest to input the IP Address of the LAN port of the device, default value is 192.168.0.254.",
	"default_gate_HasRouter": "<B>Default Gateway - </B>(Optional) Suggest to input the IP Address of the LAN port of the device, default value is 192.168.0.1.",
...
var MacCloneCfgHelpRpm =
{
	...
	"brief": "Most Cable ISPs (Internet Service Provider) register the unique MAC Address from the wired connection on your <span id = \"t_main_computer\" style=\"color:#C11C66\">MAIN COMPUTER - the last computer used to be connected with the Cable Modem and had Internet connection</span>.",
	...
	"save": "Click the <B>Save</B> button to save your settings.",
	"note": "<B>Note</B>:",
	"s_2": "Please ensure you are doing the MAC Clone with the wired connection of your <span style=\"color:#C11C66\">MAIN COMPUTER</span> which used to be connected with your Cable and had Internet connection.",
...
var MiscHelpRpm =
{
	...
	"statistics": "<font color=\"#C11C66\">Note: FLOOD Filtering will take effect only when the <b>Statistics</b> in <b>System Tools</b> is enabled.</font>",
	"note_2":"<font color=\"#C11C66\">Note 2: If Hardware NAT is enabled, FLOOD Filtering will NOT take effect, because these two modules cannot work at the same time.</font>",
...
var NasCfgHelpRpm =
{
	...
	"volume": "<B>Volume</B> - The volume name of the USB drive the users have access to. <SPAN style=\"color:#C11C66\">Volume 1-8</SPAN> is mapping to USB port 1, <SPAN style=\"color:#C11C66\">Volume 9-16</SPAN> is mapping to USB port 2.",
...
var NetworkCfgHelpRpm =
{
	...
	"type": "<B>Type</B> - Choosing smart IP(DHCP) to get IP address from DHCP server, or choosing static IP to config IP address manually.",
	"mac_addr": "<B>MAC Address</B> - The physical address of the LAN ports, as seen from the LAN. The value cannot be changed.",
	"ip_addr": "<B>IP Address</B> - Enter the IP address of your Device in dotted-decimal notation (factory default - 192.168.0.1).",
	...
	"note": "<B>Note: </B>",
	"s_0": "If you change the IP address, you must use the new IP address to login to the Device.",
...
var NetworkCfgHelpRpm_AP =
{
	...
	"ip_addr_HasRouter": "<B>IP Address</B> - Enter the IP address of your Device in dotted-decimal notation (factory default - 192.168.0.1).",
	"ip_addr": "<B>IP Address</B> - Enter the IP address of your Device in dotted-decimal notation (factory default - 192.168.0.254).",
	...
	"s_1": "If you select the type of smart IP(DHCP), the DHCP server in this device will not startup",
	"s_2": "If the new IP address you set is not in the same subnet with the previous one, the IP Address pool in the DHCP server will be configured automatically",
	"smartdhcp_note":"<B>Note</B>: If you select the type of <B>smart IP(DHCP)</B>, the DHCP server in this device will not startup.",
...
var PPPoEv6CfgHelpRpm =
{
	...
	"passthrough": "<B>passthrough(Bridge)</B>  Select this type if your ISP uses Pass-Through (Bridge) network deployment.",
	"password": "<B>User Name/Password</B> - Enter the User Name and Password provided by your ISP. These fields are case-sensitive.",
...
var RestoreDefaultCfgHelpRpm =
{
	...
	"admin_0": "Default Password",
	"s_0": "Default IP Address",
	"s_1": "Default Subnet Mask",
...
var SoftwareUpgradeHelpRpm =
{
	...
	"brief": "To upgrade the device\'s firmware, follow these instructions:",
	...
	"s_1": "The device will reboot while the upgrading has been finished.",
	...
	"note": "<B>Note: </b> The firmware version must correspond to the hardware. The upgrade process takes a few moments and the device restarts automatically when the upgrade is complete. It is important to keep power applied during the entire process. Loss of power during the upgrade could damage the device."
};
...
var StatusHelpRpm =
{
	...
	"wireless 2.4GHz/5GHz": "<B>Wireless 2.4GHz/5GHz</B> - These are the current settings or information for Wireless.You can configure them in the <B>Wireless 2.4GHz/5GHz -&gt; Basic Settings</B> page.",
	"operation_mode": "<B>Operation Mode</B> - Indicates the mode which the device is working on.",	
...
var StatusHelpRpm_AP =
{
	...
	"brief": "The <B>Status</B> page displays the AP\'s current status and configuration. All information is read-only.",
	"lan": "<B>LAN</B> - The following parameters apply to the LAN port of the AP. You can configure them on the <B>Network -> LAN</B> page.",
	"mac_addr": "<B>MAC Address</B> - The physical address of the AP, as seen from the LAN.",
	"ip_addr": "<B>IP Address</B> - The LAN IP address of the AP.",
	"subn_mask": StatusHelpRpm.subn_mask,
	"operation_mode": StatusHelpRpm.operation_mode,	
	"wireless": StatusHelpRpm.wireless,
	"wire_radio": "<B>Wireless Radio</B> - Indicates whether the wireless radio feature of the AP is enabled or disabled.",
	"name_ssid_root": "<B>Name(SSID) of Root AP</B> - The SSID of the Root AP.",	
	"name_ssid": "<B>Name(SSID)</B> - The SSID of the AP.",
	"mode": "<B>Mode</B> - The current wireless mode which the AP works on.",
	"channel": StatusHelpRpm.channel,
	"chan_width": StatusHelpRpm.chan_width,
	"mac_addr_0": "<B>MAC Address</B> - The physical address of the AP, as seen from the WLAN.",
	"wds_stat": StatusHelpRpm.wds_stat,	
	"system": "<B>System Up Time</B> - The length of time since the AP was last powered on or reset.",
	"refresh": "Click the <B>Refresh</B> button to get the latest status and settings of the AP."
};
var SysRebootHelpRpm =
{
	"header": "Reboot Help",
	"brief": "Click the <B>Reboot</B> button to reboot the device.",
	"reboot_title": "<b>Reboot</b>",
	"reboot_brief": "Click the <B>Reboot</B> button to reboot the device.",
    "auto_reboot_title": "<b>Auto Reboot Time</b>",
    "r_0": "There are two options:",
    "r_1": "Disable: Disable the auto reboot function.",
    "r_timeout": "Timeout: Specify a time period(1-72 hours), then the router will reboot automatically after every this interval.",
    "r_2": "Schedule:",
    "r_3": "Day: Choose Everyday, or choose Select Days and select the certain day (days) to reboot the router.",
    "r_4": "Time: Specify the time in HHMM format for auto reboot.",
	"s_0": "Some settings of the device will take effect only after rebooting, which include:",
	"s_1": "Change the LAN IP Address (system will reboot automatically).",
	"s_2": "Upgrade the firmware of the device (system will reboot automatically).",
	"s_3": "Restore the device\'s settings to the factory defaults (system will reboot automatically).",
	"s_4": "Update the configuration with the file (system will reboot automatically)."
};
var SysAutoRebootHelpRpm =
{
	"header": "Reboot Help",
	"brief": "Click the <B>Reboot</B> button to reboot the device.",
	"reboot_title": "<b>Reboot</b>",
...
var SystemLogHelpRpm =
{
	...
	"clea_log": "<B>Clear Log</B> - All the logs will be deleted from the device permanently, not just from the page.",
...
var SystemStatisticHelpRpm =
{
	...
	"note": "<font color=\"#C11C66\">Note: If Hardware NAT is enabled, Statistics will NOT take effect, because these two modules cannot work at the same time.</font>",
...
var Usb3gHelpRpm=
{
	...
	"pinStatus": "<B>PIN Status</B> - Displays the PIN status of the SIM card, including Unable to unlock SIM card, Ready, SIM Locked, PIN Locked, and Unknown Error.",
	"local": "<B>Location</B> - Displays the location of the SIM card.",
	...
	"setaup": "<B>Set Dial Number, APN, Username and Password manually</B> - Select the checkbox to set the Dial Number, APN, Username and Password manually.",
	"number": "<B>Dial Number/APN/Username/Password</B> - Enter the Dial Number, APN, Username and Password provided by your ISP.",
	"auth": "<B>Authentication Type</B> - Select an authentication type from the drop-down list. The default method is AUTO_AUTH. Some ISPs may require a specific authentication type, please confirm it with your ISP or keep the default settings.",
	"conn_mode": "<B>Connection Mode</B>",
	"alwa_on": "<b>Always on</b> - Connect automatically after the Router is disconnected. To use this option, click the radio button.",
	"connect": "<B>Connect on Demand</B> - You can configure the Router to disconnect your Internet connection after a specified period of the Internet connectivity (<B>Max Idle Time</B>). If your Internet connection has been terminated due to inactivity, <B>Connect on Demand </B> enables the Router to automatically re-establish your connection when you attempt to access the Internet again. If you wish to activate <B>Connect on Demand</B>, put a check mark in the circle. If you want your Internet connection to remain active all the times, enter <B>0</B> in the <B>Max Idle Time</B> field.",
	"note_0": "<b>Note:</b> Sometimes the connection cannot be disconnected although you specify a time to <B>Max Idle Time</B>(0~99 mins) because some applications visit the Internet continually in the background.",
	"connect_manu": "<b>Connect Manually</b> - You can configure the Router to make it connect or disconnect manually. After a specified period of inactivity (<B>Max Idle Time</B>), the Router will disconnect your Internet connection, and not be able to re-establish your connection automatically as soon as you attempt to access the Internet again. To use this option, click the radio button. If you want your Internet connection to remain active all the times, enter <B>0</B> in the <B>Max Idle Time</B> field. Otherwise, enter the number in minutes that you wish to have the Internet connecting last unless a new link requested.",
	...
	"echo": "<B>Echo Request Interval</B> - Enter a time interval value between 0 and 120 (in seconds) for which the router requests Access Concentrator to echo at every interval. The default value is 30. 0 means no detection.",
	"fip": "<B>Use The Following IP Address</B> - Select this option and enter the IP address provided by your ISP.</li>",
...
var Usb3gModemListHelpRpm=
{
	...
	"delete": "<B>Delete</B> - Displays options to delete the corresponding .bin file."
};
...
var WanStaticIpCfgHelpRpm =
{
	...
	"dyna_ip": "If your ISP is running a DHCP server, select the <B>Dynamic IP</B> option.",
	"stat_ip": "If your ISP provides a static or fixed IP Address, Subnet Mask, Gateway and DNS setting, select the <B>Static IP</B> option.",
	"russia": "If your ISP provides a PPPoE connection, select <B>PPPoE/Russian PPPoE</B> option.",
	"bigp_cable": "If your ISP provides BigPond Cable (or Heart Beat Signal) connection, please select <B>BigPond Cable</B> option.",
	"russia_0": "If your ISP provides L2TP connection, please select <B>L2TP/Russian L2TP</B> option.",
	"russia_1": "If your ISP provides PPTP connection, please select <B>PPTP/Russian PPTP</B> option.",
	"detect": "If you don\'t know how to choose the appropriate connection type, click the <B>Detect</B> button to allow the Router to automatically search your Internet connection for servers and protocols. The connection type will be reported when an active Internet service is successfully detected by the Router. This report is for your reference only. To make sure the connection type your ISP provides, please refer to the ISP. The various types of Internet connections that the Router can detect are as follows:",
	"russia_2": "<B>PPPoE/Russian PPPoE</B> - Connections which use PPPoE that requires a user name and password.",
	"dyna_ip_0": "<B>Dynamic IP</B> - Connections which use dynamic IP address assignment.",
	"stat_ip_0": "<B>Static IP</B> - Connections which use static IP address assignment.",
...
var WlanAdvHelpRpm_AP =
{
	...
	"brief": "<B>Transmit Power</B> - Here you can specify the transmit power of the AP. You can select High, Middle or Low which you would like. High is the default setting and is recommended.",	
	"brief_AP": "<B>Transmit Power</B> - Here you can specify the transmit power of the AP. You can select 100%, 75% or 50% which you would like.",	
	"beacon_inte": "<B>Beacon Interval</B> - The beacons are the packets sent by the AP to synchronize a wireless network. Beacon Interval value determines the time interval of the beacons. You can specify a value between 40-1000 milliseconds. The default value is 100.",	
	"beacon_inte_AP": "<B>Beacon Interval</B> - The beacons are the packets sent by the AP to synchronize a wireless network. Beacon Interval value determines the time interval of the beacons. You can specify a value between 40-1000 milliseconds. The default value is 100.",	
	"rts_thre": "<B>RTS Threshold</B> - Here you can specify the RTS (Request to Send) Threshold. If the packet is larger than the specified RTS Threshold size, the AP will send RTS frames to a particular receiving station and negotiate the sending of a data frame. The default value is 2346.",	
	"rts_thre_AP": "<B>RTS Threshold</B> - Here you can specify the RTS (Request to Send) Threshold. If the packet is larger than the specified RTS Threshold size, the AP will send RTS frames to a particular receiving station and negotiate the sending of a data frame. The default value is 2346.",	
...
var WlanNetworkHelpRpm_AP =
{
	...
	"brief": "<B>Note</B>: The operating distance or range of your wireless connection varies significantly based on the physical placement of the AP. For best results, place your AP:",	
	...
	"note": "<B>Note</B>: Failure to follow these guidelines can result in significant performance degradation or inability to wirelessly connect to the AP.",	
	...
	"broadcast": "<B>Enable SSID Broadcast</B> - If you select the <B>Enable SSID Broadcast</B> checkbox, the AP will broadcast its name (SSID) on the air."	
};
var WlanNetworkHelpRpm_MSSID =
{
	...
	"wireless": "<B>SSID</B> - Enter a value of up to 32 characters. The same Name (SSID) must be assigned to all wireless devices in your network. In Multi-SSID operation mode, enter SSID for each BSS in the field \"SSID1\" ~ \"SSID4\".",
	"region": WlanNetworkHelpRpm.region,
	"mode": WlanNetworkHelpRpm.mode,
	"chan_width": WlanNetworkHelpRpm.chan_width,
	"channel": WlanNetworkHelpRpm.channel,
	"broadcast": WlanNetworkHelpRpm_AP.broadcast,
	"vlan":"<B>VLAN ID</B> - The ID of a VLAN. Only in the same VLAN, can a Wireless PC and a wired PC communicate with each other. The value can be between 1 and 4094. If the VLAN function is enabled, when AP forwards packets, the packets out from the LAN port will be added with an IEEE 802.1Q VLAN Tag, whose VLAN ID is just the ID of the VLAN where the sender belongs.",
	"en_vlan":"<B>Enable VLAN</B> - Check this box to enable the VLAN function. The AP supports up to 4 VLANs. All wireless PCs in the VLANs are able to access this AP. The AP can also work with an IEEE 802.1Q Tag VLAN supporting Switch."
};
var WlanSecurityHelpRpm =
{
	"header": "Wireless Security Help",
	"brief": "You can select one of the following security options:",
	"wireless": "<b>Disable Wireless Security</b> - The wireless security function can be enabled or disabled. If disabled, the wireless stations will be able to connect the device without encryption. It is recommended strongly that you choose one of following options to enable security.",
	...
	"personal_0": "<B>WPA/WPA2 - Personal</B>",
	...
	"wpa2wpa3auto": "<B>WPA2/WPA3-Auto</B> - WPA2/WPA3-Auto mode allows for gradual migration to a WPA3-Personal network while maintaining interoperability with WPA2-Personal devices and without disruption to users.",
	"wpa3_sae": "<B>WPA3-SAE</B> - Wi-Fi networks protected by WPA3-SAE receive more robust password-based authentication through Simultaneous Authentication of Equals (SAE), bringing stronger protections for the networks.",
	"encryption": "<B>Encryption</B> - You can select either <B>Auto</B>, or <B>TKIP</B> or <B>AES</B>.",
	"psk_pass": "<B>Wireless Password</B> - You can enter <B>ASCII</B> or <B>Hexadecimal</B> characters. For <B>Hexadecimal</B>, the length should be between 8 and 64 characters; for <B>ASCII</B>, the length should be between 8 and 63 characters.",
	...
	"enterprise_0": "<B>WPA/WPA2 - Enterprise</B>",
...
{
	"header": "Throughput Monitor Help",
	"brief": "This page helps to watch wireless throughput info. ",
	"rate": "<b>Rate</b> - The Throughput unit.",
	"run_time": "<b>Run Time</b> - How long this funtion is running. ",
	"transmit": "<b>Transmit</b> - Wireless transmit rate information. ",
	"receive": "<b>Receive</b> - Wireless receive rate information.",
	"start": "Click the <b>Start</b> button to start wireless throughput monitor. ",
	"stop": "Click the <b>Stop</b> button to stop wireless throughput monitor. "
};
...
var WlanWpsHelpRpm_AP =
{
	...
	"brief": "WPS function will help you add a new device to the network quickly. If the new device supports Wi-Fi Protected Setup and is equipped with a configuration button, you can add it to the network by pressing the configuration button on the device and then press the button on the AP within two minutes. The status LED on the AP will be on for five minutes if the device has been successfully added to the network. If the new device supports Wi-Fi Protected Setup and the connection way using PIN, you can add it to the network by entering the AP\'s PIN.",
	"wps_stat": WlanWpsHelpRpm.wps_stat,
	"curr_pin": "<B>Current PIN</B> - The current value of the AP\'s PIN displayed here. The default PIN of the AP can be found in the label.",
	"rest_pin": "<B>Restore PIN</B> - Restore the PIN of the AP to its default.",
	"generate": "<B>Generate New PIN</B> - Click this button, and then you can get a new random value for the AP\'s PIN. You can ensure the network security by generating a new PIN.",
	"add_devi": WlanWpsHelpRpm.add_devi,
	"note": "<B>Note: </B> The WPS function cannot be configured if the Wireless Function of the AP is disabled. Please make sure the Wireless Function is enabled before configuring the WPS."
};
var WlanConnectHelpRpm =
{
	"header": "Connect to Host Network Help",
	"brief": "In Range Extender mode, the device will relay data to an associated root AP. AP function is enabled meanwhile. The wireless range extender relays signal between its stations and the root AP for greater wireless range.",
	"connect24g": "<B>Connect to 2.4GHz</B> - Enable or disable to connect the extender to an existing 2.4GHz network.",
	"lock_to_ap": "<B>Lock to AP</B> - If selected, the device’s connection will be restricted to only the network with this specific MAC address.",
	"scanner": "<B>Wireless Scanner</B> - Click this button to scan and display all available Wi-Fi networks within range that you want the extender to connect to. Once a network is selected, the SSID and security settings of that network will automatically populate.",
	"host_ssid24g": "<B>SSID(to be bridged)</B> - Enter the case-sensitive SSID of the host network which the extender will be connecting to, or click <b>Wireless Scanner</b> and select a Wi-Fi network.",
	"host_bssid24g": "<B>MAC Address(to be bridged)</B> - Enter the MAC Address of the host network which the extender will be connecting to, or click <b>Wireless Scanner</b> and select a Wi-Fi network.",
	"host_sec": "<B>Security</B> - Select one of the security options to match with the host network.",
	"sec_none": "<B>No Security</B> - This option disables the wireless security.",
	"sec_wpa": "<B>WPA-PSK</B> - This option supports implementation of the WPA (Wi-Fi Protected Access) standard. It is recommended.",
	"sec_wpa2": "<B>WPA2-PSK</B> - This option supports implementation of the WPA2 (Wi-Fi Protected Access) standard. It is also recommended.",
	"sec_wep": "<B>WEP</B> - This option is the most basic form of wireless security that can be used if your client devices can only access wireless using WEP (Wired Equivalent Privacy).",
	"settings":"<B>Index</B> - Select which of the four keys will be used.",
	...
	"wep_password":"<B>Password</B> - Enter the matching WEP key information for your network."
};
var WlanExtenderHelpRpm =
{
	"header": "Extended Network Settings Help",
	"brief": "In Range Extender mode, the device will relay data to an associated root AP. AP function is enabled meanwhile. The wireless range extender relays signal between its stations and the root AP for greater wireless range.",
	"ext24g": "<B>Extended 2.4GHz</B> - Enable or disable the 2.4GHz wireless function of the range extender.",
	"ext_ssid24g": "<B>Extended 2.4GHz SSID</B> - Either use the <b>Copy Host SSID</b> button to automatically copy the main router/AP's SSID or enter a new name (up to 32 characters long). This field is case-sensitive.",
	"ext_cpssid": "<B>Copy Host SSID</B> - Click to copy the Host SSID. When selected, the extended network will share the SSID of your host network.",
	"ext_sec": "<B>Extended 2.4GHz Security</B> - Select one of the security options to set local extended wireless network.",
	"sec_none": "<B>No Security</B> - This option disables the wireless security.",
	"sec_wpa": "<B>WPA-PSK/WPA2-PSK</B> - This option supports multiple implementation of the WPA (Wi-Fi Protected Access) standard, such as WPA and WPA2.",
	"sec_wep": "<B>WEP</B> - This option is the most basic form of wireless security that can be used if your client devices can only access wireless using WEP (Wired Equivalent Privacy).",
	"broadcast": "<B>Enable SSID Broadcast</B> - If you select the <B>Enable SSID Broadcast</B> checkbox, the wireless router will broadcast its name (SSID) on the air."
};
var WlanExtender5GHelpRpm =
{
	"header": "Extended Network Settings Help",
	"brief": "In Range Extender mode, the device will relay data to an associated root AP. AP function is enabled meanwhile. The wireless range extender relays signal between its stations and the root AP for greater wireless range.",
	"ext24g": "<B>Extended 5GHz</B> - Enable or disable the 5GHz wireless function of the range extender.",
	"ext_ssid24g": "<B>Extended 5GHz SSID</B> - Either use the <b>Copy Host SSID</b> button to automatically copy the main router/AP's SSID or enter a new name (up to 32 characters long). This field is case-sensitive.",
	"ext_cpssid": "<B>Copy Host SSID</B> - Click to copy the Host SSID. When selected, the extended network will share the SSID of your host network.",
	"ext_sec": "<B>Extended 5GHz Security</B> - Select one of the security options to set local extended wireless network.",
	"sec_none": "<B>No Security</B> - This option disables the wireless security.",
	"sec_wpa": "<B>WPA-PSK/WPA2-PSK</B> - This option supports multiple implementation of the WPA (Wi-Fi Protected Access) standard, such as WPA and WPA2.",
	"sec_wep": "<B>WEP</B> - This option is the most basic form of wireless security that can be used if your client devices can only access wireless using WEP (Wired Equivalent Privacy).",
	"broadcast": "<B>Enable SSID Broadcast</B> - If you select the <B>Enable SSID Broadcast</B> checkbox, the wireless router will broadcast its name (SSID) on the air."
...
var QsLanApHelpRpm =
{
	"header": "Network Settings Help",
	"brief": "You can configure the IP parameters of LAN on this page.",
	"type": "<B>Type</B> - Choosing Smart IP to get IP address from remoter DHCP server, or choosing Static IP to config IP address manually.",	
	"ipaddr": "<B>IP Address</B> - Enter the IP address of your system in dotted-decimal notation (factory default:<SCRIPT language=\"JavaScript\">document.write(\'192.168.0.254\');</SCRIPT>).",
	"mask": "<B>Subnet Mask</B> - An address code that determines the size of the network. Normally 255.255.255.0 is used as the subnet mask.",
	"dhcps": "<B>DHCP Server</B> - Enable or Disable the server. If you chose Smart IP type, the selection will be disabled. If you disable the Server, you must have another DHCP server within your network or else you must configure the IP address of the computer manually.",
	"note": "<B>Note:</B> If you change the IP address, you must use the new IP address to login the system."
};
var QsModeHelpRpm =
{
	"header": "Operation Mode Help",
	"mode_router": "<B>Wireless Router(Default)</B>: In this mode, the device enables multiple users to share the Internet connection via Ethernet port. The LAN devices share the same IP from ISP through Wireless port. While connecting to Internet, the Ethernet port works as a WAN port.",
	"mode_modem": "<B>3G/4G Router</B>: In this mode, the device enables multiple users to share the Internet connection via 3G/4G modem. The LAN devices share the same IP from ISP through Wireless port. While connecting to Internet, the Ethernet port works as a LAN port.",
	"mode_ap": "<B>Access Point</B>: In this mode, this device can be connected to a wired network and transform the wired access into wireless that multiple devices can share together, especially for a home, office or hotel where only wired network is available.",
	"mode_re": "<B>Range Extender</B>: In this mode, this device can copy and reinforce the existing wireless signal to extend the coverage of the signal, especially for a large space to eliminate signal-blind corners.",
	"mode_client": "<B>Client</B>: In this mode, this device can be connected to another device via Ethernet port and act as an adapter to grant your wired devices access to a wireless network, especially for a Smart TV, Media Player, or game console only with an Ethernet port.",	
	"mode_mssid": "<B>Multi-SSID</B>: In this mode, this device can create up to 4 wireless networks labeled with different SSIDs and assign each SSID with different security or VLAN, especially for the situation when the various access policies and functions are required.",
    "mode_hotspot": "<B>WISP</B>: In this mode, the device enables multiple users to share Internet connection from WISP. The LAN port devices share the same IP from WISP through Wireless port. While connecting to WISP, the Wireless port works as a WAN port. The Ethernet port acts as a LAN port."
};
var QsMultissidHelpRpm =
{
	"header": "Wireless Help",
	"brief": "<B>Multi-SSID</B> - AP can support up to 4 SSID.",
	"en_vlan": "<B>Enable VLAN</B> - Check this box to enable the VLAN function. The AP supports up to 4 VLANs. All wireless PCs in the VLANs are able to access this AP. The AP can also work with an IEEE 802.1Q Tag VLAN supported Switch.",	
	"ssid": "<B>SSID</B> - Enter a value of up to 32 characters. The same Name (SSID) must be assigned to all wireless devices in your network. In Multi-SSID operation mode, enter SSID for each BSS in the field \"SSID1\" ~ \"SSID4\".",	
	"vlan": "<B>VLAN ID</B> - The ID of a VLAN. Only in the same VLAN, can a Wireless PC and a wired PC communicate with each other. The value can be between 1 and 4094. If the VLAN function is enabled, when AP forwards packets, the packets out from the LAN port will be added with an IEEE 802.1Q VLAN Tag, whose VLAN ID is just the ID of the VLAN where the sender belongs.",
	"mode": "<B>Mode</B> - You can choose the appropriate \"Mixed\" mode. ",
	"chan_width": "<B>Channel Width</B> - The bandwidth of the wireless channel.",	
	"chan": "<B>Channel</B> - This field determines which operating frequency will be used. It is not necessary to change the wireless channel unless you notice interference problems with another nearby access point.",
	"security": "<b>You can select one of the following security options: ",
	"no_sec": "<b>No Security</b> - The wireless security function can be enabled or disabled. If you select \"None\", the wireless stations will be able to connect this device without encryption. It is recommended strongly that you choose one of following options to enable security.",	
	"wpa2-psk": "<B>WPA2-PSK</B>",	
	"password": "<B>Password</B> - You can enter <B>ASCII</B> characters. The length should be between 8 and 63 characters."
};
var QsReviewHelpRpm =
{
	"header": "Finish Help",
	"finish": "Click the <strong>Finish</strong> button to finish the <B>Quick Setup</B>.",
	"back": "Click the <strong>Back</strong> button to return to the previous page."		
};
var QsWlScanClientHelpRpm =
{
	"header": "Wlan Site Survey Help",
	"note": "<B>Note</B>: The information of APs which you could connect to is shown on this page. Set as follow:",
	"n_0": "First, find the line where the network you want to connect lay on.",	
	"n_1": "Then, check the \"connect\" at the end of that line.",	
	"n_2": "Now, the target network's SSID is filled in the correct place on the Wlan configure page automatically.",	
	"refresh": "<B>Note</B>: Click the <B>Refresh</B> button to update the AP list.",
	"back": "Click the <B>Back</B> button to return Operation Mode selection page."
};
...
var WzdWanTypeHelpRpm =
{
	...
	"russia": "<b>PPPoE/Russian PPPoE</b> - If you have applied ADSL to realize Dial-up service, you should choose this type. Under this condition, you should fill in both the User Name and Password that the ISP supplied.",
	"russia_0": "<b>L2TP/Russian L2TP</b> - In this type, you should fill in the username, password and IP address/Domain name of VPN Server.",
	"russia_1": "<b>PPTP/Russian PPTP</b> - In this type, you should fill in the username, password and IP address/Domain name of VPN Server.",
	"next": "Click the <b>Next</b> button to continue or the <b>Back</b> button to go back to the previous page."
};
var WzdWlanHelpRpm =
{
	...
	"psk_pass": "<B>Wireless Password</B> - You can enter <B>ASCII</B> characters. The length should be between 8 and 63 characters. Please note that the key is case sensitive.",
	"s_2": ""
};
var WzdWlanHelpRpm_AP =
{
	...
	"mode": "<b>Mode</b> - This field determines the wireless mode which the AP works on.",
	"chan_width": WzdWlanHelpRpm.chan_width,
	"channel": WzdWlanHelpRpm.channel,
	"s_0": WzdWlanHelpRpm.s_0,
	"disable_secu": "<b>Disable Security</b> - The wireless security function can be enabled or disabled. If disabled, the wireless stations will be able to connect the AP without encryption. It is recommended strongly that you choose one of following options to enable security.",
...
{
	"header": WzdWlanHelpRpm.header,
	"brief_re":"<B>Range Extender</B> - In Range Extender mode, the wireless repeater relays signal between its stations and the root AP for greater wireless range.</p>",
	"re_wirelessAP":"<B>Wireless Name of Root AP</B> - Enter the name of a remote AP (also called the SSID) that you want to access. Click the <B>Back</B> button back to the AP list page, you can choose another one of searching results to fill in this field.",
	"re_wirelessAP2":"<B>MAC Address of Root AP</B> - Enter the MAC address of AP that you want to access. When you use the survey function in previous page to fulfill the <B>Wireless Name of Root AP</B>, this field will be filled in automatically.",
	"re_wds":"<B>WDS Mode</B> - This field determines which WDS Mode will be used. It is not necessary to change the WDS Mode unless you notice network communication problems with root AP. If you select Auto, then Router will choose the appropriate WDS Mode automatically.",
	"re_wirelessname":"<B>Wireless Name of Range Extender</B> - This field determins the Local AP SSID. You can set the same SSID with the Root AP's, or customize as you want.",
	"brief_hotspot":"<B>WISP</B> - In this mode, the device enables multiple users to share Internet connection from WISP. ",
	"hotspot_ssid":"<B>SSID(to be bridged)</B> - Enter the name of a remote AP (also called the SSID) that you want to access. Click the <B>Back</B> button back to the AP list page, you can choose another one of searching results to fill in this field.",
	"hostpot_mac":"<B>MAC Address(to be bridged):</B> - Enter the MAC address of AP that you want to access. When you use the survey function in previous page to fulfill the <B>Wireless Name of Root AP</B>, this field will be filled in automatically.",
	"hotspot_localssid":"<B>Local Network SSID:</B> - Enter the name of the local Wi-Fi Network.",
	"brief_client":"<B>Client</B> - This device will act as a wireless station to enable wired host(s) to access AP.",
	"client_wirelessAP1":"<B>Wireless Name of Root AP</B> - Enter a string of up to 32 characters. To achieve more information, you can read the same glossary in Access Point part.",
	"client_wirelessAP2":"<B>MAC Address of Root AP</B> - Enter the MAC address of AP that you want to access. When you use the survey function in previous page to fulfill the <B>Wireless Name of Root AP</B>, this field will be filled in automatically.",
	"security": WzdWlanHelpRpm.s_0,
	"no_sec": QsMultissidHelpRpm.no_sec,
	/*"wep_0":WlanSecurityHelpRpm.wep_0,*/
	"wep_0":"<B>Secure(WEP)</B>",
	"auth_type":WlanSecurityHelpRpm.auth_type,
	...
	"bit_1":"For <B>152-bit</B> encryption - You can enter 32 hexadecimal digits (any combination of 0-9, a-f, A-F, and null key is not permitted) or 13 ASCII characters.",
	"wpa_0":"Most Secure(WPA/WPA2-PSK)",
	...
	"not_change":"<B>Not Change</B> - If you chose this option, wireless security configuration will not change!</P>"
};
var IPTVHelp = 
{
...
var PingWatchDogHelpRpm =
{
    ...
    "switch": "<B>Switch</B> - Enable/Disable Ping Watch Dog.",
    "ip": "<B>IP Address</B> - The IP address of the target host where the Ping Watch Dog Utility is sending ping packets.",
    "interval": "<B>Interval</B> - Time interval between two ping packets which are sent out continuously.",
    "delay": "<B>Delay</B> - Time delay before first ping packet is sent out when this device is restarted.",
    "failcount": "<B>Fail Count</B> - Upper limit of the ping packet this device can drop continuously.If this value is overrun, this device will restart automatically.",
	"save": "Be sure to click the <B>Save</B> button to make your settings in operation."		
};
var SnmpHelpRpm = 
{
    "header": "SNMP Settings Help",
    "brief": "Simple Network Management Protocol (SNMP) is a popular network monitoring and management protocol. ", 		
	"agent": "<B>SNMP Agent</B> - Choose <B>Enable</B> to open this function if you want to have remote control through SNMPv1/v2 agent with MIB-II. Choose <B>Disable</B> to close this function.",
	"contact": "<B>SysContact</B> - The textual identification of the contact person for this managed node.",
	"name": "<B>SysName</B> - An administratively-assigned name for this managed node.",
	"desc": "<B>SysDescription</B> - The software version information for this managed node.",
	"location": "<B>SysLocation</B> - The physical location of this node.",
	"note1": "<B>Note:</B> Specifying one of these values via the Device's Web-Based Utility makes the corresponding object read-only. If there isn't such a config setting, then the write request will succeed (assuming suitable access control settings), but the new value would be forgotten the next time the agent was restarted.	",	
	"getcomm": "<B>Get Community</B> - Enter the community name that allows Read-Only access to this device's SNMP information. The community name can be considered a group password. The default setting is <B>public</B>.",
	"getsour": "<B>Get Source</B> - Get source defines the IP address or subnet for management systems that can read information from this 'get' community device.",
	"setcomm": "<B>Set Community</B> - Enter the community name that allows Read/Write access to this device's SNMP information.  The community name can be considered a group password. The default setting is <B>private</B>.",
	"setsour": "<B>Set Source</B> - Set source defines the IP address or subnet for management systems that can control this 'set' community device.",
	"note2": "<B>Note:</B> A restricted source can be a specific IP address (e.g. 10.10.10.1), or a subnet - represented as IP/BITS (e.g. 10.10.10.0/24). If an IP Address of 0.0.0.0 is specified, the agent will accept all requests under the corresponding community name.",
	"save": "Click the <B>Save</B> button to save your settings."
}; 
var ledControlHelp = {
    header: "LED Control",
    brief: "The LED Control allows you to turn On or Off the LEDs on your device according to a specific time schedule.",
	night_mode: "<b>Night Mode</b> - Indicates whether the Night Mode is On (enabled) or Off (disabled).",
    off_time: "<b>LED Off Time</b> - Select the time schedule to turn off LEDs."
};
var FeedbackHelp = {
    header: "Feedback",
    brief: "This page allows you to send your questions or suggestions to us, so that we can resolve your issues and keep improving product features to give you a better network experience. For technical problems, it is recommended to attach the configuration file or system log of the device to help us investigate your case."
};
var WlanSchedule = {
    header: "Wireless Schedule",
    brief: "The Effective Time Schedule is based on the time of the Router. The time can be set in System Tools -> Time Settings.",
	schedule: "<b>Wireless Schedule</b> - Toggle On to enable this feature.",
    save: "Click the Save button to save your settings."
};
var languageHelp = {
    header: "Language Help",
    brief: "Select the language you preferred from the pull-down list.",
};
var ManageCtrl_h = 
{
   "header": "Manage Control Help",
   "userstatus": "<B>Current User Status</B>",
   "routerinfo": "The Router's Information: User Type , Username , Host IP Address and  Host MAC Address",
   "manageAccount": "<b>Account Management</b>",
   "password_brief": "It is strongly recommended that you change the factory default user name and password of the Router. All users who try to access the Router's web-based utility  will be prompted for the Router's user name and password.",
   "password_note": "<strong>Note</strong>: The new user name and password must not exceed 32 characters in length and must not include any spaces. Enter the new Password twice to confirm it.",
   "serviceConfig": "<B>Service Configuration</B>",
   "locale_manage": "Local Management",
   "remote_manage": "Remote Management",
   "l_brief": "This feature allows you to deny LAN computers from accessing the Router.",
   "r_brief": "This feature allows you to manage your Router from a remote location via the Internet.",
   "management": "<B>Port</B> - Web browser access normally uses the standard HTTP(HTTPS) service port 80(443). This Router's default remote management web port number is 80. For greater security, you can change the remote management web port to a custom port by entering that number in the box provided. Choose a number between 1024 and 65535 but do not use the number of any common service port.",
   "management_0": "<B>Available Host (IP/MAC)</B> - This is the current address(IP or MAC) you will use when accessing your Router from the Internet. ",
   "s_0": "To access the Router, you should enter your Router's WAN IP address into your browser's address (in IE) or location (in Netscape) box, followed by a colon and the custom port number you set in the Web Management Port box. For example, if your Router's WAN address is 202.96.12.8 and you use port number 8080, enter http://202.96.12.8:8080  in your browser. You will be asked for the Router's password. After successfully entering the password, you will be able to access the Router's web-based utility.",
   "note1": "<B>Note:</B>",
   "s_1": "Be sure to change the Router's default password to a secure password.",
   "virt_server": "If the web management port conflicts with the one used for a <b>Virtual Server</b> entry, the entry will be automatically <b>disabled</b> after the setting is saved.",
   "certnote": "<B>Certificate</B>",
   "cert_brief": "A file that provides you with authentication information. Download and install the certificate for Local/Remote Management via HTTPS if you need it. Once the certificate is installed, warnings will not pop up when you access the router via HTTPS.",
   "note": "<B>Note:</B>",
   "Cert_note": "For the comprehensive guide, please refer to the User Guide on the product's support page.",
   "save": "Click the <strong>Save</strong> button when finished."
};
var cwmp_h = 
{
	"header": "CWMP Settings",
	"brief": "CWMP (CPE WAN Management Protocol, also called TR-069) allows Auto-Configuration Server (ACS) to perform auto-configuration, provision, connection, and diagnostics to this device. You may configure this function under your ISP's instructions.",
	"cwmp": "<B>CWMP</B> - Enable or disable the CWMP (CPE WAN Management Protocol) feature.",
	"inform": "<B>Inform</B> - Enable this feature to send an Inform message to the ACS (Auto Configuration Server) periodically.",
	"inform_interval": "<B>Inform Interval</B> - Enter the time in seconds when the Inform message will be sent to the ACS.",
	"acs_url": "<B>ACS URL</B> - Enter the web address of the ACS which is provided by your ISP.",
	"acs_name_pwd": "<B>ACS Username/Password</B> - Enter the username and password to log in to the ACS server.",
	"interface": "<B>Interface used by TR-069 client</B> - Select which interface to be used by the TR-069 client.",
	"soap_msg": "<B>Display SOAP messages on serial console</B> - Toggle to enable or disable this feature.",
	"conn_req_auth": "<B>Connection Request Authentication</B> - Select this checkbox to enable authentication for the connection request.",
	"conn_name_pwd": "<B>Username/Password</B> - Enter the username and password for the ACS server to log in the router.",
	"path_port_url": "<B>Path/Port/URL</B> - Enter the path, port and URL for the ACS server to connect to the router.",
	"rpc_method": "<B>Get RPC methods</B> - Click to get the methods to support CWMP."	
};
var name_str =
{
	...
	"GuestNetWirelessCfgHelpRpmWithFacebook": GuestNetWirelessCfgHelpRpmWithFacebook,
	...
	"SysAutoRebootHelpRpm": SysAutoRebootHelpRpm,
	...
	"WlanExtender5GHelpRpm": WlanExtender5GHelpRpm,
...
{
	ManageCtrl_h["password_brief"]="It is strongly recommended that you change the factory default password of the Router. All users who try to access the Router's web-based utility  will be prompted for the Router's password.";
	ManageCtrl_h["password_note"]="<strong>Note</strong>: The new password must be 6 - 32 characters in length, may not include spaces, and must contain at least two types of the following characters: letters, numbers and symbols. Enter the new Password twice to confirm it.";
	ChangeLoginPwdHelpRpm["brief"]="It is strongly recommended that you change the factory default password of the device. All users who try to access the device\'s web-based utility will be prompted for the device\'s password.";
	ChangeLoginPwdHelpRpm["note"]="<b>Note</b>: The new password must be 6 - 32 characters in length, may not include spaces, and must contain at least two types of the following characters: letters, numbers and symbols. Enter the new Password twice to confirm it.";
}
if(INCLUDE_US_CPI_SPEC)
{
	NetworkCfgHelpRpm_AP["ip_addr_HasRouter"]="<B>IP Address</B> - Enter the IP address of your Device in dotted-decimal notation (factory default - 192.168.15.15).";
	NetworkCfgHelpRpm["ip_addr"]="<B>IP Address</B> - Enter the IP address of your Device in dotted-decimal notation (factory default - 192.168.15.15).";
	LanDhcpServerHelpRpm_AP["default_gate_HasRouter"]="<B>Default Gateway - </B>(Optional) Suggest to input the IP Address of the LAN port of the device, default value is 192.168.15.15.";
	LanDhcpServerHelpRpm["default_gate"]="<B>Default Gateway - </B>(Optional) Suggest to input the IP Address of the LAN port of the device, default value is 192.168.15.15.";
	LanDhcpServerHelpRpm["address"]="<b>Start IP Address - </b>This field specifies the first address in the IP Address pool. 192.168.15.100 is the default start IP address.";
	LanDhcpServerHelpRpm["address_0"]="<B>End IP Address</B> - This field specifies the last address in the IP Address pool. 192.168.15.199 is the default end IP address.";
	LanDhcpServerHelpRpm_AP["address"]="<b>Start IP Address - </b>This field specifies the first address in the IP Address pool. 192.168.15.100 is the default start IP address.";
	LanDhcpServerHelpRpm_AP["address_0"]="<B>End IP Address</B> - This field specifies the last address in the IP Address pool. 192.168.15.199 is the default end IP address.";
}
if(INCLUDE_LAN_WLAN_SAE)
{
	WlanSecurityHelpRpm["personal"]="<B>WPA/WPA2/WPA3 - Personal</B> - Select WPA based on pre-shared passphrase.";
	WlanSecurityHelpRpm["personal_0"]="<B>WPA/WPA2/WPA3 - Personal</B>";
	WlanSecurityHelpRpm["auto"]="<B>WPA/WPA2-Auto</B> - Select <B>WPA-PSK</B> or <B>WPA2-PSK</B> automatically based on the wireless station\'s capability and request.";
}