(function($) {
    $.helpContent = {
        ...
        wirelessAdv: {
            ...
            CONTENT: [{
                type: "name",
                title: "2.4GHz/5GHz Advanced Settings",
        ...
        wirelessSettings: {
            ...
            CONTENT: [{
                type: "name",
                title: "2.4GHz|5GHz",
                content: INCLUDE_LAN_WLAN_DUALBAND == 1 ?"Select 2.4GHz or 5GHz to change the corresponding settings.":"Select 2.4GHz to change the corresponding settings."
            }, {
                type: "name",
                title: "Network Name (SSID)",
        ...
        sysMode: {
            ...
            CONTENT: [{
                ...
                content: INCLUDE_LAN_WLAN_DUALBAND == 1 ?"Enables multi-users to share Internet via xDSL using its xDSL port and share it wirelessly over the crystal clear 5GHz band and the 2.4GHz band.":"Enables multi-users to share Internet via xDSL using its xDSL port and share it wirelessly over the crystal clear 2.4GHz band."
            }, {
                ...
                content: INCLUDE_LAN_WLAN_DUALBAND == 1 ?"Enables multi-users to share Internet via Ethernet WAN (EWAN) using its interchangeable WAN port and share it wirelessly over the crystal clear 5GHz band and the 2.4GHz band.":"Enables multi-users to share Internet via Ethernet WAN (EWAN) using its interchangeable WAN port and share it wirelessly over the crystal clear 2.4GHz band."
            },{
				display: INCLUDE_USB_3G_BACKUP,
                type: "name",
                title: "Wireless Router Mode With 3G/4G Backup",
                content: INCLUDE_LAN_WLAN_DUALBAND == 1 ?"Enables multi-users to share Internet via Ethernet WAN (EWAN) using its interchangeable WAN port and share it wirelessly over the crystal clear 5GHz band and the 2.4GHz band. It will try to share 3G or 4G Internet when EWAN is disconnected":"Enables multi-users to share Internet via Ethernet WAN (EWAN) using its interchangeable WAN port and share it wirelessly over the crystal clear 2.4GHz band. It will try to share 3G or 4G Internet when EWAN is disconnected"
            }]
        },
        ethWan: {
            ...
            },
			{
				...
				type: "name",
				title: "Secondary Connection Addressing Type (Dynamic IP or Static IP)",
				children: [{
					type: "name",
					title: "Dynamic IP",
		...
		basicLte: {
            ...
            CONTENT: [{
                type: "name",
				title: "Mobile Data",
                content: "It is enabled by default. You can disable it to prohibit Internet access."
            },	{
                type: "name",
				title: "Profile Name",
                content: "The name of the profile you've selected."			
            },	{
                type: "name",
				title: "Network Mode",
                content: "The device supports three modes of network connection - Auto, 4G Only, and 3G Only. You can select network mode according to your mobile network standard and the current network condition."
            },	{
                type: "name",
				title: "PDP Type",
                content: "Select the type of your PDP (Packet Data Protocol)."			
            },	{
                type: "name",
				title: "APN",
                content: "Access Point Name, provided by your ISP. You need to set APN only after selecting the static APN type. You are recommended to keep the default value."
            },	{
                type: "name",
				title: "Username/Password",
                content: "Enter the username and password provided by your ISP. These fields are case-sensitive. You are recommended to keep the default value."					
            },	{
                type: "name",
				title: "Authentication Type",
                content: "Some ISPs need a specific authentication type, please confirm it with your ISP or keep the default value.",
				children: [{
                    type: "paragraph",
                    title: "NONE",
                    content: "No any authentication is needed."
                }, {
                    type: "paragraph",
                    title: "PAP",
                    content: "Password Authentication Protocol. This protocol allows the device to establish authentication with the peer using two handshakes. Select this option if the ISP requires this authentication type."
                }, {
                    type: "paragraph",
                    title: "CHAP",
                    content: "Challenge Handshake Authentication Protocol. This protocol allows the device to establish authentication with the peer using three handshakes and checking the peer identity periodically. Select this option if the ISP requires this authentication type."
                }]
			}]
		},
		advanceLte: {
            ...
            CONTENT: [{
                ...
                type: "name",
				title: "Data Roaming",
                content: "It is disabled by default. If disabled, data service is not allowed when roaming. If enabled, data service is allowed when roaming, but may incur significant roaming charges."				
            },	{
                type: "name",
				title: "Profile Name",
                content: "The name of the profile you've selected."			
                ...
                content: "Create a new dial-up profile. Up to 8 profiles can be added."		
			}]
		},
		PINManagement: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "You can configure your PIN code on this page."
            },	{
				type: "name",
				title: "SIM Card Status",
                content: "Shows the status of your SIM card."				
            },	{
				type: "name",
				title: "PIN Lock",
                content: "You can select whether to enable this function or not. Once the PIN Lock function is enabled, every time you start the device with this SIM card inserted, you need to enter the PIN code. But you can go to enable the Auto-unlock PIN function, which could save you this trouble."				
            },	{
				type: "name",
				title: "Auto-unlock PIN",
                content: "When the PIN code is required upon device restarting, it will be validated automatically once. If validation failed, you need to enter the PIN code on the PIN Management page."				
            },	{
				type: "name",
				title: "PIN",
                content: "Personal Identification Number of the SIM card. It consists of 4-8 digits."				
            },	{
				type: "name",
				title: "PUK",
                content: "PIN Unlocked Key. It consists of 8 digits."	
            },	{
				type: "name",
				title: "Remaining Attempts",
                content: "Shows how many attempts are left for you to try entering the PIN or PUK code. You have 3 attempts at most for entering the PIN code and 10 attempts at most for entering the PUK code."	
            }]
		}
    };
})(jQuery);
