(function($){
    ...
    $.su = $.su || {};    $.su.CHAR = {
       LOGIN :{ 
           ...
           PASSWORD_TIPS:"1 ～ 15 文字<br />英字 (A-Z、a-z)<br />数字 (0-9)<br />記号 (スペースを除く)"
},
       INIT :{ 
           PASSWORD:"パスワード",
		...
		TPLOGIN_REDIRECT: {
			USER_NOTE: "お客様へ：",
			REDIRETC_NOTE: "入力されたアドレスは現在TP-Link社製品では使用されておりません。管理画面を開くためにはこちらへアクセスをしてください <a href=\"http://tplinkwifi.net\">tplinkwifi.net</a>。",
       ...
       INDEX :{ 
           ...
           REBOOTING:"再起動中... <br/> 再起動中はいかなる操作もしないでください。",
           MODE_SWITCH:"モード選択",
       ...
       ERROR :{ 
           ...
           "00000083":"ゲートウェイをIPと同じにすることはできません。",
           "00000084":"プライマリ DNSを IPと同じにすることはできません。",
           "00000085":"セカンダリ DNSを IPと同じにすることはできません。",
           "00000086":"プライマリ DNSを セカンダリ DNSと同じにすることはできません。",
           ...
           "00000119":"NAT ブーストは、<a onclick=\"$.su.menu.advanced.goTo('qos');\" src=\"void(0)\">QoS</a> または<a onclick=\"$.su.menu.advanced.goTo('sysstatistics');\" src=\"void(0)\">トラフィック統計</a>のいずれかを有効にすると、無効になります。",
           ...
           "00000153":"追加対象のアドレスは既に存在します。",
           "00000154":"追加対象のアドレスは既に存在します。",
           "00000250":"このフォルダーは存在しません。",
           "00000251":"ダウンロード用のフォルダーを指定してください。",
           "00000252":"ダウンロード フォルダー エラー。",
           "00000253":"USB デバイスが取り外されました。",
           "00000254":"USB デバイスがありません。",
           "00000270":"これ以上ダウンロード タスクを追加できません。",
           "00000273":"ダウンロード タスクは既に存在します。",
           "00000274":"無効な URL のタスクが追加されました。",
           "00004139":"インターネット接続なし",
           "00004140":"要求がタイムアウトしました。インターネット接続を確認してもう一度お試しください。",
           "00004141":"不明なエラー",
           ...
           "00004155":"アカウントが存在しません。",
           "00004156":"クラウド アプリケーションを開始できません。このデバイスを再起動して、あとでもう一度実行してください。",
           "00004157":"クラウド サーバーに接続できません。インターネット接続を確認して、あとでもう一度実行してください。",
           "00004158":"WANポートが接続されていません。",
           "00004159":"インターネット接続が無効です。ご契約のプロバイダーにご連絡いただいた後、再度お試しください。",
           "00004160":"DHCPサーバーから取得したIPアドレスが無効です。WAN接続タイプを確認のうえ、再度お試しください。",
           "00004161":"PPPoE認証が失敗しました。 ユーザー名とパスワードをご確認ください。",
           "00004162":"PPPoEサーバーに接続できませんでした。",
           "00004164":"PPTP認証が失敗しました。ユーザー名とパスワードをご確認ください。",
           "00004165":"PPTPサーバーに接続できませんでした。",
           "00004167":"L2TP認証が失敗しました。ユーザー名とパスワードをご確認ください。",
           "00004168":"L2TPサーバーに接続できませんでした。",
           "00004169":"不明なエラー、後程再度お試しください。",
           "00004170":"WANポートが接続されていません。",
           "00004171":"インターネット接続がありません。",
           "00004172":"接続できませんでした。",
           "00004173":"ユーザー名かパスワードが違います。",
           "00004174":"無効なメールフォーマットです。",
           "00004175":"無効なユーザー名の形式です。",
           "00004176":"メールは既に存在します。",
           "00004177":"アカウント情報にアクセスできません。ページを更新してください。",
           "00004178":"システムエラーです。ページを更新して、もう一度実行してください。",
           ...
           "E5000":"クラウド サーバーに接続できません。",
           "E5001":"誤ったTP-Link ID(メールアドレス)です。 もしくはデバイスがオフラインで管理者 (%email) のみがオフラインアクセスが可能です。",
           "E5002":"誤ったパスワードです。",
       ...
       QUICK_SETUP :{ 
           ...
           WIRELESS_SETTINGS:"ワイヤレス設定",
           PRE_INSTALL_CONF:"ISP コンフィギュレーションの事前インストール",
           SUMMARY:"要約",
           ...
           CITY:"市区町村",
           ISP:"ISP",
           AUTO_MANUAL:"接続の種類を手動で設定してください。",
           CONNECTION2:"セカンダリ接続",
           VPN_SERVER:"VPN サーバー IP/ドメイン名",
       ...
       BASIC_INTERNET :{ 
           ...
           NOTE1:"使用しているインターネット接続タイプがわからない場合は、自動検出を使用するか、インターネット サービス プロバイダー (ISP) に問い合わせてください。",
       ...
       BASIC_WIRELESS :{ 
           ...
           TXBF_MUMIMO:"TxBF,MU-MIMO",
           ENABLE_TXBF_MUMIMO:"TxBF,MU-MIMO を有効にする"
},
       BASIC_USB :{ 
           TITLE:"基本設定",
       ...
       INTERNET :{ 
           ...
           CUSTOM:"カスタム",
           AFTR_NAME:"AFTR 名",
           PPP_SHARE_V6:"IPv4と同じセッションを使用する",
           PPP_SHARE_V4:"IPv6と同じセッションを使用する",
           IPV4_ADDR:"IPv4 アドレス",
       ...
       G3_G4 :{ 
           ...
           PINLOCK_1:"PIN 保護が有効になっています。PIN を入力してください。",
           PINLOCK_2:"SIM/UIM がロックされています。パソコン/ノート PC から PUK コードを入力してロックを解除してください。",
           PINLOCK_3:"PIM が無効です。確認してもう一度実行してください。",
           PINLOCK_4:"PIN が正常に確認されました。",
           PINLOCK_5:"PIN ステータスが不明です。SIM/UIM カードがロック解除されていることを確認してください。",
           PINLOCK_6:"SIM/UIM カードをロック解除できません。パソコン/ノート PC から PUK コードを入力してロック解除してください。",
           PINLOCK_7:"3G/4G USB モデムを識別中...",
       ...
       YANDEX_DNS :{ 
           TITLE:"yandex DNS",
           STATUS:"ステータス",
           ENABLE:"Yandex DNSをすべてのデバイスで有効にする。",
           DISABLE:"無効",
           BASIC:"基本",
           SAFE:"安全",
           CHILD:"子ども",
           GRID_TITLE:"特定のデバイスへのYandex DNSルール",
           ID:"ID",
           MAC:"MAC アドレス",
           CONTROL:"コントロールモード",
           DES:"説明",
       ...
       FIRMWARE :{ 
           ...
           CONFIG_MAY_RESET_NOTE:"このバージョンへのアップグレード後、現在の設定は失われます。",
