 ...
 $.su.CHAR.HELP ={
       STATUS_INTERNET :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "3G/4G モデム ステータス",
                           content: "3G/4G モデムの現在のステータスを表示します。"
                       } ,{                      
                           type: "name",
                           title: "IP アドレス",
                           content: "現在の 3G/4G (インターネット) IP アドレスを表示します。3G/4G ネットワークが検出されない場合、このフィールドはブランクまたは 0.0.0.0 になります。"
                       } ,{                      
                           type: "name",
                           title: "サブネット　マスク",
                           content: "3G/4G IP アドレスに関連付けられているサブネット マスクを表示します。"
                       } ,{                      
                           type: "name",
                           title: "デフォルト ゲートウェイ",
                           content: "デフォルト ゲートウェイ (ルーター) の IP アドレスを表示します。"
                       } ,{                      
                           type: "name",
                           title: "プライマリ DNS/セカンダリ DNS",
                           content: "ISP によって関連付けられた DNS サーバー IP アドレスを表示します。"
                       } ,{                      
                           type: "name",
                           title: "3G/4G モデム信号",
                           content: "現在の 3G /4G ワイヤレス信号強度を表示します。"
                       }]
},
       ...
       children: [{                      
                           ...
                           type: "title",
                            title: "インターネット接続タイプBigPond ケーブル"
                       } ,{                      
                           type: "paragraph",
       ...
       IPTV :{ 
               ...
               CONTENT: [{
                           type: "name",
                           title: "IGMP スヌーピング",
                           content: "IGMP (インターネット グループ管理プロトコル) スヌーピング機能を有効にするにはこれを選択します。"
                       } ,{                      
                           type: "name",
                           title: "IGMP プロキシ",
       ...
       DDNS :{ 
               ...
               CONTENT: [{
                           type: "paragraph",
                           content: "動的DNS(ドメインネームシステム)はあなたに固定ホスト・ドメイン名を動的IPに割り当てることを許可します。この機能はあなたが所有するウェブサイトやFTPサーバーをホストする際にとても便利です。まずはじめに、 www.dydns.com のような動的DNSサービスプロバイダーに登録する必要があります。次に、登録情報を入力してください。"
                       } ,{                      
                           type: "step",
       ...
       content: [ 
                ...
                "3. 動的DNSサービス プロバイダーに登録したドメイン名を入力します。",
                "4. 動的DNSの更新要求を受け取る頻度を選択します。",
                "5.[ログイン]、[保存] をクリックします。"]
} ,{                      
                           type: "note",
                           title: "注：",
                           content: "新たなDDNSアカウントを使用したい場合は、初めにログアウトしてから新たなアカウントでログインしてください。"
                       }]
},
       DYNAMIC_DNS :{ 
               TITLE:"動的 DNS",
       ...
       DOMAIN_NAME_LIST :{ 
               ...
               CONTENT: [{
                           type: "paragraph",
                           content: "このテーブルにはTP-Link IDに登録された動的DNSドメイン名が表示されます。"
                       } ,{                      
                           type: "step",
       ...
       children: [{                      
                           ...
                           type: "name",
                           title: "暗号化",
                           content: "次のセキュリティ暗号化タイプを選択してください:TKIP (Temporal Key Integrity Protocol)、AES (Advanced Encryption Standard)、または自動 (TKIP と AES の両方)。TKIP は 802.11n 仕様ではサポートされていないため、ルーターが 802.11n モードで動作している場合、TKIP 暗号化の使用は推奨されません。TKIP を選択すると、WPS 機能が無効になります。"
                       } ,{                      
                           type: "name",
                           title: "パスワード",
       ...
       MODEM :{ 
               ...
               CONTENT: [{
                           ...
                           type: "paragraph",
                           content: "設定を保存するには [保存] ボタンをクリックします。"
                       }]
},
       MODEM_ADVANCED :{ 
               TITLE:"3G/4G のヘルプ",
               CONTENT: [{
                           ...
                           content: "ISP が DNS サーバー IP アドレスを提供している場合は、このチェック ボックスをオンにして、<strong>プライマリ DNS</strong> とセカンダリ DNS (optional) IP アドレスを以下に入力します。入力しない場合、DNS サーバーは ISP から動的に割り当てられます。"
                       } ,{                      
                           type: "name",
                           title: "プライマリ DNS",
       ...
       children: [{                      
                           ...
                           content: "1 ～ 10 の値を入力して、アクティブ ダウンロードの最大数を設定します。"
                       } ,{                      
                           type: "name",
                           title: "速度制限",
                           ...
                           type: "name",
                           title: "最大アップロード速度",
                           content: "1 ～ 100000 kB/秒の値を入力して、最大アップロード速度を設定します。既定値は　128 です。"
                       } ,{                      
                           type: "name",
                           title: "接続数",
                           content: "最大接続数を指定します。"
       ...
       content: [ 
                "1. [追加] をクリックします。",
                "2.ダウンロードのソース、PC からのトレント、USB または USB からのトレントを選択します。",
                "3.BT のトレントの場所を選択するか、FTP、HTTP、aMule の URL を入力します。  ",
                "4. [OK] をクリックします。",
                "5.aMule の場合、[詳細設定] > [aMule サーバー] で aMule サーバー IP アドレスとポートを指定します。"]
}]
} ,{                      
                           type: "name",
                           title: "ダウンロードを削除するには",
       ...
       PARENTAL_CONTROL :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "保護者による制限",
                           content: "保護者による制限機能を有効にするにはこれをオンにします。"
                       }]
},
       PARENTAL_CONTROL_DEVICES :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "説明",
                           content: "接続されているデバイスの簡単な説明を表示します。"
                       } ,{                      
                           type: "name",
                           title: "ステータス",
       ...
       YANDEX_DNS :{ 
               ...
               CONTENT: [{
                           type: "paragraph",
                           content: "このページでは悪意あるウェブサイトやアダルトサイトへのお子様のアクセスを制限するYandex. DNSフィルタの設定が可能です。すべてのデバイスへ向けた一般的なフィルタ、または各デバイスごと個別のフィルタを設定することができます。"
                       } ,{                      
                           type: "paragraph",
                           content: "Yandex.DNSに関する詳しい情報はdns.yandex.ru をご覧ください。"
                       } ,{                      
                           type: "name",
                           title: "すべてのデバイスにおいてYandex.DNSを有効にする。",
                           content: "ブロックされた DoS 攻撃ソースの IP アドレスと MAC アドレスをリストします。"
                       } ,{                      
                           type: "name",
                           title: "無効",
                           content: "すべてのデバイスにおいていかなるYandex.DNSフィルタも機能しないことを意味します。"
                       } ,{                      
                           type: "name",
                           title: "基本",
                           content: "BasicYandex.DNSフィルタはすべてのデバイスにおいて機能することを意味します。"
                       } ,{                      
                           type: "name",
                           title: "安全",
                           content: "SafeYandex.DNSフィルタはすべてのデバイスにおいて機能することを意味します。"
                       } ,{                      
                           type: "name",
                           title: "子ども",
                           content: "ChildYandex.DNSフィルタはすべてのデバイスにおいて機能することを意味します。"
                       }]
},
       YANDEX_DNS_GRID :{ 
               TITLE:"特定のデバイスに対するYandex.DNSルール",
               CONTENT: [{
                           type: "name",
                           title: "MAC address",
                           content: "Yandex.DNSフィルタが機能しているデバイスのMACアドレスを表示"
                       } ,{                      
                           type: "name",
                           title: "コントロールモード",
                           content: "特定のデバイスを選択したYandex.DNSフィルタを表示"
                       } ,{                      
                           type: "name",
                           title: "説明",
                           content: "デバイスを確認しやすくするための説明を表示"
                       } ,{                      
                           type: "paragraph",
                           content: "特別なデバイスに対する特定のYandex.DNSフィルタを設定するためには、[追加]をクリックしてください。スキャンしたリストから選択するかMACアドレスを手入力をしてください。コントロールモード(基本、セーフ、子ども)を選択して説明をルールに記入してください。"
                       } ,{                      
                           type: "paragraph",
                           content: "エントリを追加や削除する場合は[変更]またはゴミ箱アイコンをクリックしてください。"
                       }]
},
       ACCESS_CONTROL :{ 
               TITLE:"アクセス コントロール",
       ...
       FIRMWARE :{ 
               ...
               CONTENT: [{
                           type: "paragraph",
                           content: "ルーターのファームウェアをアップグレードする前に、<a class=\"link\" href=\"http://www.tp-link.com/en/Support/\" target=\"_blank\">TP-Link サポート</a> ウェブサイトからコンピューターに最新のファームウェア アップデートをダウンロードする必要があります。"
                       } ,{                      
                           type: "step",
       ...
       ADMIN_REMOTE :{ 
               ...
               CONTENT: [{
                           ...
                           content: "ルーターへのアクセスが許可される有効な IP アドレスまたは IP範囲を入力します。"
                       } ,{                      
                           type: "paragraph",
                           content: "[保存] をクリックして、すべての設定を保存してください。"
                       }]
...
{                      
       ...
       SYSTEM_DEBUG_MODE :{ 
               ...
               CONTENT: [{
                           type: "name",
                           title: "デバッグ モード",
                           content: "ルーターの異常状態のログを表示するには、これを有効にします。当社のテクニカル サポートの指示に従ってデバッグする場合のみ、これを使用してください。"
                       }]
},
       OPEN_VPN :{ 
               TITLE:"OpenVPN",
       ...
       BASIC_NETWORK_ROUTER :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "SSID",
                           content: "2.4GHz/5GHz 周波数帯域の現在のワイヤレス ネットワーク名を表示します。"
                       } ,{                      
                           type: "name",
                           title: "チャンネル",
                           content: "ワイヤレス 2.4GHz/5GHz ネットワークがブロードキャストするチャンネルを表示します。"
                       } ,{                      
                           type: "name",
                           title: "MAC",
                           content: "ワイヤレス 2.4GHz/5GHz の現在の MAC アドレスを表示します。"
                       } ,{                      
                           type: "title",
       ...
       BASIC_NETWORK_USB :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "使用可能",
                           content: "接続されている USB ストレージ デバイスの使用可能なストレージ総容量を表示します。"
                       }]
},
       BASIC_INTERNET :{ 
               TITLE:"インターネット",
       ...
       BASIC_WIRELESS :{ 
               ...
               CONTENT: [{
                           type: "name",
                           title: "ワイヤレス ラジオを有効にする",
                           content: "2.4GHz/5GHz ワイヤレス ラジオの周波数を有効にするには、このチェックボックスをオンにします。"
                       } ,{                      
                           type: "name",
                           title: "ネットワーク名 (SSID)",
                           ...
                           type: "name",
                           title: "SSID を非表示にする",
                           content: "Wi-Fi ネットワーク リストで 2.4GHz/5GHz ネットワーク名 (SSID) を非表示にする場合は、このチェック ボックスをオンにします。"
                       } ,{                      
                           type: "name",
                           title: "パスワード",
                           content: "ワイヤレス パスワードを 8 ～ 63 文字の ASCII 文字、あるいは 8 ～ 64 文字の 16 進文字で入力します。このフィールドは大文字小文字が区別されます。"
                       } ,{                      
                           type: "paragraph",
                           content: "[保存] をクリックして、すべての設定を保存してください。"
                       }]
       ...
       BASIC_ACCOUNT_LOGIN :{ 
               ...
               CONTENT: [{
                           type: "paragraph",
                           content: "TP-Linkクラウドサービスはあなたのネットワークのアクセスをリアルタイムで表示します。外出中でもインターネットからアクセスできます。クラウドデバイスとクラウドアカウントをバインドすることを強くお勧めいたします。"
                       }]
},
       ACCOUNT_INFO :{ 
               TITLE:"アカウント情報",
