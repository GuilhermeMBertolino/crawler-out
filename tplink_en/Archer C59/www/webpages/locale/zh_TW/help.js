(function($){
 ...
 $.su.CHAR.HELP ={
       ...
       children: [{                      
                           ...
                           type: "name",
                           title: "俄羅斯",
                           content: "如果您的 ISP 位於俄羅斯，並且已事先確定必要的參數，包括網際網路/IP 電話/IPTV VLAN ID 和優先順序及 LAN (2003/1/2/4) 連接埠功能，則選取這個項目。",
       children: [{                      
                           type: "name",
       ...
       content: [ 
                ...
                "3. 輸入您跟動態DNS服務供應商註冊的網域名稱。",
                "4. 選擇將要傳送動態DNS更新請求的時間間隔。",
                "5. 點選登入並儲存。"]
} ,{                      
                           type: "note",
                           title: "註",
       ...
       content: [ 
                "1. 點選 增加。",
                "2. 選擇下載的來源，是來自於電腦的torrent、來自於USB的torrent或URL。",
                "3. 為BT選擇torrent地點或為FTP、HTTP與aMule輸入URL。",
                "4. 點選確定。",
                "5. 對aMule來說，請在下方「進階 > aMlue伺服器」指定aMule伺服器IP位址與通訊埠。"]
}]
} ,{                      
                           type: "name",
                           title: "刪除下載",
...
{                      
       ...
       content: [ 
                "1. 點選 增加。",
                "2. 輸入使用者名稱和密碼，向 PPTP VPN 伺服器驗證用戶端。",
                "3. 點選 確定。"]
} ,{                      
                           type: "step",
                           title: "修改或刪除已存在的帳號",
