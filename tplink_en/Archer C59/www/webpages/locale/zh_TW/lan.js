(function($){
    ...
    $.su = $.su || {};    $.su.CHAR = {
       LOGIN :{ 
           ...
           USER_CONFLICT_INFO_1:"使用者 %USER% (%MAC%)目前已經登入本路由器。您無法在同時間登入，請稍候再試。",
           ...
           PASSWORD_TIPS:"1-15個字元<br />英文字母(A-Z,a-z)<br />數字(0-9)<br />符號(不包含空格)"
},
       INIT :{ 
           PASSWORD:"密碼",
       ...
       BASIC_WIRELESS :{ 
           ...
           HIDE_SSID:"隱藏 SSID",
           TXBF_MUMIMO:"TxBF,MU-MIMO",
           ENABLE_TXBF_MUMIMO:"啟用 TxBF,MU-MIMO"
},
       BASIC_USB :{ 
           TITLE:"基本設定",
           TITIL_NEW:"磁碟與帳號",
       ...
       FIRMWARE :{ 
           ...
           CONFIG_MAY_RESET_NOTE:"在升級到此版本後，您將會失去目前的設定。",
           CHECK_UPGRADE:"檢查升級"
},
       BACKUP :{ 
           BACKUP:"備份",
       ...
       VPN :{ 
           ...
           INSTALL_NOTE2:"設定 OpenVPN 伺服器參數 (服務類型、服務埠和用戶端存取)，然後按一下「儲存」。同時確定 NAT 設定的外接埠不是服務埠，且 DMZ 已停用。",
