	...
	$.su.CHAR.HELP = {
		STATUS_INTERNET: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "3G/4G Modem Status",
				content: "Displays the current status of the 3G/4G modem."
			},{
				type: "name",
				title: "IP Address",
				content: "Displays the current 3G/4G (Internet) IP Address. This field will be blank or 0.0.0.0 if the 3G/4G network is not detected."
			},{
				type: "name",
				title: "Subnet Mask",
				content: "Displays the subnet mask associated with the 3G/ 4G IP Address."
			},{
				type: "name",
				title: "Default Gateway",
				content: "Displays the IP address of default gateway (your router)."
			},{
				type: "name",
				title: "Primary DNS/Secondary DNS",
				content: "Displays the DNS server IP addresses assigned by your ISP."
			},{
				type: "name",
				title: "3G/4G Modem Signal",
				content: "Displays the current 3G /4G wireless signal strength."
			}]
		},
		...
		STATUS_USB: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "3G/4G Modem Type",
				content: "Displays the type of your 3G/4G USB Modem."
			}]*/
		},
		STATUS_PERFORMANCE: {
			TITLE: "Performance",
		...
		IPTV:{
			...
			CONTENT: [{
					type: "name",
					title: "IGMP Snooping",
					content: "Select to enable the IGMP (Internet Group Management Protocol) Snooping feature."
				},{
					type: "name",
					title: "IGMP Proxy",
		...
		MODEM: {
			...
			CONTENT: [
				...
				},
				{
					type: "name",
					title: "Region",
					content: "Automatically selects and displays your region when the USB modem and SIM card are successfully identified. If not select your region from the drop-down menu."
				},
				{
					type: "name",
					title: "Mobile ISP",
				...
				},
				{
					type: "name",
					title: "SIM/UIM PIN",
					content: "If the SIM/UIM Protection is enabled, enter the PIN code. The SIM/UIM Protection is disabled by default. Please note that if you enter invalid PIN 3 times, the SIM/UIM card will be locked automatically. You can only unlock it by entering the PUK code from your PC/laptop."
				},
				{
					type: "name",
					title: "Message",
					content: "Displays the PIN information of the SIM/UIM card if the PIN Protection is enabled."
				},
				{
					type: "name",
					title: "Set the Dial Number, APN, Username and Password manually",
					content: "If your ISP is not listed in the <strong>Mobile ISP</strong> list, select this checkbox and enter the Dial Number, APN (Access Point Name), Username and Password that are provided by your ISP."
				},
				{
					type: "name",
					title: "Dial Number",
					content: "Enter the Dial Number provided by your ISP."
				},
				{
					type: "name",
					title: "APN",
					content: "Enter the APN (Access Point Name) provided by your ISP."
				},
				{
					type: "name",
					title: "Username/Password",
				...
				{
					type: "paragraph",
					content: "Click the Save button to save your settings."
				}
			]
		},
		MODEM_ADVANCED: {
			...
			CONTENT: [
				...
				},
				{
					...
					content: "Select an authentication type. The default is Auto. Some ISPs require a specific authentication type, please confirm it with your ISP or keep the default settings."
				},
				{
					type: "name",
					title: "Auto",
					content: "If Auto (default), the router automatically determines the authentication type used by your ISP."
				},
				{
					type: "name",
					title: "PAP",
				...
				},
				{
					type: "name",
					title: "MTU Size",
					content: "The default MTU (Maximum Transmission Unit) size is 1480 bytes. Do not change it unless required by your ISP."
				},
				{
					type: "name",
					title: "Use the following DNS Servers",
					content: "If your ISP provides DNS server IP addresses, select this checkbox and enter the <strong>Primary DNS</strong> and Secondary DNS (optional) IP addresses below. Otherwise, the DNS servers will be assigned dynamically by your ISP."
				},
				{
					type: "name",
					title: "Primary DNS",
					content: "Enter the DNS IP address in dotted-decimal notation provided by your ISP."
				},
				{
					type: "name",
					title: "Secondary DNS",
					content: "(Optional) Enter another DNS IP address in dotted-decimal notation provided by your ISP."
				},
				{
					type: "paragraph",
		...
		OFFLINE_DOWNLOAD: {	
				...
				children:[
			{
				...
				content: "Enter a value between 1 and 100000 kB/s to set the maximum upload speed. The default value is 128."
			},{
				type: "name",
		...
		FACTORY: {
			...
			CONTENT: [{
				...
				title: "Note",
				content: [
					"1. Factory Restore will erase all settings that you have configured for the router. ",
		...
		ADMIN_ACCOUNT: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "This page allows you to change your login password, and to set an email address for password recovery."
			},{
				type: "name",
				title: "Old Password",
		...
		ADMIN_RECOVERY: {
			...
			CONTENT: [{
				...
				content: "It is highly recommended that you enable the Password Recovery feature, which will help reset your password via email."
			},{
				type: "name",
				title: "From",
		...
		SYSTEM_DEBUG_MODE:{
			...
			CONTENT: [{
				type: "name",
				title: "Debug Mode",
				content: "This feature allows you to view the router's abnormal state log, please use this only for debugging under the guidance of our Technical Support."
			}]
		},
		OPEN_VPN:{
			TITLE: "OpenVPN",
