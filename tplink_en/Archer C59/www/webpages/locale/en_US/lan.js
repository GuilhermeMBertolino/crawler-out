(function($){
	...
	$.su.CHAR = {
		LOGIN: {
			...
			END: 						".",
			END2: 						"?",
			FORGET_PASSWORD_INFO_0: 	"Press and hold the Reset button for %SECONDS% seconds to restore the router to its factory defaults.",
			...
			FORGET_PASSWORD_NOTE: 		"You can also press and hold the Reset button for %SECONDS% seconds to restore the router to its default username and password (admin/admin).",
			START: 						"Start",
			...
			PASSWORD_TIPS: 				"1-15 characters<br />Alpha characters(A-Z,a-z)<br />Numbers(0-9)<br />Symbols(Excluding Space)"
		},
        INIT: {
			PASSWORD: 					"Password",
		...
		TPLOGIN_REDIRECT: {
			...
			REDIRETC_NOTE: "The address you have entered is no longer being used by TP-Link products. To connect to your web management page, please visit <a href=\"http://tplinkwifi.net\">tplinkwifi.net</a>.",
		...
		OFFLINE_ERROR:{
			...
			NOTE2: "2. The cloud server is inaccessible temporarily. Please refresh the page later.",
		...
		ERROR: {			
			...
			"00000119":					"NAT Boost will be disabled when either <a onclick=\"$.su.menu.advanced.goTo('qos');\" src=\"void(0)\">QoS</a> or <a onclick=\"$.su.menu.advanced.goTo('sysstatistics');\" src=\"void(0)\">Traffic Statistics</a> is enabled.",
			...
			"00000153": 				"The to-be-added address already exists.",
			"00000154": 				"The to-be-added address already exists.",
			"00000250":  				"The folder does not exist.",
			"00000251":  				"Please specify a folder for the downloads.",
			"00000252":  				"Download folder error.",
			"00000253":  				"USB device is unplugged!",
			"00000254":  				"No USB device!",
			"00000270":  				"can't add download task any more.",
			"00000273": 				"The download task already exists.",
			"00000274": 				"Add a task with invalid URL.",
			...
			"00004183":   				"Account should contain characters.",
		...
		QUICK_SETUP: {
			...
			WIRELESS_SETTINGS: 			"Wireless Settings",
			PRE_INSTALL_CONF:			"Pre-Install ISP Config",
			SUMMARY: 					"Summary",
			...
			PRE_INSTALL_CONF: 			"Pre-install ISP config",
			CONNECTION2:				"Secondary Connection",
			VPN_SERVER:					"VPN Server IP/Domain Name",			
		...
		BASIC_INTERNET: {
			...
			NOTE1: 						"If you are not sure about which Internet Connection Type you have, use Auto Detect or contact your Internet Service Provider (ISP) for assistance.",
			NOTE: 						"If you are not sure about which Internet Connection Type you have, contact your Internet Service Provider (ISP) for assistance."
		},
		BASIC_WIRELESS:{
			...
			HIDE_SSID: 					"Hide SSID",
			TXBF_MUMIMO:				"TxBF,MU-MIMO",
			ENABLE_TXBF_MUMIMO:			"Enable TxBF,MU-MIMO"
		},
		BASIC_USB: {
		...
		G3_G4:{
			...
			PINLOCK_1: 					"PIN protection is enabled. Please enter the PIN.",
			PINLOCK_2: 					"The SIM/UIM is locked. Please unlock it by entering the PUK code from your PC/laptop.",
			PINLOCK_3: 					"The PIN is invalid. Please check it and try again.",
			PINLOCK_4: 					"PIN was successfully verified.",
			PINLOCK_5: 					"Unknown PIN status, please ensure that SIM/UIM card is unlocked.",
			PINLOCK_6: 					"Unable to unlock the SIM/UIM card, please unlock it by enterning the PUK code from your PC/laptop.",
			PINLOCK_7: 					"Identifying the 3G/4G USB modem...",
			...
			MAX_IDLE_TIME: 				"Max Idle Time",
			CONNECTION_TIP: 			"The current Internet connection is WAN (preferred).",
			IDLE_TIME_TIP: 				"The Connection Mode and Max Idle Time cannot be set manually.",
			MINUTES: 					"minutes. (0 means the connection is always-on.)",
		...
		FIRMWARE:{
			...
			DO_NOT_OPERATE: 			"Firmware upgrading... <br/> To avoid any damage, please keep the router powered on and do NOT operate the router during the firmware upgrade process.",
			...
			CONFIG_MAY_RESET_NOTE:		"Your current settings will be lost after upgrading to this version.",
