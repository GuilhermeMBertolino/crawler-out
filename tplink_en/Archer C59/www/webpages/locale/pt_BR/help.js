 ...
 $.su.CHAR.HELP ={
       STATUS_INTERNET :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Status do Modem 3G/4G",
                           content: "Mostra o status atual do modem 3G/4G."
                       } ,{                      
                           type: "name",
                           title: "Endereço IP",
                           content: "Mostra o endereço IP 3G/4G atual. Este campo ficará em branco ou como 0.0.0.0 caso a rede 3G/4G não esteja detectada."
                       } ,{                      
                           type: "name",
                           title: "Máscara de Sub-rede",
                           content: "Mostra a máscara de sub-rede associada ao endereço IP 3G/4G."
                       } ,{                      
                           type: "name",
                           title: "Gateway Padrão",
                           content: "Mostra o endereço IP do gateway padrão (seu roteador)"
                       } ,{                      
                           type: "name",
                           title: "DNS Primário/DNS Secundário",
                           content: "Mostra os endereços IP do servidor DNS atribuídos pelo seu provedor."
                       } ,{                      
                           type: "name",
                           title: "Sinal do Modem 3G/4G",
                           content: "Mostra a força do sinal wireless 3G/4G atual."
                       }]
},
       ...
       IPTV :{ 
               ...
               CONTENT: [{
                           type: "name",
                           title: "IGMP Snooping",
                           content: "Selecione para habilitar a função IGMP (Protocolo de Gerenciamento de Grupo de Internet) Snooping."
                       } ,{                      
                           type: "name",
                           title: "IGMP Proxy",
                           ...
                           type: "name",
                           title: "Modo",
                           content: "Selecione o modo apropriado para seu provedor. Há seis modos que suportam IPTV:",
       children: [{                      
                           type: "name",
                           title: "Ponte",
       ...
       children: [{                      
                           ...
                           type: "name",
                           title: "Modo",
                           content: "Selecione o modo transmissão"
                       } ,{                      
                           type: "name",
                           title: "Largura do Canal",
       ...
       GUEST_NETWORK_WIRELESS :{ 
               ...
               CONTENT: [{
                           ...
                           content: "Selecione a senha para intervalo de atualização da sua Rede para Convidado."
                       } ,{                      
                           type: "name",
                           title: "Segurança",
       ...
       MODEM :{ 
               ...
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Região",
                           content: "Automaticamente selecione e exibe sua região quando o modem USB e cartão SIM são identificados com sucesso. Caso contrário, selecione sua região na lista."
                       } ,{                      
                           type: "name",
                           title: "ISP Móvel",
                           ...
                           type: "name",
                           title: "SIM/UIM PIN",
                           content: "Caso a Proteção SIM/UIM esteja habilitada, insira o código PIN. A proteção SIM/UIM é desabilitada por padrão. Atenção, caso você insira um número PIN inválido por 3 vezes, o cartão SIM/UIM será bloqueado automaticamente. Você poderá desbloquear somente inserindo o código PUK do seu PC/laptop."
                       } ,{                      
                           type: "name",
                           title: "Mensagem",
                           content: "Mostra a informação sobre PIN do cartão SIM/UIM caso a Proteção PIN estiver habilitada."
                       } ,{                      
                           type: "name",
                           title: "Configure o Número de Discagem, APN, Nome de Usuário e Senha manualmente",
                           content: "Caso seu provedor não esteja na lista <strong>Provedor Móvel</strong> , selecione esta opção e insira o Número de Discagem, APN (Access Point Name), Nome de Usuário e Senha fornecidos pelo seu provedor."
                       } ,{                      
                           type: "name",
                           title: "Número de Discagem",
                           content: "Insira o Número de Discagem fornecido pelo seu provedor."
                       } ,{                      
                           type: "name",
                           title: "APN",
                           content: "Insira o APN fornecido pelo seu provedor."
                       } ,{                      
                           type: "name",
                           title: "Nome de Usuário/Senha",
                           content: "Insira o nome de Usuário fornecidos pelo provedor. Estes campos são suscetíveis a letras maíuscula se minúsculas."
                       } ,{                      
                           type: "name",
                           ...
                           type: "paragraph",
                           content: "Clique no botão Salvar para gravar as configurações."
                       }]
},
       MODEM_ADVANCED :{ 
               TITLE:"Ajuda 3G/4G",
               CONTENT: [{
                           ...
                           type: "name",
                           title: "Região",
                           content: "Automaticamente selecione e exibe sua região quando o modem USB e cartão SIM são identificados com sucesso. Caso contrário, selecione a região no menu."
                       } ,{                      
                           type: "name",
                           title: "ISP Móvel",
                           content: "Mostra o provedor da rede 3G/4G. Caso não seja detectado, selecione o provedor do menu a seguir. O Número de Discagem e APN padrões serão preenchidos automaticamente."
                           ...
                           content: "Selecione um tipo de autenticação. O padrão é Automático. Alguns provedores exigem um tipo de autenticação específico, favor confirmar com seu provedor ou mantenha as configurações padrões."
                       } ,{                      
                           type: "name",
                           title: "Automático",
                           content: "Caso esteja em Auto (padrão), o roteador automaticamente determina o tipo de autenticação utilizado pelo seu provedor"
                       } ,{                      
                           type: "name",
                           title: "PAP",
                           ...
                           type: "name",
                           title: "Tamanho MTU",
                           content: "O tamanho MTU padrão (Maximum Transmission Unit) é de 1480 bytes. Não altere-o a menos que seja solicitado pelo seu provedor."
                       } ,{                      
                           type: "name",
                           title: "Utilize os servidores DNS a seguir",
                           content: "Caso seu provedor ofereça endereços IP de servidores DNS, selecione esta opção e insira os endereços IP de  <strong>DNS Primário</strong> e DNS Scundário (opcional). Caso contrário, os servidores DNS serão atribuídos dinamixamente pelo seu provedor."
                       } ,{                      
                           type: "name",
                           title: "DNS Primário",
                           content: "Insira o endereço IP DNS na linha decimal pontilhada fornecida pelo seu provedor."
                       } ,{                      
                           type: "name",
                           title: "DNS Secundário",
                           content: "(Opcional) Insira outro endereço IP DNS na linha decimal pontilhada fornecida pelo provedor."
                       } ,{                      
                           type: "paragraph",
                           content: "Clique em <strong>Salvar</strong> para guardar as alterações."
                       }]
},
       DISK_SETTING :{ 
       ...
       children: [{                      
                           ...
                           content: "Caso habilitado, usuários na sua rede poderão acessar o dispositivo de armazenamento USB utilizando um endereço IP atribuído (ex.: \\\\192.168.0.1)."
                       } ,{                      
                           type: "name",
                           title: "FTP",
       ...
       children: [{                      
                           ...
                           content: "Insira um valor entre 1 e 10 para configurar o número máximo de downloads."
                       } ,{                      
                           type: "name",
                           ...
                           content: "Insira um valor entre 1 e 100.000 kB/s para configurar a velocidade máxima de upload. O valor padrão é de 128."
                       } ,{                      
                           type: "name",
                           ...
                           content: "Habilite esta função para melhorar a eficiência de comunicação entre seu grupo de peers e então você poderá aumentar a velocidade de download."
                       } ,{                      
                           type: "name",
       ...
       content: [ 
                "1. Clique em Adicionar.",
                "2. Selecione a fonte do download, torrent do PC, torrent do USB ou URL.",
                "3. Selecione o local do torrent para BT, ou insira o URL para FTP, HTTP e aMule.  ",
                "4. Clique em OK.",
       ...
       content: [ 
                ...
                "3. Selecione sua porta desejada.",
                "4. Clique em OK."]
}]
},
       QOS_DATABASE :{ 
...
{                      
       ...
       SYSTEM_DEBUG_MODE :{ 
               ...
               CONTENT: [{
                           type: "name",
                           title: "Modo Debug",
			   content: "Habilite para visualizar o estado de log anormal do roteador, favor utilizar este somente para debug sob a guia do nosso Suporte Técnico."
                       }]
},
       OPEN_VPN :{ 
               TITLE:"OpenVPN",
       ...
       BASIC_ACCOUNT_LOGIN :{ 
               ...
               CONTENT: [{
                           type: "paragraph",
		           content:"O serviço TP -Link cloud permite monitorar a rede em tempo real, acessar e gerenciar seus dispositivos através da Internet e fornece outros recursos avançados quando você estiver ausente. É altamente recomendável que você faça login e vincule sua conta cloud aos seus dipositivos cloud."
                       }]
},
       ACCOUNT_INFO :{ 
