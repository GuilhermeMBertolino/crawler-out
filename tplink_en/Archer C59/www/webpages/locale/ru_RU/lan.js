(function($){
    ...
    $.su = $.su || {};    $.su.CHAR = {
       LOGIN :{ 
           ...
           USER_CONFLICT_INFO_1:"Пользователь %USER% (%MAC%) на данный момент вошёл в маршрутизатор. Вы не можете войти одновременно с ним. Повторите попытку позднее.",
           ...
           PASSWORD_TIPS:"1-15 символы<br />символы(A-Z,a-z)<br />Цифры(0-9)<br />Символы(не включая пробелы)"
},
       INIT :{ 
           PASSWORD:"Пароль",
           ...
           INIT_NOTE_CONTENT:"Пожалуйста, настройте %PRODUCT% для подключения к Интернет. Для начала, создайте пароль администратора для управления вашим маршрутизатором. "
},
		TPLOGIN_REDIRECT: {
			USER_NOTE: "Уважаемый пользователь:",
			REDIRETC_NOTE: "Указанный вами адрес больше не используется продукцией TP-Link. Для подключения к веб-интерфейсу управления посетите страницу: <a href=\"http://tplinkwifi.net\">tplinkwifi.net</a>.",
       ...
       INDEX :{ 
           ...
           REBOOTING:"Перезагрузка... <br/>Пожалуйста, НЕ производите никаких действий во время выполнения данной операции.",
       ...
       ERROR :{ 
           ...
           "00000046":"IP адрес и МАС адрес не должны содержать НУЛИ. Пожалуйста, введите снова. ",
           ...
           "00000083":"Шлюз не может совпадать с IP адресом.",
           "00000084":"Предпочитаемый DNS-сервер не может совпадать с IP адресом.",
           "00000085":"Альтернативный DNS-сервер не может совпадать с IP адресом.",
           "00000086":"Предпочитаемый DNS-сервер не может совпадать с альтернативным DNS-сервером.",
           ...
           "00000119":"Если функция ускорения NAT отключена, то <a onclick=\"$.su.menu.advanced.goTo('qos');\" src=\"void(0)\">приоритезация данных</a> или <a onclick=\"$.su.menu.advanced.goTo('sysstatistics');\" src=\"void(0)\">Статистика трафика</a> будет включена автоматически.",
           ...
           "00000153":"Адрес, который необходимо добавить, уже существует.",
           "00000154":"Адрес, который необходимо добавить, уже существует.",
           "00000250":"Папка не существует. ",
           "00000251":"Пожалуйста, укажите папку для загрузок. ",
           "00000252":"Ошибка в папке загрузки.",
           "00000253":"USB-устройство не подключено!",
           "00000254":"Нет USB-устройства!",
           "00000270":"задание на загрузку больше не добавляется",
           "00000273":"Задание на загрузку уже существует.",
           "00000274":"Добавить задание с неверным URL.",
           "00004139":"Нет подключения к Интернету",
           "00004140":"Время ожидания запроса истекло. Проверьте подключение к Интернету и повторите попытку позже. ",
           "00004141":"Неизвестная ошибка. ",
           "00004142":"Неверный защитный код.",
           "00004143":"Неверный пароль. ",
           "00004144":"Данное имя пользователя уже существует. ",
           "00004145":"Неверный пароль. ",
           "00004146":"Невозможно отвязать устройство. Повторите попытку позже. ",
           "00004147":"Данное устройство привязано к другому аккаунту. ",
           ...
           "00004151":"Не более 1000 доменных имён могут быть зарегистрированы в одном облачном аккаунте. ",
           "00004152":"Это устройство было привязано к другому доменному имени.",
           "00004153":"Это доменное имя было связано с другим устройством.",
           "00004154":"Нет ответа от сервера. Пожалуйста, повторите попытку позже.",
           "00004155":"Пользователь не существует.",
           "00004156":"Невозможно запустить облачное приложение. Пожалуйста, перезагрузите данное устройство и повторите попытку позже.",
           "00004157":"Невозможно выполнить подключение к облачному приложению. Пожалуйста, проверьте ваше подключение к Интернету и повторите попытку позже.",
           "00004158":"К порту WAN не подключён кабель.",
           "00004159":"Невозможно установить соединение с Интернетом. Обратитесь к Вашему поставщику услуг или повторите попытку позже. ",
           "00004160":"Невозможно получить IP-адрес с DHCP сервера. Проверьте ваш тип соединения WAN или повторите попытку позже. ",
           "00004161":"Ошибка аутентификации PPPoE. Проверьте ваше имя пользователя/пароль. ",
           "00004162":"Невозможно подключиться к PPPoE серверу. ",
           "00004164":"Ошибка аутентификации PPTP. Проверьте ваше имя пользователя/пароль. ",
           "00004165":"Невозможно подключиться к PPTP серверу. ",
           "00004167":"Ошибка аутентификации L2TP. Проверьте ваше имя пользователя/пароль. ",
           "00004168":"Невозможно подключиться к L2TP серверу. ",
           "00004169":"Неизвестная ошибка. Попробуйте попытку позже. ",
           "00004170":"К порту WAN не подключён кабель.",
           "00004171":"Нет подключения к Интернету",
           "00004172":"Не удалось подключиться.",
           "00004173":"Неверное имя пользователя или пароль. ",
           "00004174":"Некорректный формат электронной почты.",
           "00004175":"Неверный формат имени пользователя. ",
           "00004176":"Данная электронная почта уже существует. ",
           "00004177":"Невозможно получить доступ к информации об учётной записи. Обновите страницу. ",
           "00004178":"Системная ошибка. Обновите страницу и повторите попытку позже. ",
           "00004179":"Невозможно выполнить привязку данного устройства. Повторите попытку позже. ",
           "00004180":"Это устройство было отвязано от данного облачного аккаунта. Пожалуйста, войдите в систему под вашим аккаунтом, чтобы привязать устройство к вашему аккаунту.",
           "00004181":"Устройство не в сети. Пожалуйста, проверьте настройки вашего подключения к Интернету.",
           "00004182":"Невозможно отправить электронную почту. Проверьте подключение к Интернету и повторите попытку.",
           "00004183":"Аккаунт должен содержать символы.",
           "00004184":"Вы ввели неправильный пароль 20 раз. Повторите попытку через 2 часа.",
           "00004185":"Вы получали защитный код 10 раз в течение 1 часа. Повторите попытку через 24 часа.",
           "00004186":"К сожалению, не удалось активировать ваш аккаунт. Пожалуйста, повторно отправьте письмо с подтверждением регистрации.",
           "00004187":"К сожалению, ссылка устарела. Пожалуйста, повторно отправьте письмо с подтверждением регистрации.",
           "00004188":"К сожалению, ссылка устарела. Пожалуйста, повторно отправьте письмо.",
           "00004189":"К сожалению, не удалось восстановить ваш пароль. Пожалуйста, повторно отправьте письмо.",
           "00004190":"",
           "00004191":"",
       ...
       QUICK_SETUP :{ 
           ...
           WIRELESS_SETTINGS:"Настройки беспроводного режима",
           PRE_INSTALL_CONF:"Автонастройка подключения к Интернет",
           ...
           CONNECTION2:"Вторичное подключение",
           VPN_SERVER:"IP-адрес/доменное имя VPN-сервера",
       ...
       BASIC_INTERNET :{ 
           ...
           NOTE1:"Если вы не уверены, какой тип подключения к Интернет используется на вашем компьютере, свяжитесь с вашим поставщиком Интернет-услуг и уточните у него эту информацию.",
           NOTE:"Если вы не уверены в типе вашего Интернет-соединения, проконсультируйтесь с вашим поставщиком Интернет-услуг. "
},
       BASIC_WIRELESS :{ 
           ...
           TXBF_MUMIMO:"TxBF,MU-MIMO",
           ENABLE_TXBF_MUMIMO:"Включить TxBF,MU-MIMO"	          
},
       BASIC_USB :{ 
       ...
       INTERNET :{ 
           ...
           AFTR_NAME:"Имя АFTR",
           PPP_SHARE_V6:"Используйте ту же сессию при соединении IPv4",
           PPP_SHARE_V4:"Используйте ту же сессию при соединении IPv6",
       ...
       IPTV :{ 
		...
		UDP_PROXY:"UDP-прокси",
		   UDP_PROXY_PORT:"UDP Proxy порт",
       ...
       DHCP_SERVER :{ 
           ...
           LEASENOTE:"минут (2-2880. По умолчанию: 120)",
       ...
       G3_G4 :{ 
           ...
           PINLOCK_1:"Включена защита с помощью PIN. Введите Ваш PIN.",
           PINLOCK_2:"SIM/UIM карта заблокирована. Введите Ваш PUK-код на вашем компьютере/ноутбуке для разблокировки.",
           PINLOCK_3:"Неверный PIN-код. Проверьте его и повторите попытку.",
           PINLOCK_4:"PIN был успешно проверен. ",
           PINLOCK_5:"Неизвестный статус PIN, удостоверьтесь, что SIM/UIM карта разблокирована.",
           PINLOCK_6:"Разблокировка SIM/UIM карта невозможна, пожалуйста, введите PUK-код на Вашем компьютере/ноутбуке.",
       ...
       OFFLINE_DOWNLOAD :{ 
           ...
           SCHEDULE:"Расписание ",
           MAXACTIVE:"Максимальное число активных загрузок",
           MAXACTIVENUM:"(1-10)",
           ...
           SPEEDTIPS:"(без ограничений.) ",
           BTPORT:"Порт для загрузки BT ",
           SEED:"Продолжить загрузку после выполнения задачи",
           UNIT:"KB/s",
           MODIFY:"Изменить",
           PC:"PC",
           USB:"USB",
           ...
           NUM_OF_CON_PT:"Максимальное количество присоединенных пиров через торрент ",
       ...
       FIRMWARE :{ 
           ...
           LOCAL_TITLE:"Обновление вручную",
           ...
           CONFIG_MAY_RESET_NOTE:"Ваши текущие настройки будут утеряны после обновления до данной версии. ",
       ...
       BACKUP :{ 
           ...
           RESTORE_WARN:"Сброс настроек маршрутизатора... <br/>Пожалуйста, НЕ производите никаких действий во время выполнения данной операции.",
           RESTORE_CONFIRM_CONTENT:"Восстановить настройки из резервного файла?",
           FILE:"Файл",
           FACTORY:"Заводские настройки",
           FACTORYTIP:"Выполните сброс всех настроек к заводским значениям. ",
           ...
           FACTORY_WARN:"Сброс настроек маршрутизатора... <br/>Пожалуйста, НЕ производите никаких действий во время выполнения данной операции.",
       ...
       SYSPARA :{ 
           ...
           GROUPUNIT:"секунд",
           MU_MIMO_FEATURE:"Многопользовательский MIMO",
           MU_MIMO:"Включить МU-MIMO",
           WMM_FEATURE:"WMM",
           WMM:"Включить WMM",
           GI_FEATURE:"Short GI",
       ...
       VPN :{ 
           ...
           INSTALL_NOTE2:"Настройте параметры сервера OpenVPN (Тип сервиса, сервисный порт и клиентский доступ) и нажмите Сохранить. Убедитесь, что Вы не используете зарезервированные (сервисные) порты в настройках NAT, а также, что функция DMZ выключена. ",
