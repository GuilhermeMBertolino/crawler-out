	...
	create: function(defaults, options){
		...
		me.each(function(i, obj){
			...
			if (!viewOnly){
				...
				inHTML +=					"</div>";
				inHTML +=					"<div class=\"button-container inline\">";
				inHTML +=						"<button type=\"button\" class=\"button-button btn-msg btn-msg-clear\"><span class=\"button-button-before\"></span><span class=\"text button-text\">" +$.su.CHAR.OPERATION.CLEAR+ "</span></button>";
				inHTML +=					"</div>";
				inHTML +=					"<div class=\"button-container inline\">";
