...
function ddns_get_device_number()
	local req = {}
	req.params = {}

	req.method = "getDeviceNumber"
	req.params.cloudUserName = uci_r:get("cloud_config", "login", "username")
	...
	if data.error_code ~=  0 then return data.error_code end
	
	return data.result.deviceNum
end
