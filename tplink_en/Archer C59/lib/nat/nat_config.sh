...
NAT_FILTER_VPN_CHAINS="zone_lan_natfd_vpn"
NAT_FILTER_VS_CHAINS="zone_lan_natfd_vs zone_wan_natfd_vs"
NAT_FILTER_DMZ_CHAINS="zone_lan_natfd_dmz zone_wan_natfd_dmz"
NAT_FILTER_PT_CHAINS="forwarding_rule_pt"

NAT_FILTER_CHAINS="$NAT_FILTER_VPN_CHAINS $NAT_FILTER_VS_CHAINS $NAT_FILTER_DMZ_CHAINS $NAT_FILTER_PT_CHAINS"
...
nat_config_default() {
    ...
    export "nat_filter_vpn_chains"="$NAT_FILTER_VPN_CHAINS"
    export "nat_filter_vs_chains"="$NAT_FILTER_VS_CHAINS"
    export "nat_filter_dmz_chains"="$NAT_FILTER_DMZ_CHAINS"
    export "nat_filter_pt_chains"="$NAT_FILTER_PT_CHAINS"
