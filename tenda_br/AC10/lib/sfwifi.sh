...
load_firmware()
{
    cmd="/sbin/insmod /lib/modules/startcore.ko"
    eval $cmd
}
...
insmod_rf_ate() {
    cmd="/sbin/insmod /lib/modules/sf16a18_rf.ko thermal_on=1"
    eval $cmd
    sleep 1
}
...
insmod_fmac_lb(){
    insmod_umac /lib/modules/sf16a18_fmac.ko lb
}

insmod_fmac_hb(){
    insmod_umac /lib/modules/sf16a18_fmac.ko hb
}
...
#    eval $cmd
    /sbin/rmmod sf16a18_lb_fmac\"
}

unload_fmac_hb(){
#    cmd="/sbin/rmmod sf16a18_hb_fmac\" "
#    eval $cmd
    /sbin/rmmod sf16a18_hb_fmac\"
}
