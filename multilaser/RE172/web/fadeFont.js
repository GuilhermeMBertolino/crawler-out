...
var qiksearch_ticker_text = new Array ("RE172");
...
function writeDiv()
{
	...
	if(!qiksearch_tickerObj)
		return;
  qiksearch_tickerObj.innerHTML= '<font face="verdana,arial,helvetica" size="2" color="#FFFFFF"><b>' + qiksearch_ticker_text[div_count] +  '</b>' ;
