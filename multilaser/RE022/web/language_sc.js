...
var upload_wait = '请等待...';
var msg_need_50="设备已重启大约需要50秒！";
var msg_upload_err1="软件升级失败！";
var msg_upload_err2="升级失败！";
var msg_file_format_err1="非法的文件格式！";
var msg_file_format_err2="无效的文件格式！请上传系统升级软件！";
var msg_file_big_err="升级软件过大！";
var msg_file_check_err="升级软件校验失败！";
var msg_up_success="上传成功！";
var msg_updating="软件正在升级。";
var msg_not_close_ap="在此期间不要关闭或重启路由器。";
...
/***********	wlbasic.htm	************/
var wlbasic_header_for_double="无线配置-wlan"
...
var util_gw_array45 = "(GMT+05:30)科伦坡";
var util_gw_array46 = "(GMT+06:00)阿斯塔纳、阿拉木图、达卡";
...
var wlmeshACL_mode_allow='允许'
var wlmeshACL_mode_deny='拒绝'
...
/*************   preset.htm     *****************/
var preset_explain = '此页面允许您将默认配置文件作为默认设置保存或重新加载到设备'
var preset_title = '保存/重新加载默认设置'
var preset_tab1 = '保存默认文件配置'
var preset_tab2 = '加载默认文件配置'

var guide_intall_guide="安装指南"
var guide_auto_detect="自动检测"
var wifi_Band_steering = '双频合一';
var on = "开"
var off = "关"
var install_bandsteering_on_info = "打开双频合一后，5G网络将与2.4G网络集成，创建单个SSID。"
var install_2g='2.4G 无线网络设置';
var install_ssid='SSID:';
var install_password='密码:';
var install_5g='5G 无线网络设置';
var guide_prev="上一步"
var install_save='保存并应用';
var guide_next="下一步"
var menu_title ='AP';
var input_password='输入密码（在设备背面）'
var login_in='登录';

var input_password='请输入密码（密码位于设备背面）';
var input_user_name='请输入用户名称';
var input_user_password='请输入用户密码';
var name_password_err='用户名密码错误';
var login_err_too_much_times='错误：您已成功登录三次，请等待一分钟，然后重试。如果您忘记了密码，请按重置几秒钟以恢复出厂设置。';
var web_access =  '访问用户的限制性设置（ 允许|拒绝）'

var menu_mirror = '镜像配置'
var source = "源"
var destination = "目标"
var quickSetup_menu = "快速设置"

/***********  install ************/
var install_header= "快速设置";
var install_header_explain= "本页面用来进行快速设置。";
var install_apply = '应用';
var install_ppp_user_name_cannot_be_empty = 'PPP账号不能为空！';
var install_ppp_password_cannot_be_empty = 'PPP密码不能为空！';
var install_cannot_accept_space_character_in_ppp_user_name = 'PPP账号不能有空格。';
var install_cannot_accept_space_character_in_ppp_password = 'PPP密码不能有空格。';
var install_ssid_cannot_be_empty = '无线名称不能为空！';
var install_ssid_length_should_be_maximum_32_octets = '无线名称长度最大应为32个八位字节。';
var install_invalid_password = '无效的密码！';
var install_wan = '广域网设置';
var install_wan_access_type = '上网方式:';
var install_wan_user = '用户名称:';
var install_wan_password = '密码:';
var install_ip_address = 'IP地址';
var install_gateway_address = '网关地址';
var install_subnet_mask = '子网掩码';
var install_primary_dns_server = '主DNS服务器';
var install_dual_control = '双频合一:';
var install_dual_control_explain = '启用频带控制后，2.4G和5G频带将被集成，从而创建单个SSID.'
var install_open = '开启';
var install_close = '关闭';
var install_wifi_setting = '无线设置';
var install_wifi_ssid = '无线名称:';
var install_wifi_password = '无线密码:';
var install_2g = '2.4G无线设置';
var install_5g = '5G无线设置';
var install_sync_2g = '与2.4G配置同步:';
var install_DHCP_desc = '有线/DSL/宽带连接使您的设备立即联机，无需任何配置或注册。'
var install_static_ip_desc = '您将收到ISP提供的IP参数。'
var install_pppoE_desc = '对于ADSL调制解调器，您将收到ISP提供的PPPoE用户和密码。'

var install_pppoe_on_info = "通常用于ADSL调制解调器，您的ISP为您提供PPPoE用户名和密码。"
var install_bandsteering_on_info = "打开频段控制后，5G网络将与2.4G网络集成，创建单个SSID。"
var install_dhcp_on_info = "对于电缆/ DSL /宽带连接，使您的计算机立即在线，无需任何设置或登录。"
var install_staticip_on_info = "您的 ISP 为您提供了指定的 IP 参数。"
var guide_detect_mode_dhcp="检测到 DHCP"
var guide_detect_mode_pppoe="检测到 PPPoE"
var guide_detect_mode_unplugged="广域网端口已拔出"
var guide_detect_mode_detecting="检测中"
var skip_the_wizard = '跳过向导'

var password_level_weak = '弱';
var password_level_middle = '中等';
var password_level_powerful = '强';

var versionStr = "主版本";
var subversionStr = "子版本";
var compileStr = "编译版本";
var binStr = "固件名";
var msg_request_fail = '请求失败';
var menu_timeout = '网络请求超时';
var menu_telnet_start = 'telnet已开启！';
var menu_telnet_close = 'telnet已关闭！';
var password_user_err = '用户名必须为1-15位ASCII可见字符';
var password_pass_err = '密码长度必须为8-31位ASCII可见字符';
var scheduled_restart = '定时重启'

/***********  scheduled_restart.htm ************/
var scheduled_restart="定时重启"
var scheduled_restart_open="开启"
var scheduled_restart_close="关闭"
var scheduled_restart_duplicate = '重复'
var scheduled_restart_time = '重复'
var Monday = "星期一"
var Tuesday = "星期二"
var Wednesday = "星期三"
var Thursday = "星期四"
...
var Saturday = "星期六"
var Sunday = "星期天"
var scheduleRestartSetErr="设置错误"
var scheduled_restart_save='保存'
var scheduled_restart_save_apply='保存&生效'

/*********** Guest Network ************/
var wlguest_ssid_cannot_be_empty = '无线名称不能为空！';
var wlguest_ssid_length_should_be_maximum_32_octets = '无线名称长度最大应为32个八位字节。';
var wlguest_invalid_password = '无效的密码！';
var wlguest_wlan_guest = '访客网络';
var wlguest_install_ssid = '无线名称:';
var wlguest_install_password = '无线密码:';
var wlguest_apply_changes = '应用';
var wlguest_enabled = '开启';
var wlguest_disabled = '关闭';
var wlguest_page_desc_install = '本页面用来进行快速设置。';
var wlguest_ssid_same_as_root_2g = '设置失败！访客网络的名称不能与主无线名称相同';
var wlguest_ssid_same_as_root_5g = '设置失败！访客网络的名称不能与主无线5G名称相同';
var wlguest_psk_same_as_root_2g = '设置失败！访客网络的密码不能与主无线2G密码相同';
var wlguest_psk_same_as_root_5g = '设置失败！访客网络的密码不能与主无线5G密码相同';
var menu_guest_network='访客网络'
var menu_wireless_setting='无线设置'
var guest_save='保存'
var guest_save_apply='保存&生效'
var guest_explain='访客网络设置'
var guest_enable='启用：'
var guest_yes='是'
var guest_no='否'
var guest_band='信道：'
...
var guest_5g='5G'
var guest_both='同时'
var guest_2g_ssid='2.4G无线名称：'
var guest_5g_ssid='5G无线名称：'
var guest_password='密码：'
var guest_speed='限速：'
var guest_speed_desc='mpbs 0：不限速'
var guest_available='开放时间：'
var guest_available_hours='小时'
var guest_available_days='天'
var guest_available_always='始终'
var guest_hour_time='小时后，访客网络将关闭。'
var guest_day_time='天后，访客网络将关闭。'
var guest_speed_notint='无效的输入! 必须为整数，范围0-10000。'
var guest_time_notint1='无效的输入! 必须为整数，范围1-1000。'
var guest_time_notint2='无效的输入! 必须为整数，范围1-100。'
var guest_qrcode_desc='提示：生成无线网络二维码，扫描即可获取wifi账号密码，复制黏贴即可连接网络。部分安卓手机软件扫描后便可直接连接wifi'

var wlsecurity_no_chinese='无线密码长度必须为8-63位ASCII可见字符.';
var wlsecurity_no_chinese1='加密密钥必须为ASCII可见字符.';
var wlsecurity_no_chinese2='无线密码不能含<\/script>.';

/***********  parent_control ************/
var menu_parent_control='家长控制'
var menu_parent_control_setting='家长控制设置'
var parent_control_explain='家长控制设置'
var parent_save='保存&生效'
var parent_enable='启动家长控制'
var parent_rule_name='规则名称'
var parent_mac_address='MAC 地址'
var parent_day='日期'
var parent_day0='星期一'
var parent_day1='星期二'
var parent_day2='星期三'
...
var parent_day5='星期六'
var parent_day6='星期日'
var parent_time='开始结束时间'
var parent_blocking_type='过滤类型'
var parent_allow_all='自由上网'
var parent_deny_all='不能上网'
var parent_allow_url='白名单'
var parent_deny_url='黑名单'
var parent_url='网址'
var parent_enable_rule='状态'
var parent_rule_table='家长控制条目'
var parent_edit='编辑'
var portfw_select='选择'
var parent_delete_selected='删除选中项'
var parent_delete_all='删除所有'
var parent_weekday_not_select='日期未选择。'
var parent_blocking_url_null='过滤网址不能为空，最少一条。'
var parent_start_end_time_null='开始结束时间不能为空。'
var parent_start_time_wrong='开始时间格式错误。'
var parent_end_time_wrong='结束时间格式错误。'
var parent_start_greater_than_end_time='开始时间不能大于结束时间。'
var parent_yes='生效'
var parent_no='不生效'
var menu_mac_group_setting='MAC组设置'
var parent_blocking_url_invalid='错误符号: \";\"';
var parent_blocking_mac_null='MAC地址不能为空，最少一条。'
var parent_blocking_group_name_null='组名不能为空。'
var macgroup_header='MAC组设置'
var macgroup_header_explain='本页面设置MAC地址组，用于家长控制页面MAC组的选择。'
var parent_group_name='组名'
var parent_mac_address='MAC地址'
var parent_group_table='MAC组条目'
var parent_group='MAC组'
var parent_single_mac='单个MAC地址'

/***********	parent_control.htm	************/
var parentCtr_rulename_length = '规则名字长度太长！';
var parentCtr_macaddr_no = '请设置mac地址！';
var parentCtr_macaddr_invalid = 'mac地址无效！';
var parentCtr_weekdays_no = '请设置星期！';
var parentCtr_time_no = '请设置时间！';
var parentCtr_time_invalid = '无效时间！';
var parentCtr_url_invalid = '无效的url！';
var parentCtr_url_exist = '同一规则中存在相同的url！';
var parentCtr_url_type = '请设置url过滤类型！';
var parentCtr_url_repeat = '规则重复！';
var parentCtr_url_conflict = '与已有规则冲突！';
var parentCtr_entry_full = '条目已满！添加失败！';

var portfw_operation = '操作'

var password_conflict_old = '设置失败：新密码与旧密码相同';
var password_user_restrictive_setup = '普通用户的权限设置'
var password_user_account_management = '用户账户设置'
var password_admin_account_management = '管理员账户设置'
var ssid_contains_spaces_continue_saving = '无线名称中含有空格，且无线名称开头和结尾处空格会自动去除，是否继续保存？';
var ssid_cannot_be_all_spaces = '无线名称不能全为空格，请重新输入！';
var upgrade_success = '升级成功'
var device_reboot ='设备重启'
var factory_reset_config = "恢复至出厂配置"
var back_to = '< 返回'
var wladv_wall = '穿墙模式'
var wladv_standard = '标准模式'
var wladv_green = '节能模式'
var enable_wizard = '启用向导'
var enable_wizard_title = '重置为出厂时显示指南页面'

var menu_defsettings="默认配置"
var dns_master="首选DNS服务器"
var dns_slave="备用DNS服务器"

/***********  Iptv ************/
var menu_iptv_settings='IPTV设置';
var iptv_header='IPTV设置'
var iptv_enable='IPTV网络'
var iptv_default_vlan_id='(默认为102)'
var iptv_lan_port='LAN接口'
var iptv_lan_port1='网口1'
var iptv_lan_port2='网口2'
var iptv_lan_port3='网口3'
var iptv_lan_port4='网口4(WAN)'
var iptv_vlan_id='VLAN-ID[1-4094]'
var iptv_save='保存'
var iptv_apply='保存&生效'
var iptv_reset='重置'
var iptv_vlan_id_null_alert='请输入VLAN ID'
var iptv_vlan_id_error_alert='VLAN ID不能为8或9'
var iptv_vlan_id_range_alert='VLAN ID的范围为2-4094'
var wlsec_save_apply  = "保存&应用"
var wps_explain = "此页面允许你开始PBC功能"
var WIFI_setting = "无线5G/无线2.4G"
var device_reboot_explan = "重启启动路由器"
var menu_ipv6_lan='IPv6局域网设置';
var menu_ipv6_wan='IPv6广域网设置';
var menu_radvd="Radvd"
var mode_route="路由"
var super_old_password="旧密码"
var urlfilter_select_to_delete="请选择要删除的规则。"

var easyMesh_header = "EasyMesh常规设置"
var easyMesh_explan = "此页面用于配置接入点的 EasyMesh 功能的参数。"
var easyMesh_controller = "控制器"
var easyMesh_agent = "代理"
var easyMesh_disabled = "禁用"
var easyMesh_role = "角色"
var easyMesh_topology_header = "EasyMesh网络拓扑"
var easyMesh_topology_explan = "此页面显示 EasyMesh 网络的拓扑"
var easyMesh_topology_title = "网络拓扑"
var easyMesh_message1 = "设备名称不能为空。"
var easyMesh_message2 = "设备名称应小于或等于 32 个字符。"
var easyMesh_message3 = "某些接口未启用 11k 或/和 11v，单击“确定”启用并继续"
var easyMesh_message4 = "您的安全设置有问题。\n请注意，EasyMesh仅支持带有PSK的WPA2。\n请确保安全类型为 WPA2，密码不为空。"
var easyMesh_message5 =  "警告：WLAN1 和/或 Wlan2 的 VAP1 将被自动管理。 \n单击“确定”继续。"
var easymesh_refresh = "刷新"
var easyMesh_topology_detail = "展示详情"
var easyMesh_detail_header = "EasyMesh 设备详细信息表"
var easyMesh_detail_explan = "此表显示网络中单个 EasyMesh 设备的详细信息、子邻居列表和关联的工作站列表"

var wlsch_time_repeat = "配置时间存在重叠"

var topology_go_to_detail='点击可查看详情'

/***********	macgroup.htm	************/
var mac_group_name_empty = '组名不允许为空！';
var mac_group_name_length = '组名长度太长！';
var mac_group_same_macaddr = '同一组中存在相同的mac地址！';
var mac_group_name_exist = '组名已存在！';
var mac_group_entry_full = '条目已满，添加失败！';
var filtering_policy = '过滤策略'
var filtering_policy_msg = '修改过滤策略会清空之前的mac过滤表'

var menu_arp_list='客户列表';
var customer_client_explain = '下表显示每个客户的MAC地址与IP地址。'

/***********	lan_port_status.htm ************/
var lan_port_status = '局域网端口状态';
var lan_port_this_page_shows_the_current_lan_port_status = '本页面显示当前局域网端口状态。';
var lan_port_refresh = '刷新';
var lan_port_title = '网口'
var lan_connected_title = '连接状态'
var lan_mode_title = '模式'
var lan_speed_title = '速率'
var lan_port_connected = '已连接';
var lan_port_not_connected = '未连接';
var lan_port_full = '全双工';
var lan_port_half = '半双工';
var wlan_scheduled_message = "当前处于wifi定时范围时间内，请先关闭定时开关"
var reboot_confirm_alert = "确认重启设备？"
var white_macfilter_alert = "当前白名单列表为空，请至少添加一条数据"
var tr069_interval_size_limit = "定期通知间隔最大为 2147483647"
var least_select_one = "至少选择一项"
var parentCtr_def_policy = "全局默认缺省策略"
var firewall_delete_alert_message = "白名单模式下不允许清空所有规则,请先关闭mac过滤"

var remote_mangement_menu = "远程管理"
var remote_mangement_desc = "远程访问相关配置修改"
var remote_login = "远程登录"
var remote_port = "外部端口"
var illegal_number = '重复次数:';
var diagnostic_times = '次';
var interface_selection = '接口选择:';
var destination_address = '目标地址:';
var diagnostic_go = '执行';
var illegal_destination_address = '目标地址非法！请重新输入！';
var illegal_number_of_repetitions = '重复次数非法！请重新输入！';

var online_upgrade_menu = '在线升级'
var online_upgrade_des = '此页面可进行在线版本检测与升级'
var check_version = "检查版本"
var online_upgrade_msg1 = '升级中，请等待'
var online_upgrade_msg2 = '最新版本号为: '
var online_upgrade_err1 = '升级失败，请重试'
var online_upgrade_err2 = '下载错误，请重试'
var online_upgrade_err3 = '获取最新版本错误，请重试'
var online_upgrade_err4 = '已是最新的版本'
var online_upgrade_err5 = '获取最新版本超时，请重试'

var repeater_message_1 = "当前中继频段为5GHZ,如需中继2.4GHZ,请前往(模式设置)修改中继频段，是否继续？"
var repeater_message_2 = "当前中继频段为2.4GHZ,如需中继5GHZ,请前往(模式设置)修改中继频段，是否继续？"
