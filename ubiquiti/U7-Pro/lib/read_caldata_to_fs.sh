    ...
    case "$board" in
	    ...
	    ;;
            ...
            ap-mp03.1-*)
                    ...
                    FILESIZE=131072
                    dd if=${mtdblock} of=/lib/firmware/IPQ5018/caldata.bin bs=1 count=$FILESIZE skip=4096       # IPQ5018 2.4G
                    dd if=${mtdblock} of=/lib/firmware/qcn9000/caldata_1.bin bs=1 count=$FILESIZE skip=157696   # QCN9000 5G
            ;;
            ap-mp03.1 | ap-mp03.3* | ap-mp03.4*)
                    ...
                    dd if=${mtdblock} of=/lib/firmware/IPQ5018/caldata.bin bs=1 count=$FILESIZE skip=4096       # IPQ5018 2.4G
                    dd if=${mtdblock} of=/lib/firmware/qcn9000/caldata_1.bin bs=1 count=$FILESIZE skip=157696   # QCN9000 5G
                    dd if=${mtdblock} of=/lib/firmware/qcn9000/caldata_2.bin bs=1 count=$FILESIZE skip=311296   # QCN9000 6G
            ;;
            ap-mp03.5-*)
                    [ -f /lib/firmware/IPQ5018/caldata.bin ] && exit 1;
                    FILESIZE=131072
                    dd if=${mtdblock} of=/lib/firmware/IPQ5018/caldata.bin bs=1 count=$FILESIZE skip=4096      # IPQ5018 2.4G
                    dd if=${mtdblock} of=/lib/firmware/qcn6122/caldata_1.bin bs=1 count=$FILESIZE skip=157696  # QCN6122 5G
                    ln -s /lib/firmware/qcn6122/caldata_1.bin /lib/firmware/qcn6122/caldata_2.bin
            ;;
            ap-dk0*)
                    [ -f /tmp/wifi0.caldata ] && exit 1;
            ...
            ap-mi01.6-qcn9160-c1)
                    ...
                    cp ${apdk}/qcn9224/caldata_2.bin /lib/firmware/qcn9224/caldata_2.bin
                    cp ${apdk}/qcn9224/caldata_3.bin /lib/firmware/qcn9224/caldata_3.bin
                    echo "====generate caldata done=====" >/dev/kmsg
            ;;
