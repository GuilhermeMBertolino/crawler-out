...
var mssid_2_wep_key = '<% getCfgGeneral(1, "Key1Str2"); %>';
var mssid_2_wpa_key = '<% getCfgGeneral(1, "WPAPSK2"); %>';
var mssid_3_wep_key = '<% getCfgGeneral(1, "Key1Str3"); %>';
var mssid_3_wpa_key = '<% getCfgGeneral(1, "WPAPSK3"); %>';
...
{
	var flag = eval(location.href.split("#")[1]);//get opener flag value
	if (flag == 1) {
		document.getElementById("mssid").innerHTML = mssid2;	
		document.security_form.set_mssid_index.value = 2;	
		
		if (encryp_type.split(";")[1] == "NONE")
			document.security_form.security_mode.selectedIndex = 0;
		else if (encryp_type.split(";")[1] == "WEP") {
			document.security_form.security_mode.selectedIndex = 1;
			document.security_form.WEPSelect.value = wep_key_type.split(";")[1];
			document.security_form.wep_key.value = mssid_2_wep_key;
		}
		else {
			if (security_mode.split(";")[1] == "WPAPSK")
				document.security_form.security_mode.selectedIndex = 2;
			else if (security_mode.split(";")[1] == "WPA2PSK")
				document.security_form.security_mode.selectedIndex = 3;
			else if (security_mode.split(";")[1] == "WPAPSKWPA2PSK")
				document.security_form.security_mode.selectedIndex = 4;
				
			if (encryp_type.split(";")[1] == "TKIP")
				document.security_form.cipher[0].checked = true;
			else if (encryp_type.split(";")[1] == "AES")
				document.security_form.cipher[1].checked = true;
			else if (encryp_type.split(";")[1] == "TKIPAES")
				document.security_form.cipher[2].checked = true;
				
			document.security_form.passphrase.value = mssid_2_wpa_key;
			document.security_form.keyRenewalInterval.value = key_interval.split(";")[1];
		}
	}
	else if (flag == 2) {
		document.getElementById("mssid").innerHTML = mssid3;
		document.security_form.set_mssid_index.value = 3;	
		
		if (encryp_type.split(";")[2] == "NONE")
			document.security_form.security_mode.selectedIndex = 0;
		else if (encryp_type.split(";")[2] == "WEP") {
			document.security_form.security_mode.selectedIndex = 1;
			document.security_form.WEPSelect.value = wep_key_type.split(";")[2];
			document.security_form.wep_key.value = mssid_3_wep_key;
		}
		else {
			if (security_mode.split(";")[2] == "WPAPSK")
				document.security_form.security_mode.selectedIndex = 2;
			else if (security_mode.split(";")[2] == "WPA2PSK")
				document.security_form.security_mode.selectedIndex = 3;
			else if (security_mode.split(";")[2] == "WPAPSKWPA2PSK")
				document.security_form.security_mode.selectedIndex = 4;
				
			if (encryp_type.split(";")[2] == "TKIP")
				document.security_form.cipher[0].checked = true;
			else if (encryp_type.split(";")[2] == "AES")
				document.security_form.cipher[1].checked = true;
			else if (encryp_type.split(";")[2] == "TKIPAES")
				document.security_form.cipher[2].checked = true;
				
			document.security_form.passphrase.value = mssid_3_wpa_key;
			document.security_form.keyRenewalInterval.value = key_interval.split(";")[2];
		}
	}
	else {
		document.security_form.set_mssid_index.value = 1;
	}
	
	onWEPSelect();
	securityMode();
	
	document.security_form.security_mode1.value = security_mode.split(";")[0];
	document.security_form.encryp_type1.value = encryp_type.split(";")[0];
	document.security_form.default_key_id1.value = default_key_id.split(";")[0];
	document.security_form.WEPSelect1.value = wep_key_type.split(";")[0];
	document.security_form.keyRenewalInterval1.value = key_interval.split(";")[0];
...
<input type="hidden" name="multi_flag" value="1">
<input type="hidden" name="set_mssid_index">
<input type="hidden" name="security_mode1">
<input type="hidden" name="encryp_type1">
<input type="hidden" name="default_key_id1">
<input type="hidden" name="WEPSelect1">
<input type="hidden" name="keyRenewalInterval1">
...
<option value="WEP"><script>dw("WEP")</script></option>
...
<td><input name="wep_key" maxlength="26"> <select name="WEPSelect" onChange="onWEPSelect()"> 
...
<td><input name="passphrase" maxlength="64"></td>
</tr>
