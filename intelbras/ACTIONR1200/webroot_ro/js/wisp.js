...
function disableAP() {
	var className = $("#disableAP").attr("class");

	if (className == "btn-off") {
		$("#disableAP").attr("class", "btn-on");
		$("#disableAP").val(1);
	} else {
		$("#disableAP").attr("class", "btn-off");
		$("#disableAP").val(0);
